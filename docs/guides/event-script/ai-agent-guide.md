...
> - A flow is a **YAML file compiled and validated by the engine** (`CompileFlows`). Your job is to
>   produce one that passes — the [invariants](flow-grammar.md#invariants) are the contract.
