 ...
 */
@ZeroTracing
@PreLoad(route=EchoService.ROUTE)
public class EchoService implements TypedLambdaFunction<EventEnvelope, Void> {
    public static final String ROUTE = "cloud.health.inbox";
