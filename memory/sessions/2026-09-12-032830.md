...
`design/streaming-return-route-ratified`, commit `b358d8bd`; merged via PR
#366, squash `b700b4f0`, title clean).** The ratified design is SIMPLER than the first draft on two axes:
