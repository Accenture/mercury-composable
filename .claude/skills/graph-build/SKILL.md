...
**Canonical spec (authoritative).** Full detail and precedence live in [`.graph-builder/build.md`](.graph-builder/build.md); defer to it on any conflict. The step checklist and gate below are lifted verbatim from that spec — this wrapper is not a second source of truth.
