import{j as f,T as Wh,_ as co,H as cc,W as Mg}from"./vendor-panels-Cixz1HBJ.js";import{a as Ph,b as Dg,r as T,N as Og,R as Fh,u as kg,B as Rg,c as zg,d as ef,e as Bg}from"./vendor-router-DUFbnzxw.js";import{N as Hg,H as xh,P as Sh,M as Gg,u as Ug,a as Lg,B as Yg,b as qg,C as Xg,c as Jg,i as Ig}from"./vendor-xyflow-k-RwjR-l.js";import{c as Zg,a as Qg,d as uo,J as xc}from"./vendor-json-view-Djmwb-hd.js";import{M as Vg,r as Kg}from"./vendor-markdown-Cp1IxVgw.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const p of document.querySelectorAll('link[rel="modulepreload"]'))u(p);new MutationObserver(p=>{for(const h of p)if(h.type==="childList")for(const v of h.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&u(v)}).observe(document,{childList:!0,subtree:!0});function s(p){const h={};return p.integrity&&(h.integrity=p.integrity),p.referrerPolicy&&(h.referrerPolicy=p.referrerPolicy),p.crossOrigin==="use-credentials"?h.credentials="include":p.crossOrigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function u(p){if(p.ep)return;p.ep=!0;const h=s(p);fetch(p.href,h)}})();var Pr={exports:{}},so={},Fr={exports:{}},ec={};/**
 * @license React
 ...
 */var wh;function $g(){return wh||(wh=1,(function(r){function n(D,O){var Q=D.length;D.push(O);e:for(;0<Q;){var P=Q-1>>>1,F=D[P];if(0<p(F,O))D[P]=O,D[Q]=F,Q=P;else break e}}function s(D){return D.length===0?null:D[0]}function u(D){if(D.length===0)return null;var O=D[0],Q=D.pop();if(Q!==O){D[0]=Q;e:for(var P=0,F=D.length,ie=F>>>1;P<ie;){var oe=2*(P+1)-1,ee=D[oe],ye=oe+1,se=D[ye];if(0>p(ee,Q))ye<F&&0>p(se,ee)?(D[P]=se,D[ye]=Q,P=ye):(D[P]=ee,D[oe]=Q,P=oe);else if(ye<F&&0>p(se,Q))D[P]=se,D[ye]=Q,P=ye;else break e}}return O}function p(D,O){var Q=D.sortIndex-O.sortIndex;return Q!==0?Q:D.id-O.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;r.unstable_now=function(){return h.now()}}else{var v=Date,g=v.now();r.unstable_now=function(){return v.now()-g}}var m=[],y=[],w=1,b=null,S=3,N=!1,E=!1,C=!1,_=!1,j=typeof setTimeout=="function"?setTimeout:null,k=typeof clearTimeout=="function"?clearTimeout:null,H=typeof setImmediate<"u"?setImmediate:null;function L(D){for(var O=s(y);O!==null;){if(O.callback===null)u(y);else if(O.startTime<=D)u(y),O.sortIndex=O.expirationTime,n(m,O);else break;O=s(y)}}function X(D){if(C=!1,L(D),!E)if(s(m)!==null)E=!0,Y||(Y=!0,te());else{var O=s(y);O!==null&&re(X,O.startTime-D)}}var Y=!1,B=-1,I=5,V=-1;function K(){return _?!0:!(r.unstable_now()-V<I)}function $(){if(_=!1,Y){var D=r.unstable_now();V=D;var O=!0;try{e:{E=!1,C&&(C=!1,k(B),B=-1),N=!0;var Q=S;try{t:{for(L(D),b=s(m);b!==null&&!(b.expirationTime>D&&K());){var P=b.callback;if(typeof P=="function"){b.callback=null,S=b.priorityLevel;var F=P(b.expirationTime<=D);if(D=r.unstable_now(),typeof F=="function"){b.callback=F,L(D),O=!0;break t}b===s(m)&&u(m),L(D)}else u(m);b=s(m)}if(b!==null)O=!0;else{var ie=s(y);ie!==null&&re(X,ie.startTime-D),O=!1}}break e}finally{b=null,S=Q,N=!1}O=void 0}}finally{O?te():Y=!1}}}var te;if(typeof H=="function")te=function(){H($)};else if(typeof MessageChannel<"u"){var ue=new MessageChannel,he=ue.port2;ue.port1.onmessage=$,te=function(){he.postMessage(null)}}else te=function(){j($,0)};function re(D,O){B=j(function(){D(r.unstable_now())},O)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(D){D.callback=null},r.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<D?Math.floor(1e3/D):5},r.unstable_getCurrentPriorityLevel=function(){return S},r.unstable_next=function(D){switch(S){case 1:case 2:case 3:var O=3;break;default:O=S}var Q=S;S=O;try{return D()}finally{S=Q}},r.unstable_requestPaint=function(){_=!0},r.unstable_runWithPriority=function(D,O){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var Q=S;S=D;try{return O()}finally{S=Q}},r.unstable_scheduleCallback=function(D,O,Q){var P=r.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?P+Q:P):Q=P,D){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=Q+F,D={id:w++,callback:O,priorityLevel:D,startTime:Q,expirationTime:F,sortIndex:-1},Q>P?(D.sortIndex=Q,n(y,D),s(m)===null&&D===s(y)&&(C?(k(B),B=-1):C=!0,re(X,Q-P))):(D.sortIndex=F,n(m,D),E||N||(E=!0,Y||(Y=!0,te()))),D},r.unstable_shouldYield=K,r.unstable_wrapCallback=function(D){var O=S;return function(){var Q=S;S=O;try{return D.apply(this,arguments)}finally{S=Q}}}})(ec)),ec}var Th;function Wg(){return Th||(Th=1,Fr.exports=$g()),Fr.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Nh;function ty(){if(Nh)return nc;Nh=1;var r=Ph().__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;return nc.c=function(n){return r.H.useMemoCache(n)},nc}var Ch;function ny(){return Ch||(Ch=1,tc.exports=ty()),tc.exports}var Se=ny();const ay="_wrapper_bt1w8_2",ly="_header_bt1w8_10",oy="_headerActions_bt1w8_21",iy="_title_bt1w8_27",sy="_panelGroup_bt1w8_36",ry="_clipboardToggle_bt1w8_43",cy="_helpToggle_bt1w8_66",uy="_helpButtonWrapper_bt1w8_93",dy="_helpTogglePulsing_bt1w8_97",py="_helpHint_bt1w8_112",hy="_helpHintFading_bt1w8_139",fy="_helpHintKbd_bt1w8_144",my="_resizeHandle_bt1w8_153",kt={wrapper:ay,header:ly,headerActions:oy,title:iy,panelGroup:sy,clipboardToggle:ry,helpToggle:cy,helpButtonWrapper:uy,helpTogglePulsing:dy,helpHint:py,helpHintFading:hy,helpHintKbd:fy,resizeHandle:my},gy=r=>{try{return!new DOMParser().parseFromString(r.trim(),"text/xml").querySelector("parsererror")}catch{return!1}},yy=r=>{try{return JSON.parse(r),!0}catch{return!1}},vy=r=>r.trim()?yy(r)?{valid:!0,error:null,type:"json"}:gy(r)?{valid:!0,error:null,type:"xml"}:{valid:!1,error:"Invalid JSON/XML format",type:null}:{valid:!0,error:null,type:null},uc=r=>{try{const n=JSON.parse(r);return JSON.stringify(n,null,2)}catch{return r}},by=()=>{const r=Se.c(8);let n;r[0]===Symbol.for("react.memo_cache_sentinel")?(n=[],r[0]=n):n=r[0];const[s,u]=T.useState(n),p=T.useRef(0);let h;r[1]===Symbol.for("react.memo_cache_sentinel")?(h=new Set,r[1]=h):h=r[1];const v=T.useRef(h);let g,m;r[2]===Symbol.for("react.memo_cache_sentinel")?(g=()=>()=>{v.current.forEach(clearTimeout)},m=[],r[2]=g,r[3]=m):(g=r[2],m=r[3]),T.useEffect(g,m);let y;r[4]===Symbol.for("react.memo_cache_sentinel")?(y=(E,C)=>{const _=C===void 0?"info":C,j=p.current=p.current+1;u(H=>[...H,{id:j,message:E,type:_}]);const k=setTimeout(()=>{v.current.delete(k),u(H=>H.filter(L=>L.id!==j))},3e3);v.current.add(k)},r[4]=y):y=r[4];const w=y;let b;r[5]===Symbol.for("react.memo_cache_sentinel")?(b=E=>{u(C=>C.filter(_=>_.id!==E))},r[5]=b):b=r[5];const S=b;let N;return r[6]!==s?(N={toasts:s,addToast:w,removeToast:S},r[6]=s,r[7]=N):N=r[7],N},oa=(r,n)=>{const s=T.useCallback(()=>{try{const h=window.localStorage.getItem(r);return h?JSON.parse(h):n}catch{return n}},[r]),[u,p]=T.useState(s);return T.useEffect(()=>{p(s())},[r]),T.useEffect(()=>{try{window.localStorage.setItem(r,JSON.stringify(u))}catch(h){console.error(`Error setting localStorage key "${r}":`,h)}},[r,u]),T.useEffect(()=>{const h=v=>{(v.key===r||v.key===null)&&p(s())};return window.addEventListener("storage",h),()=>window.removeEventListener("storage",h)},[r,s]),T.useEffect(()=>{const h=()=>p(s());return window.addEventListener("focus",h),document.addEventListener("visibilitychange",h),()=>{window.removeEventListener("focus",h),document.removeEventListener("visibilitychange",h)}},[s]),[u,p]},_y=200,jh=50,xy=8,Sy=2e4,On=[{path:"/json-path",label:"JSON-Path",title:"JSON-Path Playground",wsPath:"/ws/json/path",storageKeyPayload:"jsonpath-last-payload",storageKeyHistory:"jsonpath-command-history",storageKeyTab:"jsonpath-right-tab",supportsUpload:!0,tabs:["payload","graph","graph-data"]},{path:"/",label:"Minigraph",title:"Minigraph Playground",wsPath:"/ws/graph/playground",storageKeyPayload:"minigraph-last-payload",storageKeyHistory:"minigraph-command-history",storageKeyTab:"minigraph-right-tab",storageKeySavedGraphs:"minigraph-saved-graphs",storageKeyHelpTopic:"minigraph-help-topic",supportsClipboard:!0,supportsHelp:!0,tabs:["graph","graph-data"]}],Mi={json_simple:JSON.stringify({name:"John Doe",age:30,city:"New York"},null,2),json_nested:JSON.stringify({user:{name:"Jane Smith",profile:{email:"jane@example.com",address:{city:"San Francisco",country:"USA"}}}},null,2),json_array:JSON.stringify([{id:1,name:"Item 1",status:"active"},{id:2,name:"Item 2",status:"pending"},{id:3,name:"Item 3",status:"inactive"}],null,2),xml_simple:`<?xml version="1.0" encoding="UTF-8"?>
<person>
  <name>John Doe</name>
  <age>30</age>
  <city>New York</city>
...
</items>`};function tf(r){return`ws://${window.location.host}${r}`}function ac(r,n,s,u){const p=r[n]??{phase:"idle",messages:[]},h=[...p.messages,{id:s,raw:u}];return h.length>_y&&h.shift(),{...r,[n]:{...p,messages:h}}}function wy(r,n){const s=r[n.path]??{phase:"idle",messages:[]};switch(n.type){case"CONNECTING":return{...r,[n.path]:{...s,phase:"connecting"}};case"CONNECTED":return ac({...r,[n.path]:{...s,phase:"connected"}},n.path,n.id,n.msg);case"MESSAGE_RECEIVED":return ac(r,n.path,n.id,n.msg);case"DISCONNECTED":return ac({...r,[n.path]:{...s,phase:"idle"}},n.path,n.id,n.msg);case"CONNECT_ERROR":return{...r,[n.path]:{...s,phase:"idle"}};case"CLEAR_MESSAGES":return{...r,[n.path]:{...s,messages:[]}};default:return r}}const nf=T.createContext(null);function Ty({children:r}){const[n,s]=T.useReducer(wy,{}),u=T.useRef({}),p=T.useRef({}),h=T.useRef({});T.useEffect(()=>()=>{Object.entries(u.current).forEach(([B,I])=>{I==null||I.close();const V=p.current[B];V&&clearInterval(V)})},[]);const v=B=>tf(B),g=B=>(h.current[B]=(h.current[B]??0)+1,h.current[B]),m=()=>{const B=new Date().toString(),I=B.indexOf("GMT");return I>0?B.substring(0,I).trim():B},y=(B,I)=>JSON.stringify({type:B,message:I,time:m()}),w=B=>{try{const I=JSON.parse(B);if(I!==null&&typeof I=="object"){const V=I.type;return V==="ping"||V==="pong"}}catch{}return!1},b=T.useCallback((B,I)=>{if(!window.WebSocket){I==null||I("WebSocket not supported by your browser","error");return}const V=u.current[B];if(V&&(V.readyState===WebSocket.OPEN||V.readyState===WebSocket.CONNECTING)){I==null||I("Already connected","error");return}s({type:"CONNECTING",path:B});const K=new WebSocket(v(B));u.current[B]=K,K.onopen=()=>{s({type:"CONNECTED",path:B,id:g(B),msg:y("info","connected")}),I==null||I("Connected to WebSocket","success"),K.send(JSON.stringify({type:"welcome"})),p.current[B]=setInterval(()=>{K.readyState===WebSocket.OPEN&&K.send(y("ping","keep alive"))},Sy)},K.onmessage=$=>{w($.data)||s({type:"MESSAGE_RECEIVED",path:B,id:g(B),msg:$.data})},K.onerror=()=>{s({type:"CONNECT_ERROR",path:B})},K.onclose=$=>{const te=p.current[B];te&&(clearInterval(te),p.current[B]=null),s({type:"DISCONNECTED",path:B,id:g(B),msg:y("info",`disconnected - (${$.code}) ${$.reason}`)}),I==null||I("Disconnected from WebSocket","info"),u.current[B]===K&&(u.current[B]=null)}},[]),S=T.useCallback(B=>{const I=u.current[B];I?I.close():s({type:"MESSAGE_RECEIVED",path:B,id:g(B),msg:y("error","already disconnected")})},[]);T.useEffect(()=>(On.forEach(B=>{b(B.wsPath)}),()=>{On.forEach(B=>{const I=u.current[B.wsPath];I&&I.close()})}),[]);const N=T.useCallback((B,I)=>{const V=u.current[B];return V&&V.readyState===WebSocket.OPEN?(V.send(I),!0):!1},[]),E=T.useCallback((B,I)=>{s({type:"MESSAGE_RECEIVED",path:B,id:g(B),msg:I})},[]),C=T.useCallback(B=>{s({type:"CLEAR_MESSAGES",path:B})},[]),[_,j]=T.useState({}),k=T.useCallback((B,I)=>{j(V=>{if(I===null){const K={...V};return delete K[B],K}return{...V,[B]:I}})},[]),H=T.useCallback(B=>_[B]??null,[_]),L=T.useCallback(B=>{const I=_[B]??null;return I!==null&&j(V=>{const K={...V};return delete K[B],K}),I},[_]),X=T.useCallback(B=>n[B]??{phase:"idle",messages:[]},[n]),Y=T.useMemo(()=>({getSlot:X,connect:b,disconnect:S,send:N,appendMessage:E,clearMessages:C,setPendingPayload:k,peekPendingPayload:H,takePendingPayload:L}),[X,b,S,N,E,C,k,H,L]);return f.jsx(nf.Provider,{value:Y,children:r})}function Sc(){const r=T.useContext(nf);if(!r)throw new Error("useWebSocketContext must be used inside <WebSocketProvider>");return r}const Ey=r=>{try{const n=JSON.parse(r);return{type:n.type||"info",message:n.message||r,time:n.time,raw:r}}catch{return{type:"raw",message:r,time:null,raw:r}}},Ay=r=>({info:"ℹ️",error:"❌",ping:"🔄",welcome:"👋",raw:""})[r]??"•",po=r=>{try{const n=JSON.parse(r);if(typeof n=="object"&&n!==null)return{isJSON:!0,data:n}}catch{}return{isJSON:!1,data:null}};function Ny(r){if(!r.includes("Graph exported to "))return null;const n=Tc(r);if(!n)return null;const s=n.split("/")[4];return s?{graphName:s,apiPath:n}:null}function Cy(r){return r.includes("Invalid filename")?{reason:"invalid-name"}:r.includes("Expect root node name")?{reason:"root-name-conflict"}:null}function wc(r){const n=po(r);return n.isJSON?(typeof n.data.type=="string",!1):!0}function Tc(r){const n=r.match(/\/api\/graph\/model\/([^\s'"]+)/);return n?n[0]:null}function af(r){return wc(r)?Tc(r)!==null:!1}function lf(r){const n=r.match(/\/api\/json\/content\/([\w-]+)/);return n?n[0]:null}function jy(r){const n=r.match(/Large payload \((\d+)\)\s*->\s*GET\s+(\/api\/inspect\/[^\s]+)/i);if(!n)return null;const s=parseInt(n[1],10),u=n[2],h=`${u.split("/").filter(Boolean).pop()??"payload"}.json`;return{apiPath:u,byteSize:s,filename:h}}function My(r){const n=r.match(/You may upload .*?->\s*POST\s+(\/api\/mock\/[\w-]+)/i);return n?n[1]:null}function Dy(r){if(!r.startsWith("> "))return!1;const n=r.slice(2).trim().toLowerCase();return n==="help"||n.startsWith("help ")?!0:n.startsWith("describe ")?!n.slice(9).trim().startsWith("graph"):!1}function Oy(r){if(!r.startsWith("> ")||!r.slice(2).trimStart().toLowerCase().startsWith("import graph from "))return null;const s=r.slice(2).trimStart().slice(18).trim();return s.length>0?s:null}function ky(r){if(!wc(r)||r.startsWith("> ")||af(r))return null;const n=r.toLowerCase();return n.includes("graph model imported as draft")?"import-graph":n.includes(" -> ")&&n.includes("removed")||n.startsWith("node ")&&(n.includes(" created")||n.includes(" updated")||n.includes(" deleted")||n.includes(" connected to ")||n.includes(" imported from ")||n.includes(" overwritten by node from "))?"node-mutation":null}const Ry={command:"",historyIndex:-1,draftCommand:""};function zy(r,n){switch(n.type){case"SET_COMMAND":return{...r,command:n.value,historyIndex:-1,draftCommand:""};case"CLEAR_COMMAND":return{...r,command:"",historyIndex:-1,draftCommand:""};case"SET_HISTORY_INDEX":return{...r,historyIndex:n.index,command:n.command};case"ENTER_HISTORY":return{...r,historyIndex:0,command:n.command,draftCommand:r.command};case"EXIT_HISTORY":return{...r,historyIndex:-1,command:r.draftCommand,draftCommand:""};default:return r}}function By(r){const n=Se.c(77),{wsPath:s,storageKeyHistory:u,payload:p,addToast:h,bus:v,handleLocalCommand:g}=r,m=Sc();let y;n[0]!==m||n[1]!==s?(y=m.getSlot(s),n[0]=m,n[1]=s,n[2]=y):y=n[2];const{phase:w,messages:b}=y,S=w==="connected",N=w==="connecting",[E,C]=T.useReducer(zy,Ry),{command:_,historyIndex:j}=E;let k;n[3]===Symbol.for("react.memo_cache_sentinel")?(k=[],n[3]=k):k=n[3];const[H,L]=oa(u,k),X=T.useRef(null),Y=T.useRef(!1);let B;n[4]===Symbol.for("react.memo_cache_sentinel")?(B=()=>{X.current&&(X.current.scrollTop=X.current.scrollHeight)},n[4]=B):B=n[4];let I;n[5]!==b?(I=[b],n[5]=b,n[6]=I):I=n[6],T.useEffect(B,I);let V;n[7]!==h||n[8]!==m||n[9]!==s?(V=()=>{m.connect(s,h)},n[7]=h,n[8]=m,n[9]=s,n[10]=V):V=n[10];const K=V;let $;n[11]!==m||n[12]!==s?($=()=>{m.disconnect(s)},n[11]=m,n[12]=s,n[13]=$):$=n[13];const te=$;let ue;n[14]!==_||n[15]!==m||n[16]!==g||n[17]!==H||n[18]!==p||n[19]!==w||n[20]!==L||n[21]!==s?(ue=()=>{if(w!=="connected")return;const W=_.trim();if(W.length!==0){if((g==null?void 0:g(W))===!0){H[0]!==W&&L(ve=>[W,...ve].slice(0,jh)),m.appendMessage(s,"> "+W),C({type:"CLEAR_COMMAND"});return}m.send(s,W),H[0]!==W&&L(ve=>[W,...ve].slice(0,jh)),W==="load"&&(p.length===0?m.appendMessage(s,"ERROR: please paste JSON/XML payload in input text area"):m.send(s,p)),C({type:"CLEAR_COMMAND"})}},n[14]=_,n[15]=m,n[16]=g,n[17]=H,n[18]=p,n[19]=w,n[20]=L,n[21]=s,n[22]=ue):ue=n[22];const he=ue;let re;n[23]!==H||n[24]!==j?(re=W=>{if(W.key==="ArrowUp"){if(W.preventDefault(),H.length===0)return;if(j===-1)C({type:"ENTER_HISTORY",command:H[0]});else if(j<H.length-1){const ve=j+1;C({type:"SET_HISTORY_INDEX",index:ve,command:H[ve]})}}else if(W.key==="ArrowDown")if(W.preventDefault(),j<=0)j===0&&C({type:"EXIT_HISTORY"});else{const ve=j-1;C({type:"SET_HISTORY_INDEX",index:ve,command:H[ve]})}},n[23]=H,n[24]=j,n[25]=re):re=n[25];const D=re;let O,Q;n[26]!==h||n[27]!==v||n[28]!==m||n[29]!==p||n[30]!==s?(Q=()=>{if(v)return v.on("upload.contentPath",W=>{if(!Y.current)return;if(Y.current=!1,p.length===0){m.appendMessage(s,"ERROR: please paste JSON/XML payload in the input text area");return}let ve;try{ve=JSON.stringify(JSON.parse(p))}catch{m.appendMessage(s,"ERROR: payload is not valid JSON — cannot upload");return}fetch(W.uploadPath,{method:"POST",headers:{"Content-Type":"application/json"},body:ve}).then(Te=>{if(!Te.ok)throw new Error(`HTTP ${Te.status}`);h("Payload uploaded successfully","success")}).catch(Te=>{m.appendMessage(s,`ERROR: upload failed — ${Te.message}`),h(`Upload failed: ${Te.message}`,"error")})})},O=[v,p,s,m,h],n[26]=h,n[27]=v,n[28]=m,n[29]=p,n[30]=s,n[31]=O,n[32]=Q):(O=n[31],Q=n[32]),T.useEffect(Q,O);let P,F;n[33]!==h||n[34]!==v||n[35]!==m||n[36]!==b||n[37]!==p||n[38]!==s?(P=()=>{if(v||!Y.current||b.length===0)return;const W=b[b.length-1].raw,ve=lf(W);if(!ve)return;if(Y.current=!1,p.length===0){m.appendMessage(s,"ERROR: please paste JSON/XML payload in the input text area");return}let Te;try{Te=JSON.stringify(JSON.parse(p))}catch{m.appendMessage(s,"ERROR: payload is not valid JSON — cannot upload");return}fetch(ve,{method:"POST",headers:{"Content-Type":"application/json"},body:Te}).then(me=>{if(!me.ok)throw new Error(`HTTP ${me.status}`);h("Payload uploaded successfully","success")}).catch(me=>{m.appendMessage(s,`ERROR: upload failed — ${me.message}`),h(`Upload failed: ${me.message}`,"error")})},F=[v,b,p,s,m,h],n[33]=h,n[34]=v,n[35]=m,n[36]=b,n[37]=p,n[38]=s,n[39]=P,n[40]=F):(P=n[39],F=n[40]),T.useEffect(P,F);let ie;n[41]!==h||n[42]!==m||n[43]!==p||n[44]!==w||n[45]!==s?(ie=()=>{if(w==="connected"){if(p.length===0){h("Nothing to upload — paste a JSON payload first","error");return}Y.current=!0,m.send(s,"upload")}},n[41]=h,n[42]=m,n[43]=p,n[44]=w,n[45]=s,n[46]=ie):ie=n[46];const oe=ie;let ee;n[47]!==m||n[48]!==w||n[49]!==s?(ee=W=>{w==="connected"&&m.send(s,W)},n[47]=m,n[48]=w,n[49]=s,n[50]=ee):ee=n[50];const ye=ee;let se;n[51]!==h||n[52]!==b?(se=()=>{navigator.clipboard.writeText(b.map(Hy).join(`
`)),h("Console copied to clipboard!","success")},n[51]=h,n[52]=b,n[53]=se):se=n[53];const ge=se;let je;n[54]!==h||n[55]!==m||n[56]!==s?(je=()=>{m.clearMessages(s),h("Console cleared","info")},n[54]=h,n[55]=m,n[56]=s,n[57]=je):je=n[57];const He=je;let we;n[58]!==m||n[59]!==s?(we=W=>{m.appendMessage(s,W)},n[58]=m,n[59]=s,n[60]=we):we=n[60];const ae=we;let de;n[61]===Symbol.for("react.memo_cache_sentinel")?(de=W=>C({type:"SET_COMMAND",value:W}),n[61]=de):de=n[61];const fe=de;let ze;return n[62]!==ae||n[63]!==He||n[64]!==_||n[65]!==K||n[66]!==S||n[67]!==N||n[68]!==ge||n[69]!==te||n[70]!==D||n[71]!==H||n[72]!==b||n[73]!==he||n[74]!==ye||n[75]!==oe?(ze={connected:S,connecting:N,messages:b,command:_,setCommand:fe,connect:K,disconnect:te,sendCommand:he,handleKeyDown:D,consoleRef:X,copyMessages:ge,clearMessages:He,uploadPayload:oe,sendRawText:ye,appendMessage:ae,history:H},n[62]=ae,n[63]=He,n[64]=_,n[65]=K,n[66]=S,n[67]=N,n[68]=ge,n[69]=te,n[70]=D,n[71]=H,n[72]=b,n[73]=he,n[74]=ye,n[75]=oe,n[76]=ze):ze=n[76],ze}function Hy(r){return r.raw}function Gy(r){const n=Se.c(5);let s;n[0]!==r?(s=()=>window.matchMedia(r).matches,n[0]=r,n[1]=s):s=n[1];const[u,p]=T.useState(s);let h,v;return n[2]!==r?(h=()=>{const g=window.matchMedia(r),m=y=>p(y.matches);return g.addEventListener("change",m),()=>g.removeEventListener("change",m)},v=[r],n[2]=r,n[3]=h,n[4]=v):(h=n[3],v=n[4]),T.useEffect(h,v),u}function Mh(r){return typeof r!="object"||r===null?!1:Array.isArray(r.nodes)}function lc(r,n,s){const u=n.includes(s)?s:n[0]??"graph";return typeof r=="string"&&n.includes(r)?r:u}function Uy(r,n,s,u,p){const[h,v]=T.useState(null),[g,m]=oa(p,s),y=lc(g,u,s),[w,b]=T.useState(!1),S=T.useCallback(_=>{m(j=>{const k=lc(j,u,s),H=typeof _=="function"?_(k):_;return lc(H,u,s)})},[m,u,s]);T.useEffect(()=>{g!==y&&m(y)},[g,y,m]);const N=T.useRef(r);T.useEffect(()=>{N.current=r},[r]);const E=T.useRef(null);T.useEffect(()=>{if(!r)return;const _=new AbortController;return v(null),fetch(r,{signal:_.signal}).then(j=>{if(!j.ok)throw new Error(`HTTP ${j.status}`);return j.json()}).then(j=>{Mh(j)&&(v(j),S("graph"))}).catch(j=>{j.name!=="AbortError"&&n(`Graph fetch failed: ${j.message}`,"error")}),()=>{_.abort()}},[r,n]);const C=T.useCallback(()=>{var k;const _=N.current;if(!_)return;(k=E.current)==null||k.abort();const j=new AbortController;E.current=j,b(!0),fetch(_,{signal:j.signal}).then(H=>{if(!H.ok)throw new Error(`HTTP ${H.status}`);return H.json()}).then(H=>{Mh(H)&&v(H),b(!1)}).catch(H=>{H.name!=="AbortError"&&(n(`Graph refresh failed: ${H.message}`,"error"),b(!1))})},[]);return T.useEffect(()=>()=>{var _;(_=E.current)==null||_.abort()},[]),{graphData:h,setGraphData:v,rightTab:y,setRightTab:S,isRefreshing:w,refetchGraph:C}}function Ly(r){const n=Se.c(22),{bus:s,pinnedGraphPath:u,setPinnedGraphPath:p,connected:h,sendRawText:v,addToast:g}=r,m=T.useRef(null),y=T.useRef(!1),w=T.useRef(u),b=T.useRef(h),S=T.useRef(v);let N,E;n[0]!==u?(N=()=>{w.current=u},E=[u],n[0]=u,n[1]=N,n[2]=E):(N=n[1],E=n[2]),T.useEffect(N,E);let C,_;n[3]!==h?(C=()=>{b.current=h},_=[h],n[3]=h,n[4]=C,n[5]=_):(C=n[4],_=n[5]),T.useEffect(C,_);let j,k;n[6]!==v?(j=()=>{S.current=v},k=[v],n[6]=v,n[7]=j,n[8]=k):(j=n[7],k=n[8]),T.useEffect(j,k);let H,L;n[9]!==h?(H=()=>{h||(y.current=!1,m.current!==null&&(clearTimeout(m.current),m.current=null))},L=[h],n[9]=h,n[10]=H,n[11]=L):(H=n[10],L=n[11]),T.useEffect(H,L);let X,Y;n[12]!==s||n[13]!==p?(Y=()=>s.on("graph.link",$=>{y.current&&(y.current=!1,p($.apiPath))}),X=[s,p],n[12]=s,n[13]=p,n[14]=X,n[15]=Y):(X=n[14],Y=n[15]),T.useEffect(Y,X);let B,I;n[16]!==g||n[17]!==s?(B=()=>s.on("graph.mutation",$=>{if(b.current){if($.mutationType==="import-graph"){m.current!==null&&(clearTimeout(m.current),m.current=null),y.current=!0,S.current("describe graph"),g("Graph imported — refreshing view…","info");return}m.current!==null&&clearTimeout(m.current),m.current=setTimeout(()=>{m.current=null,b.current&&(y.current=!0,S.current("describe graph"),g(w.current!==null?"Graph updated — refreshing…":"Graph updated — opening Graph tab…","info"))},300)}}),I=[s,g],n[16]=g,n[17]=s,n[18]=B,n[19]=I):(B=n[18],I=n[19]),T.useEffect(B,I);let V,K;n[20]===Symbol.for("react.memo_cache_sentinel")?(V=()=>()=>{m.current!==null&&clearTimeout(m.current)},K=[],n[20]=V,n[21]=K):(V=n[20],K=n[21]),T.useEffect(V,K)}const Yy=`Connect two nodes together
--------------------------
...
`,w1=Object.assign({"../../../src/main/resources/help/help connect.md":Yy,"../../../src/main/resources/help/help create.md":qy,"../../../src/main/resources/help/help data-dictionary.md":Xy,"../../../src/main/resources/help/help delete.md":Jy,"../../../src/main/resources/help/help describe.md":Iy,"../../../src/main/resources/help/help edit.md":Zy,"../../../src/main/resources/help/help execute.md":Qy,"../../../src/main/resources/help/help export.md":Vy,"../../../src/main/resources/help/help graph-api-fetcher.md":Ky,"../../../src/main/resources/help/help graph-data-mapper.md":$y,"../../../src/main/resources/help/help graph-extension.md":Wy,"../../../src/main/resources/help/help graph-island.md":Py,"../../../src/main/resources/help/help graph-join.md":Fy,"../../../src/main/resources/help/help graph-js.md":e1,"../../../src/main/resources/help/help graph-math.md":t1,"../../../src/main/resources/help/help import.md":n1,"../../../src/main/resources/help/help inspect.md":a1,"../../../src/main/resources/help/help instantiate.md":l1,"../../../src/main/resources/help/help list.md":o1,"../../../src/main/resources/help/help run.md":i1,"../../../src/main/resources/help/help seen.md":s1,"../../../src/main/resources/help/help tutorial 1.md":r1,"../../../src/main/resources/help/help tutorial 10.md":c1,"../../../src/main/resources/help/help tutorial 11.md":u1,"../../../src/main/resources/help/help tutorial 12.md":d1,"../../../src/main/resources/help/help tutorial 2.md":p1,"../../../src/main/resources/help/help tutorial 3.md":h1,"../../../src/main/resources/help/help tutorial 4.md":f1,"../../../src/main/resources/help/help tutorial 5.md":m1,"../../../src/main/resources/help/help tutorial 6.md":g1,"../../../src/main/resources/help/help tutorial 7.md":y1,"../../../src/main/resources/help/help tutorial 8.md":v1,"../../../src/main/resources/help/help tutorial 9.md":b1,"../../../src/main/resources/help/help update.md":_1,"../../../src/main/resources/help/help upload.md":x1,"../../../src/main/resources/help/help.md":S1});function T1(r){const n=r.split("/");return(n[n.length-1]??r).replace(/\.md$/,"")}const of=Object.fromEntries(Object.entries(w1).map(([r,n])=>[T1(r),n]));function Ri(r){const n=r===""?"help":`help ${r}`;return of[n]??null}const E1=Object.keys(of).filter(r=>r!=="help").map(r=>r.replace(/^help\s+/,"")).sort(),dc=[{id:"overview",label:"Overview"},{id:"graph-model",label:"Graph Model"},{id:"graph-skills",label:"Graph Skills"},{id:"instance-model",label:"Instance Model"},{id:"tutorials",label:"Tutorials",chipStripLabel:"Chapters"}],A1=new Set(["execute","inspect","instantiate","run","seen","upload"]);function sf(r){return r===""?"overview":r.startsWith("tutorial ")?"tutorials":r.startsWith("graph-")?"graph-skills":A1.has(r)?"instance-model":"graph-model"}function pc(r){if(r==="overview")return[""];const n=E1.filter(s=>sf(s)===r);return r==="tutorials"?[...n].sort((s,u)=>{const p=parseInt(s.replace(/^tutorial\s+/,""),10),h=parseInt(u.replace(/^tutorial\s+/,""),10);return p-h}):n}function N1(r,n){return r===""?"Overview":n==="tutorials"?r.replace(/^tutorial\s+/,""):r}const fl=dc.flatMap(r=>pc(r.id));function rf(r){return r.replace(/^help\s*/i,"").trim().toLowerCase()}function C1(r){const n=Se.c(6),{bus:s,setHelpTopic:u,onTabSwitch:p}=r,h=T.useRef(p);let v;n[0]!==p?(v=()=>{h.current=p},n[0]=p,n[1]=v):v=n[1],T.useEffect(v);let g,m;n[2]!==s||n[3]!==u?(g=()=>s.on("command.helpOrDescribe",y=>{if(!y.commandText.trim().toLowerCase().startsWith("help"))return;const b=rf(y.commandText);Ri(b)!==null&&(u(b),h.current())}),m=[s,u],n[2]=s,n[3]=u,n[4]=g,n[5]=m):(g=n[4],m=n[5]),T.useEffect(g,m)}function j1(r){const n=Se.c(12),{ctx:s,navigate:u,addToast:p,wsPath:h}=r;let v;n[0]===Symbol.for("react.memo_cache_sentinel")?(v=On.find(M1),n[0]=v):v=n[0];const g=v,m=T.useRef(null),y=g==null?void 0:g.wsPath;let w,b;n[1]!==p||n[2]!==s||n[3]!==u?(w=()=>{if(!y||!m.current)return;if(s.getSlot(y).phase==="connected"){const{wsPath:j,json:k}=m.current;m.current=null,s.setPendingPayload(j,k),u(g.path),p("JSON loaded into JSON-Path editor ✓","success")}},b=[y,s,u,p,g],n[1]=p,n[2]=s,n[3]=u,n[4]=w,n[5]=b):(w=n[4],b=n[5]),T.useEffect(w,b);let S;n[6]!==p||n[7]!==s||n[8]!==u?(S=_=>{if(!g)return;const j=s.getSlot(g.wsPath);j.phase==="connected"?(s.setPendingPayload(g.wsPath,_),u(g.path),p("JSON loaded into JSON-Path editor ✓","success")):j.phase==="connecting"?(m.current={wsPath:g.wsPath,json:_},p("Updated pending JSON transfer — latest payload will open when connected","info")):(m.current={wsPath:g.wsPath,json:_},s.connect(g.wsPath,p),p("Connecting to JSON-Path Playground…","info"))},n[6]=p,n[7]=s,n[8]=u,n[9]=S):S=n[9];const N=S,E=g&&h!==g.wsPath?N:void 0;let C;return n[10]!==E?(C={handleSendToJsonPath:E},n[10]=E,n[11]=C):C=n[11],C}function M1(r){return r.tabs.includes("payload")&&r.supportsUpload}function D1(r){const n=Se.c(7),{bus:s,onOpenModal:u,modalOpen:p}=r,h=T.useRef(!1);let v,g;n[0]!==p?(v=()=>{p||(h.current=!1)},g=[p],n[0]=p,n[1]=v,n[2]=g):(v=n[1],g=n[2]),T.useEffect(v,g);let m,y;n[3]!==s||n[4]!==u?(m=()=>s.on("upload.invitation",w=>{h.current||(h.current=!0,u(w.uploadPath))}),y=[s,u],n[3]=s,n[4]=u,n[5]=m,n[6]=y):(m=n[5],y=n[6]),T.useEffect(m,y)}function O1(r){const n=Se.c(17),{bus:s,addToast:u}=r,[p,h]=T.useState(null),v=T.useRef(null);let g;n[0]===Symbol.for("react.memo_cache_sentinel")?(g=new Set,n[0]=g):g=n[0];const[m,y]=T.useState(g);let w;n[1]===Symbol.for("react.memo_cache_sentinel")?(w=B=>{v.current=document.activeElement,h(B)},n[1]=w):w=n[1];const b=w;let S;n[2]===Symbol.for("react.memo_cache_sentinel")?(S=()=>{h(null),setTimeout(()=>{var B;return(B=v.current)==null?void 0:B.focus()},0)},n[2]=S):S=n[2];const N=S;let E;n[3]!==u||n[4]!==p?(E=B=>{y(I=>new Set([...I,p])),h(null),setTimeout(()=>{var I;return(I=v.current)==null?void 0:I.focus()},0),u("Mock data uploaded successfully ✓","success")},n[3]=u,n[4]=p,n[5]=E):E=n[5];const C=E;let _;n[6]!==u?(_=B=>{u(`Upload failed: ${B}`,"error")},n[6]=u,n[7]=_):_=n[7];const j=_;let k;n[8]===Symbol.for("react.memo_cache_sentinel")?(k=()=>{y(new Set)},n[8]=k):k=n[8];const H=k,L=p!==null;let X;n[9]!==s||n[10]!==L?(X={bus:s,onOpenModal:b,modalOpen:L},n[9]=s,n[10]=L,n[11]=X):X=n[11],D1(X);let Y;return n[12]!==j||n[13]!==C||n[14]!==p||n[15]!==m?(Y={modalUploadPath:p,successfulUploadPaths:m,handleOpenUploadModal:b,handleCloseUploadModal:N,handleUploadSuccess:C,handleUploadError:j,resetSuccessfulPaths:H},n[12]=j,n[13]=C,n[14]=p,n[15]=m,n[16]=Y):Y=n[16],Y}function k1(r){const n=Se.c(14),{bus:s,connected:u,appendMessage:p,addToast:h}=r,v=T.useRef(null),g=T.useRef(!1),m=T.useRef(p);let y,w;n[0]!==p?(y=()=>{m.current=p},w=[p],n[0]=p,n[1]=y,n[2]=w):(y=n[1],w=n[2]),T.useEffect(y,w);const b=T.useRef(h);let S,N;n[3]!==h?(S=()=>{b.current=h},N=[h],n[3]=h,n[4]=S,n[5]=N):(S=n[4],N=n[5]),T.useEffect(S,N);let E,C;n[6]!==u?(E=()=>{var L;u||((L=v.current)==null||L.abort(),v.current=null,g.current=!1)},C=[u],n[6]=u,n[7]=E,n[8]=C):(E=n[7],C=n[8]),T.useEffect(E,C);let _,j;n[9]===Symbol.for("react.memo_cache_sentinel")?(_=()=>()=>{var L;(L=v.current)==null||L.abort()},j=[],n[9]=_,n[10]=j):(_=n[9],j=n[10]),T.useEffect(_,j);let k,H;n[11]!==s?(H=()=>s.on("payload.large",L=>{var V;if(g.current)return;const{apiPath:X,byteSize:Y}=L;(V=v.current)==null||V.abort();const B=new AbortController;v.current=B;const I=(Y/1048576).toFixed(2);b.current(`Fetching large payload (${I} MB)…`,"info"),g.current=!0,fetch(X,{signal:B.signal}).then(R1).then(K=>{if(!K.trim())throw new Error("empty response body");let $=K;try{$=JSON.stringify(JSON.parse(K),null,2)}catch{}m.current($),g.current=!1,v.current=null}).catch(K=>{K.name!=="AbortError"&&(g.current=!1,v.current=null,m.current(`ERROR: payload fetch failed — ${K.message}`),b.current(`Payload fetch failed: ${K.message}`,"error"))})}),k=[s],n[11]=s,n[12]=k,n[13]=H):(k=n[12],H=n[13]),T.useEffect(H,k)}function R1(r){if(!r.ok)throw new Error(`HTTP ${r.status}`);return r.text()}function z1(r){const n=Se.c(14);let s;n[0]===Symbol.for("react.memo_cache_sentinel")?(s={},n[0]=s):s=n[0];const[u,p]=oa(r,s);let h;n[1]!==p?(h=E=>{p(C=>({...C,[E]:{name:E,savedAt:new Date().toISOString()}}))},n[1]=p,n[2]=h):h=n[2];const v=h;let g;n[3]!==p?(g=E=>{p(C=>{const _={...C};return delete _[E],_})},n[3]=p,n[4]=g):g=n[4];const m=g;let y;n[5]!==u?(y=E=>Object.prototype.hasOwnProperty.call(u,E),n[5]=u,n[6]=y):y=n[6];const w=y;let b;n[7]!==u?(b=Object.values(u).sort(B1),n[7]=u,n[8]=b):b=n[8];const S=b;let N;return n[9]!==m||n[10]!==w||n[11]!==v||n[12]!==S?(N={savedGraphs:S,saveGraph:v,deleteGraph:m,hasGraph:w},n[9]=m,n[10]=w,n[11]=v,n[12]=S,n[13]=N):N=n[13],N}function B1(r,n){return new Date(n.savedAt).getTime()-new Date(r.savedAt).getTime()}function H1(r,n){const s=Se.c(11),[u,p]=oa(r,1),h=T.useRef(!1),[v,g]=T.useState(null),[m,y]=T.useState(null);let w,b;s[0]!==n?(w=()=>n.on("command.importGraph",k=>{g(k.graphName),y(null)}),b=[n],s[0]=n,s[1]=w,s[2]=b):(w=s[1],b=s[2]),T.useEffect(w,b);let S;s[3]!==u?(S=k=>{y(k),k===`untitled-${u}`&&(h.current=!0)},s[3]=u,s[4]=S):S=s[4];const N=S;let E;s[5]!==p?(E=()=>{g(null),y(null),h.current&&p(G1),h.current=!1},s[5]=p,s[6]=E):E=s[6];const C=E,_=m??v??`untitled-${u}`;let j;return s[7]!==_||s[8]!==C||s[9]!==N?(j={defaultName:_,setLastSavedName:N,resetName:C},s[7]=_,s[8]=C,s[9]=N,s[10]=j):j=s[10],j}function G1(r){return r+1}function U1(r){const n=Se.c(27),{bus:s,connected:u,sendRawText:p,saveGraph:h,setLastSavedName:v,addToast:g}=r,m=T.useRef(null);let y;n[0]!==g||n[1]!==u||n[2]!==p?(y=Y=>{if(!u){g("Save failed: connection required to export graph","error");return}const B=setTimeout(()=>{m.current!==null&&(m.current=null,g("Save failed: export confirmation timed out","error"))},1e4);m.current={graphName:Y,timeoutId:B},p(`export graph as ${Y}`)},n[0]=g,n[1]=u,n[2]=p,n[3]=y):y=n[3];const w=y;let b,S;n[4]!==g||n[5]!==s||n[6]!==h||n[7]!==v?(b=()=>s.on("graph.exported",Y=>{if(m.current===null||Y.graphName!==m.current.graphName)return;clearTimeout(m.current.timeoutId);const B=m.current.graphName;m.current=null,h(B),v(B),g(`Graph saved as "${B}"`,"success")}),S=[s,h,v,g],n[4]=g,n[5]=s,n[6]=h,n[7]=v,n[8]=b,n[9]=S):(b=n[8],S=n[9]),T.useEffect(b,S);let N,E;n[10]!==g||n[11]!==s?(N=()=>s.on("graph.export.failed",Y=>{m.current!==null&&(clearTimeout(m.current.timeoutId),m.current=null,Y.reason==="invalid-name"?g("Save failed: invalid filename (a–z, A–Z, 0–9, hyphen only)","error"):g("Save failed: root node name does not match existing graph","error"))}),E=[s,g],n[10]=g,n[11]=s,n[12]=N,n[13]=E):(N=n[12],E=n[13]),T.useEffect(N,E);let C,_;n[14]!==g||n[15]!==u?(C=()=>{!u&&m.current!==null&&(clearTimeout(m.current.timeoutId),m.current=null,g("Save failed: connection closed before export confirmation","error"))},_=[u,g],n[14]=g,n[15]=u,n[16]=C,n[17]=_):(C=n[16],_=n[17]),T.useEffect(C,_);let j,k;n[18]===Symbol.for("react.memo_cache_sentinel")?(j=()=>()=>{m.current!==null&&clearTimeout(m.current.timeoutId)},k=[],n[18]=j,n[19]=k):(j=n[18],k=n[19]),T.useEffect(j,k);let H;n[20]!==g||n[21]!==u||n[22]!==p?(H=Y=>{u&&(p(`import graph from ${Y}`),g(`Importing graph "${Y}"…`,"info"))},n[20]=g,n[21]=u,n[22]=p,n[23]=H):H=n[23];const L=H;let X;return n[24]!==L||n[25]!==w?(X={handleSaveGraph:w,handleLoadGraph:L},n[24]=L,n[25]=w,n[26]=X):X=n[26],X}const oc=new Map;function L1(r){const n=Se.c(7);let s;n[0]!==r?(s=()=>oc.get(r)??null,n[0]=r,n[1]=s):s=n[1];const[u,p]=T.useState(s);let h;n[2]!==r?(h=m=>{p(m),m===null?oc.delete(r):oc.set(r,m)},n[2]=r,n[3]=h):h=n[3];const v=h;let g;return n[4]!==u||n[5]!==v?(g=[u,v],n[4]=u,n[5]=v,n[6]=g):g=n[6],g}function Dh(r){if(r==null)return"";const n=typeof r=="string"?r:JSON.stringify(r);return n.includes("'''")&&console.warn(`[commandBuilder] Property value contains "'''" which cannot be escaped in the backend grammar. The value may be truncated on paste.`),n.includes(`
`)?`'''
${n}
'''`:n}function Y1(r,n){const s=[`${r} node ${n.alias}`];n.types.length>0&&s.push(`with type ${n.types[0]}`);const u=Object.entries(n.properties).filter(([,p])=>p!=null);if(u.length>0){s.push("with properties");for(const[p,h]of u)if(Array.isArray(h))for(const v of h)s.push(`${p}[]=${Dh(v)}`);else s.push(`${p}[]=${Dh(h)}`)}return s.join(`
`)}const q1="_toastContainer_hhy5k_1",X1="_toast_hhy5k_1",J1="_slideIn_hhy5k_1",I1="_success_hhy5k_36",Z1="_error_hhy5k_40",Q1="_info_hhy5k_44",V1="_toastIcon_hhy5k_48",K1="_toastMessage_hhy5k_53",ro={toastContainer:q1,toast:X1,slideIn:J1,success:I1,error:Z1,info:Q1,toastIcon:V1,toastMessage:K1},$1=r=>{const n=Se.c(7),{toasts:s,onRemove:u}=r;if(s.length===0)return null;let p;if(n[0]!==u||n[1]!==s){let v;n[3]!==u?(v=g=>f.jsxs("div",{className:`${ro.toast} ${ro[g.type]}`,onClick:()=>u(g.id),children:[f.jsxs("span",{className:ro.toastIcon,children:[g.type==="success"&&"✅",g.type==="error"&&"❌",g.type==="info"&&"ℹ️"]}),f.jsx("span",{className:ro.toastMessage,children:g.message})]},g.id),n[3]=u,n[4]=v):v=n[4],p=s.map(v),n[0]=u,n[1]=s,n[2]=p}else p=n[2];let h;return n[5]!==p?(h=f.jsx("div",{className:ro.toastContainer,children:p}),n[5]=p,n[6]=h):h=n[6],h},W1="_container_9dbh2_3",P1="_trigger_9dbh2_7",F1="_chevron_9dbh2_37",e0="_chevronOpen_9dbh2_43",t0="_dot_9dbh2_49",n0="_dotIdle_9dbh2_56",a0="_dotConnecting_9dbh2_57",l0="_dotConnected_9dbh2_58",o0="_dotPartial_9dbh2_59",i0="_dropdown_9dbh2_65",dn={container:W1,trigger:P1,chevron:F1,chevronOpen:e0,dot:t0,dotIdle:n0,dotConnecting:a0,dotConnected:l0,dotPartial:o0,dropdown:i0};function hc(r){const n=Se.c(23),{label:s,dotStatus:u,children:p}=r,[h,v]=T.useState(!1),g=T.useRef(null);let m,y;n[0]!==h?(m=()=>{if(!h)return;const X=Y=>{g.current&&!g.current.contains(Y.target)&&v(!1)};return document.addEventListener("mousedown",X),()=>document.removeEventListener("mousedown",X)},y=[h],n[0]=h,n[1]=m,n[2]=y):(m=n[1],y=n[2]),T.useEffect(m,y);let w;n[3]===Symbol.for("react.memo_cache_sentinel")?(w=X=>{var Y,B;X.key==="Escape"&&(v(!1),(B=(Y=g.current)==null?void 0:Y.querySelector("button[aria-haspopup]"))==null||B.focus())},n[3]=w):w=n[3];const b=w,S=u==="connected"?dn.dotConnected:u==="connecting"?dn.dotConnecting:u==="partial"?dn.dotPartial:u==="idle"?dn.dotIdle:void 0;let N;n[4]===Symbol.for("react.memo_cache_sentinel")?(N=()=>v(s0),n[4]=N):N=n[4];let E;n[5]!==S||n[6]!==u?(E=u!==void 0&&f.jsx("span",{className:`${dn.dot} ${S??""}`,"aria-hidden":"true"}),n[5]=S,n[6]=u,n[7]=E):E=n[7];let C;n[8]!==s?(C=f.jsx("span",{children:s}),n[8]=s,n[9]=C):C=n[9];const _=`${dn.chevron} ${h?dn.chevronOpen:""}`;let j;n[10]!==_?(j=f.jsx("span",{className:_,"aria-hidden":"true",children:"▾"}),n[10]=_,n[11]=j):j=n[11];let k;n[12]!==h||n[13]!==E||n[14]!==C||n[15]!==j?(k=f.jsxs("button",{className:dn.trigger,onClick:N,"aria-haspopup":"true","aria-expanded":h,children:[E,C,j]}),n[12]=h,n[13]=E,n[14]=C,n[15]=j,n[16]=k):k=n[16];let H;n[17]!==p||n[18]!==h?(H=h&&f.jsx("div",{className:dn.dropdown,role:"menu",children:p}),n[17]=p,n[18]=h,n[19]=H):H=n[19];let L;return n[20]!==H||n[21]!==k?(L=f.jsxs("div",{className:dn.container,ref:g,onKeyDown:b,children:[k,H]}),n[20]=H,n[21]=k,n[22]=L):L=n[22],L}function s0(r){return!r}const r0="_nav_1hfby_3",c0="_menuList_1hfby_11",u0="_menuItem_1hfby_19",d0="_toolRow_1hfby_56",p0="_toolLink_1hfby_67",h0="_toolLinkActive_1hfby_92",f0="_toolDot_1hfby_99",m0="_toolDotIdle_1hfby_106",g0="_toolDotConnecting_1hfby_107",y0="_toolDotConnected_1hfby_108",v0="_connectAllRow_1hfby_112",b0="_connectAllBtn_1hfby_118",_0="_connectAllBtnStop_1hfby_142",x0="_toolConnectBtn_1hfby_154",S0="_toolConnectBtnStop_1hfby_180",w0="_externalIcon_1hfby_192",ft={nav:r0,menuList:c0,menuItem:u0,toolRow:d0,toolLink:p0,toolLinkActive:h0,toolDot:f0,toolDotIdle:m0,toolDotConnecting:g0,toolDotConnected:y0,connectAllRow:v0,connectAllBtn:b0,connectAllBtnStop:_0,toolConnectBtn:x0,toolConnectBtnStop:S0,externalIcon:w0};function T0(r){return r.every(n=>n==="connected")?"connected":r.every(n=>n==="idle")?"idle":r.some(n=>n==="connecting")?"connecting":"partial"}function E0(r){return r==="connected"?"connected":r==="connecting"?"connecting":"idle"}const A0=[{href:"/info",label:"Info"},{href:"/info/lib",label:"Libraries"},{href:"/info/routes",label:"Services"},{href:"/health",label:"Health"},{href:"/env",label:"Environment"},{href:"http://localhost:8085/api/ws/json",label:"Legacy JSON"},{href:"http://localhost:8085/api/ws/graph",label:"Legacy Graph"}];function N0(r){const n=Se.c(27),{addToast:s}=r,u=Sc();let p,h,v;if(n[0]!==u){const Y=On.map(B=>u.getSlot(B.wsPath).phase);v=T0(Y),p=Y.every(D0),h=Y.some(M0),n[0]=u,n[1]=p,n[2]=h,n[3]=v}else p=n[1],h=n[2],v=n[3];const g=h;let m;n[4]!==s||n[5]!==u?(m=function(){On.forEach(B=>{u.getSlot(B.wsPath).phase==="idle"&&u.connect(B.wsPath,s)})},n[4]=s,n[5]=u,n[6]=m):m=n[6];const y=m;let w;n[7]!==u?(w=function(){On.forEach(B=>{const{phase:I}=u.getSlot(B.wsPath);(I==="connected"||I==="connecting")&&u.disconnect(B.wsPath)})},n[7]=u,n[8]=w):w=n[8];const b=w,S=`${ft.connectAllBtn} ${p?ft.connectAllBtnStop:""}`,N=p?b:y,E=g?"Connecting…":p?"Disconnect all WebSockets":"Connect all WebSockets",C=g?"Connecting…":p?"Disconnect All":"Connect All";let _;n[9]!==g||n[10]!==S||n[11]!==N||n[12]!==E||n[13]!==C?(_=f.jsx("div",{className:ft.connectAllRow,children:f.jsx("button",{className:S,onClick:N,disabled:g,"aria-label":E,children:C})}),n[9]=g,n[10]=S,n[11]=N,n[12]=E,n[13]=C,n[14]=_):_=n[14];let j;n[15]!==s||n[16]!==u?(j=On.map(Y=>{const{phase:B}=u.getSlot(Y.wsPath),I=E0(B),V=B==="connected",K=B==="connecting",$=I==="connected"?ft.toolDotConnected:I==="connecting"?ft.toolDotConnecting:ft.toolDotIdle;return f.jsxs("li",{role:"none",className:ft.toolRow,children:[f.jsxs(Og,{to:Y.path,role:"menuitem",className:j0,children:[f.jsx("span",{className:`${ft.toolDot} ${$}`,"aria-hidden":"true"}),f.jsx("span",{className:ft.toolLabel,children:Y.label})]}),f.jsx("button",{className:`${ft.toolConnectBtn} ${V?ft.toolConnectBtnStop:""}`,onClick:()=>V||K?u.disconnect(Y.wsPath):u.connect(Y.wsPath,s),disabled:K,"aria-label":K?"Connecting…":V?`Disconnect ${Y.label}`:`Connect ${Y.label}`,title:K?"Connecting…":tf(Y.wsPath),children:K?"…":V?"Stop":"Start"})]},Y.path)}),n[15]=s,n[16]=u,n[17]=j):j=n[17];let k;n[18]!==j?(k=f.jsx("ul",{className:ft.menuList,role:"none",children:j}),n[18]=j,n[19]=k):k=n[19];let H;n[20]!==k||n[21]!==_||n[22]!==v?(H=f.jsxs(hc,{label:"Tools",dotStatus:v,children:[_,k]}),n[20]=k,n[21]=_,n[22]=v,n[23]=H):H=n[23];let L;n[24]===Symbol.for("react.memo_cache_sentinel")?(L=f.jsx(hc,{label:"Quick Links",children:f.jsx("ul",{className:ft.menuList,role:"none",children:A0.map(C0)})}),n[24]=L):L=n[24];let X;return n[25]!==H?(X=f.jsxs("nav",{className:ft.nav,"aria-label":"Main navigation",children:[H,L]}),n[25]=H,n[26]=X):X=n[26],X}function C0(r){return f.jsx("li",{role:"none",children:f.jsxs("a",{href:r.href,role:"menuitem",className:ft.menuItem,target:"_blank",rel:"noopener noreferrer",children:[r.label,f.jsx("span",{className:ft.externalIcon,"aria-hidden":"true",children:"↗"})]})},r.href)}function j0(r){const{isActive:n}=r;return`${ft.toolLink} ${n?ft.toolLinkActive:""}`}function M0(r){return r==="connecting"}function D0(r){return r==="connected"}const O0="_saveBtn_1xd2l_3",k0="_saveForm_1xd2l_33",R0="_saveInput_1xd2l_39",z0="_saveInputWarn_1xd2l_55",B0="_saveWarnLabel_1xd2l_59",H0="_saveActionBtn_1xd2l_65",Ca={saveBtn:O0,saveForm:k0,saveInput:R0,saveInputWarn:z0,saveWarnLabel:B0,saveActionBtn:H0};function G0(r){const n=Se.c(33),{disabled:s,defaultName:u,onSave:p,nameExists:h,connected:v}=r,g=v===void 0?!1:v,[m,y]=T.useState(!1),[w,b]=T.useState(""),S=T.useRef(null);let N;n[0]!==u?(N=()=>{b(u),y(!0)},n[0]=u,n[1]=N):N=n[1];const E=N;let C;n[2]===Symbol.for("react.memo_cache_sentinel")?(C=()=>{y(!1),b("")},n[2]=C):C=n[2];const _=C;let j;n[3]!==p||n[4]!==w?(j=()=>{const K=w.trim();K&&(p(K),y(!1),b(""))},n[3]=p,n[4]=w,n[5]=j):j=n[5];const k=j;let H;n[6]!==k?(H=K=>{K.key==="Enter"&&(K.preventDefault(),k()),K.key==="Escape"&&(K.preventDefault(),_())},n[6]=k,n[7]=H):H=n[7];const L=H;let X,Y;if(n[8]!==m?(X=()=>{var K;m&&((K=S.current)==null||K.focus())},Y=[m],n[8]=m,n[9]=X,n[10]=Y):(X=n[9],Y=n[10]),T.useEffect(X,Y),m){const K=`${Ca.saveInput}${h!=null&&h(w.trim())?` ${Ca.saveInputWarn}`:""}`;let $;n[11]===Symbol.for("react.memo_cache_sentinel")?($=P=>b(P.target.value),n[11]=$):$=n[11];let te;n[12]!==L||n[13]!==w||n[14]!==K?(te=f.jsx("input",{ref:S,className:K,type:"text",value:w,onChange:$,onKeyDown:L,placeholder:"Enter a name…","aria-label":"Graph save name",maxLength:80}),n[12]=L,n[13]=w,n[14]=K,n[15]=te):te=n[15];let ue;n[16]!==h||n[17]!==w?(ue=(h==null?void 0:h(w.trim()))&&f.jsx("span",{className:Ca.saveWarnLabel,role:"status",children:"Overwrite?"}),n[16]=h,n[17]=w,n[18]=ue):ue=n[18];let he;n[19]!==w?(he=w.trim(),n[19]=w,n[20]=he):he=n[20];const re=!he;let D;n[21]!==k||n[22]!==re?(D=f.jsx("button",{className:Ca.saveActionBtn,onClick:k,disabled:re,"aria-label":"Confirm save",children:"✅"}),n[21]=k,n[22]=re,n[23]=D):D=n[23];let O;n[24]===Symbol.for("react.memo_cache_sentinel")?(O=f.jsx("button",{className:Ca.saveActionBtn,onClick:_,"aria-label":"Cancel save",children:"❌"}),n[24]=O):O=n[24];let Q;return n[25]!==te||n[26]!==ue||n[27]!==D?(Q=f.jsxs("div",{className:Ca.saveForm,children:[te,ue,D,O]}),n[25]=te,n[26]=ue,n[27]=D,n[28]=Q):Q=n[28],Q}const B=s||!g,I=s?"No graph loaded":g?"Export graph snapshot to server and save bookmark":"Connect first to save";let V;return n[29]!==E||n[30]!==B||n[31]!==I?(V=f.jsx("button",{className:Ca.saveBtn,onClick:E,disabled:B,title:I,"aria-label":"Save graph snapshot",children:"💾 Save Graph"}),n[29]=E,n[30]=B,n[31]=I,n[32]=V):V=n[32],V}const U0="_empty_tpeii_3",L0="_hint_tpeii_12",Y0="_list_tpeii_21",q0="_row_tpeii_31",X0="_rowInfo_tpeii_50",J0="_rowName_tpeii_58",I0="_rowMeta_tpeii_67",Z0="_rowActions_tpeii_78",Q0="_loadBtn_tpeii_84",V0="_deleteBtn_tpeii_85",pn={empty:U0,hint:L0,list:Y0,row:q0,rowInfo:X0,rowName:J0,rowMeta:I0,rowActions:Z0,loadBtn:Q0,deleteBtn:V0};function K0(r){const n=Se.c(8),{savedGraphs:s,onLoad:u,onDelete:p,connected:h}=r,v=s.length>0?`Load Graph (${s.length})`:"Load Graph";let g;n[0]!==h||n[1]!==p||n[2]!==u||n[3]!==s?(g=s.length===0?f.jsx("p",{className:pn.empty,children:"No saved graphs yet."}):f.jsxs(f.Fragment,{children:[!h&&f.jsx("p",{className:pn.hint,children:"Connect to load a graph"}),f.jsx("ul",{className:pn.list,role:"list",children:s.map(y=>f.jsxs("li",{className:pn.row,children:[f.jsxs("div",{className:pn.rowInfo,children:[f.jsx("span",{className:pn.rowName,title:y.name,children:y.name}),f.jsx("span",{className:pn.rowMeta,children:new Date(y.savedAt).toLocaleString()})]}),f.jsxs("div",{className:pn.rowActions,children:[f.jsx("button",{className:pn.loadBtn,onClick:()=>u(y.name),disabled:!h,title:h?`Run: import graph from ${y.name}`:"Connect to the playground first","aria-label":`Load graph ${y.name}`,children:"Load"}),f.jsx("button",{className:pn.deleteBtn,onClick:()=>p(y.name),title:`Remove "${y.name}" from local storage`,"aria-label":`Delete saved graph ${y.name}`,children:"Delete"})]})]},y.name))})]}),n[0]=h,n[1]=p,n[2]=u,n[3]=s,n[4]=g):g=n[4];let m;return n[5]!==v||n[6]!==g?(m=f.jsx(hc,{label:v,children:g}),n[5]=v,n[6]=g,n[7]=m):m=n[7],m}const $0="_payloadRoot_6u47x_2",W0="_labelRow_6u47x_10",P0="_label_6u47x_10",F0="_payloadControls_6u47x_26",ev="_charCounter_6u47x_32",tv="_typeIndicator_6u47x_38",nv="_validationIcon_6u47x_49",av="_formatButton_6u47x_53",lv="_uploadButton_6u47x_67",ov="_textarea_6u47x_82",iv="_textareaError_6u47x_107",sv="_errorMessage_6u47x_109",rv="_sampleButtonsRow_6u47x_117",cv="_sampleButtons_6u47x_117",uv="_sampleLabel_6u47x_130",dv="_sampleGroup_6u47x_136",pv="_sampleGroupLabel_6u47x_143",hv="_sampleButton_6u47x_117",at={payloadRoot:$0,labelRow:W0,label:P0,payloadControls:F0,charCounter:ev,typeIndicator:tv,validationIcon:nv,formatButton:av,uploadButton:lv,textarea:ov,textareaError:iv,errorMessage:sv,sampleButtonsRow:rv,sampleButtons:cv,sampleLabel:uv,sampleGroup:dv,sampleGroupLabel:pv,sampleButton:hv};function fv(r){const n=Se.c(21),{onLoad:s}=r;let u,p,h,v,g,m;if(n[0]!==s){const b=Object.keys(Mi).filter(yv),S=Object.keys(Mi).filter(gv),N=mv;v=at.sampleButtons,n[7]===Symbol.for("react.memo_cache_sentinel")?(g=f.jsx("span",{className:at.sampleLabel,children:"Quick load:"}),n[7]=g):g=n[7];let E;n[8]===Symbol.for("react.memo_cache_sentinel")?(E=f.jsx("span",{className:at.sampleGroupLabel,children:"JSON:"}),n[8]=E):E=n[8];const C=b.map(_=>f.jsx("button",{className:at.sampleButton,onClick:()=>s(Mi[_]),children:N(_)},_));n[9]!==C?(m=f.jsxs("div",{className:at.sampleGroup,children:[E,C]}),n[9]=C,n[10]=m):m=n[10],u=at.sampleGroup,n[11]===Symbol.for("react.memo_cache_sentinel")?(p=f.jsx("span",{className:at.sampleGroupLabel,children:"XML:"}),n[11]=p):p=n[11],h=S.map(_=>f.jsx("button",{className:at.sampleButton,onClick:()=>s(Mi[_]),children:N(_)},_)),n[0]=s,n[1]=u,n[2]=p,n[3]=h,n[4]=v,n[5]=g,n[6]=m}else u=n[1],p=n[2],h=n[3],v=n[4],g=n[5],m=n[6];let y;n[12]!==u||n[13]!==p||n[14]!==h?(y=f.jsxs("div",{className:u,children:[p,h]}),n[12]=u,n[13]=p,n[14]=h,n[15]=y):y=n[15];let w;return n[16]!==v||n[17]!==g||n[18]!==m||n[19]!==y?(w=f.jsxs("div",{className:v,children:[g,m,y]}),n[16]=v,n[17]=g,n[18]=m,n[19]=y,n[20]=w):w=n[20],w}function mv(r){return r.replace(/^(json|xml)_/,"").replace(/_/g," ")}function gv(r){return r.startsWith("xml_")}function yv(r){return r.startsWith("json_")}function vv(r){const n=Se.c(40),{payload:s,onChange:u,validation:p,onFormat:h,onUpload:v}=r;let g;n[0]===Symbol.for("react.memo_cache_sentinel")?(g=f.jsx("label",{htmlFor:"payload",className:at.label,children:"JSON/XML Payload"}),n[0]=g):g=n[0];let m;n[1]!==s.length?(m=f.jsxs("span",{className:at.charCounter,children:["size: ",s.length]}),n[1]=s.length,n[2]=m):m=n[2];let y;n[3]!==s||n[4]!==p.type?(y=s&&p.type&&f.jsx("span",{className:at.typeIndicator,children:p.type.toUpperCase()}),n[3]=s,n[4]=p.type,n[5]=y):y=n[5];let w;n[6]!==s||n[7]!==p.valid?(w=s&&f.jsx("span",{className:at.validationIcon,children:p.valid?"✅":"❌"}),n[6]=s,n[7]=p.valid,n[8]=w):w=n[8];const b=!s||p.type!=="json",S=p.type==="xml"?"Format only available for JSON":"Format JSON";let N;n[9]!==h||n[10]!==b||n[11]!==S?(N=f.jsx("button",{className:at.formatButton,onClick:h,disabled:b,title:S,children:"Format"}),n[9]=h,n[10]=b,n[11]=S,n[12]=N):N=n[12];let E;n[13]!==v||n[14]!==s||n[15]!==p.type||n[16]!==p.valid?(E=v!==void 0&&f.jsx("button",{className:at.uploadButton,onClick:v,disabled:!s||!p.valid||p.type!=="json",title:"Upload JSON payload to current session via REST",children:"Upload"}),n[13]=v,n[14]=s,n[15]=p.type,n[16]=p.valid,n[17]=E):E=n[17];let C;n[18]!==m||n[19]!==y||n[20]!==w||n[21]!==N||n[22]!==E?(C=f.jsxs("div",{className:at.labelRow,children:[g,f.jsxs("div",{className:at.payloadControls,children:[m,y,w,N,E]})]}),n[18]=m,n[19]=y,n[20]=w,n[21]=N,n[22]=E,n[23]=C):C=n[23];const _=`${at.textarea} ${p.valid?"":at.textareaError}`;let j;n[24]!==u?(j=Y=>u(Y.target.value),n[24]=u,n[25]=j):j=n[25];let k;n[26]!==s||n[27]!==_||n[28]!==j?(k=f.jsx("textarea",{id:"payload",className:_,placeholder:"Paste your JSON/XML payload here",value:s,onChange:j}),n[26]=s,n[27]=_,n[28]=j,n[29]=k):k=n[29];let H;n[30]!==p.error||n[31]!==p.valid?(H=!p.valid&&f.jsx("div",{className:at.errorMessage,children:p.error}),n[30]=p.error,n[31]=p.valid,n[32]=H):H=n[32];let L;n[33]!==u?(L=f.jsx("div",{className:at.sampleButtonsRow,children:f.jsx(fv,{onLoad:u})}),n[33]=u,n[34]=L):L=n[34];let X;return n[35]!==k||n[36]!==H||n[37]!==L||n[38]!==C?(X=f.jsxs("div",{className:at.payloadRoot,children:[C,k,H,L]}),n[35]=k,n[36]=H,n[37]=L,n[38]=C,n[39]=X):X=n[39],X}const bv="_content_138ap_8",_v="_header_138ap_22",xv="_icon_138ap_42",Sv="_alias_138ap_47",wv="_badge_138ap_53",Tv="_body_138ap_65",Ev="_row_138ap_70",Av="_label_138ap_83",Nv="_value_138ap_89",Cv="_edgeHandle_138ap_103",ln={content:bv,header:_v,icon:xv,alias:Sv,badge:wv,body:Tv,row:Ev,label:Av,value:Nv,edgeHandle:Cv},jv={Root:{icon:"🚀",label:"Root"},End:{icon:"🏁",label:"End"},Fetcher:{icon:"🌐",label:"Fetcher"},mapper:{icon:"🗺️",label:"Mapper"},Math:{icon:"🔢",label:"Math"},JavaScript:{icon:"📜",label:"JavaScript"},Provider:{icon:"🔌",label:"Provider"},Dictionary:{icon:"📖",label:"Dictionary"},Join:{icon:"🔀",label:"Join"},Extension:{icon:"🧩",label:"Extension"},Island:{icon:"🏝️",label:"Island"},Decision:{icon:"❓",label:"Decision"}};function Mv(r){return jv[r]??{icon:"📦",label:r}}function Oh(r){const n=Se.c(7),{label:s,value:u}=r;let p;n[0]!==s?(p=f.jsx("span",{className:ln.label,children:s}),n[0]=s,n[1]=p):p=n[1];let h;n[2]!==u?(h=f.jsx("span",{className:ln.value,title:u,children:u}),n[2]=u,n[3]=h):h=n[3];let v;return n[4]!==p||n[5]!==h?(v=f.jsxs("div",{className:ln.row,children:[p,h]}),n[4]=p,n[5]=h,n[6]=v):v=n[6],v}function Dv(r){const n=Se.c(3),{properties:s}=r;let u,p;if(n[0]!==s){p=Symbol.for("react.early_return_sentinel");e:{const h=Object.entries(s).filter(kv);if(h.length===0){p=null;break e}u=f.jsx(f.Fragment,{children:h.map(Ov)})}n[0]=s,n[1]=u,n[2]=p}else u=n[1],p=n[2];return p!==Symbol.for("react.early_return_sentinel")?p:u}function Ov(r){const[n,s]=r;if(Array.isArray(s))return s.map((p,h)=>{const v=typeof p=="string"?p:JSON.stringify(p);return f.jsx(Oh,{label:h===0?n:"",value:v},`${n}-${h}`)});const u=typeof s=="string"?s:JSON.stringify(s);return f.jsx(Oh,{label:n,value:u},n)}function kv(r){const[,n]=r;return n!=null}function Yt(r){const n=Se.c(35),{data:s,isConnectable:u,selected:p}=r;let h;n[0]!==s.nodeType?(h=Mv(s.nodeType),n[0]=s.nodeType,n[1]=h):h=n[1];const v=h;let g;n[2]!==s.minHeight||n[3]!==p?(g=f.jsx(Hg,{minWidth:180,minHeight:s.minHeight,isVisible:p}),n[2]=s.minHeight,n[3]=p,n[4]=g):g=n[4];let m;if(n[5]!==s.targetHandles||n[6]!==u){let j;n[8]!==u?(j=k=>{const{id:H,offset:L}=k;return f.jsx(xh,{id:H,type:"target",position:Sh.Left,isConnectable:u,className:ln.edgeHandle,style:{top:`calc(50% + ${L}px)`}},H)},n[8]=u,n[9]=j):j=n[9],m=s.targetHandles.map(j),n[5]=s.targetHandles,n[6]=u,n[7]=m}else m=n[7];let y;n[10]!==v.icon?(y=f.jsx("span",{className:ln.icon,children:v.icon}),n[10]=v.icon,n[11]=y):y=n[11];let w;n[12]!==s.alias?(w=f.jsx("span",{className:ln.alias,children:s.alias}),n[12]=s.alias,n[13]=w):w=n[13];let b;n[14]!==v.label?(b=f.jsx("span",{className:ln.badge,children:v.label}),n[14]=v.label,n[15]=b):b=n[15];let S;n[16]!==y||n[17]!==w||n[18]!==b?(S=f.jsxs("div",{className:ln.header,children:[y,w,b]}),n[16]=y,n[17]=w,n[18]=b,n[19]=S):S=n[19];let N;n[20]!==s.properties?(N=f.jsx("div",{className:ln.body,children:f.jsx(Dv,{properties:s.properties})}),n[20]=s.properties,n[21]=N):N=n[21];let E;n[22]!==S||n[23]!==N?(E=f.jsxs("div",{className:ln.content,children:[S,N]}),n[22]=S,n[23]=N,n[24]=E):E=n[24];let C;if(n[25]!==s.sourceHandles||n[26]!==u){let j;n[28]!==u?(j=k=>{const{id:H,offset:L}=k;return f.jsx(xh,{id:H,type:"source",position:Sh.Right,isConnectable:u,className:ln.edgeHandle,style:{top:`calc(50% + ${L}px)`}},H)},n[28]=u,n[29]=j):j=n[29],C=s.sourceHandles.map(j),n[25]=s.sourceHandles,n[26]=u,n[27]=C}else C=n[27];let _;return n[30]!==C||n[31]!==g||n[32]!==m||n[33]!==E?(_=f.jsxs(f.Fragment,{children:[g,m,E,C]}),n[30]=C,n[31]=g,n[32]=m,n[33]=E,n[34]=_):_=n[34],_}const Rv={Root:Yt,End:Yt,Fetcher:Yt,mapper:Yt,Math:Yt,JavaScript:Yt,Provider:Yt,Dictionary:Yt,Join:Yt,Extension:Yt,Island:Yt,Decision:Yt,default:Yt},zv="_graphWrapper_191wx_15",Bv="_empty_191wx_22",Hv="_emptyIcon_191wx_35",Gv="_refreshingOverlay_191wx_69",Uv="_refreshingSpinner_191wx_85",Lv="_contextMenu_191wx_100",Yv="_contextMenuItem_191wx_110",an={graphWrapper:zv,empty:Bv,emptyIcon:Hv,refreshingOverlay:Gv,refreshingSpinner:Uv,contextMenu:Lv,contextMenuItem:Yv};class qv extends T.Component{constructor(){super(...arguments),this.state={caughtError:null}}static getDerivedStateFromError(n){return{caughtError:n instanceof Error?n.message:String(n)}}componentDidCatch(n,s){var p,h;const u=n instanceof Error?n.message:String(n);console.error("[GraphView] Render error:",u,s.componentStack),(h=(p=this.props).onRenderError)==null||h.call(p,`Graph render failed: ${u}`)}render(){return this.state.caughtError?f.jsxs("div",{className:an.empty,children:[f.jsx("span",{className:an.emptyIcon,children:"⚠️"}),f.jsx("span",{children:"Graph could not be rendered."}),f.jsx("span",{children:this.state.caughtError})]}):this.props.children}}const cf=240,ho=100,kh=60,Xv=120,Jv={boxSizing:"border-box",borderRadius:"8px",borderWidth:"1.5px",borderStyle:"solid",background:"var(--bg-secondary, #1e1e2e)",color:"var(--text-primary, #cdd6f4)",fontSize:"0.75rem",boxShadow:"0 2px 8px rgba(0,0,0,0.45)",overflow:"visible",padding:0},Iv={Root:"#15803d",End:"#dc2626",Fetcher:"#2563eb",mapper:"#ea580c",Math:"#a16207",JavaScript:"#7e22ce",Provider:"#be185d",Dictionary:"#0e7490",Join:"#65a30d",Extension:"#4338ca",Island:"#475569",Decision:"#b45309"},Zv="#6c7086",fc="rgba(148, 163, 184, 0.42)",Qv="var(--bg-secondary)",ki=24,Vv=32,Rh=["#0369a1","#15803d","#b45309","#7e22ce","#b91c1c","#0f766e","#c2410c","#a16207"],Kv={fetch:"#0369a1",details:"#0369a1","ext-call":"#0369a1",mapping:"#b45309",compute:"#b45309",calculate:"#b45309",evaluate:"#b45309",fork:"#7e22ce",join:"#7e22ce",one:"#7e22ce",two:"#6d28d9",three:"#5b21b6",more:"#4c1d95",done:"#15803d",complete:"#15803d",finish:"#15803d",positive:"#15803d",negative:"#b91c1c"};function $v(r){let n=0;for(let s=0;s<r.length;s++)n=(n<<5)-n+r.charCodeAt(s),n|=0;return Math.abs(n)}function Wv(r){if(r.length===0)return fc;const n=r[0].trim().toLowerCase(),s=Kv[n];return s||Rh[$v(n)%Rh.length]}function zh(r){return`source-${r}`}function Bh(r){return`target-${r}`}function Pv(r,n){return n<=1?0:n===2?r===0?-ki:ki:(r-(n-1)/2)*ki}function Hh(r,n){return Array.from({length:r},(s,u)=>({id:n(u),offset:Pv(u,r)}))}function Fv(r){return r<=1?ho:Math.max(ho,(r-1)*ki+Vv*2)}function eb(r){const n=Iv[r]??Zv;return{...Jv,borderColor:n,"--node-accent":n}}function tb(r,n,s){var b;const u=new Map,p=new Map;for(const S of r)u.set(S.alias,[]),p.set(S.alias,0);for(const S of n??[])(b=u.get(S.source))==null||b.push(S.target),p.set(S.target,(p.get(S.target)??0)+1);const h=r.filter(S=>p.get(S.alias)===0||S.types.includes("entry_point")).map(S=>S.alias),v=new Map,g=[...h];for(h.forEach(S=>v.set(S,0));g.length>0;){const S=g.shift(),N=v.get(S)??0;for(const E of u.get(S)??[])(!v.has(E)||v.get(E)<=N)&&(v.set(E,N+1),g.push(E))}const m=v.size>0?Math.max(...v.values()):0;for(const S of r)v.has(S.alias)||v.set(S.alias,m+1);const y=new Map;for(const[S,N]of v)y.has(N)||y.set(N,[]),y.get(N).push(S);const w=new Map;for(const[S,N]of y){let C=-(N.reduce((_,j)=>_+(s.get(j)??ho),0)+Math.max(0,N.length-1)*kh)/2;N.forEach(_=>{const j=s.get(_)??ho;w.set(_,{x:S*(cf+Xv),y:C}),C+=j+kh})}return w}function nb(r){const n=r.connections??[],s=new Map,u=new Map;for(const w of n)s.set(w.source,(s.get(w.source)??0)+1),u.set(w.target,(u.get(w.target)??0)+1);const p=new Map(r.nodes.map(w=>[w.alias,Fv(Math.max(s.get(w.alias)??0,u.get(w.alias)??0))])),h=tb(r.nodes,n,p),v=r.nodes.map(w=>{const b=s.get(w.alias)??0,S=u.get(w.alias)??0,N=p.get(w.alias)??ho;return{id:w.alias,type:w.types[0]??"default",position:h.get(w.alias)??{x:0,y:0},width:cf,height:N,style:eb(w.types[0]??"unknown"),data:{alias:w.alias,nodeType:w.types[0]??"unknown",properties:w.properties,sourceHandles:Hh(b,zh),targetHandles:Hh(S,Bh),minHeight:N}}}),g=new Map,m=new Map,y=[];for(const[w,b]of n.entries()){const S=b.relations.map(j=>j.type),N=`${b.source}__${b.target}__${w}`,E=Wv(S),C=g.get(b.source)??0,_=m.get(b.target)??0;g.set(b.source,C+1),m.set(b.target,_+1),y.push({id:N,source:b.source,target:b.target,sourceHandle:zh(C),targetHandle:Bh(_),label:S.join(", "),type:"bezier",markerEnd:{type:Gg.ArrowClosed,width:16,height:16,color:fc},style:{stroke:fc,strokeWidth:2},labelStyle:{fill:E,fontSize:10,fontWeight:700},labelBgStyle:{fill:Qv,fillOpacity:.94,stroke:"rgba(15, 23, 42, 0.16)",strokeWidth:1},labelBgPadding:[5,2],labelBgBorderRadius:6,data:{relationTypes:S}})}return{nodes:v,edges:y}}function ab(r,n){return r.nodes.find(s=>s.alias===n)}function lb(r,n){return(r.connections??[]).filter(s=>s.source!==s.target&&(s.source===n||s.target===n))}const ob="_toolbar_10vsj_2",ib="_label_10vsj_12",sb="_toolbarActions_10vsj_18",rb="_toolbarButton_10vsj_24",Di={toolbar:ob,label:ib,toolbarActions:sb,toolbarButton:rb};function uf(r){const n=Se.c(19),{graphData:s,onCopySuccess:u,onCopyError:p,extraActions:h}=r;let v;n[0]!==s||n[1]!==p||n[2]!==u?(v=()=>{s&&navigator.clipboard.writeText(JSON.stringify(s,null,2)).then(()=>u==null?void 0:u()).catch(()=>p==null?void 0:p())},n[0]=s,n[1]=p,n[2]=u,n[3]=v):v=n[3];const g=v,m=(s==null?void 0:s.nodes.length)??0;let y;n[4]!==(s==null?void 0:s.connections)?(y=(s==null?void 0:s.connections)??[],n[4]=s==null?void 0:s.connections,n[5]=y):y=n[5];const w=y.length,b=m!==1?"s":"",S=w!==1?"s":"";let N;n[6]!==w||n[7]!==m||n[8]!==b||n[9]!==S?(N=f.jsxs("span",{className:Di.label,children:[m," node",b," · ",w," connection",S]}),n[6]=w,n[7]=m,n[8]=b,n[9]=S,n[10]=N):N=n[10];let E;n[11]!==g?(E=f.jsx("button",{className:Di.toolbarButton,onClick:g,title:"Copy raw graph JSON to clipboard","aria-label":"Copy raw graph JSON to clipboard",children:"📑"}),n[11]=g,n[12]=E):E=n[12];let C;n[13]!==h||n[14]!==E?(C=f.jsxs("div",{className:Di.toolbarActions,children:[h,E]}),n[13]=h,n[14]=E,n[15]=C):C=n[15];let _;return n[16]!==N||n[17]!==C?(_=f.jsxs("div",{className:Di.toolbar,children:[N,C]}),n[16]=N,n[17]=C,n[18]=_):_=n[18],_}const Gh=[],Uh=[];function cb(r){const n=Se.c(65),{graphData:s,onCopySuccess:u,onCopyError:p,onRenderError:h,isRefreshing:v,onClipNode:g}=r,m=v===void 0?!1:v,[y,w]=T.useState(null),b=T.useRef(null);let S,N;n[0]!==y?(S=()=>{if(!y)return;const ae=fe=>{b.current&&!b.current.contains(fe.target)&&w(null)},de=fe=>{fe.key==="Escape"&&w(null)};return document.addEventListener("mousedown",ae),document.addEventListener("keydown",de),()=>{document.removeEventListener("mousedown",ae),document.removeEventListener("keydown",de)}},N=[y],n[0]=y,n[1]=S,n[2]=N):(S=n[1],N=n[2]),T.useEffect(S,N);const E=T.useRef(h);let C,_;n[3]!==h?(C=()=>{E.current=h},_=[h],n[3]=h,n[4]=C,n[5]=_):(C=n[4],_=n[5]),T.useEffect(C,_);let j;e:{if(!s){let ae;n[6]===Symbol.for("react.memo_cache_sentinel")?(ae={nodes:Gh,edges:Uh,transformError:null},n[6]=ae):ae=n[6],j=ae;break e}try{let ae;n[7]!==s?(ae=nb(s),n[7]=s,n[8]=ae):ae=n[8];const de=ae;let fe;n[9]!==de?(fe={...de,transformError:null},n[9]=de,n[10]=fe):fe=n[10],j=fe}catch(ae){const de=ae,fe=de instanceof Error?de.message:String(de);let ze;n[11]===Symbol.for("react.memo_cache_sentinel")?(ze={nodes:Gh,edges:Uh,transformError:fe},n[11]=ze):ze=n[11],j=ze}}const{nodes:k,edges:H,transformError:L}=j;let X,Y;n[12]!==L?(X=()=>{var ae;L&&((ae=E.current)==null||ae.call(E,`Graph render failed: ${L}`))},Y=[L],n[12]=L,n[13]=X,n[14]=Y):(X=n[13],Y=n[14]),T.useEffect(X,Y);let B;n[15]!==s?(B=s?JSON.stringify(s.nodes.map(db)):"empty",n[15]=s,n[16]=B):B=n[16];const I=B,[V,K,$]=Ug(k),[te,ue,he]=Lg(H);let re,D;if(n[17]!==H||n[18]!==k||n[19]!==ue||n[20]!==K?(re=()=>{K(k),ue(H)},D=[k,H,K,ue],n[17]=H,n[18]=k,n[19]=ue,n[20]=K,n[21]=re,n[22]=D):(re=n[21],D=n[22]),T.useEffect(re,D),L){let ae,de;n[23]===Symbol.for("react.memo_cache_sentinel")?(ae=f.jsx("span",{className:an.emptyIcon,children:"⚠️"}),de=f.jsx("span",{children:"Graph could not be rendered."}),n[23]=ae,n[24]=de):(ae=n[23],de=n[24]);let fe;return n[25]!==L?(fe=f.jsxs("div",{className:an.empty,children:[ae,de,f.jsx("span",{children:L})]}),n[25]=L,n[26]=fe):fe=n[26],fe}if(!s||s.nodes.length===0){let ae,de;n[27]===Symbol.for("react.memo_cache_sentinel")?(ae=f.jsx("span",{className:an.emptyIcon,children:"🕸️"}),de=f.jsx("span",{children:"No graph data yet."}),n[27]=ae,n[28]=de):(ae=n[27],de=n[28]);let fe;n[29]===Symbol.for("react.memo_cache_sentinel")?(fe=f.jsx("strong",{children:"describe graph"}),n[29]=fe):fe=n[29];let ze;return n[30]===Symbol.for("react.memo_cache_sentinel")?(ze=f.jsxs("div",{className:an.empty,children:[ae,de,f.jsxs("span",{children:["Run ",fe," or ",f.jsx("strong",{children:"export graph"})," in the playground."]})]}),n[30]=ze):ze=n[30],ze}let O;n[31]!==s||n[32]!==p||n[33]!==u?(O=f.jsx(uf,{graphData:s,onCopySuccess:u,onCopyError:p}),n[31]=s,n[32]=p,n[33]=u,n[34]=O):O=n[34];let Q;n[35]===Symbol.for("react.memo_cache_sentinel")?(Q={padding:.25},n[35]=Q):Q=n[35];let P;n[36]===Symbol.for("react.memo_cache_sentinel")?(P={hideAttribution:!1},n[36]=P):P=n[36];let F;n[37]!==g?(F=(ae,de)=>{g&&(ae.preventDefault(),w({x:ae.clientX,y:ae.clientY,nodeAlias:de.data.alias}))},n[37]=g,n[38]=F):F=n[38];let ie,oe,ee;n[39]===Symbol.for("react.memo_cache_sentinel")?(ie=()=>w(null),oe=f.jsx(Yg,{variant:qg.Dots,gap:18,size:1,color:"rgba(255,255,255,0.07)"}),ee=f.jsx(Xg,{showInteractive:!1}),n[39]=ie,n[40]=oe,n[41]=ee):(ie=n[39],oe=n[40],ee=n[41]);let ye;n[42]===Symbol.for("react.memo_cache_sentinel")?(ye=f.jsx(Jg,{nodeColor:ub,maskColor:"rgba(0,0,0,0.3)",style:{background:"#fff"}}),n[42]=ye):ye=n[42];let se;n[43]!==te||n[44]!==V||n[45]!==he||n[46]!==$||n[47]!==F?(se=f.jsxs(Ig,{nodes:V,edges:te,onNodesChange:$,onEdgesChange:he,nodeTypes:Rv,fitView:!0,fitViewOptions:Q,minZoom:.2,maxZoom:2.5,proOptions:P,onNodeContextMenu:F,onPaneClick:ie,children:[oe,ee,ye]}),n[43]=te,n[44]=V,n[45]=he,n[46]=$,n[47]=F,n[48]=se):se=n[48];let ge;n[49]!==m?(ge=m&&f.jsx("div",{className:an.refreshingOverlay,children:f.jsx("div",{className:an.refreshingSpinner,role:"status","aria-label":"Graph refreshing"})}),n[49]=m,n[50]=ge):ge=n[50];let je;n[51]!==y||n[52]!==s||n[53]!==g?(je=y&&g&&s&&f.jsx("div",{ref:b,className:an.contextMenu,style:{position:"fixed",top:y.y,left:y.x},role:"menu",children:f.jsx("button",{role:"menuitem",autoFocus:!0,className:an.contextMenuItem,onClick:()=>{const ae=ab(s,y.nodeAlias);if(ae){const de=lb(s,y.nodeAlias);g(ae,de)}w(null)},children:"Clip to Clipboard"})}),n[51]=y,n[52]=s,n[53]=g,n[54]=je):je=n[54];let He;n[55]!==m||n[56]!==O||n[57]!==se||n[58]!==ge||n[59]!==je?(He=f.jsxs("div",{className:an.graphWrapper,"aria-busy":m,children:[O,se,ge,je]}),n[55]=m,n[56]=O,n[57]=se,n[58]=ge,n[59]=je,n[60]=He):He=n[60];let we;return n[61]!==I||n[62]!==h||n[63]!==He?(we=f.jsx(qv,{onRenderError:h,children:He},I),n[61]=I,n[62]=h,n[63]=He,n[64]=we):we=n[64],we}function ub(r){return{Root:"#15803d",End:"#dc2626",Fetcher:"#2563eb",mapper:"#ea580c",Math:"#a16207",JavaScript:"#7e22ce",Provider:"#be185d",Dictionary:"#0e7490",Join:"#65a30d",Extension:"#4338ca",Island:"#475569",Decision:"#b45309"}[r.type??""]??"#6c7086"}function db(r){return r.alias}const pb="_root_1yhjs_2",hb="_empty_1yhjs_10",fb="_emptyIcon_1yhjs_23",mb="_toolbarButton_1yhjs_29 _toolbarButton_10vsj_24",gb="_scrollBody_1yhjs_34",yb="_jsonContainer_1yhjs_45",vb="_jsonLabel_1yhjs_46",bb="_jsonString_1yhjs_47",_b="_jsonNumber_1yhjs_48",xb="_jsonBoolean_1yhjs_49",Sb="_jsonNull_1yhjs_50",qt={root:pb,empty:hb,emptyIcon:fb,toolbarButton:mb,scrollBody:gb,jsonContainer:yb,jsonLabel:vb,jsonString:bb,jsonNumber:_b,jsonBoolean:xb,jsonNull:Sb},wb=Qg,Tb=Zg,Eb=r=>r<3,Ab={default:Eb,all:wb,none:Tb};function Nb(r){const n=Se.c(22),{graphData:s,onCopySuccess:u,onCopyError:p}=r,[h,v]=T.useState("all");if(!s){let L;return n[0]===Symbol.for("react.memo_cache_sentinel")?(L=f.jsx("div",{className:qt.root,children:f.jsxs("div",{className:qt.empty,children:[f.jsx("span",{className:qt.emptyIcon,children:"🕸️"}),f.jsx("span",{children:"No graph data yet."}),f.jsx("span",{children:"Pin a graph-link message in the Console to load the raw data here."})]})}),n[0]=L):L=n[0],L}let g;n[1]===Symbol.for("react.memo_cache_sentinel")?(g=()=>v("all"),n[1]=g):g=n[1];const m=h==="all";let y;n[2]!==m?(y=f.jsx("button",{className:qt.toolbarButton,onClick:g,title:"Expand all nodes","aria-label":"Expand all JSON nodes","aria-pressed":m,children:"➖"}),n[2]=m,n[3]=y):y=n[3];let w;n[4]===Symbol.for("react.memo_cache_sentinel")?(w=()=>v("none"),n[4]=w):w=n[4];const b=h==="none";let S;n[5]!==b?(S=f.jsx("button",{className:qt.toolbarButton,onClick:w,title:"Collapse all nodes","aria-label":"Collapse all JSON nodes","aria-pressed":b,children:"➕"}),n[5]=b,n[6]=S):S=n[6];let N;n[7]!==y||n[8]!==S?(N=f.jsxs(f.Fragment,{children:[y,S]}),n[7]=y,n[8]=S,n[9]=N):N=n[9];let E;n[10]!==s||n[11]!==p||n[12]!==u||n[13]!==N?(E=f.jsx(uf,{graphData:s,onCopySuccess:u,onCopyError:p,extraActions:N}),n[10]=s,n[11]=p,n[12]=u,n[13]=N,n[14]=E):E=n[14];const C=s,_=Ab[h];let j;n[15]===Symbol.for("react.memo_cache_sentinel")?(j={...uo,container:`${uo.container} ${qt.jsonContainer}`,label:qt.jsonLabel,stringValue:qt.jsonString,numberValue:qt.jsonNumber,booleanValue:qt.jsonBoolean,nullValue:qt.jsonNull},n[15]=j):j=n[15];let k;n[16]!==_||n[17]!==C?(k=f.jsx("div",{className:qt.scrollBody,children:f.jsx(xc,{data:C,shouldExpandNode:_,style:j})}),n[16]=_,n[17]=C,n[18]=k):k=n[18];let H;return n[19]!==k||n[20]!==E?(H=f.jsxs("div",{className:qt.root,children:[E,k]}),n[19]=k,n[20]=E,n[21]=H):H=n[21],H}const Cb="_rightPanel_19vt8_2",jb="_tabStrip_19vt8_10",Mb="_tab_19vt8_10",Db="_tabActive_19vt8_38",Ob="_tabBadge_19vt8_42",kb="_tabBody_19vt8_48",Rb="_tabBodyHidden_19vt8_57",zb="_rightPanelGroup_19vt8_62",Bb="_verticalResizeHandle_19vt8_70",_t={rightPanel:Cb,tabStrip:jb,tab:Mb,tabActive:Db,tabBadge:Ob,tabBody:kb,tabBodyHidden:Rb,rightPanelGroup:zb,verticalResizeHandle:Bb},Lh="help-split-percent",ic="help-split-maximized",Hb=45,Gb=98;function Ub({tabs:r,payload:n,onChange:s,validation:u,onFormat:p,onUpload:h,graphData:v,activeTab:g,onTabChange:m,onGraphRenderError:y,onGraphDataCopySuccess:w,onGraphDataCopyError:b,isGraphRefreshing:S,onClipNode:N,helpPanel:E}){const C=T.useId(),_=`${C}-tab-payload`,j=`${C}-tab-graph`,k=`${C}-tab-graph-data`,H=f.jsxs("div",{className:_t.rightPanel,children:[f.jsxs("div",{className:_t.tabStrip,role:"tablist","aria-label":"Right panel tabs",children:[r.includes("payload")&&f.jsx("button",{role:"tab","aria-selected":g==="payload","aria-controls":_,className:`${_t.tab}${g==="payload"?` ${_t.tabActive}`:""}`,onClick:()=>m("payload"),children:"Payload Editor"}),r.includes("graph")&&f.jsxs("button",{role:"tab","aria-selected":g==="graph","aria-controls":j,className:`${_t.tab}${g==="graph"?` ${_t.tabActive}`:""}`,onClick:()=>m("graph"),children:["Graph",v!==null&&f.jsx("span",{className:_t.tabBadge,"aria-label":"Graph data available",children:"🕸️"})]}),r.includes("graph-data")&&f.jsx("button",{role:"tab","aria-selected":g==="graph-data","aria-controls":k,className:`${_t.tab}${g==="graph-data"?` ${_t.tabActive}`:""}`,onClick:()=>m("graph-data"),children:"Graph Data (Raw)"})]}),r.includes("payload")&&f.jsx("div",{role:"tabpanel",id:_,tabIndex:g==="payload"?0:-1,className:`${_t.tabBody}${g!=="payload"?` ${_t.tabBodyHidden}`:""}`,children:f.jsx(vv,{payload:n,onChange:s,validation:u,onFormat:p,onUpload:h})}),r.includes("graph")&&f.jsx("div",{role:"tabpanel",id:j,tabIndex:g==="graph"?0:-1,className:`${_t.tabBody}${g!=="graph"?` ${_t.tabBodyHidden}`:""}`,children:f.jsx(cb,{graphData:v,onRenderError:y,isRefreshing:S,onCopySuccess:w,onCopyError:b,onClipNode:N})}),r.includes("graph-data")&&f.jsx("div",{role:"tabpanel",id:k,tabIndex:g==="graph-data"?0:-1,className:`${_t.tabBody}${g!=="graph-data"?` ${_t.tabBodyHidden}`:""}`,children:f.jsx(Nb,{graphData:v,onCopySuccess:w,onCopyError:b})})]}),L=T.useRef(Number(sessionStorage.getItem(Lh))||Hb),X=T.useRef(null),Y=T.useRef(null),[B,I]=T.useState(()=>sessionStorage.getItem(ic)==="1"),V=T.useRef(B),K=T.useCallback(O=>{const Q=O["help-split-help"];if(Q===void 0)return;const P=Q>=Gb;P!==V.current&&(V.current=P,I(P),sessionStorage.setItem(ic,P?"1":"0")),P||(L.current=Q,sessionStorage.setItem(Lh,String(Q)))},[]),$=T.useCallback(()=>{var Q,P,F,ie;const O=!V.current;if(V.current=O,I(O),sessionStorage.setItem(ic,O?"1":"0"),O)(Q=Y.current)==null||Q.resize("0%"),(P=X.current)==null||P.resize("100%");else{const oe=L.current;(F=X.current)==null||F.resize(`${oe}%`),(ie=Y.current)==null||ie.resize(`${100-oe}%`)}},[]),te=!!E;if(T.useEffect(()=>{te&&V.current&&requestAnimationFrame(()=>{var O,Q;(O=Y.current)==null||O.resize("0%"),(Q=X.current)==null||Q.resize("100%")})},[te]),!E)return H;const ue=typeof E=="function"?E($,B):E,re=V.current?100:L.current,D=100-re;return f.jsxs(Wh,{orientation:"vertical",className:_t.rightPanelGroup,onLayoutChanged:K,children:[f.jsx(co,{panelRef:Y,defaultSize:`${D}%`,minSize:"0%",children:H}),f.jsx(cc,{className:_t.verticalResizeHandle,"aria-label":"Resize help panel"}),f.jsx(co,{id:"help-split-help",panelRef:X,defaultSize:`${re}%`,minSize:"15%",children:ue})]})}class Lb extends Fh.Component{constructor(){super(...arguments),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(n,s){console.error("[ConsoleErrorBoundary] Failed to render message:",n,s.componentStack)}render(){return this.state.hasError?f.jsx("span",{children:this.props.fallback}):this.props.children}}const Yb=2e3,qb=(r={})=>{const{onSuccess:n,onError:s}=r,[u,p]=T.useState(!1),h=T.useRef(null);return T.useEffect(()=>()=>{h.current!==null&&clearTimeout(h.current)},[]),{copy:T.useCallback(async g=>{if(!navigator.clipboard)return console.warn("useCopyToClipboard: Clipboard API not available in this browser."),s==null||s(),!1;try{return await navigator.clipboard.writeText(g),p(!0),h.current!==null&&clearTimeout(h.current),h.current=setTimeout(()=>{h.current=null,p(!1)},Yb),n==null||n(),!0}catch(m){return console.error("useCopyToClipboard: Failed to write to clipboard.",m),s==null||s(),!1}},[n,s]),copied:u}},Xb="_consoleRoot_1lgp1_2",Jb="_consoleHeader_1lgp1_10",Ib="_consoleTitle_1lgp1_20",Zb="_consoleControls_1lgp1_25",Qb="_controlButton_1lgp1_30",Vb="_console_1lgp1_2",Kb="_emptyConsole_1lgp1_67",$b="_consoleMessage_1lgp1_80",Wb="_consoleMessageActivatable_1lgp1_94",Pb="_consoleMessageGraphLink_1lgp1_104",Fb="_consoleMessageLargePayload_1lgp1_115",e2="_consoleMessageMockUpload_1lgp1_122",t2="_uploadMockButton_1lgp1_131",n2="_copyButton_1lgp1_172",a2="_copyButtonCopied_1lgp1_225",l2="_sendToJsonPathButton_1lgp1_234",o2="_messageIcon_1lgp1_268",i2="_messageContent_1lgp1_272",s2="_messageText_1lgp1_278",r2="_messageTime_1lgp1_283",c2="_jsonViewWrapper_1lgp1_295",u2="_jsonContainer_1lgp1_301",d2="_jsonLabel_1lgp1_302",p2="_jsonString_1lgp1_303",h2="_jsonNumber_1lgp1_304",f2="_jsonBoolean_1lgp1_305",m2="_jsonNull_1lgp1_306",Ye={consoleRoot:Xb,consoleHeader:Jb,consoleTitle:Ib,consoleControls:Zb,controlButton:Qb,console:Vb,emptyConsole:Kb,consoleMessage:$b,consoleMessageActivatable:Wb,consoleMessageGraphLink:Pb,consoleMessageLargePayload:Fb,consoleMessageMockUpload:e2,uploadMockButton:t2,copyButton:n2,copyButtonCopied:a2,sendToJsonPathButton:l2,messageIcon:o2,messageContent:i2,messageText:s2,messageTime:r2,"messageType-error":"_messageType-error_1lgp1_290","messageType-info":"_messageType-info_1lgp1_291","messageType-welcome":"_messageType-welcome_1lgp1_292",jsonViewWrapper:c2,jsonContainer:u2,jsonLabel:d2,jsonString:p2,jsonNumber:h2,jsonBoolean:f2,jsonNull:m2};function g2(r){var sa;const n=Se.c(77),{message:s,msgId:u,classificationMap:p,onGraphLink:h,onCopyMessage:v,onSendToJsonPath:g,onUploadMockData:m,successfulUploadPaths:y}=r;let w,b,S;n[0]!==s?(b=Ey(s),w=Ay(b.type),S=po(b.message),n[0]=s,n[1]=w,n[2]=b,n[3]=S):(w=n[1],b=n[2],S=n[3]);const N=S;let E,C,_,j,k,H;if(n[4]!==p||n[5]!==u||n[6]!==m||n[7]!==y){const be=(u!==void 0?p==null?void 0:p.get(u):void 0)??[];C=be.some(x2),_=be.some(_2),j=be.some(b2),k=((sa=be.find(v2))==null?void 0:sa.uploadPath)??null,E=!!m&&j&&k!==null,H=E&&!!(y!=null&&y.has(k)),n[4]=p,n[5]=u,n[6]=m,n[7]=y,n[8]=E,n[9]=C,n[10]=_,n[11]=j,n[12]=k,n[13]=H}else E=n[8],C=n[9],_=n[10],j=n[11],k=n[12],H=n[13];const L=H,X=!!h&&C&&!j&&!_,Y=!!g&&N.isJSON;let B;n[14]!==v?(B={onSuccess:v},n[14]=v,n[15]=B):B=n[15];const{copy:I,copied:V}=qb(B);let K;n[16]!==I||n[17]!==s?(K=be=>{be.stopPropagation(),I(s)},n[16]=I,n[17]=s,n[18]=K):K=n[18];const $=K;let te;n[19]!==I||n[20]!==s?(te=be=>{(be.key==="Enter"||be.key===" ")&&(be.preventDefault(),be.stopPropagation(),I(s))},n[19]=I,n[20]=s,n[21]=te):te=n[21];const ue=te;let he;n[22]!==N.data||n[23]!==N.isJSON||n[24]!==g?(he=be=>{if(be.stopPropagation(),!g||!N.isJSON)return;const hn=JSON.stringify(N.data,null,2);g(hn)},n[22]=N.data,n[23]=N.isJSON,n[24]=g,n[25]=he):he=n[25];const re=he;let D;n[26]!==k||n[27]!==m?(D=be=>{be.stopPropagation(),!(!m||!k)&&m(k)},n[26]=k,n[27]=m,n[28]=D):D=n[28];const O=D,Q=Ye[`messageType-${b.type}`],P=X?Ye.consoleMessageActivatable:"",F=C?Ye.consoleMessageGraphLink:"",ie=_?Ye.consoleMessageLargePayload:"",oe=j?Ye.consoleMessageMockUpload:"";let ee;n[29]!==F||n[30]!==ie||n[31]!==oe||n[32]!==Q||n[33]!==P?(ee=[Ye.consoleMessage,Q,P,F,ie,oe].filter(Boolean),n[29]=F,n[30]=ie,n[31]=oe,n[32]=Q,n[33]=P,n[34]=ee):ee=n[34];const ye=ee.join(" ");let se;n[35]!==X||n[36]!==h?(se=X?()=>h():void 0,n[35]=X,n[36]=h,n[37]=se):se=n[37];const ge=X?"Click to load graph in Graph View":void 0,je=X?"button":void 0,He=X?0:void 0;let we;n[38]!==X||n[39]!==h?(we=X?be=>{(be.key==="Enter"||be.key===" ")&&(be.preventDefault(),h())}:void 0,n[38]=X,n[39]=h,n[40]=we):we=n[40];const ae=X?"Load graph in Graph View":void 0,de=j?"⬆️":_?"⬇️":C?"🕸️":w;let fe;n[41]!==de?(fe=f.jsx("span",{className:Ye.messageIcon,children:de}),n[41]=de,n[42]=fe):fe=n[42];let ze;n[43]!==N.data||n[44]!==N.isJSON||n[45]!==b.message||n[46]!==L?(ze=f.jsx("div",{className:Ye.messageContent,children:N.isJSON?f.jsx("div",{className:Ye.jsonViewWrapper,children:f.jsx(xc,{data:N.data,shouldExpandNode:y2,style:{...uo,container:`${uo.container} ${Ye.jsonContainer}`,label:Ye.jsonLabel,stringValue:Ye.jsonString,numberValue:Ye.jsonNumber,booleanValue:Ye.jsonBoolean,nullValue:Ye.jsonNull}})}):f.jsxs("span",{className:Ye.messageText,children:[b.message,L&&f.jsx("span",{title:"Upload succeeded",children:" ✅"})]})}),n[43]=N.data,n[44]=N.isJSON,n[45]=b.message,n[46]=L,n[47]=ze):ze=n[47];const W=`${Ye.copyButton} ${V?Ye.copyButtonCopied:""}`,ve=V?"Copied!":"Copy message",Te=V?"Copied to clipboard":"Copy message to clipboard",me=V?"✅":"📄";let Oe;n[48]!==$||n[49]!==ue||n[50]!==W||n[51]!==ve||n[52]!==Te||n[53]!==me?(Oe=f.jsx("button",{className:W,onClick:$,onKeyDown:ue,title:ve,"aria-label":Te,tabIndex:0,children:me}),n[48]=$,n[49]=ue,n[50]=W,n[51]=ve,n[52]=Te,n[53]=me,n[54]=Oe):Oe=n[54];let Ge;n[55]!==Y||n[56]!==re?(Ge=Y&&f.jsx("button",{className:Ye.sendToJsonPathButton,onClick:re,onKeyDown:be=>{(be.key==="Enter"||be.key===" ")&&re(be)},title:"Open in JSON-Path Playground","aria-label":"Open this JSON in the JSON-Path Playground",tabIndex:0,children:"➡️"}),n[55]=Y,n[56]=re,n[57]=Ge):Ge=n[57];let dt;n[58]!==E||n[59]!==O?(dt=E&&f.jsx("button",{className:Ye.uploadMockButton,onClick:O,onKeyDown:be=>{(be.key==="Enter"||be.key===" ")&&O(be)},title:"Re-open upload dialog","aria-label":"Re-open mock data upload dialog",tabIndex:0,children:"⬆️ Upload JSON…"}),n[58]=E,n[59]=O,n[60]=dt):dt=n[60];let Fe;n[61]!==b.time?(Fe=b.time&&f.jsx("span",{className:Ye.messageTime,children:b.time}),n[61]=b.time,n[62]=Fe):Fe=n[62];let ct;return n[63]!==ye||n[64]!==se||n[65]!==ge||n[66]!==je||n[67]!==He||n[68]!==we||n[69]!==ae||n[70]!==fe||n[71]!==ze||n[72]!==Oe||n[73]!==Ge||n[74]!==dt||n[75]!==Fe?(ct=f.jsxs("div",{className:ye,onClick:se,title:ge,role:je,tabIndex:He,onKeyDown:we,"aria-label":ae,children:[fe,ze,Oe,Ge,dt,Fe]}),n[63]=ye,n[64]=se,n[65]=ge,n[66]=je,n[67]=He,n[68]=we,n[69]=ae,n[70]=fe,n[71]=ze,n[72]=Oe,n[73]=Ge,n[74]=dt,n[75]=Fe,n[76]=ct):ct=n[76],ct}function y2(r){return r<1}function v2(r){return r.kind==="upload.invitation"}function b2(r){return r.kind==="upload.invitation"}function _2(r){return r.kind==="payload.large"}function x2(r){return r.kind==="graph.link"}function S2(r){const n=Se.c(32),{messages:s,classificationMap:u,onCopy:p,onClear:h,consoleRef:v,onGraphLinkMessage:g,onCopyMessage:m,onSendToJsonPath:y,onUploadMockData:w,successfulUploadPaths:b}=r;let S;n[0]===Symbol.for("react.memo_cache_sentinel")?(S=f.jsx("span",{className:Ye.consoleTitle,children:"Console Output"}),n[0]=S):S=n[0];let N;n[1]!==p?(N=f.jsx("button",{className:Ye.controlButton,onClick:p,title:"Copy console output","aria-label":"Copy console output to clipboard",children:"📑"}),n[1]=p,n[2]=N):N=n[2];let E;n[3]!==h?(E=f.jsx("button",{className:Ye.controlButton,onClick:h,title:"Clear console","aria-label":"Clear console",children:"🗑️"}),n[3]=h,n[4]=E):E=n[4];let C;n[5]!==N||n[6]!==E?(C=f.jsxs("div",{className:Ye.consoleHeader,children:[S,f.jsxs("div",{className:Ye.consoleControls,children:[N,E]})]}),n[5]=N,n[6]=E,n[7]=C):C=n[7];let _;if(n[8]!==u||n[9]!==s||n[10]!==m||n[11]!==g||n[12]!==y||n[13]!==w||n[14]!==b){let L;n[16]!==u||n[17]!==m||n[18]!==g||n[19]!==y||n[20]!==w||n[21]!==b?(L=X=>f.jsx(Lb,{fallback:X.raw,children:f.jsx(g2,{message:X.raw,msgId:X.id,classificationMap:u,onGraphLink:g?()=>g(X):void 0,onCopyMessage:m,onSendToJsonPath:y,onUploadMockData:w,successfulUploadPaths:b})},X.id),n[16]=u,n[17]=m,n[18]=g,n[19]=y,n[20]=w,n[21]=b,n[22]=L):L=n[22],_=s.map(L),n[8]=u,n[9]=s,n[10]=m,n[11]=g,n[12]=y,n[13]=w,n[14]=b,n[15]=_}else _=n[15];let j;n[23]!==s.length?(j=s.length===0&&f.jsxs("div",{className:Ye.emptyConsole,children:["No messages yet. Use the ",f.jsx("strong",{children:"Start"})," button in the header to connect."]}),n[23]=s.length,n[24]=j):j=n[24];let k;n[25]!==v||n[26]!==_||n[27]!==j?(k=f.jsxs("div",{className:Ye.console,ref:v,role:"log","aria-live":"polite",children:[_,j]}),n[25]=v,n[26]=_,n[27]=j,n[28]=k):k=n[28];let H;return n[29]!==C||n[30]!==k?(H=f.jsxs("div",{className:Ye.consoleRoot,children:[C,k]}),n[29]=C,n[30]=k,n[31]=H):H=n[31],H}const w2="_commandInput_j85f1_2",T2="_labelRow_j85f1_8",E2="_labelGroup_j85f1_16",A2="_label_j85f1_8",N2="_infoWrapper_j85f1_28",C2="_paletteToggle_j85f1_34",j2="_paletteToggleActive_j85f1_66",M2="_popover_j85f1_73",D2="_popoverOpen_j85f1_95",O2="_popoverTitle_j85f1_121",k2="_popoverRow_j85f1_135",R2="_popoverKeyword_j85f1_156",z2="_popoverDesc_j85f1_168",B2="_popoverAlias_j85f1_174",H2="_inputRow_j85f1_181",G2="_inputWrapper_j85f1_187",U2="_textarea_j85f1_197",L2="_sendButton_j85f1_226",Y2="_hint_j85f1_243",q2="_dropup_j85f1_251",X2="_dropupHeader_j85f1_266",J2="_dropupItem_j85f1_282",I2="_dropupItemText_j85f1_305",Z2="_matchHighlight_j85f1_313",Q2="_multilineIndicator_j85f1_319",Ke={commandInput:w2,labelRow:T2,labelGroup:E2,label:A2,infoWrapper:N2,paletteToggle:C2,paletteToggleActive:j2,popover:M2,popoverOpen:D2,popoverTitle:O2,popoverRow:k2,popoverKeyword:R2,popoverDesc:z2,popoverAlias:B2,inputRow:H2,inputWrapper:G2,textarea:U2,sendButton:L2,hint:Y2,dropup:q2,dropupHeader:X2,dropupItem:J2,dropupItemText:I2,matchHighlight:Z2,multilineIndicator:Q2},V2=[{keyword:"help",description:"List all help topics, or get help for a specific command",template:"help"},{keyword:"create",description:"Create a new graph node",template:`create node {name}
with type {type}
with properties
...
{constant} -> input.body.{key}`,multiline:!0},{keyword:"upload mock data",description:"Print the URL to POST a JSON payload as mock input.body",template:"upload mock data"},{keyword:"execute",description:"Execute a single node skill in isolation",template:"execute node {name}"},{keyword:"inspect",description:"Inspect a state-machine variable",template:"inspect {variable_name}"},{keyword:"run",description:"Run the graph instance from root to end",template:"run"}];function K2(r,n){const s=Se.c(22),[u,p]=T.useState(!1),[h,v]=T.useState(-1);let g;if(s[0]!==n||s[1]!==r){e:{const L=n.trimStart();if(L.length===0){let V;s[3]===Symbol.for("react.memo_cache_sentinel")?(V=[],s[3]=V):V=s[3],g=V;break e}const X=L.toLowerCase(),Y=r.filter(V=>V.toLowerCase().startsWith(X)),B=new Set;g=Y.filter(V=>B.has(V)?!1:(B.add(V),!0)).slice(0,xy)}s[0]=n,s[1]=r,s[2]=g}else g=s[2];const m=g;let y;s[4]===Symbol.for("react.memo_cache_sentinel")?(y=()=>{p(!0),v(-1)},s[4]=y):y=s[4];const w=y;let b;s[5]!==m?(b=L=>{const X=m.length;X!==0&&v(Y=>L===1?Y<0?0:(Y+1)%X:Y<=0?X-1:Y-1)},s[5]=m,s[6]=b):b=s[6];const S=b;let N;s[7]!==m?(N=(L,X)=>{L>=0&&L<m.length&&X(m[L]),p(!1),v(-1)},s[7]=m,s[8]=N):N=s[8];const E=N;let C;s[9]!==E||s[10]!==h||s[11]!==u||s[12]!==m?(C=L=>{if(!u||m.length===0)return;const X=h>=0?h:0;E(X,L)},s[9]=E,s[10]=h,s[11]=u,s[12]=m,s[13]=C):C=s[13];const _=C;let j;s[14]===Symbol.for("react.memo_cache_sentinel")?(j=()=>{p(!1),v(-1)},s[14]=j):j=s[14];const k=j;let H;return s[15]!==E||s[16]!==h||s[17]!==u||s[18]!==S||s[19]!==_||s[20]!==m?(H={suggestions:m,isOpen:u,activeIndex:h,onCommandChange:w,navigate:S,accept:E,onTab:_,dismiss:k},s[15]=E,s[16]=h,s[17]=u,s[18]=S,s[19]=_,s[20]=m,s[21]=H):H=s[21],H}const $2=r=>T.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 16 16",fill:"none",width:14,height:14,stroke:"currentColor",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round",...r},T.createElement("polyline",{points:"2,4 6,8 2,12"}),T.createElement("line",{x1:7,y1:12,x2:14,y2:12}));function W2(r){const n=Se.c(70),{command:s,onChange:u,onKeyDown:p,onSend:h,sendDisabled:v,disabled:g,history:m}=r,y=T.useRef(null),w=T.useRef(null),b=T.useRef(null),[S,N]=T.useState(!1);let E,C;n[0]!==S?(E=()=>{if(!S)return;const W=ve=>{w.current&&!w.current.contains(ve.target)&&N(!1)};return document.addEventListener("mousedown",W),()=>document.removeEventListener("mousedown",W)},C=[S],n[0]=S,n[1]=E,n[2]=C):(E=n[1],C=n[2]),T.useEffect(E,C);const _=K2(m,s);let j;n[3]===Symbol.for("react.memo_cache_sentinel")?(j=()=>{const W=y.current;W&&(W.style.height="auto",W.style.height=`${W.scrollHeight}px`)},n[3]=j):j=n[3];let k;n[4]!==s?(k=[s],n[4]=s,n[5]=k):k=n[5],T.useEffect(j,k);const H=g?"Not connected":"Enter command (Enter to send · Shift+Enter for new line)",L=g?"Enter your test message once it is connected":"Enter to send · Shift+Enter for new line · ↑↓ for history";let X;n[6]!==_||n[7]!==u||n[8]!==p||n[9]!==h?(X=W=>{var ve,Te;if(W.key==="Tab"){W.preventDefault(),_.isOpen&&_.suggestions.length>0&&(_.onTab(me=>u(me)),requestAnimationFrame(()=>{const me=y.current;me&&(me.selectionStart=me.selectionEnd=me.value.length)}));return}if(W.key==="Enter"){if(W.shiftKey)return;if(W.preventDefault(),_.isOpen&&_.activeIndex>=0){_.accept(_.activeIndex,me=>u(me)),requestAnimationFrame(()=>{const me=y.current;me&&(me.selectionStart=me.selectionEnd=me.value.length)}),(ve=y.current)==null||ve.focus();return}h(),(Te=y.current)==null||Te.focus();return}if(W.key==="Escape"){if(_.isOpen){_.dismiss(),W.preventDefault();return}return}if(W.key==="ArrowUp"||W.key==="ArrowDown"){if(_.isOpen&&_.suggestions.length>0){W.preventDefault(),_.navigate(W.key==="ArrowDown"?1:-1);return}const me=y.current;if(me){const{selectionStart:Oe,value:Ge}=me,Fe=!Ge.slice(0,Oe).includes(`
`),ct=!Ge.slice(Oe).includes(`
`);if(!(W.key==="ArrowUp"&&Fe||W.key==="ArrowDown"&&ct))return}p(W),requestAnimationFrame(()=>{const Oe=y.current;Oe&&(Oe.selectionStart=Oe.selectionEnd=Oe.value.length)});return}p(W)},n[6]=_,n[7]=u,n[8]=p,n[9]=h,n[10]=X):X=n[10];const Y=X;let B;n[11]===Symbol.for("react.memo_cache_sentinel")?(B=f.jsx("label",{htmlFor:"command",className:Ke.label,children:"Command"}),n[11]=B):B=n[11];const I=`${Ke.paletteToggle}${S?` ${Ke.paletteToggleActive}`:""}`;let V;n[12]===Symbol.for("react.memo_cache_sentinel")?(V=()=>N(e_),n[12]=V):V=n[12];let K;n[13]!==S?(K=W=>{var ve;if(W.key==="ArrowDown"&&S){W.preventDefault();const Te=(ve=b.current)==null?void 0:ve.querySelector('[role="option"]');Te==null||Te.focus()}},n[13]=S,n[14]=K):K=n[14];let $;n[15]===Symbol.for("react.memo_cache_sentinel")?($=f.jsx($2,{"aria-hidden":"true",focusable:"false"}),n[15]=$):$=n[15];let te;n[16]!==S||n[17]!==I||n[18]!==K?(te=f.jsx("button",{type:"button",className:I,"aria-label":"Toggle command palette","aria-expanded":S,"aria-controls":"command-palette",onClick:V,onKeyDown:K,title:"Command palette",children:$}),n[16]=S,n[17]=I,n[18]=K,n[19]=te):te=n[19];const ue=`${Ke.popover}${S?` ${Ke.popoverOpen}`:""}`;let he,re;n[20]===Symbol.for("react.memo_cache_sentinel")?(he=W=>{var ve,Te;if(W.key==="ArrowDown"||W.key==="ArrowUp"){W.preventDefault();const me=(ve=b.current)==null?void 0:ve.querySelectorAll('[role="option"]');if(!me||me.length===0)return;const Oe=Array.from(me).indexOf(document.activeElement);W.key==="ArrowDown"?me[Oe<0?0:(Oe+1)%me.length].focus():me[Oe<=0?me.length-1:Oe-1].focus()}else W.key==="Escape"&&(W.preventDefault(),N(!1),(Te=y.current)==null||Te.focus())},re=f.jsx("p",{className:Ke.popoverTitle,children:"Command palette — click to insert"}),n[20]=he,n[21]=re):(he=n[20],re=n[21]);let D;n[22]!==S||n[23]!==u?(D=V2.map(W=>{const{keyword:ve,alias:Te,description:me,template:Oe}=W;return f.jsxs("div",{className:Ke.popoverRow,role:"option","aria-selected":!1,tabIndex:S?0:-1,onMouseDown:F2,onClick:()=>{var Ge;u(Oe),N(!1),(Ge=y.current)==null||Ge.focus()},onKeyDown:Ge=>{var dt;(Ge.key==="Enter"||Ge.key===" ")&&(Ge.preventDefault(),u(Oe),N(!1),(dt=y.current)==null||dt.focus())},children:[f.jsx("span",{className:Ke.popoverKeyword,children:ve}),f.jsxs("span",{className:Ke.popoverDesc,children:[me,Te&&f.jsxs("span",{className:Ke.popoverAlias,children:[" · alias: ",Te]})]})]},ve)}),n[22]=S,n[23]=u,n[24]=D):D=n[24];let O;n[25]!==ue||n[26]!==D?(O=f.jsxs("div",{id:"command-palette",ref:b,className:ue,role:"listbox","aria-label":"Command palette",onKeyDown:he,children:[re,D]}),n[25]=ue,n[26]=D,n[27]=O):O=n[27];let Q;n[28]!==te||n[29]!==O?(Q=f.jsx("div",{className:Ke.labelRow,children:f.jsxs("div",{className:Ke.labelGroup,children:[B,f.jsxs("span",{ref:w,className:Ke.infoWrapper,children:[te,O]})]})}),n[28]=te,n[29]=O,n[30]=Q):Q=n[30];const P=!(_.isOpen&&_.suggestions.length>0);let F;n[31]===Symbol.for("react.memo_cache_sentinel")?(F=f.jsx("div",{className:Ke.dropupHeader,"aria-hidden":"true",children:"Recent Commands"}),n[31]=F):F=n[31];let ie;n[32]!==_||n[33]!==s||n[34]!==u?(ie=_.isOpen&&_.suggestions.length>0&&_.suggestions.map((W,ve)=>{const Te=W.split(`
`)[0],me=W.includes(`
`),Oe=s.trimStart().split(`
`)[0],Ge=Math.min(Oe.length,Te.length),dt=Te.slice(0,Ge),Fe=Te.slice(Ge);return f.jsxs("div",{id:`history-option-${ve}`,role:"option","aria-selected":ve===_.activeIndex,className:Ke.dropupItem,onMouseDown:P2,onClick:()=>{_.accept(ve,ct=>u(ct)),requestAnimationFrame(()=>{const ct=y.current;ct&&(ct.selectionStart=ct.selectionEnd=ct.value.length)})},children:[f.jsxs("span",{className:Ke.dropupItemText,children:[Ge>0&&f.jsx("strong",{className:Ke.matchHighlight,children:dt}),Fe,me?"…":""]}),me&&f.jsx("span",{className:Ke.multilineIndicator,"aria-label":"multi-line command",children:"↵"})]},W)}),n[32]=_,n[33]=s,n[34]=u,n[35]=ie):ie=n[35];let oe;n[36]!==P||n[37]!==ie?(oe=f.jsxs("div",{id:"history-dropup",role:"listbox","aria-label":"Command history suggestions",className:Ke.dropup,hidden:P,children:[F,ie]}),n[36]=P,n[37]=ie,n[38]=oe):oe=n[38];const ee=_.isOpen&&_.suggestions.length>0,ye=_.isOpen&&_.suggestions.length>0&&_.activeIndex>=0?`history-option-${_.activeIndex}`:void 0;let se;n[39]!==_||n[40]!==u?(se=W=>{u(W.target.value),_.onCommandChange()},n[39]=_,n[40]=u,n[41]=se):se=n[41];let ge;n[42]!==_?(ge=()=>_.dismiss(),n[42]=_,n[43]=ge):ge=n[43];let je;n[44]!==s||n[45]!==g||n[46]!==Y||n[47]!==H||n[48]!==ee||n[49]!==ye||n[50]!==se||n[51]!==ge?(je=f.jsx("textarea",{ref:y,id:"command",role:"combobox","aria-expanded":ee,"aria-haspopup":"listbox","aria-controls":"history-dropup","aria-activedescendant":ye,"aria-autocomplete":"list",className:Ke.textarea,rows:1,placeholder:H,value:s,disabled:g,onChange:se,onKeyDown:Y,onBlur:ge,autoComplete:"off",autoCorrect:"off",spellCheck:!1}),n[44]=s,n[45]=g,n[46]=Y,n[47]=H,n[48]=ee,n[49]=ye,n[50]=se,n[51]=ge,n[52]=je):je=n[52];let He;n[53]!==oe||n[54]!==je?(He=f.jsxs("div",{className:Ke.inputWrapper,children:[oe,je]}),n[53]=oe,n[54]=je,n[55]=He):He=n[55];let we;n[56]!==h?(we=()=>{var W;h(),(W=y.current)==null||W.focus()},n[56]=h,n[57]=we):we=n[57];let ae;n[58]!==v||n[59]!==we?(ae=f.jsx("button",{className:Ke.sendButton,onClick:we,disabled:v,"aria-label":"Send command",children:"Send"}),n[58]=v,n[59]=we,n[60]=ae):ae=n[60];let de;n[61]!==He||n[62]!==ae?(de=f.jsxs("div",{className:Ke.inputRow,children:[He,ae]}),n[61]=He,n[62]=ae,n[63]=de):de=n[63];let fe;n[64]!==L?(fe=f.jsx("p",{className:Ke.hint,children:L}),n[64]=L,n[65]=fe):fe=n[65];let ze;return n[66]!==Q||n[67]!==de||n[68]!==fe?(ze=f.jsxs("div",{className:Ke.commandInput,children:[Q,de,fe]}),n[66]=Q,n[67]=de,n[68]=fe,n[69]=ze):ze=n[69],ze}function P2(r){return r.preventDefault()}function F2(r){return r.preventDefault()}function e_(r){return!r}const t_="_root_1ac49_1",n_={root:t_};function a_(r){const n=Se.c(22),{messages:s,classificationMap:u,onCopy:p,onClear:h,consoleRef:v,onGraphLinkMessage:g,onCopyMessage:m,onSendToJsonPath:y,onUploadMockData:w,successfulUploadPaths:b,command:S,onCommandChange:N,onCommandKeyDown:E,onSend:C,sendDisabled:_,inputDisabled:j,commandHistory:k}=r;let H;n[0]!==u||n[1]!==v||n[2]!==s||n[3]!==h||n[4]!==p||n[5]!==m||n[6]!==g||n[7]!==y||n[8]!==w||n[9]!==b?(H=f.jsx(S2,{messages:s,classificationMap:u,onCopy:p,onClear:h,consoleRef:v,onGraphLinkMessage:g,onCopyMessage:m,onSendToJsonPath:y,onUploadMockData:w,successfulUploadPaths:b}),n[0]=u,n[1]=v,n[2]=s,n[3]=h,n[4]=p,n[5]=m,n[6]=g,n[7]=y,n[8]=w,n[9]=b,n[10]=H):H=n[10];let L;n[11]!==S||n[12]!==k||n[13]!==j||n[14]!==N||n[15]!==E||n[16]!==C||n[17]!==_?(L=f.jsx(W2,{command:S,onChange:N,onKeyDown:E,onSend:C,disabled:j,sendDisabled:_,history:k}),n[11]=S,n[12]=k,n[13]=j,n[14]=N,n[15]=E,n[16]=C,n[17]=_,n[18]=L):L=n[18];let X;return n[19]!==H||n[20]!==L?(X=f.jsxs("div",{className:n_.root,children:[H,L]}),n[19]=H,n[20]=L,n[21]=X):X=n[21],X}const l_="_dialog_g80bk_4",o_="_modalInner_g80bk_26",i_="_modalHeader_g80bk_34",s_="_modalTitleGroup_g80bk_44",r_="_modalTitle_g80bk_44",c_="_modalPath_g80bk_57",u_="_closeButton_g80bk_64",d_="_modalBody_g80bk_95",p_="_dropZone_g80bk_105",h_="_dropZoneActive_g80bk_127",f_="_dropZoneIcon_g80bk_133",m_="_dropZoneText_g80bk_139",g_="_dropZoneOr_g80bk_152",y_="_browseButton_g80bk_159",v_="_fileInputHidden_g80bk_188",b_="_fileError_g80bk_193",__="_textareaLabel_g80bk_198",x_="_textarea_g80bk_198",S_="_validationError_g80bk_226",w_="_keyboardHint_g80bk_231",T_="_errorBanner_g80bk_236",E_="_modalFooter_g80bk_247",A_="_footerActions_g80bk_257",N_="_formatButton_g80bk_263",C_="_cancelButton_g80bk_264",j_="_uploadButton_g80bk_265",M_="_spinner_g80bk_332",Ze={dialog:l_,modalInner:o_,modalHeader:i_,modalTitleGroup:s_,modalTitle:r_,modalPath:c_,closeButton:u_,modalBody:d_,dropZone:p_,dropZoneActive:h_,dropZoneIcon:f_,dropZoneText:m_,dropZoneOr:g_,browseButton:y_,fileInputHidden:v_,fileError:b_,textareaLabel:__,textarea:x_,validationError:S_,keyboardHint:w_,errorBanner:T_,modalFooter:E_,footerActions:A_,formatButton:N_,cancelButton:C_,uploadButton:j_,spinner:M_};function D_(r){const n=Se.c(9),{uploadPath:s,json:u,onSuccess:p,onError:h}=r,[v,g]=T.useState(!1),m=T.useRef(null);let y;n[0]===Symbol.for("react.memo_cache_sentinel")?(y=()=>{var E;(E=m.current)==null||E.abort(),m.current=null,g(!1)},n[0]=y):y=n[0];const w=y;let b;n[1]!==u||n[2]!==h||n[3]!==p||n[4]!==s?(b=async()=>{var C;(C=m.current)==null||C.abort();const E=new AbortController;m.current=E,g(!0);try{const _=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:u,signal:E.signal}),j=await _.text();if(!_.ok){g(!1),h(`HTTP ${_.status} — ${j}`);return}g(!1),p(j)}catch(_){const j=_;if(j.name==="AbortError"){g(!1);return}g(!1),h(j.message??"Network error")}},n[1]=u,n[2]=h,n[3]=p,n[4]=s,n[5]=b):b=n[5];const S=b;let N;return n[6]!==v||n[7]!==S?(N={isUploading:v,upload:S,cancel:w},n[6]=v,n[7]=S,n[8]=N):N=n[8],N}var $h;const O_=((($h=navigator.userAgentData)==null?void 0:$h.platform)??navigator.platform).toLowerCase().includes("mac");function k_(r){return new Promise((n,s)=>{const u=new FileReader;u.onload=()=>n(u.result),u.onerror=()=>s(new Error(`Could not read file "${r.name}"`)),u.readAsText(r,"utf-8")})}function R_(r){const n=r.name.toLowerCase().endsWith(".json"),s=r.type==="application/json"||r.type==="text/plain";return!n&&!s?`"${r.name}" does not appear to be a JSON file. Only .json files are accepted.`:null}function z_({uploadPath:r,onSuccess:n,onClose:s,onError:u}){const[p,h]=T.useState(""),[v,g]=T.useState(null),[m,y]=T.useState(null),[w,b]=T.useState(!1),S=T.useRef(null),N=T.useRef(null),E=T.useRef(null),_=po(p).isJSON,j=_&&p.trim()!=="",{isUploading:k,upload:H,cancel:L}=D_({uploadPath:r,json:p,onSuccess:n,onError:O=>{g(O),u(O)}});T.useEffect(()=>{var Q;const O=S.current;if(O)return O.open||O.showModal(),(Q=N.current)==null||Q.focus(),()=>{O.open&&O.close()}},[]);const X=T.useCallback(()=>{L(),s()},[L,s]),Y=T.useCallback(O=>{O.target===S.current&&X()},[X]),B=T.useCallback(O=>{O.preventDefault(),X()},[X]),I=T.useCallback(()=>{g(null),H()},[H]),V=T.useCallback(O=>{O.key==="Enter"&&(O.ctrlKey||O.metaKey)&&(O.preventDefault(),j&&!k&&I())},[j,k,I]),K=T.useCallback(()=>{_&&h(uc(p))},[_,p]),$=T.useCallback(async O=>{var P;y(null),g(null);const Q=R_(O);if(Q){y(Q);return}try{const F=await k_(O);if(!po(F).isJSON){y(`"${O.name}" contains invalid JSON.`);return}h(uc(F)),(P=N.current)==null||P.focus()}catch(F){y(F.message)}},[]),te=T.useCallback(O=>{O.preventDefault(),O.stopPropagation(),w||b(!0)},[w]),ue=T.useCallback(O=>{O.preventDefault(),O.stopPropagation(),(O.currentTarget===O.target||!O.currentTarget.contains(O.relatedTarget))&&b(!1)},[]),he=T.useCallback(O=>{O.preventDefault(),O.stopPropagation(),b(!1);const Q=O.dataTransfer.files[0];Q&&$(Q)},[$]),re=T.useCallback(O=>{var P;const Q=(P=O.target.files)==null?void 0:P[0];Q&&($(Q),O.target.value="")},[$]),D=!_&&p.trim()!=="";return f.jsx("dialog",{ref:S,className:Ze.dialog,"aria-modal":"true","aria-labelledby":"mock-upload-modal-title",onClick:Y,onCancel:B,children:f.jsxs("div",{className:Ze.modalInner,onClick:O=>O.stopPropagation(),children:[f.jsxs("div",{className:Ze.modalHeader,children:[f.jsxs("div",{className:Ze.modalTitleGroup,children:[f.jsx("span",{id:"mock-upload-modal-title",className:Ze.modalTitle,children:"⬆️ Upload Mock Data"}),f.jsx("span",{className:Ze.modalPath,children:r})]}),f.jsx("button",{className:Ze.closeButton,onClick:X,"aria-label":"Close upload modal",title:"Close",disabled:k,children:"✕"})]}),f.jsxs("div",{className:Ze.modalBody,children:[f.jsxs("div",{className:`${Ze.dropZone} ${w?Ze.dropZoneActive:""}`,onDragOver:te,onDragLeave:ue,onDrop:he,"aria-label":"Drop a JSON file here",children:[f.jsx("span",{className:Ze.dropZoneIcon,children:"📂"}),f.jsxs("span",{className:Ze.dropZoneText,children:["Drop a ",f.jsx("code",{children:".json"})," file here"]}),f.jsx("span",{className:Ze.dropZoneOr,children:"— or —"}),f.jsx("input",{ref:E,type:"file",accept:".json,application/json",className:Ze.fileInputHidden,"aria-hidden":"true",tabIndex:-1,onChange:re}),f.jsx("button",{type:"button",className:Ze.browseButton,onClick:()=>{var O;return(O=E.current)==null?void 0:O.click()},disabled:k,"aria-label":"Browse for a JSON file",children:"Browse file…"})]}),m&&f.jsxs("span",{className:Ze.fileError,role:"alert",children:["⚠️ ",m]}),f.jsx("label",{htmlFor:"mock-upload-textarea",className:Ze.textareaLabel,children:"JSON Payload"}),f.jsx("textarea",{id:"mock-upload-textarea",ref:N,className:Ze.textarea,value:p,onChange:O=>{h(O.target.value),y(null)},onKeyDown:V,placeholder:"Paste JSON here, or drop / browse a .json file above",rows:10,spellCheck:!1,"aria-describedby":D?"mock-upload-validation":void 0}),D&&f.jsx("span",{id:"mock-upload-validation",className:Ze.validationError,role:"status",children:"⚠️ Invalid JSON — check syntax"}),f.jsx("span",{className:Ze.keyboardHint,children:O_?"⌘+Enter to upload":"Ctrl+Enter to upload"}),v&&f.jsxs("div",{className:Ze.errorBanner,role:"alert",children:["❌ Upload failed: ",v]})]}),f.jsxs("div",{className:Ze.modalFooter,children:[f.jsx("button",{className:Ze.formatButton,onClick:K,disabled:!_||k,title:"Format JSON","aria-label":"Format JSON",children:"Format"}),f.jsxs("div",{className:Ze.footerActions,children:[f.jsx("button",{className:Ze.cancelButton,onClick:X,disabled:k,children:"Cancel"}),f.jsx("button",{className:Ze.uploadButton,onClick:I,disabled:!j||k,"aria-busy":k,children:k?f.jsxs(f.Fragment,{children:[f.jsx("span",{className:Ze.spinner,"aria-hidden":"true"})," Uploading…"]}):"Upload ▶"})]})]})]})})}const mc=(r,n)=>n.some(s=>r instanceof s);let Yh,qh;function B_(){return Yh||(Yh=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function H_(){return qh||(qh=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const gc=new WeakMap,sc=new WeakMap,zi=new WeakMap;function G_(r){const n=new Promise((s,u)=>{const p=()=>{r.removeEventListener("success",h),r.removeEventListener("error",v)},h=()=>{s(ia(r.result)),p()},v=()=>{u(r.error),p()};r.addEventListener("success",h),r.addEventListener("error",v)});return zi.set(n,r),n}function U_(r){if(gc.has(r))return;const n=new Promise((s,u)=>{const p=()=>{r.removeEventListener("complete",h),r.removeEventListener("error",v),r.removeEventListener("abort",v)},h=()=>{s(),p()},v=()=>{u(r.error||new DOMException("AbortError","AbortError")),p()};r.addEventListener("complete",h),r.addEventListener("error",v),r.addEventListener("abort",v)});gc.set(r,n)}let yc={get(r,n,s){if(r instanceof IDBTransaction){if(n==="done")return gc.get(r);if(n==="store")return s.objectStoreNames[1]?void 0:s.objectStore(s.objectStoreNames[0])}return ia(r[n])},set(r,n,s){return r[n]=s,!0},has(r,n){return r instanceof IDBTransaction&&(n==="done"||n==="store")?!0:n in r}};function df(r){yc=r(yc)}function L_(r){return H_().includes(r)?function(...n){return r.apply(vc(this),n),ia(this.request)}:function(...n){return ia(r.apply(vc(this),n))}}function Y_(r){return typeof r=="function"?L_(r):(r instanceof IDBTransaction&&U_(r),mc(r,B_())?new Proxy(r,yc):r)}function ia(r){if(r instanceof IDBRequest)return G_(r);if(sc.has(r))return sc.get(r);const n=Y_(r);return n!==r&&(sc.set(r,n),zi.set(n,r)),n}const vc=r=>zi.get(r);function q_(r,n,{blocked:s,upgrade:u,blocking:p,terminated:h}={}){const v=indexedDB.open(r,n),g=ia(v);return u&&v.addEventListener("upgradeneeded",m=>{u(ia(v.result),m.oldVersion,m.newVersion,ia(v.transaction),m)}),s&&v.addEventListener("blocked",m=>s(m.oldVersion,m.newVersion,m)),g.then(m=>{h&&m.addEventListener("close",()=>h()),p&&m.addEventListener("versionchange",y=>p(y.oldVersion,y.newVersion,y))}).catch(()=>{}),g}function X_(r,{blocked:n}={}){const s=indexedDB.deleteDatabase(r);return n&&s.addEventListener("blocked",u=>n(u.oldVersion,u)),ia(s).then(()=>{})}const J_=["get","getKey","getAll","getAllKeys","count"],I_=["put","add","delete","clear"],rc=new Map;function Xh(r,n){if(!(r instanceof IDBDatabase&&!(n in r)&&typeof n=="string"))return;if(rc.get(n))return rc.get(n);const s=n.replace(/FromIndex$/,""),u=n!==s,p=I_.includes(s);if(!(s in(u?IDBIndex:IDBObjectStore).prototype)||!(p||J_.includes(s)))return;const h=async function(v,...g){const m=this.transaction(v,p?"readwrite":"readonly");let y=m.store;return u&&(y=y.index(g.shift())),(await Promise.all([y[s](...g),p&&m.done]))[0]};return rc.set(n,h),h}df(r=>({...r,get:(n,s,u)=>Xh(n,s)||r.get(n,s,u),has:(n,s)=>!!Xh(n,s)||r.has(n,s)}));const Z_=["continue","continuePrimaryKey","advance"],Jh={},bc=new WeakMap,pf=new WeakMap,Q_={get(r,n){if(!Z_.includes(n))return r[n];let s=Jh[n];return s||(s=Jh[n]=function(...u){bc.set(this,pf.get(this)[n](...u))}),s}};async function*V_(...r){let n=this;if(n instanceof IDBCursor||(n=await n.openCursor(...r)),!n)return;n=n;const s=new Proxy(n,Q_);for(pf.set(s,n),zi.set(s,vc(n));n;)yield s,n=await(bc.get(s)||n.continue()),bc.delete(s)}function Ih(r,n){return n===Symbol.asyncIterator&&mc(r,[IDBIndex,IDBObjectStore,IDBCursor])||n==="iterate"&&mc(r,[IDBIndex,IDBObjectStore])}df(r=>({...r,get(n,s,u){return Ih(n,s)?V_:r.get(n,s,u)},has(n,s){return Ih(n,s)||r.has(n,s)}}));const hf="minigraph-clipboard",K_=1,kn="items";let Oi=null;function Zh(){return q_(hf,K_,{upgrade(r){r.objectStoreNames.contains(kn)&&r.deleteObjectStore(kn);const n=r.createObjectStore(kn,{keyPath:"id"});n.createIndex("by-alias","node.alias",{unique:!0}),n.createIndex("by-clippedAt","clippedAt")}})}function ml(){return Oi||(Oi=Zh().catch(async r=>(console.warn("[clipboard/db] openDB failed, deleting and recreating:",r),Oi=null,await X_(hf),Zh()))),Oi}async function $_(){return(await(await ml()).getAllFromIndex(kn,"by-clippedAt")).reverse()}async function Qh(r){return(await ml()).getFromIndex(kn,"by-alias",r)}async function W_(r){await(await ml()).add(kn,r)}async function P_(r,n){const u=(await ml()).transaction(kn,"readwrite");await u.store.delete(r),await u.store.add(n),await u.done}async function F_(r){await(await ml()).delete(kn,r)}async function ex(){await(await ml()).clear(kn)}const tx="minigraph-clipboard-sync";function nx(){return new BroadcastChannel(tx)}function ax(r,n){switch(n.type){case"HYDRATE":return{items:n.items,isLoading:!1};case"ITEM_ADDED":return{...r,items:[n.item,...r.items]};case"ITEM_REPLACED":{const s=r.items.filter(u=>u.id!==n.previousId);return{...r,items:[n.item,...s]}}case"ITEM_REMOVED":return{...r,items:r.items.filter(s=>s.id!==n.id)};case"ITEMS_CLEARED":return{...r,items:[]};default:return r}}const ff=T.createContext(null);function lx({children:r}){const[n,s]=T.useReducer(ax,{items:[],isLoading:!0}),u=T.useRef(null);T.useEffect(()=>{$_().then(y=>s({type:"HYDRATE",items:y}))},[]),T.useEffect(()=>{let y;try{y=nx()}catch{return}return u.current=y,y.onmessage=w=>{const b=w.data;switch(b.type){case"item-added":s({type:"ITEM_ADDED",item:b.item});break;case"item-replaced":s({type:"ITEM_REPLACED",item:b.item,previousId:b.previousId});break;case"item-removed":s({type:"ITEM_REMOVED",id:b.id});break;case"items-cleared":s({type:"ITEMS_CLEARED"});break}},()=>{y.close(),u.current=null}},[]);const p=T.useCallback(y=>{var w;(w=u.current)==null||w.postMessage(y)},[]),h=T.useCallback(async(y,w,b)=>{try{const S={id:crypto.randomUUID(),clippedAt:new Date().toISOString(),sourceWsPath:b.sourceWsPath,sourceLabel:b.sourceLabel,node:y,connections:w},N=await Qh(y.alias);if(N)return{status:"duplicate",existingItem:N,pendingItem:S};try{await W_(S)}catch(E){if(E instanceof DOMException&&E.name==="ConstraintError"){const C=await Qh(y.alias);if(C)return{status:"duplicate",existingItem:C,pendingItem:S}}throw E}return s({type:"ITEM_ADDED",item:S}),p({type:"item-added",item:S}),{status:"added"}}catch(S){return{status:"error",message:S instanceof Error?S.message:String(S)}}},[p]),v=T.useCallback(async(y,w)=>{await P_(w,y),s({type:"ITEM_REPLACED",item:y,previousId:w}),p({type:"item-replaced",item:y,previousId:w})},[p]),g=T.useCallback(async y=>{await F_(y),s({type:"ITEM_REMOVED",id:y}),p({type:"item-removed",id:y})},[p]),m=T.useCallback(async()=>{await ex(),s({type:"ITEMS_CLEARED"}),p({type:"items-cleared"})},[p]);return f.jsx(ff.Provider,{value:{items:n.items,isLoading:n.isLoading,clipNode:h,confirmReplace:v,removeItem:g,clearAll:m},children:r})}function mf(){const r=T.useContext(ff);if(!r)throw new Error("useClipboardContext must be used inside <ClipboardProvider>");return r}function gf(r){const n=Date.now(),s=new Date(r).getTime(),u=n-s;if(u<0)return"just now";const p=Math.floor(u/1e3);if(p<60)return"just now";const h=Math.floor(p/60);if(h<60)return`${h} min ago`;const v=Math.floor(h/60);if(v<24)return`${v} hour${v>1?"s":""} ago`;const g=Math.floor(v/24);return g===1?"yesterday":g<30?`${g} days ago`:new Date(r).toLocaleDateString()}const ox="_card_3lfqf_2",ix="_alias_3lfqf_10",sx="_meta_3lfqf_18",rx="_propsLine_3lfqf_24",cx="_timestamp_3lfqf_32",ux="_actions_3lfqf_39",dx="_pasteBtn_3lfqf_45",px="_inspectBtn_3lfqf_46",hx="_removeBtn_3lfqf_47",Ft={card:ox,alias:ix,meta:sx,propsLine:rx,timestamp:cx,actions:ux,pasteBtn:dx,inspectBtn:px,removeBtn:hx};function fx(r){const n=Se.c(55),{item:s,connected:u,onPaste:p,onRemove:h,onInspect:v}=r,{node:g,connections:m,clippedAt:y,sourceLabel:w}=s,b=g.types[0]??"—",S=g.properties.skill??"—";let N;n[0]!==g.properties?(N=Object.entries(g.properties).filter(gx).map(mx),n[0]=g.properties,n[1]=N):N=n[1];const E=N,C=E.length>0?E.join(", "):"—";let _;if(n[2]!==m||n[3]!==g.alias){let ee;n[5]!==g.alias?(ee=ye=>ye.source===g.alias,n[5]=g.alias,n[6]=ee):ee=n[6],_=m.filter(ee),n[2]=m,n[3]=g.alias,n[4]=_}else _=n[4];const j=_.length;let k;if(n[7]!==m||n[8]!==g.alias){let ee;n[10]!==g.alias?(ee=ye=>ye.target===g.alias,n[10]=g.alias,n[11]=ee):ee=n[11],k=m.filter(ee),n[7]=m,n[8]=g.alias,n[9]=k}else k=n[9];const H=k.length,L=`${m.length} (${j} out, ${H} in)`;let X;n[12]!==g.alias?(X=f.jsx("div",{className:Ft.alias,children:g.alias}),n[12]=g.alias,n[13]=X):X=n[13];let Y;n[14]!==b?(Y=f.jsxs("div",{className:Ft.meta,children:["Type: ",b]}),n[14]=b,n[15]=Y):Y=n[15];let B;n[16]!==S?(B=f.jsxs("div",{className:Ft.meta,children:["Skill: ",S]}),n[16]=S,n[17]=B):B=n[17];let I;n[18]!==C?(I=f.jsxs("span",{className:Ft.propsLine,children:["Props: ",C]}),n[18]=C,n[19]=I):I=n[19];let V;n[20]!==C||n[21]!==I?(V=f.jsx("div",{className:Ft.meta,title:C,children:I}),n[20]=C,n[21]=I,n[22]=V):V=n[22];let K;n[23]!==L?(K=f.jsxs("div",{className:Ft.meta,children:["Connections: ",L]}),n[23]=L,n[24]=K):K=n[24];let $;n[25]!==y?($=gf(y),n[25]=y,n[26]=$):$=n[26];let te;n[27]!==w||n[28]!==$?(te=f.jsxs("div",{className:Ft.timestamp,children:["Clipped ",$," from ",w]}),n[27]=w,n[28]=$,n[29]=te):te=n[29];let ue;n[30]!==s||n[31]!==p?(ue=()=>p(s),n[30]=s,n[31]=p,n[32]=ue):ue=n[32];const he=!u,re=`Paste node ${g.alias}`;let D;n[33]!==ue||n[34]!==he||n[35]!==re?(D=f.jsx("button",{className:Ft.pasteBtn,onClick:ue,disabled:he,"aria-label":re,children:"Paste"}),n[33]=ue,n[34]=he,n[35]=re,n[36]=D):D=n[36];const O=`Inspect node ${g.alias}`;let Q;n[37]!==v||n[38]!==O?(Q=f.jsx("button",{className:Ft.inspectBtn,onClick:v,"aria-label":O,children:"Describe"}),n[37]=v,n[38]=O,n[39]=Q):Q=n[39];const P=`Remove node ${g.alias} from clipboard`;let F;n[40]!==h||n[41]!==P?(F=f.jsx("button",{className:Ft.removeBtn,onClick:h,"aria-label":P,children:"Remove"}),n[40]=h,n[41]=P,n[42]=F):F=n[42];let ie;n[43]!==D||n[44]!==Q||n[45]!==F?(ie=f.jsxs("div",{className:Ft.actions,children:[D,Q,F]}),n[43]=D,n[44]=Q,n[45]=F,n[46]=ie):ie=n[46];let oe;return n[47]!==te||n[48]!==ie||n[49]!==X||n[50]!==Y||n[51]!==B||n[52]!==V||n[53]!==K?(oe=f.jsxs("div",{className:Ft.card,children:[X,Y,B,V,K,te,ie]}),n[47]=te,n[48]=ie,n[49]=X,n[50]=Y,n[51]=B,n[52]=V,n[53]=K,n[54]=oe):oe=n[54],oe}function mx(r){const[n,s]=r,u=typeof s=="string"?s:JSON.stringify(s);return`${n}=${u&&u.length>30?u.slice(0,30)+"…":u}`}function gx(r){const[n]=r;return n!=="skill"}const yx="_sidebar_nf394_2",vx="_header_nf394_12",bx="_headerTitle_nf394_22",_x="_clearBtn_nf394_29",xx="_itemList_nf394_45",Sx="_loading_nf394_55",wx="_emptyState_nf394_65",Tx="_emptyIcon_nf394_78",Ex="_emptyTitle_nf394_83",Ax="_emptyHint_nf394_87",Nx="_inspectPanel_nf394_93",Cx="_inspectHeader_nf394_101",jx="_inspectClose_nf394_115",Mx="_inspectBody_nf394_129",Dx="_dialog_nf394_135",Ox="_dialogTitle_nf394_150",kx="_dialogBody_nf394_157",Rx="_dialogActions_nf394_164",zx="_cancelBtn_nf394_171",Bx="_replaceBtn_nf394_185",lt={sidebar:yx,header:vx,headerTitle:bx,clearBtn:_x,itemList:xx,loading:Sx,emptyState:wx,emptyIcon:Tx,emptyTitle:Ex,emptyHint:Ax,inspectPanel:Nx,inspectHeader:Cx,inspectClose:jx,inspectBody:Mx,dialog:Dx,dialogTitle:Ox,dialogBody:kx,dialogActions:Rx,cancelBtn:zx,replaceBtn:Bx};function Hx(){const r=Se.c(1);let n;return r[0]===Symbol.for("react.memo_cache_sentinel")?(n=f.jsxs("div",{className:lt.emptyState,children:[f.jsx("span",{className:lt.emptyIcon,children:"📋"}),f.jsx("span",{className:lt.emptyTitle,children:"No items clipped yet."}),f.jsx("span",{className:lt.emptyHint,children:"Right-click a node in the Graph view to get started."})]}),r[0]=n):n=r[0],n}function Gx(r){const n=Se.c(18),{connected:s,onPaste:u}=r,p=mf(),[h,v]=T.useState(null);let g;n[0]===Symbol.for("react.memo_cache_sentinel")?(g=f.jsx("span",{className:lt.headerTitle,children:"Clipboard"}),n[0]=g):g=n[0];let m;n[1]!==p?(m=p.items.length>0&&f.jsx("button",{className:lt.clearBtn,onClick:()=>p.clearAll(),"aria-label":"Clear all clipboard items",children:"Clear"}),n[1]=p,n[2]=m):m=n[2];let y;n[3]!==m?(y=f.jsxs("div",{className:lt.header,children:[g,m]}),n[3]=m,n[4]=y):y=n[4];let w;n[5]!==p||n[6]!==s||n[7]!==(h==null?void 0:h.id)||n[8]!==u?(w=p.isLoading?f.jsx("div",{className:lt.loading,children:"Loading…"}):p.items.length===0?f.jsx(Hx,{}):p.items.map(E=>f.jsx(fx,{item:E,connected:s,onPaste:u,onRemove:()=>p.removeItem(E.id),onInspect:()=>v((h==null?void 0:h.id)===E.id?null:E)},E.id)),n[5]=p,n[6]=s,n[7]=h==null?void 0:h.id,n[8]=u,n[9]=w):w=n[9];let b;n[10]!==w?(b=f.jsx("div",{className:lt.itemList,children:w}),n[10]=w,n[11]=b):b=n[11];let S;n[12]!==h?(S=h&&f.jsxs("div",{className:lt.inspectPanel,children:[f.jsxs("div",{className:lt.inspectHeader,children:[f.jsxs("span",{children:["Describe node ",h.node.alias]}),f.jsx("button",{className:lt.inspectClose,onClick:()=>v(null),"aria-label":"Close inspect panel",children:"✕"})]}),f.jsx("div",{className:lt.inspectBody,children:f.jsx(xc,{data:{node:h.node,connections:h.connections},style:uo})})]}),n[12]=h,n[13]=S):S=n[13];let N;return n[14]!==y||n[15]!==b||n[16]!==S?(N=f.jsxs("div",{className:lt.sidebar,children:[y,b,S]}),n[14]=y,n[15]=b,n[16]=S,n[17]=N):N=n[17],N}const Vh=120,Kh=18,Ux=180,Lx=650;function Yx(r){const{wheelTargetRef:n,scrollRef:s,contentWrapperRef:u,currentIndex:p,totalPages:h,onNavigatePrev:v,onNavigateNext:g}=r,m=T.useRef(0),y=T.useRef(null),w=T.useRef(!1),b=T.useRef(null),S=T.useRef(v),N=T.useRef(g),E=T.useRef(p),C=T.useRef(h);T.useEffect(()=>{S.current=v}),T.useEffect(()=>{N.current=g}),T.useEffect(()=>{E.current=p}),T.useEffect(()=>{C.current=h}),T.useEffect(()=>{b.current!==null&&(clearTimeout(b.current),b.current=null),u.current&&(u.current.style.transition="none",u.current.style.transform="translateY(0)"),m.current=0,y.current=null},[p]),T.useEffect(()=>{const _=n.current;if(!_)return;function j(){m.current=0,y.current=null,u.current&&(u.current.style.transition="transform 0.28s cubic-bezier(0.25, 0.46, 0.45, 0.94)",u.current.style.transform="translateY(0)")}function k(H){if(H.deltaY===0)return;const L=s.current;if(!L)return;const X=L.scrollTop<=0,Y=L.scrollTop+L.clientHeight>=L.scrollHeight-1,B=H.deltaY<0,I=H.deltaY>0,V=X&&B,K=Y&&I;if(!V&&!K){j();return}if(w.current)return;const $=E.current,te=C.current;if(V&&$===0||K&&$===te-1)return;const ue=V?"prev":"next";if(y.current!==null&&y.current!==ue&&j(),y.current=ue,m.current+=Math.abs(H.deltaY),u.current){const he=ue==="prev"?-1:1,re=m.current*(Kh/Vh),D=Math.min(re,Kh)*he;u.current.style.transition="none",u.current.style.transform=`translateY(${D}px)`}if(b.current!==null&&clearTimeout(b.current),b.current=setTimeout(j,Ux),m.current>=Vh){b.current!==null&&clearTimeout(b.current);const he=y.current;j(),w.current=!0,he==="prev"?S.current():N.current(),setTimeout(()=>{w.current=!1},Lx)}}return _.addEventListener("wheel",k,{passive:!0}),()=>{b.current!==null&&clearTimeout(b.current),_.removeEventListener("wheel",k)}},[])}const qx="_helpRoot_18tja_2",Xx="_categoryNav_18tja_11",Jx="_categoryTabScroller_18tja_21",Ix="_categoryTab_18tja_21",Zx="_categoryTabActive_18tja_71",Qx="_maximizeButton_18tja_78",Vx="_closeButton_18tja_100",Kx="_helpBody_18tja_122",$x="_emptyFallback_18tja_130",Wx="_helpContent_18tja_147",Px="_topicLink_18tja_226",Fx="_helpBodyContent_18tja_271",e3="_chipStrip_18tja_276",t3="_chipStripLabel_18tja_294",n3="_topicChip_18tja_310",a3="_topicChipActive_18tja_338",xt={helpRoot:qx,categoryNav:Xx,categoryTabScroller:Jx,categoryTab:Ix,categoryTabActive:Zx,maximizeButton:Qx,closeButton:Vx,helpBody:Kx,emptyFallback:$x,helpContent:Wx,topicLink:Px,helpBodyContent:Fx,chipStrip:e3,chipStripLabel:t3,topicChip:n3,topicChipActive:a3};function _c(r){return typeof r=="string"?r:typeof r=="number"?String(r):Array.isArray(r)?r.map(_c).join(""):Fh.isValidElement(r)?_c(r.props.children):""}function l3(r){if(!r.trim().toLowerCase().startsWith("help "))return null;const u=r.trim().slice(5).replace(/\s*\(.*\)\s*$/,"").trim().toLowerCase();return u.length>0?u:null}function o3(r){var ye;const n=Se.c(53),{activeTopic:s,onNavigate:u,onClose:p,onToggleMaximize:h,isMaximized:v}=r,g=T.useRef(null),m=T.useRef(null),y=T.useRef(null),w=T.useRef(null);let b;n[0]===Symbol.for("react.memo_cache_sentinel")?(b=()=>{g.current&&(g.current.scrollTop=0)},n[0]=b):b=n[0];let S;n[1]!==s?(S=[s],n[1]=s,n[2]=S):S=n[2],T.useEffect(b,S);let N;n[3]===Symbol.for("react.memo_cache_sentinel")?(N=()=>{const se=w.current;if(!se)return;const ge=se.querySelector('[aria-current="step"]');ge&&ge.scrollIntoView({block:"nearest",inline:"nearest",behavior:"smooth"})},n[3]=N):N=n[3];let E;n[4]!==s?(E=[s],n[4]=s,n[5]=E):E=n[5],T.useEffect(N,E);let C;n[6]!==s?(C=sf(s),n[6]=s,n[7]=C):C=n[7];const _=C;let j;n[8]!==_?(j=pc(_),n[8]=_,n[9]=j):j=n[9];const k=j,H=k.length;let L;n[10]!==_?(L=((ye=dc.find(se=>se.id===_))==null?void 0:ye.chipStripLabel)??null,n[10]=_,n[11]=L):L=n[11];const X=L,Y=fl.indexOf(s),B=Y<0?0:Y,I=fl.length;let V,K;n[12]!==u||n[13]!==B?(V=()=>u(fl[B-1]??""),K=()=>u(fl[B+1]??fl[fl.length-1]),n[12]=u,n[13]=B,n[14]=V,n[15]=K):(V=n[14],K=n[15]);let $;n[16]!==B||n[17]!==V||n[18]!==K?($={wheelTargetRef:m,scrollRef:g,contentWrapperRef:y,currentIndex:B,totalPages:I,onNavigatePrev:V,onNavigateNext:K},n[16]=B,n[17]=V,n[18]=K,n[19]=$):$=n[19],Yx($);let te;n[20]!==s?(te=Ri(s),n[20]=s,n[21]=te):te=n[21];const ue=te;let he;n[22]!==u?(he=se=>{const{children:ge,...je}=se,He=_c(ge).trim(),we=l3(He);return we!==null&&Ri(we)!==null?f.jsx("li",{...je,children:f.jsx("button",{className:xt.topicLink,"aria-label":`Open help topic: ${we}`,onClick:()=>u(we),children:ge})}):f.jsx("li",{...je,children:ge})},n[22]=u,n[23]=he):he=n[23];const re=he;let D;n[24]!==_||n[25]!==u?(D=dc.map(se=>f.jsx("button",{className:[xt.categoryTab,se.id===_?xt.categoryTabActive:""].join(" ").trim(),"aria-current":se.id===_?"true":void 0,onClick:()=>{const ge=pc(se.id);u(ge[0]??"")},children:se.label},se.id)),n[24]=_,n[25]=u,n[26]=D):D=n[26];let O;n[27]!==D?(O=f.jsx("div",{className:xt.categoryTabScroller,children:D}),n[27]=D,n[28]=O):O=n[28];let Q;n[29]!==v||n[30]!==h?(Q=h&&f.jsx("button",{className:xt.maximizeButton,onClick:h,"aria-label":v?"Restore help panel":"Maximize help panel",children:v?"⊞":"⛶"}),n[29]=v,n[30]=h,n[31]=Q):Q=n[31];let P;n[32]!==p?(P=p&&f.jsx("button",{className:xt.closeButton,onClick:p,"aria-label":"Close help panel",children:"×"}),n[32]=p,n[33]=P):P=n[33];let F;n[34]!==O||n[35]!==Q||n[36]!==P?(F=f.jsxs("nav",{className:xt.categoryNav,"aria-label":"Help categories",children:[O,Q,P]}),n[34]=O,n[35]=Q,n[36]=P,n[37]=F):F=n[37];let ie;n[38]!==_||n[39]!==s||n[40]!==k||n[41]!==H||n[42]!==X||n[43]!==u?(ie=H>1&&f.jsxs("div",{className:xt.chipStrip,ref:w,children:[X!==null&&f.jsx("span",{className:xt.chipStripLabel,children:X}),k.map(se=>{const ge=se===s,je=N1(se,_);return f.jsx("button",{className:[xt.topicChip,ge?xt.topicChipActive:""].join(" ").trim(),"aria-current":ge?"step":void 0,onClick:()=>u(se),children:je},se)})]}),n[38]=_,n[39]=s,n[40]=k,n[41]=H,n[42]=X,n[43]=u,n[44]=ie):ie=n[44];let oe;n[45]!==s||n[46]!==ue||n[47]!==re?(oe=f.jsx("div",{className:xt.helpBody,ref:g,children:f.jsx("div",{className:xt.helpBodyContent,ref:y,children:ue===null?f.jsxs("div",{className:xt.emptyFallback,children:[f.jsxs("code",{children:["help ",s||""]}),"  not found in the local bundle."]}):f.jsx("div",{className:xt.helpContent,children:f.jsx(Vg,{remarkPlugins:[Kg],components:s===""?{li:re}:void 0,children:ue})})})}),n[45]=s,n[46]=ue,n[47]=re,n[48]=oe):oe=n[48];let ee;return n[49]!==F||n[50]!==ie||n[51]!==oe?(ee=f.jsxs("div",{className:xt.helpRoot,role:"region","aria-label":"Help browser",ref:m,children:[F,ie,oe]}),n[49]=F,n[50]=ie,n[51]=oe,n[52]=ee):ee=n[52],ee}function i3(r){const n=Se.c(22),{existingItem:s,pendingItem:u,onReplace:p,onCancel:h}=r,v=T.useRef(null);let g,m;n[0]===Symbol.for("react.memo_cache_sentinel")?(g=()=>{const k=v.current;k&&!k.open&&k.showModal()},m=[],n[0]=g,n[1]=m):(g=n[0],m=n[1]),T.useEffect(g,m);let y;n[2]===Symbol.for("react.memo_cache_sentinel")?(y=f.jsx("h2",{id:"duplicate-dialog-title",className:lt.dialogTitle,children:"Duplicate Node"}),n[2]=y):y=n[2];let w;n[3]!==u.node.alias?(w=f.jsxs("strong",{children:['"',u.node.alias,'"']}),n[3]=u.node.alias,n[4]=w):w=n[4];let b;n[5]!==s.clippedAt?(b=gf(s.clippedAt),n[5]=s.clippedAt,n[6]=b):b=n[6];let S;n[7]!==w||n[8]!==b?(S=f.jsxs("p",{className:lt.dialogBody,children:["A clipboard item with alias ",w," already exists (clipped ",b,")."]}),n[7]=w,n[8]=b,n[9]=S):S=n[9];let N;n[10]===Symbol.for("react.memo_cache_sentinel")?(N=f.jsx("p",{className:lt.dialogBody,children:"Replace it with the new snapshot?"}),n[10]=N):N=n[10];let E;n[11]!==h?(E=f.jsx("button",{className:lt.cancelBtn,onClick:h,children:"Cancel"}),n[11]=h,n[12]=E):E=n[12];let C;n[13]!==p?(C=f.jsx("button",{className:lt.replaceBtn,onClick:p,children:"Replace"}),n[13]=p,n[14]=C):C=n[14];let _;n[15]!==E||n[16]!==C?(_=f.jsxs("div",{className:lt.dialogActions,children:[E,C]}),n[15]=E,n[16]=C,n[17]=_):_=n[17];let j;return n[18]!==h||n[19]!==_||n[20]!==S?(j=f.jsxs("dialog",{ref:v,className:lt.dialog,onClose:h,"aria-labelledby":"duplicate-dialog-title",children:[y,S,N,_]}),n[18]=h,n[19]=_,n[20]=S,n[21]=j):j=n[21],j}function s3(r,n){if(!n)return null;const s=r.trim().toLowerCase();if(s!=="help"&&!s.startsWith("help "))return null;const u=rf(r);return Ri(u)!==null?u:null}class r3{constructor(){this.listeners=new Map}on(n,s){const u=n;return this.listeners.has(u)||this.listeners.set(u,new Set),this.listeners.get(u).add(s),()=>{var p;(p=this.listeners.get(u))==null||p.delete(s)}}emit(n){const s=this.listeners.get(n.kind);s&&s.forEach(u=>{try{u(n)}catch(p){console.error(`[ProtocolBus] listener for '${n.kind}' threw:`,p)}})}clear(){this.listeners.clear()}}const c3=new Set(["info","error","ping","welcome"]);function u3(r,n){const s=[],u={msgId:r,raw:n};let p=!1,h=!1,v=!1,g=!1,m=!1;const y=po(n);if(y.isJSON){const _=y.data;if(typeof _.type=="string"){const j=_.type;return s.push({...u,kind:"lifecycle",type:j,knownType:c3.has(j),message:typeof _.message=="string"?_.message:n,time:_.time??null}),s.length>0?s:[{...u,kind:"unclassified"}]}return s.push({...u,kind:"json.response",data:y.data}),s.length>0?s:[{...u,kind:"unclassified"}]}const w=jy(n);w&&(m=!0,s.push({...u,kind:"payload.large",apiPath:w.apiPath,byteSize:w.byteSize,filename:w.filename}));const b=My(n);b&&(v=!0,s.push({...u,kind:"upload.invitation",uploadPath:b}));const S=lf(n);if(S&&(g=!0,s.push({...u,kind:"upload.contentPath",uploadPath:S})),af(n)){h=!0;const _=Tc(n);_&&s.push({...u,kind:"graph.link",apiPath:_})}if(h){const _=Ny(n);_&&s.push({...u,kind:"graph.exported",graphName:_.graphName,apiPath:_.apiPath})}const N=ky(n);N&&s.push({...u,kind:"graph.mutation",mutationType:N}),n.startsWith("> ")&&(p=!0,s.push({...u,kind:"command.echo",commandText:n.slice(2)})),Dy(n)&&s.push({...u,kind:"command.helpOrDescribe",commandText:n.slice(2)});const E=Oy(n);E&&s.push({...u,kind:"command.importGraph",graphName:E});const C=Cy(n);return C&&s.push({...u,kind:"graph.export.failed",reason:C.reason}),!p&&!h&&!v&&!g&&!m&&wc(n)&&s.push({...u,kind:"docs.response",isMarkdown:!0}),s.length===0&&s.push({...u,kind:"unclassified"}),s}function d3(r){const n=Se.c(12),{messages:s,bus:u}=r,p=T.useRef(-1);let h;n[0]!==s?(h=()=>{s.length>0&&(p.current=s[s.length-1].id)},n[0]=s,n[1]=h):h=n[1];let v;n[2]===Symbol.for("react.memo_cache_sentinel")?(v=[],n[2]=v):v=n[2],T.useEffect(h,v);let g;if(n[3]!==s){g=new Map;for(const S of s)g.set(S.id,u3(S.id,S.raw));n[3]=s,n[4]=g}else g=n[4];const m=g;let y,w;n[5]!==u||n[6]!==m||n[7]!==s?(y=()=>{if(s.length===0)return;const S=s.filter(N=>N.id>p.current);if(S.length!==0){p.current=s[s.length-1].id;for(const N of S){const E=m.get(N.id);if(E)for(const C of E)u.emit(C)}}},w=[s,u,m],n[5]=u,n[6]=m,n[7]=s,n[8]=y,n[9]=w):(y=n[8],w=n[9]),T.useEffect(y,w);let b;return n[10]!==m?(b={classificationMap:m},n[10]=m,n[11]=b):b=n[11],b}function p3({config:r}){const{title:n,wsPath:s,storageKeyPayload:u,storageKeyHistory:p,storageKeyTab:h,storageKeySavedGraphs:v,supportsUpload:g,supportsClipboard:m,supportsHelp:y,tabs:w}=r,b=kg(),[S,N]=oa(u,""),E=Sc(),[C,_]=T.useState(()=>E.peekPendingPayload(s)),{takePendingPayload:j}=E;T.useEffect(()=>{const De=j(s);De!==null&&_(De)},[j,s]);const k=C??S,H=T.useCallback(De=>{_(null),N(De)},[N]),L=T.useMemo(()=>k?vy(k):{valid:!0,error:null,type:null},[k]),{toasts:X,addToast:Y,removeToast:B}=by(),V=T.useRef(new r3).current,K=T.useCallback(De=>s3(De,y===!0)!==null,[y]),$=By({wsPath:s,storageKeyHistory:p,payload:k,addToast:Y,bus:V,handleLocalCommand:K}),{classificationMap:te}=d3({messages:$.messages,bus:V}),[ue,he]=L1(s),{graphData:re,setGraphData:D,rightTab:O,setRightTab:Q,isRefreshing:P}=Uy(ue,Y,w[0],w,h),{modalUploadPath:F,successfulUploadPaths:ie,handleOpenUploadModal:oe,handleCloseUploadModal:ee,handleUploadSuccess:ye,handleUploadError:se,resetSuccessfulPaths:ge}=O1({bus:V,addToast:Y});Ly({bus:V,pinnedGraphPath:ue,setPinnedGraphPath:he,connected:$.connected,sendRawText:$.sendRawText,addToast:Y});const je=T.useRef(!1);T.useEffect(()=>{je.current&&!$.connected&&(he(null),D(null)),je.current=$.connected},[$.connected,he,D]);const[He,we]=oa(r.storageKeyHelpTopic??"help-topic-fallback",""),[ae,de]=oa("help-panel-open",!1),[fe,ze]=T.useState(()=>!!y&&!ae),[W,ve]=T.useState(!1),Te=T.useRef(null),me=T.useCallback(()=>{fe&&(ve(!0),Te.current=setTimeout(()=>ze(!1),400))},[fe]);T.useEffect(()=>{if(!fe||W)return;const De=setTimeout(me,3e3);return()=>clearTimeout(De)},[fe,W,me]),T.useEffect(()=>{ae&&fe&&me()},[ae,fe,me]),T.useEffect(()=>()=>{Te.current&&clearTimeout(Te.current)},[]),T.useEffect(()=>{if(!y)return;const De=Et=>{Et.ctrlKey&&Et.key==="`"&&(Et.preventDefault(),de(et=>!et))};return window.addEventListener("keydown",De),()=>window.removeEventListener("keydown",De)},[y,de]),C1({bus:V,setHelpTopic:we,onTabSwitch:y?()=>de(!0):()=>{}}),k1({bus:V,connected:$.connected,appendMessage:$.appendMessage,addToast:Y});const Oe=mf(),[Ge,dt]=oa("clipboard-sidebar-open",!1),[Fe,ct]=T.useState(null),sa=T.useCallback(De=>{const et=(re==null?void 0:re.nodes.some(ja=>ja.alias===De.node.alias))??!1?"update":"create",Rn=Y1(et,De.node);$.setCommand(Rn),Y(`${et==="create"?"Create":"Update"} command for "${De.node.alias}" pasted to input`,"info")},[re,$.setCommand,Y]),be=T.useCallback(async(De,Et)=>{try{const et=await Oe.clipNode(De,Et,{sourceWsPath:s,sourceLabel:r.label});switch(et.status){case"added":Y(`Node "${De.alias}" clipped to clipboard`,"success");break;case"duplicate":ct({pendingItem:et.pendingItem,existingItem:et.existingItem});break;case"error":Y(`Clip failed: ${et.message}`,"error");break}}catch(et){Y(`Clip failed: ${et instanceof Error?et.message:String(et)}`,"error")}},[Oe,s,r.label,Y]),hn=z1(v??""),{defaultName:fo,setLastSavedName:mo,resetName:ra}=H1(v?`${v}-untitled-counter`:"untitled-counter",V),{handleSaveGraph:Bi,handleLoadGraph:go}=U1({bus:V,connected:$.connected,sendRawText:$.sendRawText,saveGraph:hn.saveGraph,setLastSavedName:mo,addToast:Y}),Hi=T.useCallback(De=>{const Et=te.get(De.id),et=Et==null?void 0:Et.find(Rn=>Rn.kind==="graph.link");et&&he(et.apiPath)},[te]),{handleSendToJsonPath:Gi}=j1({ctx:E,navigate:b,addToast:Y,wsPath:s}),ca=Gy("(max-width: 768px)"),{defaultLayout:St,onLayoutChanged:on}=Mg({id:r.path+"-panel-split",storage:localStorage}),wt=T.useCallback(()=>H(uc(k)),[k]),Ui=T.useCallback(()=>{$.clearMessages(),he(null),D(null),ge(),ra()},[$.clearMessages,D,ge,ra]);return f.jsxs("div",{className:kt.wrapper,children:[f.jsx($1,{toasts:X,onRemove:B}),F&&f.jsx(z_,{uploadPath:F,onSuccess:ye,onClose:ee,onError:se}),f.jsxs("header",{className:kt.header,children:[f.jsx("h1",{className:kt.title,children:n}),f.jsxs("div",{className:kt.headerActions,children:[v&&f.jsx(G0,{disabled:!re,defaultName:fo,onSave:Bi,nameExists:hn.hasGraph,connected:$.connected}),v&&hn.savedGraphs.length>0&&f.jsx(K0,{savedGraphs:hn.savedGraphs,onLoad:go,onDelete:hn.deleteGraph,connected:$.connected}),m&&f.jsxs("button",{className:kt.clipboardToggle,onClick:()=>dt(De=>!De),"aria-label":Ge?"Close clipboard sidebar":"Open clipboard sidebar","aria-pressed":Ge,children:["Clipboard",Oe.items.length>0?` (${Oe.items.length})`:""]}),f.jsx(N0,{addToast:Y}),y&&f.jsxs("div",{className:kt.helpButtonWrapper,children:[f.jsx("button",{className:`${kt.helpToggle}${fe&&!W?` ${kt.helpTogglePulsing}`:""}`,onClick:()=>de(De=>!De),"aria-label":ae?"Close help panel":"Open help panel","aria-pressed":ae,children:"?"}),fe&&f.jsxs("div",{className:`${kt.helpHint}${W?` ${kt.helpHintFading}`:""}`,onClick:me,role:"status",children:[f.jsx("kbd",{className:kt.helpHintKbd,children:"Ctrl + `"})," to toggle help"]})]})]})]}),Fe&&f.jsx(i3,{existingItem:Fe.existingItem,pendingItem:Fe.pendingItem,onReplace:async()=>{try{await Oe.confirmReplace(Fe.pendingItem,Fe.existingItem.id),ct(null),Y(`Clipboard item "${Fe.pendingItem.node.alias}" replaced`,"success")}catch(De){Y(`Replace failed: ${De instanceof Error?De.message:String(De)}`,"error")}},onCancel:()=>{ct(null),Y("Clip cancelled","info")}}),f.jsxs(Wh,{className:kt.panelGroup,orientation:ca?"vertical":"horizontal",defaultLayout:St,onLayoutChanged:on,children:[f.jsx(co,{defaultSize:ae||Ge?"50%":"60%",minSize:"25%",children:f.jsx(a_,{messages:$.messages,classificationMap:te,onCopy:$.copyMessages,onClear:Ui,consoleRef:$.consoleRef,command:$.command,onCommandChange:$.setCommand,onCommandKeyDown:$.handleKeyDown,onSend:$.sendCommand,sendDisabled:!$.connected||!$.command.trim(),inputDisabled:!$.connected,commandHistory:$.history,onGraphLinkMessage:Hi,onCopyMessage:()=>Y("Copied to clipboard","success"),onSendToJsonPath:Gi,onUploadMockData:oe,successfulUploadPaths:ie})}),f.jsx(cc,{className:kt.resizeHandle,"aria-label":"Resize panels"}),f.jsx(co,{defaultSize:ae?"50%":Ge?"30%":"40%",minSize:"20%",children:f.jsx(Ub,{tabs:w,payload:k,onChange:H,validation:L,onFormat:wt,onUpload:g?$.uploadPayload:void 0,graphData:re,activeTab:O,onTabChange:Q,onGraphRenderError:De=>Y(De,"error"),onGraphDataCopySuccess:()=>Y("Graph JSON copied to clipboard!","success"),onGraphDataCopyError:()=>Y("Copy failed","error"),isGraphRefreshing:P,onClipNode:m?be:void 0,helpPanel:y&&ae?(De,Et)=>f.jsx(o3,{activeTopic:He,onNavigate:we,onClose:()=>de(!1),onToggleMaximize:De,isMaximized:Et}):void 0})}),m&&Ge&&f.jsxs(f.Fragment,{children:[f.jsx(cc,{className:kt.resizeHandle,"aria-label":"Resize clipboard"}),f.jsx(co,{defaultSize:"20%",minSize:"10%",maxSize:"40%",children:f.jsx(Gx,{connected:$.connected,onPaste:sa})})]})]})]})}function h3(){const r=Se.c(2),n=On[0].path;let s;r[0]===Symbol.for("react.memo_cache_sentinel")?(s=On.map(f3),r[0]=s):s=r[0];let u;return r[1]===Symbol.for("react.memo_cache_sentinel")?(u=f.jsx(Ty,{children:f.jsx(lx,{children:f.jsx(Rg,{children:f.jsxs(zg,{children:[s,f.jsx(ef,{path:"*",element:f.jsx(Bg,{to:n,replace:!0})})]})})})}),r[1]=u):u=r[1],u}function f3(r){return f.jsx(ef,{path:r.path,element:f.jsx(p3,{config:r},r.path)},r.path)}ey.createRoot(document.getElementById("root")).render(f.jsx(T.StrictMode,{children:f.jsx(h3,{})}));
//# sourceMappingURL=index-Zwf68sXD.js.map
