...
Also: BOTH PRs merged same day — Java
[PR #236](https://github.com/Accenture/mercury-composable/pull/236) (squash `6ed481e1`,
CI green 6m51s) and Rust PR #183 (the whole typed-AsyncHttpRequest arc, one commit
`0b5be4a6`, CI green first try). Thread [[thread-ops-tunable-instances]] closed. Eric then
ruled the Rust feature progression sufficient for a release: **Rust v4.10.6 in flight**
(re-aligns version numbers with Java, whose 4.10.6 was the Sonar patch — contents differ
by design; agent preparing chore/release-4.10.6).
