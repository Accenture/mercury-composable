...
- **latest_release:** v4.12.4 (2026-09-08 — the regular release the parked 2026-09-04 field
  ...
  The live version source stays the root pom.xml. **Rust release lock-step: pending** — the
  eq/ne twin and Playground webapp are already on Rust main; the Rust v4.12.4 release itself
  has not been cut yet. python/node packs stay at 4.12.1 — no wrapper changes.)
