 ...
 * production legs: {@code key=String}, {@code value=byte[]}.
 */
final class KafkaTestSupport {
    ...
    static void createTopic(String bootstrapServers, String topic) throws InterruptedException, ExecutionException, TimeoutException {
        Properties p = new Properties();
