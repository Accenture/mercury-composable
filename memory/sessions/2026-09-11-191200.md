...
**Merged:** PR #362, squash `88bdff3a` (title clean). Third and final PR of
the field-MR arc (#360 kafka lazy+waiting, #361 redis.health, #362 hardening).
Continuity gained [[kafka-clients-kernel-threads]] (the durable thread-model
rule) and the preload fact its #362 refs.
