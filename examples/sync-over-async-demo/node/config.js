...
export default {
  ...
  protobufRequestTopic: 'protobuf-topic-1',   // facade -> backend (system-of-record-protobuf) [Protobuf]
  protobufResponseTopic: 'protobuf-topic-2',  // backend -> facade (soa-reply-protobuf)        [Protobuf]
