...
For a fully-filled instance of this body, see the verified Claude skill below (`### Claude Code — verified format`) — it shows the same body in context, so it is not repeated here.
