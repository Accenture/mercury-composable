...
`)}function Ni(e,t){let n=t?.nodes.some(t=>t.alias===e.node.alias)?`update`:`create`;return{verb:n,command:Mi(n,e.node)}}function Pi(e){return`${e} ${e===1?`node`:`nodes`} clipped to workspace`}function Fi(e){let{added:t,duplicates:n,failed:r}=e;if(t===0&&n===0&&r===0)return{message:`No selected nodes are available to clip.`,type:`info`};if(t===0&&n>0&&r===0)return{message:`All selected nodes already exist in workspace.`,type:`info`};if(t===0&&n===0&&r>0)return{message:`Failed to clip selected nodes to workspace.`,type:`error`};let i=Pi(t);return n>0&&(i+=`. ${n} already existed.`),r>0&&(i+=`. ${r} failed.`),{message:i,type:r>0?`error`:`success`}}function Ii(e){return{execute(t){return e(t)}}}var L=/^[A-Za-z0-9_-]+$/,Li=/^[A-Za-z0-9_-]+(?:\[(?:0|[1-9]\d*)?\])*$/,Ri=new Set([`input`,`output`,`model`,`response`,`result`,`parameter`,`none`,`next`,`api`,`error`]);function zi(e,t){return`properties.${e}.${t}`}function Bi(e){return e.split(`.`).every(e=>Li.test(e))}function Vi(e){return Bi(e)}function Hi(e,t={}){let n={},r=t.mode??`create`,i=e.alias.trim(),a=t.originalAlias?.trim()??``,o=e.nodeType.trim();r===`edit`?a?L.test(a)||(n.alias=`Use only letters, numbers, underscore, and hyphen.`):n.alias=`Original alias is required.`:i?L.test(i)?Ri.has(i.toLowerCase())?n.alias=`"${i}" is reserved.`:t.graphData?.nodes.some(e=>e.alias.toLowerCase()===i.toLowerCase())&&(n.alias=`Node "${i}" already exists in the current graph.`):n.alias=`Use only letters, numbers, underscore, and hyphen.`:n.alias=`Alias is required.`,o&&!L.test(o)&&(n.nodeType=`Use only letters, numbers, underscore, and hyphen.`);for(let t of e.properties){let e=t.key.trim(),r=t.value.trim();!e&&!r||(!e&&r?n[zi(t.id,`key`)]=`Property key is required when value is present.`:Vi(e)||(n[zi(t.id,`key`)]=`Use a property name or dot/bracket path, for example mapping[] or config.value.`),r.includes(`'''`)&&(n[zi(t.id,`value`)]=`Property value cannot contain '''.`))}return{valid:Object.keys(n).length===0,errors:n}}function Ui(e,t={}){let n={},r=e.trim();return r?L.test(r)?t.graphData&&!t.graphData.nodes.some(e=>e.alias.toLowerCase()===r.toLowerCase())&&(n.alias=`Node "${r}" is no longer available in the current graph.`):n.alias=`Use only letters, numbers, underscore, and hyphen.`:n.alias=`Alias is required.`,{valid:Object.keys(n).length===0,errors:n}}function Wi(e,t){let n={},r=e.trim(),i=t.trim();return(!r||!L.test(r))&&(n.sourceAlias=`Use only letters, numbers, underscore, and hyphen.`),(!i||!L.test(i))&&(n.targetAlias=`Use only letters, numbers, underscore, and hyphen.`),!n.sourceAlias&&!n.targetAlias&&r===i&&(n.targetAlias=`Source and target must be different nodes.`),{valid:Object.keys(n).length===0,errors:n}}function Gi(e,t){return!!e?.nodes.some(e=>e.alias.toLowerCase()===t.toLowerCase())}function Ki(e,t={}){let n={},r=e.sourceAlias.trim(),i=e.targetAlias.trim(),a=e.relation.trim();return t.connected===!1&&(n.command=`Connection disconnected. Reconnect before creating a connection.`),r?L.test(r)?t.graphData&&!Gi(t.graphData,r)&&(n.sourceAlias=`Node "${r}" is no longer available in the current graph.`):n.sourceAlias=`Use only letters, numbers, underscore, and hyphen.`:n.sourceAlias=`Source is required.`,i?L.test(i)?t.graphData&&!Gi(t.graphData,i)&&(n.targetAlias=`Node "${i}" is no longer available in the current graph.`):n.targetAlias=`Use only letters, numbers, underscore, and hyphen.`:n.targetAlias=`Target is required.`,r&&i&&r.toLowerCase()===i.toLowerCase()&&(n.targetAlias=`Source and target nodes must be different.`),a?L.test(a)||(n.relation=`Use only letters, numbers, underscore, and hyphen.`):n.relation=`Relation is required.`,{valid:Object.keys(n).length===0,errors:n}}function qi(e){return e.length<=63488?{valid:!0,errors:{}}:{valid:!1,errors:{command:`The node command is too large. Shorten property values before submitting.`}}}function Ji(e,t=!1){return e.properties.map(e=>({key:e.key.trim(),value:t?e.value.replace(/\r\n/g,`
`).replace(/\r/g,`
`):e.value.trim()})).filter(e=>e.key||e.value.trim())}function Yi(e){let t=qi(e);if(!t.valid)throw Error(t.errors.command)}function Xi(e,t,n){if(n.includes(`
`)){e.push(`${t}='''`),e.push(n),e.push(`'''`);return}e.push(`${t}=${n}`)}function Zi(e){let t=Hi(e);if(!t.valid)throw Error(Object.values(t.errors)[0]??`Invalid node form state.`);let n=e.alias.trim(),r=e.nodeType.trim(),i=Ji(e,!0),a=[`create node ${n}`];if(r&&a.push(`with type ${r}`),i.length>0){a.push(`with properties`);for(let e of i)Xi(a,e.key,e.value)}let o=a.join(`
`);return Yi(o),o}function Qi(e,t){let n=t.trim(),r=Hi(e,{mode:`edit`,originalAlias:n});if(!r.valid)throw Error(Object.values(r.errors)[0]??`Invalid node form state.`);let i=e.nodeType.trim(),a=Ji(e,!0),o=[`update node ${n}`];if(i&&o.push(`with type ${i}`),a.length>0){o.push(`with properties`);for(let e of a)Xi(o,e.key,e.value)}let s=o.join(`
`);return Yi(s),s}function $i(e,t={}){let n=e.trim(),r=Ui(n,t);if(!r.valid)throw Error(Object.values(r.errors)[0]??`Invalid node alias.`);let i=`delete node ${n}`;return Yi(i),i}function ea(e,t){let n=e.trim(),r=t.trim(),i=Wi(n,r);if(!i.valid)throw Error(Object.values(i.errors)[0]??`Invalid connection endpoints.`);let a=`delete connection ${n} and ${r}`;return Yi(a),a}function ta(e){let t=Ki(e);if(!t.valid)throw Error(Object.values(t.errors)[0]??`Invalid connection form state.`);let n=`connect ${e.sourceAlias.trim()} to ${e.targetAlias.trim()} with ${e.relation.trim()}`;return Yi(n),n}var na=0;function ra(e=``,t=``){return na+=1,{id:`property-row-${na}`,key:e,value:t}}function ia(e){return{alias:e===`empty-graph`?`root`:``,nodeType:e===`empty-graph`?`Root`:``,properties:[ra()],source:e}}function aa(e){let t=e.indexOf(`[`);if(t===-1)return null;let n=e.indexOf(`]`,t+1);return n===-1||e.indexOf(`[`,n+1)!==-1?null:{open:t,close:n}}function oa(e){let t=aa(e);if(!t)return e;let n=e.slice(t.open+1,t.close);return/^\d+$/.test(n)?e.slice(0,t.open+1)+n.padStart(3,`0`)+e.slice(t.close):e}function sa(e){let t=aa(e);if(!t)return e;let n=e.slice(t.open+1,t.close);return/^\d+$/.test(n)?e.slice(0,t.open+1)+e.slice(t.close):e}function ca(e){return e.slice().sort((e,t)=>{let n=oa(e.key.trim()),r=oa(t.key.trim());return!n&&!r?0:n?!r||n<r?-1:+(n>r):1})}var la=`This node contains data that cannot be safely represented in the edit form. Use the console edit command for this node.`;function ua(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function da(e){return e===null?`null`:String(e)}function fa(e,t,n){if(!Bi(e))return!1;if(Array.isArray(t))return t.length!==0&&t.every((t,r)=>fa(`${e}[${r}]`,t,n));if(ua(t)){let r=Object.entries(t);return r.length!==0&&r.every(([t,r])=>fa(`${e}.${t}`,r,n))}let r=da(t);return r.includes(`'''`)?!1:(n.push(ra(e,r)),!0)}function pa(e){if(!L.test(e.alias)||e.types.length>1)return{valid:!1,formState:null,message:la};let t=Object.entries(e.properties),n=[];for(let[e,r]of t)if(!fa(e,r,n))return{valid:!1,formState:null,message:la};let r=ca(n).map(e=>({...e,key:sa(e.key)}));return{valid:!0,formState:{alias:e.alias,nodeType:e.types[0]??``,properties:r.length>0?r:[ra()],source:`edit-node`},message:null}}function ma(e,t,n){let r=[];for(let i of e.connections??[]){let e=i.source===t&&i.target===n,a=i.source===n&&i.target===t;if(!(!e&&!a))for(let e of i.relations)r.push(ta({sourceAlias:i.source,targetAlias:i.target,relation:e.type}))}return r}function ha(e,t,n){try{let r=ma(e,t,n);return r.length===0?null:{label:`delete connection ${t} → ${n}`,inverseCommands:r}}catch{return null}}function ga(e){let t=pa(e);if(!t.valid||t.formState===null)return null;try{return{label:`edit node ${e.alias}`,inverseCommands:[Qi(t.formState,e.alias)]}}catch{return null}}function _a(e){try{return{label:`create node ${e}`,inverseCommands:[$i(e)]}}catch{return null}}function va(e,t,n){try{let r=ma(e,t,n);return{label:`create connection ${t} → ${n}`,inverseCommands:[ea(t,n),...r]}}catch{return null}}function ya(e,t){let n=pa(t);if(!n.valid||n.formState===null)return null;try{let r=[Zi(n.formState)];for(let n of e.connections??[])if(!(n.source!==t.alias&&n.target!==t.alias))for(let e of n.relations)r.push(ta({sourceAlias:n.source,targetAlias:n.target,relation:e.type}));return{label:`delete node ${t.alias}`,inverseCommands:r}}catch{return null}}var ba=2500;function xa({bus:e,connected:t,sendRawText:n,addToast:r}){let i=(0,P.useRef)([]),a=(0,P.useRef)(0),o=(0,P.useCallback)(()=>{i.current=[]},[]);(0,P.useEffect)(()=>{t||o()},[o,t]),(0,P.useEffect)(()=>e.on(`graph.mutation`,e=>{e.mutationType===`import-graph`&&o()}),[e,o]);let s=(0,P.useCallback)(e=>{if(e===null||e.inverseCommands.length===0)return null;let t=++a.current;return i.current=[...i.current.slice(-19),{...e,id:t}],t},[]),c=(0,P.useRef)(!1),l=(0,P.useCallback)(()=>new Promise(t=>{let n=!1,r=()=>{n||(n=!0,i(),clearTimeout(a),t())},i=e.on(`graph.mutation`,r),a=setTimeout(r,ba)}),[e]),u=(0,P.useCallback)(e=>{if(c.current){r(`An undo is already in progress.`,`info`);return}let t=i.current,a=t[t.length-1];if(!a){r(`Nothing to undo.`,`info`);return}if(e!==void 0&&a.id!==e){r(`Newer changes exist — press Ctrl+Z to undo them in order.`,`info`);return}i.current=t.slice(0,-1),c.current=!0,(async()=>{try{for(let e of a.inverseCommands){if(!n(e)){r(`Could not send the undo command because the WebSocket is not open.`,`error`),o();return}await l()}r(`Undo: ${a.label}`,`success`)}finally{c.current=!1}})()},[r,o,n,l]);return{push:s,undoLast:(0,P.useCallback)(()=>u(void 0),[u]),undoEntry:u,hasEntries:(0,P.useCallback)(()=>i.current.length>0,[]),clear:o}}function Sa(e){return e.trim().toLowerCase()}function Ca(e,t){if(!t.alias||t.action!==null&&t.action!==`delete-node`)return null;let n=e.aliases.find(n=>Sa(n)===Sa(t.alias)&&e.results[n]===void 0);return n?{...e,results:{...e.results,[n]:t.status===`accepted`?`success`:`error`}}:null}function wa(e){return e.aliases.every(t=>e.results[t]!==void 0)}function Ta(e){let t=Object.values(e.results).filter(e=>e===`success`).length,n=Object.values(e.results).filter(e=>e===`error`).length,r=`${t} selected ${t===1?`node`:`nodes`} deleted.`;return t===0&&n>0?{message:`Failed to delete selected nodes.`,type:`error`}:n>0?{message:`${r} ${n} failed.`,type:`error`}:{message:r,type:`success`}}var Ea={toastContainer:`_toastContainer_1wl5r_1`,toast:`_toast_1wl5r_1`,slideIn:`_slideIn_1wl5r_1`,success:`_success_1wl5r_36`,error:`_error_1wl5r_40`,info:`_info_1wl5r_44`,toastIcon:`_toastIcon_1wl5r_48`,toastMessage:`_toastMessage_1wl5r_53`,toastAction:`_toastAction_1wl5r_59`},Da=({toasts:e,onRemove:t})=>e.length===0?null:(0,I.jsx)(`div`,{className:Ea.toastContainer,children:e.map(e=>(0,I.jsxs)(`div`,{className:`${Ea.toast} ${Ea[e.type]}`,onClick:()=>t(e.id),children:[(0,I.jsxs)(`span`,{className:Ea.toastIcon,children:[e.type===`success`&&`✅`,e.type===`error`&&`❌`,e.type===`info`&&`ℹ️`]}),(0,I.jsx)(`span`,{className:Ea.toastMessage,children:e.message}),e.action&&(0,I.jsx)(`button`,{type:`button`,className:Ea.toastAction,onClick:n=>{n.stopPropagation(),e.action?.onClick(),t(e.id)},children:e.action.label})]},e.id))}),Oa={container:`_container_9dbh2_3`,trigger:`_trigger_9dbh2_7`,chevron:`_chevron_9dbh2_37`,chevronOpen:`_chevronOpen_9dbh2_43`,dot:`_dot_9dbh2_49`,dotIdle:`_dotIdle_9dbh2_56`,dotConnecting:`_dotConnecting_9dbh2_57`,pulse:`_pulse_9dbh2_1`,dotConnected:`_dotConnected_9dbh2_58`,dotPartial:`_dotPartial_9dbh2_59`,dropdown:`_dropdown_9dbh2_65`,fadeIn:`_fadeIn_9dbh2_1`};function ka({label:e,dotStatus:t,children:n}){let[r,i]=(0,P.useState)(!1),a=(0,P.useRef)(null);(0,P.useEffect)(()=>{if(!r)return;let e=e=>{a.current&&!a.current.contains(e.target)&&i(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[r]);let o=e=>{e.key===`Escape`&&(i(!1),a.current?.querySelector(`button[aria-haspopup]`)?.focus())},s=t===`connected`?Oa.dotConnected:t===`connecting`?Oa.dotConnecting:t===`partial`?Oa.dotPartial:t===`idle`?Oa.dotIdle:void 0;return(0,I.jsxs)(`div`,{className:Oa.container,ref:a,onKeyDown:o,children:[(0,I.jsxs)(`button`,{className:Oa.trigger,onClick:()=>i(e=>!e),"aria-haspopup":`true`,"aria-expanded":r,children:[t!==void 0&&(0,I.jsx)(`span`,{className:`${Oa.dot} ${s??``}`,"aria-hidden":`true`}),(0,I.jsx)(`span`,{children:e}),(0,I.jsx)(`span`,{className:`${Oa.chevron} ${r?Oa.chevronOpen:``}`,"aria-hidden":`true`,children:`▾`})]}),r&&(0,I.jsx)(`div`,{className:Oa.dropdown,role:`menu`,children:n})]})}var R={panel:`_panel_1ws0d_1`,section:`_section_1ws0d_7`,sectionHeader:`_sectionHeader_1ws0d_20`,sessionHeaderRow:`_sessionHeaderRow_1ws0d_29`,iconButton:`_iconButton_1ws0d_36`,copyButton:`_copyButton_1ws0d_63`,copyButtonCopied:`_copyButtonCopied_1ws0d_95`,relationshipRow:`_relationshipRow_1ws0d_102`,subscriberRow:`_subscriberRow_1ws0d_103`,sessionId:`_sessionId_1ws0d_114`,statusDot:`_statusDot_1ws0d_127`,metaText:`_metaText_1ws0d_136`,emptyMessage:`_emptyMessage_1ws0d_137`,subscriberList:`_subscriberList_1ws0d_148`,subscribeForm:`_subscribeForm_1ws0d_157`,subscribeInput:`_subscribeInput_1ws0d_164`,subscribeButton:`_subscribeButton_1ws0d_189`,resetButton:`_resetButton_1ws0d_190`,unsubscribeButton:`_unsubscribeButton_1ws0d_218`,actionsRow:`_actionsRow_1ws0d_241`,errorMessage:`_errorMessage_1ws0d_261`,infoMessage:`_infoMessage_1ws0d_262`};function Aa({copied:e}){return e?(0,I.jsx)(`svg`,{viewBox:`0 0 16 16`,"aria-hidden":`true`,focusable:`false`,children:(0,I.jsx)(`path`,{d:`M6.2 11.4 2.9 8.1l1.1-1.1 2.2 2.2 5.8-5.8 1.1 1.1-6.9 6.9Z`})}):(0,I.jsxs)(`svg`,{viewBox:`0 0 16 16`,"aria-hidden":`true`,focusable:`false`,children:[(0,I.jsx)(`path`,{d:`M5 2.5A1.5 1.5 0 0 1 6.5 1h6A1.5 1.5 0 0 1 14 2.5v6A1.5 1.5 0 0 1 12.5 10H11V8.7h1.5a.2.2 0 0 0 .2-.2v-6a.2.2 0 0 0-.2-.2h-6a.2.2 0 0 0-.2.2V4H5V2.5Z`}),(0,I.jsx)(`path`,{d:`M2 6.5A1.5 1.5 0 0 1 3.5 5h6A1.5 1.5 0 0 1 11 6.5v7A1.5 1.5 0 0 1 9.5 15h-6A1.5 1.5 0 0 1 2 13.5v-7Zm1.5-.2a.2.2 0 0 0-.2.2v7a.2.2 0 0 0 .2.2h6a.2.2 0 0 0 .2-.2v-7a.2.2 0 0 0-.2-.2h-6Z`})]})}function ja(e){return e.connected?e.state.pendingCommand===`refresh`||e.state.loading?`connecting`:e.state.sessionId?`connected`:`partial`:`idle`}function Ma({controller:e}){let{state:t}=e,[n,r]=(0,P.useState)(!1),[i,a]=(0,P.useState)(``),[o,s]=(0,P.useState)(null),[c,l]=(0,P.useState)(null),u=(0,P.useRef)(null),d=e.canReset;(0,P.useEffect)(()=>()=>{u.current!==null&&window.clearTimeout(u.current)},[]),(0,P.useEffect)(()=>{t.subscribedTo&&t.pendingCommand!==`subscribe`&&(r(!1),a(``))},[t.pendingCommand,t.subscribedTo]);let f=t=>{t.preventDefault(),e.subscribeToSession(i)},p=async e=>{try{await navigator.clipboard.writeText(e),s(null),l(e),u.current!==null&&window.clearTimeout(u.current),u.current=window.setTimeout(()=>{l(null),u.current=null},1400)}catch{l(null),s(`Could not copy the session ID. Please copy it manually.`)}};return e.connected?(0,I.jsxs)(`div`,{className:R.panel,children:[(0,I.jsxs)(`section`,{className:R.section,children:[(0,I.jsx)(`div`,{className:R.sectionHeader,children:`This session`}),(0,I.jsxs)(`div`,{className:R.sessionHeaderRow,children:[t.sessionId?(0,I.jsx)(`code`,{className:R.sessionId,title:t.sessionId,children:t.sessionId}):(0,I.jsx)(`p`,{className:R.emptyMessage,children:`Session details are not loaded yet.`}),t.sessionId&&(0,I.jsx)(`button`,{type:`button`,className:`${R.copyButton} ${c===t.sessionId?R.copyButtonCopied:``}`,onClick:()=>void p(t.sessionId),"aria-label":`Copy session ID`,title:c===t.sessionId?`Copied`:`Copy session ID`,children:(0,I.jsx)(Aa,{copied:c===t.sessionId})}),e.canSubscribe&&(0,I.jsx)(`button`,{type:`button`,className:R.iconButton,onClick:()=>{e.clearMessage(),r(e=>!e)},"aria-expanded":n,"aria-label":n?`Close subscribe form`:`Subscribe to another session`,title:n?`Close subscribe form`:`Subscribe to another session`,children:n?`×`:`+`})]}),t.startedSince&&(0,I.jsxs)(`div`,{className:R.metaText,children:[`Started since `,t.startedSince]}),n&&(0,I.jsxs)(`form`,{className:R.subscribeForm,onSubmit:f,children:[(0,I.jsx)(`input`,{className:R.subscribeInput,value:i,onChange:t=>{a(t.target.value),e.clearMessage()},placeholder:`ws-123456-1`,autoComplete:`off`,disabled:!e.canSubscribe}),(0,I.jsx)(`button`,{type:`submit`,className:R.subscribeButton,disabled:!e.canSubscribe||i.trim().length===0,children:t.pendingCommand===`subscribe`?`...`:`Subscribe`})]})]}),t.subscribedTo&&(0,I.jsxs)(`section`,{className:R.section,children:[(0,I.jsx)(`div`,{className:R.sectionHeader,children:`Subscribed to`}),(0,I.jsxs)(`div`,{className:R.relationshipRow,children:[(0,I.jsx)(`span`,{className:R.statusDot,"aria-hidden":`true`}),(0,I.jsx)(`code`,{className:R.sessionId,title:t.subscribedTo,children:t.subscribedTo}),(0,I.jsx)(`button`,{type:`button`,className:R.unsubscribeButton,onClick:e.unsubscribe,disabled:!e.canUnsubscribe,children:t.pendingCommand===`unsubscribe`?`...`:`Unsubscribe`})]})]}),t.subscribers.length>0&&(0,I.jsxs)(`section`,{className:R.section,children:[(0,I.jsx)(`div`,{className:R.sectionHeader,children:`Subscribers`}),(0,I.jsx)(`ul`,{className:R.subscriberList,children:t.subscribers.map(e=>(0,I.jsxs)(`li`,{className:R.subscriberRow,children:[(0,I.jsx)(`span`,{className:R.statusDot,"aria-hidden":`true`}),(0,I.jsx)(`code`,{className:R.sessionId,title:e,children:e})]},e))})]}),d&&(0,I.jsx)(`div`,{className:R.actionsRow,children:(0,I.jsx)(`button`,{type:`button`,className:R.resetButton,onClick:e.resetSession,disabled:!e.canReset,children:t.pendingCommand===`reset`?`Resetting...`:`Reset Session`})}),t.error&&(0,I.jsx)(`div`,{className:R.errorMessage,role:`alert`,children:t.error}),o&&(0,I.jsx)(`div`,{className:R.errorMessage,role:`alert`,children:o})]}):(0,I.jsx)(`div`,{className:R.panel,children:(0,I.jsx)(`p`,{className:R.emptyMessage,children:`Connect Minigraph to view session details.`})})}function Na({controller:e}){return(0,I.jsx)(ka,{label:`Session`,dotStatus:ja(e),children:(0,I.jsx)(Ma,{controller:e})})}var Pa={nav:`_nav_1hfby_3`,menuList:`_menuList_1hfby_11`,menuItem:`_menuItem_1hfby_19`,toolRow:`_toolRow_1hfby_56`,toolLink:`_toolLink_1hfby_67`,toolLinkActive:`_toolLinkActive_1hfby_92`,toolDot:`_toolDot_1hfby_99`,toolDotIdle:`_toolDotIdle_1hfby_106`,toolDotConnecting:`_toolDotConnecting_1hfby_107`,pulse:`_pulse_1hfby_1`,toolDotConnected:`_toolDotConnected_1hfby_108`,connectAllRow:`_connectAllRow_1hfby_112`,connectAllBtn:`_connectAllBtn_1hfby_118`,connectAllBtnStop:`_connectAllBtnStop_1hfby_142`,toolConnectBtn:`_toolConnectBtn_1hfby_154`,toolConnectBtnStop:`_toolConnectBtnStop_1hfby_180`,externalIcon:`_externalIcon_1hfby_192`};function Fa(e){return e.every(e=>e===`connected`)?`connected`:e.every(e=>e===`idle`)?`idle`:e.some(e=>e===`connecting`)?`connecting`:`partial`}function Ia(e){return e===`connected`?`connected`:e===`connecting`?`connecting`:`idle`}var La=[{href:`/info`,label:`Info`},{href:`/info/lib`,label:`Libraries`},{href:`/info/routes`,label:`Services`},{href:`/health`,label:`Health`},{href:`/env`,label:`Environment`},{href:`http://localhost:8085/api/ws/json`,label:`Legacy JSON`},{href:`http://localhost:8085/api/ws/graph`,label:`Legacy Graph`}];function Ra({addToast:e,sessionCollaboration:t}){let n=wr(),r=_r.map(e=>n.getSlot(e.wsPath).phase),i=Fa(r),a=r.every(e=>e===`connected`),o=r.some(e=>e===`connecting`);function s(){_r.forEach(t=>{n.getSlot(t.wsPath).phase===`idle`&&n.connect(t.wsPath,e)})}function c(){_r.forEach(e=>{let{phase:t}=n.getSlot(e.wsPath);(t===`connected`||t===`connecting`)&&n.disconnect(e.wsPath)})}return(0,I.jsxs)(`nav`,{className:Pa.nav,"aria-label":`Main navigation`,children:[t&&(0,I.jsx)(Na,{controller:t}),(0,I.jsxs)(ka,{label:`Tools`,dotStatus:i,children:[(0,I.jsx)(`div`,{className:Pa.connectAllRow,children:(0,I.jsx)(`button`,{className:`${Pa.connectAllBtn} ${a?Pa.connectAllBtnStop:``}`,onClick:a?c:s,disabled:o,"aria-label":o?`Connecting…`:a?`Disconnect all WebSockets`:`Connect all WebSockets`,children:o?`Connecting…`:a?`Disconnect All`:`Connect All`})}),(0,I.jsx)(`ul`,{className:Pa.menuList,role:`none`,children:_r.map(t=>{let{phase:r}=n.getSlot(t.wsPath),i=Ia(r),a=r===`connected`,o=r===`connecting`,s=i===`connected`?Pa.toolDotConnected:i===`connecting`?Pa.toolDotConnecting:Pa.toolDotIdle;return(0,I.jsxs)(`li`,{role:`none`,className:Pa.toolRow,children:[(0,I.jsxs)(Gn,{to:t.path,role:`menuitem`,className:({isActive:e})=>`${Pa.toolLink} ${e?Pa.toolLinkActive:``}`,children:[(0,I.jsx)(`span`,{className:`${Pa.toolDot} ${s}`,"aria-hidden":`true`}),(0,I.jsx)(`span`,{className:Pa.toolLabel,children:t.label})]}),(0,I.jsx)(`button`,{className:`${Pa.toolConnectBtn} ${a?Pa.toolConnectBtnStop:``}`,onClick:()=>a||o?n.disconnect(t.wsPath):n.connect(t.wsPath,e),disabled:o,"aria-label":o?`Connecting…`:a?`Disconnect ${t.label}`:`Connect ${t.label}`,title:o?`Connecting…`:yr(t.wsPath),children:o?`…`:a?`Stop`:`Start`})]},t.path)})})]}),(0,I.jsx)(ka,{label:`Quick Links`,children:(0,I.jsx)(`ul`,{className:Pa.menuList,role:`none`,children:La.map(e=>(0,I.jsx)(`li`,{role:`none`,children:(0,I.jsxs)(`a`,{href:e.href,role:`menuitem`,className:Pa.menuItem,target:`_blank`,rel:`noopener noreferrer`,children:[e.label,(0,I.jsx)(`span`,{className:Pa.externalIcon,"aria-hidden":`true`,children:`↗`})]})},e.href))})})]})}var za={saveBtn:`_saveBtn_ek34s_3`,saveBtnSaved:`_saveBtnSaved_ek34s_25`,saveBtnLabel:`_saveBtnLabel_ek34s_35`,saveForm:`_saveForm_ek34s_50`,saveInput:`_saveInput_ek34s_56`,saveInputWarn:`_saveInputWarn_ek34s_72`,saveWarnLabel:`_saveWarnLabel_ek34s_76`,saveActionBtn:`_saveActionBtn_ek34s_82`};function Ba(e){return e?`Saved: ${e}`:`Save Graph`}function Va({disabled:e,defaultName:t,savedName:n=null,onSave:r,nameExists:i,connected:a=!1}){let[o,s]=(0,P.useState)(!1),[c,l]=(0,P.useState)(``),u=(0,P.useRef)(null),d=(0,P.useRef)(null),f=(0,P.useRef)(!1),p=(0,P.useCallback)(()=>{l(t),s(!0)},[t]),m=(0,P.useCallback)(()=>{f.current=!0,s(!1),l(``)},[]),h=(0,P.useCallback)(()=>{let e=c.trim();e&&(r(e),f.current=!0,s(!1),l(``))},[c,r]),g=(0,P.useCallback)(e=>{e.key===`Enter`&&(e.preventDefault(),h()),e.key===`Escape`&&(e.preventDefault(),m())},[h,m]);return(0,P.useEffect)(()=>{o?u.current?.focus():f.current&&(f.current=!1,d.current?.focus())},[o]),o?(0,I.jsxs)(`div`,{className:za.saveForm,children:[(0,I.jsx)(`input`,{ref:u,className:`${za.saveInput}${i?.(c.trim())?` ${za.saveInputWarn}`:``}`,type:`text`,value:c,onChange:e=>l(e.target.value),onKeyDown:g,placeholder:`Enter a name…`,"aria-label":`Graph save name`,maxLength:80}),i?.(c.trim())&&(0,I.jsx)(`span`,{className:za.saveWarnLabel,role:`status`,children:`Overwrite?`}),(0,I.jsx)(`button`,{className:za.saveActionBtn,onClick:h,disabled:!c.trim(),"aria-label":`Confirm save`,children:`✅`}),(0,I.jsx)(`button`,{className:za.saveActionBtn,onClick:m,"aria-label":`Cancel save`,children:`❌`})]}):(0,I.jsxs)(`button`,{ref:d,className:`${za.saveBtn}${n?` ${za.saveBtnSaved}`:``}`,onClick:p,disabled:e||!a,title:e?`No graph loaded`:a?n?`Graph saved as ${n}. Click to save again`:`Export graph snapshot to server and save bookmark`:`Connect first to save`,"aria-label":n?`Graph saved as ${n}. Save again`:`Save graph snapshot`,children:[(0,I.jsx)(`span`,{"aria-hidden":`true`,children:n?`✅`:`💾`}),(0,I.jsx)(`span`,{className:za.saveBtnLabel,children:Ba(n)})]})}var Ha={empty:`_empty_tpeii_3`,hint:`_hint_tpeii_12`,list:`_list_tpeii_21`,row:`_row_tpeii_31`,rowInfo:`_rowInfo_tpeii_50`,rowName:`_rowName_tpeii_58`,rowMeta:`_rowMeta_tpeii_67`,rowActions:`_rowActions_tpeii_78`,loadBtn:`_loadBtn_tpeii_84`,deleteBtn:`_deleteBtn_tpeii_85`};function Ua({savedGraphs:e,onLoad:t,onDelete:n,connected:r}){return(0,I.jsx)(ka,{label:e.length>0?`Load Graph (${e.length})`:`Load Graph`,children:e.length===0?(0,I.jsx)(`p`,{className:Ha.empty,children:`No saved graphs yet.`}):(0,I.jsxs)(I.Fragment,{children:[!r&&(0,I.jsx)(`p`,{className:Ha.hint,children:`Connect to load a graph`}),(0,I.jsx)(`ul`,{className:Ha.list,role:`list`,children:e.map(e=>(0,I.jsxs)(`li`,{className:Ha.row,children:[(0,I.jsxs)(`div`,{className:Ha.rowInfo,children:[(0,I.jsx)(`span`,{className:Ha.rowName,title:e.name,children:e.name}),(0,I.jsx)(`span`,{className:Ha.rowMeta,children:new Date(e.savedAt).toLocaleString()})]}),(0,I.jsxs)(`div`,{className:Ha.rowActions,children:[(0,I.jsx)(`button`,{className:Ha.loadBtn,onClick:()=>t(e.name),disabled:!r,title:r?`Run: import graph from ${e.name}`:`Connect to the playground first`,"aria-label":`Load graph ${e.name}`,children:`Load`}),(0,I.jsx)(`button`,{className:Ha.deleteBtn,onClick:()=>n(e.name),title:`Remove "${e.name}" from local storage`,"aria-label":`Delete saved graph ${e.name}`,children:`Delete`})]})]},e.name))})]})})}var Wa={payloadRoot:`_payloadRoot_6u47x_2`,labelRow:`_labelRow_6u47x_10`,label:`_label_6u47x_10`,payloadControls:`_payloadControls_6u47x_26`,charCounter:`_charCounter_6u47x_32`,typeIndicator:`_typeIndicator_6u47x_38`,validationIcon:`_validationIcon_6u47x_49`,formatButton:`_formatButton_6u47x_53`,uploadButton:`_uploadButton_6u47x_67`,textarea:`_textarea_6u47x_82`,textareaError:`_textareaError_6u47x_107`,errorMessage:`_errorMessage_6u47x_109`,sampleButtonsRow:`_sampleButtonsRow_6u47x_117`,sampleButtons:`_sampleButtons_6u47x_117`,sampleLabel:`_sampleLabel_6u47x_130`,sampleGroup:`_sampleGroup_6u47x_136`,sampleGroupLabel:`_sampleGroupLabel_6u47x_143`,sampleButton:`_sampleButton_6u47x_117`};function Ga({onLoad:e}){let t=Object.keys(vr).filter(e=>e.startsWith(`json_`)),n=Object.keys(vr).filter(e=>e.startsWith(`xml_`)),r=e=>e.replace(/^(json|xml)_/,``).replace(/_/g,` `);return(0,I.jsxs)(`div`,{className:Wa.sampleButtons,children:[(0,I.jsx)(`span`,{className:Wa.sampleLabel,children:`Quick load:`}),(0,I.jsxs)(`div`,{className:Wa.sampleGroup,children:[(0,I.jsx)(`span`,{className:Wa.sampleGroupLabel,children:`JSON:`}),t.map(t=>(0,I.jsx)(`button`,{className:Wa.sampleButton,onClick:()=>e(vr[t]),children:r(t)},t))]}),(0,I.jsxs)(`div`,{className:Wa.sampleGroup,children:[(0,I.jsx)(`span`,{className:Wa.sampleGroupLabel,children:`XML:`}),n.map(t=>(0,I.jsx)(`button`,{className:Wa.sampleButton,onClick:()=>e(vr[t]),children:r(t)},t))]})]})}function Ka({payload:e,onChange:t,validation:n,onFormat:r,onUpload:i}){return(0,I.jsxs)(`div`,{className:Wa.payloadRoot,children:[(0,I.jsxs)(`div`,{className:Wa.labelRow,children:[(0,I.jsx)(`label`,{htmlFor:`payload`,className:Wa.label,children:`JSON/XML Payload`}),(0,I.jsxs)(`div`,{className:Wa.payloadControls,children:[(0,I.jsxs)(`span`,{className:Wa.charCounter,children:[`size: `,e.length]}),e&&n.type&&(0,I.jsx)(`span`,{className:Wa.typeIndicator,children:n.type.toUpperCase()}),e&&(0,I.jsx)(`span`,{className:Wa.validationIcon,children:n.valid?`✅`:`❌`}),(0,I.jsx)(`button`,{className:Wa.formatButton,onClick:r,disabled:!e||n.type!==`json`,title:n.type===`xml`?`Format only available for JSON`:`Format JSON`,children:`Format`}),i!==void 0&&(0,I.jsx)(`button`,{className:Wa.uploadButton,onClick:i,disabled:!e||!n.valid||n.type!==`json`,title:`Upload JSON payload to current session via REST`,children:`Upload`})]})]}),(0,I.jsx)(`textarea`,{id:`payload`,className:`${Wa.textarea} ${n.valid?``:Wa.textareaError}`,placeholder:`Paste your JSON/XML payload here`,value:e,onChange:e=>t(e.target.value)}),!n.valid&&(0,I.jsx)(`div`,{className:Wa.errorMessage,children:n.error}),(0,I.jsx)(`div`,{className:Wa.sampleButtonsRow,children:(0,I.jsx)(Ga,{onLoad:t})})]})}var qa={Root:{icon:`🚀`,label:`Root`},End:{icon:`🏁`,label:`End`},Fetcher:{icon:`🌐`,label:`Fetcher`},mapper:{icon:`🗺️`,label:`Mapper`},Math:{icon:`🔢`,label:`Math`},JavaScript:{icon:`📜`,label:`JavaScript`},Provider:{icon:`🔌`,label:`Provider`},Dictionary:{icon:`📖`,label:`Dictionary`},Join:{icon:`🔀`,label:`Join`},Extension:{icon:`🧩`,label:`Extension`},Island:{icon:`🏝️`,label:`Island`},Decision:{icon:`❓`,label:`Decision`},Suspend:{icon:`⏸️`,label:`Suspend`},Resume:{icon:`▶️`,label:`Resume`},Suspensible:{icon:`⏯️`,label:`Suspensible`}},Ja={boxSizing:`border-box`,borderRadius:`8px`,borderWidth:`1.5px`,borderStyle:`solid`,background:`var(--bg-secondary, #1e1e2e)`,color:`var(--text-primary, #cdd6f4)`,fontSize:`0.75rem`,boxShadow:`0 2px 8px rgba(0,0,0,0.45)`,overflow:`visible`,padding:0},Ya={Root:`#15803d`,End:`#dc2626`,Fetcher:`#2563eb`,mapper:`#ea580c`,Math:`#a16207`,JavaScript:`#7e22ce`,Provider:`#be185d`,Dictionary:`#0e7490`,Join:`#65a30d`,Extension:`#4338ca`,Island:`#475569`,Decision:`#b45309`,Suspend:`#0d9488`,Resume:`#0284c7`,Suspensible:`#c026d3`},Xa=`#6c7086`;function Za(e){return qa[e]??{icon:`📦`,label:e}}function Qa(e){return Ya[e]??Xa}function $a(e){let t=Ya[e]??Xa;return{...Ja,borderColor:t,"--node-accent":t}}var eo={content:`_content_oauql_8`,header:`_header_oauql_24`,icon:`_icon_oauql_44`,alias:`_alias_oauql_49`,badge:`_badge_oauql_55`,body:`_body_oauql_67`,bodyPeek:`_bodyPeek_oauql_77`,row:`_row_oauql_85`,label:`_label_oauql_98`,value:`_value_oauql_104`,edgeHandle:`_edgeHandle_oauql_118`,authoringRing:`_authoringRing_oauql_134`,authoringTargetOverlay:`_authoringTargetOverlay_oauql_188`,authoringTargetOverlayActive:`_authoringTargetOverlayActive_oauql_204`};function to({label:e,value:t}){return(0,I.jsxs)(`div`,{className:eo.row,children:[(0,I.jsx)(`span`,{className:eo.label,children:e}),(0,I.jsx)(`span`,{className:eo.value,title:t,children:t})]})}function no({properties:e}){let t=Object.entries(e).filter(([,e])=>e!=null);return t.length===0?null:(0,I.jsx)(I.Fragment,{children:t.map(([e,t])=>Array.isArray(t)?t.map((t,n)=>{let r=typeof t==`string`?t:JSON.stringify(t);return(0,I.jsx)(to,{label:n===0?e:``,value:r},`${e}-${n}`)}):(0,I.jsx)(to,{label:e,value:typeof t==`string`?t:JSON.stringify(t)},e))})}function ro({alias:e,nodeType:t,properties:n,compact:r=!1}){let i=Za(t);return(0,I.jsx)(P.Fragment,{children:(0,I.jsxs)(`div`,{className:eo.content,children:[(0,I.jsxs)(`div`,{className:eo.header,children:[(0,I.jsx)(`span`,{className:eo.icon,children:i.icon}),(0,I.jsx)(`span`,{className:eo.alias,children:e}),(0,I.jsx)(`span`,{className:eo.badge,children:i.label})]}),(0,I.jsx)(`div`,{className:r?`${eo.body} ${eo.bodyPeek}`:eo.body,children:(0,I.jsx)(no,{properties:n})})]})})}function io({id:e,data:t,isConnectable:n,selected:r}){let[i,a]=(0,P.useState)(!1),o=t.supportsConnectionAuthoring&&!i,l=c(),d=o&&l.inProgress&&l.fromNode?.id!==e;return(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(h,{minWidth:180,minHeight:t.minHeight,isVisible:r,onResizeStart:()=>a(!0),onResizeEnd:()=>a(!1)}),t.targetHandles.map(({id:e,offset:t})=>(0,I.jsx)(s,{id:e,type:`target`,position:u.Left,isConnectable:n,className:eo.edgeHandle,style:{top:`calc(50% + ${t}px)`}},e)),t.backSourceHandles.map(({id:e,offset:t})=>(0,I.jsx)(s,{id:e,type:`source`,position:u.Left,isConnectable:n,className:eo.edgeHandle,style:{top:`calc(50% + ${t}px)`}},e)),(0,I.jsx)(ro,{alias:t.alias,nodeType:t.nodeType,properties:t.properties,compact:t.compact}),o&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(s,{id:`authoring-source`,type:`source`,position:u.Right,isConnectable:n,isConnectableEnd:!1,className:eo.authoringRing}),(0,I.jsx)(s,{id:`authoring-target`,type:`target`,position:u.Left,isConnectable:n,isConnectableStart:!1,className:d?`${eo.authoringTargetOverlay} ${eo.authoringTargetOverlayActive}`:eo.authoringTargetOverlay})]}),t.sourceHandles.map(({id:e,offset:t})=>(0,I.jsx)(s,{id:e,type:`source`,position:u.Right,isConnectable:n,className:eo.edgeHandle,style:{top:`calc(50% + ${t}px)`}},e)),t.backTargetHandles.map(({id:e,offset:t})=>(0,I.jsx)(s,{id:e,type:`target`,position:u.Right,isConnectable:n,className:eo.edgeHandle,style:{top:`calc(50% + ${t}px)`}},e))]})}var ao={Root:io,End:io,Fetcher:io,mapper:io,Math:io,JavaScript:io,Provider:io,Dictionary:io,Join:io,Extension:io,Island:io,Decision:io,default:io},z={graphWrapper:`_graphWrapper_1pee8_15`,graphSurface:`_graphSurface_1pee8_24`,empty:`_empty_1pee8_30`,emptyIcon:`_emptyIcon_1pee8_43`,emptyCreateButton:`_emptyCreateButton_1pee8_48`,emptyHint:`_emptyHint_1pee8_70`,refreshingOverlay:`_refreshingOverlay_1pee8_135`,clipboardDropOverlay:`_clipboardDropOverlay_1pee8_147`,clipboardDropMessage:`_clipboardDropMessage_1pee8_160`,refreshingSpinner:`_refreshingSpinner_1pee8_175`,graphRefreshSpin:`_graphRefreshSpin_1pee8_1`,connectBanner:`_connectBanner_1pee8_189`,connectBannerCancel:`_connectBannerCancel_1pee8_209`,detailToggleIcon:`_detailToggleIcon_1pee8_248`,detailToggleHeader:`_detailToggleHeader_1pee8_259`,detailToggleLine:`_detailToggleLine_1pee8_266`},oo=class extends P.Component{constructor(...e){super(...e),this.state={caughtError:null}}static getDerivedStateFromError(e){return{caughtError:e instanceof Error?e.message:String(e)}}componentDidCatch(e,t){let n=e instanceof Error?e.message:String(e);console.error(`[GraphView] Render error:`,n,t.componentStack),this.props.onRenderError?.(`Graph render failed: ${n}`)}render(){return this.state.caughtError?(0,I.jsxs)(`div`,{className:z.empty,children:[(0,I.jsx)(`span`,{className:z.emptyIcon,children:`⚠️`}),(0,I.jsx)(`span`,{children:`Graph could not be rendered.`}),(0,I.jsx)(`span`,{children:this.state.caughtError})]}):this.props.children}},so=[`fetch`,`details`,`ext-call`,`mapping`,`compute`,`calculate`,`evaluate`,`fork`,`join`,`one`,`two`,`three`,`more`,`done`,`complete`,`finish`,`positive`,`negative`],co={fetch:`#0369a1`,details:`#0369a1`,"ext-call":`#0369a1`,mapping:`#b45309`,compute:`#b45309`,calculate:`#b45309`,evaluate:`#b45309`,fork:`#7e22ce`,join:`#7e22ce`,one:`#7e22ce`,two:`#6d28d9`,three:`#5b21b6`,more:`#4c1d95`,done:`#15803d`,complete:`#15803d`,finish:`#15803d`,positive:`#15803d`,negative:`#b91c1c`},lo=[`#0369a1`,`#15803d`,`#b45309`,`#7e22ce`,`#b91c1c`,`#0f766e`,`#c2410c`,`#a16207`];function uo(e){let t=0;for(let n=0;n<e.length;n++)t=(t<<5)-t+e.charCodeAt(n),t|=0;return Math.abs(t)}function fo(e,t){if(e.length===0)return t;let n=e[0].trim().toLowerCase();return co[n]||lo[uo(n)%lo.length]}var po=240,B=100,V=100,mo=60,ho=360,go=120,_o=80,vo=4,yo=1e4,bo=2e3,xo=64,So=256,Co=256,wo=512,To=.001,Eo=8,Do=16,Oo=`rgba(148, 163, 184, 0.42)`,ko=`var(--bg-secondary)`,Ao=24,jo=32;function Mo(e){return fo(e,Oo)}function No(e){return`source-${e}`}function Po(e){return`target-${e}`}function Fo(e){return`back-source-${e}`}function Io(e){return`back-target-${e}`}function Lo(e,t){return t<=1?0:t===2?e===0?-24:Ao:(e-(t-1)/2)*Ao}function Ro(e,t=B){return e<=1?t:Math.max(t,(e-1)*Ao+jo*2)}var zo=40,Bo=9,Vo=18,Ho=22;function Uo(e){let t=typeof e==`string`?e:JSON.stringify(e)??``;return Math.max(1,Math.ceil(t.length/Ho))}function Wo(e){let t=zo;for(let n of Object.values(e.properties??{})){if(n==null)continue;let e=Array.isArray(n)?n:[n];for(let n of e)t+=Bo+Uo(n)*Vo}return Math.max(B,t)}var Go=new Set([`graph.math`,`graph.js`]),Ko=[`Dictionary`,`Provider`,`Module`,`Entity`],qo={ROOT_TREE:0,DEFAULT_TREE:1,END_TREE:2};function Jo(e){return e.alias.toLowerCase()===`root`||e.types.includes(`Root`)||e.types.includes(`entry_point`)}function Yo(e){return e.alias.toLowerCase()===`end`||e.types.includes(`End`)}function Xo(e){return e.hasRoot?qo.ROOT_TREE:e.hasEnd?qo.END_TREE:qo.DEFAULT_TREE}function Zo(e,t){let n=Xo(e)-Xo(t);return n===0?e.sortKey.localeCompare(t.sortKey):n}function Qo(e){return`real:${e}`}function $o(e){return new Map([...e].map(([e,t])=>[e,t.slice()]))}function es(e){return new Map(e.map((e,t)=>[e.id,t]))}function ts(e,t,n){let r=(t.get(e)??[]).map(e=>n.get(e)).filter(e=>e!==void 0);if(r.length!==0)return r.reduce((e,t)=>e+t,0)/r.length}function ns(e,t,n){let r=es(e);return e.slice().sort((e,i)=>{let a=ts(e.id,t,n),o=ts(i.id,t,n);if(a!==void 0&&o!==void 0){let e=a-o;if(Math.abs(e)>2**-52)return e}let s=r.get(e.id)-r.get(i.id);return s===0?e.stableKey.localeCompare(i.stableKey):s})}function rs(e,t){let n=Array(t+1).fill(0),r=e=>{let t=0;for(let r=e;r>0;r-=r&-r)t+=n[r];return t},i=e=>{for(let t=e;t<n.length;t+=t&-t)n[t]+=1},a=0;for(let t=e.length-1;t>=0;t--){let n=e[t]+1;a+=r(n-1),i(n)}return a}function is(e,t){let n=new Map([...e].map(([e,t])=>[e,es(t)])),r=new Map;for(let e of t)r.has(e.level)||r.set(e.level,[]),r.get(e.level).push(e);let i=0;for(let[e,t]of r){let r=n.get(e),a=n.get(e+1);if(!r||!a)continue;let o=t.map(e=>({sourceId:e.sourceId,targetId:e.targetId,sourcePosition:r.get(e.sourceId),targetPosition:a.get(e.targetId)})).sort((e,t)=>e.sourcePosition-t.sourcePosition||e.targetPosition-t.targetPosition||e.sourceId.localeCompare(t.sourceId)||e.targetId.localeCompare(t.targetId)).map(e=>e.targetPosition);i+=rs(o,a.size)}return i}function as(e,t,n){e.has(t)||e.set(t,[]),e.get(t).push(n)}function os(e){return[e.source,e.target,...e.relations.map(e=>e.type)].join(`	`)}function ss(e,t){return e.nodeIntrusions<t.nodeIntrusions||e.nodeIntrusions===t.nodeIntrusions&&e.edgeCrossings<t.edgeCrossings}function cs(e){let t=new Map;for(let[n,r]of e){let e=-(r.reduce((e,t)=>e+t.height,0)+Math.max(0,r.length-1)*mo)/2;for(let i of r)i.alias&&t.set(i.alias,{alias:i.alias,level:n,x:n*360,y:e,height:i.height}),e+=i.height+mo}return t}function ls(e,t,n,r,i){let a=1-i;return a*a*a*e+3*a*a*i*t+3*a*i*i*n+i*i*i*r}function us(e,t,n,r){let i=0,a=1;for(let o=0;o<32;o++){let o=(i+a)/2;ls(e,t,t,n,o)<r?i=o:a=o}return(i+a)/2}function ds(e,t,n,r,i){let a=e.x+po,o=t.x,s=i.x+To,c=i.x+po-To;if(s>=o||c<=a)return null;let l=a+(o-a)/2,u=us(a,l,o,s),d=us(a,l,o,c),f=e.y+e.height/2+n,p=t.y+t.height/2+r,m=ls(f,f,p,p,u),h=ls(f,f,p,p,d);return{yLow:Math.min(m,h),yHigh:Math.max(m,h)}}function fs(e,t,n,r,i){let a=ds(e,t,n,r,i);if(!a)return!1;let o=i.y+To,s=i.y+i.height-To;return a.yHigh>o&&a.yLow<s}function ps(e,t){let n=new Map;for(let[e,r]of t)n.has(r)||n.set(r,[]),n.get(r).push(e);for(let e of n.values())e.sort();let r=[];for(let[i,a]of e.entries()){let e=t.get(a.source),o=t.get(a.target);if(!(e===void 0||o===void 0||o-e<=1)){for(let t=e+1;t<o;t++)for(let e of n.get(t)??[])if(r.push({connectionIndex:i,nodeAlias:e}),r.length>bo)return null}}return r}function ms(e,t,n){let r=new Map,i=new Map;for(let e of t.keys())r.set(e,[]),i.set(e,[]);for(let[n,a]of e.entries()){let e=t.get(a.source),o=t.get(a.target);if(e===void 0||o===void 0)continue;let s=e>=o,c=os(a);s?(i.get(a.source).push({connectionIndex:n,peerAlias:a.target,isBack:s,stableKey:c}),r.get(a.target).push({connectionIndex:n,peerAlias:a.source,isBack:s,stableKey:c})):(r.get(a.source).push({connectionIndex:n,peerAlias:a.target,isBack:s,stableKey:c}),i.get(a.target).push({connectionIndex:n,peerAlias:a.source,isBack:s,stableKey:c}))}let a=(e,t)=>n(e.peerAlias)-n(t.peerAlias)||e.peerAlias.localeCompare(t.peerAlias)||e.stableKey.localeCompare(t.stableKey)||e.connectionIndex-t.connectionIndex;for(let e of r.values())e.sort(a);for(let e of i.values())e.sort(a);let o=new Map,s=new Map;for(let e of r.values())for(let[t,n]of e.entries()){let r=Lo(t,e.length);n.isBack?s.set(n.connectionIndex,r):o.set(n.connectionIndex,r)}for(let e of i.values())for(let[t,n]of e.entries()){let r=Lo(t,e.length);n.isBack?o.set(n.connectionIndex,r):s.set(n.connectionIndex,r)}return{sourceOffsets:o,targetOffsets:s}}function hs(e,t,n,r){let i=cs(e),{sourceOffsets:a,targetOffsets:o}=ms(n,t,e=>i.get(e)?.y??0),s=0;for(let{connectionIndex:e,nodeAlias:t}of r){let r=n[e],c=i.get(r.source),l=i.get(r.target),u=i.get(t);!c||!l||!u||fs(c,l,a.get(e)??0,o.get(e)??0,u)&&(s+=1)}return s}function gs(e,t,n,r){let i=e=>t.map(t=>e.get(t).map(e=>e.id).join(`	`)).join(`
`),a=$o(e),o=1,s=a,c=n(a),l=[{candidate:a,depth:0}],u=new Set([i(a)]),d=0;for(;d<l.length&&o<r;){let{candidate:e,depth:a}=l[d++];if(!(a>=2))for(let d of t){let t=e.get(d);for(let f=0;f<t.length;f++){for(let p=0;p<t.length;p++){if(f===p)continue;let t=$o(e),m=t.get(d),[h]=m.splice(f,1);m.splice(p,0,h);let g=i(t);if(u.has(g))continue;u.add(g);let _=n(t);if(o+=1,ss(_,c)&&(s=t,c=_),a+1<2&&l.push({candidate:t,depth:a+1}),o>=r)break}if(o>=r)break}if(o>=r)break}}for(let n of t)e.set(n,s.get(n).slice());return o}function _s(e,t,n,r){let i=new Map;for(let[t,n]of e)i.has(n)||i.set(n,[]),i.get(n).push({id:Qo(t),alias:t,height:r.get(t)??B,stableKey:`real:${t}`});for(let e of i.values())e.sort((e,t)=>e.stableKey.localeCompare(t.stableKey));let a=$o(i),o=$o(i),s=t.map((t,n)=>({connectionIndex:n,source:t.source,target:t.target,sourceLevel:e.get(t.source),targetLevel:e.get(t.target),stableKey:os(t)})).filter(e=>e.sourceLevel!==void 0&&e.targetLevel!==void 0&&!n.has(`${e.source}\t${e.target}`)&&e.sourceLevel<e.targetLevel).sort((e,t)=>e.source.localeCompare(t.source)||e.target.localeCompare(t.target)||e.stableKey.localeCompare(t.stableKey)||e.connectionIndex-t.connectionIndex),c=s.reduce((e,t)=>e+(t.targetLevel-t.sourceLevel),0)<=yo,l=new Map,u=new Map,d=[];for(let[e,t]of s.entries()){let n=t.sourceLevel,r=t.targetLevel;if(!c&&r-n>1)continue;let i=Qo(t.source),a=n;for(let s=n+1;s<r;s++){let n=`dummy:${t.source}\t${t.target}\t${e}\t${s}`;o.has(s)||o.set(s,[]),o.get(s).push({id:n,height:B,stableKey:n}),d.push({sourceId:i,targetId:n,level:a}),as(u,i,n),as(l,n,i),i=n,a=s}let s=Qo(t.target);d.push({sourceId:i,targetId:s,level:a}),as(u,i,s),as(l,s,i)}for(let e of o.values())e.sort((e,t)=>e.stableKey.localeCompare(t.stableKey));let f=[...o.keys()].sort((e,t)=>e-t);if(f.length<=1||d.length===0)return a;let p=$o(o),m=$o(o),h=ps(t,e),g=h?.length??2001,_=h!==null,v=n=>({nodeIntrusions:_?hs(n,e,t,h??[]):0,edgeCrossings:is(n,d)}),y=v(m),b=()=>{let e=v(p);ss(e,y)&&(y=e,m=$o(p))},x=[...o.values()].reduce((e,t)=>e+t.length,0)<=xo&&d.length<=So&&g<=Co,S=0,C=()=>{let e=wo-S;!x||e<=1||(S+=gs(p,f,v,e),b())};for(let e=0;e<vo;e++){for(let e=1;e<f.length;e++){let t=f[e],n=f[e-1];p.set(t,ns(p.get(t),l,es(p.get(n))))}b(),C();for(let e=f.length-2;e>=0;e--){let t=f[e],n=f[e+1];p.set(t,ns(p.get(t),u,es(p.get(n))))}b(),C()}return _&&hs(a,e,t,h??[])<y.nodeIntrusions?a:m}function vs(e,t,n,r,i){let a=n.slice().sort((e,n)=>os(t[e.connectionIndex]).localeCompare(os(t[n.connectionIndex]))||e.nodeAlias.localeCompare(n.nodeAlias)||e.connectionIndex-n.connectionIndex);for(let{connectionIndex:n,nodeAlias:o}of a){let a=t[n],s=e.get(a.source),c=e.get(a.target),l=e.get(o);if(!s||!c||!l)continue;let u=ds(s,c,r.get(n)??0,i.get(n)??0,l);if(!u)continue;let d=l.y+To,f=l.y+l.height-To;if(u.yHigh<=d||u.yLow>=f)continue;let p=u.yHigh+Do-l.y,m=l.y+l.height-(u.yLow-Do);return p<=m?{x:l.x,y:l.y,delta:p,direction:1}:{x:l.x,y:l.y,delta:m,direction:-1}}return null}function ys(e,t,n,r){let i=ps(n,t);if(!(i===null||i.length===0))for(let a=0;a<Eo;a++){let a=new Map;for(let[n,i]of e){let e=t.get(n);e!==void 0&&a.set(n,{alias:n,level:e,x:i.x,y:i.y,height:r.get(n)??B})}let{sourceOffsets:o,targetOffsets:s}=ms(n,t,e=>a.get(e)?.y??0),c=vs(a,n,i,o,s);if(!c)return;for(let[t,n]of e)n.x===c.x&&(c.direction===1?n.y>=c.y:n.y<=c.y)&&e.set(t,{x:n.x,y:n.y+c.delta*c.direction})}}function bs(e,t){if(t.has(e.alias))return`flow`;let n=e.types[0]??``,r=typeof e.properties.skill==`string`?e.properties.skill:void 0;return n===`Dictionary`?`Dictionary`:n===`Provider`?`Provider`:r&&Go.has(r)?`Module`:r?`__unknown__`:`Entity`}function xs(e,t,n){let r=new Set;for(let e of t??[])r.add(e.source),r.add(e.target);let i=[],a=[],o=new Map;for(let t of e){let e=bs(t,r);o.set(t.alias,e),e===`flow`?i.push(t):a.push(t)}let s=new Set(i.map(e=>e.alias)),c=new Map(i.map(e=>[e.alias,e])),l=new Map,u=new Map,d=new Map;for(let e of i)l.set(e.alias,[]),u.set(e.alias,new Set),d.set(e.alias,0);for(let e of t??[])!s.has(e.source)||!s.has(e.target)||(l.get(e.source)?.push(e.target),u.get(e.source)?.add(e.target),u.get(e.target)?.add(e.source),d.set(e.target,(d.get(e.target)??0)+1));for(let e of l.values())e.sort();let f=i.filter(e=>d.get(e.alias)===0||e.types.includes(`entry_point`)||Jo(e)).map(e=>e.alias).sort(),p=new Set;{let e=new Map;for(let t of i)e.set(t.alias,0);function t(t){if(e.get(t)!==0)return;e.set(t,1);let n=[{node:t,childIdx:0}];for(;n.length>0;){let t=n[n.length-1],r=l.get(t.node)??[];if(t.childIdx>=r.length){e.set(t.node,2),n.pop();continue}let i=r[t.childIdx++],a=e.get(i);a===1?p.add(`${t.node}\t${i}`):a===0&&(e.set(i,1),n.push({node:i,childIdx:0}))}}for(let e of f)t(e);for(let e of[...s].sort())t(e)}let m=[],h=new Set;for(let e of Array.from(s).sort()){if(h.has(e))continue;let t=[],n=[e];for(h.add(e);n.length>0;){let e=n.pop();t.push(e);for(let t of u.get(e)??[])h.has(t)||(h.add(t),n.push(t))}t.sort();let r=t.map(e=>c.get(e)).filter(e=>!!e);m.push({aliases:t,nodes:r,hasRoot:r.some(Jo),hasEnd:r.some(Yo),sortKey:t[0]??``})}m.sort(Zo);let g=new Map;m.forEach((e,t)=>{e.aliases.forEach(e=>g.set(e,t))});let _=m.map(()=>[]);for(let e of t){let t=g.get(e.source),n=g.get(e.target);t!==void 0&&t===n&&_[t].push(e)}let v=new Map,y=new Map,b=0,x=0;for(let[e,t]of m.entries()){let r=new Set(t.aliases),i=t.nodes.filter(e=>d.get(e.alias)===0||e.types.includes(`entry_point`)||Jo(e)).map(e=>e.alias).sort();i.length===0&&t.aliases.length>0&&i.push(t.aliases[0]);let a=new Map,o=[...i];i.forEach(e=>a.set(e,0));let s=0;for(;s<o.length;){let e=o[s++],t=a.get(e)??0;for(let n of l.get(e)??[])r.has(n)&&(p.has(`${e}\t${n}`)||(!a.has(n)||a.get(n)<=t)&&(a.set(n,t+1),o.push(n)))}let c=a.size>0?Math.max(...a.values()):0;for(let e of t.aliases)a.has(e)||a.set(e,c+1);let u=_s(a,_[e],p,n),f=x;for(let[e,t]of[...u].sort(([e],[t])=>e-t)){let n=-(t.reduce((e,t)=>e+t.height,0)+Math.max(0,t.length-1)*mo)/2,r=b+e,i=x+e*360;f=Math.max(f,i);for(let e of t)e.alias&&(v.set(e.alias,r),y.set(e.alias,{x:i,y:n})),n+=e.height+mo}let m=a.size>0?Math.max(...a.values()):0;b+=m+1,x=f+po+ho}ys(y,v,t,n);let S=0;for(let[e,t]of y)S=Math.max(S,t.y+(n.get(e)??B));let C=S+(y.size>0?go:0),ee=new Map;for(let e of Ko)ee.set(e,[]);ee.set(`__unknown__`,[]);for(let e of a){let t=o.get(e.alias);ee.get(t).push(e.alias)}for(let e of[...Ko,`__unknown__`]){let t=(ee.get(e)??[]).slice().sort();if(t.length===0)continue;let r=t.reduce((e,t)=>Math.max(e,n.get(t)??B),0);t.forEach((e,t)=>{y.set(e,{x:0+t*360,y:C})}),C+=r+_o}return{positions:y,levelOf:v}}function Ss(e,t,n){let r=new Map,i=new Map;for(let e of t)r.set(e.source,(r.get(e.source)??0)+1),i.set(e.target,(i.get(e.target)??0)+1);return new Map(e.map(e=>{let t=Ro(Math.max(r.get(e.alias)??0,i.get(e.alias)??0),n?V:B);return[e.alias,n?t:Math.max(t,Wo(e))]}))}function Cs(e,t,n={}){let r=e.connections??[],i=Ss(e.nodes,r,n.compactNodes===!0);for(let[e,n]of t)i.has(e)&&Number.isFinite(n)&&n>0&&i.set(e,n);return xs(e.nodes,r,i).positions}function ws(e,t={}){let n=e.connections??[],r=t.supportsConnectionAuthoring===!0,i=t.compactNodes===!0,a=Ss(e.nodes,n,i),{positions:o,levelOf:s}=xs(e.nodes,n,a),c=new Set;for(let[e,t]of n.entries()){let n=s.get(t.source),r=s.get(t.target);n!==void 0&&r!==void 0&&n>=r&&c.add(e)}let u=new Map,d=new Map;for(let t of e.nodes)u.set(t.alias,[]),d.set(t.alias,[]);for(let[e,t]of n.entries()){let n=os(t);c.has(e)?(d.get(t.source).push({connIndex:e,peerAlias:t.target,isBack:!0,stableKey:n}),u.get(t.target).push({connIndex:e,peerAlias:t.source,isBack:!0,stableKey:n})):(u.get(t.source).push({connIndex:e,peerAlias:t.target,isBack:!1,stableKey:n}),d.get(t.target).push({connIndex:e,peerAlias:t.source,isBack:!1,stableKey:n}))}let f=e=>o.get(e)?.y??0,p=(e,t)=>f(e.peerAlias)-f(t.peerAlias)||e.peerAlias.localeCompare(t.peerAlias)||e.stableKey.localeCompare(t.stableKey)||e.connIndex-t.connIndex;for(let e of u.values())e.sort(p);for(let e of d.values())e.sort(p);let m=new Map,h=new Map,g=e.nodes.map(e=>{let t=u.get(e.alias)??[],n=d.get(e.alias)??[],s=Ro(Math.max(t.length,n.length),i?V:B),c=Math.max(s,a.get(e.alias)??B),l=[],f=[],p=0,g=0;for(let e=0;e<t.length;e++){let n=t[e],r=Lo(e,t.length);if(n.isBack){let e=Io(g++);f.push({id:e,offset:r}),h.set(n.connIndex,e)}else{let e=No(p++);l.push({id:e,offset:r}),m.set(n.connIndex,e)}}let _=[],v=[],y=0,b=0;for(let e=0;e<n.length;e++){let t=n[e],r=Lo(e,n.length);if(t.isBack){let e=Fo(b++);v.push({id:e,offset:r}),m.set(t.connIndex,e)}else{let e=Po(y++);_.push({id:e,offset:r}),h.set(t.connIndex,e)}}return{id:e.alias,type:e.types[0]??`default`,className:`nokey`,position:o.get(e.alias)??{x:0,y:0},width:po,...i?{height:c}:{initialHeight:c},style:{...$a(e.types[0]??`unknown`),minHeight:s},data:{alias:e.alias,nodeType:e.types[0]??`unknown`,properties:e.properties,sourceHandles:l,targetHandles:_,backSourceHandles:v,backTargetHandles:f,supportsConnectionAuthoring:r,compact:i,minHeight:s}}}),_=[];for(let[e,t]of n.entries()){let n=t.relations.map(e=>e.type),r=`${t.source}__${t.target}__${e}`,i=Mo(n);_.push({id:r,source:t.source,target:t.target,sourceHandle:m.get(e),targetHandle:h.get(e),label:n.join(`, `),type:`bezier`,markerEnd:{type:l.ArrowClosed,width:16,height:16,color:Oo},style:{stroke:Oo,strokeWidth:2},labelStyle:{fill:i,fontSize:10,fontWeight:700},labelBgStyle:{fill:ko,fillOpacity:.94,stroke:`rgba(15, 23, 42, 0.16)`,strokeWidth:1},labelBgPadding:[5,2],labelBgBorderRadius:6,data:{relationTypes:n}})}return{nodes:g,edges:_}}var Ts=`application/x-minigraph-clipboard-item`;function Es(e){return e.includes(Ts)}function Ds(e,t){e.effectAllowed=`copy`,e.setData(Ts,t)}function Os(e){let t=e?.getData(`application/x-minigraph-clipboard-item`)??``;return t.trim()?t:null}function ks(e,t){return e.nodes.find(e=>e.alias===t)}function As(e,t){return(e.connections??[]).filter(e=>e.source!==e.target&&(e.source===t||e.target===t))}var js={toolbar:`_toolbar_19yq4_2`,nameGroup:`_nameGroup_19yq4_17`,graphName:`_graphName_19yq4_24`,stats:`_stats_19yq4_33`,toolbarActions:`_toolbarActions_19yq4_53`,toolbarButton:`_toolbarButton_19yq4_59`};function Ms({graphData:e,graphName:t,onCopySuccess:n,onCopyError:r,extraActions:i}){let a=(0,P.useCallback)(()=>{e&&navigator.clipboard.writeText(JSON.stringify(e,null,2)).then(()=>n?.()).catch(()=>r?.())},[e,n,r]),o=e?.nodes.length??0,s=(e?.connections??[]).length;return(0,I.jsxs)(`div`,{className:js.toolbar,children:[(0,I.jsxs)(`div`,{className:js.nameGroup,children:[(0,I.jsx)(`span`,{className:js.graphName,children:t??`Untitled`}),(0,I.jsxs)(`span`,{className:js.stats,children:[o,` node`,o===1?``:`s`,` · `,s,` connection`,s===1?``:`s`]})]}),(0,I.jsxs)(`div`,{className:js.toolbarActions,children:[i,(0,I.jsx)(`button`,{className:js.toolbarButton,onClick:a,title:`Copy raw graph JSON to clipboard`,"aria-label":`Copy raw graph JSON to clipboard`,children:`📑`})]})]})}var Ns={menu:`_menu_13qxg_1`,menuItem:`_menuItem_13qxg_12`};function Ps({open:e,x:t,y:n,canCreateNode:r,onCreateNode:i,onClose:a}){let o=(0,P.useRef)(null),s=(0,P.useRef)(null);return(0,P.useEffect)(()=>{if(!e)return;s.current?.focus();let t=e=>{o.current&&!o.current.contains(e.target)&&a()},n=e=>{e.key===`Escape`&&(e.preventDefault(),a())};return document.addEventListener(`pointerdown`,t),document.addEventListener(`keydown`,n),()=>{document.removeEventListener(`pointerdown`,t),document.removeEventListener(`keydown`,n)}},[e,a]),e?(0,I.jsx)(`div`,{ref:o,className:Ns.menu,style:{left:t,top:n},role:`menu`,"aria-label":`Graph actions`,children:(0,I.jsx)(`button`,{ref:s,role:`menuitem`,type:`button`,className:Ns.menuItem,disabled:!r,onClick:()=>{r&&(i(),a())},children:`Create Node`})}):null}var Fs={menu:`_menu_1trgd_1`,menuItem:`_menuItem_1trgd_12`,dangerItem:`_dangerItem_1trgd_38`,confirmation:`_confirmation_1trgd_51`,confirmationText:`_confirmationText_1trgd_57`,confirmationActions:`_confirmationActions_1trgd_65`},Is=8;function Ls(e){let{open:t,x:n,y:r,onClose:i}=e,[a,o]=(0,P.useState)(!1),[s,c]=(0,P.useState)({left:n,top:r}),l=(0,P.useRef)(null),u=(0,P.useRef)(null),d=(0,P.useRef)(null),f=e.mode===`multi-node`?e.selectedCount:null,p=f!==null&&f>1,m=e.mode===`multi-node`?p&&e.canClipSelectedNodes:e.canClipNode,h=e.mode===`single-node`&&e.canConnectNode,g=e.mode===`single-node`&&e.canEditNode,_=e.mode===`multi-node`?p&&e.canDeleteSelectedNodes:e.canDeleteNode,v=m||h||g||_,y=p?`${f} selected nodes`:e.mode===`single-node`?e.nodeAlias:``;return(0,P.useLayoutEffect)(()=>{t&&o(!1)},[t,y,n,r]),(0,P.useLayoutEffect)(()=>{if(!t)return;let e=l.current;if(!e){c({left:n,top:r});return}let i=e.getBoundingClientRect(),a=Math.max(Is,window.innerWidth-i.width-Is),o=Math.max(Is,window.innerHeight-i.height-Is);c({left:Math.min(Math.max(n,Is),a),top:Math.min(Math.max(r,Is),o)})},[m,_,g,a,t,y,n,r]),(0,P.useEffect)(()=>{if(!t){o(!1);return}a?d.current?.focus():u.current?.focus()},[a,t]),(0,P.useEffect)(()=>{if(!t)return;let e=e=>{l.current&&!l.current.contains(e.target)&&i()},n=e=>{e.key===`Escape`&&(e.preventDefault(),i())},r=()=>i();return document.addEventListener(`pointerdown`,e),document.addEventListener(`keydown`,n),window.addEventListener(`scroll`,r,!0),window.addEventListener(`resize`,r),()=>{document.removeEventListener(`pointerdown`,e),document.removeEventListener(`keydown`,n),window.removeEventListener(`scroll`,r,!0),window.removeEventListener(`resize`,r)}},[i,t]),!t||!v?null:(0,I.jsx)(`div`,{ref:l,className:Fs.menu,style:{left:s.left,top:s.top},role:`menu`,"aria-label":p?`Actions for ${f} selected nodes`:`Node actions for ${y}`,children:a?(0,I.jsxs)(`div`,{className:Fs.confirmation,role:`group`,"aria-label":`Confirm delete ${y}`,children:[(0,I.jsx)(`div`,{className:Fs.confirmationText,children:p?`Delete ${f} selected nodes?`:`Delete "${y}"?`}),(0,I.jsxs)(`div`,{className:Fs.confirmationActions,children:[(0,I.jsx)(`button`,{ref:d,type:`button`,className:`${Fs.menuItem} ${Fs.dangerItem}`,onClick:()=>{e.mode===`multi-node`?e.onDeleteSelectedNodes():e.onDeleteNode(),i()},children:`Delete`}),(0,I.jsx)(`button`,{type:`button`,className:Fs.menuItem,onClick:()=>o(!1),children:`Cancel`})]})]}):(0,I.jsxs)(I.Fragment,{children:[m&&(0,I.jsx)(`button`,{ref:u,role:`menuitem`,type:`button`,className:Fs.menuItem,onClick:()=>{e.mode===`multi-node`?e.onClipSelectedNodes():e.onClipNode(),i()},children:p?`Clip ${f} selected nodes to Workspace`:`Clip to Workspace`}),h&&e.mode===`single-node`&&(0,I.jsx)(`button`,{ref:m?void 0:u,role:`menuitem`,type:`button`,className:Fs.menuItem,onClick:()=>{e.onConnectNode(),i()},children:`Connect to…`}),g&&e.mode===`single-node`&&(0,I.jsx)(`button`,{ref:m||h?void 0:u,role:`menuitem`,type:`button`,className:Fs.menuItem,onClick:()=>{e.onEditNode(),i()},children:`Edit Node`}),_&&(0,I.jsx)(`button`,{ref:!m&&!h&&!g?u:void 0,role:`menuitem`,type:`button`,className:`${Fs.menuItem} ${Fs.dangerItem}`,onClick:()=>o(!0),children:p?`Delete ${f} selected nodes`:`Delete Node`})]})})}var Rs={tip:`_tip_a9o1b_1`,fading:`_fading_a9o1b_11`,tipButton:`_tipButton_a9o1b_15`};function zs({visible:e,fading:t,onDismiss:n}){return e?(0,I.jsx)(`div`,{className:`${Rs.tip}${t?` ${Rs.fading}`:``}`,role:`status`,children:(0,I.jsx)(`button`,{type:`button`,className:Rs.tipButton,onClick:n,children:`Multi-select: Shift/Ctrl/Cmd + click nodes, or Shift + drag on the canvas.`})}):null}function Bs(e){return e.trim().toLowerCase()}function Vs(e){let t=new Set;return e.filter(e=>{let n=Bs(e);return t.has(n)?!1:(t.add(n),!0)})}function Hs(e,t){let n=Vs(t),r=Bs(e);return n.length>1&&n.some(e=>Bs(e)===r)?{kind:`multi-node`,aliases:n}:{kind:`single-node`,alias:e}}function Us(e,t){let n=new Map(t.nodes.map(e=>[Bs(e.alias),e]));return Vs(e).map(e=>n.get(Bs(e))).filter(e=>e!==void 0)}var Ws=[],Gs=[],Ks=[`Shift`,`Control`,`Meta`];function qs(e,t){return e.length===t.length&&e.every((e,n)=>e===t[n])}function Js({graphData:e,graphName:t,onCopySuccess:n,onCopyError:r,onRenderError:i,isRefreshing:a=!1,onClipNode:o,onClipNodes:s,onClipboardDrop:c,isConnected:l,supportsAuthoring:u=!1,onCreateNode:p,onCreateConnection:h,onEditNode:x,onDeleteNode:S,onDeleteNodes:C,onDeleteConnection:ee,panelLayoutKey:te}){let[w,T]=(0,P.useState)(null),[E,ne]=(0,P.useState)(null),[re,D]=(0,P.useState)([]),[ie,ae]=(0,P.useState)(!1),[oe,O]=(0,P.useState)(!1),[k,A]=(0,P.useState)(!1),j=(0,P.useRef)(0),se=(0,P.useRef)(!1),ce=(0,P.useRef)(null),le=!!(u&&p&&l),M=!!(u&&h&&l),N=!!o,ue=!!s,de=!!(u&&x&&l),fe=!!(u&&S&&l),pe=!!(u&&C&&l),me=N||de||fe||M,he=ue||pe,ge=me||he,_e=!!(c&&l),ve=(0,P.useCallback)(()=>{j.current=0,ae(!1)},[]);(0,P.useEffect)(()=>{if(!E)return;let e=e=>{e.key===`Escape`&&ne(null)},t=()=>ne(null);return document.addEventListener(`keydown`,e),window.addEventListener(`scroll`,t,!0),window.addEventListener(`resize`,t),()=>{document.removeEventListener(`keydown`,e),window.removeEventListener(`scroll`,t,!0),window.removeEventListener(`resize`,t)}},[E]),(0,P.useEffect)(()=>{let e=()=>ve();return window.addEventListener(`dragend`,e),window.addEventListener(`drop`,e),()=>{window.removeEventListener(`dragend`,e),window.removeEventListener(`drop`,e),ve()}},[ve]);let ye=(0,P.useRef)(i);(0,P.useEffect)(()=>{ye.current=i},[i]);let[be,xe]=hr(`graph-nodes-compact`,!1),{nodes:Se,edges:Ce,transformError:we}=(0,P.useMemo)(()=>{if(!e)return{nodes:Ws,edges:Gs,transformError:null};try{return{...ws(e,{supportsConnectionAuthoring:M,compactNodes:be}),transformError:null}}catch(e){return{nodes:Ws,edges:Gs,transformError:e instanceof Error?e.message:String(e)}}},[M,be,e]);(0,P.useEffect)(()=>{we&&ye.current?.(`Graph render failed: ${we}`)},[we]);let Te=(0,P.useMemo)(()=>e?JSON.stringify(e.nodes.map(e=>e.alias)):`empty`,[e]),[Ee,De,Oe]=b(Se),[ke,Ae,je]=f(Ce),Me=(0,P.useRef)(null),Ne=!!(e&&e.nodes.length>0),Pe=(0,P.useCallback)(({nodes:e})=>{let t=e.map(e=>e.data.alias);D(e=>qs(e,t)?e:t)},[]);(0,P.useEffect)(()=>{De(Se),Ae(Ce),D([]),T(null)},[Se,Ce,De,Ae]);let Fe=(0,P.useRef)(null),Ie=(0,P.useRef)(null);(0,P.useEffect)(()=>{if(!e||e.nodes.length===0)return;let t=Ie.current;if(t&&t.graph===e&&t.compact===be)return;let n=new Map(e.nodes.map(e=>[e.alias,e.properties]));if(!(Ee.length===n.size&&Ee.every(e=>n.get(e.id)===e.data.properties&&e.data.compact===be)))return;let r=new Map;for(let e of Ee){let t=e.measured?.height;if(typeof t!=`number`)return;r.set(e.id,t)}Ie.current={graph:e,compact:be};let i=Cs(e,r,{compactNodes:be});Ee.some(e=>{let t=i.get(e.id);return t!==void 0&&(t.x!==e.position.x||t.y!==e.position.y)})&&De(e=>e.map(e=>{let t=i.get(e.id);return t?{...e,position:t}:e})),requestAnimationFrame(()=>{Fe.current?.fitView({padding:.25})})},[be,e,Ee,De]);let Le=(0,P.useCallback)(()=>{!oe||k||(A(!0),ce.current!==null&&clearTimeout(ce.current),ce.current=setTimeout(()=>{O(!1),ce.current=null},400))},[k,oe]);(0,P.useEffect)(()=>{!Ne||we||se.current||(se.current=!0,A(!1),O(!0))},[Ne,we]),(0,P.useEffect)(()=>{if(!oe||k)return;let e=setTimeout(Le,5e3);return()=>clearTimeout(e)},[Le,k,oe]),(0,P.useEffect)(()=>()=>{ce.current!==null&&clearTimeout(ce.current)},[]);let Re=e=>{_e&&Es(Array.from(e.dataTransfer.types))&&(e.preventDefault(),j.current+=1,ae(!0))},ze=e=>{_e&&Es(Array.from(e.dataTransfer.types))&&(e.preventDefault(),e.dataTransfer.dropEffect=`copy`,ae(!0))},Be=e=>{Es(Array.from(e.dataTransfer.types))&&(j.current=Math.max(0,j.current-1),j.current===0&&ae(!1))},Ve=e=>{if(!_e||!Es(Array.from(e.dataTransfer.types)))return;e.preventDefault();let t=Os(e.dataTransfer);ve(),t&&c?.(t)},He=(0,P.useMemo)(()=>new Set(e?.nodes.map(e=>e.alias)??[]),[e]),Ue=w?.target.kind===`single-node`&&e?ks(e,w.target.alias):null,We=w?.target.kind===`multi-node`?w.target.aliases:[],Ge=e?Us(We,e):[],Ke=(0,P.useCallback)(e=>!M||!e.source||!e.target||e.source===e.target||!He.has(e.source)||!He.has(e.target)?!1:e.sourceHandle===`authoring-source`&&e.targetHandle===`authoring-target`,[M,He]),qe=(0,P.useRef)(null);(0,P.useEffect)(()=>{let e=e=>{qe.current={x:e.clientX,y:e.clientY}};return document.addEventListener(`pointerup`,e,!0),()=>document.removeEventListener(`pointerup`,e,!0)},[]);let Je=(0,P.useCallback)(e=>{Ke(e)&&(!e.source||!e.target||h?.(e.source,e.target,qe.current??void 0))},[Ke,h]),[Ye,Xe]=(0,P.useState)(null);(0,P.useEffect)(()=>{Xe(null)},[e,M]),(0,P.useEffect)(()=>{if(Ye===null)return;let e=e=>{e.key===`Escape`&&(e.preventDefault(),Xe(null))};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[Ye]);let Ze=(0,P.useCallback)((e,t)=>{t.handleId!==`authoring-source`||t.handleType!==`source`||(Me.current=t.nodeId,T(null),ne(null))},[]),Qe=(0,P.useCallback)(()=>{Me.current=null},[]),$e=(0,P.useRef)(te);(0,P.useEffect)(()=>{if($e.current===te||($e.current=te,!Ne))return;let e=null,t=requestAnimationFrame(()=>{e=requestAnimationFrame(()=>{Fe.current?.fitView({padding:.25})})});return()=>{cancelAnimationFrame(t),e!==null&&cancelAnimationFrame(e)}},[Ne,te]);let et=!!(u&&ee&&l),tt=(0,P.useCallback)(async({edges:e})=>{if(et&&e.length>0){let t=new Set;for(let n of e){let e=`${n.source}\t${n.target}`;t.has(e)||(t.add(e),ee?.(n.source,n.target))}}return!1},[et,ee]);return we?(0,I.jsxs)(`div`,{className:z.empty,children:[(0,I.jsx)(`span`,{className:z.emptyIcon,children:`⚠️`}),(0,I.jsx)(`span`,{children:`Graph could not be rendered.`}),(0,I.jsx)(`span`,{children:we})]}):(0,I.jsx)(oo,{onRenderError:i,children:(0,I.jsxs)(`div`,{className:z.graphWrapper,"aria-busy":a,children:[Ne&&e&&(0,I.jsx)(Ms,{graphData:e,graphName:t,onCopySuccess:n,onCopyError:r}),(0,I.jsxs)(`div`,{className:z.graphSurface,"data-connect-picking":Ye!==null||void 0,onDragEnter:Re,onDragOver:ze,onDragLeave:Be,onDrop:Ve,onWheelCapture:Le,children:[Ne?(0,I.jsxs)(v,{nodes:Ee,edges:ke,onInit:e=>{Fe.current=e},onNodesChange:Oe,onEdgesChange:je,nodesConnectable:M,edgesReconnectable:!1,connectOnClick:!1,isValidConnection:Ke,onConnect:Je,onConnectStart:Ze,onConnectEnd:Qe,deleteKeyCode:[`Delete`,`Backspace`],onBeforeDelete:tt,nodeTypes:ao,fitView:!0,fitViewOptions:{padding:.25},minZoom:.2,maxZoom:2.5,selectionKeyCode:`Shift`,multiSelectionKeyCode:Ks,selectionOnDrag:!1,selectionMode:g.Partial,proOptions:{hideAttribution:!1},onSelectionChange:Pe,onNodeContextMenu:(e,t)=>{if(e.preventDefault(),e.stopPropagation(),Le(),ne(null),!ge)return;let n=Hs(t.data.alias,re);n.kind===`single-node`&&re.length>1&&(De(e=>e.map(e=>({...e,selected:e.data.alias===t.data.alias}))),D([t.data.alias])),T({x:e.clientX,y:e.clientY,target:n})},onPaneContextMenu:e=>{e.preventDefault(),Le(),T(null),le&&ne({x:e.clientX,y:e.clientY})},onPaneClick:()=>{Le(),T(null),ne(null),Xe(null)},onNodeClick:(e,t)=>{if(Le(),Ye===null)return;e.preventDefault(),e.stopPropagation();let n=t.data.alias;n!==Ye&&h?.(Ye,n,{x:e.clientX,y:e.clientY}),Xe(null)},onNodeDragStart:()=>Le(),onSelectionStart:()=>Le(),onMoveStart:e=>{e&&Le()},children:[(0,I.jsx)(y,{variant:m.Dots,gap:18,size:1,color:`rgba(255,255,255,0.07)`}),(0,I.jsx)(d,{showInteractive:!1,children:(0,I.jsx)(_,{onClick:()=>xe(e=>!e),title:be?`Show node details`:`Show thumbnail nodes`,"aria-label":be?`Show node details`:`Show thumbnail nodes`,"aria-pressed":be,children:(0,I.jsxs)(`span`,{className:z.detailToggleIcon,"aria-hidden":`true`,children:[(0,I.jsx)(`span`,{className:z.detailToggleHeader}),be&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`span`,{className:z.detailToggleLine}),(0,I.jsx)(`span`,{className:z.detailToggleLine}),(0,I.jsx)(`span`,{className:z.detailToggleLine})]})]})})})]}):(0,I.jsxs)(`div`,{className:z.empty,children:[(0,I.jsx)(`span`,{className:z.emptyIcon,children:`🕸️`}),(0,I.jsx)(`span`,{children:`No graph data yet.`}),(0,I.jsxs)(`span`,{children:[`Run `,(0,I.jsx)(`strong`,{children:`describe graph`}),` or `,(0,I.jsx)(`strong`,{children:`export graph`}),` in the playground.`]}),u&&p&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`button`,{type:`button`,className:z.emptyCreateButton,disabled:!l,onClick:()=>p(`empty-graph`),children:`Create Node`}),!l&&(0,I.jsx)(`span`,{className:z.emptyHint,children:`Connect WebSocket to create a node.`})]})]}),(0,I.jsx)(zs,{visible:oe,fading:k,onDismiss:Le}),Ye!==null&&(0,I.jsxs)(`div`,{className:z.connectBanner,role:`status`,children:[(0,I.jsxs)(`span`,{children:[`Connecting from `,(0,I.jsx)(`strong`,{children:Ye}),` — click a target node`]}),(0,I.jsx)(`button`,{type:`button`,className:z.connectBannerCancel,onClick:()=>Xe(null),children:`Cancel (Esc)`})]}),a&&(0,I.jsx)(`div`,{className:z.refreshingOverlay,children:(0,I.jsx)(`div`,{className:z.refreshingSpinner,role:`status`,"aria-label":`Graph refreshing`})}),ie&&(0,I.jsx)(`div`,{className:z.clipboardDropOverlay,children:(0,I.jsx)(`div`,{className:z.clipboardDropMessage,children:`Drop to paste workspace node`})}),(0,I.jsx)(Ps,{open:E!==null,x:E?.x??0,y:E?.y??0,canCreateNode:le,onCreateNode:()=>p?.(`pane-context-menu`),onClose:()=>ne(null)}),w?.target.kind===`multi-node`?(0,I.jsx)(Ls,{mode:`multi-node`,open:Ge.length>1&&he,x:w.x,y:w.y,selectedCount:We.length,canClipSelectedNodes:ue,canDeleteSelectedNodes:pe,onClipSelectedNodes:()=>{if(!e){s?.([]);return}let t=Ge.map(t=>({node:t,connections:As(e,t.alias)}));s?.(t)},onDeleteSelectedNodes:()=>{let e=Ge.length===We.length;C?.(e?Ge:[])},onClose:()=>T(null)}):(0,I.jsx)(Ls,{mode:`single-node`,open:w!==null&&Ue!==null&&me,x:w?.x??0,y:w?.y??0,nodeAlias:w?.target.kind===`single-node`?w.target.alias:``,canClipNode:N&&Ue!==null,canConnectNode:M&&Ue!==null,canEditNode:de&&Ue!==null,canDeleteNode:fe&&Ue!==null,onConnectNode:()=>{Ue&&Xe(Ue.alias)},onClipNode:()=>{if(!Ue||!e)return;let t=As(e,Ue.alias);o?.(Ue,t)},onEditNode:()=>{Ue&&x?.(Ue)},onDeleteNode:()=>{Ue&&S?.(Ue)},onClose:()=>T(null)})]})]})},Te)}var Ys={root:`_root_1yhjs_2`,empty:`_empty_1yhjs_10`,emptyIcon:`_emptyIcon_1yhjs_23`,toolbarButton:`_toolbarButton_1yhjs_29 _toolbarButton_19yq4_59`,scrollBody:`_scrollBody_1yhjs_34`,jsonContainer:`_jsonContainer_1yhjs_45`,jsonLabel:`_jsonLabel_1yhjs_46`,jsonString:`_jsonString_1yhjs_47`,jsonNumber:`_jsonNumber_1yhjs_48`,jsonBoolean:`_jsonBoolean_1yhjs_49`,jsonNull:`_jsonNull_1yhjs_50`},Xs={default:e=>e<3,all:i,none:a};function Zs({graphData:e,graphName:t,onCopySuccess:n,onCopyError:i}){let[a,s]=(0,P.useState)(`all`);return e?(0,I.jsxs)(`div`,{className:Ys.root,children:[(0,I.jsx)(Ms,{graphData:e,graphName:t,onCopySuccess:n,onCopyError:i,extraActions:(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`button`,{className:Ys.toolbarButton,onClick:()=>s(`all`),title:`Expand all nodes`,"aria-label":`Expand all JSON nodes`,"aria-pressed":a===`all`,children:`➖`}),(0,I.jsx)(`button`,{className:Ys.toolbarButton,onClick:()=>s(`none`),title:`Collapse all nodes`,"aria-label":`Collapse all JSON nodes`,"aria-pressed":a===`none`,children:`➕`})]})}),(0,I.jsx)(`div`,{className:Ys.scrollBody,children:(0,I.jsx)(o,{data:e,shouldExpandNode:Xs[a],style:{...r,container:`${r.container} ${Ys.jsonContainer}`,label:Ys.jsonLabel,stringValue:Ys.jsonString,numberValue:Ys.jsonNumber,booleanValue:Ys.jsonBoolean,nullValue:Ys.jsonNull}})})]}):(0,I.jsx)(`div`,{className:Ys.root,children:(0,I.jsxs)(`div`,{className:Ys.empty,children:[(0,I.jsx)(`span`,{className:Ys.emptyIcon,children:`🕸️`}),(0,I.jsx)(`span`,{children:`No graph data yet.`}),(0,I.jsx)(`span`,{children:`Pin a graph-link message in the Console to load the raw data here.`})]})})}var Qs={rightPanel:`_rightPanel_xa3j1_2`,tabStrip:`_tabStrip_xa3j1_10`,tab:`_tab_xa3j1_10`,tabActive:`_tabActive_xa3j1_41`,tabBadge:`_tabBadge_xa3j1_45`,tabBody:`_tabBody_xa3j1_51`,tabBodyHidden:`_tabBodyHidden_xa3j1_64`,graphContent:`_graphContent_xa3j1_68`,rightPanelGroup:`_rightPanelGroup_xa3j1_75`,verticalResizeHandle:`_verticalResizeHandle_xa3j1_83`},$s=`help-split-percent`,ec=`help-split-maximized`,tc=45,nc=98;function rc({tabs:e,payload:t,onChange:n,validation:r,onFormat:i,onUpload:a,graphData:o,graphName:s,activeTab:c,onTabChange:l,onGraphRenderError:u,onGraphDataCopySuccess:d,onGraphDataCopyError:f,isGraphRefreshing:p,onClipNode:m,onClipNodes:h,onClipboardDrop:g,isConnected:_,supportsAuthoring:v,onCreateNode:y,onCreateConnection:b,onEditNode:x,onDeleteNode:S,onDeleteNodes:C,onDeleteConnection:w,panelLayoutKey:E,helpPanel:ne}){let re=(0,P.useId)(),D=`${re}-tab-payload`,ie=`${re}-tab-graph`,ae=`${re}-tab-graph-data`,oe=(0,I.jsxs)(`div`,{className:Qs.rightPanel,children:[(0,I.jsxs)(`div`,{className:Qs.tabStrip,role:`tablist`,"aria-label":`Right panel tabs`,children:[e.includes(`payload`)&&(0,I.jsx)(`button`,{role:`tab`,"aria-selected":c===`payload`,"aria-controls":D,className:`${Qs.tab}${c===`payload`?` ${Qs.tabActive}`:``}`,onClick:()=>l(`payload`),children:`Payload Editor`}),e.includes(`graph`)&&(0,I.jsxs)(`button`,{role:`tab`,"aria-selected":c===`graph`,"aria-controls":ie,className:`${Qs.tab}${c===`graph`?` ${Qs.tabActive}`:``}`,onClick:()=>l(`graph`),children:[`Graph`,o!==null&&(0,I.jsx)(`span`,{className:Qs.tabBadge,"aria-label":`Graph data available`,children:`🕸️`})]}),e.includes(`graph-data`)&&(0,I.jsx)(`button`,{role:`tab`,"aria-selected":c===`graph-data`,"aria-controls":ae,className:`${Qs.tab}${c===`graph-data`?` ${Qs.tabActive}`:``}`,onClick:()=>l(`graph-data`),children:`Graph Data (Raw)`})]}),e.includes(`payload`)&&(0,I.jsx)(`div`,{role:`tabpanel`,id:D,tabIndex:c===`payload`?0:-1,className:`${Qs.tabBody}${c===`payload`?``:` ${Qs.tabBodyHidden}`}`,children:(0,I.jsx)(Ka,{payload:t,onChange:n,validation:r,onFormat:i,onUpload:a})}),e.includes(`graph`)&&(0,I.jsx)(`div`,{role:`tabpanel`,id:ie,tabIndex:c===`graph`?0:-1,className:`${Qs.tabBody}${c===`graph`?``:` ${Qs.tabBodyHidden}`}`,children:(0,I.jsx)(`div`,{className:Qs.graphContent,children:(0,I.jsx)(Js,{graphData:o,graphName:s,onRenderError:u,isRefreshing:p,onCopySuccess:d,onCopyError:f,onClipNode:m,onClipNodes:h,onClipboardDrop:g,isConnected:_,supportsAuthoring:v,onCreateNode:y,onCreateConnection:b,onEditNode:x,onDeleteNode:S,onDeleteNodes:C,onDeleteConnection:w,panelLayoutKey:E})})}),e.includes(`graph-data`)&&(0,I.jsx)(`div`,{role:`tabpanel`,id:ae,tabIndex:c===`graph-data`?0:-1,className:`${Qs.tabBody}${c===`graph-data`?``:` ${Qs.tabBodyHidden}`}`,children:(0,I.jsx)(Zs,{graphData:o,graphName:s,onCopySuccess:d,onCopyError:f})})]}),O=(0,P.useRef)(Number(sessionStorage.getItem($s))||tc),k=(0,P.useRef)(null),A=(0,P.useRef)(null),[j,se]=(0,P.useState)(()=>sessionStorage.getItem(ec)===`1`),ce=(0,P.useRef)(j),le=(0,P.useCallback)(e=>{let t=e[`help-split-help`];if(t===void 0)return;let n=t>=nc;n!==ce.current&&(ce.current=n,se(n),sessionStorage.setItem(ec,n?`1`:`0`)),n||(O.current=t,sessionStorage.setItem($s,String(t)))},[]),M=(0,P.useCallback)(()=>{let e=!ce.current;if(ce.current=e,se(e),sessionStorage.setItem(ec,e?`1`:`0`),e)A.current?.resize(`0%`),k.current?.resize(`100%`);else{let e=O.current;k.current?.resize(`${e}%`),A.current?.resize(`${100-e}%`)}},[]),N=!!ne;if((0,P.useEffect)(()=>{N&&ce.current&&requestAnimationFrame(()=>{A.current?.resize(`0%`),k.current?.resize(`100%`)})},[N]),!ne)return oe;let ue=typeof ne==`function`?ne(M,j):ne,de=ce.current?100:O.current,fe=100-de;return(0,I.jsxs)(T,{orientation:`vertical`,className:Qs.rightPanelGroup,onLayoutChanged:le,children:[(0,I.jsx)(te,{panelRef:A,defaultSize:`${fe}%`,minSize:`0%`,children:oe}),(0,I.jsx)(ee,{className:Qs.verticalResizeHandle,"aria-label":`Resize help panel`}),(0,I.jsx)(te,{id:`help-split-help`,panelRef:k,defaultSize:`${de}%`,minSize:`15%`,children:ue})]})}var ic=class extends P.Component{constructor(...e){super(...e),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(e,t){console.error(`[ConsoleErrorBoundary] Failed to render message:`,e,t.componentStack)}render(){return this.state.hasError?(0,I.jsx)(`span`,{children:this.props.fallback}):this.props.children}},ac=2e3,oc=(e={})=>{let{onSuccess:t,onError:n}=e,[r,i]=(0,P.useState)(!1),a=(0,P.useRef)(null);return(0,P.useEffect)(()=>()=>{a.current!==null&&clearTimeout(a.current)},[]),{copy:(0,P.useCallback)(async e=>{if(!navigator.clipboard)return console.warn(`useCopyToClipboard: Clipboard API not available in this browser.`),n?.(),!1;try{return await navigator.clipboard.writeText(e),i(!0),a.current!==null&&clearTimeout(a.current),a.current=setTimeout(()=>{a.current=null,i(!1)},ac),t?.(),!0}catch(e){return console.error(`useCopyToClipboard: Failed to write to clipboard.`,e),n?.(),!1}},[t,n]),copied:r}},H={consoleRoot:`_consoleRoot_1lgp1_2`,consoleHeader:`_consoleHeader_1lgp1_10`,consoleTitle:`_consoleTitle_1lgp1_20`,consoleControls:`_consoleControls_1lgp1_25`,controlButton:`_controlButton_1lgp1_30`,console:`_console_1lgp1_2`,emptyConsole:`_emptyConsole_1lgp1_67`,consoleMessage:`_consoleMessage_1lgp1_80`,consoleMessageActivatable:`_consoleMessageActivatable_1lgp1_94`,consoleMessageGraphLink:`_consoleMessageGraphLink_1lgp1_104`,consoleMessageLargePayload:`_consoleMessageLargePayload_1lgp1_115`,consoleMessageMockUpload:`_consoleMessageMockUpload_1lgp1_122`,uploadMockButton:`_uploadMockButton_1lgp1_131`,copyButton:`_copyButton_1lgp1_172`,copyButtonCopied:`_copyButtonCopied_1lgp1_225`,sendToJsonPathButton:`_sendToJsonPathButton_1lgp1_234`,messageIcon:`_messageIcon_1lgp1_268`,messageContent:`_messageContent_1lgp1_272`,messageText:`_messageText_1lgp1_278`,messageTime:`_messageTime_1lgp1_283`,"messageType-error":`_messageType-error_1lgp1_290`,"messageType-info":`_messageType-info_1lgp1_291`,"messageType-welcome":`_messageType-welcome_1lgp1_292`,jsonViewWrapper:`_jsonViewWrapper_1lgp1_295`,jsonContainer:`_jsonContainer_1lgp1_301`,jsonLabel:`_jsonLabel_1lgp1_302`,jsonString:`_jsonString_1lgp1_303`,jsonNumber:`_jsonNumber_1lgp1_304`,jsonBoolean:`_jsonBoolean_1lgp1_305`,jsonNull:`_jsonNull_1lgp1_306`};function sc({message:e,msgId:t,classificationMap:n,onGraphLink:i,onCopyMessage:a,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l}){let u=Tr(e),d=Er(u.type),f=Dr(u.message),p=(t===void 0?void 0:n?.get(t))??[],m=p.some(e=>e.kind===`graph.link`),h=p.some(e=>e.kind===`payload.large`),g=p.some(e=>e.kind===`upload.invitation`),_=p.find(e=>e.kind===`upload.invitation`)?.uploadPath??null,v=!!c&&g&&_!==null,y=v&&!!l?.has(_),b=!!i&&m&&!g&&!h,x=!!s&&f.isJSON,{copy:S,copied:C}=oc({onSuccess:a}),ee=t=>{t.stopPropagation(),S(e)},te=t=>{(t.key===`Enter`||t.key===` `)&&(t.preventDefault(),t.stopPropagation(),S(e))},w=e=>{e.stopPropagation(),!(!s||!f.isJSON)&&s(JSON.stringify(f.data,null,2))},T=e=>{e.stopPropagation(),!(!c||!_)&&c(_)};return(0,I.jsxs)(`div`,{className:[H.consoleMessage,H[`messageType-${u.type}`],b?H.consoleMessageActivatable:``,m?H.consoleMessageGraphLink:``,h?H.consoleMessageLargePayload:``,g?H.consoleMessageMockUpload:``].filter(Boolean).join(` `),onClick:b?()=>i():void 0,title:b?`Click to load graph in Graph View`:void 0,role:b?`button`:void 0,tabIndex:b?0:void 0,onKeyDown:b?e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),i())}:void 0,"aria-label":b?`Load graph in Graph View`:void 0,children:[(0,I.jsx)(`span`,{className:H.messageIcon,children:g?`⬆️`:h?`⬇️`:m?`🕸️`:d}),(0,I.jsx)(`div`,{className:H.messageContent,children:f.isJSON?(0,I.jsx)(`div`,{className:H.jsonViewWrapper,children:(0,I.jsx)(o,{data:f.data,shouldExpandNode:e=>e<1,style:{...r,container:`${r.container} ${H.jsonContainer}`,label:H.jsonLabel,stringValue:H.jsonString,numberValue:H.jsonNumber,booleanValue:H.jsonBoolean,nullValue:H.jsonNull}})}):(0,I.jsxs)(`span`,{className:H.messageText,children:[u.message,y&&(0,I.jsx)(`span`,{title:`Upload succeeded`,children:` ✅`})]})}),(0,I.jsx)(`button`,{className:`${H.copyButton} ${C?H.copyButtonCopied:``}`,onClick:ee,onKeyDown:te,title:C?`Copied!`:`Copy message`,"aria-label":C?`Copied to clipboard`:`Copy message to clipboard`,tabIndex:0,children:C?`✅`:`📄`}),x&&(0,I.jsx)(`button`,{className:H.sendToJsonPathButton,onClick:w,onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&w(e)},title:`Open in JSON-Path Playground`,"aria-label":`Open this JSON in the JSON-Path Playground`,tabIndex:0,children:`➡️`}),v&&(0,I.jsx)(`button`,{className:H.uploadMockButton,onClick:T,onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&T(e)},title:`Re-open upload dialog`,"aria-label":`Re-open mock data upload dialog`,tabIndex:0,children:`⬆️ Upload JSON…`}),u.time&&(0,I.jsx)(`span`,{className:H.messageTime,children:u.time})]})}function cc({messages:e,classificationMap:t,onCopy:n,onClear:r,consoleRef:i,onGraphLinkMessage:a,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l}){return(0,I.jsxs)(`div`,{className:H.consoleRoot,children:[(0,I.jsxs)(`div`,{className:H.consoleHeader,children:[(0,I.jsx)(`span`,{className:H.consoleTitle,children:`Console Output`}),(0,I.jsxs)(`div`,{className:H.consoleControls,children:[(0,I.jsx)(`button`,{className:H.controlButton,onClick:n,title:`Copy console output`,"aria-label":`Copy console output to clipboard`,children:`📑`}),(0,I.jsx)(`button`,{className:H.controlButton,onClick:r,title:`Clear console`,"aria-label":`Clear console`,children:`🗑️`})]})]}),(0,I.jsxs)(`div`,{className:H.console,ref:i,role:`log`,"aria-live":`polite`,children:[e.map(e=>(0,I.jsx)(ic,{fallback:e.raw,children:(0,I.jsx)(sc,{message:e.raw,msgId:e.id,classificationMap:t,onGraphLink:a?()=>a(e):void 0,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l})},e.id)),e.length===0&&(0,I.jsxs)(`div`,{className:H.emptyConsole,children:[`No messages yet. Use the `,(0,I.jsx)(`strong`,{children:`Start`}),` button in the header to connect.`]})]})]})}var lc={commandInput:`_commandInput_188pe_2`,labelRow:`_labelRow_188pe_8`,labelGroup:`_labelGroup_188pe_16`,label:`_label_188pe_8`,infoWrapper:`_infoWrapper_188pe_28`,paletteToggle:`_paletteToggle_188pe_34`,paletteToggleActive:`_paletteToggleActive_188pe_66`,popover:`_popover_188pe_73`,popoverOpen:`_popoverOpen_188pe_95`,popoverTitle:`_popoverTitle_188pe_121`,popoverRow:`_popoverRow_188pe_135`,popoverKeyword:`_popoverKeyword_188pe_156`,popoverDesc:`_popoverDesc_188pe_168`,popoverAlias:`_popoverAlias_188pe_174`,inputRow:`_inputRow_188pe_181`,inputWrapper:`_inputWrapper_188pe_187`,textarea:`_textarea_188pe_197`,sendButton:`_sendButton_188pe_236`,hint:`_hint_188pe_253`,dropup:`_dropup_188pe_261`,dropupHeader:`_dropupHeader_188pe_276`,dropupItem:`_dropupItem_188pe_292`,dropupItemText:`_dropupItemText_188pe_315`,matchHighlight:`_matchHighlight_188pe_323`,multilineIndicator:`_multilineIndicator_188pe_329`},uc=[`graph.data.mapper`,`graph.math`,`graph.js`,`graph.api.fetcher`,`graph.extension`,`graph.island`,`graph.join`],dc=[{keyword:`help`,description:`List all help topics, or get help for a specific command`,template:`help`},{keyword:`create`,description:`Create a new graph node`,template:`create node {name}
with type {type}
with properties
...
{constant} -> input.body.{key}`,multiline:!0},{keyword:`upload mock data`,description:`Print the URL to POST a JSON payload as mock input.body`,template:`upload mock data`},{keyword:`execute`,description:`Execute a single node skill in isolation`,template:`execute node {name}`},{keyword:`inspect`,description:`Inspect a state-machine variable`,template:`inspect {variable_name}`},{keyword:`run`,description:`Run the graph instance from root to end`,template:`run`}];[...uc.map(e=>({tokens:[`describe`,`skill`,e],template:`describe skill ${e}`,hint:`Describe built-in skill: ${e}`}))];function fc(e,t){let[n,r]=(0,P.useState)(!1),[i,a]=(0,P.useState)(-1),o=(0,P.useMemo)(()=>{let n=t.trimStart();if(n.length===0)return[];let r=n.toLowerCase(),i=e.filter(e=>e.toLowerCase().startsWith(r)),a=new Set;return i.filter(e=>a.has(e)?!1:(a.add(e),!0)).slice(0,8)},[e,t]),s=()=>{r(!0),a(-1)},c=e=>{let t=o.length;t!==0&&a(n=>e===1?n<0?0:(n+1)%t:n<=0?t-1:n-1)},l=(e,t)=>{e>=0&&e<o.length&&t(o[e]),r(!1),a(-1)};return{suggestions:o,isOpen:n,activeIndex:i,onCommandChange:s,navigate:c,accept:l,onTab:e=>{!n||o.length===0||l(i>=0?i:0,e)},dismiss:()=>{r(!1),a(-1)}}}var pc=e=>(0,I.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 16 16`,fill:`none`,width:14,height:14,stroke:`currentColor`,strokeWidth:1.5,strokeLinecap:`round`,strokeLinejoin:`round`,...e,children:[(0,I.jsx)(`polyline`,{points:`2,4 6,8 2,12`}),(0,I.jsx)(`line`,{x1:7,y1:12,x2:14,y2:12})]});function mc({command:e,onChange:t,onKeyDown:n,onSend:r,sendDisabled:i,disabled:a,history:o}){let s=(0,P.useRef)(null),c=(0,P.useRef)(null),l=(0,P.useRef)(null),[u,d]=(0,P.useState)(!1);(0,P.useEffect)(()=>{if(!u)return;let e=e=>{c.current&&!c.current.contains(e.target)&&d(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[u]);let f=fc(o,e),p=(0,P.useCallback)(()=>{let e=s.current;e&&(e.style.height=`auto`,e.style.height=`${e.scrollHeight}px`)},[]);(0,P.useEffect)(()=>{p()},[e,p]),(0,P.useEffect)(()=>{let e=s.current?.parentElement;if(!e||typeof ResizeObserver>`u`)return;let t=null,n=new ResizeObserver(()=>{t===null&&(t=requestAnimationFrame(()=>{t=null,p()}))});return n.observe(e),()=>{n.disconnect(),t!==null&&cancelAnimationFrame(t)}},[p]);let m=a?`Not connected`:`Enter command (Enter to send · Shift+Enter for new line)`,h=a?`Enter your test message once it is connected`:`Enter to send · Shift+Enter for new line · ↑↓ for history`;return(0,I.jsxs)(`div`,{className:lc.commandInput,children:[(0,I.jsx)(`div`,{className:lc.labelRow,children:(0,I.jsxs)(`div`,{className:lc.labelGroup,children:[(0,I.jsx)(`label`,{htmlFor:`command`,className:lc.label,children:`Command`}),(0,I.jsxs)(`span`,{ref:c,className:lc.infoWrapper,children:[(0,I.jsx)(`button`,{type:`button`,className:`${lc.paletteToggle}${u?` ${lc.paletteToggleActive}`:``}`,"aria-label":`Toggle command palette`,"aria-expanded":u,"aria-controls":`command-palette`,onClick:()=>d(e=>!e),onKeyDown:e=>{e.key===`ArrowDown`&&u&&(e.preventDefault(),(l.current?.querySelector(`[role="option"]`))?.focus())},title:`Command palette`,children:(0,I.jsx)(pc,{"aria-hidden":`true`,focusable:`false`})}),(0,I.jsxs)(`div`,{id:`command-palette`,ref:l,className:`${lc.popover}${u?` ${lc.popoverOpen}`:``}`,role:`listbox`,"aria-label":`Command palette`,onKeyDown:e=>{if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault();let t=l.current?.querySelectorAll(`[role="option"]`);if(!t||t.length===0)return;let n=Array.from(t).indexOf(document.activeElement);e.key===`ArrowDown`?t[n<0?0:(n+1)%t.length].focus():t[n<=0?t.length-1:n-1].focus()}else e.key===`Escape`&&(e.preventDefault(),d(!1),s.current?.focus())},children:[(0,I.jsx)(`p`,{className:lc.popoverTitle,children:`Command palette — click to insert`}),dc.map(({keyword:e,alias:n,description:r,template:i})=>(0,I.jsxs)(`div`,{className:lc.popoverRow,role:`option`,"aria-selected":!1,tabIndex:u?0:-1,onMouseDown:e=>e.preventDefault(),onClick:()=>{t(i),d(!1),s.current?.focus()},onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t(i),d(!1),s.current?.focus())},children:[(0,I.jsx)(`span`,{className:lc.popoverKeyword,children:e}),(0,I.jsxs)(`span`,{className:lc.popoverDesc,children:[r,n&&(0,I.jsxs)(`span`,{className:lc.popoverAlias,children:[` · alias: `,n]})]})]},e))]})]})]})}),(0,I.jsxs)(`div`,{className:lc.inputRow,children:[(0,I.jsxs)(`div`,{className:lc.inputWrapper,children:[(0,I.jsxs)(`div`,{id:`history-dropup`,role:`listbox`,"aria-label":`Command history suggestions`,className:lc.dropup,hidden:!(f.isOpen&&f.suggestions.length>0),children:[(0,I.jsx)(`div`,{className:lc.dropupHeader,"aria-hidden":`true`,children:`Recent Commands`}),f.isOpen&&f.suggestions.length>0&&f.suggestions.map((n,r)=>{let i=n.split(`
`)[0],a=n.includes(`
`),o=e.trimStart().split(`
`)[0],c=Math.min(o.length,i.length),l=i.slice(0,c),u=i.slice(c);return(0,I.jsxs)(`div`,{id:`history-option-${r}`,role:`option`,"aria-selected":r===f.activeIndex,className:lc.dropupItem,onMouseDown:e=>e.preventDefault(),onClick:()=>{f.accept(r,e=>t(e)),requestAnimationFrame(()=>{let e=s.current;e&&(e.selectionStart=e.selectionEnd=e.value.length)})},children:[(0,I.jsxs)(`span`,{className:lc.dropupItemText,children:[c>0&&(0,I.jsx)(`strong`,{className:lc.matchHighlight,children:l}),u,a?`…`:``]}),a&&(0,I.jsx)(`span`,{className:lc.multilineIndicator,"aria-label":`multi-line command`,children:`↵`})]},n)})]}),(0,I.jsx)(`textarea`,{ref:s,id:`command`,role:`combobox`,"aria-expanded":f.isOpen&&f.suggestions.length>0,"aria-haspopup":`listbox`,"aria-controls":`history-dropup`,"aria-activedescendant":f.isOpen&&f.suggestions.length>0&&f.activeIndex>=0?`history-option-${f.activeIndex}`:void 0,"aria-autocomplete":`list`,className:lc.textarea,rows:1,placeholder:m,value:e,disabled:a,onChange:e=>{t(e.target.value),f.onCommandChange()},onKeyDown:e=>{if(e.key===`Tab`){e.preventDefault(),f.isOpen&&f.suggestions.length>0&&(f.onTab(e=>t(e)),requestAnimationFrame(()=>{let e=s.current;e&&(e.selectionStart=e.selectionEnd=e.value.length)}));return}if(e.key===`Enter`){if(e.shiftKey)return;if(e.preventDefault(),f.isOpen&&f.activeIndex>=0){f.accept(f.activeIndex,e=>t(e)),requestAnimationFrame(()=>{let e=s.current;e&&(e.selectionStart=e.selectionEnd=e.value.length)}),s.current?.focus();return}r(),s.current?.focus();return}if(e.key===`Escape`){if(f.isOpen){f.dismiss(),e.preventDefault();return}return}if(e.key===`ArrowUp`||e.key===`ArrowDown`){if(f.isOpen&&f.suggestions.length>0){e.preventDefault(),f.navigate(e.key===`ArrowDown`?1:-1);return}let t=s.current;if(t){let{selectionStart:n,value:r}=t,i=!r.slice(0,n).includes(`
`),a=!r.slice(n).includes(`
`);if(!(e.key===`ArrowUp`&&i||e.key===`ArrowDown`&&a))return}n(e),requestAnimationFrame(()=>{let e=s.current;e&&(e.selectionStart=e.selectionEnd=e.value.length)});return}n(e)},onBlur:()=>f.dismiss(),autoComplete:`off`,autoCorrect:`off`,spellCheck:!1})]}),(0,I.jsx)(`button`,{className:lc.sendButton,onClick:()=>{r(),s.current?.focus()},disabled:i,"aria-label":`Send command`,children:`Send`})]}),h&&(0,I.jsx)(`p`,{className:lc.hint,children:h})]})}var hc={root:`_root_1ac49_1`};function gc({messages:e,classificationMap:t,onCopy:n,onClear:r,consoleRef:i,onGraphLinkMessage:a,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l,command:u,onCommandChange:d,onCommandKeyDown:f,onSend:p,sendDisabled:m,inputDisabled:h,commandHistory:g}){return(0,I.jsxs)(`div`,{className:hc.root,children:[(0,I.jsx)(cc,{messages:e,classificationMap:t,onCopy:n,onClear:r,consoleRef:i,onGraphLinkMessage:a,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l}),(0,I.jsx)(mc,{command:u,onChange:d,onKeyDown:f,onSend:p,disabled:h,sendDisabled:m,history:g})]})}var _c=e=>(0,I.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 16 16`,fill:`none`,width:16,height:16,stroke:`currentColor`,strokeWidth:1.8,strokeLinecap:`round`,strokeLinejoin:`round`,...e,children:[(0,I.jsx)(`line`,{x1:4.75,y1:4.75,x2:11.25,y2:11.25}),(0,I.jsx)(`line`,{x1:11.25,y1:4.75,x2:4.75,y2:11.25})]}),U={root:`_root_1qoh5_9`,card:`_card_1qoh5_19`,ribbon:`_ribbon_1qoh5_32`,ribbonIcon:`_ribbonIcon_1qoh5_45`,ribbonAlias:`_ribbonAlias_1qoh5_50`,ribbonAliasInput:`_ribbonAliasInput_1qoh5_57`,ribbonBadge:`_ribbonBadge_1qoh5_82`,ribbonClose:`_ribbonClose_1qoh5_93`,ribbonCloseIcon:`_ribbonCloseIcon_1qoh5_114`,body:`_body_1qoh5_121`,row:`_row_1qoh5_128`,rowDropTarget:`_rowDropTarget_1qoh5_138`,dragGrip:`_dragGrip_1qoh5_142`,rowLabel:`_rowLabel_1qoh5_166`,rowKey:`_rowKey_1qoh5_167`,rowValue:`_rowValue_1qoh5_178`,rowSpacer:`_rowSpacer_1qoh5_185`,keyInput:`_keyInput_1qoh5_189`,valueInput:`_valueInput_1qoh5_190`,removeButton:`_removeButton_1qoh5_228`,removeIcon:`_removeIcon_1qoh5_251`,addRow:`_addRow_1qoh5_257`,addButton:`_addButton_1qoh5_263`,message:`_message_1qoh5_282`,errorMessage:`_errorMessage_1qoh5_283`,warningMessage:`_warningMessage_1qoh5_284`,errorText:`_errorText_1qoh5_306`,footer:`_footer_1qoh5_312`,secondaryButton:`_secondaryButton_1qoh5_321`,primaryButton:`_primaryButton_1qoh5_322`},vc=1,yc=10,bc=36;function xc(e){let t=e.split(`
`).reduce((e,t)=>e+Math.max(1,Math.ceil(t.length/bc)),0);return Math.min(Math.max(t,vc),yc)}function Sc({mode:e,formState:t,phase:n,lockReason:r,serverMessage:i,validationErrors:a,onFormStateChange:o,onSubmit:s,onClose:c}){let l=(0,P.useRef)(null),u=(0,P.useRef)(null),d=(0,P.useRef)(new Map),f=(0,P.useRef)(null),p=e===`create`,m=n===`sending`,h=r===`disconnected`,g=m||h,_=p?`Create Node`:`Save Changes`,v=p?`Creating...`:`Saving...`,y=p?`Connection disconnected. Refresh the page and create the node again after the app reconnects.`:`Connection disconnected. Refresh the page and edit the node again after the app reconnects.`,b=Za(t.nodeType),x=Qa(t.nodeType);(0,P.useEffect)(()=>{p?l.current?.focus():u.current?.focus();let e=e=>{e.key===`Escape`&&(e.preventDefault(),m||c())};return document.addEventListener(`keydown`,e),()=>{document.removeEventListener(`keydown`,e)}},[p,c,m]),(0,P.useEffect)(()=>{let e=f.current;if(!e)return;let t=d.current.get(e);t&&(t.focus(),f.current=null)},[t.properties]);let S=(0,P.useCallback)(e=>{e.preventDefault(),!g&&s()},[g,s]),C=(0,P.useCallback)(e=>{o({...t,...e})},[t,o]),ee=(0,P.useCallback)((e,n)=>{o({...t,properties:t.properties.map(t=>t.id===e?{...t,...n}:t)})},[t,o]),te=(0,P.useCallback)(()=>{let e=ra();f.current=e.id,o({...t,properties:[...t.properties,e]})},[t,o]),w=(0,P.useCallback)(e=>{let n=t.properties.filter(t=>t.id!==e);o({...t,properties:n.length>0?n:[ra()]})},[t,o]),T=(0,P.useRef)(null),[E,ne]=(0,P.useState)(null),re=(0,P.useCallback)(()=>{T.current=null,ne(null)},[]),D=(0,P.useCallback)(e=>t=>{if(T.current=e,t.dataTransfer){t.dataTransfer.effectAllowed=`move`,t.dataTransfer.setData(`text/plain`,e);let n=t.currentTarget.closest(`[data-row-id]`);n instanceof HTMLElement&&typeof t.dataTransfer.setDragImage==`function`&&t.dataTransfer.setDragImage(n,16,16)}},[]),ie=(0,P.useCallback)(e=>t=>{T.current!==null&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),ne(t=>t===e?t:e))},[]),ae=(0,P.useCallback)(e=>{let n=T.current;if(re(),n===null||n===e)return;let r=t.properties.find(e=>e.id===n);if(!r)return;let i=t.properties.filter(e=>e.id!==n),a=i.length;if(e!==null){let t=i.findIndex(t=>t.id===e);t!==-1&&(a=t)}let s=[...i.slice(0,a),r,...i.slice(a)];o({...t,properties:ca(s)})},[re,t,o]),oe=(0,P.useCallback)(e=>t=>{T.current!==null&&(t.preventDefault(),ae(e))},[ae]);return(0,I.jsx)(`div`,{className:U.root,children:(0,I.jsxs)(`form`,{className:U.card,style:{borderColor:x,"--node-accent":x},"aria-label":p?`Create node`:`Edit node ${t.alias}`,onSubmit:S,children:[(0,I.jsxs)(`header`,{className:U.ribbon,children:[(0,I.jsx)(`span`,{className:U.ribbonIcon,"aria-hidden":`true`,children:b.icon}),p?(0,I.jsx)(`input`,{ref:l,className:U.ribbonAliasInput,value:t.alias,placeholder:`node-alias`,"aria-label":`Node alias`,disabled:g,"aria-invalid":!!a.alias,onChange:e=>C({alias:e.target.value})}):(0,I.jsx)(`span`,{className:U.ribbonAlias,children:t.alias}),(0,I.jsx)(`span`,{className:U.ribbonBadge,children:b.label}),(0,I.jsx)(`button`,{type:`button`,className:U.ribbonClose,"aria-label":`Close node editor`,title:`Close (Esc)`,onClick:c,disabled:m,children:(0,I.jsx)(_c,{className:U.ribbonCloseIcon,"aria-hidden":`true`,focusable:`false`})})]}),(0,I.jsxs)(`div`,{className:U.body,children:[i&&!h&&(0,I.jsx)(`div`,{className:U.message,role:`status`,children:i}),a.command&&(0,I.jsx)(`div`,{className:U.errorMessage,role:`alert`,children:a.command}),a.alias&&(0,I.jsx)(`div`,{className:U.errorMessage,role:`alert`,children:a.alias}),h&&(0,I.jsx)(`div`,{className:U.warningMessage,role:`status`,children:i??y}),(0,I.jsxs)(`div`,{className:U.row,children:[(0,I.jsx)(`span`,{"aria-hidden":`true`}),(0,I.jsx)(`label`,{className:U.rowLabel,htmlFor:`node-edit-type`,children:`type`}),(0,I.jsxs)(`div`,{className:U.rowValue,children:[(0,I.jsx)(`input`,{id:`node-edit-type`,ref:u,className:U.valueInput,value:t.nodeType,disabled:g,"aria-invalid":!!a.nodeType,onChange:e=>C({nodeType:e.target.value})}),a.nodeType&&(0,I.jsx)(`span`,{className:U.errorText,children:a.nodeType})]}),(0,I.jsx)(`span`,{className:U.rowSpacer,"aria-hidden":`true`})]}),t.properties.map(e=>{let t=a[zi(e.id,`key`)],n=a[zi(e.id,`value`)];return(0,I.jsxs)(`div`,{"data-row-id":e.id,className:E===e.id?`${U.row} ${U.rowDropTarget}`:U.row,onDragOver:ie(e.id),onDrop:oe(e.id),children:[(0,I.jsx)(`span`,{className:U.dragGrip,role:`button`,"aria-label":`Reorder property ${e.key.trim()||`(empty)`}`,title:`Drag to reorder — same keys append as [0], [1], … in row order`,draggable:!g,onDragStart:D(e.id),onDragEnd:re,children:`⠿`}),(0,I.jsxs)(`div`,{className:U.rowKey,children:[(0,I.jsx)(`input`,{ref:t=>{t?d.current.set(e.id,t):d.current.delete(e.id)},className:U.keyInput,value:e.key,placeholder:`key`,"aria-label":`Property key`,disabled:g,"aria-invalid":!!t,onChange:t=>ee(e.id,{key:t.target.value})}),t&&(0,I.jsx)(`span`,{className:U.errorText,children:t})]}),(0,I.jsxs)(`div`,{className:U.rowValue,children:[(0,I.jsx)(`textarea`,{className:U.valueInput,value:e.value,placeholder:`value`,"aria-label":`Property value`,disabled:g,rows:xc(e.value),"aria-invalid":!!n,onChange:t=>ee(e.id,{value:t.target.value})}),n&&(0,I.jsx)(`span`,{className:U.errorText,children:n})]}),(0,I.jsx)(`button`,{type:`button`,className:U.removeButton,"aria-label":`Remove property`,disabled:g,onClick:()=>w(e.id),children:(0,I.jsx)(_c,{className:U.removeIcon,"aria-hidden":`true`,focusable:`false`})})]},e.id)}),(0,I.jsx)(`div`,{className:E===`end`?`${U.addRow} ${U.rowDropTarget}`:U.addRow,onDragOver:ie(`end`),onDrop:oe(null),children:(0,I.jsxs)(`button`,{type:`button`,className:U.addButton,disabled:g,onClick:te,children:[(0,I.jsx)(`span`,{"aria-hidden":`true`,children:`+`}),(0,I.jsx)(`span`,{children:`Add Property`})]})})]}),(0,I.jsxs)(`footer`,{className:U.footer,children:[(0,I.jsx)(`button`,{type:`button`,className:U.secondaryButton,onClick:c,disabled:m,children:`Cancel`}),(0,I.jsx)(`button`,{type:`submit`,className:U.primaryButton,disabled:g,children:m?v:_})]})]})})}var W={dialog:`_dialog_g80bk_4`,modalInner:`_modalInner_g80bk_26`,modalHeader:`_modalHeader_g80bk_34`,modalTitleGroup:`_modalTitleGroup_g80bk_44`,modalTitle:`_modalTitle_g80bk_44`,modalPath:`_modalPath_g80bk_57`,closeButton:`_closeButton_g80bk_64`,modalBody:`_modalBody_g80bk_95`,dropZone:`_dropZone_g80bk_105`,dropZoneActive:`_dropZoneActive_g80bk_127`,dropZoneIcon:`_dropZoneIcon_g80bk_133`,dropZoneText:`_dropZoneText_g80bk_139`,dropZoneOr:`_dropZoneOr_g80bk_152`,browseButton:`_browseButton_g80bk_159`,fileInputHidden:`_fileInputHidden_g80bk_188`,fileError:`_fileError_g80bk_193`,textareaLabel:`_textareaLabel_g80bk_198`,textarea:`_textarea_g80bk_198`,validationError:`_validationError_g80bk_226`,keyboardHint:`_keyboardHint_g80bk_231`,errorBanner:`_errorBanner_g80bk_236`,modalFooter:`_modalFooter_g80bk_247`,footerActions:`_footerActions_g80bk_257`,formatButton:`_formatButton_g80bk_263`,cancelButton:`_cancelButton_g80bk_264`,uploadButton:`_uploadButton_g80bk_265`,spinner:`_spinner_g80bk_332`,spin:`_spin_g80bk_332`};function Cc({uploadPath:e,json:t,onSuccess:n,onError:r}){let[i,a]=(0,P.useState)(!1),o=(0,P.useRef)(null),s=(0,P.useCallback)(()=>{o.current?.abort(),o.current=null,a(!1)},[]);return{isUploading:i,upload:(0,P.useCallback)(async()=>{o.current?.abort();let i=new AbortController;o.current=i,a(!0);try{let o=await fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:t,signal:i.signal}),s=await o.text();if(!o.ok){a(!1),r(`HTTP ${o.status} — ${s}`);return}a(!1),n(s)}catch(e){if(e.name===`AbortError`){a(!1);return}a(!1),r(e.message??`Network error`)}},[e,t,n,r]),cancel:s}}var wc=(navigator.userAgentData?.platform??navigator.platform).toLowerCase().includes(`mac`);function Tc(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=()=>n(Error(`Could not read file "${e.name}"`)),r.readAsText(e,`utf-8`)})}function Ec(e){let t=e.name.toLowerCase().endsWith(`.json`),n=e.type===`application/json`||e.type===`text/plain`;return!t&&!n?`"${e.name}" does not appear to be a JSON file. Only .json files are accepted.`:null}function Dc({uploadPath:e,onSuccess:t,onClose:n,onError:r}){let[i,a]=(0,P.useState)(``),[o,s]=(0,P.useState)(null),[c,l]=(0,P.useState)(null),[u,d]=(0,P.useState)(!1),f=(0,P.useRef)(null),p=(0,P.useRef)(null),m=(0,P.useRef)(null),h=Dr(i).isJSON,g=h&&i.trim()!==``,{isUploading:_,upload:v,cancel:y}=Cc({uploadPath:e,json:i,onSuccess:t,onError:e=>{s(e),r(e)}});(0,P.useEffect)(()=>{let e=f.current;if(e)return e.open||e.showModal(),p.current?.focus(),()=>{e.open&&e.close()}},[]);let b=(0,P.useCallback)(()=>{y(),n()},[y,n]),x=(0,P.useCallback)(e=>{e.target===f.current&&b()},[b]),S=(0,P.useCallback)(e=>{e.preventDefault(),b()},[b]),C=(0,P.useCallback)(()=>{s(null),v()},[v]),ee=(0,P.useCallback)(e=>{e.key===`Enter`&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),g&&!_&&C())},[g,_,C]),te=(0,P.useCallback)(()=>{h&&a(pr(i))},[h,i]),w=(0,P.useCallback)(async e=>{l(null),s(null);let t=Ec(e);if(t){l(t);return}try{let t=await Tc(e);if(!Dr(t).isJSON){l(`"${e.name}" contains invalid JSON.`);return}a(pr(t)),p.current?.focus()}catch(e){l(e.message)}},[]),T=(0,P.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),u||d(!0)},[u]),E=(0,P.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),(e.currentTarget===e.target||!e.currentTarget.contains(e.relatedTarget))&&d(!1)},[]),ne=(0,P.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),d(!1);let t=e.dataTransfer.files[0];t&&w(t)},[w]),re=(0,P.useCallback)(e=>{let t=e.target.files?.[0];t&&(w(t),e.target.value=``)},[w]),D=!h&&i.trim()!==``;return(0,I.jsx)(`dialog`,{ref:f,className:W.dialog,"aria-modal":`true`,"aria-labelledby":`mock-upload-modal-title`,onClick:x,onCancel:S,children:(0,I.jsxs)(`div`,{className:W.modalInner,onClick:e=>e.stopPropagation(),children:[(0,I.jsxs)(`div`,{className:W.modalHeader,children:[(0,I.jsxs)(`div`,{className:W.modalTitleGroup,children:[(0,I.jsx)(`span`,{id:`mock-upload-modal-title`,className:W.modalTitle,children:`⬆️ Upload Mock Data`}),(0,I.jsx)(`span`,{className:W.modalPath,children:e})]}),(0,I.jsx)(`button`,{className:W.closeButton,onClick:b,"aria-label":`Close upload modal`,title:`Close`,disabled:_,children:`✕`})]}),(0,I.jsxs)(`div`,{className:W.modalBody,children:[(0,I.jsxs)(`div`,{className:`${W.dropZone} ${u?W.dropZoneActive:``}`,onDragOver:T,onDragLeave:E,onDrop:ne,"aria-label":`Drop a JSON file here`,children:[(0,I.jsx)(`span`,{className:W.dropZoneIcon,children:`📂`}),(0,I.jsxs)(`span`,{className:W.dropZoneText,children:[`Drop a `,(0,I.jsx)(`code`,{children:`.json`}),` file here`]}),(0,I.jsx)(`span`,{className:W.dropZoneOr,children:`— or —`}),(0,I.jsx)(`input`,{ref:m,type:`file`,accept:`.json,application/json`,className:W.fileInputHidden,"aria-hidden":`true`,tabIndex:-1,onChange:re}),(0,I.jsx)(`button`,{type:`button`,className:W.browseButton,onClick:()=>m.current?.click(),disabled:_,"aria-label":`Browse for a JSON file`,children:`Browse file…`})]}),c&&(0,I.jsxs)(`span`,{className:W.fileError,role:`alert`,children:[`⚠️ `,c]}),(0,I.jsx)(`label`,{htmlFor:`mock-upload-textarea`,className:W.textareaLabel,children:`JSON Payload`}),(0,I.jsx)(`textarea`,{id:`mock-upload-textarea`,ref:p,className:W.textarea,value:i,onChange:e=>{a(e.target.value),l(null)},onKeyDown:ee,placeholder:`Paste JSON here, or drop / browse a .json file above`,rows:10,spellCheck:!1,"aria-describedby":D?`mock-upload-validation`:void 0}),D&&(0,I.jsx)(`span`,{id:`mock-upload-validation`,className:W.validationError,role:`status`,children:`⚠️ Invalid JSON — check syntax`}),(0,I.jsx)(`span`,{className:W.keyboardHint,children:wc?`⌘+Enter to upload`:`Ctrl+Enter to upload`}),o&&(0,I.jsxs)(`div`,{className:W.errorBanner,role:`alert`,children:[`❌ Upload failed: `,o]})]}),(0,I.jsxs)(`div`,{className:W.modalFooter,children:[(0,I.jsx)(`button`,{className:W.formatButton,onClick:te,disabled:!h||_,title:`Format JSON`,"aria-label":`Format JSON`,children:`Format`}),(0,I.jsxs)(`div`,{className:W.footerActions,children:[(0,I.jsx)(`button`,{className:W.cancelButton,onClick:b,disabled:_,children:`Cancel`}),(0,I.jsx)(`button`,{className:W.uploadButton,onClick:C,disabled:!g||_,"aria-busy":_,children:_?(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`span`,{className:W.spinner,"aria-hidden":`true`}),` Uploading…`]}):`Upload ▶`})]})]})]})})}var Oc={popover:`_popover_qw337_7`,header:`_header_qw337_19`,endpoint:`_endpoint_qw337_30`,arrow:`_arrow_qw337_41`,chips:`_chips_qw337_46`,chip:`_chip_qw337_46`,customRow:`_customRow_qw337_73`,input:`_input_qw337_78`,submitButton:`_submitButton_qw337_100`,errorText:`_errorText_qw337_122`,statusText:`_statusText_qw337_128`,warningText:`_warningText_qw337_129`},kc=12;function Ac({formState:e,phase:t,lockReason:n,serverMessage:r,validationErrors:i,anchor:a,onFormStateChange:o,onSubmit:s,onClose:c}){let l=(0,P.useRef)(null),u=(0,P.useRef)(null),[d,f]=(0,P.useState)(null),p=t===`sending`,m=n===`disconnected`,h=p||m,g=(0,P.useRef)(null);(0,P.useEffect)(()=>{g.current!==null&&e.relation===g.current&&(g.current=null,h||s())},[h,e.relation,s]),(0,P.useEffect)(()=>{u.current?.focus()},[]),(0,P.useLayoutEffect)(()=>{let e={x:window.innerWidth/2,y:96},t=a??e,n=l.current?.getBoundingClientRect(),r=n?.width??280,i=n?.height??180;f({left:Math.min(Math.max(t.x-r/2,kc),Math.max(kc,window.innerWidth-r-kc)),top:Math.min(Math.max(t.y+14,kc),Math.max(kc,window.innerHeight-i-kc))})},[a]),(0,P.useEffect)(()=>{let e=e=>{e.key===`Escape`&&(e.preventDefault(),p||c())},t=e=>{p||l.current&&!l.current.contains(e.target)&&c()};return document.addEventListener(`keydown`,e),document.addEventListener(`pointerdown`,t),()=>{document.removeEventListener(`keydown`,e),document.removeEventListener(`pointerdown`,t)}},[c,p]);let _=(0,P.useCallback)(t=>{o({...e,relation:t})},[e,o]),v=(0,P.useCallback)(t=>{h||(g.current=t,o({...e,relation:t}))},[h,e,o]),y=(0,P.useCallback)(e=>{e.preventDefault(),!h&&s()},[h,s]),b=i.relation??i.command??i.sourceAlias??i.targetAlias;return(0,I.jsxs)(`div`,{ref:l,className:Oc.popover,style:d?{left:d.left,top:d.top}:{visibility:`hidden`},role:`dialog`,"aria-label":`Create connection from ${e.sourceAlias} to ${e.targetAlias}`,children:[(0,I.jsxs)(`div`,{className:Oc.header,children:[(0,I.jsx)(`span`,{className:Oc.endpoint,children:e.sourceAlias}),(0,I.jsx)(`span`,{className:Oc.arrow,"aria-hidden":`true`,children:`→`}),(0,I.jsx)(`span`,{className:Oc.endpoint,children:e.targetAlias})]}),(0,I.jsx)(`div`,{className:Oc.chips,children:so.map(e=>(0,I.jsx)(`button`,{type:`button`,className:Oc.chip,style:{"--chip-color":co[e]},disabled:h,onClick:()=>v(e),children:e},e))}),(0,I.jsxs)(`form`,{className:Oc.customRow,onSubmit:y,children:[(0,I.jsx)(`input`,{ref:u,className:Oc.input,value:e.relation,placeholder:`custom relation…`,autoComplete:`off`,autoCorrect:`off`,spellCheck:!1,disabled:h,"aria-label":`Relation name`,"aria-invalid":!!i.relation,onChange:e=>_(e.target.value)}),(0,I.jsx)(`button`,{type:`submit`,className:Oc.submitButton,disabled:h||!e.relation.trim(),children:p?`Creating…`:`Connect`})]}),b&&!p&&(0,I.jsx)(`div`,{className:Oc.errorText,role:`alert`,children:b}),r&&(0,I.jsx)(`div`,{className:m?Oc.warningText:Oc.statusText,role:`status`,children:r})]})}var jc=1e4,Mc=`A graph authoring action is already pending. Wait for it to finish before starting another.`,Nc=`Could not send the create-node command because the WebSocket is not open. The form values remain in this dialog.`,Pc=`Could not send the edit-node command because the WebSocket is not open. Your changes remain in this dialog.`,Fc=`Could not send the delete-node command because the WebSocket is not open.`,Ic=`Could not send the create-connection command because the WebSocket is not open. The form values remain in this dialog.`,Lc=`Could not send delete-node commands because the WebSocket is not open.`,Rc=`No selected nodes are available to delete.`,zc=`Select 100 or fewer nodes to delete at once.`,Bc=`Some delete-node commands were sent, but not all backend results were observed yet. Refresh the graph before trying again.`,Vc=`This node is no longer available in the current graph.`,Hc=`Connection disconnected. Refresh the page and create the node again after the app reconnects.`,Uc=`Connection disconnected. Refresh the page and edit the node again after the app reconnects.`,Wc=`Connection disconnected. Refresh the page and create the connection again after the app reconnects.`,Gc=`Connection disconnected while the graph authoring action was pending. The outcome is unknown. Refresh the page and check the graph before trying again.`,Kc={status:`closed`,pendingSubmit:null,serverMessage:null};function qc(e){return e.pendingSubmit}function Jc(e){return e.action===`delete-nodes`}function Yc(e){return e===`create-connection`?Ic:e===`edit-node`?Pc:e===`delete-node`?Fc:Nc}function Xc(e){return Jc(e)?Bc:`The ${e.action} command was sent, but no backend result was observed yet. The outcome is unknown.`}function Zc(e){return e===`create-connection`?Wc:e===`edit-node`?Uc:Hc}function Qc(e,t){return!e||!t?!1:e.trim().toLowerCase()===t.trim().toLowerCase()}function $c(e,t){return e?.nodes.find(e=>e.alias.toLowerCase()===t.toLowerCase())??null}function el(e,t){return e.status===`error`?!0:t.action===`create-connection`?e.action===`create-connection`?e.alias===null?!0:Qc(e.alias,t.alias)?e.status===`accepted`?Qc(e.targetAlias,t.targetAlias):e.targetAlias===null||Qc(e.targetAlias,t.targetAlias):!1:e.action===null?Qc(e.alias,t.alias)||Qc(e.alias,t.targetAlias):!1:Qc(e.alias,t.alias)?e.action===null||e.action===t.action:!1}function tl(e,t){let n=qc(e);return!n||Jc(n)||!el(t,n)?null:t.status===`accepted`?{state:Kc,acceptedResult:{status:t.status,action:t.action,alias:t.alias,targetAlias:t.targetAlias,message:t.message}}:e.status===`open`?{state:{...e,phase:`editing`,pendingSubmit:null,serverMessage:t.status===`error`?`Backend returned an error while this submit was pending: ${t.message}`:t.message}}:{state:Kc,notification:{message:t.message,type:`error`}}}function nl(e){return{...e,phase:`editing`,pendingSubmit:null,serverMessage:Yc(e.action)}}function rl(e){let t=qc(e);if(!t)return null;let n=Xc(t);return e.status===`open`?{state:{...e,phase:`editing`,pendingSubmit:null,serverMessage:n}}:{state:Kc,notification:{message:n,type:`error`}}}function il(e){let t=qc(e);if(e.status===`open`){let n=t?Gc:Zc(e.action);return{state:{...e,phase:`editing`,pendingSubmit:null,serverMessage:n,connectionLost:!0}}}return t?{state:Kc,notification:{message:Gc,type:`error`}}:null}function al(e){return`sourceAlias`in e}function ol({bus:e,connected:t,graphData:n,executor:r,timeoutMs:i=jc,onAccepted:a,onUserMessage:o}){let[s,c]=(0,P.useState)(Kc),[l,u]=(0,P.useState)({}),d=(0,P.useRef)(s),f=(0,P.useRef)(null),p=(0,P.useRef)(t),m=(0,P.useRef)(n),h=(0,P.useRef)(a),g=(0,P.useRef)(o);(0,P.useEffect)(()=>{d.current=s},[s]),(0,P.useEffect)(()=>{m.current=n},[n]),(0,P.useEffect)(()=>{h.current=a},[a]),(0,P.useEffect)(()=>{g.current=o},[o]);let _=(0,P.useCallback)((e,t=`error`)=>{g.current?.(e,t)},[]),v=(0,P.useCallback)(e=>{d.current=e,c(e)},[]),y=(0,P.useCallback)(()=>{f.current!==null&&(clearTimeout(f.current),f.current=null)},[]),b=(0,P.useCallback)(()=>{y(),f.current=setTimeout(()=>{let e=rl(d.current);e&&(v(e.state),e.notification&&_(e.notification.message,e.notification.type)),f.current=null},i)},[y,_,v,i]),x=(0,P.useCallback)(e=>{if(!t)return;if(qc(d.current)){_(Mc,`error`);return}let n=ia(e);u({}),v({status:`open`,action:`create-node`,phase:`editing`,formState:n,originalAlias:null,pendingSubmit:null,serverMessage:null,connectionLost:!1})},[t,_,v]),S=(0,P.useCallback)((e,n)=>{if(!t)return;if(qc(d.current)){_(Mc,`error`);return}let r={sourceAlias:e,targetAlias:n,relation:``},{relation:i,...a}=Ki(r,{graphData:m.current,connected:t}).errors;Object.keys(a).length>0||(u({}),v({status:`open`,action:`create-connection`,phase:`editing`,formState:r,pendingSubmit:null,serverMessage:null,connectionLost:!1}))},[t,_,v]),C=(0,P.useCallback)(e=>{if(!t){_(Uc,`error`);return}if(qc(d.current)){_(Mc,`error`);return}let n=$c(m.current,e.alias);if(!n){_(Vc,`error`);return}let r=pa(n);if(!r.valid||!r.formState){_(r.message??`This node cannot be edited in the UI.`,`error`);return}u({}),v({status:`open`,action:`edit-node`,phase:`editing`,formState:r.formState,originalAlias:n.alias,pendingSubmit:null,serverMessage:null,connectionLost:!1})},[t,_,v]),ee=(0,P.useCallback)(e=>{if(!t){_(Fc,`error`);return}if(qc(d.current)){_(Mc,`error`);return}let n=Ui(e.alias,{graphData:m.current});if(!n.valid){_(Object.values(n.errors)[0]??`Invalid node alias.`,`error`);return}let i;try{i=$i(e.alias,{graphData:m.current})}catch(e){_(e instanceof Error?e.message:String(e),`error`);return}if(!r.execute(i)){_(Fc,`error`);return}let a={action:`delete-node`,alias:e.alias.trim(),command:i,sentAt:new Date().toISOString()};u({}),v({status:`closed`,pendingSubmit:a,serverMessage:null}),b()},[t,r,_,v,b]),te=(0,P.useCallback)(e=>{if(!t){_(Lc,`error`);return}if(qc(d.current)){_(Mc,`error`);return}if(e.length===0){_(Rc,`info`);return}if(e.length>100){_(zc,`error`);return}let n=new Set,i=e.filter(e=>{let t=e.alias.trim().toLowerCase();return n.has(t)?!1:(n.add(t),!0)}),a=[],o=[];for(let e of i){let t=Ui(e.alias,{graphData:m.current});if(!t.valid){_(Object.values(t.errors)[0]??Rc,`error`);return}try{o.push(e.alias.trim()),a.push($i(e.alias,{graphData:m.current}))}catch(e){_(e instanceof Error?e.message:String(e),`error`);return}}for(let[e,t]of a.entries())if(!r.execute(t)){_(e===0?Lc:Gc,`error`);return}let s={action:`delete-nodes`,aliases:o,commands:a,sentAt:new Date().toISOString(),results:{}};u({}),v({status:`closed`,pendingSubmit:s,serverMessage:null}),_(`${o.length} delete-node commands sent. Waiting for backend response.`,`info`),b()},[t,r,_,v,b]),w=(0,P.useCallback)(e=>{let t=d.current;if(t.status===`open`&&!(t.phase===`sending`||t.connectionLost)){if(u({}),t.action===`create-connection`){if(!al(e))return;v({...t,formState:e,pendingSubmit:null,serverMessage:null,connectionLost:!1});return}al(e)||v({...t,formState:e,pendingSubmit:null,serverMessage:null,connectionLost:!1})}},[v]),T=(0,P.useCallback)(()=>{let e=d.current;if(e.status!==`open`||e.phase===`sending`||e.connectionLost)return;let n=e.action;if(!t){v({...e,serverMessage:Yc(n)});return}let i=e.action===`create-connection`?Ki(e.formState,{graphData:m.current,connected:t}):Hi(e.formState,e.action===`edit-node`?{mode:`edit`,originalAlias:e.originalAlias}:{graphData:m.current});if(!i.valid){u(i.errors);return}let a,o,s=null;try{if(e.action===`edit-node`)o=e.originalAlias?.trim()??``,a=Qi(e.formState,o);else if(e.action===`create-node`)o=e.formState.alias.trim(),a=Zi(e.formState);else if(al(e.formState))o=e.formState.sourceAlias.trim(),s=e.formState.targetAlias.trim(),a=ta(e.formState);else{u({command:`Invalid connection form state.`});return}}catch(e){u({command:e instanceof Error?e.message:String(e)});return}if(!r.execute(a)){v(nl(e));return}let c={action:n,alias:o,targetAlias:s,command:a,sentAt:new Date().toISOString()};u({}),v({...e,phase:`sending`,pendingSubmit:c,serverMessage:null,connectionLost:!1}),b()},[t,r,v,b]),E=(0,P.useCallback)(()=>{let e=d.current;e.status===`open`&&e.phase!==`sending`&&(y(),u({}),v(Kc))},[y,v]);return(0,P.useEffect)(()=>e.on(`minigraph.nodeAction.textResult`,e=>{let t=d.current,n=qc(t);if(!n)return;if(Jc(n)){let r=Ca(n,e);if(!r)return;if(e.status===`accepted`&&h.current?.({status:e.status,action:e.action,alias:e.alias,targetAlias:e.targetAlias,message:e.message}),!wa(r)){v({...t,pendingSubmit:r});return}y(),v(Kc);let i=Ta(r);_(i.message,i.type);return}let r=tl(t,e);r&&(y(),r.acceptedResult&&u({}),v(r.state),r.acceptedResult&&h.current?.(r.acceptedResult),r.notification&&_(r.notification.message,r.notification.type))}),[e,y,_,v]),(0,P.useEffect)(()=>{if(p.current&&!t){let e=il(d.current);e&&(y(),v(e.state),e.notification&&_(e.notification.message,e.notification.type))}p.current=t},[y,t,_,v]),(0,P.useEffect)(()=>()=>{y()},[y]),{state:s,validationErrors:l,openCreateNode:x,openCreateConnection:S,openEditNode:C,deleteNode:ee,deleteNodes:te,updateFormState:w,submit:T,close:E}}var sl=/^ws-\d+-\d+$/;function cl(e){return sl.test(e.trim())}var ll={sessionId:null,startedSince:null,subscribedTo:null,subscribers:[],loading:!1,pendingCommand:null,error:null,lastInfo:null};function ul(e){return Array.from(new Set(e)).sort()}function dl({enabled:e,connected:t,bus:n,classificationMap:r,sendRawText:i,addToast:a}){let[o,s]=(0,P.useState)(ll),c=(0,P.useRef)(new Set),l=(0,P.useRef)(0),u=(0,P.useRef)(i),d=(0,P.useRef)(a);(0,P.useEffect)(()=>{u.current=i},[i]),(0,P.useEffect)(()=>{d.current=a},[a]);let f=(0,P.useCallback)(()=>{if(!e||!t)return!1;s(e=>({...e,loading:!0,pendingCommand:`refresh`,error:null,lastInfo:null}));let n=u.current(`session`);if(!n){let e=`Could not load session details because the WebSocket is not open.`;s(t=>({...t,loading:!1,pendingCommand:null,error:e})),d.current(e,`error`)}return n},[t,e]),p=(0,P.useCallback)(e=>{let t=`${e.kind}:${e.msgId}`;if(!c.current.has(t)){if(c.current.add(t),e.kind===`minigraph.session.started`){s({...ll,sessionId:e.sessionId});return}if(e.kind===`minigraph.session.status`){s(t=>({...t,sessionId:e.sessionId,startedSince:e.startedSince,subscribedTo:e.subscribedTo,subscribers:ul(e.subscribers),loading:!1,pendingCommand:null,error:null,lastInfo:null}));return}if(e.kind===`minigraph.session.commandResult`){if(e.status===`accepted`){s(t=>({...t,subscribedTo:e.command===`subscribe`?e.sessionId:e.command===`unsubscribe`?null:t.subscribedTo,pendingCommand:null,error:null,lastInfo:null}));return}s(t=>({...t,pendingCommand:null,error:e.message,lastInfo:null}));return}if(e.kind===`minigraph.session.notification`){e.type===`host-closed`?s(t=>({...t,subscribedTo:t.subscribedTo===e.sessionId?null:t.subscribedTo,subscribers:t.subscribers.filter(t=>t!==e.sessionId),error:null,lastInfo:null})):e.type===`subscriber-joined`?s(t=>({...t,subscribers:ul([...t.subscribers,e.sessionId]),error:null,lastInfo:null})):s(t=>({...t,subscribers:t.subscribers.filter(t=>t!==e.sessionId),error:null,lastInfo:null}));return}e.kind===`session.reset`&&(s(e=>({...e,startedSince:null,subscribedTo:null,subscribers:[],loading:!1,pendingCommand:null,error:null,lastInfo:null})),f())}},[f]),m=(0,P.useCallback)(()=>{s(e=>({...e,error:null,lastInfo:null}))},[]),h=(0,P.useCallback)(n=>{let r=n.trim();if(!e||!t||o.pendingCommand!==null||o.subscribedTo!==null)return!1;if(!cl(r))return s(e=>({...e,error:`Enter a valid session ID like ws-123456-1.`,lastInfo:null})),!1;s(e=>({...e,pendingCommand:`subscribe`,error:null,lastInfo:null}));let c=i(`session subscribe ${r}`);if(!c){let e=`Could not subscribe because the WebSocket is not open.`;s(t=>({...t,pendingCommand:null,error:e})),a(e,`error`)}return c},[a,t,e,i,o.pendingCommand,o.subscribedTo]),g=(0,P.useCallback)(()=>{if(!e||!t||o.pendingCommand!==null||o.subscribedTo===null)return!1;s(e=>({...e,pendingCommand:`unsubscribe`,error:null,lastInfo:null}));let n=i(`session unsubscribe`);if(!n){let e=`Could not unsubscribe because the WebSocket is not open.`;s(t=>({...t,pendingCommand:null,error:e})),a(e,`error`)}return n},[a,t,e,i,o.pendingCommand,o.subscribedTo]),_=(0,P.useCallback)(()=>{if(!e||!t||o.pendingCommand!==null||o.subscribedTo!==null||o.subscribers.length===0)return!1;s(e=>({...e,pendingCommand:`reset`,error:null,lastInfo:null}));let n=i(`session reset`);if(!n){let e=`Could not reset because the WebSocket is not open.`;s(t=>({...t,pendingCommand:null,error:e})),a(e,`error`)}return n},[a,t,e,i,o.pendingCommand,o.subscribedTo,o.subscribers.length]);(0,P.useEffect)(()=>{e&&t||(c.current.clear(),l.current=0,s(ll))},[t,e]),(0,P.useEffect)(()=>{if(!e)return;let t=n.on(`minigraph.session.started`,e=>{p(e)}),r=n.on(`minigraph.session.status`,e=>{p(e)}),i=n.on(`minigraph.session.commandResult`,e=>{p(e)}),a=n.on(`minigraph.session.notification`,e=>{p(e)}),o=n.on(`session.reset`,e=>{p(e)});return()=>{t(),r(),i(),a(),o()}},[n,e,p]),(0,P.useEffect)(()=>{!e||!t||f()},[t,e,f]),(0,P.useEffect)(()=>{if(!e||!r)return;let t=l.current;for(let[e,n]of r)if(!(e<=l.current)){for(let e of n)(e.kind===`minigraph.session.started`||e.kind===`minigraph.session.status`||e.kind===`minigraph.session.commandResult`||e.kind===`minigraph.session.notification`||e.kind===`session.reset`)&&p(e);t=Math.max(t,e)}l.current=t,c.current.clear()},[r,e,p]);let v=o.subscribedTo===null,y=o.subscribers.length>0;return(0,P.useMemo)(()=>({state:o,connected:t,isPrimary:v,hasSubscribers:y,canSubscribe:e&&t&&o.pendingCommand===null&&o.subscribedTo===null,canUnsubscribe:e&&t&&o.subscribedTo!==null&&o.pendingCommand===null,canReset:e&&t&&o.pendingCommand===null&&o.subscribedTo===null&&o.subscribers.length>0,subscribeToSession:h,unsubscribe:g,resetSession:_,clearMessage:m}),[m,t,e,y,v,_,o,h,g])}var fl=(e,t)=>t.some(t=>e instanceof t),pl,ml;function hl(){return pl||=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]}function gl(){return ml||=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey]}var _l=new WeakMap,vl=new WeakMap,yl=new WeakMap;function bl(e){let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`success`,i),e.removeEventListener(`error`,a)},i=()=>{t(El(e.result)),r()},a=()=>{n(e.error),r()};e.addEventListener(`success`,i),e.addEventListener(`error`,a)});return yl.set(t,e),t}function xl(e){if(_l.has(e))return;let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`complete`,i),e.removeEventListener(`error`,a),e.removeEventListener(`abort`,a)},i=()=>{t(),r()},a=()=>{n(e.error||new DOMException(`AbortError`,`AbortError`)),r()};e.addEventListener(`complete`,i),e.addEventListener(`error`,a),e.addEventListener(`abort`,a)});_l.set(e,t)}var Sl={get(e,t,n){if(e instanceof IDBTransaction){if(t===`done`)return _l.get(e);if(t===`store`)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return El(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t===`done`||t===`store`)||t in e}};function Cl(e){Sl=e(Sl)}function wl(e){return gl().includes(e)?function(...t){return e.apply(Dl(this),t),El(this.request)}:function(...t){return El(e.apply(Dl(this),t))}}function Tl(e){return typeof e==`function`?wl(e):(e instanceof IDBTransaction&&xl(e),fl(e,hl())?new Proxy(e,Sl):e)}function El(e){if(e instanceof IDBRequest)return bl(e);if(vl.has(e))return vl.get(e);let t=Tl(e);return t!==e&&(vl.set(e,t),yl.set(t,e)),t}var Dl=e=>yl.get(e);function Ol(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,t),s=El(o);return r&&o.addEventListener(`upgradeneeded`,e=>{r(El(o.result),e.oldVersion,e.newVersion,El(o.transaction),e)}),n&&o.addEventListener(`blocked`,e=>n(e.oldVersion,e.newVersion,e)),s.then(e=>{a&&e.addEventListener(`close`,()=>a()),i&&e.addEventListener(`versionchange`,e=>i(e.oldVersion,e.newVersion,e))}).catch(()=>{}),s}function kl(e,{blocked:t}={}){let n=indexedDB.deleteDatabase(e);return t&&n.addEventListener(`blocked`,e=>t(e.oldVersion,e)),El(n).then(()=>void 0)}var Al=[`get`,`getKey`,`getAll`,`getAllKeys`,`count`],jl=[`put`,`add`,`delete`,`clear`],Ml=new Map;function Nl(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t==`string`))return;if(Ml.get(t))return Ml.get(t);let n=t.replace(/FromIndex$/,``),r=t!==n,i=jl.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||Al.includes(n)))return;let a=async function(e,...t){let a=this.transaction(e,i?`readwrite`:`readonly`),o=a.store;return r&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),i&&a.done]))[0]};return Ml.set(t,a),a}Cl(e=>({...e,get:(t,n,r)=>Nl(t,n)||e.get(t,n,r),has:(t,n)=>!!Nl(t,n)||e.has(t,n)}));var Pl=[`continue`,`continuePrimaryKey`,`advance`],Fl={},Il=new WeakMap,Ll=new WeakMap,Rl={get(e,t){if(!Pl.includes(t))return e[t];let n=Fl[t];return n||=Fl[t]=function(...e){Il.set(this,Ll.get(this)[t](...e))},n}};async function*zl(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;let n=new Proxy(t,Rl);for(Ll.set(n,t),yl.set(n,Dl(t));t;)yield n,t=await(Il.get(n)||t.continue()),Il.delete(n)}function G(e,t){return t===Symbol.asyncIterator&&fl(e,[IDBIndex,IDBObjectStore,IDBCursor])||t===`iterate`&&fl(e,[IDBIndex,IDBObjectStore])}Cl(e=>({...e,get(t,n,r){return G(t,n)?zl:e.get(t,n,r)},has(t,n){return G(t,n)||e.has(t,n)}}));var K=`minigraph-clipboard`,q=1,J=`items`,Y=null;function Bl(){return Ol(K,q,{upgrade(e){e.objectStoreNames.contains(J)&&e.deleteObjectStore(J);let t=e.createObjectStore(J,{keyPath:`id`});t.createIndex(`by-alias`,`node.alias`,{unique:!0}),t.createIndex(`by-clippedAt`,`clippedAt`)}})}function Vl(){return Y||=Bl().catch(async e=>(console.warn(`[clipboard/db] openDB failed, deleting and recreating:`,e),Y=null,await kl(K),Bl())),Y}async function Hl(){return(await(await Vl()).getAllFromIndex(J,`by-clippedAt`)).reverse()}async function Ul(e){return(await Vl()).getFromIndex(J,`by-alias`,e)}async function Wl(e){await(await Vl()).add(J,e)}async function Gl(e,t){let n=(await Vl()).transaction(J,`readwrite`);await n.store.delete(e),await n.store.add(t),await n.done}async function Kl(e){await(await Vl()).delete(J,e)}async function ql(){await(await Vl()).clear(J)}var Jl=`minigraph-clipboard-sync`;function Yl(){return new BroadcastChannel(Jl)}function Xl(e,t){switch(t.type){case`HYDRATE`:return{items:t.items,isLoading:!1};case`ITEM_ADDED`:return{...e,items:[t.item,...e.items]};case`ITEM_REPLACED`:{let n=e.items.filter(e=>e.id!==t.previousId);return{...e,items:[t.item,...n]}}case`ITEM_REMOVED`:return{...e,items:e.items.filter(e=>e.id!==t.id)};case`ITEMS_CLEARED`:return{...e,items:[]};default:return e}}var Zl=(0,P.createContext)(null);function Ql({children:e}){let[t,n]=(0,P.useReducer)(Xl,{items:[],isLoading:!0}),r=(0,P.useRef)(null);(0,P.useEffect)(()=>{Hl().then(e=>n({type:`HYDRATE`,items:e}))},[]),(0,P.useEffect)(()=>{let e;try{e=Yl()}catch{return}return r.current=e,e.onmessage=e=>{let t=e.data;switch(t.type){case`item-added`:n({type:`ITEM_ADDED`,item:t.item});break;case`item-replaced`:n({type:`ITEM_REPLACED`,item:t.item,previousId:t.previousId});break;case`item-removed`:n({type:`ITEM_REMOVED`,id:t.id});break;case`items-cleared`:n({type:`ITEMS_CLEARED`});break}},()=>{e.close(),r.current=null}},[]);let i=(0,P.useCallback)(e=>{r.current?.postMessage(e)},[]),a=(0,P.useCallback)(async(e,t,r)=>{try{let a={id:crypto.randomUUID(),clippedAt:new Date().toISOString(),sourceWsPath:r.sourceWsPath,sourceLabel:r.sourceLabel,node:e,connections:t},o=await Ul(e.alias);if(o)return{status:`duplicate`,existingItem:o,pendingItem:a};try{await Wl(a)}catch(t){if(t instanceof DOMException&&t.name===`ConstraintError`){let t=await Ul(e.alias);if(t)return{status:`duplicate`,existingItem:t,pendingItem:a}}throw t}return n({type:`ITEM_ADDED`,item:a}),i({type:`item-added`,item:a}),{status:`added`}}catch(e){return{status:`error`,message:e instanceof Error?e.message:String(e)}}},[i]),o=(0,P.useCallback)(async(e,t)=>{await Gl(t,e),n({type:`ITEM_REPLACED`,item:e,previousId:t}),i({type:`item-replaced`,item:e,previousId:t})},[i]),s=(0,P.useCallback)(async e=>{await Kl(e),n({type:`ITEM_REMOVED`,id:e}),i({type:`item-removed`,id:e})},[i]),c=(0,P.useCallback)(async()=>{await ql(),n({type:`ITEMS_CLEARED`}),i({type:`items-cleared`})},[i]);return(0,I.jsx)(Zl.Provider,{value:{items:t.items,isLoading:t.isLoading,clipNode:a,confirmReplace:o,removeItem:s,clearAll:c},children:e})}function $l(){let e=(0,P.useContext)(Zl);if(!e)throw Error(`useClipboardContext must be used inside <ClipboardProvider>`);return e}var eu=new Intl.Collator(void 0,{sensitivity:`base`,numeric:!0});function tu(e){return e.node.types[0]?.trim()||`unknown`}function nu(e,t){return eu.compare(e,t)}function ru(e,t){return e-t}function iu(e){return e===`recent`||e===`connections`?`descending`:`ascending`}function au(e,t){return t===`descending`?-e:e}function ou(e,t){let n=t.trim();if(!n)return{missing:!0,value:``};let r=e.node.properties[n];return r==null?{missing:!0,value:``}:typeof r==`string`?{missing:!1,value:r}:typeof r==`number`||typeof r==`boolean`?{missing:!1,value:String(r)}:{missing:!1,value:JSON.stringify(r)}}function su(e,t,n,r){let i=ou(e,n),a=ou(t,n);return i.missing&&!a.missing?1:!i.missing&&a.missing?-1:au(nu(i.value,a.value),r)}function cu(e,t){let n=t.direction??iu(t.field);return e.map((e,t)=>({item:e,originalIndex:t})).sort((e,r)=>{let i=0;switch(t.field){case`type`:i=nu(tu(e.item),tu(r.item));break;case`alias`:i=nu(e.item.node.alias,r.item.node.alias);break;case`source`:i=nu(e.item.sourceLabel,r.item.sourceLabel);break;case`connections`:i=e.item.connections.length-r.item.connections.length;break;case`property`:i=su(e.item,r.item,t.propertyKey??``,n);break;default:i=Date.parse(e.item.clippedAt)-Date.parse(r.item.clippedAt);break}return t.field!==`property`&&(i=au(i,n)),i===0?ru(e.originalIndex,r.originalIndex):i}).map(({item:e})=>e)}function lu(e){let t=Date.now()-new Date(e).getTime();if(t<0)return`just now`;let n=Math.floor(t/1e3);if(n<60)return`just now`;let r=Math.floor(n/60);if(r<60)return`${r} min ago`;let i=Math.floor(r/60);if(i<24)return`${i} hour${i>1?`s`:``} ago`;let a=Math.floor(i/24);return a===1?`yesterday`:a<30?`${a} days ago`:new Date(e).toLocaleDateString()}var uu={item:`_item_1ne62_1`,previewFrame:`_previewFrame_1ne62_13`,preview:`_preview_1ne62_13`,previewShell:`_previewShell_1ne62_25`,metaBlock:`_metaBlock_1ne62_29`,timestamp:`_timestamp_1ne62_35`,removeChrome:`_removeChrome_1ne62_40`,removeIcon:`_removeIcon_1ne62_71`};function du({item:e,onRemove:t,onOpenMenu:n,onCloseMenu:r}){let{node:i,clippedAt:a,sourceLabel:o}=e;return(0,I.jsxs)(`div`,{className:uu.item,children:[(0,I.jsxs)(`div`,{className:uu.previewFrame,children:[(0,I.jsx)(`button`,{type:`button`,className:uu.removeChrome,draggable:!1,"aria-label":`Remove node ${i.alias} from clipboard`,onClick:n=>{n.stopPropagation(),r(),t(e.id)},children:(0,I.jsx)(_c,{className:uu.removeIcon,"aria-hidden":`true`,focusable:`false`})}),(0,I.jsx)(`div`,{className:uu.preview,role:`group`,draggable:!0,onDragStart:t=>{r(),Ds(t.dataTransfer,e.id)},onContextMenu:t=>{t.preventDefault(),n(e.id,t.clientX,t.clientY)},onKeyDown:t=>{if(t.key===`ContextMenu`||t.key===`F10`&&t.shiftKey){t.preventDefault();let r=t.currentTarget.getBoundingClientRect();n(e.id,Math.round(r.left+8),Math.round(r.top+8))}},tabIndex:0,"aria-label":`Drag node ${i.alias} into the graph to paste`,children:(0,I.jsx)(`div`,{className:uu.previewShell,style:$a(i.types[0]??`unknown`),children:(0,I.jsx)(ro,{alias:i.alias,nodeType:i.types[0]??`unknown`,properties:i.properties})})})]}),(0,I.jsx)(`div`,{className:uu.metaBlock,children:(0,I.jsxs)(`div`,{className:uu.timestamp,children:[`Clipped `,lu(a),` from `,o]})})]})}var fu={menu:`_menu_164vh_1`,menuItem:`_menuItem_164vh_12`},pu=16;function mu(e,t,n){let r=pu,i=Math.max(pu,n-t-pu);return Math.min(Math.max(e,r),i)}function hu({open:e,x:t,y:n,canPasteToInput:r,onPasteToInput:i,onInspect:a,onClose:o}){let s=(0,P.useRef)(null),c=(0,P.useRef)(null),l=(0,P.useRef)(null),[u,d]=(0,P.useState)({left:t,top:n});return(0,P.useLayoutEffect)(()=>{if(!e||!s.current)return;let r=s.current.getBoundingClientRect();d({left:mu(t,r.width,window.innerWidth),top:mu(n,r.height,window.innerHeight)})},[e,t,n]),(0,P.useEffect)(()=>{if(!e)return;r?c.current?.focus():l.current?.focus();let t=e=>{s.current&&!s.current.contains(e.target)&&o()},n=e=>{e.key===`Escape`&&(e.preventDefault(),o())},i=()=>o();return document.addEventListener(`pointerdown`,t),document.addEventListener(`keydown`,n),window.addEventListener(`scroll`,i,!0),window.addEventListener(`resize`,i),()=>{document.removeEventListener(`pointerdown`,t),document.removeEventListener(`keydown`,n),window.removeEventListener(`scroll`,i,!0),window.removeEventListener(`resize`,i)}},[e,r,o]),e?(0,I.jsxs)(`div`,{ref:s,className:fu.menu,style:{left:u.left,top:u.top},role:`menu`,"aria-label":`Clipboard item actions`,children:[(0,I.jsx)(`button`,{ref:c,role:`menuitem`,type:`button`,className:fu.menuItem,disabled:!r,onClick:()=>{r&&i()},children:`Paste to Input`}),(0,I.jsx)(`button`,{ref:l,role:`menuitem`,type:`button`,className:fu.menuItem,onClick:a,children:`Inspect`})]}):null}var X={sidebar:`_sidebar_1jo34_2`,header:`_header_1jo34_12`,headerTitle:`_headerTitle_1jo34_25`,clearBtn:`_clearBtn_1jo34_32`,sortBar:`_sortBar_1jo34_48`,sortMenuWrapper:`_sortMenuWrapper_1jo34_63`,sortMenuButton:`_sortMenuButton_1jo34_68`,sortButtonLabel:`_sortButtonLabel_1jo34_93`,sortButtonValue:`_sortButtonValue_1jo34_98`,sortButtonDirection:`_sortButtonDirection_1jo34_106`,sortButtonCaret:`_sortButtonCaret_1jo34_114`,sortButtonCaretOpen:`_sortButtonCaretOpen_1jo34_121`,sortPopover:`_sortPopover_1jo34_125`,sortGroup:`_sortGroup_1jo34_139`,propertySortRow:`_propertySortRow_1jo34_150`,sortGroupTitle:`_sortGroupTitle_1jo34_154`,sortOption:`_sortOption_1jo34_164`,propertyLabel:`_propertyLabel_1jo34_197`,propertyInput:`_propertyInput_1jo34_205`,itemList:`_itemList_1jo34_223`,loading:`_loading_1jo34_233`,emptyState:`_emptyState_1jo34_243`,emptyIcon:`_emptyIcon_1jo34_256`,emptyTitle:`_emptyTitle_1jo34_261`,emptyHint:`_emptyHint_1jo34_265`,inspectPanel:`_inspectPanel_1jo34_271`,inspectHeader:`_inspectHeader_1jo34_279`,inspectClose:`_inspectClose_1jo34_293`,inspectBody:`_inspectBody_1jo34_307`,dialog:`_dialog_1jo34_313`,dialogTitle:`_dialogTitle_1jo34_328`,dialogBody:`_dialogBody_1jo34_335`,dialogActions:`_dialogActions_1jo34_342`,cancelBtn:`_cancelBtn_1jo34_349`,replaceBtn:`_replaceBtn_1jo34_363`};function gu(){return(0,I.jsxs)(`div`,{className:X.emptyState,children:[(0,I.jsx)(`span`,{className:X.emptyIcon,children:`📋`}),(0,I.jsx)(`span`,{className:X.emptyTitle,children:`No items clipped yet.`}),(0,I.jsx)(`span`,{className:X.emptyHint,children:`Right-click a node in the Graph view to get started.`})]})}var _u=[{value:`recent`,label:`Recent`},{value:`type`,label:`Type`},{value:`alias`,label:`Alias`},{value:`source`,label:`Source`},{value:`connections`,label:`Connections`},{value:`property`,label:`Property`}],vu=[{value:`ascending`,label:`Ascending`},{value:`descending`,label:`Descending`}],yu=_u.reduce((e,t)=>({...e,[t.value]:t.label}),{});function bu({connected:e,onPasteToInput:t}){let n=(0,P.useId)(),i=(0,P.useId)(),a=(0,P.useRef)(null),s=$l(),[c,l]=(0,P.useState)(null),[u,d]=(0,P.useState)(null),[f,p]=(0,P.useState)(`recent`),[m,h]=(0,P.useState)(iu(`recent`)),[g,_]=(0,P.useState)(``),[v,y]=(0,P.useState)(!1),b=(e,t,n)=>{d({itemId:e,x:t,y:n})},x=()=>{d(null)},S=e=>{x(),t(e)},C=e=>{x(),l(t=>t?.id===e.id?null:e)},ee=e=>{x(),l(t=>t?.id===e?null:t),s.removeItem(e)},te=()=>{x(),l(null),s.clearAll()},w=e=>{p(e),h(iu(e))};(0,P.useEffect)(()=>{let e=new Set(s.items.map(e=>e.id));u&&!e.has(u.itemId)&&d(null),c&&!e.has(c.id)&&l(null)},[s.items,u,c]),(0,P.useEffect)(()=>{if(!v)return;let e=e=>{a.current?.contains(e.target)||y(!1)},t=e=>{e.key===`Escape`&&y(!1)};return document.addEventListener(`pointerdown`,e),document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`pointerdown`,e),document.removeEventListener(`keydown`,t)}},[v]);let T=(0,P.useMemo)(()=>u?s.items.find(e=>e.id===u.itemId)??null:null,[u,s.items]),E=(0,P.useMemo)(()=>cu(s.items,{field:f,direction:m,propertyKey:g}),[s.items,m,f,g]);return(0,I.jsxs)(`div`,{className:X.sidebar,children:[(0,I.jsxs)(`div`,{className:X.header,children:[(0,I.jsx)(`span`,{className:X.headerTitle,children:`Workspace`}),s.items.length>0&&(0,I.jsx)(`button`,{className:X.clearBtn,onClick:te,"aria-label":`Clear all workspace items`,children:`Clear`})]}),s.items.length>0&&(0,I.jsx)(`div`,{className:X.sortBar,children:(0,I.jsxs)(`div`,{className:X.sortMenuWrapper,ref:a,children:[(0,I.jsxs)(`button`,{type:`button`,className:X.sortMenuButton,onClick:()=>y(e=>!e),"aria-expanded":v,"aria-controls":n,children:[(0,I.jsx)(`span`,{className:X.sortButtonLabel,children:`Sort`}),(0,I.jsx)(`span`,{className:X.sortButtonValue,children:yu[f]}),(0,I.jsx)(`span`,{className:X.sortButtonDirection,children:m===`ascending`?`Asc`:`Desc`}),(0,I.jsx)(`span`,{className:`${X.sortButtonCaret}${v?` ${X.sortButtonCaretOpen}`:``}`,"aria-hidden":`true`,children:`▾`})]}),v&&(0,I.jsxs)(`div`,{id:n,className:X.sortPopover,children:[(0,I.jsxs)(`div`,{className:X.sortGroup,role:`group`,"aria-labelledby":`${n}-field-title`,children:[(0,I.jsx)(`div`,{id:`${n}-field-title`,className:X.sortGroupTitle,children:`Sort By`}),_u.map(e=>(0,I.jsxs)(`label`,{className:X.sortOption,children:[(0,I.jsx)(`input`,{type:`radio`,name:`${n}-field`,value:e.value,checked:f===e.value,onChange:()=>w(e.value)}),(0,I.jsx)(`span`,{children:e.label})]},e.value))]}),f===`property`&&(0,I.jsxs)(`div`,{className:X.propertySortRow,children:[(0,I.jsx)(`label`,{className:X.propertyLabel,htmlFor:i,children:`Property Key`}),(0,I.jsx)(`input`,{id:i,className:X.propertyInput,value:g,onChange:e=>_(e.target.value),placeholder:`skill`,"aria-label":`Property key to sort by`})]}),(0,I.jsxs)(`div`,{className:X.sortGroup,role:`group`,"aria-labelledby":`${n}-direction-title`,children:[(0,I.jsx)(`div`,{id:`${n}-direction-title`,className:X.sortGroupTitle,children:`Sort Direction`}),vu.map(e=>(0,I.jsxs)(`label`,{className:X.sortOption,children:[(0,I.jsx)(`input`,{type:`radio`,name:`${n}-direction`,value:e.value,checked:m===e.value,onChange:()=>h(e.value)}),(0,I.jsx)(`span`,{children:e.label})]},e.value))]})]})]})}),(0,I.jsx)(`div`,{className:X.itemList,children:s.isLoading?(0,I.jsx)(`div`,{className:X.loading,children:`Loading…`}):s.items.length===0?(0,I.jsx)(gu,{}):E.map(e=>(0,I.jsx)(du,{item:e,onRemove:ee,onOpenMenu:b,onCloseMenu:x},e.id))}),c&&(0,I.jsxs)(`div`,{className:X.inspectPanel,children:[(0,I.jsxs)(`div`,{className:X.inspectHeader,children:[(0,I.jsxs)(`span`,{children:[`Inspect node `,c.node.alias]}),(0,I.jsx)(`button`,{className:X.inspectClose,onClick:()=>l(null),"aria-label":`Close inspect panel`,children:`✕`})]}),(0,I.jsx)(`div`,{className:X.inspectBody,children:(0,I.jsx)(o,{data:{node:c.node,connections:c.connections},style:r})})]}),u&&T&&(0,I.jsx)(hu,{open:!0,x:u.x,y:u.y,canPasteToInput:e,onPasteToInput:()=>S(T),onInspect:()=>C(T),onClose:x})]})}function xu(e){let{wheelTargetRef:t,scrollRef:n,contentWrapperRef:r,currentIndex:i,totalPages:a,onNavigatePrev:o,onNavigateNext:s}=e,c=(0,P.useRef)(0),l=(0,P.useRef)(null),u=(0,P.useRef)(!1),d=(0,P.useRef)(null),f=(0,P.useRef)(o),p=(0,P.useRef)(s),m=(0,P.useRef)(i),h=(0,P.useRef)(a);(0,P.useEffect)(()=>{f.current=o}),(0,P.useEffect)(()=>{p.current=s}),(0,P.useEffect)(()=>{m.current=i}),(0,P.useEffect)(()=>{h.current=a}),(0,P.useEffect)(()=>{d.current!==null&&(clearTimeout(d.current),d.current=null),r.current&&(r.current.style.transition=`none`,r.current.style.transform=`translateY(0)`),c.current=0,l.current=null},[i]),(0,P.useEffect)(()=>{let e=t.current;if(!e)return;function i(){c.current=0,l.current=null,r.current&&(r.current.style.transition=`transform 0.28s cubic-bezier(0.25, 0.46, 0.45, 0.94)`,r.current.style.transform=`translateY(0)`)}function a(e){if(e.deltaY===0)return;let t=n.current;if(!t)return;let a=t.scrollTop<=0,o=t.scrollTop+t.clientHeight>=t.scrollHeight-1,s=e.deltaY<0,g=e.deltaY>0,_=a&&s,v=o&&g;if(!_&&!v){i();return}if(u.current)return;let y=m.current,b=h.current;if(_&&y===0||v&&y===b-1)return;let x=_?`prev`:`next`;if(l.current!==null&&l.current!==x&&i(),l.current=x,c.current+=Math.abs(e.deltaY),r.current){let e=x===`prev`?-1:1,t=c.current*(18/120),n=Math.min(t,18)*e;r.current.style.transition=`none`,r.current.style.transform=`translateY(${n}px)`}if(d.current!==null&&clearTimeout(d.current),d.current=setTimeout(i,180),c.current>=120){d.current!==null&&clearTimeout(d.current);let e=l.current;i(),u.current=!0,e===`prev`?f.current():p.current(),setTimeout(()=>{u.current=!1},650)}}return e.addEventListener(`wheel`,a,{passive:!0}),()=>{d.current!==null&&clearTimeout(d.current),e.removeEventListener(`wheel`,a)}},[])}var Su={helpRoot:`_helpRoot_18tja_2`,categoryNav:`_categoryNav_18tja_11`,categoryTabScroller:`_categoryTabScroller_18tja_21`,categoryTab:`_categoryTab_18tja_21`,categoryTabActive:`_categoryTabActive_18tja_71`,maximizeButton:`_maximizeButton_18tja_78`,closeButton:`_closeButton_18tja_100`,helpBody:`_helpBody_18tja_122`,emptyFallback:`_emptyFallback_18tja_130`,helpContent:`_helpContent_18tja_147`,topicLink:`_topicLink_18tja_226`,helpBodyContent:`_helpBodyContent_18tja_271`,chipStrip:`_chipStrip_18tja_276`,chipStripLabel:`_chipStripLabel_18tja_294`,topicChip:`_topicChip_18tja_310`,topicChipActive:`_topicChipActive_18tja_338`};function Cu(e){return typeof e==`string`?e:typeof e==`number`?String(e):Array.isArray(e)?e.map(Cu).join(``):P.isValidElement(e)?Cu(e.props.children):``}function wu(e){if(!e.trim().toLowerCase().startsWith(`help `))return null;let t=e.trim().slice(5).replace(/\s*\(.*\)\s*$/,``).trim().toLowerCase();return t.length>0?t:null}function Tu({activeTopic:e,onNavigate:t,onClose:n,onToggleMaximize:r,isMaximized:i}){let a=(0,P.useRef)(null),o=(0,P.useRef)(null),s=(0,P.useRef)(null),c=(0,P.useRef)(null);(0,P.useEffect)(()=>{a.current&&(a.current.scrollTop=0)},[e]),(0,P.useEffect)(()=>{let e=c.current;if(!e)return;let t=e.querySelector(`[aria-current="step"]`);t&&t.scrollIntoView({block:`nearest`,inline:`nearest`,behavior:`smooth`})},[e]);let l=ui(e),u=(0,P.useMemo)(()=>di(l),[l]),d=u.length,f=(0,P.useMemo)(()=>ci.find(e=>e.id===l)?.chipStripLabel??null,[l]),p=pi.indexOf(e),m=p<0?0:p,h=pi.length;xu({wheelTargetRef:o,scrollRef:a,contentWrapperRef:s,currentIndex:m,totalPages:h,onNavigatePrev:()=>t(pi[m-1]??``),onNavigateNext:()=>t(pi[m+1]??pi[pi.length-1])});let g=oi(e);return(0,I.jsxs)(`div`,{className:Su.helpRoot,role:`region`,"aria-label":`Help browser`,ref:o,children:[(0,I.jsxs)(`nav`,{className:Su.categoryNav,"aria-label":`Help categories`,children:[(0,I.jsx)(`div`,{className:Su.categoryTabScroller,children:ci.map(e=>(0,I.jsx)(`button`,{className:[Su.categoryTab,e.id===l?Su.categoryTabActive:``].join(` `).trim(),"aria-current":e.id===l?`true`:void 0,onClick:()=>{t(di(e.id)[0]??``)},children:e.label},e.id))}),r&&(0,I.jsx)(`button`,{className:Su.maximizeButton,onClick:r,"aria-label":i?`Restore help panel`:`Maximize help panel`,children:i?`⊞`:`⛶`}),n&&(0,I.jsx)(`button`,{className:Su.closeButton,onClick:n,"aria-label":`Close help panel`,children:`×`})]}),d>1&&(0,I.jsxs)(`div`,{className:Su.chipStrip,ref:c,children:[f!==null&&(0,I.jsx)(`span`,{className:Su.chipStripLabel,children:f}),u.map(n=>{let r=n===e,i=fi(n,l);return(0,I.jsx)(`button`,{className:[Su.topicChip,r?Su.topicChipActive:``].join(` `).trim(),"aria-current":r?`step`:void 0,onClick:()=>t(n),children:i},n)})]}),(0,I.jsx)(`div`,{className:Su.helpBody,ref:a,children:(0,I.jsx)(`div`,{className:Su.helpBodyContent,ref:s,children:g===null?(0,I.jsxs)(`div`,{className:Su.emptyFallback,children:[(0,I.jsxs)(`code`,{children:[`help `,e||``]}),`\xA0 not found in the local bundle.`]}):(0,I.jsx)(`div`,{className:Su.helpContent,children:(0,I.jsx)(x,{remarkPlugins:[C],components:e===``?{li:({children:e,...n})=>{let r=wu(Cu(e).trim());return r!==null&&oi(r)!==null?(0,I.jsx)(`li`,{...n,children:(0,I.jsx)(`button`,{className:Su.topicLink,"aria-label":`Open help topic: ${r}`,onClick:()=>t(r),children:e})}):(0,I.jsx)(`li`,{...n,children:e})}}:void 0,children:g})})})})]})}function Eu({existingItem:e,pendingItem:t,onReplace:n,onCancel:r}){let i=(0,P.useRef)(null);return(0,P.useEffect)(()=>{let e=i.current;e&&!e.open&&e.showModal()},[]),(0,I.jsxs)(`dialog`,{ref:i,className:X.dialog,onClose:r,"aria-labelledby":`duplicate-dialog-title`,children:[(0,I.jsx)(`h2`,{id:`duplicate-dialog-title`,className:X.dialogTitle,children:`Duplicate Node`}),(0,I.jsxs)(`p`,{className:X.dialogBody,children:[`A clipboard item with alias `,(0,I.jsxs)(`strong`,{children:[`"`,t.node.alias,`"`]}),` already exists (clipped `,lu(e.clippedAt),`).`]}),(0,I.jsx)(`p`,{className:X.dialogBody,children:`Replace it with the new snapshot?`}),(0,I.jsxs)(`div`,{className:X.dialogActions,children:[(0,I.jsx)(`button`,{className:X.cancelBtn,onClick:r,children:`Cancel`}),(0,I.jsx)(`button`,{className:X.replaceBtn,onClick:n,children:`Replace`})]})]})}function Du(e,t){if(!t)return null;let n=e.trim().toLowerCase();if(n!==`help`&&!n.startsWith(`help `))return null;let r=mi(e);return oi(r)===null?null:r}var Ou=class{constructor(){this.listeners=new Map}on(e,t){let n=e;return this.listeners.has(n)||this.listeners.set(n,new Set),this.listeners.get(n).add(t),()=>{this.listeners.get(n)?.delete(t)}}emit(e){let t=this.listeners.get(e.kind);t&&t.forEach(t=>{try{t(e)}catch(t){console.error(`[ProtocolBus] listener for '${e.kind}' threw:`,t)}})}clear(){this.listeners.clear()}},ku=`(ws-\\d+-\\d+)`,Au=RegExp(`^session ${ku} started(?:\\nCompanion endpoint: (\\/api\\/companion\\/${ku}))?$`,`i`),ju=RegExp(`^Session ${ku} started since (.+)$`),Mu=RegExp(`^subscribed to ${ku}$`),Nu=/^subscribed by \[(.*)]$/,Pu=RegExp(`^Subscribed to ${ku}$`),Fu=RegExp(`^Session unsubscribed from ${ku}$`),Iu=RegExp(`^Session ${ku} not found$`),Lu=RegExp(`^${ku} is not a primary session$`),Ru=RegExp(`^You have already subscribed to ${ku}(?:\\nPlease do 'session reset' before subscribing to another session)?$`),zu=RegExp(`^${ku} subscribed to your session$`),Bu=RegExp(`^${ku} unsubscribed from your session$`),Vu=RegExp(`^Session ${ku} has closed$`);function Hu(e){let t=e.trim();return t.length===0||t.startsWith(`> `)?null:t}function Uu(e){return e.split(`,`).map(e=>e.trim()).filter(e=>e.length>0&&cl(e))}function Wu(e){let t=Hu(e);if(!t)return null;let n=t.match(Au);return n?{sessionId:n[1],companionEndpoint:n[2]??null}:null}function Z(e){let t=Hu(e);if(!t)return null;let n=t.split(`
`).map(e=>e.trim()).filter(Boolean),r=n[0];if(!r)return null;let i=r.match(ju);if(!i)return null;let a=null,o=[];for(let e of n.slice(1)){let t=e.match(Mu);if(t){a=t[1];continue}let n=e.match(Nu);n&&(o=Uu(n[1]))}return{sessionId:i[1],startedSince:i[2],subscribedTo:a,subscribers:o}}function Gu(e){let t=Hu(e);if(!t)return null;let n=t.match(Pu);if(n)return{command:`subscribe`,status:`accepted`,sessionId:n[1],message:t};let r=t.match(Fu);if(r)return{command:`unsubscribe`,status:`accepted`,sessionId:r[1],message:t};let i=t.match(Iu);if(i)return{command:`subscribe`,status:`rejected`,sessionId:i[1],message:t};let a=t.match(Lu);if(a)return{command:`subscribe`,status:`rejected`,sessionId:a[1],message:t};let o=t.match(Ru);return o?{command:`subscribe`,status:`rejected`,sessionId:o[1],message:t}:t===`You cannot subscribe to yourself`?{command:`subscribe`,status:`rejected`,sessionId:null,message:t}:t===`Nothing to unsubscribe`?{command:`unsubscribe`,status:`rejected`,sessionId:null,message:t}:t===`Invalid session command`?{command:`unknown`,status:`rejected`,sessionId:null,message:t}:null}function Ku(e){let t=Hu(e);if(!t)return null;let n=t.match(zu);if(n)return{type:`subscriber-joined`,sessionId:n[1],message:t};let r=t.match(Bu);if(r)return{type:`subscriber-left`,sessionId:r[1],message:t};let i=t.match(Vu);return i?{type:`host-closed`,sessionId:i[1],message:t}:null}var qu=new Set([`info`,`error`,`ping`,`welcome`]);function Ju(e,t){let n=[],r={msgId:e,raw:t},i=!1,a=!1,o=!1,s=!1,c=!1,l=!1,u=Dr(t);if(u.isJSON){let e=u.data;if(typeof e.type==`string`){let i=e.type;return n.push({...r,kind:`lifecycle`,type:i,knownType:qu.has(i),message:typeof e.message==`string`?e.message:t,time:e.time??null}),n.length>0?n:[{...r,kind:`unclassified`}]}return n.push({...r,kind:`json.response`,data:u.data}),n.length>0?n:[{...r,kind:`unclassified`}]}let d=Pr(t);d&&(c=!0,n.push({...r,kind:`payload.large`,apiPath:d.apiPath,byteSize:d.byteSize,filename:d.filename}));let f=Fr(t);f&&(o=!0,n.push({...r,kind:`upload.invitation`,uploadPath:f}));let p=Nr(t);if(p&&(s=!0,n.push({...r,kind:`upload.contentPath`,uploadPath:p})),Mr(t)){a=!0;let e=jr(t);e&&n.push({...r,kind:`graph.link`,apiPath:e})}if(a){let e=Or(t);e&&n.push({...r,kind:`graph.exported`,graphName:e.graphName,apiPath:e.apiPath})}let m=Jr(t);m&&n.push({...r,kind:`graph.mutation`,mutationType:m});let h=qr(t);h&&n.push({...r,kind:`minigraph.nodeAction.textResult`,status:h.status,action:h.action,alias:h.alias,targetAlias:h.targetAlias,message:h.message}),h&&(h.action===`create-node`||h.status===`error`)&&n.push({...r,kind:`minigraph.createNode.textResult`,status:h.status,alias:h.alias,message:h.message}),t===`Session restarted`&&(l=!0,n.push({...r,kind:`session.reset`}));let g=Wu(t);g&&(l=!0,n.push({...r,kind:`minigraph.session.started`,sessionId:g.sessionId,companionEndpoint:g.companionEndpoint}));let _=Z(t);_&&(l=!0,n.push({...r,kind:`minigraph.session.status`,sessionId:_.sessionId,startedSince:_.startedSince,subscribedTo:_.subscribedTo,subscribers:_.subscribers}));let v=Gu(t);v&&(l=!0,n.push({...r,kind:`minigraph.session.commandResult`,command:v.command,status:v.status,sessionId:v.sessionId,message:v.message}));let y=Ku(t);y&&(l=!0,n.push({...r,kind:`minigraph.session.notification`,type:y.type,sessionId:y.sessionId,message:y.message})),t.startsWith(`> `)&&(i=!0,n.push({...r,kind:`command.echo`,commandText:t.slice(2)})),Ir(t)&&n.push({...r,kind:`command.helpOrDescribe`,commandText:t.slice(2)});let b=Lr(t);b&&n.push({...r,kind:`command.importGraph`,graphName:b});let x=kr(t);return x&&n.push({...r,kind:`graph.export.failed`,reason:x.reason}),!i&&!a&&!o&&!s&&!c&&!l&&Ar(t)&&n.push({...r,kind:`docs.response`,isMarkdown:!0}),n.length===0&&n.push({...r,kind:`unclassified`}),n}function Yu({messages:e,bus:t}){let n=(0,P.useRef)(-1);(0,P.useEffect)(()=>{e.length>0&&(n.current=e[e.length-1].id)},[]);let r=(0,P.useMemo)(()=>{let t=new Map;for(let n of e)t.set(n.id,Ju(n.id,n.raw));return t},[e]);return(0,P.useEffect)(()=>{if(e.length===0)return;let i=e.filter(e=>e.id>n.current);if(i.length!==0){n.current=e[e.length-1].id;for(let e of i){let n=r.get(e.id);if(n)for(let e of n)t.emit(e)}}},[e,t,r]),{classificationMap:r}}function Xu({config:e}){let{title:t,wsPath:n,storageKeyPayload:r,storageKeyHistory:i,storageKeyTab:a,storageKeySavedGraphs:o,supportsUpload:s,supportsClipboard:c,supportsHelp:l,supportsAuthoring:u,supportsSessionCollaboration:d,tabs:f}=e,p=Ct(),[m,h]=hr(r,``),g=wr(),[_,v]=(0,P.useState)(()=>g.peekPendingPayload(n)),{takePendingPayload:y}=g;(0,P.useEffect)(()=>{let e=y(n);e!==null&&v(e)},[y,n]);let b=_??m,x=(0,P.useCallback)(e=>{v(null),h(e)},[h]),S=(0,P.useMemo)(()=>b?fr(b):{valid:!0,error:null,type:null},[b]),{toasts:C,addToast:E,removeToast:ne}=mr(),re=(0,P.useRef)(new Ou).current,D=Zr({wsPath:n,storageKeyHistory:i,payload:b,addToast:E,bus:re,handleLocalCommand:(0,P.useCallback)(e=>Du(e,l===!0)!==null,[l])}),{classificationMap:ie}=Yu({messages:D.messages,bus:re}),[ae,oe]=Ai(n),{graphData:O,setGraphData:k,rightTab:A,setRightTab:j,isRefreshing:se}=ti(ae,E,f[0],f,a),{modalUploadPath:ce,successfulUploadPaths:le,handleOpenUploadModal:M,handleCloseUploadModal:N,handleUploadSuccess:ue,handleUploadError:de,resetSuccessfulPaths:fe}=vi({bus:re,addToast:E});ni({bus:re,pinnedGraphPath:ae,setPinnedGraphPath:oe,connected:D.connected,sendRawText:D.sendRawText,addToast:E});let pe=xa({bus:re,connected:D.connected,sendRawText:D.sendRawText,addToast:E}),me=(0,P.useRef)(null),he=(0,P.useRef)(null),ge=(0,P.useRef)(new Map),_e=(0,P.useCallback)((e,t)=>{if(t===null){E(e,`success`);return}E(e,`success`,{durationMs:6e3,action:{label:`Undo`,onClick:()=>pe.undoEntry(t)}})},[E,pe.undoEntry]),ve=(0,P.useCallback)(e=>{if(e.action===`edit-node`){let t=me.current;me.current=null,t&&t.alias===e.alias&&_e(`Updated node ${t.alias}`,pe.push(ga(t)));return}if(e.action===`create-node`&&e.alias){_e(`Created node ${e.alias}`,pe.push(_a(e.alias)));return}if(e.action===`create-connection`){let t=he.current;he.current=null,_e(`Connected ${e.alias??``} → ${e.targetAlias??``}`,pe.push(t));return}if(e.action===`delete-node`&&e.alias){let t=ge.current.get(e.alias)??null;ge.current.delete(e.alias),_e(`Deleted node ${e.alias}`,pe.push(t))}},[pe.push,_e]),ye=(0,P.useRef)(!1);(0,P.useEffect)(()=>{ye.current&&!D.connected&&(oe(null),k(null)),ye.current=D.connected},[D.connected,oe,k]);let[be,xe]=hr(e.storageKeyHelpTopic??`help-topic-fallback`,``),[Se,Ce]=hr(`help-panel-open`,!1),[we,Te]=(0,P.useState)(()=>!!l&&!Se),[Ee,De]=(0,P.useState)(!1),Oe=(0,P.useRef)(null),ke=(0,P.useCallback)(()=>{we&&(De(!0),Oe.current=setTimeout(()=>Te(!1),400))},[we]);(0,P.useEffect)(()=>{if(!we||Ee)return;let e=setTimeout(ke,3e3);return()=>clearTimeout(e)},[we,Ee,ke]),(0,P.useEffect)(()=>{Se&&we&&ke()},[Se,we,ke]),(0,P.useEffect)(()=>()=>{Oe.current&&clearTimeout(Oe.current)},[]),(0,P.useEffect)(()=>{if(!l)return;let e=e=>{e.ctrlKey&&e.key==="`"&&(e.preventDefault(),Ce(e=>!e))};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[l,Ce]),hi({bus:re,setHelpTopic:xe,onTabSwitch:l?()=>Ce(!0):()=>{}}),yi({bus:re,connected:D.connected,appendMessage:D.appendMessage,addToast:E});let[Ae,je]=hr(`console-panel-open`,!0),Me=$l(),[Ne,Pe]=hr(`clipboard-sidebar-open`,!1),[Fe,Ie]=(0,P.useState)(null),Le=(0,P.useCallback)(e=>{let t=Ni(e,O);D.setCommand(t.command),E(`${t.verb===`create`?`Create`:`Update`} command for "${e.node.alias}" pasted to input`,`info`)},[O,D.setCommand,E]),Re=(0,P.useCallback)(e=>{let t=Me.items.find(t=>t.id===e);if(!t){E(`Clipboard item is no longer available. It may have been removed in another tab.`,`error`);return}let n=Ni(t,O);if(!D.sendRawText(n.command)){E(`Could not send clipboard paste command because the WebSocket is not open.`,`error`);return}E(`Clipboard node "${t.node.alias}" sent as ${n.verb}. Waiting for backend response.`,`info`)},[Me.items,O,D.sendRawText,E]),ze=(0,P.useCallback)(async(t,r)=>{try{let i=await Me.clipNode(t,r,{sourceWsPath:n,sourceLabel:e.label});switch(i.status){case`added`:E(`Node "${t.alias}" clipped to workspace`,`success`);break;case`duplicate`:Ie({pendingItem:i.pendingItem,existingItem:i.existingItem});break;case`error`:E(`Clip failed: ${i.message}`,`error`);break}}catch(e){E(`Clip failed: ${e instanceof Error?e.message:String(e)}`,`error`)}},[Me,n,e.label,E]),Be=(0,P.useCallback)(async t=>{if(t.length===0){E(`No selected nodes are available to clip.`,`info`);return}if(t.length>100){E(`Select 100 or fewer nodes to clip at once.`,`error`);return}let r={added:0,duplicates:0,failed:0};for(let i of t){if(!i.node?.alias?.trim()){r.failed+=1;continue}try{let t=await Me.clipNode(i.node,i.connections,{sourceWsPath:n,sourceLabel:e.label});t.status===`added`&&(r.added+=1),t.status===`duplicate`&&(r.duplicates+=1),t.status===`error`&&(r.failed+=1)}catch{r.failed+=1}}let i=Fi(r);E(i.message,i.type)},[E,Me,e.label,n]),Ve=bi(o??``),{defaultName:He,savedName:Ue,resetName:We}=Ei(o?`${o}-untitled-counter`:`untitled-counter`,re,D.connected,D.connectionEpoch),Ge=(0,P.useMemo)(()=>{let e=O?.nodes.find(e=>e.types.includes(`Root`)),t=typeof e?.properties?.name==`string`?e.properties.name:void 0;return t?.trim()?t:null},[O])??He,Ke=(0,P.useMemo)(()=>Ii(D.sendRawText),[D.sendRawText]),qe=ol({bus:re,connected:D.connected,graphData:O,executor:Ke,onAccepted:ve,onUserMessage:E}),Je=qe.state,Ye=u&&Je.status===`open`&&(Je.action===`edit-node`||Je.action===`create-node`)?Je:null,Xe=u&&Je.status===`open`&&Je.action===`create-connection`?Je:null,[Ze,Qe]=(0,P.useState)(null),$e=Ye!==null||Xe!==null;(0,P.useEffect)(()=>{let e=e=>{if(e.key!==`z`&&e.key!==`Z`||!(e.metaKey||e.ctrlKey)||e.shiftKey||e.altKey)return;let t=e.target;t instanceof Element&&t.closest(`input, textarea, select, [contenteditable="true"]`)||$e||pe.hasEntries()&&(e.preventDefault(),pe.undoLast())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[$e,pe.hasEntries,pe.undoLast]);let et=(0,P.useCallback)((e,t,n)=>{Qe(n??null),he.current=O?va(O,e,t):null,qe.openCreateConnection(e,t)},[qe.openCreateConnection,O]),tt=(0,P.useCallback)((e,t)=>{try{let n=ea(e,t),r=O?ha(O,e,t):null;if(!D.sendRawText(n)){E(`Could not send the delete-connection command because the WebSocket is not open.`,`error`);return}_e(`Deleted connection ${e} → ${t}`,pe.push(r))}catch(e){E(e instanceof Error?e.message:String(e),`error`)}},[E,O,pe.push,_e,D.sendRawText]),nt=(0,P.useCallback)(e=>{me.current=e,qe.openEditNode(e)},[qe.openEditNode]),rt=(0,P.useCallback)(e=>{ge.current.set(e.alias,O?ya(O,e):null),qe.deleteNode(e)},[qe.deleteNode,O]),it=D.consoleRef,at=Ae&&Ye===null;(0,P.useEffect)(()=>{at&&it.current&&(it.current.scrollTop=it.current.scrollHeight)},[at,it]);let ot=dl({enabled:d===!0,bus:re,classificationMap:ie,connected:D.connected,sendRawText:D.sendRawText,addToast:E}),{handleSaveGraph:st,handleLoadGraph:ct}=Oi({bus:re,connected:D.connected,sendRawText:D.sendRawText,saveGraph:o?Ve.saveGraph:null,addToast:E}),lt=(0,P.useCallback)(e=>{let t=ie.get(e.id)?.find(e=>e.kind===`graph.link`);t&&oe(t.apiPath)},[ie]),{handleSendToJsonPath:ut}=gi({ctx:g,navigate:p,addToast:E,wsPath:n}),F=Qr(`(max-width: 768px)`),{defaultLayout:dt,onLayoutChanged:ft}=w({id:e.path+`-panel-split`,storage:localStorage}),pt=(0,P.useCallback)(()=>x(pr(b)),[b]),mt=(0,P.useCallback)(()=>{D.clearMessages(),oe(null),k(null),fe(),We()},[D.clearMessages,k,fe,We]);return(0,I.jsxs)(`div`,{className:lr.wrapper,children:[(0,I.jsx)(Da,{toasts:C,onRemove:ne}),ce&&(0,I.jsx)(Dc,{uploadPath:ce,onSuccess:ue,onClose:N,onError:de}),Xe!==null&&(0,I.jsx)(Ac,{formState:Xe.formState,phase:Xe.phase,lockReason:Xe.phase===`sending`?`sending`:Xe.connectionLost?`disconnected`:null,serverMessage:Xe.serverMessage,validationErrors:qe.validationErrors,anchor:Ze,onFormStateChange:qe.updateFormState,onSubmit:qe.submit,onClose:qe.close}),(0,I.jsxs)(`header`,{className:lr.header,children:[(0,I.jsx)(`h1`,{className:lr.title,children:t}),(0,I.jsxs)(`div`,{className:lr.headerActions,children:[o&&(0,I.jsx)(Va,{disabled:!O,defaultName:He,savedName:Ue,onSave:st,nameExists:Ve.hasGraph,connected:D.connected}),o&&Ve.savedGraphs.length>0&&(0,I.jsx)(Ua,{savedGraphs:Ve.savedGraphs,onLoad:ct,onDelete:Ve.deleteGraph,connected:D.connected}),(0,I.jsx)(`button`,{className:lr.panelToggle,onClick:()=>{if(Ye!==null){Ye.phase!==`sending`&&(qe.close(),je(!0));return}je(e=>!e)},"aria-label":Ye===null?Ae?`Hide console panel`:`Show console panel`:`Show console panel and close the node editor`,"aria-pressed":at,title:Ye===null?void 0:`Closes the node editor`,children:`Console`}),c&&(0,I.jsxs)(`button`,{className:lr.panelToggle,onClick:()=>Pe(e=>!e),"aria-label":Ne?`Close workspace sidebar`:`Open workspace sidebar`,"aria-pressed":Ne,children:[`Workspace`,Me.items.length>0?` (${Me.items.length})`:``]}),(0,I.jsx)(Ra,{addToast:E,sessionCollaboration:d?ot:null}),l&&(0,I.jsxs)(`div`,{className:lr.helpButtonWrapper,children:[(0,I.jsx)(`button`,{className:`${lr.helpToggle}${we&&!Ee?` ${lr.helpTogglePulsing}`:``}`,onClick:()=>Ce(e=>!e),"aria-label":Se?`Close help panel`:`Open help panel`,"aria-pressed":Se,children:`?`}),we&&(0,I.jsxs)(`div`,{className:`${lr.helpHint}${Ee?` ${lr.helpHintFading}`:``}`,onClick:ke,role:`status`,children:[(0,I.jsx)(`kbd`,{className:lr.helpHintKbd,children:"Ctrl + `"}),` to toggle help`]})]})]})]}),Fe&&(0,I.jsx)(Eu,{existingItem:Fe.existingItem,pendingItem:Fe.pendingItem,onReplace:async()=>{try{await Me.confirmReplace(Fe.pendingItem,Fe.existingItem.id),Ie(null),E(`Clipboard item "${Fe.pendingItem.node.alias}" replaced`,`success`)}catch(e){E(`Replace failed: ${e instanceof Error?e.message:String(e)}`,`error`)}},onCancel:()=>{Ie(null),E(`Clip cancelled`,`info`)}}),(0,I.jsxs)(T,{className:lr.panelGroup,orientation:F?`vertical`:`horizontal`,defaultLayout:dt,onLayoutChanged:ft,children:[(Ae||Ye!==null)&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(te,{defaultSize:Se||Ne?`50%`:`60%`,minSize:`25%`,children:Ye===null?(0,I.jsx)(gc,{messages:D.messages,classificationMap:ie,onCopy:D.copyMessages,onClear:mt,consoleRef:D.consoleRef,command:D.command,onCommandChange:D.setCommand,onCommandKeyDown:D.handleKeyDown,onSend:D.sendCommand,sendDisabled:!D.connected||!D.command.trim(),inputDisabled:!D.connected,commandHistory:D.history,onGraphLinkMessage:lt,onCopyMessage:()=>E(`Copied to clipboard`,`success`),onSendToJsonPath:ut,onUploadMockData:M,successfulUploadPaths:le}):(0,I.jsx)(Sc,{mode:Ye.action===`edit-node`?`edit`:`create`,formState:Ye.formState,phase:Ye.phase,lockReason:Ye.phase===`sending`?`sending`:Ye.connectionLost?`disconnected`:null,serverMessage:Ye.serverMessage,validationErrors:qe.validationErrors,onFormStateChange:qe.updateFormState,onSubmit:qe.submit,onClose:qe.close})}),(0,I.jsx)(ee,{className:lr.resizeHandle,"aria-label":`Resize panels`})]}),(0,I.jsx)(te,{defaultSize:Se?`50%`:Ne?`30%`:`40%`,minSize:`20%`,children:(0,I.jsx)(rc,{tabs:f,payload:b,onChange:x,validation:S,onFormat:pt,onUpload:s?D.uploadPayload:void 0,graphData:O,graphName:Ge,activeTab:A,onTabChange:j,onGraphRenderError:e=>E(e,`error`),onGraphDataCopySuccess:()=>E(`Graph JSON copied to clipboard!`,`success`),onGraphDataCopyError:()=>E(`Copy failed`,`error`),isGraphRefreshing:se,onClipNode:c?ze:void 0,onClipNodes:c?Be:void 0,onClipboardDrop:c?Re:void 0,isConnected:D.connected,supportsAuthoring:u,onCreateNode:u?qe.openCreateNode:void 0,onCreateConnection:u?et:void 0,onEditNode:u?nt:void 0,onDeleteNode:u?rt:void 0,onDeleteNodes:u?qe.deleteNodes:void 0,onDeleteConnection:u?tt:void 0,panelLayoutKey:`${Ae||Ye!==null}|${Ne}|${Se}`,helpPanel:l&&Se?((e,t)=>(0,I.jsx)(Tu,{activeTopic:be,onNavigate:xe,onClose:()=>Ce(!1),onToggleMaximize:e,isMaximized:t})):void 0})}),c&&Ne&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(ee,{className:lr.resizeHandle,"aria-label":`Resize clipboard`}),(0,I.jsx)(te,{defaultSize:`20%`,minSize:`10%`,maxSize:`40%`,children:(0,I.jsx)(bu,{connected:D.connected,onPasteToInput:Le})})]})]})]})}function Zu(){let e=_r[0].path;return(0,I.jsx)(Cr,{children:(0,I.jsx)(Ql,{children:(0,I.jsx)(Hn,{children:(0,I.jsxs)(Zt,{children:[_r.map(e=>(0,I.jsx)(Yt,{path:e.path,element:(0,I.jsx)(Xu,{config:e},e.path)},e.path)),(0,I.jsx)(Yt,{path:`*`,element:(0,I.jsx)(Jt,{to:e,replace:!0})})]})})})})}(0,cr.createRoot)(document.getElementById(`root`)).render((0,I.jsx)(P.StrictMode,{children:(0,I.jsx)(Zu,{})}));
//# sourceMappingURL=index-CIci4ITw.js.map