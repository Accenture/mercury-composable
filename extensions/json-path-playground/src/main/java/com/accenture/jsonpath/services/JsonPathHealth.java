...
@PreLoad(route="json.path.health", instances=5)
public class JsonPathHealth implements LambdaFunction {
    ...
    public Object handleEvent(Map<String, String> headers, Object input, int instance) {
        ...
        if (INFO.equals(headers.get(TYPE))) {
            ...
            about.put("service", "json-path service");
        ...
        if (HEALTH.equals(headers.get(TYPE))) {
             ...
             */
            return Map.of("json-path", "I am running fine");
        }
