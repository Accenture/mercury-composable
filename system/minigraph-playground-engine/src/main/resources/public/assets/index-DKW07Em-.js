...
`});function ri(e){let t=e.split(`/`);return(t[t.length-1]??e).replace(/\.md$/,``)}var ii=Object.fromEntries(Object.entries(ni).map(([e,t])=>[ri(e),t]));function ai(e){return ii[e===``?`help`:`help ${e}`]??null}var oi=Object.keys(ii).filter(e=>e!==`help`).map(e=>e.replace(/^help\s+/,``)).sort(),si=[{id:`overview`,label:`Overview`},{id:`graph-model`,label:`Graph Model`},{id:`graph-skills`,label:`Graph Skills`},{id:`instance-model`,label:`Instance Model`},{id:`tutorials`,label:`Tutorials`,chipStripLabel:`Chapters`}],ci=new Set([`execute`,`inspect`,`instantiate`,`run`,`seen`,`upload`]);function li(e){return e===``?`overview`:e.startsWith(`tutorial `)?`tutorials`:e.startsWith(`graph-`)?`graph-skills`:ci.has(e)?`instance-model`:`graph-model`}function ui(e){if(e===`overview`)return[``];let t=oi.filter(t=>li(t)===e);return e===`tutorials`?[...t].sort((e,t)=>parseInt(e.replace(/^tutorial\s+/,``),10)-parseInt(t.replace(/^tutorial\s+/,``),10)):t}function di(e,t){return e===``?`Overview`:t===`tutorials`?e.replace(/^tutorial\s+/,``):e}var fi=si.flatMap(e=>ui(e.id));function pi(e){return e.replace(/^help\s*/i,``).trim().toLowerCase()}function mi({bus:e,setHelpTopic:t,onTabSwitch:n}){let r=(0,M.useRef)(n);(0,M.useEffect)(()=>{r.current=n}),(0,M.useEffect)(()=>e.on(`command.helpOrDescribe`,e=>{if(!e.commandText.trim().toLowerCase().startsWith(`help`))return;let n=pi(e.commandText);ai(n)!==null&&(t(n),r.current())}),[e,t])}function hi({ctx:e,navigate:t,addToast:n,wsPath:r}){let i=gr.find(e=>e.tabs.includes(`payload`)&&e.supportsUpload),a=(0,M.useRef)(null),o=i?.wsPath;(0,M.useEffect)(()=>{if(!(!o||!a.current)&&e.getSlot(o).phase===`connected`){let{wsPath:r,json:o}=a.current;a.current=null,e.setPendingPayload(r,o),t(i.path),n(`JSON loaded into JSON-Path editor ✓`,`success`)}},[o,e,t,n,i]);let s=(0,M.useCallback)(r=>{if(!i)return;let o=e.getSlot(i.wsPath);o.phase===`connected`?(e.setPendingPayload(i.wsPath,r),t(i.path),n(`JSON loaded into JSON-Path editor ✓`,`success`)):o.phase===`connecting`?(a.current={wsPath:i.wsPath,json:r},n(`Updated pending JSON transfer — latest payload will open when connected`,`info`)):(a.current={wsPath:i.wsPath,json:r},e.connect(i.wsPath,n),n(`Connecting to JSON-Path Playground…`,`info`))},[e,t,n,i]);return{handleSendToJsonPath:i&&r!==i.wsPath?s:void 0}}function gi({bus:e,onOpenModal:t,modalOpen:n}){let r=(0,M.useRef)(!1);(0,M.useEffect)(()=>{n||(r.current=!1)},[n]),(0,M.useEffect)(()=>e.on(`upload.invitation`,e=>{r.current||(r.current=!0,t(e.uploadPath))}),[e,t])}function _i({bus:e,addToast:t}){let[n,r]=(0,M.useState)(null),i=(0,M.useRef)(null),[a,o]=(0,M.useState)(new Set),s=(0,M.useCallback)(e=>{i.current=document.activeElement,r(e)},[]),c=(0,M.useCallback)(()=>{r(null),setTimeout(()=>i.current?.focus(),0)},[]),l=(0,M.useCallback)(e=>{o(e=>new Set([...e,n])),r(null),setTimeout(()=>i.current?.focus(),0),t(`Mock data uploaded successfully ✓`,`success`)},[n,t]),u=(0,M.useCallback)(e=>{t(`Upload failed: ${e}`,`error`)},[t]),d=(0,M.useCallback)(()=>{o(new Set)},[]);return gi({bus:e,onOpenModal:s,modalOpen:n!==null}),{modalUploadPath:n,successfulUploadPaths:a,handleOpenUploadModal:s,handleCloseUploadModal:c,handleUploadSuccess:l,handleUploadError:u,resetSuccessfulPaths:d}}function vi({bus:e,connected:t,appendMessage:n,addToast:r}){let i=(0,M.useRef)(null),a=(0,M.useRef)(!1),o=(0,M.useRef)(n);(0,M.useEffect)(()=>{o.current=n},[n]);let s=(0,M.useRef)(r);(0,M.useEffect)(()=>{s.current=r},[r]),(0,M.useEffect)(()=>{t||(i.current?.abort(),i.current=null,a.current=!1)},[t]),(0,M.useEffect)(()=>()=>{i.current?.abort()},[]),(0,M.useEffect)(()=>e.on(`payload.large`,e=>{if(a.current)return;let{apiPath:t,byteSize:n}=e;i.current?.abort();let r=new AbortController;i.current=r;let c=(n/(1024*1024)).toFixed(2);s.current(`Fetching large payload (${c} MB)…`,`info`),a.current=!0,fetch(t,{signal:r.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.text()}).then(e=>{if(!e.trim())throw Error(`empty response body`);let t=e;try{t=JSON.stringify(JSON.parse(e),null,2)}catch{}o.current(t),a.current=!1,i.current=null}).catch(e=>{e.name!==`AbortError`&&(a.current=!1,i.current=null,o.current(`ERROR: payload fetch failed — ${e.message}`),s.current(`Payload fetch failed: ${e.message}`,`error`))})}),[e])}function yi(e){let[t,n]=mr(e,{}),r=(0,M.useCallback)(e=>{n(t=>({...t,[e]:{name:e,savedAt:new Date().toISOString()}}))},[n]),i=(0,M.useCallback)(e=>{n(t=>{let n={...t};return delete n[e],n})},[n]),a=(0,M.useCallback)(e=>Object.prototype.hasOwnProperty.call(t,e),[t]);return{savedGraphs:(0,M.useMemo)(()=>Object.values(t).sort((e,t)=>new Date(t.savedAt).getTime()-new Date(e.savedAt).getTime()),[t]),saveGraph:r,deleteGraph:i,hasGraph:a}}var bi={importedName:null,lastSavedName:null,isSaved:!1,untitledSlotConsumed:!1};function xi(e,t){switch(t.type){case`imported`:return{...e,importedName:t.name,lastSavedName:null,isSaved:!1};case`exported`:return{...e,lastSavedName:t.name,isSaved:!0,untitledSlotConsumed:e.untitledSlotConsumed||t.consumesUntitled};case`dirty`:return{...e,isSaved:!1};case`reset`:return{...bi}}}var Si=new Map;function Ci(e,t,n){return t&&n!==null&&e===n}function wi(e,t){let n=e.on(`command.importGraph`,e=>{t.onImported(e.graphName)}),r=e.on(`graph.exported`,e=>{t.onExported(e.graphName)}),i=e.on(`graph.mutation`,()=>{t.onDirty()}),a=e.on(`session.reset`,()=>{t.onReset()});return()=>{n(),r(),i(),a()}}function Ti(e,t,n,r){let[i,a]=mr(e,1),[o,s]=(0,M.useState)(()=>{let t=Si.get(e);return t&&Ci(t.connectionEpoch,n,r)?t.state:{...bi}}),c=(0,M.useRef)(o),l=(0,M.useCallback)(t=>{let n=xi(c.current,t);c.current=n,t.type===`reset`?Si.delete(e):r!==null&&Si.set(e,{connectionEpoch:r,state:n}),s(n)},[r,e]),u=(0,M.useCallback)(e=>{l({type:`exported`,name:e,consumesUntitled:e===`untitled-${i}`})},[i,l]),d=(0,M.useCallback)(()=>{let t=Si.get(e)?.state;(c.current.untitledSlotConsumed||t?.untitledSlotConsumed)&&a(e=>e+1),l({type:`reset`})},[a,e,l]),f=(0,M.useRef)(r);return(0,M.useEffect)(()=>{let t=Si.get(e)?.connectionEpoch;(!n||f.current!==r||t!==void 0&&t!==r)&&d(),f.current=r},[n,r,d,e]),(0,M.useEffect)(()=>wi(t,{onImported:e=>l({type:`imported`,name:e}),onExported:u,onDirty:()=>l({type:`dirty`}),onReset:d}),[t,d,u,l]),{defaultName:o.lastSavedName??o.importedName??`untitled-${i}`,savedName:o.isSaved?o.lastSavedName:null,resetName:d}}function Ei(e,t){return e.on(`graph.exported`,e=>t(e.graphName))}function Di({bus:e,connected:t,sendRawText:n,saveGraph:r,addToast:i}){let a=(0,M.useRef)(null),o=(0,M.useCallback)(e=>{if(!t){i(`Save failed: connection required to export graph`,`error`);return}let r=setTimeout(()=>{a.current!==null&&(a.current=null,i(`Save failed: export confirmation timed out`,`error`))},1e4);a.current={graphName:e,timeoutId:r},n(`export graph as ${e}`)},[t,n,i]);return(0,M.useEffect)(()=>{if(r!==null)return Ei(e,r)},[e,r]),(0,M.useEffect)(()=>e.on(`graph.exported`,e=>{if(a.current===null||e.graphName!==a.current.graphName)return;clearTimeout(a.current.timeoutId);let t=a.current.graphName;a.current=null,i(`Graph saved as "${t}"`,`success`)}),[e,i]),(0,M.useEffect)(()=>e.on(`graph.export.failed`,e=>{a.current!==null&&(clearTimeout(a.current.timeoutId),a.current=null,e.reason===`invalid-name`?i(`Save failed: invalid filename (a–z, A–Z, 0–9, hyphen only)`,`error`):i(`Save failed: root node name does not match existing graph`,`error`))}),[e,i]),(0,M.useEffect)(()=>{!t&&a.current!==null&&(clearTimeout(a.current.timeoutId),a.current=null,i(`Save failed: connection closed before export confirmation`,`error`))},[t,i]),(0,M.useEffect)(()=>()=>{a.current!==null&&clearTimeout(a.current.timeoutId)},[]),{handleSaveGraph:o,handleLoadGraph:(0,M.useCallback)(e=>{t&&(n(`import graph from ${e}`),i(`Importing graph "${e}"…`,`info`))},[t,n,i])}}var Oi=new Map;function ki(e){let[t,n]=(0,M.useState)(()=>Oi.get(e)??null);return[t,(0,M.useCallback)(t=>{n(t),t===null?Oi.delete(e):Oi.set(e,t)},[e])]}function Ai(e){if(e==null)return``;let t=typeof e==`string`?e:JSON.stringify(e);return t.includes(`'''`)&&console.warn(`[commandBuilder] Property value contains "'''" which cannot be escaped in the backend grammar. The value may be truncated on paste.`),t.includes(`
...
`)}function Mi(e,t){let n=t?.nodes.some(t=>t.alias===e.node.alias)?`update`:`create`;return{verb:n,command:ji(n,e.node)}}function Ni(e){return`${e} ${e===1?`node`:`nodes`} clipped to workspace`}function Pi(e){let{added:t,duplicates:n,failed:r}=e;if(t===0&&n===0&&r===0)return{message:`No selected nodes are available to clip.`,type:`info`};if(t===0&&n>0&&r===0)return{message:`All selected nodes already exist in workspace.`,type:`info`};if(t===0&&n===0&&r>0)return{message:`Failed to clip selected nodes to workspace.`,type:`error`};let i=Ni(t);return n>0&&(i+=`. ${n} already existed.`),r>0&&(i+=`. ${r} failed.`),{message:i,type:r>0?`error`:`success`}}function Fi(e){return{execute(t){return e(t)}}}function Ii(e){return e.trim().toLowerCase()}function L(e,t){if(!t.alias||t.action!==null&&t.action!==`delete-node`)return null;let n=e.aliases.find(n=>Ii(n)===Ii(t.alias)&&e.results[n]===void 0);return n?{...e,results:{...e.results,[n]:t.status===`accepted`?`success`:`error`}}:null}function Li(e){return e.aliases.every(t=>e.results[t]!==void 0)}function Ri(e){let t=Object.values(e.results).filter(e=>e===`success`).length,n=Object.values(e.results).filter(e=>e===`error`).length,r=`${t} selected ${t===1?`node`:`nodes`} deleted.`;return t===0&&n>0?{message:`Failed to delete selected nodes.`,type:`error`}:n>0?{message:`${r} ${n} failed.`,type:`error`}:{message:r,type:`success`}}var zi={toastContainer:`_toastContainer_hhy5k_1`,toast:`_toast_hhy5k_1`,slideIn:`_slideIn_hhy5k_1`,success:`_success_hhy5k_36`,error:`_error_hhy5k_40`,info:`_info_hhy5k_44`,toastIcon:`_toastIcon_hhy5k_48`,toastMessage:`_toastMessage_hhy5k_53`},Bi=({toasts:e,onRemove:t})=>e.length===0?null:(0,I.jsx)(`div`,{className:zi.toastContainer,children:e.map(e=>(0,I.jsxs)(`div`,{className:`${zi.toast} ${zi[e.type]}`,onClick:()=>t(e.id),children:[(0,I.jsxs)(`span`,{className:zi.toastIcon,children:[e.type===`success`&&`✅`,e.type===`error`&&`❌`,e.type===`info`&&`ℹ️`]}),(0,I.jsx)(`span`,{className:zi.toastMessage,children:e.message})]},e.id))}),Vi={container:`_container_9dbh2_3`,trigger:`_trigger_9dbh2_7`,chevron:`_chevron_9dbh2_37`,chevronOpen:`_chevronOpen_9dbh2_43`,dot:`_dot_9dbh2_49`,dotIdle:`_dotIdle_9dbh2_56`,dotConnecting:`_dotConnecting_9dbh2_57`,pulse:`_pulse_9dbh2_1`,dotConnected:`_dotConnected_9dbh2_58`,dotPartial:`_dotPartial_9dbh2_59`,dropdown:`_dropdown_9dbh2_65`,fadeIn:`_fadeIn_9dbh2_1`};function Hi({label:e,dotStatus:t,children:n}){let[r,i]=(0,M.useState)(!1),a=(0,M.useRef)(null);(0,M.useEffect)(()=>{if(!r)return;let e=e=>{a.current&&!a.current.contains(e.target)&&i(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[r]);let o=e=>{e.key===`Escape`&&(i(!1),a.current?.querySelector(`button[aria-haspopup]`)?.focus())},s=t===`connected`?Vi.dotConnected:t===`connecting`?Vi.dotConnecting:t===`partial`?Vi.dotPartial:t===`idle`?Vi.dotIdle:void 0;return(0,I.jsxs)(`div`,{className:Vi.container,ref:a,onKeyDown:o,children:[(0,I.jsxs)(`button`,{className:Vi.trigger,onClick:()=>i(e=>!e),"aria-haspopup":`true`,"aria-expanded":r,children:[t!==void 0&&(0,I.jsx)(`span`,{className:`${Vi.dot} ${s??``}`,"aria-hidden":`true`}),(0,I.jsx)(`span`,{children:e}),(0,I.jsx)(`span`,{className:`${Vi.chevron} ${r?Vi.chevronOpen:``}`,"aria-hidden":`true`,children:`▾`})]}),r&&(0,I.jsx)(`div`,{className:Vi.dropdown,role:`menu`,children:n})]})}var R={panel:`_panel_1ws0d_1`,section:`_section_1ws0d_7`,sectionHeader:`_sectionHeader_1ws0d_20`,sessionHeaderRow:`_sessionHeaderRow_1ws0d_29`,iconButton:`_iconButton_1ws0d_36`,copyButton:`_copyButton_1ws0d_63`,copyButtonCopied:`_copyButtonCopied_1ws0d_95`,relationshipRow:`_relationshipRow_1ws0d_102`,subscriberRow:`_subscriberRow_1ws0d_103`,sessionId:`_sessionId_1ws0d_114`,statusDot:`_statusDot_1ws0d_127`,metaText:`_metaText_1ws0d_136`,emptyMessage:`_emptyMessage_1ws0d_137`,subscriberList:`_subscriberList_1ws0d_148`,subscribeForm:`_subscribeForm_1ws0d_157`,subscribeInput:`_subscribeInput_1ws0d_164`,subscribeButton:`_subscribeButton_1ws0d_189`,resetButton:`_resetButton_1ws0d_190`,unsubscribeButton:`_unsubscribeButton_1ws0d_218`,actionsRow:`_actionsRow_1ws0d_241`,errorMessage:`_errorMessage_1ws0d_261`,infoMessage:`_infoMessage_1ws0d_262`};function Ui({copied:e}){return e?(0,I.jsx)(`svg`,{viewBox:`0 0 16 16`,"aria-hidden":`true`,focusable:`false`,children:(0,I.jsx)(`path`,{d:`M6.2 11.4 2.9 8.1l1.1-1.1 2.2 2.2 5.8-5.8 1.1 1.1-6.9 6.9Z`})}):(0,I.jsxs)(`svg`,{viewBox:`0 0 16 16`,"aria-hidden":`true`,focusable:`false`,children:[(0,I.jsx)(`path`,{d:`M5 2.5A1.5 1.5 0 0 1 6.5 1h6A1.5 1.5 0 0 1 14 2.5v6A1.5 1.5 0 0 1 12.5 10H11V8.7h1.5a.2.2 0 0 0 .2-.2v-6a.2.2 0 0 0-.2-.2h-6a.2.2 0 0 0-.2.2V4H5V2.5Z`}),(0,I.jsx)(`path`,{d:`M2 6.5A1.5 1.5 0 0 1 3.5 5h6A1.5 1.5 0 0 1 11 6.5v7A1.5 1.5 0 0 1 9.5 15h-6A1.5 1.5 0 0 1 2 13.5v-7Zm1.5-.2a.2.2 0 0 0-.2.2v7a.2.2 0 0 0 .2.2h6a.2.2 0 0 0 .2-.2v-7a.2.2 0 0 0-.2-.2h-6Z`})]})}function Wi(e){return e.connected?e.state.pendingCommand===`refresh`||e.state.loading?`connecting`:e.state.sessionId?`connected`:`partial`:`idle`}function Gi({controller:e}){let{state:t}=e,[n,r]=(0,M.useState)(!1),[i,a]=(0,M.useState)(``),[o,s]=(0,M.useState)(null),[c,l]=(0,M.useState)(null),u=(0,M.useRef)(null),d=e.canReset;(0,M.useEffect)(()=>()=>{u.current!==null&&window.clearTimeout(u.current)},[]),(0,M.useEffect)(()=>{t.subscribedTo&&t.pendingCommand!==`subscribe`&&(r(!1),a(``))},[t.pendingCommand,t.subscribedTo]);let f=t=>{t.preventDefault(),e.subscribeToSession(i)},p=async e=>{try{await navigator.clipboard.writeText(e),s(null),l(e),u.current!==null&&window.clearTimeout(u.current),u.current=window.setTimeout(()=>{l(null),u.current=null},1400)}catch{l(null),s(`Could not copy the session ID. Please copy it manually.`)}};return e.connected?(0,I.jsxs)(`div`,{className:R.panel,children:[(0,I.jsxs)(`section`,{className:R.section,children:[(0,I.jsx)(`div`,{className:R.sectionHeader,children:`This session`}),(0,I.jsxs)(`div`,{className:R.sessionHeaderRow,children:[t.sessionId?(0,I.jsx)(`code`,{className:R.sessionId,title:t.sessionId,children:t.sessionId}):(0,I.jsx)(`p`,{className:R.emptyMessage,children:`Session details are not loaded yet.`}),t.sessionId&&(0,I.jsx)(`button`,{type:`button`,className:`${R.copyButton} ${c===t.sessionId?R.copyButtonCopied:``}`,onClick:()=>void p(t.sessionId),"aria-label":`Copy session ID`,title:c===t.sessionId?`Copied`:`Copy session ID`,children:(0,I.jsx)(Ui,{copied:c===t.sessionId})}),e.canSubscribe&&(0,I.jsx)(`button`,{type:`button`,className:R.iconButton,onClick:()=>{e.clearMessage(),r(e=>!e)},"aria-expanded":n,"aria-label":n?`Close subscribe form`:`Subscribe to another session`,title:n?`Close subscribe form`:`Subscribe to another session`,children:n?`×`:`+`})]}),t.startedSince&&(0,I.jsxs)(`div`,{className:R.metaText,children:[`Started since `,t.startedSince]}),n&&(0,I.jsxs)(`form`,{className:R.subscribeForm,onSubmit:f,children:[(0,I.jsx)(`input`,{className:R.subscribeInput,value:i,onChange:t=>{a(t.target.value),e.clearMessage()},placeholder:`ws-123456-1`,autoComplete:`off`,disabled:!e.canSubscribe}),(0,I.jsx)(`button`,{type:`submit`,className:R.subscribeButton,disabled:!e.canSubscribe||i.trim().length===0,children:t.pendingCommand===`subscribe`?`...`:`Subscribe`})]})]}),t.subscribedTo&&(0,I.jsxs)(`section`,{className:R.section,children:[(0,I.jsx)(`div`,{className:R.sectionHeader,children:`Subscribed to`}),(0,I.jsxs)(`div`,{className:R.relationshipRow,children:[(0,I.jsx)(`span`,{className:R.statusDot,"aria-hidden":`true`}),(0,I.jsx)(`code`,{className:R.sessionId,title:t.subscribedTo,children:t.subscribedTo}),(0,I.jsx)(`button`,{type:`button`,className:R.unsubscribeButton,onClick:e.unsubscribe,disabled:!e.canUnsubscribe,children:t.pendingCommand===`unsubscribe`?`...`:`Unsubscribe`})]})]}),t.subscribers.length>0&&(0,I.jsxs)(`section`,{className:R.section,children:[(0,I.jsx)(`div`,{className:R.sectionHeader,children:`Subscribers`}),(0,I.jsx)(`ul`,{className:R.subscriberList,children:t.subscribers.map(e=>(0,I.jsxs)(`li`,{className:R.subscriberRow,children:[(0,I.jsx)(`span`,{className:R.statusDot,"aria-hidden":`true`}),(0,I.jsx)(`code`,{className:R.sessionId,title:e,children:e})]},e))})]}),d&&(0,I.jsx)(`div`,{className:R.actionsRow,children:(0,I.jsx)(`button`,{type:`button`,className:R.resetButton,onClick:e.resetSession,disabled:!e.canReset,children:t.pendingCommand===`reset`?`Resetting...`:`Reset Session`})}),t.error&&(0,I.jsx)(`div`,{className:R.errorMessage,role:`alert`,children:t.error}),o&&(0,I.jsx)(`div`,{className:R.errorMessage,role:`alert`,children:o})]}):(0,I.jsx)(`div`,{className:R.panel,children:(0,I.jsx)(`p`,{className:R.emptyMessage,children:`Connect Minigraph to view session details.`})})}function Ki({controller:e}){return(0,I.jsx)(Hi,{label:`Session`,dotStatus:Wi(e),children:(0,I.jsx)(Gi,{controller:e})})}var qi={nav:`_nav_1hfby_3`,menuList:`_menuList_1hfby_11`,menuItem:`_menuItem_1hfby_19`,toolRow:`_toolRow_1hfby_56`,toolLink:`_toolLink_1hfby_67`,toolLinkActive:`_toolLinkActive_1hfby_92`,toolDot:`_toolDot_1hfby_99`,toolDotIdle:`_toolDotIdle_1hfby_106`,toolDotConnecting:`_toolDotConnecting_1hfby_107`,pulse:`_pulse_1hfby_1`,toolDotConnected:`_toolDotConnected_1hfby_108`,connectAllRow:`_connectAllRow_1hfby_112`,connectAllBtn:`_connectAllBtn_1hfby_118`,connectAllBtnStop:`_connectAllBtnStop_1hfby_142`,toolConnectBtn:`_toolConnectBtn_1hfby_154`,toolConnectBtnStop:`_toolConnectBtnStop_1hfby_180`,externalIcon:`_externalIcon_1hfby_192`};function Ji(e){return e.every(e=>e===`connected`)?`connected`:e.every(e=>e===`idle`)?`idle`:e.some(e=>e===`connecting`)?`connecting`:`partial`}function Yi(e){return e===`connected`?`connected`:e===`connecting`?`connecting`:`idle`}var Xi=[{href:`/info`,label:`Info`},{href:`/info/lib`,label:`Libraries`},{href:`/info/routes`,label:`Services`},{href:`/health`,label:`Health`},{href:`/env`,label:`Environment`},{href:`http://localhost:8085/api/ws/json`,label:`Legacy JSON`},{href:`http://localhost:8085/api/ws/graph`,label:`Legacy Graph`}];function Zi({addToast:e,sessionCollaboration:t}){let n=Cr(),r=gr.map(e=>n.getSlot(e.wsPath).phase),i=Ji(r),a=r.every(e=>e===`connected`),o=r.some(e=>e===`connecting`);function s(){gr.forEach(t=>{n.getSlot(t.wsPath).phase===`idle`&&n.connect(t.wsPath,e)})}function c(){gr.forEach(e=>{let{phase:t}=n.getSlot(e.wsPath);(t===`connected`||t===`connecting`)&&n.disconnect(e.wsPath)})}return(0,I.jsxs)(`nav`,{className:qi.nav,"aria-label":`Main navigation`,children:[t&&(0,I.jsx)(Ki,{controller:t}),(0,I.jsxs)(Hi,{label:`Tools`,dotStatus:i,children:[(0,I.jsx)(`div`,{className:qi.connectAllRow,children:(0,I.jsx)(`button`,{className:`${qi.connectAllBtn} ${a?qi.connectAllBtnStop:``}`,onClick:a?c:s,disabled:o,"aria-label":o?`Connecting…`:a?`Disconnect all WebSockets`:`Connect all WebSockets`,children:o?`Connecting…`:a?`Disconnect All`:`Connect All`})}),(0,I.jsx)(`ul`,{className:qi.menuList,role:`none`,children:gr.map(t=>{let{phase:r}=n.getSlot(t.wsPath),i=Yi(r),a=r===`connected`,o=r===`connecting`,s=i===`connected`?qi.toolDotConnected:i===`connecting`?qi.toolDotConnecting:qi.toolDotIdle;return(0,I.jsxs)(`li`,{role:`none`,className:qi.toolRow,children:[(0,I.jsxs)(Wn,{to:t.path,role:`menuitem`,className:({isActive:e})=>`${qi.toolLink} ${e?qi.toolLinkActive:``}`,children:[(0,I.jsx)(`span`,{className:`${qi.toolDot} ${s}`,"aria-hidden":`true`}),(0,I.jsx)(`span`,{className:qi.toolLabel,children:t.label})]}),(0,I.jsx)(`button`,{className:`${qi.toolConnectBtn} ${a?qi.toolConnectBtnStop:``}`,onClick:()=>a||o?n.disconnect(t.wsPath):n.connect(t.wsPath,e),disabled:o,"aria-label":o?`Connecting…`:a?`Disconnect ${t.label}`:`Connect ${t.label}`,title:o?`Connecting…`:vr(t.wsPath),children:o?`…`:a?`Stop`:`Start`})]},t.path)})})]}),(0,I.jsx)(Hi,{label:`Quick Links`,children:(0,I.jsx)(`ul`,{className:qi.menuList,role:`none`,children:Xi.map(e=>(0,I.jsx)(`li`,{role:`none`,children:(0,I.jsxs)(`a`,{href:e.href,role:`menuitem`,className:qi.menuItem,target:`_blank`,rel:`noopener noreferrer`,children:[e.label,(0,I.jsx)(`span`,{className:qi.externalIcon,"aria-hidden":`true`,children:`↗`})]})},e.href))})})]})}var Qi={saveBtn:`_saveBtn_ek34s_3`,saveBtnSaved:`_saveBtnSaved_ek34s_25`,saveBtnLabel:`_saveBtnLabel_ek34s_35`,saveForm:`_saveForm_ek34s_50`,saveInput:`_saveInput_ek34s_56`,saveInputWarn:`_saveInputWarn_ek34s_72`,saveWarnLabel:`_saveWarnLabel_ek34s_76`,saveActionBtn:`_saveActionBtn_ek34s_82`};function $i(e){return e?`Saved: ${e}`:`Save Graph`}function ea({disabled:e,defaultName:t,savedName:n=null,onSave:r,nameExists:i,connected:a=!1}){let[o,s]=(0,M.useState)(!1),[c,l]=(0,M.useState)(``),u=(0,M.useRef)(null),d=(0,M.useRef)(null),f=(0,M.useRef)(!1),p=(0,M.useCallback)(()=>{l(t),s(!0)},[t]),m=(0,M.useCallback)(()=>{f.current=!0,s(!1),l(``)},[]),h=(0,M.useCallback)(()=>{let e=c.trim();e&&(r(e),f.current=!0,s(!1),l(``))},[c,r]),g=(0,M.useCallback)(e=>{e.key===`Enter`&&(e.preventDefault(),h()),e.key===`Escape`&&(e.preventDefault(),m())},[h,m]);return(0,M.useEffect)(()=>{o?u.current?.focus():f.current&&(f.current=!1,d.current?.focus())},[o]),o?(0,I.jsxs)(`div`,{className:Qi.saveForm,children:[(0,I.jsx)(`input`,{ref:u,className:`${Qi.saveInput}${i?.(c.trim())?` ${Qi.saveInputWarn}`:``}`,type:`text`,value:c,onChange:e=>l(e.target.value),onKeyDown:g,placeholder:`Enter a name…`,"aria-label":`Graph save name`,maxLength:80}),i?.(c.trim())&&(0,I.jsx)(`span`,{className:Qi.saveWarnLabel,role:`status`,children:`Overwrite?`}),(0,I.jsx)(`button`,{className:Qi.saveActionBtn,onClick:h,disabled:!c.trim(),"aria-label":`Confirm save`,children:`✅`}),(0,I.jsx)(`button`,{className:Qi.saveActionBtn,onClick:m,"aria-label":`Cancel save`,children:`❌`})]}):(0,I.jsxs)(`button`,{ref:d,className:`${Qi.saveBtn}${n?` ${Qi.saveBtnSaved}`:``}`,onClick:p,disabled:e||!a,title:e?`No graph loaded`:a?n?`Graph saved as ${n}. Click to save again`:`Export graph snapshot to server and save bookmark`:`Connect first to save`,"aria-label":n?`Graph saved as ${n}. Save again`:`Save graph snapshot`,children:[(0,I.jsx)(`span`,{"aria-hidden":`true`,children:n?`✅`:`💾`}),(0,I.jsx)(`span`,{className:Qi.saveBtnLabel,children:$i(n)})]})}var ta={empty:`_empty_tpeii_3`,hint:`_hint_tpeii_12`,list:`_list_tpeii_21`,row:`_row_tpeii_31`,rowInfo:`_rowInfo_tpeii_50`,rowName:`_rowName_tpeii_58`,rowMeta:`_rowMeta_tpeii_67`,rowActions:`_rowActions_tpeii_78`,loadBtn:`_loadBtn_tpeii_84`,deleteBtn:`_deleteBtn_tpeii_85`};function na({savedGraphs:e,onLoad:t,onDelete:n,connected:r}){return(0,I.jsx)(Hi,{label:e.length>0?`Load Graph (${e.length})`:`Load Graph`,children:e.length===0?(0,I.jsx)(`p`,{className:ta.empty,children:`No saved graphs yet.`}):(0,I.jsxs)(I.Fragment,{children:[!r&&(0,I.jsx)(`p`,{className:ta.hint,children:`Connect to load a graph`}),(0,I.jsx)(`ul`,{className:ta.list,role:`list`,children:e.map(e=>(0,I.jsxs)(`li`,{className:ta.row,children:[(0,I.jsxs)(`div`,{className:ta.rowInfo,children:[(0,I.jsx)(`span`,{className:ta.rowName,title:e.name,children:e.name}),(0,I.jsx)(`span`,{className:ta.rowMeta,children:new Date(e.savedAt).toLocaleString()})]}),(0,I.jsxs)(`div`,{className:ta.rowActions,children:[(0,I.jsx)(`button`,{className:ta.loadBtn,onClick:()=>t(e.name),disabled:!r,title:r?`Run: import graph from ${e.name}`:`Connect to the playground first`,"aria-label":`Load graph ${e.name}`,children:`Load`}),(0,I.jsx)(`button`,{className:ta.deleteBtn,onClick:()=>n(e.name),title:`Remove "${e.name}" from local storage`,"aria-label":`Delete saved graph ${e.name}`,children:`Delete`})]})]},e.name))})]})})}var ra={payloadRoot:`_payloadRoot_6u47x_2`,labelRow:`_labelRow_6u47x_10`,label:`_label_6u47x_10`,payloadControls:`_payloadControls_6u47x_26`,charCounter:`_charCounter_6u47x_32`,typeIndicator:`_typeIndicator_6u47x_38`,validationIcon:`_validationIcon_6u47x_49`,formatButton:`_formatButton_6u47x_53`,uploadButton:`_uploadButton_6u47x_67`,textarea:`_textarea_6u47x_82`,textareaError:`_textareaError_6u47x_107`,errorMessage:`_errorMessage_6u47x_109`,sampleButtonsRow:`_sampleButtonsRow_6u47x_117`,sampleButtons:`_sampleButtons_6u47x_117`,sampleLabel:`_sampleLabel_6u47x_130`,sampleGroup:`_sampleGroup_6u47x_136`,sampleGroupLabel:`_sampleGroupLabel_6u47x_143`,sampleButton:`_sampleButton_6u47x_117`};function ia({onLoad:e}){let t=Object.keys(_r).filter(e=>e.startsWith(`json_`)),n=Object.keys(_r).filter(e=>e.startsWith(`xml_`)),r=e=>e.replace(/^(json|xml)_/,``).replace(/_/g,` `);return(0,I.jsxs)(`div`,{className:ra.sampleButtons,children:[(0,I.jsx)(`span`,{className:ra.sampleLabel,children:`Quick load:`}),(0,I.jsxs)(`div`,{className:ra.sampleGroup,children:[(0,I.jsx)(`span`,{className:ra.sampleGroupLabel,children:`JSON:`}),t.map(t=>(0,I.jsx)(`button`,{className:ra.sampleButton,onClick:()=>e(_r[t]),children:r(t)},t))]}),(0,I.jsxs)(`div`,{className:ra.sampleGroup,children:[(0,I.jsx)(`span`,{className:ra.sampleGroupLabel,children:`XML:`}),n.map(t=>(0,I.jsx)(`button`,{className:ra.sampleButton,onClick:()=>e(_r[t]),children:r(t)},t))]})]})}function aa({payload:e,onChange:t,validation:n,onFormat:r,onUpload:i}){return(0,I.jsxs)(`div`,{className:ra.payloadRoot,children:[(0,I.jsxs)(`div`,{className:ra.labelRow,children:[(0,I.jsx)(`label`,{htmlFor:`payload`,className:ra.label,children:`JSON/XML Payload`}),(0,I.jsxs)(`div`,{className:ra.payloadControls,children:[(0,I.jsxs)(`span`,{className:ra.charCounter,children:[`size: `,e.length]}),e&&n.type&&(0,I.jsx)(`span`,{className:ra.typeIndicator,children:n.type.toUpperCase()}),e&&(0,I.jsx)(`span`,{className:ra.validationIcon,children:n.valid?`✅`:`❌`}),(0,I.jsx)(`button`,{className:ra.formatButton,onClick:r,disabled:!e||n.type!==`json`,title:n.type===`xml`?`Format only available for JSON`:`Format JSON`,children:`Format`}),i!==void 0&&(0,I.jsx)(`button`,{className:ra.uploadButton,onClick:i,disabled:!e||!n.valid||n.type!==`json`,title:`Upload JSON payload to current session via REST`,children:`Upload`})]})]}),(0,I.jsx)(`textarea`,{id:`payload`,className:`${ra.textarea} ${n.valid?``:ra.textareaError}`,placeholder:`Paste your JSON/XML payload here`,value:e,onChange:e=>t(e.target.value)}),!n.valid&&(0,I.jsx)(`div`,{className:ra.errorMessage,children:n.error}),(0,I.jsx)(`div`,{className:ra.sampleButtonsRow,children:(0,I.jsx)(ia,{onLoad:t})})]})}var oa={Root:{icon:`🚀`,label:`Root`},End:{icon:`🏁`,label:`End`},Fetcher:{icon:`🌐`,label:`Fetcher`},mapper:{icon:`🗺️`,label:`Mapper`},Math:{icon:`🔢`,label:`Math`},JavaScript:{icon:`📜`,label:`JavaScript`},Provider:{icon:`🔌`,label:`Provider`},Dictionary:{icon:`📖`,label:`Dictionary`},Join:{icon:`🔀`,label:`Join`},Extension:{icon:`🧩`,label:`Extension`},Island:{icon:`🏝️`,label:`Island`},Decision:{icon:`❓`,label:`Decision`},Suspend:{icon:`⏸️`,label:`Suspend`},Resume:{icon:`▶️`,label:`Resume`},Suspensible:{icon:`⏯️`,label:`Suspensible`}},sa={boxSizing:`border-box`,borderRadius:`8px`,borderWidth:`1.5px`,borderStyle:`solid`,background:`var(--bg-secondary, #1e1e2e)`,color:`var(--text-primary, #cdd6f4)`,fontSize:`0.75rem`,boxShadow:`0 2px 8px rgba(0,0,0,0.45)`,overflow:`visible`,padding:0},ca={Root:`#15803d`,End:`#dc2626`,Fetcher:`#2563eb`,mapper:`#ea580c`,Math:`#a16207`,JavaScript:`#7e22ce`,Provider:`#be185d`,Dictionary:`#0e7490`,Join:`#65a30d`,Extension:`#4338ca`,Island:`#475569`,Decision:`#b45309`,Suspend:`#0d9488`,Resume:`#0284c7`,Suspensible:`#c026d3`},la=`#6c7086`;function ua(e){return oa[e]??{icon:`📦`,label:e}}function da(e){return ca[e]??la}function fa(e){let t=ca[e]??la;return{...sa,borderColor:t,"--node-accent":t}}var pa={content:`_content_lun23_8`,header:`_header_lun23_24`,icon:`_icon_lun23_44`,alias:`_alias_lun23_49`,badge:`_badge_lun23_55`,body:`_body_lun23_67`,bodyPeek:`_bodyPeek_lun23_77`,row:`_row_lun23_85`,label:`_label_lun23_98`,value:`_value_lun23_104`,edgeHandle:`_edgeHandle_lun23_118`,authoringFrame:`_authoringFrame_lun23_128`,authoringHandle:`_authoringHandle_lun23_141`,authoringSourceHandle:`_authoringSourceHandle_lun23_167`,authoringTargetHandle:`_authoringTargetHandle_lun23_176`};function ma({label:e,value:t}){return(0,I.jsxs)(`div`,{className:pa.row,children:[(0,I.jsx)(`span`,{className:pa.label,children:e}),(0,I.jsx)(`span`,{className:pa.value,title:t,children:t})]})}function ha({properties:e}){let t=Object.entries(e).filter(([,e])=>e!=null);return t.length===0?null:(0,I.jsx)(I.Fragment,{children:t.map(([e,t])=>Array.isArray(t)?t.map((t,n)=>{let r=typeof t==`string`?t:JSON.stringify(t);return(0,I.jsx)(ma,{label:n===0?e:``,value:r},`${e}-${n}`)}):(0,I.jsx)(ma,{label:e,value:typeof t==`string`?t:JSON.stringify(t)},e))})}function ga({alias:e,nodeType:t,properties:n,compact:r=!1}){let i=ua(t);return(0,I.jsx)(M.Fragment,{children:(0,I.jsxs)(`div`,{className:pa.content,children:[(0,I.jsxs)(`div`,{className:pa.header,children:[(0,I.jsx)(`span`,{className:pa.icon,children:i.icon}),(0,I.jsx)(`span`,{className:pa.alias,children:e}),(0,I.jsx)(`span`,{className:pa.badge,children:i.label})]}),(0,I.jsx)(`div`,{className:r?`${pa.body} ${pa.bodyPeek}`:pa.body,children:(0,I.jsx)(ha,{properties:n})})]})})}function _a({data:e,isConnectable:t,selected:n}){let[r,i]=(0,M.useState)(!1),a=e.supportsConnectionAuthoring&&!r;return(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(m,{minWidth:180,minHeight:e.minHeight,isVisible:n,onResizeStart:()=>i(!0),onResizeEnd:()=>i(!1)}),e.targetHandles.map(({id:e,offset:n})=>(0,I.jsx)(s,{id:e,type:`target`,position:l.Left,isConnectable:t,className:pa.edgeHandle,style:{top:`calc(50% + ${n}px)`}},e)),e.backSourceHandles.map(({id:e,offset:n})=>(0,I.jsx)(s,{id:e,type:`source`,position:l.Left,isConnectable:t,className:pa.edgeHandle,style:{top:`calc(50% + ${n}px)`}},e)),(0,I.jsx)(ga,{alias:e.alias,nodeType:e.nodeType,properties:e.properties,compact:e.compact}),a&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`div`,{className:pa.authoringFrame,"aria-hidden":`true`}),(0,I.jsx)(s,{id:`authoring-source`,type:`source`,position:l.Right,isConnectable:t,isConnectableEnd:!1,className:`${pa.authoringHandle} ${pa.authoringSourceHandle}`}),(0,I.jsx)(s,{id:`authoring-target`,type:`target`,position:l.Left,isConnectable:t,isConnectableStart:!1,className:`${pa.authoringHandle} ${pa.authoringTargetHandle}`})]}),e.sourceHandles.map(({id:e,offset:n})=>(0,I.jsx)(s,{id:e,type:`source`,position:l.Right,isConnectable:t,className:pa.edgeHandle,style:{top:`calc(50% + ${n}px)`}},e)),e.backTargetHandles.map(({id:e,offset:n})=>(0,I.jsx)(s,{id:e,type:`target`,position:l.Right,isConnectable:t,className:pa.edgeHandle,style:{top:`calc(50% + ${n}px)`}},e))]})}var va={Root:_a,End:_a,Fetcher:_a,mapper:_a,Math:_a,JavaScript:_a,Provider:_a,Dictionary:_a,Join:_a,Extension:_a,Island:_a,Decision:_a,default:_a},ya={graphWrapper:`_graphWrapper_xguzu_15`,graphSurface:`_graphSurface_xguzu_24`,empty:`_empty_xguzu_30`,emptyIcon:`_emptyIcon_xguzu_43`,emptyCreateButton:`_emptyCreateButton_xguzu_48`,emptyHint:`_emptyHint_xguzu_70`,refreshingOverlay:`_refreshingOverlay_xguzu_135`,clipboardDropOverlay:`_clipboardDropOverlay_xguzu_147`,clipboardDropMessage:`_clipboardDropMessage_xguzu_160`,refreshingSpinner:`_refreshingSpinner_xguzu_175`,graphRefreshSpin:`_graphRefreshSpin_xguzu_1`,detailToggleIcon:`_detailToggleIcon_xguzu_195`,detailToggleHeader:`_detailToggleHeader_xguzu_206`,detailToggleLine:`_detailToggleLine_xguzu_213`},ba=class extends M.Component{constructor(...e){super(...e),this.state={caughtError:null}}static getDerivedStateFromError(e){return{caughtError:e instanceof Error?e.message:String(e)}}componentDidCatch(e,t){let n=e instanceof Error?e.message:String(e);console.error(`[GraphView] Render error:`,n,t.componentStack),this.props.onRenderError?.(`Graph render failed: ${n}`)}render(){return this.state.caughtError?(0,I.jsxs)(`div`,{className:ya.empty,children:[(0,I.jsx)(`span`,{className:ya.emptyIcon,children:`⚠️`}),(0,I.jsx)(`span`,{children:`Graph could not be rendered.`}),(0,I.jsx)(`span`,{children:this.state.caughtError})]}):this.props.children}},xa={fetch:`#0369a1`,details:`#0369a1`,"ext-call":`#0369a1`,mapping:`#b45309`,compute:`#b45309`,calculate:`#b45309`,evaluate:`#b45309`,fork:`#7e22ce`,join:`#7e22ce`,one:`#7e22ce`,two:`#6d28d9`,three:`#5b21b6`,more:`#4c1d95`,done:`#15803d`,complete:`#15803d`,finish:`#15803d`,positive:`#15803d`,negative:`#b91c1c`},Sa=[`#0369a1`,`#15803d`,`#b45309`,`#7e22ce`,`#b91c1c`,`#0f766e`,`#c2410c`,`#a16207`];function Ca(e){let t=0;for(let n=0;n<e.length;n++)t=(t<<5)-t+e.charCodeAt(n),t|=0;return Math.abs(t)}function wa(e,t){if(e.length===0)return t;let n=e[0].trim().toLowerCase();return xa[n]||Sa[Ca(n)%Sa.length]}var Ta=240,Ea=100,Da=100,Oa=60,ka=360,Aa=120,ja=80,Ma=4,Na=1e4,Pa=2e3,Fa=64,Ia=256,La=256,Ra=512,za=.001,Ba=8,Va=16,Ha=`rgba(148, 163, 184, 0.42)`,Ua=`var(--bg-secondary)`,Wa=24,Ga=32;function Ka(e){return wa(e,Ha)}function qa(e){return`source-${e}`}function Ja(e){return`target-${e}`}function Ya(e){return`back-source-${e}`}function Xa(e){return`back-target-${e}`}function Za(e,t){return t<=1?0:t===2?e===0?-24:Wa:(e-(t-1)/2)*Wa}function Qa(e,t=Ea){return e<=1?t:Math.max(t,(e-1)*Wa+Ga*2)}var $a=40,eo=9,to=18,no=22;function ro(e){let t=typeof e==`string`?e:JSON.stringify(e)??``;return Math.max(1,Math.ceil(t.length/no))}function io(e){let t=$a;for(let n of Object.values(e.properties??{})){if(n==null)continue;let e=Array.isArray(n)?n:[n];for(let n of e)t+=eo+ro(n)*to}return Math.max(Ea,t)}var ao=new Set([`graph.math`,`graph.js`]),oo=[`Dictionary`,`Provider`,`Module`,`Entity`],so={ROOT_TREE:0,DEFAULT_TREE:1,END_TREE:2};function co(e){return e.alias.toLowerCase()===`root`||e.types.includes(`Root`)||e.types.includes(`entry_point`)}function lo(e){return e.alias.toLowerCase()===`end`||e.types.includes(`End`)}function uo(e){return e.hasRoot?so.ROOT_TREE:e.hasEnd?so.END_TREE:so.DEFAULT_TREE}function fo(e,t){let n=uo(e)-uo(t);return n===0?e.sortKey.localeCompare(t.sortKey):n}function po(e){return`real:${e}`}function mo(e){return new Map([...e].map(([e,t])=>[e,t.slice()]))}function z(e){return new Map(e.map((e,t)=>[e.id,t]))}function B(e,t,n){let r=(t.get(e)??[]).map(e=>n.get(e)).filter(e=>e!==void 0);if(r.length!==0)return r.reduce((e,t)=>e+t,0)/r.length}function ho(e,t,n){let r=z(e);return e.slice().sort((e,i)=>{let a=B(e.id,t,n),o=B(i.id,t,n);if(a!==void 0&&o!==void 0){let e=a-o;if(Math.abs(e)>2**-52)return e}let s=r.get(e.id)-r.get(i.id);return s===0?e.stableKey.localeCompare(i.stableKey):s})}function go(e,t){let n=Array(t+1).fill(0),r=e=>{let t=0;for(let r=e;r>0;r-=r&-r)t+=n[r];return t},i=e=>{for(let t=e;t<n.length;t+=t&-t)n[t]+=1},a=0;for(let t=e.length-1;t>=0;t--){let n=e[t]+1;a+=r(n-1),i(n)}return a}function _o(e,t){let n=new Map([...e].map(([e,t])=>[e,z(t)])),r=new Map;for(let e of t)r.has(e.level)||r.set(e.level,[]),r.get(e.level).push(e);let i=0;for(let[e,t]of r){let r=n.get(e),a=n.get(e+1);if(!r||!a)continue;let o=t.map(e=>({sourceId:e.sourceId,targetId:e.targetId,sourcePosition:r.get(e.sourceId),targetPosition:a.get(e.targetId)})).sort((e,t)=>e.sourcePosition-t.sourcePosition||e.targetPosition-t.targetPosition||e.sourceId.localeCompare(t.sourceId)||e.targetId.localeCompare(t.targetId)).map(e=>e.targetPosition);i+=go(o,a.size)}return i}function vo(e,t,n){e.has(t)||e.set(t,[]),e.get(t).push(n)}function yo(e){return[e.source,e.target,...e.relations.map(e=>e.type)].join(`	`)}function bo(e,t){return e.nodeIntrusions<t.nodeIntrusions||e.nodeIntrusions===t.nodeIntrusions&&e.edgeCrossings<t.edgeCrossings}function xo(e){let t=new Map;for(let[n,r]of e){let e=-(r.reduce((e,t)=>e+t.height,0)+Math.max(0,r.length-1)*Oa)/2;for(let i of r)i.alias&&t.set(i.alias,{alias:i.alias,level:n,x:n*360,y:e,height:i.height}),e+=i.height+Oa}return t}function So(e,t,n,r,i){let a=1-i;return a*a*a*e+3*a*a*i*t+3*a*i*i*n+i*i*i*r}function Co(e,t,n,r){let i=0,a=1;for(let o=0;o<32;o++){let o=(i+a)/2;So(e,t,t,n,o)<r?i=o:a=o}return(i+a)/2}function wo(e,t,n,r,i){let a=e.x+Ta,o=t.x,s=i.x+za,c=i.x+Ta-za;if(s>=o||c<=a)return null;let l=a+(o-a)/2,u=Co(a,l,o,s),d=Co(a,l,o,c),f=e.y+e.height/2+n,p=t.y+t.height/2+r,m=So(f,f,p,p,u),h=So(f,f,p,p,d);return{yLow:Math.min(m,h),yHigh:Math.max(m,h)}}function To(e,t,n,r,i){let a=wo(e,t,n,r,i);if(!a)return!1;let o=i.y+za,s=i.y+i.height-za;return a.yHigh>o&&a.yLow<s}function Eo(e,t){let n=new Map;for(let[e,r]of t)n.has(r)||n.set(r,[]),n.get(r).push(e);for(let e of n.values())e.sort();let r=[];for(let[i,a]of e.entries()){let e=t.get(a.source),o=t.get(a.target);if(!(e===void 0||o===void 0||o-e<=1)){for(let t=e+1;t<o;t++)for(let e of n.get(t)??[])if(r.push({connectionIndex:i,nodeAlias:e}),r.length>Pa)return null}}return r}function Do(e,t,n){let r=new Map,i=new Map;for(let e of t.keys())r.set(e,[]),i.set(e,[]);for(let[n,a]of e.entries()){let e=t.get(a.source),o=t.get(a.target);if(e===void 0||o===void 0)continue;let s=e>=o,c=yo(a);s?(i.get(a.source).push({connectionIndex:n,peerAlias:a.target,isBack:s,stableKey:c}),r.get(a.target).push({connectionIndex:n,peerAlias:a.source,isBack:s,stableKey:c})):(r.get(a.source).push({connectionIndex:n,peerAlias:a.target,isBack:s,stableKey:c}),i.get(a.target).push({connectionIndex:n,peerAlias:a.source,isBack:s,stableKey:c}))}let a=(e,t)=>n(e.peerAlias)-n(t.peerAlias)||e.peerAlias.localeCompare(t.peerAlias)||e.stableKey.localeCompare(t.stableKey)||e.connectionIndex-t.connectionIndex;for(let e of r.values())e.sort(a);for(let e of i.values())e.sort(a);let o=new Map,s=new Map;for(let e of r.values())for(let[t,n]of e.entries()){let r=Za(t,e.length);n.isBack?s.set(n.connectionIndex,r):o.set(n.connectionIndex,r)}for(let e of i.values())for(let[t,n]of e.entries()){let r=Za(t,e.length);n.isBack?o.set(n.connectionIndex,r):s.set(n.connectionIndex,r)}return{sourceOffsets:o,targetOffsets:s}}function Oo(e,t,n,r){let i=xo(e),{sourceOffsets:a,targetOffsets:o}=Do(n,t,e=>i.get(e)?.y??0),s=0;for(let{connectionIndex:e,nodeAlias:t}of r){let r=n[e],c=i.get(r.source),l=i.get(r.target),u=i.get(t);!c||!l||!u||To(c,l,a.get(e)??0,o.get(e)??0,u)&&(s+=1)}return s}function ko(e,t,n,r){let i=e=>t.map(t=>e.get(t).map(e=>e.id).join(`	`)).join(`
`),a=mo(e),o=1,s=a,c=n(a),l=[{candidate:a,depth:0}],u=new Set([i(a)]),d=0;for(;d<l.length&&o<r;){let{candidate:e,depth:a}=l[d++];if(!(a>=2))for(let d of t){let t=e.get(d);for(let f=0;f<t.length;f++){for(let p=0;p<t.length;p++){if(f===p)continue;let t=mo(e),m=t.get(d),[h]=m.splice(f,1);m.splice(p,0,h);let g=i(t);if(u.has(g))continue;u.add(g);let _=n(t);if(o+=1,bo(_,c)&&(s=t,c=_),a+1<2&&l.push({candidate:t,depth:a+1}),o>=r)break}if(o>=r)break}if(o>=r)break}}for(let n of t)e.set(n,s.get(n).slice());return o}function Ao(e,t,n,r){let i=new Map;for(let[t,n]of e)i.has(n)||i.set(n,[]),i.get(n).push({id:po(t),alias:t,height:r.get(t)??Ea,stableKey:`real:${t}`});for(let e of i.values())e.sort((e,t)=>e.stableKey.localeCompare(t.stableKey));let a=mo(i),o=mo(i),s=t.map((t,n)=>({connectionIndex:n,source:t.source,target:t.target,sourceLevel:e.get(t.source),targetLevel:e.get(t.target),stableKey:yo(t)})).filter(e=>e.sourceLevel!==void 0&&e.targetLevel!==void 0&&!n.has(`${e.source}\t${e.target}`)&&e.sourceLevel<e.targetLevel).sort((e,t)=>e.source.localeCompare(t.source)||e.target.localeCompare(t.target)||e.stableKey.localeCompare(t.stableKey)||e.connectionIndex-t.connectionIndex),c=s.reduce((e,t)=>e+(t.targetLevel-t.sourceLevel),0)<=Na,l=new Map,u=new Map,d=[];for(let[e,t]of s.entries()){let n=t.sourceLevel,r=t.targetLevel;if(!c&&r-n>1)continue;let i=po(t.source),a=n;for(let s=n+1;s<r;s++){let n=`dummy:${t.source}\t${t.target}\t${e}\t${s}`;o.has(s)||o.set(s,[]),o.get(s).push({id:n,height:Ea,stableKey:n}),d.push({sourceId:i,targetId:n,level:a}),vo(u,i,n),vo(l,n,i),i=n,a=s}let s=po(t.target);d.push({sourceId:i,targetId:s,level:a}),vo(u,i,s),vo(l,s,i)}for(let e of o.values())e.sort((e,t)=>e.stableKey.localeCompare(t.stableKey));let f=[...o.keys()].sort((e,t)=>e-t);if(f.length<=1||d.length===0)return a;let p=mo(o),m=mo(o),h=Eo(t,e),g=h?.length??2001,_=h!==null,v=n=>({nodeIntrusions:_?Oo(n,e,t,h??[]):0,edgeCrossings:_o(n,d)}),y=v(m),b=()=>{let e=v(p);bo(e,y)&&(y=e,m=mo(p))},x=[...o.values()].reduce((e,t)=>e+t.length,0)<=Fa&&d.length<=Ia&&g<=La,S=0,C=()=>{let e=Ra-S;!x||e<=1||(S+=ko(p,f,v,e),b())};for(let e=0;e<Ma;e++){for(let e=1;e<f.length;e++){let t=f[e],n=f[e-1];p.set(t,ho(p.get(t),l,z(p.get(n))))}b(),C();for(let e=f.length-2;e>=0;e--){let t=f[e],n=f[e+1];p.set(t,ho(p.get(t),u,z(p.get(n))))}b(),C()}return _&&Oo(a,e,t,h??[])<y.nodeIntrusions?a:m}function jo(e,t,n,r,i){let a=n.slice().sort((e,n)=>yo(t[e.connectionIndex]).localeCompare(yo(t[n.connectionIndex]))||e.nodeAlias.localeCompare(n.nodeAlias)||e.connectionIndex-n.connectionIndex);for(let{connectionIndex:n,nodeAlias:o}of a){let a=t[n],s=e.get(a.source),c=e.get(a.target),l=e.get(o);if(!s||!c||!l)continue;let u=wo(s,c,r.get(n)??0,i.get(n)??0,l);if(!u)continue;let d=l.y+za,f=l.y+l.height-za;if(u.yHigh<=d||u.yLow>=f)continue;let p=u.yHigh+Va-l.y,m=l.y+l.height-(u.yLow-Va);return p<=m?{x:l.x,y:l.y,delta:p,direction:1}:{x:l.x,y:l.y,delta:m,direction:-1}}return null}function Mo(e,t,n,r){let i=Eo(n,t);if(!(i===null||i.length===0))for(let a=0;a<Ba;a++){let a=new Map;for(let[n,i]of e){let e=t.get(n);e!==void 0&&a.set(n,{alias:n,level:e,x:i.x,y:i.y,height:r.get(n)??Ea})}let{sourceOffsets:o,targetOffsets:s}=Do(n,t,e=>a.get(e)?.y??0),c=jo(a,n,i,o,s);if(!c)return;for(let[t,n]of e)n.x===c.x&&(c.direction===1?n.y>=c.y:n.y<=c.y)&&e.set(t,{x:n.x,y:n.y+c.delta*c.direction})}}function No(e,t){if(t.has(e.alias))return`flow`;let n=e.types[0]??``,r=typeof e.properties.skill==`string`?e.properties.skill:void 0;return n===`Dictionary`?`Dictionary`:n===`Provider`?`Provider`:r&&ao.has(r)?`Module`:r?`__unknown__`:`Entity`}function Po(e,t,n){let r=new Set;for(let e of t??[])r.add(e.source),r.add(e.target);let i=[],a=[],o=new Map;for(let t of e){let e=No(t,r);o.set(t.alias,e),e===`flow`?i.push(t):a.push(t)}let s=new Set(i.map(e=>e.alias)),c=new Map(i.map(e=>[e.alias,e])),l=new Map,u=new Map,d=new Map;for(let e of i)l.set(e.alias,[]),u.set(e.alias,new Set),d.set(e.alias,0);for(let e of t??[])!s.has(e.source)||!s.has(e.target)||(l.get(e.source)?.push(e.target),u.get(e.source)?.add(e.target),u.get(e.target)?.add(e.source),d.set(e.target,(d.get(e.target)??0)+1));for(let e of l.values())e.sort();let f=i.filter(e=>d.get(e.alias)===0||e.types.includes(`entry_point`)||co(e)).map(e=>e.alias).sort(),p=new Set;{let e=new Map;for(let t of i)e.set(t.alias,0);function t(t){if(e.get(t)!==0)return;e.set(t,1);let n=[{node:t,childIdx:0}];for(;n.length>0;){let t=n[n.length-1],r=l.get(t.node)??[];if(t.childIdx>=r.length){e.set(t.node,2),n.pop();continue}let i=r[t.childIdx++],a=e.get(i);a===1?p.add(`${t.node}\t${i}`):a===0&&(e.set(i,1),n.push({node:i,childIdx:0}))}}for(let e of f)t(e);for(let e of[...s].sort())t(e)}let m=[],h=new Set;for(let e of Array.from(s).sort()){if(h.has(e))continue;let t=[],n=[e];for(h.add(e);n.length>0;){let e=n.pop();t.push(e);for(let t of u.get(e)??[])h.has(t)||(h.add(t),n.push(t))}t.sort();let r=t.map(e=>c.get(e)).filter(e=>!!e);m.push({aliases:t,nodes:r,hasRoot:r.some(co),hasEnd:r.some(lo),sortKey:t[0]??``})}m.sort(fo);let g=new Map;m.forEach((e,t)=>{e.aliases.forEach(e=>g.set(e,t))});let _=m.map(()=>[]);for(let e of t){let t=g.get(e.source),n=g.get(e.target);t!==void 0&&t===n&&_[t].push(e)}let v=new Map,y=new Map,b=0,x=0;for(let[e,t]of m.entries()){let r=new Set(t.aliases),i=t.nodes.filter(e=>d.get(e.alias)===0||e.types.includes(`entry_point`)||co(e)).map(e=>e.alias).sort();i.length===0&&t.aliases.length>0&&i.push(t.aliases[0]);let a=new Map,o=[...i];i.forEach(e=>a.set(e,0));let s=0;for(;s<o.length;){let e=o[s++],t=a.get(e)??0;for(let n of l.get(e)??[])r.has(n)&&(p.has(`${e}\t${n}`)||(!a.has(n)||a.get(n)<=t)&&(a.set(n,t+1),o.push(n)))}let c=a.size>0?Math.max(...a.values()):0;for(let e of t.aliases)a.has(e)||a.set(e,c+1);let u=Ao(a,_[e],p,n),f=x;for(let[e,t]of[...u].sort(([e],[t])=>e-t)){let n=-(t.reduce((e,t)=>e+t.height,0)+Math.max(0,t.length-1)*Oa)/2,r=b+e,i=x+e*360;f=Math.max(f,i);for(let e of t)e.alias&&(v.set(e.alias,r),y.set(e.alias,{x:i,y:n})),n+=e.height+Oa}let m=a.size>0?Math.max(...a.values()):0;b+=m+1,x=f+Ta+ka}Mo(y,v,t,n);let S=0;for(let[e,t]of y)S=Math.max(S,t.y+(n.get(e)??Ea));let C=S+(y.size>0?Aa:0),w=new Map;for(let e of oo)w.set(e,[]);w.set(`__unknown__`,[]);for(let e of a){let t=o.get(e.alias);w.get(t).push(e.alias)}for(let e of[...oo,`__unknown__`]){let t=(w.get(e)??[]).slice().sort();if(t.length===0)continue;let r=t.reduce((e,t)=>Math.max(e,n.get(t)??Ea),0);t.forEach((e,t)=>{y.set(e,{x:0+t*360,y:C})}),C+=r+ja}return{positions:y,levelOf:v}}function Fo(e,t,n){let r=new Map,i=new Map;for(let e of t)r.set(e.source,(r.get(e.source)??0)+1),i.set(e.target,(i.get(e.target)??0)+1);return new Map(e.map(e=>{let t=Qa(Math.max(r.get(e.alias)??0,i.get(e.alias)??0),n?Da:Ea);return[e.alias,n?t:Math.max(t,io(e))]}))}function Io(e,t,n={}){let r=e.connections??[],i=Fo(e.nodes,r,n.compactNodes===!0);for(let[e,n]of t)i.has(e)&&Number.isFinite(n)&&n>0&&i.set(e,n);return Po(e.nodes,r,i).positions}function Lo(e,t={}){let n=e.connections??[],r=t.supportsConnectionAuthoring===!0,i=t.compactNodes===!0,a=Fo(e.nodes,n,i),{positions:o,levelOf:s}=Po(e.nodes,n,a),c=new Set;for(let[e,t]of n.entries()){let n=s.get(t.source),r=s.get(t.target);n!==void 0&&r!==void 0&&n>=r&&c.add(e)}let l=new Map,u=new Map;for(let t of e.nodes)l.set(t.alias,[]),u.set(t.alias,[]);for(let[e,t]of n.entries()){let n=yo(t);c.has(e)?(u.get(t.source).push({connIndex:e,peerAlias:t.target,isBack:!0,stableKey:n}),l.get(t.target).push({connIndex:e,peerAlias:t.source,isBack:!0,stableKey:n})):(l.get(t.source).push({connIndex:e,peerAlias:t.target,isBack:!1,stableKey:n}),u.get(t.target).push({connIndex:e,peerAlias:t.source,isBack:!1,stableKey:n}))}let d=e=>o.get(e)?.y??0,f=(e,t)=>d(e.peerAlias)-d(t.peerAlias)||e.peerAlias.localeCompare(t.peerAlias)||e.stableKey.localeCompare(t.stableKey)||e.connIndex-t.connIndex;for(let e of l.values())e.sort(f);for(let e of u.values())e.sort(f);let p=new Map,m=new Map,h=e.nodes.map(e=>{let t=l.get(e.alias)??[],n=u.get(e.alias)??[],s=Qa(Math.max(t.length,n.length),i?Da:Ea),c=Math.max(s,a.get(e.alias)??Ea),d=[],f=[],h=0,g=0;for(let e=0;e<t.length;e++){let n=t[e],r=Za(e,t.length);if(n.isBack){let e=Xa(g++);f.push({id:e,offset:r}),m.set(n.connIndex,e)}else{let e=qa(h++);d.push({id:e,offset:r}),p.set(n.connIndex,e)}}let _=[],v=[],y=0,b=0;for(let e=0;e<n.length;e++){let t=n[e],r=Za(e,n.length);if(t.isBack){let e=Ya(b++);v.push({id:e,offset:r}),p.set(t.connIndex,e)}else{let e=Ja(y++);_.push({id:e,offset:r}),m.set(t.connIndex,e)}}return{id:e.alias,type:e.types[0]??`default`,className:`nokey`,position:o.get(e.alias)??{x:0,y:0},width:Ta,...i?{height:c}:{initialHeight:c},style:{...fa(e.types[0]??`unknown`),minHeight:s},data:{alias:e.alias,nodeType:e.types[0]??`unknown`,properties:e.properties,sourceHandles:d,targetHandles:_,backSourceHandles:v,backTargetHandles:f,supportsConnectionAuthoring:r,compact:i,minHeight:s}}}),g=[];for(let[e,t]of n.entries()){let n=t.relations.map(e=>e.type),r=`${t.source}__${t.target}__${e}`,i=Ka(n);g.push({id:r,source:t.source,target:t.target,sourceHandle:p.get(e),targetHandle:m.get(e),label:n.join(`, `),type:`bezier`,markerEnd:{type:y.ArrowClosed,width:16,height:16,color:Ha},style:{stroke:Ha,strokeWidth:2},labelStyle:{fill:i,fontSize:10,fontWeight:700},labelBgStyle:{fill:Ua,fillOpacity:.94,stroke:`rgba(15, 23, 42, 0.16)`,strokeWidth:1},labelBgPadding:[5,2],labelBgBorderRadius:6,data:{relationTypes:n}})}return{nodes:h,edges:g}}var Ro=`application/x-minigraph-clipboard-item`;function zo(e){return e.includes(Ro)}function Bo(e,t){e.effectAllowed=`copy`,e.setData(Ro,t)}function Vo(e){let t=e?.getData(`application/x-minigraph-clipboard-item`)??``;return t.trim()?t:null}function Ho(e,t){return e.nodes.find(e=>e.alias===t)}function Uo(e,t){return(e.connections??[]).filter(e=>e.source!==e.target&&(e.source===t||e.target===t))}var Wo={toolbar:`_toolbar_19yq4_2`,nameGroup:`_nameGroup_19yq4_17`,graphName:`_graphName_19yq4_24`,stats:`_stats_19yq4_33`,toolbarActions:`_toolbarActions_19yq4_53`,toolbarButton:`_toolbarButton_19yq4_59`};function Go({graphData:e,graphName:t,onCopySuccess:n,onCopyError:r,extraActions:i}){let a=(0,M.useCallback)(()=>{e&&navigator.clipboard.writeText(JSON.stringify(e,null,2)).then(()=>n?.()).catch(()=>r?.())},[e,n,r]),o=e?.nodes.length??0,s=(e?.connections??[]).length;return(0,I.jsxs)(`div`,{className:Wo.toolbar,children:[(0,I.jsxs)(`div`,{className:Wo.nameGroup,children:[(0,I.jsx)(`span`,{className:Wo.graphName,children:t??`Untitled`}),(0,I.jsxs)(`span`,{className:Wo.stats,children:[o,` node`,o===1?``:`s`,` · `,s,` connection`,s===1?``:`s`]})]}),(0,I.jsxs)(`div`,{className:Wo.toolbarActions,children:[i,(0,I.jsx)(`button`,{className:Wo.toolbarButton,onClick:a,title:`Copy raw graph JSON to clipboard`,"aria-label":`Copy raw graph JSON to clipboard`,children:`📑`})]})]})}var Ko={menu:`_menu_13qxg_1`,menuItem:`_menuItem_13qxg_12`};function qo({open:e,x:t,y:n,canCreateNode:r,onCreateNode:i,onClose:a}){let o=(0,M.useRef)(null),s=(0,M.useRef)(null);return(0,M.useEffect)(()=>{if(!e)return;s.current?.focus();let t=e=>{o.current&&!o.current.contains(e.target)&&a()},n=e=>{e.key===`Escape`&&(e.preventDefault(),a())};return document.addEventListener(`pointerdown`,t),document.addEventListener(`keydown`,n),()=>{document.removeEventListener(`pointerdown`,t),document.removeEventListener(`keydown`,n)}},[e,a]),e?(0,I.jsx)(`div`,{ref:o,className:Ko.menu,style:{left:t,top:n},role:`menu`,"aria-label":`Graph actions`,children:(0,I.jsx)(`button`,{ref:s,role:`menuitem`,type:`button`,className:Ko.menuItem,disabled:!r,onClick:()=>{r&&(i(),a())},children:`Create Node`})}):null}var Jo={menu:`_menu_1trgd_1`,menuItem:`_menuItem_1trgd_12`,dangerItem:`_dangerItem_1trgd_38`,confirmation:`_confirmation_1trgd_51`,confirmationText:`_confirmationText_1trgd_57`,confirmationActions:`_confirmationActions_1trgd_65`},Yo=8;function Xo(e){let{open:t,x:n,y:r,onClose:i}=e,[a,o]=(0,M.useState)(!1),[s,c]=(0,M.useState)({left:n,top:r}),l=(0,M.useRef)(null),u=(0,M.useRef)(null),d=(0,M.useRef)(null),f=e.mode===`multi-node`?e.selectedCount:null,p=f!==null&&f>1,m=e.mode===`multi-node`?p&&e.canClipSelectedNodes:e.canClipNode,h=e.mode===`single-node`&&e.canEditNode,g=e.mode===`multi-node`?p&&e.canDeleteSelectedNodes:e.canDeleteNode,_=m||h||g,v=p?`${f} selected nodes`:e.mode===`single-node`?e.nodeAlias:``;return(0,M.useLayoutEffect)(()=>{t&&o(!1)},[t,v,n,r]),(0,M.useLayoutEffect)(()=>{if(!t)return;let e=l.current;if(!e){c({left:n,top:r});return}let i=e.getBoundingClientRect(),a=Math.max(Yo,window.innerWidth-i.width-Yo),o=Math.max(Yo,window.innerHeight-i.height-Yo);c({left:Math.min(Math.max(n,Yo),a),top:Math.min(Math.max(r,Yo),o)})},[m,g,h,a,t,v,n,r]),(0,M.useEffect)(()=>{if(!t){o(!1);return}a?d.current?.focus():u.current?.focus()},[a,t]),(0,M.useEffect)(()=>{if(!t)return;let e=e=>{l.current&&!l.current.contains(e.target)&&i()},n=e=>{e.key===`Escape`&&(e.preventDefault(),i())},r=()=>i();return document.addEventListener(`pointerdown`,e),document.addEventListener(`keydown`,n),window.addEventListener(`scroll`,r,!0),window.addEventListener(`resize`,r),()=>{document.removeEventListener(`pointerdown`,e),document.removeEventListener(`keydown`,n),window.removeEventListener(`scroll`,r,!0),window.removeEventListener(`resize`,r)}},[i,t]),!t||!_?null:(0,I.jsx)(`div`,{ref:l,className:Jo.menu,style:{left:s.left,top:s.top},role:`menu`,"aria-label":p?`Actions for ${f} selected nodes`:`Node actions for ${v}`,children:a?(0,I.jsxs)(`div`,{className:Jo.confirmation,role:`group`,"aria-label":`Confirm delete ${v}`,children:[(0,I.jsx)(`div`,{className:Jo.confirmationText,children:p?`Delete ${f} selected nodes?`:`Delete "${v}"?`}),(0,I.jsxs)(`div`,{className:Jo.confirmationActions,children:[(0,I.jsx)(`button`,{ref:d,type:`button`,className:`${Jo.menuItem} ${Jo.dangerItem}`,onClick:()=>{e.mode===`multi-node`?e.onDeleteSelectedNodes():e.onDeleteNode(),i()},children:`Delete`}),(0,I.jsx)(`button`,{type:`button`,className:Jo.menuItem,onClick:()=>o(!1),children:`Cancel`})]})]}):(0,I.jsxs)(I.Fragment,{children:[m&&(0,I.jsx)(`button`,{ref:u,role:`menuitem`,type:`button`,className:Jo.menuItem,onClick:()=>{e.mode===`multi-node`?e.onClipSelectedNodes():e.onClipNode(),i()},children:p?`Clip ${f} selected nodes to Workspace`:`Clip to Workspace`}),h&&e.mode===`single-node`&&(0,I.jsx)(`button`,{ref:m?void 0:u,role:`menuitem`,type:`button`,className:Jo.menuItem,onClick:()=>{e.onEditNode(),i()},children:`Edit Node`}),g&&(0,I.jsx)(`button`,{ref:!m&&!h?u:void 0,role:`menuitem`,type:`button`,className:`${Jo.menuItem} ${Jo.dangerItem}`,onClick:()=>o(!0),children:p?`Delete ${f} selected nodes`:`Delete Node`})]})})}var Zo={tip:`_tip_a9o1b_1`,fading:`_fading_a9o1b_11`,tipButton:`_tipButton_a9o1b_15`};function Qo({visible:e,fading:t,onDismiss:n}){return e?(0,I.jsx)(`div`,{className:`${Zo.tip}${t?` ${Zo.fading}`:``}`,role:`status`,children:(0,I.jsx)(`button`,{type:`button`,className:Zo.tipButton,onClick:n,children:`Multi-select: Shift/Ctrl/Cmd + click nodes, or Shift + drag on the canvas.`})}):null}function $o(e){return e.trim().toLowerCase()}function es(e){let t=new Set;return e.filter(e=>{let n=$o(e);return t.has(n)?!1:(t.add(n),!0)})}function ts(e,t){let n=es(t),r=$o(e);return n.length>1&&n.some(e=>$o(e)===r)?{kind:`multi-node`,aliases:n}:{kind:`single-node`,alias:e}}function ns(e,t){let n=new Map(t.nodes.map(e=>[$o(e.alias),e]));return es(e).map(e=>n.get($o(e))).filter(e=>e!==void 0)}var rs=[],is=[],as=[`Shift`,`Control`,`Meta`];function os(e,t){return e.length===t.length&&e.every((e,n)=>e===t[n])}function ss({graphData:e,graphName:t,onCopySuccess:n,onCopyError:r,onRenderError:i,isRefreshing:a=!1,onClipNode:o,onClipNodes:s,onClipboardDrop:l,isConnected:m,supportsAuthoring:h=!1,onCreateNode:y,onCreateConnection:b,onEditNode:x,onDeleteNode:S,onDeleteNodes:C}){let[w,ee]=(0,M.useState)(null),[te,T]=(0,M.useState)(null),[E,ne]=(0,M.useState)([]),[re,D]=(0,M.useState)(!1),[ie,ae]=(0,M.useState)(!1),[oe,se]=(0,M.useState)(!1),O=(0,M.useRef)(0),k=(0,M.useRef)(!1),A=(0,M.useRef)(null),ce=!!(h&&y&&m),le=!!(h&&b&&m),ue=!!o,de=!!s,j=!!(h&&x&&m),fe=!!(h&&S&&m),pe=!!(h&&C&&m),me=ue||j||fe,he=de||pe,ge=me||he,_e=!!(l&&m),ve=(0,M.useCallback)(()=>{O.current=0,D(!1)},[]);(0,M.useEffect)(()=>{if(!te)return;let e=e=>{e.key===`Escape`&&T(null)},t=()=>T(null);return document.addEventListener(`keydown`,e),window.addEventListener(`scroll`,t,!0),window.addEventListener(`resize`,t),()=>{document.removeEventListener(`keydown`,e),window.removeEventListener(`scroll`,t,!0),window.removeEventListener(`resize`,t)}},[te]),(0,M.useEffect)(()=>{let e=()=>ve();return window.addEventListener(`dragend`,e),window.addEventListener(`drop`,e),()=>{window.removeEventListener(`dragend`,e),window.removeEventListener(`drop`,e),ve()}},[ve]);let ye=(0,M.useRef)(i);(0,M.useEffect)(()=>{ye.current=i},[i]);let[be,xe]=mr(`graph-nodes-compact`,!1),{nodes:Se,edges:Ce,transformError:we}=(0,M.useMemo)(()=>{if(!e)return{nodes:rs,edges:is,transformError:null};try{return{...Lo(e,{supportsConnectionAuthoring:le,compactNodes:be}),transformError:null}}catch(e){return{nodes:rs,edges:is,transformError:e instanceof Error?e.message:String(e)}}},[le,be,e]);(0,M.useEffect)(()=>{we&&ye.current?.(`Graph render failed: ${we}`)},[we]);let Te=(0,M.useMemo)(()=>e?JSON.stringify(e.nodes.map(e=>e.alias)):`empty`,[e]),[Ee,De,Oe]=f(Se),[ke,Ae,je]=c(Ce),Me=(0,M.useRef)(null),Ne=!!(e&&e.nodes.length>0),Pe=(0,M.useCallback)(({nodes:e})=>{let t=e.map(e=>e.data.alias);ne(e=>os(e,t)?e:t)},[]);(0,M.useEffect)(()=>{De(Se),Ae(Ce),ne([]),ee(null)},[Se,Ce,De,Ae]);let Fe=(0,M.useRef)(null),Ie=(0,M.useRef)(null);(0,M.useEffect)(()=>{if(!e||e.nodes.length===0)return;let t=Ie.current;if(t&&t.graph===e&&t.compact===be)return;let n=new Map(e.nodes.map(e=>[e.alias,e.properties]));if(!(Ee.length===n.size&&Ee.every(e=>n.get(e.id)===e.data.properties&&e.data.compact===be)))return;let r=new Map;for(let e of Ee){let t=e.measured?.height;if(typeof t!=`number`)return;r.set(e.id,t)}Ie.current={graph:e,compact:be};let i=Io(e,r,{compactNodes:be});Ee.some(e=>{let t=i.get(e.id);return t!==void 0&&(t.x!==e.position.x||t.y!==e.position.y)})&&De(e=>e.map(e=>{let t=i.get(e.id);return t?{...e,position:t}:e})),requestAnimationFrame(()=>{Fe.current?.fitView({padding:.25})})},[be,e,Ee,De]);let Le=(0,M.useCallback)(()=>{!ie||oe||(se(!0),A.current!==null&&clearTimeout(A.current),A.current=setTimeout(()=>{ae(!1),A.current=null},400))},[oe,ie]);(0,M.useEffect)(()=>{!Ne||we||k.current||(k.current=!0,se(!1),ae(!0))},[Ne,we]),(0,M.useEffect)(()=>{if(!ie||oe)return;let e=setTimeout(Le,5e3);return()=>clearTimeout(e)},[Le,oe,ie]),(0,M.useEffect)(()=>()=>{A.current!==null&&clearTimeout(A.current)},[]);let Re=e=>{_e&&zo(Array.from(e.dataTransfer.types))&&(e.preventDefault(),O.current+=1,D(!0))},ze=e=>{_e&&zo(Array.from(e.dataTransfer.types))&&(e.preventDefault(),e.dataTransfer.dropEffect=`copy`,D(!0))},Be=e=>{zo(Array.from(e.dataTransfer.types))&&(O.current=Math.max(0,O.current-1),O.current===0&&D(!1))},Ve=e=>{if(!_e||!zo(Array.from(e.dataTransfer.types)))return;e.preventDefault();let t=Vo(e.dataTransfer);ve(),t&&l?.(t)},He=(0,M.useMemo)(()=>new Set(e?.nodes.map(e=>e.alias)??[]),[e]),N=w?.target.kind===`single-node`&&e?Ho(e,w.target.alias):null,Ue=w?.target.kind===`multi-node`?w.target.aliases:[],P=e?ns(Ue,e):[],We=(0,M.useCallback)(e=>!le||!e.source||!e.target||e.source===e.target||!He.has(e.source)||!He.has(e.target)?!1:e.sourceHandle===`authoring-source`&&e.targetHandle===`authoring-target`,[le,He]),Ge=(0,M.useCallback)(e=>{We(e)&&(!e.source||!e.target||b?.(e.source,e.target))},[We,b]),Ke=(0,M.useCallback)((e,t)=>{t.handleId!==`authoring-source`||t.handleType!==`source`||(Me.current=t.nodeId,ee(null),T(null))},[]),qe=(0,M.useCallback)(()=>{Me.current=null},[]);return we?(0,I.jsxs)(`div`,{className:ya.empty,children:[(0,I.jsx)(`span`,{className:ya.emptyIcon,children:`⚠️`}),(0,I.jsx)(`span`,{children:`Graph could not be rendered.`}),(0,I.jsx)(`span`,{children:we})]}):(0,I.jsx)(ba,{onRenderError:i,children:(0,I.jsxs)(`div`,{className:ya.graphWrapper,"aria-busy":a,children:[Ne&&e&&(0,I.jsx)(Go,{graphData:e,graphName:t,onCopySuccess:n,onCopyError:r}),(0,I.jsxs)(`div`,{className:ya.graphSurface,onDragEnter:Re,onDragOver:ze,onDragLeave:Be,onDrop:Ve,onWheelCapture:Le,children:[Ne?(0,I.jsxs)(_,{nodes:Ee,edges:ke,onInit:e=>{Fe.current=e},onNodesChange:Oe,onEdgesChange:je,nodesConnectable:le,edgesReconnectable:!1,connectOnClick:!1,isValidConnection:We,onConnect:Ge,onConnectStart:Ke,onConnectEnd:qe,nodeTypes:va,fitView:!0,fitViewOptions:{padding:.25},minZoom:.2,maxZoom:2.5,selectionKeyCode:`Shift`,multiSelectionKeyCode:as,selectionOnDrag:!1,selectionMode:u.Partial,proOptions:{hideAttribution:!1},onSelectionChange:Pe,onNodeContextMenu:(e,t)=>{if(e.preventDefault(),e.stopPropagation(),Le(),T(null),!ge)return;let n=ts(t.data.alias,E);n.kind===`single-node`&&E.length>1&&(De(e=>e.map(e=>({...e,selected:e.data.alias===t.data.alias}))),ne([t.data.alias])),ee({x:e.clientX,y:e.clientY,target:n})},onPaneContextMenu:e=>{e.preventDefault(),Le(),ee(null),ce&&T({x:e.clientX,y:e.clientY})},onPaneClick:()=>{Le(),ee(null),T(null)},onNodeClick:()=>Le(),onNodeDragStart:()=>Le(),onSelectionStart:()=>Le(),onMoveStart:e=>{e&&Le()},children:[(0,I.jsx)(v,{variant:p.Dots,gap:18,size:1,color:`rgba(255,255,255,0.07)`}),(0,I.jsx)(d,{showInteractive:!1,children:(0,I.jsx)(g,{onClick:()=>xe(e=>!e),title:be?`Show node details`:`Show thumbnail nodes`,"aria-label":be?`Show node details`:`Show thumbnail nodes`,"aria-pressed":be,children:(0,I.jsxs)(`span`,{className:ya.detailToggleIcon,"aria-hidden":`true`,children:[(0,I.jsx)(`span`,{className:ya.detailToggleHeader}),be&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`span`,{className:ya.detailToggleLine}),(0,I.jsx)(`span`,{className:ya.detailToggleLine}),(0,I.jsx)(`span`,{className:ya.detailToggleLine})]})]})})})]}):(0,I.jsxs)(`div`,{className:ya.empty,children:[(0,I.jsx)(`span`,{className:ya.emptyIcon,children:`🕸️`}),(0,I.jsx)(`span`,{children:`No graph data yet.`}),(0,I.jsxs)(`span`,{children:[`Run `,(0,I.jsx)(`strong`,{children:`describe graph`}),` or `,(0,I.jsx)(`strong`,{children:`export graph`}),` in the playground.`]}),h&&y&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`button`,{type:`button`,className:ya.emptyCreateButton,disabled:!m,onClick:()=>y(`empty-graph`),children:`Create Node`}),!m&&(0,I.jsx)(`span`,{className:ya.emptyHint,children:`Connect WebSocket to create a node.`})]})]}),(0,I.jsx)(Qo,{visible:ie,fading:oe,onDismiss:Le}),a&&(0,I.jsx)(`div`,{className:ya.refreshingOverlay,children:(0,I.jsx)(`div`,{className:ya.refreshingSpinner,role:`status`,"aria-label":`Graph refreshing`})}),re&&(0,I.jsx)(`div`,{className:ya.clipboardDropOverlay,children:(0,I.jsx)(`div`,{className:ya.clipboardDropMessage,children:`Drop to paste workspace node`})}),(0,I.jsx)(qo,{open:te!==null,x:te?.x??0,y:te?.y??0,canCreateNode:ce,onCreateNode:()=>y?.(`pane-context-menu`),onClose:()=>T(null)}),w?.target.kind===`multi-node`?(0,I.jsx)(Xo,{mode:`multi-node`,open:P.length>1&&he,x:w.x,y:w.y,selectedCount:Ue.length,canClipSelectedNodes:de,canDeleteSelectedNodes:pe,onClipSelectedNodes:()=>{if(!e){s?.([]);return}let t=P.map(t=>({node:t,connections:Uo(e,t.alias)}));s?.(t)},onDeleteSelectedNodes:()=>{let e=P.length===Ue.length;C?.(e?P:[])},onClose:()=>ee(null)}):(0,I.jsx)(Xo,{mode:`single-node`,open:w!==null&&N!==null&&me,x:w?.x??0,y:w?.y??0,nodeAlias:w?.target.kind===`single-node`?w.target.alias:``,canClipNode:ue&&N!==null,canEditNode:j&&N!==null,canDeleteNode:fe&&N!==null,onClipNode:()=>{if(!N||!e)return;let t=Uo(e,N.alias);o?.(N,t)},onEditNode:()=>{N&&x?.(N)},onDeleteNode:()=>{N&&S?.(N)},onClose:()=>ee(null)})]})]})},Te)}var cs={root:`_root_1yhjs_2`,empty:`_empty_1yhjs_10`,emptyIcon:`_emptyIcon_1yhjs_23`,toolbarButton:`_toolbarButton_1yhjs_29 _toolbarButton_19yq4_59`,scrollBody:`_scrollBody_1yhjs_34`,jsonContainer:`_jsonContainer_1yhjs_45`,jsonLabel:`_jsonLabel_1yhjs_46`,jsonString:`_jsonString_1yhjs_47`,jsonNumber:`_jsonNumber_1yhjs_48`,jsonBoolean:`_jsonBoolean_1yhjs_49`,jsonNull:`_jsonNull_1yhjs_50`},ls={default:e=>e<3,all:i,none:a};function us({graphData:e,graphName:t,onCopySuccess:n,onCopyError:i}){let[a,s]=(0,M.useState)(`all`);return e?(0,I.jsxs)(`div`,{className:cs.root,children:[(0,I.jsx)(Go,{graphData:e,graphName:t,onCopySuccess:n,onCopyError:i,extraActions:(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`button`,{className:cs.toolbarButton,onClick:()=>s(`all`),title:`Expand all nodes`,"aria-label":`Expand all JSON nodes`,"aria-pressed":a===`all`,children:`➖`}),(0,I.jsx)(`button`,{className:cs.toolbarButton,onClick:()=>s(`none`),title:`Collapse all nodes`,"aria-label":`Collapse all JSON nodes`,"aria-pressed":a===`none`,children:`➕`})]})}),(0,I.jsx)(`div`,{className:cs.scrollBody,children:(0,I.jsx)(o,{data:e,shouldExpandNode:ls[a],style:{...r,container:`${r.container} ${cs.jsonContainer}`,label:cs.jsonLabel,stringValue:cs.jsonString,numberValue:cs.jsonNumber,booleanValue:cs.jsonBoolean,nullValue:cs.jsonNull}})})]}):(0,I.jsx)(`div`,{className:cs.root,children:(0,I.jsxs)(`div`,{className:cs.empty,children:[(0,I.jsx)(`span`,{className:cs.emptyIcon,children:`🕸️`}),(0,I.jsx)(`span`,{children:`No graph data yet.`}),(0,I.jsx)(`span`,{children:`Pin a graph-link message in the Console to load the raw data here.`})]})})}var ds={rightPanel:`_rightPanel_xa3j1_2`,tabStrip:`_tabStrip_xa3j1_10`,tab:`_tab_xa3j1_10`,tabActive:`_tabActive_xa3j1_41`,tabBadge:`_tabBadge_xa3j1_45`,tabBody:`_tabBody_xa3j1_51`,tabBodyHidden:`_tabBodyHidden_xa3j1_64`,graphContent:`_graphContent_xa3j1_68`,rightPanelGroup:`_rightPanelGroup_xa3j1_75`,verticalResizeHandle:`_verticalResizeHandle_xa3j1_83`},fs=`help-split-percent`,ps=`help-split-maximized`,ms=45,hs=98;function gs({tabs:e,payload:t,onChange:n,validation:r,onFormat:i,onUpload:a,graphData:o,graphName:s,activeTab:c,onTabChange:l,onGraphRenderError:u,onGraphDataCopySuccess:d,onGraphDataCopyError:f,isGraphRefreshing:p,onClipNode:m,onClipNodes:h,onClipboardDrop:g,isConnected:_,supportsAuthoring:v,onCreateNode:y,onCreateConnection:b,onEditNode:x,onDeleteNode:S,onDeleteNodes:ee,helpPanel:T}){let E=(0,M.useId)(),ne=`${E}-tab-payload`,re=`${E}-tab-graph`,D=`${E}-tab-graph-data`,ie=(0,I.jsxs)(`div`,{className:ds.rightPanel,children:[(0,I.jsxs)(`div`,{className:ds.tabStrip,role:`tablist`,"aria-label":`Right panel tabs`,children:[e.includes(`payload`)&&(0,I.jsx)(`button`,{role:`tab`,"aria-selected":c===`payload`,"aria-controls":ne,className:`${ds.tab}${c===`payload`?` ${ds.tabActive}`:``}`,onClick:()=>l(`payload`),children:`Payload Editor`}),e.includes(`graph`)&&(0,I.jsxs)(`button`,{role:`tab`,"aria-selected":c===`graph`,"aria-controls":re,className:`${ds.tab}${c===`graph`?` ${ds.tabActive}`:``}`,onClick:()=>l(`graph`),children:[`Graph`,o!==null&&(0,I.jsx)(`span`,{className:ds.tabBadge,"aria-label":`Graph data available`,children:`🕸️`})]}),e.includes(`graph-data`)&&(0,I.jsx)(`button`,{role:`tab`,"aria-selected":c===`graph-data`,"aria-controls":D,className:`${ds.tab}${c===`graph-data`?` ${ds.tabActive}`:``}`,onClick:()=>l(`graph-data`),children:`Graph Data (Raw)`})]}),e.includes(`payload`)&&(0,I.jsx)(`div`,{role:`tabpanel`,id:ne,tabIndex:c===`payload`?0:-1,className:`${ds.tabBody}${c===`payload`?``:` ${ds.tabBodyHidden}`}`,children:(0,I.jsx)(aa,{payload:t,onChange:n,validation:r,onFormat:i,onUpload:a})}),e.includes(`graph`)&&(0,I.jsx)(`div`,{role:`tabpanel`,id:re,tabIndex:c===`graph`?0:-1,className:`${ds.tabBody}${c===`graph`?``:` ${ds.tabBodyHidden}`}`,children:(0,I.jsx)(`div`,{className:ds.graphContent,children:(0,I.jsx)(ss,{graphData:o,graphName:s,onRenderError:u,isRefreshing:p,onCopySuccess:d,onCopyError:f,onClipNode:m,onClipNodes:h,onClipboardDrop:g,isConnected:_,supportsAuthoring:v,onCreateNode:y,onCreateConnection:b,onEditNode:x,onDeleteNode:S,onDeleteNodes:ee})})}),e.includes(`graph-data`)&&(0,I.jsx)(`div`,{role:`tabpanel`,id:D,tabIndex:c===`graph-data`?0:-1,className:`${ds.tabBody}${c===`graph-data`?``:` ${ds.tabBodyHidden}`}`,children:(0,I.jsx)(us,{graphData:o,graphName:s,onCopySuccess:d,onCopyError:f})})]}),ae=(0,M.useRef)(Number(sessionStorage.getItem(fs))||ms),oe=(0,M.useRef)(null),se=(0,M.useRef)(null),[O,k]=(0,M.useState)(()=>sessionStorage.getItem(ps)===`1`),A=(0,M.useRef)(O),ce=(0,M.useCallback)(e=>{let t=e[`help-split-help`];if(t===void 0)return;let n=t>=hs;n!==A.current&&(A.current=n,k(n),sessionStorage.setItem(ps,n?`1`:`0`)),n||(ae.current=t,sessionStorage.setItem(fs,String(t)))},[]),le=(0,M.useCallback)(()=>{let e=!A.current;if(A.current=e,k(e),sessionStorage.setItem(ps,e?`1`:`0`),e)se.current?.resize(`0%`),oe.current?.resize(`100%`);else{let e=ae.current;oe.current?.resize(`${e}%`),se.current?.resize(`${100-e}%`)}},[]),ue=!!T;if((0,M.useEffect)(()=>{ue&&A.current&&requestAnimationFrame(()=>{se.current?.resize(`0%`),oe.current?.resize(`100%`)})},[ue]),!T)return ie;let de=typeof T==`function`?T(le,O):T,j=A.current?100:ae.current,fe=100-j;return(0,I.jsxs)(te,{orientation:`vertical`,className:ds.rightPanelGroup,onLayoutChanged:ce,children:[(0,I.jsx)(w,{panelRef:se,defaultSize:`${fe}%`,minSize:`0%`,children:ie}),(0,I.jsx)(C,{className:ds.verticalResizeHandle,"aria-label":`Resize help panel`}),(0,I.jsx)(w,{id:`help-split-help`,panelRef:oe,defaultSize:`${j}%`,minSize:`15%`,children:de})]})}var _s=class extends M.Component{constructor(...e){super(...e),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(e,t){console.error(`[ConsoleErrorBoundary] Failed to render message:`,e,t.componentStack)}render(){return this.state.hasError?(0,I.jsx)(`span`,{children:this.props.fallback}):this.props.children}},vs=2e3,ys=(e={})=>{let{onSuccess:t,onError:n}=e,[r,i]=(0,M.useState)(!1),a=(0,M.useRef)(null);return(0,M.useEffect)(()=>()=>{a.current!==null&&clearTimeout(a.current)},[]),{copy:(0,M.useCallback)(async e=>{if(!navigator.clipboard)return console.warn(`useCopyToClipboard: Clipboard API not available in this browser.`),n?.(),!1;try{return await navigator.clipboard.writeText(e),i(!0),a.current!==null&&clearTimeout(a.current),a.current=setTimeout(()=>{a.current=null,i(!1)},vs),t?.(),!0}catch(e){return console.error(`useCopyToClipboard: Failed to write to clipboard.`,e),n?.(),!1}},[t,n]),copied:r}},V={consoleRoot:`_consoleRoot_1lgp1_2`,consoleHeader:`_consoleHeader_1lgp1_10`,consoleTitle:`_consoleTitle_1lgp1_20`,consoleControls:`_consoleControls_1lgp1_25`,controlButton:`_controlButton_1lgp1_30`,console:`_console_1lgp1_2`,emptyConsole:`_emptyConsole_1lgp1_67`,consoleMessage:`_consoleMessage_1lgp1_80`,consoleMessageActivatable:`_consoleMessageActivatable_1lgp1_94`,consoleMessageGraphLink:`_consoleMessageGraphLink_1lgp1_104`,consoleMessageLargePayload:`_consoleMessageLargePayload_1lgp1_115`,consoleMessageMockUpload:`_consoleMessageMockUpload_1lgp1_122`,uploadMockButton:`_uploadMockButton_1lgp1_131`,copyButton:`_copyButton_1lgp1_172`,copyButtonCopied:`_copyButtonCopied_1lgp1_225`,sendToJsonPathButton:`_sendToJsonPathButton_1lgp1_234`,messageIcon:`_messageIcon_1lgp1_268`,messageContent:`_messageContent_1lgp1_272`,messageText:`_messageText_1lgp1_278`,messageTime:`_messageTime_1lgp1_283`,"messageType-error":`_messageType-error_1lgp1_290`,"messageType-info":`_messageType-info_1lgp1_291`,"messageType-welcome":`_messageType-welcome_1lgp1_292`,jsonViewWrapper:`_jsonViewWrapper_1lgp1_295`,jsonContainer:`_jsonContainer_1lgp1_301`,jsonLabel:`_jsonLabel_1lgp1_302`,jsonString:`_jsonString_1lgp1_303`,jsonNumber:`_jsonNumber_1lgp1_304`,jsonBoolean:`_jsonBoolean_1lgp1_305`,jsonNull:`_jsonNull_1lgp1_306`};function bs({message:e,msgId:t,classificationMap:n,onGraphLink:i,onCopyMessage:a,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l}){let u=wr(e),d=Tr(u.type),f=Er(u.message),p=(t===void 0?void 0:n?.get(t))??[],m=p.some(e=>e.kind===`graph.link`),h=p.some(e=>e.kind===`payload.large`),g=p.some(e=>e.kind===`upload.invitation`),_=p.find(e=>e.kind===`upload.invitation`)?.uploadPath??null,v=!!c&&g&&_!==null,y=v&&!!l?.has(_),b=!!i&&m&&!g&&!h,x=!!s&&f.isJSON,{copy:S,copied:C}=ys({onSuccess:a}),w=t=>{t.stopPropagation(),S(e)},ee=t=>{(t.key===`Enter`||t.key===` `)&&(t.preventDefault(),t.stopPropagation(),S(e))},te=e=>{e.stopPropagation(),!(!s||!f.isJSON)&&s(JSON.stringify(f.data,null,2))},T=e=>{e.stopPropagation(),!(!c||!_)&&c(_)};return(0,I.jsxs)(`div`,{className:[V.consoleMessage,V[`messageType-${u.type}`],b?V.consoleMessageActivatable:``,m?V.consoleMessageGraphLink:``,h?V.consoleMessageLargePayload:``,g?V.consoleMessageMockUpload:``].filter(Boolean).join(` `),onClick:b?()=>i():void 0,title:b?`Click to load graph in Graph View`:void 0,role:b?`button`:void 0,tabIndex:b?0:void 0,onKeyDown:b?e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),i())}:void 0,"aria-label":b?`Load graph in Graph View`:void 0,children:[(0,I.jsx)(`span`,{className:V.messageIcon,children:g?`⬆️`:h?`⬇️`:m?`🕸️`:d}),(0,I.jsx)(`div`,{className:V.messageContent,children:f.isJSON?(0,I.jsx)(`div`,{className:V.jsonViewWrapper,children:(0,I.jsx)(o,{data:f.data,shouldExpandNode:e=>e<1,style:{...r,container:`${r.container} ${V.jsonContainer}`,label:V.jsonLabel,stringValue:V.jsonString,numberValue:V.jsonNumber,booleanValue:V.jsonBoolean,nullValue:V.jsonNull}})}):(0,I.jsxs)(`span`,{className:V.messageText,children:[u.message,y&&(0,I.jsx)(`span`,{title:`Upload succeeded`,children:` ✅`})]})}),(0,I.jsx)(`button`,{className:`${V.copyButton} ${C?V.copyButtonCopied:``}`,onClick:w,onKeyDown:ee,title:C?`Copied!`:`Copy message`,"aria-label":C?`Copied to clipboard`:`Copy message to clipboard`,tabIndex:0,children:C?`✅`:`📄`}),x&&(0,I.jsx)(`button`,{className:V.sendToJsonPathButton,onClick:te,onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&te(e)},title:`Open in JSON-Path Playground`,"aria-label":`Open this JSON in the JSON-Path Playground`,tabIndex:0,children:`➡️`}),v&&(0,I.jsx)(`button`,{className:V.uploadMockButton,onClick:T,onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&T(e)},title:`Re-open upload dialog`,"aria-label":`Re-open mock data upload dialog`,tabIndex:0,children:`⬆️ Upload JSON…`}),u.time&&(0,I.jsx)(`span`,{className:V.messageTime,children:u.time})]})}function xs({messages:e,classificationMap:t,onCopy:n,onClear:r,consoleRef:i,onGraphLinkMessage:a,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l}){return(0,I.jsxs)(`div`,{className:V.consoleRoot,children:[(0,I.jsxs)(`div`,{className:V.consoleHeader,children:[(0,I.jsx)(`span`,{className:V.consoleTitle,children:`Console Output`}),(0,I.jsxs)(`div`,{className:V.consoleControls,children:[(0,I.jsx)(`button`,{className:V.controlButton,onClick:n,title:`Copy console output`,"aria-label":`Copy console output to clipboard`,children:`📑`}),(0,I.jsx)(`button`,{className:V.controlButton,onClick:r,title:`Clear console`,"aria-label":`Clear console`,children:`🗑️`})]})]}),(0,I.jsxs)(`div`,{className:V.console,ref:i,role:`log`,"aria-live":`polite`,children:[e.map(e=>(0,I.jsx)(_s,{fallback:e.raw,children:(0,I.jsx)(bs,{message:e.raw,msgId:e.id,classificationMap:t,onGraphLink:a?()=>a(e):void 0,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l})},e.id)),e.length===0&&(0,I.jsxs)(`div`,{className:V.emptyConsole,children:[`No messages yet. Use the `,(0,I.jsx)(`strong`,{children:`Start`}),` button in the header to connect.`]})]})]})}var H={commandInput:`_commandInput_188pe_2`,labelRow:`_labelRow_188pe_8`,labelGroup:`_labelGroup_188pe_16`,label:`_label_188pe_8`,infoWrapper:`_infoWrapper_188pe_28`,paletteToggle:`_paletteToggle_188pe_34`,paletteToggleActive:`_paletteToggleActive_188pe_66`,popover:`_popover_188pe_73`,popoverOpen:`_popoverOpen_188pe_95`,popoverTitle:`_popoverTitle_188pe_121`,popoverRow:`_popoverRow_188pe_135`,popoverKeyword:`_popoverKeyword_188pe_156`,popoverDesc:`_popoverDesc_188pe_168`,popoverAlias:`_popoverAlias_188pe_174`,inputRow:`_inputRow_188pe_181`,inputWrapper:`_inputWrapper_188pe_187`,textarea:`_textarea_188pe_197`,sendButton:`_sendButton_188pe_236`,hint:`_hint_188pe_253`,dropup:`_dropup_188pe_261`,dropupHeader:`_dropupHeader_188pe_276`,dropupItem:`_dropupItem_188pe_292`,dropupItemText:`_dropupItemText_188pe_315`,matchHighlight:`_matchHighlight_188pe_323`,multilineIndicator:`_multilineIndicator_188pe_329`},Ss=[`graph.data.mapper`,`graph.math`,`graph.js`,`graph.api.fetcher`,`graph.extension`,`graph.island`,`graph.join`],Cs=[{keyword:`help`,description:`List all help topics, or get help for a specific command`,template:`help`},{keyword:`create`,description:`Create a new graph node`,template:`create node {name}
with type {type}
with properties
