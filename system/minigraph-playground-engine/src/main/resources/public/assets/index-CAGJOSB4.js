...
</items>`};function _e(e){return`ws://${window.location.host}${e}`}var P=ne();function ve(e,t,n,r){let i=e[t]??{phase:`idle`,connectionEpoch:null,messages:[]},a=[...i.messages,{id:n,raw:r}];return a.length>200&&a.shift(),{...e,[t]:{...i,messages:a}}}function ye(e,t){let n=e[t.path]??{phase:`idle`,connectionEpoch:null,messages:[]};switch(t.type){case`CONNECTING`:return{...e,[t.path]:{...n,phase:`connecting`}};case`CONNECTED`:return ve({...e,[t.path]:{...n,phase:`connected`,connectionEpoch:t.id}},t.path,t.id,t.msg);case`MESSAGE_RECEIVED`:return ve(e,t.path,t.id,t.msg);case`DISCONNECTED`:return ve({...e,[t.path]:{...n,phase:`idle`}},t.path,t.id,t.msg);case`CONNECT_ERROR`:return{...e,[t.path]:{...n,phase:`idle`}};case`CLEAR_MESSAGES`:return{...e,[t.path]:{...n,messages:[]}};default:return e}}var be=(0,j.createContext)(null);function xe({children:e}){let[t,n]=(0,j.useReducer)(ye,{}),r=(0,j.useRef)({}),i=(0,j.useRef)({}),a=(0,j.useRef)({});(0,j.useEffect)(()=>()=>{Object.entries(r.current).forEach(([e,t])=>{t?.close();let n=i.current[e];n&&clearInterval(n)})},[]);let o=e=>_e(e),s=e=>(a.current[e]=(a.current[e]??0)+1,a.current[e]),c=()=>{let e=new Date().toString(),t=e.indexOf(`GMT`);return t>0?e.substring(0,t).trim():e},l=(e,t)=>JSON.stringify({type:e,message:t,time:c()}),u=e=>{try{let t=JSON.parse(e);if(typeof t==`object`&&t){let e=t.type;return e===`ping`||e===`pong`}}catch{}return!1},d=(0,j.useCallback)((e,t)=>{if(!window.WebSocket){t?.(`WebSocket not supported by your browser`,`error`);return}let a=r.current[e];if(a&&(a.readyState===WebSocket.OPEN||a.readyState===WebSocket.CONNECTING)){t?.(`Already connected`,`error`);return}n({type:`CONNECTING`,path:e});let c=new WebSocket(o(e));r.current[e]=c,c.onopen=()=>{n({type:`CONNECTED`,path:e,id:s(e),msg:l(`info`,`connected`)}),t?.(`Connected to WebSocket`,`success`),c.send(JSON.stringify({type:`welcome`})),i.current[e]=setInterval(()=>{c.readyState===WebSocket.OPEN&&c.send(l(`ping`,`keep alive`))},me)},c.onmessage=t=>{u(t.data)||n({type:`MESSAGE_RECEIVED`,path:e,id:s(e),msg:t.data})},c.onerror=()=>{n({type:`CONNECT_ERROR`,path:e})},c.onclose=a=>{let o=i.current[e];o&&(clearInterval(o),i.current[e]=null),n({type:`DISCONNECTED`,path:e,id:s(e),msg:l(`info`,`disconnected - (${a.code}) ${a.reason}`)}),t?.(`Disconnected from WebSocket`,`info`),r.current[e]===c&&(r.current[e]=null)}},[]),f=(0,j.useCallback)(e=>{let t=r.current[e];t?t.close():n({type:`MESSAGE_RECEIVED`,path:e,id:s(e),msg:l(`error`,`already disconnected`)})},[]);(0,j.useEffect)(()=>(he.forEach(e=>{d(e.wsPath)}),()=>{he.forEach(e=>{let t=r.current[e.wsPath];t&&t.close()})}),[]);let p=(0,j.useCallback)((e,t)=>{let n=r.current[e];return n&&n.readyState===WebSocket.OPEN?(n.send(t),!0):!1},[]),m=(0,j.useCallback)((e,t)=>{n({type:`MESSAGE_RECEIVED`,path:e,id:s(e),msg:t})},[]),h=(0,j.useCallback)(e=>{n({type:`CLEAR_MESSAGES`,path:e})},[]),[g,_]=(0,j.useState)({}),v=(0,j.useCallback)((e,t)=>{_(n=>{if(t===null){let t={...n};return delete t[e],t}return{...n,[e]:t}})},[]),y=(0,j.useCallback)(e=>g[e]??null,[g]),b=(0,j.useCallback)(e=>{let t=g[e]??null;return t!==null&&_(t=>{let n={...t};return delete n[e],n}),t},[g]),x=(0,j.useCallback)(e=>t[e]??{phase:`idle`,connectionEpoch:null,messages:[]},[t]),S=(0,j.useMemo)(()=>({getSlot:x,connect:d,disconnect:f,send:p,appendMessage:m,clearMessages:h,setPendingPayload:v,peekPendingPayload:y,takePendingPayload:b}),[x,d,f,p,m,h,v,y,b]);return(0,P.jsx)(be.Provider,{value:S,children:e})}function Se(){let e=(0,j.useContext)(be);if(!e)throw Error(`useWebSocketContext must be used inside <WebSocketProvider>`);return e}var Ce=e=>{try{let t=JSON.parse(e);return{type:t.type||`info`,message:t.message||e,time:t.time,raw:e}}catch{return{type:`raw`,message:e,time:null,raw:e}}},we=e=>({info:`ℹ️`,error:`❌`,ping:`🔄`,welcome:`👋`,raw:``})[e]??`•`,Te=e=>{try{let t=JSON.parse(e);if(typeof t==`object`&&t)return{isJSON:!0,data:t}}catch{}return{isJSON:!1,data:null}};function Ee(e){if(!e.includes(`Graph exported to `))return null;let t=ke(e);if(!t)return null;let n=t.split(`/`)[4];return n?{graphName:n,apiPath:t}:null}function De(e){return e.includes(`Invalid filename`)?{reason:`invalid-name`}:e.includes(`Expect root node name`)?{reason:`root-name-conflict`}:null}function Oe(e){let t=Te(e);return t.isJSON?(t.data.type,!1):!0}function ke(e){let t=e.match(/\/api\/graph\/model\/([^\s'"]+)/);return t?t[0]:null}function Ae(e){return Oe(e)?ke(e)!==null:!1}function je(e){let t=e.match(/\/api\/json\/content\/([\w-]+)/);return t?t[0]:null}function Me(e){let t=e.match(/Large payload \((\d+)\)\s*->\s*GET\s+(\/api\/inspect\/[^\s]+)/i);if(!t)return null;let n=parseInt(t[1],10),r=t[2];return{apiPath:r,byteSize:n,filename:`${r.split(`/`).filter(Boolean).pop()??`payload`}.json`}}function Ne(e){let t=e.match(/You may upload .*?->\s*POST\s+(\/api\/mock\/[\w-]+)/i);return t?t[1]:null}function Pe(e){if(!e.startsWith(`> `))return!1;let t=e.slice(2).trim().toLowerCase();return t===`help`||t.startsWith(`help `)?!0:t.startsWith(`describe `)?!t.slice(9).trim().startsWith(`graph`):!1}function Fe(e){if(!e.startsWith(`> `)||!e.slice(2).trimStart().toLowerCase().startsWith(`import graph from `))return null;let t=e.slice(2).trimStart().slice(18).trim();return t.length>0?t:null}var Ie=/^node ([A-Za-z0-9_-]+) created$/i,Le=/^node ([A-Za-z0-9_-]+) already exists$/i,Re=/^node ([A-Za-z0-9_-]+) updated$/i,ze=/^node ([A-Za-z0-9_-]+) deleted$/i,Be=/^node ([A-Za-z0-9_-]+) connected to ([A-Za-z0-9_-]+)$/i,Ve=/^node ([A-Za-z0-9_-]+) not found$/i,He=/^Source and target nodes must be different$/i,Ue=/^Syntax: connect \{node-A\} to \{node-B\} with \{relation\}$/i,We=/^ERROR: (.+)$/;function Ge(e){let t=e.trim();if(t.startsWith(`> `))return null;let n=t.match(Ie);if(n)return{status:`accepted`,action:`create-node`,alias:n[1],targetAlias:null,message:t};let r=t.match(Le);if(r)return{status:`rejected`,action:`create-node`,alias:r[1],targetAlias:null,message:t};let i=t.match(Re);if(i)return{status:`accepted`,action:`edit-node`,alias:i[1],targetAlias:null,message:t};let a=t.match(ze);if(a)return{status:`accepted`,action:`delete-node`,alias:a[1],targetAlias:null,message:t};let o=t.match(Be);if(o)return{status:`accepted`,action:`create-connection`,alias:o[1],targetAlias:o[2],message:t};let s=t.match(Ve);return s?{status:`rejected`,action:null,alias:s[1],targetAlias:null,message:t}:He.test(t)||Ue.test(t)?{status:`rejected`,action:`create-connection`,alias:null,targetAlias:null,message:t}:t.match(We)?{status:`error`,action:null,alias:null,targetAlias:null,message:t}:null}function Ke(e){if(!Oe(e)||e.startsWith(`> `)||Ae(e))return null;let t=e.toLowerCase();return t.includes(`graph model imported as draft`)?`import-graph`:t.includes(` -> `)&&t.includes(`removed`)||t.startsWith(`node `)&&(t.includes(` created`)||t.includes(` updated`)||t.includes(` deleted`)||t.includes(` connected to `)||t.includes(` imported from `)||t.includes(` overwritten by node from `))?`node-mutation`:null}var qe={command:``,historyIndex:-1,draftCommand:``};function Je(e,t){switch(t.type){case`SET_COMMAND`:return{...e,command:t.value,historyIndex:-1,draftCommand:``};case`CLEAR_COMMAND`:return{...e,command:``,historyIndex:-1,draftCommand:``};case`SET_HISTORY_INDEX`:return{...e,historyIndex:t.index,command:t.command};case`ENTER_HISTORY`:return{...e,historyIndex:0,command:t.command,draftCommand:e.command};case`EXIT_HISTORY`:return{...e,historyIndex:-1,command:e.draftCommand,draftCommand:``};default:return e}}function Ye({wsPath:e,storageKeyHistory:t,payload:n,addToast:r,bus:i,handleLocalCommand:a}){let o=Se(),{phase:s,connectionEpoch:c,messages:l}=o.getSlot(e),u=s===`connected`,d=s===`connecting`,[f,p]=(0,j.useReducer)(Je,qe),{command:m,historyIndex:h}=f,[g,_]=pe(t,[]),v=(0,j.useRef)(null),y=(0,j.useRef)(!1);(0,j.useEffect)(()=>{v.current&&(v.current.scrollTop=v.current.scrollHeight)},[l]);let b=(0,j.useCallback)(()=>{o.connect(e,r)},[o,e,r]),x=(0,j.useCallback)(()=>{o.disconnect(e)},[o,e]),S=(0,j.useCallback)(()=>{if(s!==`connected`)return;let t=m.trim();if(t.length!==0){if(a?.(t)===!0){g[0]!==t&&_(e=>[t,...e].slice(0,50)),o.appendMessage(e,`> `+t),p({type:`CLEAR_COMMAND`});return}o.send(e,t),g[0]!==t&&_(e=>[t,...e].slice(0,50)),t===`load`&&(n.length===0?o.appendMessage(e,`ERROR: please paste JSON/XML payload in input text area`):o.send(e,n)),p({type:`CLEAR_COMMAND`})}},[o,e,s,m,n,g,_,a]),C=(0,j.useCallback)(e=>{if(e.key===`ArrowUp`){if(e.preventDefault(),g.length===0)return;if(h===-1)p({type:`ENTER_HISTORY`,command:g[0]});else if(h<g.length-1){let e=h+1;p({type:`SET_HISTORY_INDEX`,index:e,command:g[e]})}}else if(e.key===`ArrowDown`)if(e.preventDefault(),h<=0)h===0&&p({type:`EXIT_HISTORY`});else{let e=h-1;p({type:`SET_HISTORY_INDEX`,index:e,command:g[e]})}},[g,h]);(0,j.useEffect)(()=>{if(i)return i.on(`upload.contentPath`,t=>{if(!y.current)return;if(y.current=!1,n.length===0){o.appendMessage(e,`ERROR: please paste JSON/XML payload in the input text area`);return}let i;try{i=JSON.stringify(JSON.parse(n))}catch{o.appendMessage(e,`ERROR: payload is not valid JSON — cannot upload`);return}fetch(t.uploadPath,{method:`POST`,headers:{"Content-Type":`application/json`},body:i}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);r(`Payload uploaded successfully`,`success`)}).catch(t=>{o.appendMessage(e,`ERROR: upload failed — ${t.message}`),r(`Upload failed: ${t.message}`,`error`)})})},[i,n,e,o,r]),(0,j.useEffect)(()=>{if(i||!y.current||l.length===0)return;let t=l[l.length-1].raw,a=je(t);if(!a)return;if(y.current=!1,n.length===0){o.appendMessage(e,`ERROR: please paste JSON/XML payload in the input text area`);return}let s;try{s=JSON.stringify(JSON.parse(n))}catch{o.appendMessage(e,`ERROR: payload is not valid JSON — cannot upload`);return}fetch(a,{method:`POST`,headers:{"Content-Type":`application/json`},body:s}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);r(`Payload uploaded successfully`,`success`)}).catch(t=>{o.appendMessage(e,`ERROR: upload failed — ${t.message}`),r(`Upload failed: ${t.message}`,`error`)})},[i,l,n,e,o,r]);let w=(0,j.useCallback)(()=>{if(s===`connected`){if(n.length===0){r(`Nothing to upload — paste a JSON payload first`,`error`);return}y.current=!0,o.send(e,`upload`)}},[o,e,s,n,r]),ee=(0,j.useCallback)(t=>s===`connected`&&o.send(e,t),[o,e,s]),te=(0,j.useCallback)(()=>{navigator.clipboard.writeText(l.map(e=>e.raw).join(`
`)),r(`Console copied to clipboard!`,`success`)},[l,r]),T=(0,j.useCallback)(()=>{o.clearMessages(e),r(`Console cleared`,`info`)},[o,e,r]),E=(0,j.useCallback)(t=>{o.appendMessage(e,t)},[o,e]);return{connected:u,connecting:d,connectionEpoch:c,messages:l,command:m,setCommand:(0,j.useCallback)(e=>p({type:`SET_COMMAND`,value:e}),[]),connect:b,disconnect:x,sendCommand:S,handleKeyDown:C,consoleRef:v,copyMessages:te,clearMessages:T,uploadPayload:w,sendRawText:ee,appendMessage:E,history:g}}function Xe(e){let[t,n]=(0,j.useState)(()=>window.matchMedia(e).matches);return(0,j.useEffect)(()=>{let t=window.matchMedia(e),r=e=>n(e.matches);return t.addEventListener(`change`,r),()=>t.removeEventListener(`change`,r)},[e]),t}function Ze(e){if(typeof e!=`object`||!e)return!1;let t=e;return Array.isArray(t.nodes)}function Qe(e,t,n){let r=t.includes(n)?n:t[0]??`graph`;return typeof e==`string`&&t.includes(e)?e:r}function $e(e){return Ze(e)&&e.nodes.length>0?e:null}function et(e,t,n,r,i){let[a,o]=(0,j.useState)(null),[s,c]=pe(i,n),l=Qe(s,r,n),[u,d]=(0,j.useState)(!1),f=(0,j.useCallback)(e=>{c(t=>{let i=Qe(t,r,n);return Qe(typeof e==`function`?e(i):e,r,n)})},[c,r,n]);(0,j.useEffect)(()=>{s!==l&&c(l)},[s,l,c]);let p=(0,j.useRef)(e);(0,j.useEffect)(()=>{p.current=e},[e]);let m=(0,j.useRef)(!1);(0,j.useEffect)(()=>{m.current=a!==null},[a]);let h=(0,j.useRef)(null);(0,j.useEffect)(()=>{if(!e){o(null);return}let t=new AbortController;return o(null),fetch(e,{signal:t.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{let t=$e(e);t&&(o(t),f(`graph`))}).catch(()=>{}),()=>{t.abort()}},[e]);let g=(0,j.useCallback)(()=>{let e=p.current;if(!e)return;h.current?.abort();let n=new AbortController;h.current=n,d(!0),fetch(e,{signal:n.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.json()}).then(e=>{let t=$e(e),n=t!==null&&!m.current;o(t),n&&f(`graph`),d(!1)}).catch(e=>{e.name!==`AbortError`&&(t(`Graph refresh failed: ${e.message}`,`error`),d(!1))})},[]);return(0,j.useEffect)(()=>()=>{h.current?.abort()},[]),{graphData:a,setGraphData:o,rightTab:l,setRightTab:f,isRefreshing:u,refetchGraph:g}}function tt({bus:e,hasGraph:t,connected:n,refetchGraph:r,clearGraph:i,addToast:a}){let o=(0,j.useRef)(null),s=(0,j.useRef)(t),c=(0,j.useRef)(n),l=(0,j.useRef)(r);(0,j.useEffect)(()=>{s.current=t},[t]),(0,j.useEffect)(()=>{c.current=n},[n]),(0,j.useEffect)(()=>{l.current=r},[r]),(0,j.useEffect)(()=>{!n&&o.current!==null&&(clearTimeout(o.current),o.current=null)},[n]),(0,j.useEffect)(()=>e.on(`graph.mutation`,e=>{if(c.current){if(e.mutationType===`import-graph`){o.current!==null&&(clearTimeout(o.current),o.current=null),l.current(),a(`Graph imported — refreshing view…`,`info`);return}o.current!==null&&clearTimeout(o.current),o.current=setTimeout(()=>{o.current=null,c.current&&(l.current(),a(s.current?`Graph updated — refreshing…`:`Graph updated — opening Graph tab…`,`info`))},300)}}),[e,a]),(0,j.useEffect)(()=>e.on(`session.reset`,()=>{o.current!==null&&(clearTimeout(o.current),o.current=null),i()}),[e,i]),(0,j.useEffect)(()=>()=>{o.current!==null&&clearTimeout(o.current)},[])}var nt=`Connect two nodes together
--------------------------
...
`,I=`List nodes, connections, graphs or flows
----------------------------------------
...
...
\`\`\`
`,Bt=`Upload mock data to current graph instance
------------------------------------------
...
`),Ut=Object.assign({"../../../src/main/resources/help/help connect.md":nt,"../../../src/main/resources/help/help create.md":rt,"../../../src/main/resources/help/help data-dictionary.md":it,"../../../src/main/resources/help/help delete.md":at,"../../../src/main/resources/help/help describe.md":ot,"../../../src/main/resources/help/help edit.md":st,"../../../src/main/resources/help/help execute.md":ct,"../../../src/main/resources/help/help export.md":lt,"../../../src/main/resources/help/help graph-api-fetcher.md":F,"../../../src/main/resources/help/help graph-data-mapper.md":ut,"../../../src/main/resources/help/help graph-extension.md":dt,"../../../src/main/resources/help/help graph-island.md":ft,"../../../src/main/resources/help/help graph-join.md":pt,"../../../src/main/resources/help/help graph-js.md":mt,"../../../src/main/resources/help/help graph-math.md":ht,"../../../src/main/resources/help/help graph-resume.md":gt,"../../../src/main/resources/help/help graph-suspend.md":_t,"../../../src/main/resources/help/help graph-task.md":vt,"../../../src/main/resources/help/help import.md":yt,"../../../src/main/resources/help/help inspect.md":bt,"../../../src/main/resources/help/help instantiate.md":xt,"../../../src/main/resources/help/help list.md":I,"../../../src/main/resources/help/help run.md":St,"../../../src/main/resources/help/help seen.md":Ct,"../../../src/main/resources/help/help session.md":wt,"../../../src/main/resources/help/help tutorial 1.md":Tt,"../../../src/main/resources/help/help tutorial 10.md":Et,"../../../src/main/resources/help/help tutorial 11.md":Dt,"../../../src/main/resources/help/help tutorial 12.md":Ot,"../../../src/main/resources/help/help tutorial 13.md":kt,"../../../src/main/resources/help/help tutorial 14.md":At,"../../../src/main/resources/help/help tutorial 2.md":jt,"../../../src/main/resources/help/help tutorial 3.md":Mt,"../../../src/main/resources/help/help tutorial 4.md":Nt,"../../../src/main/resources/help/help tutorial 5.md":Pt,"../../../src/main/resources/help/help tutorial 6.md":Ft,"../../../src/main/resources/help/help tutorial 7.md":It,"../../../src/main/resources/help/help tutorial 8.md":Lt,"../../../src/main/resources/help/help tutorial 9.md":Rt,"../../../src/main/resources/help/help update.md":zt,"../../../src/main/resources/help/help upload.md":Bt,"../../../src/main/resources/help/help.md":Vt});function Wt(e){let t=e.split(`/`);return(t[t.length-1]??e).replace(/\.md$/,``)}var Gt=Object.fromEntries(Object.entries(Ut).map(([e,t])=>[Wt(e),t])),Kt={help:Ht};function qt(e){return e===`json-path`?Kt:Gt}function Jt(e,t=`minigraph`){let n=e===``?`help`:`help ${e}`;return qt(t)[n]??null}var Yt=Object.keys(Gt).filter(e=>e!==`help`).map(e=>e.replace(/^help\s+/,``)).sort(),Xt=[{id:`overview`,label:`Overview`},{id:`graph-model`,label:`Graph Model`},{id:`graph-skills`,label:`Graph Skills`},{id:`instance-model`,label:`Instance Model`},{id:`tutorials`,label:`Tutorials`,chipStripLabel:`Chapters`}],Zt=[{id:`overview`,label:`Overview`}];function Qt(e=`minigraph`){return e===`json-path`?Zt:Xt}var $t=new Set([`execute`,`inspect`,`instantiate`,`run`,`seen`,`upload`]);function en(e,t=`minigraph`){return t===`json-path`||e===``?`overview`:e.startsWith(`tutorial `)?`tutorials`:e.startsWith(`graph-`)?`graph-skills`:$t.has(e)?`instance-model`:`graph-model`}function tn(e,t=`minigraph`){if(e===`overview`)return[``];if(t===`json-path`)return[];let n=Yt.filter(n=>en(n,t)===e);return e===`tutorials`?[...n].sort((e,t)=>parseInt(e.replace(/^tutorial\s+/,``),10)-parseInt(t.replace(/^tutorial\s+/,``),10)):n}function nn(e,t){return e===``?`Overview`:t===`tutorials`?e.replace(/^tutorial\s+/,``):e}function rn(e=`minigraph`){return Qt(e).flatMap(t=>tn(t.id,e))}rn();function an(e){return e.replace(/^help\s*/i,``).trim().toLowerCase()}function on({bus:e,setHelpTopic:t,onTabSwitch:n,enabled:r=!0,contentProfile:i=`minigraph`}){let a=(0,j.useRef)(n);(0,j.useEffect)(()=>{a.current=n}),(0,j.useEffect)(()=>{if(r)return e.on(`command.helpOrDescribe`,e=>{if(!e.commandText.trim().toLowerCase().startsWith(`help`))return;let n=an(e.commandText);Jt(n,i)!==null&&(t(n),a.current())})},[e,t,r,i])}function sn({ctx:e,navigate:t,addToast:n,wsPath:r}){let i=he.find(e=>e.tabs.includes(`payload`)&&e.supportsUpload),a=(0,j.useRef)(null),o=i?.wsPath;(0,j.useEffect)(()=>{if(!(!o||!a.current)&&e.getSlot(o).phase===`connected`){let{wsPath:r,json:o}=a.current;a.current=null,e.setPendingPayload(r,o),t(i.path),n(`JSON loaded into JSON-Path editor ✓`,`success`)}},[o,e,t,n,i]);let s=(0,j.useCallback)(r=>{if(!i)return;let o=e.getSlot(i.wsPath);o.phase===`connected`?(e.setPendingPayload(i.wsPath,r),t(i.path),n(`JSON loaded into JSON-Path editor ✓`,`success`)):o.phase===`connecting`?(a.current={wsPath:i.wsPath,json:r},n(`Updated pending JSON transfer — latest payload will open when connected`,`info`)):(a.current={wsPath:i.wsPath,json:r},e.connect(i.wsPath,n),n(`Connecting to JSON-Path Playground…`,`info`))},[e,t,n,i]);return{handleSendToJsonPath:i&&r!==i.wsPath?s:void 0}}function cn({bus:e,onOpenPanel:t}){(0,j.useEffect)(()=>e.on(`upload.invitation`,e=>{t(e.uploadPath)}),[e,t])}function ln({bus:e,addToast:t}){let[n,r]=(0,j.useState)(null),i=(0,j.useRef)(null),a=(0,j.useRef)([]),o=(0,j.useRef)(null),[s,c]=(0,j.useState)(new Set),l=(0,j.useCallback)(e=>{let t=i.current;if(t!==null){t!==e&&!a.current.includes(e)&&a.current.push(e);return}o.current=document.activeElement,i.current=e,r(e)},[]),u=(0,j.useCallback)(()=>{let e=a.current.shift()??null;i.current=e,r(e),e===null&&setTimeout(()=>o.current?.focus(),0)},[]),d=(0,j.useCallback)(()=>{u()},[u]),f=(0,j.useCallback)(e=>{if(i.current===e)return u(),!0;let t=a.current.indexOf(e);return t===-1?!1:(a.current.splice(t,1),!0)},[u]),p=(0,j.useCallback)(e=>{let n=i.current;n&&c(e=>new Set([...e,n])),u(),t(`Mock data uploaded successfully ✓`,`success`)},[t,u]),m=(0,j.useCallback)(e=>{t(`Upload failed: ${e}`,`error`)},[t]),h=(0,j.useCallback)(()=>{c(new Set)},[]);return cn({bus:e,onOpenPanel:l}),{uploadPanelPath:n,successfulUploadPaths:s,handleOpenUploadPanel:l,handleCloseUploadPanel:d,handleCloseUploadPath:f,handleUploadSuccess:p,handleUploadError:m,resetSuccessfulPaths:h}}function un({bus:e,connected:t,appendMessage:n,addToast:r}){let i=(0,j.useRef)(null),a=(0,j.useRef)(!1),o=(0,j.useRef)(n);(0,j.useEffect)(()=>{o.current=n},[n]);let s=(0,j.useRef)(r);(0,j.useEffect)(()=>{s.current=r},[r]),(0,j.useEffect)(()=>{t||(i.current?.abort(),i.current=null,a.current=!1)},[t]),(0,j.useEffect)(()=>()=>{i.current?.abort()},[]),(0,j.useEffect)(()=>e.on(`payload.large`,e=>{if(a.current)return;let{apiPath:t,byteSize:n}=e;i.current?.abort();let r=new AbortController;i.current=r;let c=(n/(1024*1024)).toFixed(2);s.current(`Fetching large payload (${c} MB)…`,`info`),a.current=!0,fetch(t,{signal:r.signal}).then(e=>{if(!e.ok)throw Error(`HTTP ${e.status}`);return e.text()}).then(e=>{if(!e.trim())throw Error(`empty response body`);let t=e;try{t=JSON.stringify(JSON.parse(e),null,2)}catch{}o.current(t),a.current=!1,i.current=null}).catch(e=>{e.name!==`AbortError`&&(a.current=!1,i.current=null,o.current(`ERROR: payload fetch failed — ${e.message}`),s.current(`Payload fetch failed: ${e.message}`,`error`))})}),[e])}function dn(e){let[t,n]=pe(e,{}),r=(0,j.useCallback)(e=>{n(t=>({...t,[e]:{name:e,savedAt:new Date().toISOString()}}))},[n]),i=(0,j.useCallback)(e=>{n(t=>{let n={...t};return delete n[e],n})},[n]),a=(0,j.useCallback)(e=>Object.prototype.hasOwnProperty.call(t,e),[t]);return{savedGraphs:(0,j.useMemo)(()=>Object.values(t).sort((e,t)=>new Date(t.savedAt).getTime()-new Date(e.savedAt).getTime()),[t]),saveGraph:r,deleteGraph:i,hasGraph:a}}var fn={importedName:null,lastSavedName:null,isSaved:!1,untitledSlotConsumed:!1};function pn(e,t){switch(t.type){case`imported`:return{...e,importedName:t.name,lastSavedName:null,isSaved:!1};case`exported`:return{...e,lastSavedName:t.name,isSaved:!0,untitledSlotConsumed:e.untitledSlotConsumed||t.consumesUntitled};case`dirty`:return{...e,isSaved:!1};case`reset`:return{...fn}}}var mn=new Map;function hn(e,t,n){return t&&n!==null&&e===n}function gn(e,t){let n=e.on(`command.importGraph`,e=>{t.onImported(e.graphName)}),r=e.on(`graph.exported`,e=>{t.onExported(e.graphName)}),i=e.on(`graph.mutation`,()=>{t.onDirty()}),a=e.on(`session.reset`,()=>{t.onReset()});return()=>{n(),r(),i(),a()}}function _n(e,t,n,r){let[i,a]=pe(e,1),[o,s]=(0,j.useState)(()=>{let t=mn.get(e);return t&&hn(t.connectionEpoch,n,r)?t.state:{...fn}}),c=(0,j.useRef)(o),l=(0,j.useCallback)(t=>{let n=pn(c.current,t);c.current=n,t.type===`reset`?mn.delete(e):r!==null&&mn.set(e,{connectionEpoch:r,state:n}),s(n)},[r,e]),u=(0,j.useCallback)(e=>{l({type:`exported`,name:e,consumesUntitled:e===`untitled-${i}`})},[i,l]),d=(0,j.useCallback)(()=>{let t=mn.get(e)?.state;(c.current.untitledSlotConsumed||t?.untitledSlotConsumed)&&a(e=>e+1),l({type:`reset`})},[a,e,l]),f=(0,j.useRef)(r);return(0,j.useEffect)(()=>{let t=mn.get(e)?.connectionEpoch;(!n||f.current!==r||t!==void 0&&t!==r)&&d(),f.current=r},[n,r,d,e]),(0,j.useEffect)(()=>gn(t,{onImported:e=>l({type:`imported`,name:e}),onExported:u,onDirty:()=>l({type:`dirty`}),onReset:d}),[t,d,u,l]),{defaultName:o.lastSavedName??o.importedName??`untitled-${i}`,savedName:o.isSaved?o.lastSavedName:null,resetName:d}}var vn=new Set([`description`,`question`,`purpose`]),yn=`input.body`;function bn(e){return/[A-Za-z0-9_.]/.test(e)}function xn(e){return/[A-Za-z0-9_.*\[\]-]/.test(e)}function Sn(e,t){let n=0;for(;n<e.length;){let r=e.indexOf(yn,n);if(r===-1)return;let i=r>0?e[r-1]:``,a=r>1?e[r-2]:``,o=e[r+10]??``;if(i&&bn(i)&&!(i===`.`&&a===`$`)||o&&/[A-Za-z0-9_]/.test(o)){n=r+10;continue}let s=r+10;for(;s<e.length&&xn(e[s]);)s+=1;let c=e.slice(r,s);for(;c.endsWith(`.`)||c.endsWith(`-`)||c.endsWith(`[`);)c=c.slice(0,-1);for(;c.endsWith(`]`)&&!c.includes(`[`);)c=c.slice(0,-1);t.add(c),n=Math.max(s,r+10)}}function Cn(e,t,n){if(!(n&&vn.has(n.toLowerCase()))){if(typeof e==`string`){Sn(e,t);return}if(Array.isArray(e)){for(let n of e)Cn(n,t);return}if(typeof e==`object`&&e)for(let[n,r]of Object.entries(e))Cn(r,t,n)}}function wn(e){if(!e)return[];let t=new Set;for(let n of e.nodes)Cn(n.properties,t);return Array.from(t).sort()}var Tn={instantiate:`instantiate graph`,requestInputUpload:`upload mock data`,run:`run`},En=/^Graph instance created\. Loaded (\d+) mock (?:entry|entries), model\.ttl = (\d+) ms$/,Dn=/^Graph traversal completed in (\d+) ms$/,On=/^ERROR:\s*(.+)$/;function kn(e){let t=e.match(En);return t?{mockEntries:Number.parseInt(t[1],10),ttlMs:Number.parseInt(t[2],10)}:null}function An(e){return e===`Graph instance cleared`}function jn(e){let t=e.match(Dn);return t?{status:`completed`,elapsedMs:Number.parseInt(t[1],10)}:e.startsWith(`Graph traversal aborted`)?{status:`aborted`,elapsedMs:null}:null}function Mn(e){return e.match(On)?.[1]?.trim()||null}function Nn(e){let t=e.trim().toLowerCase();return t===Tn.instantiate||t===`${Tn.instantiate}...`}function Pn(e){return e.trim().toLowerCase()===Tn.run}var Fn=1e4,In={phase:`idle`,intent:null,pendingSignal:null,invalidated:!1};function Ln({enabled:e,bus:t,connected:n,connectionEpoch:r,graphData:i,graphIdentity:a,isPrimary:o,sendRawText:s,addToast:c,onWorkflowInputInvalidated:l}){let[u,d]=(0,j.useState)(In),f=(0,j.useRef)(In),p=(0,j.useRef)(null),m=(0,j.useRef)(s),h=(0,j.useRef)(c),g=(0,j.useRef)(l),_=(0,j.useMemo)(()=>wn(i),[i]),v=(0,j.useRef)(_);(0,j.useEffect)(()=>{m.current=s},[s]),(0,j.useEffect)(()=>{h.current=c},[c]),(0,j.useEffect)(()=>{g.current=l},[l]),(0,j.useEffect)(()=>{v.current=_},[_]);let y=(0,j.useCallback)(e=>{f.current=e,d(e)},[]),b=(0,j.useCallback)(()=>{p.current=null,y({...In})},[y]),x=(0,j.useCallback)(()=>{let e=p.current;p.current=null,e&&g.current?.(e)},[]),S=(0,j.useCallback)(()=>{x(),b()},[x,b]),C=(0,j.useCallback)(()=>{let e=f.current;if(x(),e.pendingSignal!==null){y({...e,phase:`outcome-uncertain`,invalidated:!0});return}b()},[x,b,y]),w=(0,j.useCallback)((e,t,n)=>(y(t),m.current(e)?!0:(b(),h.current(n,`error`),!1)),[b,y]),ee=e&&n&&i!==null&&o,te=ee&&(u.phase===`idle`||u.phase===`ready`&&_.length>0),T=ee&&u.phase===`ready`,E=e?i?n?o?``:`Run the graph from the host session`:`Connect first to run the graph`:`Load a graph first`:`Graph run controls are unavailable`,ne=(0,j.useCallback)(()=>!T||f.current.phase!==`ready`?!1:w(Tn.run,{phase:`running`,intent:null,pendingSignal:`run-terminal`,invalidated:!1},`Could not run graph because the WebSocket is not open.`),[T,w]),D=(0,j.useCallback)(()=>{if(!te)return!1;let e=f.current;return e.phase!==`idle`&&e.phase!==`ready`?!1:w(Tn.instantiate,{phase:`instantiating`,intent:`instantiate-only`,pendingSignal:`instance-created`,invalidated:!1},`Could not instantiate graph because the WebSocket is not open.`)},[te,w]),re=(0,j.useCallback)(e=>{let t=f.current;return t.phase!==`awaiting-input`&&t.phase!==`requesting-input`||t.intent===null||p.current!==e?!1:(p.current=null,y({phase:`ready`,intent:null,pendingSignal:null,invalidated:!1}),h.current(`Graph instantiated and ready to run.`,`success`),!0)},[y]),ie=(0,j.useCallback)(e=>{let t=f.current;return t.phase!==`awaiting-input`&&t.phase!==`requesting-input`||t.intent===null||p.current!==e?!1:(b(),h.current(`Graph instantiation cancelled.`,`info`),!0)},[b]);(0,j.useEffect)(()=>{let e=t.on(`graph.instance.created`,()=>{let e=f.current;if(e.pendingSignal===`instance-created`){if(e.invalidated){b();return}if(e.intent===null){y({phase:`ready`,intent:null,pendingSignal:null,invalidated:!1});return}v.current.length>0?w(Tn.requestInputUpload,{phase:`requesting-input`,intent:e.intent,pendingSignal:`upload-invitation`,invalidated:!1},`Graph was instantiated, but the input upload could not be requested.`):(y({phase:`ready`,intent:null,pendingSignal:null,invalidated:!1}),h.current(`Graph instantiated and ready to run.`,`success`))}}),n=t.on(`graph.instance.cleared`,S),r=t.on(`graph.mutation`,C),i=t.on(`session.reset`,S),a=t.on(`graph.exported`,C),o=t.on(`upload.invitation`,e=>{let t=f.current;if(t.pendingSignal===`upload-invitation`){if(t.invalidated){g.current?.(e.uploadPath),b();return}t.intent!==null&&(p.current=e.uploadPath,y({phase:`awaiting-input`,intent:t.intent,pendingSignal:null,invalidated:!1}))}}),s=t.on(`graph.run.terminal`,e=>{let t=f.current;if(t.pendingSignal!==`run-terminal`)return;let n=!t.invalidated&&e.status===`aborted`;b(),n&&h.current(`Graph run aborted. See the console for details.`,`error`)}),c=t.on(`command.error`,e=>{let t=f.current;if(t.pendingSignal===`instance-created`){let n=!t.invalidated;b(),n&&h.current(`Could not instantiate graph: ${e.message}`,`error`)}else if(t.pendingSignal===`upload-invitation`){let n=!t.invalidated;b(),n&&h.current(`Could not request graph input: ${e.message}`,`error`)}}),l=t.on(`command.echo`,e=>{let t=f.current;Nn(e.commandText)?(t.phase===`idle`||t.phase===`ready`)&&y({phase:`instantiating`,intent:null,pendingSignal:`instance-created`,invalidated:!1}):Pn(e.commandText)&&(t.phase===`idle`||t.phase===`ready`)&&y({phase:`running`,intent:null,pendingSignal:`run-terminal`,invalidated:!1})});return()=>{e(),n(),r(),i(),a(),o(),s(),c(),l()}},[t,S,C,b,w,y]),(0,j.useEffect)(()=>{if(u.phase!==`instantiating`&&u.phase!==`requesting-input`)return;let e=setTimeout(()=>{let e=f.current;(e.phase===`instantiating`||e.phase===`requesting-input`)&&(y({...e,phase:`outcome-uncertain`}),h.current(`Graph setup is taking longer than expected. Waiting for the backend outcome…`,`info`))},Fn);return()=>clearTimeout(e)},[u.phase,y]);let ae=(0,j.useRef)(a);(0,j.useEffect)(()=>{ae.current!==a&&C(),ae.current=a},[a,C]);let oe=(0,j.useRef)(r);(0,j.useEffect)(()=>{oe.current!==r&&S(),oe.current=r},[r,S]),(0,j.useEffect)(()=>{!e||!n||!o?S():i||C()},[e,n,i,S,C,o]);let O=u.phase!==`idle`&&u.phase!==`ready`;return{phase:u.phase,ready:u.phase===`ready`,busy:O,canInteract:ee,canInstantiate:te,canRun:T,disabledReason:E,inputBodyPaths:_,inputIntent:u.intent,workflowUploadPath:p.current,isWorkflowInputPanel:u.intent!==null&&(u.phase===`requesting-input`||u.phase===`awaiting-input`),runGraph:ne,instantiateGraph:D,handleInputUploadSuccess:re,handleInputCancelled:ie}}function Rn(e,t){return e.on(`graph.exported`,e=>t(e.graphName))}function zn({bus:e,connected:t,sendRawText:n,saveGraph:r,addToast:i}){let a=(0,j.useRef)(null),o=(0,j.useCallback)(e=>{if(!t){i(`Save failed: connection required to export graph`,`error`);return}let r=setTimeout(()=>{a.current!==null&&(a.current=null,i(`Save failed: export confirmation timed out`,`error`))},1e4);a.current={graphName:e,timeoutId:r},n(`export graph as ${e}`)},[t,n,i]);return(0,j.useEffect)(()=>{if(r!==null)return Rn(e,r)},[e,r]),(0,j.useEffect)(()=>e.on(`graph.exported`,e=>{if(a.current===null||e.graphName!==a.current.graphName)return;clearTimeout(a.current.timeoutId);let t=a.current.graphName;a.current=null,i(`Graph saved as "${t}"`,`success`)}),[e,i]),(0,j.useEffect)(()=>e.on(`graph.export.failed`,e=>{a.current!==null&&(clearTimeout(a.current.timeoutId),a.current=null,e.reason===`invalid-name`?i(`Save failed: invalid filename (a–z, A–Z, 0–9, hyphen only)`,`error`):i(`Save failed: root node name does not match existing graph`,`error`))}),[e,i]),(0,j.useEffect)(()=>{!t&&a.current!==null&&(clearTimeout(a.current.timeoutId),a.current=null,i(`Save failed: connection closed before export confirmation`,`error`))},[t,i]),(0,j.useEffect)(()=>()=>{a.current!==null&&clearTimeout(a.current.timeoutId)},[]),{handleSaveGraph:o,handleLoadGraph:(0,j.useCallback)(e=>{t&&(n(`import graph from ${e}`),i(`Importing graph "${e}"…`,`info`))},[t,n,i])}}function Bn(e){if(e==null)return``;let t=typeof e==`string`?e:JSON.stringify(e);return t.includes(`'''`)&&console.warn(`[commandBuilder] Property value contains "'''" which cannot be escaped in the backend grammar. The value may be truncated on paste.`),t.includes(`
`)?`'''\n${t}\n'''`:t}function Vn(e,t){let n=[`${e} node ${t.alias}`];t.types.length>0&&n.push(`with type ${t.types[0]}`);let r=Object.entries(t.properties).filter(([,e])=>e!=null);if(r.length>0){n.push(`with properties`);for(let[e,t]of r)if(Array.isArray(t))for(let r of t)n.push(`${e}[]=${Bn(r)}`);else n.push(`${e}[]=${Bn(t)}`)}return n.join(`
`)}function Hn(e,t){let n=t?.nodes.some(t=>t.alias===e.node.alias)?`update`:`create`;return{verb:n,command:Vn(n,e.node)}}function Un(e){return`${e} ${e===1?`node`:`nodes`} clipped to workspace`}function Wn(e){let{added:t,duplicates:n,failed:r}=e;if(t===0&&n===0&&r===0)return{message:`No selected nodes are available to clip.`,type:`info`};if(t===0&&n>0&&r===0)return{message:`All selected nodes already exist in workspace.`,type:`info`};if(t===0&&n===0&&r>0)return{message:`Failed to clip selected nodes to workspace.`,type:`error`};let i=Un(t);return n>0&&(i+=`. ${n} already existed.`),r>0&&(i+=`. ${r} failed.`),{message:i,type:r>0?`error`:`success`}}function Gn(e){return{execute(t){return e(t)}}}var Kn=/^[A-Za-z0-9_-]+$/,qn=/^[A-Za-z0-9_-]+(?:\[(?:0|[1-9]\d*)?\])*$/,Jn=new Set([`input`,`output`,`model`,`response`,`result`,`parameter`,`none`,`next`,`api`,`error`]);function Yn(e,t){return`properties.${e}.${t}`}function Xn(e){return e.split(`.`).every(e=>qn.test(e))}function Zn(e){return Xn(e)}function Qn(e,t={}){let n={},r=t.mode??`create`,i=e.alias.trim(),a=t.originalAlias?.trim()??``,o=e.nodeType.trim();r===`edit`?a?Kn.test(a)||(n.alias=`Use only letters, numbers, underscore, and hyphen.`):n.alias=`Original alias is required.`:i?Kn.test(i)?Jn.has(i.toLowerCase())?n.alias=`"${i}" is reserved.`:t.graphData?.nodes.some(e=>e.alias.toLowerCase()===i.toLowerCase())&&(n.alias=`Node "${i}" already exists in the current graph.`):n.alias=`Use only letters, numbers, underscore, and hyphen.`:n.alias=`Alias is required.`,o&&!Kn.test(o)&&(n.nodeType=`Use only letters, numbers, underscore, and hyphen.`);for(let t of e.properties){let e=t.key.trim(),r=t.value.trim();!e&&!r||(!e&&r?n[Yn(t.id,`key`)]=`Property key is required when value is present.`:Zn(e)||(n[Yn(t.id,`key`)]=`Use a property name or dot/bracket path, for example mapping[] or config.value.`),r.includes(`'''`)&&(n[Yn(t.id,`value`)]=`Property value cannot contain '''.`))}return{valid:Object.keys(n).length===0,errors:n}}function $n(e,t={}){let n={},r=e.trim();return r?Kn.test(r)?t.graphData&&!t.graphData.nodes.some(e=>e.alias.toLowerCase()===r.toLowerCase())&&(n.alias=`Node "${r}" is no longer available in the current graph.`):n.alias=`Use only letters, numbers, underscore, and hyphen.`:n.alias=`Alias is required.`,{valid:Object.keys(n).length===0,errors:n}}function er(e,t){let n={},r=e.trim(),i=t.trim();return(!r||!Kn.test(r))&&(n.sourceAlias=`Use only letters, numbers, underscore, and hyphen.`),(!i||!Kn.test(i))&&(n.targetAlias=`Use only letters, numbers, underscore, and hyphen.`),!n.sourceAlias&&!n.targetAlias&&r===i&&(n.targetAlias=`Source and target must be different nodes.`),{valid:Object.keys(n).length===0,errors:n}}function tr(e,t){return!!e?.nodes.some(e=>e.alias.toLowerCase()===t.toLowerCase())}function nr(e,t={}){let n={},r=e.sourceAlias.trim(),i=e.targetAlias.trim(),a=e.relation.trim();return t.connected===!1&&(n.command=`Connection disconnected. Reconnect before creating a connection.`),r?Kn.test(r)?t.graphData&&!tr(t.graphData,r)&&(n.sourceAlias=`Node "${r}" is no longer available in the current graph.`):n.sourceAlias=`Use only letters, numbers, underscore, and hyphen.`:n.sourceAlias=`Source is required.`,i?Kn.test(i)?t.graphData&&!tr(t.graphData,i)&&(n.targetAlias=`Node "${i}" is no longer available in the current graph.`):n.targetAlias=`Use only letters, numbers, underscore, and hyphen.`:n.targetAlias=`Target is required.`,r&&i&&r.toLowerCase()===i.toLowerCase()&&(n.targetAlias=`Source and target nodes must be different.`),a?Kn.test(a)||(n.relation=`Use only letters, numbers, underscore, and hyphen.`):n.relation=`Relation is required.`,{valid:Object.keys(n).length===0,errors:n}}function rr(e){return e.length<=63488?{valid:!0,errors:{}}:{valid:!1,errors:{command:`The node command is too large. Shorten property values before submitting.`}}}function ir(e,t=!1){return e.properties.map(e=>({key:e.key.trim(),value:t?e.value.replace(/\r\n/g,`
`).replace(/\r/g,`
`):e.value.trim()})).filter(e=>e.key||e.value.trim())}function ar(e){let t=rr(e);if(!t.valid)throw Error(t.errors.command)}function or(e,t,n){if(n.includes(`
`)){e.push(`${t}='''`),e.push(n),e.push(`'''`);return}e.push(`${t}=${n}`)}function sr(e){let t=Qn(e);if(!t.valid)throw Error(Object.values(t.errors)[0]??`Invalid node form state.`);let n=e.alias.trim(),r=e.nodeType.trim(),i=ir(e,!0),a=[`create node ${n}`];if(r&&a.push(`with type ${r}`),i.length>0){a.push(`with properties`);for(let e of i)or(a,e.key,e.value)}let o=a.join(`
`);return ar(o),o}function cr(e,t){let n=t.trim(),r=Qn(e,{mode:`edit`,originalAlias:n});if(!r.valid)throw Error(Object.values(r.errors)[0]??`Invalid node form state.`);let i=e.nodeType.trim(),a=ir(e,!0),o=[`update node ${n}`];if(i&&o.push(`with type ${i}`),a.length>0){o.push(`with properties`);for(let e of a)or(o,e.key,e.value)}let s=o.join(`
`);return ar(s),s}function lr(e,t={}){let n=e.trim(),r=$n(n,t);if(!r.valid)throw Error(Object.values(r.errors)[0]??`Invalid node alias.`);let i=`delete node ${n}`;return ar(i),i}function ur(e,t){let n=e.trim(),r=t.trim(),i=er(n,r);if(!i.valid)throw Error(Object.values(i.errors)[0]??`Invalid connection endpoints.`);let a=`delete connection ${n} and ${r}`;return ar(a),a}function dr(e){let t=nr(e);if(!t.valid)throw Error(Object.values(t.errors)[0]??`Invalid connection form state.`);let n=`connect ${e.sourceAlias.trim()} to ${e.targetAlias.trim()} with ${e.relation.trim()}`;return ar(n),n}function fr(e,t,n){let r=[];for(let i of e.connections??[])if(!(i.source!==t||i.target!==n))for(let e of i.relations)r.push(e.type);return r}function pr(e,t){try{let n=new Map,r=(t,r)=>{let i=`${t}\t${r}`,a=n.get(i);return a||(a=fr(e,t,r),n.set(i,a)),a},i=[],a=[],o=new Set;for(let{source:e,target:n,relation:s}of t){let t=r(e,n);if(s===void 0){if(t.length===0)continue;for(let r of t)i.push({source:e,target:n,relation:r});t.length=0}else{let r=t.indexOf(s);if(r===-1)continue;t.splice(r,1),i.push({source:e,target:n,relation:s})}let c=[e,n].sort().join(`	`);o.has(c)||(o.add(c),a.push({a:e,b:n}))}if(i.length===0)return null;let s=[];for(let{a:e,b:t}of a){s.push(ur(e,t));for(let n of r(e,t))s.push(dr({sourceAlias:e,targetAlias:t,relation:n}));for(let n of r(t,e))s.push(dr({sourceAlias:t,targetAlias:e,relation:n}))}return{commands:s,removed:i}}catch{return null}}function mr(e){let t=e[0];return e.length===1?`relation '${t.relation}' (${t.source} → ${t.target})`:e.every(e=>e.source===t.source&&e.target===t.target)?`connection ${t.source} → ${t.target}`:`${e.length} relations`}var hr=0;function gr(e=``,t=``){return hr+=1,{id:`property-row-${hr}`,key:e,value:t}}function _r(e){return{alias:e===`empty-graph`?`root`:``,nodeType:e===`empty-graph`?`Root`:``,properties:[gr()],source:e}}function vr(e){let t=e.indexOf(`[`);if(t===-1)return null;let n=e.indexOf(`]`,t+1);return n===-1||e.indexOf(`[`,n+1)!==-1?null:{open:t,close:n}}function yr(e){let t=vr(e);if(!t)return e;let n=e.slice(t.open+1,t.close);return/^\d+$/.test(n)?e.slice(0,t.open+1)+n.padStart(3,`0`)+e.slice(t.close):e}function br(e){let t=vr(e);if(!t)return e;let n=e.slice(t.open+1,t.close);return/^\d+$/.test(n)?e.slice(0,t.open+1)+e.slice(t.close):e}function xr(e){return e.slice().sort((e,t)=>{let n=yr(e.key.trim()),r=yr(t.key.trim());return!n&&!r?0:n?!r||n<r?-1:+(n>r):1})}var Sr=`This node contains data that cannot be safely represented in the edit form. Use the console edit command for this node.`;function Cr(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function wr(e){return e===null?`null`:String(e)}function Tr(e,t,n){if(!Xn(e))return!1;if(Array.isArray(t))return t.length!==0&&t.every((t,r)=>Tr(`${e}[${r}]`,t,n));if(Cr(t)){let r=Object.entries(t);return r.length!==0&&r.every(([t,r])=>Tr(`${e}.${t}`,r,n))}let r=wr(t);return r.includes(`'''`)?!1:(n.push(gr(e,r)),!0)}function Er(e){if(!Kn.test(e.alias)||e.types.length>1)return{valid:!1,formState:null,message:Sr};let t=Object.entries(e.properties),n=[];for(let[e,r]of t)if(!Tr(e,r,n))return{valid:!1,formState:null,message:Sr};let r=xr(n).map(e=>({...e,key:br(e.key)}));return{valid:!0,formState:{alias:e.alias,nodeType:e.types[0]??``,properties:r.length>0?r:[gr()],source:`edit-node`},message:null}}function Dr(e,t,n){let r=[];for(let i of e.connections??[]){let e=i.source===t&&i.target===n,a=i.source===n&&i.target===t;if(!(!e&&!a))for(let e of i.relations)r.push(dr({sourceAlias:i.source,targetAlias:i.target,relation:e.type}))}return r}function Or(e){if(e.length===0)return null;try{return{label:`delete ${mr(e)}`,inverseCommands:e.map(({source:e,target:t,relation:n})=>dr({sourceAlias:e,targetAlias:t,relation:n}))}}catch{return null}}function kr(e){let t=Er(e);if(!t.valid||t.formState===null)return null;try{return{label:`edit node ${e.alias}`,inverseCommands:[cr(t.formState,e.alias)]}}catch{return null}}function Ar(e){try{return{label:`create node ${e}`,inverseCommands:[lr(e)]}}catch{return null}}function jr(e,t,n){try{let r=Dr(e,t,n);return{label:`create connection ${t} → ${n}`,inverseCommands:[ur(t,n),...r]}}catch{return null}}function Mr(e,t){let n=Er(t);if(!n.valid||n.formState===null)return null;try{let r=[sr(n.formState)];for(let n of e.connections??[])if(!(n.source!==t.alias&&n.target!==t.alias))for(let e of n.relations)r.push(dr({sourceAlias:n.source,targetAlias:n.target,relation:e.type}));return{label:`delete node ${t.alias}`,inverseCommands:r}}catch{return null}}var Nr=2500;function Pr({bus:e,connected:t,sendRawText:n,addToast:r}){let i=(0,j.useRef)([]),a=(0,j.useRef)(0),o=(0,j.useCallback)(()=>{i.current=[]},[]);(0,j.useEffect)(()=>{t||o()},[o,t]),(0,j.useEffect)(()=>e.on(`graph.mutation`,e=>{e.mutationType===`import-graph`&&o()}),[e,o]);let s=(0,j.useCallback)(e=>{if(e===null||e.inverseCommands.length===0)return null;let t=++a.current;return i.current=[...i.current.slice(-19),{...e,id:t}],t},[]),c=(0,j.useRef)(!1),l=(0,j.useCallback)(()=>new Promise(t=>{let n=!1,r=()=>{n||(n=!0,i(),clearTimeout(a),t())},i=e.on(`graph.mutation`,r),a=setTimeout(r,Nr)}),[e]),u=(0,j.useRef)([]),d=(0,j.useCallback)(e=>{e.length!==0&&(u.current.push(e),!c.current&&(c.current=!0,(async()=>{try{for(;;){let e=u.current.shift();if(!e)break;for(let t of e){if(!n(t)){r(`Could not send the command because the WebSocket is not open.`,`error`),u.current=[];return}await l()}}}finally{c.current=!1}})()))},[r,n,l]),f=(0,j.useCallback)(e=>{if(c.current){r(`A graph edit is already in progress.`,`info`);return}let t=i.current,a=t[t.length-1];if(!a){r(`Nothing to undo.`,`info`);return}if(e!==void 0&&a.id!==e){r(`Newer changes exist — press Ctrl+Z to undo them in order.`,`info`);return}i.current=t.slice(0,-1),c.current=!0,(async()=>{try{for(let e of a.inverseCommands){if(!n(e)){r(`Could not send the undo command because the WebSocket is not open.`,`error`),o();return}await l()}r(`Undo: ${a.label}`,`success`)}finally{c.current=!1}})()},[r,o,n,l]);return{push:s,undoLast:(0,j.useCallback)(()=>f(void 0),[f]),undoEntry:f,runCommands:d,hasEntries:(0,j.useCallback)(()=>i.current.length>0,[]),clear:o}}function Fr(e){return e.trim().toLowerCase()}function Ir(e,t){if(!t.alias||t.action!==null&&t.action!==`delete-node`)return null;let n=e.aliases.find(n=>Fr(n)===Fr(t.alias)&&e.results[n]===void 0);return n?{...e,results:{...e.results,[n]:t.status===`accepted`?`success`:`error`}}:null}function Lr(e){return e.aliases.every(t=>e.results[t]!==void 0)}function Rr(e){let t=Object.values(e.results).filter(e=>e===`success`).length,n=Object.values(e.results).filter(e=>e===`error`).length,r=`${t} selected ${t===1?`node`:`nodes`} deleted.`;return t===0&&n>0?{message:`Failed to delete selected nodes.`,type:`error`}:n>0?{message:`${r} ${n} failed.`,type:`error`}:{message:r,type:`success`}}var zr={toastContainer:`_toastContainer_1rn7u_1`,toast:`_toast_1rn7u_1`,slideIn:`_slideIn_1rn7u_1`,success:`_success_1rn7u_36`,error:`_error_1rn7u_40`,info:`_info_1rn7u_44`,toastIcon:`_toastIcon_1rn7u_48`,toastMessage:`_toastMessage_1rn7u_53`,toastAction:`_toastAction_1rn7u_59`},Br=({toasts:e,onRemove:t})=>e.length===0?null:(0,P.jsx)(`div`,{className:zr.toastContainer,children:e.map(e=>(0,P.jsxs)(`div`,{className:`${zr.toast} ${zr[e.type]}`,onClick:()=>t(e.id),children:[(0,P.jsxs)(`span`,{className:zr.toastIcon,children:[e.type===`success`&&`✅`,e.type===`error`&&`❌`,e.type===`info`&&`ℹ️`]}),(0,P.jsx)(`span`,{className:zr.toastMessage,children:e.message}),e.action&&(0,P.jsx)(`button`,{type:`button`,className:zr.toastAction,onClick:n=>{n.stopPropagation(),e.action?.onClick(),t(e.id)},children:e.action.label})]},e.id))}),Vr={container:`_container_9dbh2_3`,trigger:`_trigger_9dbh2_7`,chevron:`_chevron_9dbh2_37`,chevronOpen:`_chevronOpen_9dbh2_43`,dot:`_dot_9dbh2_49`,dotIdle:`_dotIdle_9dbh2_56`,dotConnecting:`_dotConnecting_9dbh2_57`,pulse:`_pulse_9dbh2_1`,dotConnected:`_dotConnected_9dbh2_58`,dotPartial:`_dotPartial_9dbh2_59`,dropdown:`_dropdown_9dbh2_65`,fadeIn:`_fadeIn_9dbh2_1`};function Hr({label:e,dotStatus:t,children:n}){let[r,i]=(0,j.useState)(!1),a=(0,j.useRef)(null);(0,j.useEffect)(()=>{if(!r)return;let e=e=>{a.current&&!a.current.contains(e.target)&&i(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[r]);let o=e=>{e.key===`Escape`&&(i(!1),a.current?.querySelector(`button[aria-haspopup]`)?.focus())},s=t===`connected`?Vr.dotConnected:t===`connecting`?Vr.dotConnecting:t===`partial`?Vr.dotPartial:t===`idle`?Vr.dotIdle:void 0;return(0,P.jsxs)(`div`,{className:Vr.container,ref:a,onKeyDown:o,children:[(0,P.jsxs)(`button`,{className:Vr.trigger,onClick:()=>i(e=>!e),"aria-haspopup":`true`,"aria-expanded":r,children:[t!==void 0&&(0,P.jsx)(`span`,{className:`${Vr.dot} ${s??``}`,"aria-hidden":`true`}),(0,P.jsx)(`span`,{children:e}),(0,P.jsx)(`span`,{className:`${Vr.chevron} ${r?Vr.chevronOpen:``}`,"aria-hidden":`true`,children:`▾`})]}),r&&(0,P.jsx)(`div`,{className:Vr.dropdown,role:`menu`,children:n})]})}var L={panel:`_panel_1ws0d_1`,section:`_section_1ws0d_7`,sectionHeader:`_sectionHeader_1ws0d_20`,sessionHeaderRow:`_sessionHeaderRow_1ws0d_29`,iconButton:`_iconButton_1ws0d_36`,copyButton:`_copyButton_1ws0d_63`,copyButtonCopied:`_copyButtonCopied_1ws0d_95`,relationshipRow:`_relationshipRow_1ws0d_102`,subscriberRow:`_subscriberRow_1ws0d_103`,sessionId:`_sessionId_1ws0d_114`,statusDot:`_statusDot_1ws0d_127`,metaText:`_metaText_1ws0d_136`,emptyMessage:`_emptyMessage_1ws0d_137`,subscriberList:`_subscriberList_1ws0d_148`,subscribeForm:`_subscribeForm_1ws0d_157`,subscribeInput:`_subscribeInput_1ws0d_164`,subscribeButton:`_subscribeButton_1ws0d_189`,resetButton:`_resetButton_1ws0d_190`,unsubscribeButton:`_unsubscribeButton_1ws0d_218`,actionsRow:`_actionsRow_1ws0d_241`,errorMessage:`_errorMessage_1ws0d_261`,infoMessage:`_infoMessage_1ws0d_262`};function Ur({copied:e}){return e?(0,P.jsx)(`svg`,{viewBox:`0 0 16 16`,"aria-hidden":`true`,focusable:`false`,children:(0,P.jsx)(`path`,{d:`M6.2 11.4 2.9 8.1l1.1-1.1 2.2 2.2 5.8-5.8 1.1 1.1-6.9 6.9Z`})}):(0,P.jsxs)(`svg`,{viewBox:`0 0 16 16`,"aria-hidden":`true`,focusable:`false`,children:[(0,P.jsx)(`path`,{d:`M5 2.5A1.5 1.5 0 0 1 6.5 1h6A1.5 1.5 0 0 1 14 2.5v6A1.5 1.5 0 0 1 12.5 10H11V8.7h1.5a.2.2 0 0 0 .2-.2v-6a.2.2 0 0 0-.2-.2h-6a.2.2 0 0 0-.2.2V4H5V2.5Z`}),(0,P.jsx)(`path`,{d:`M2 6.5A1.5 1.5 0 0 1 3.5 5h6A1.5 1.5 0 0 1 11 6.5v7A1.5 1.5 0 0 1 9.5 15h-6A1.5 1.5 0 0 1 2 13.5v-7Zm1.5-.2a.2.2 0 0 0-.2.2v7a.2.2 0 0 0 .2.2h6a.2.2 0 0 0 .2-.2v-7a.2.2 0 0 0-.2-.2h-6Z`})]})}function Wr(e){return e.connected?e.state.pendingCommand===`refresh`||e.state.loading?`connecting`:e.state.sessionId?`connected`:`partial`:`idle`}function Gr({controller:e}){let{state:t}=e,[n,r]=(0,j.useState)(!1),[i,a]=(0,j.useState)(``),[o,s]=(0,j.useState)(null),[c,l]=(0,j.useState)(null),u=(0,j.useRef)(null),d=e.canReset;(0,j.useEffect)(()=>()=>{u.current!==null&&window.clearTimeout(u.current)},[]),(0,j.useEffect)(()=>{t.subscribedTo&&t.pendingCommand!==`subscribe`&&(r(!1),a(``))},[t.pendingCommand,t.subscribedTo]);let f=t=>{t.preventDefault(),e.subscribeToSession(i)},p=async e=>{try{await navigator.clipboard.writeText(e),s(null),l(e),u.current!==null&&window.clearTimeout(u.current),u.current=window.setTimeout(()=>{l(null),u.current=null},1400)}catch{l(null),s(`Could not copy the session ID. Please copy it manually.`)}};return e.connected?(0,P.jsxs)(`div`,{className:L.panel,children:[(0,P.jsxs)(`section`,{className:L.section,children:[(0,P.jsx)(`div`,{className:L.sectionHeader,children:`This session`}),(0,P.jsxs)(`div`,{className:L.sessionHeaderRow,children:[t.sessionId?(0,P.jsx)(`code`,{className:L.sessionId,title:t.sessionId,children:t.sessionId}):(0,P.jsx)(`p`,{className:L.emptyMessage,children:`Session details are not loaded yet.`}),t.sessionId&&(0,P.jsx)(`button`,{type:`button`,className:`${L.copyButton} ${c===t.sessionId?L.copyButtonCopied:``}`,onClick:()=>void p(t.sessionId),"aria-label":`Copy session ID`,title:c===t.sessionId?`Copied`:`Copy session ID`,children:(0,P.jsx)(Ur,{copied:c===t.sessionId})}),e.canSubscribe&&(0,P.jsx)(`button`,{type:`button`,className:L.iconButton,onClick:()=>{e.clearMessage(),r(e=>!e)},"aria-expanded":n,"aria-label":n?`Close subscribe form`:`Subscribe to another session`,title:n?`Close subscribe form`:`Subscribe to another session`,children:n?`×`:`+`})]}),t.startedSince&&(0,P.jsxs)(`div`,{className:L.metaText,children:[`Started since `,t.startedSince]}),n&&(0,P.jsxs)(`form`,{className:L.subscribeForm,onSubmit:f,children:[(0,P.jsx)(`input`,{className:L.subscribeInput,value:i,onChange:t=>{a(t.target.value),e.clearMessage()},placeholder:`ws-123456-1`,autoComplete:`off`,disabled:!e.canSubscribe}),(0,P.jsx)(`button`,{type:`submit`,className:L.subscribeButton,disabled:!e.canSubscribe||i.trim().length===0,children:t.pendingCommand===`subscribe`?`...`:`Subscribe`})]})]}),t.subscribedTo&&(0,P.jsxs)(`section`,{className:L.section,children:[(0,P.jsx)(`div`,{className:L.sectionHeader,children:`Subscribed to`}),(0,P.jsxs)(`div`,{className:L.relationshipRow,children:[(0,P.jsx)(`span`,{className:L.statusDot,"aria-hidden":`true`}),(0,P.jsx)(`code`,{className:L.sessionId,title:t.subscribedTo,children:t.subscribedTo}),(0,P.jsx)(`button`,{type:`button`,className:L.unsubscribeButton,onClick:e.unsubscribe,disabled:!e.canUnsubscribe,children:t.pendingCommand===`unsubscribe`?`...`:`Unsubscribe`})]})]}),t.subscribers.length>0&&(0,P.jsxs)(`section`,{className:L.section,children:[(0,P.jsx)(`div`,{className:L.sectionHeader,children:`Subscribers`}),(0,P.jsx)(`ul`,{className:L.subscriberList,children:t.subscribers.map(e=>(0,P.jsxs)(`li`,{className:L.subscriberRow,children:[(0,P.jsx)(`span`,{className:L.statusDot,"aria-hidden":`true`}),(0,P.jsx)(`code`,{className:L.sessionId,title:e,children:e})]},e))})]}),d&&(0,P.jsx)(`div`,{className:L.actionsRow,children:(0,P.jsx)(`button`,{type:`button`,className:L.resetButton,onClick:e.resetSession,disabled:!e.canReset,children:t.pendingCommand===`reset`?`Resetting...`:`Reset Session`})}),t.error&&(0,P.jsx)(`div`,{className:L.errorMessage,role:`alert`,children:t.error}),o&&(0,P.jsx)(`div`,{className:L.errorMessage,role:`alert`,children:o})]}):(0,P.jsx)(`div`,{className:L.panel,children:(0,P.jsx)(`p`,{className:L.emptyMessage,children:`Connect Minigraph to view session details.`})})}function Kr({controller:e}){return(0,P.jsx)(Hr,{label:`Session`,dotStatus:Wr(e),children:(0,P.jsx)(Gr,{controller:e})})}var qr={nav:`_nav_1hfby_3`,menuList:`_menuList_1hfby_11`,menuItem:`_menuItem_1hfby_19`,toolRow:`_toolRow_1hfby_56`,toolLink:`_toolLink_1hfby_67`,toolLinkActive:`_toolLinkActive_1hfby_92`,toolDot:`_toolDot_1hfby_99`,toolDotIdle:`_toolDotIdle_1hfby_106`,toolDotConnecting:`_toolDotConnecting_1hfby_107`,pulse:`_pulse_1hfby_1`,toolDotConnected:`_toolDotConnected_1hfby_108`,connectAllRow:`_connectAllRow_1hfby_112`,connectAllBtn:`_connectAllBtn_1hfby_118`,connectAllBtnStop:`_connectAllBtnStop_1hfby_142`,toolConnectBtn:`_toolConnectBtn_1hfby_154`,toolConnectBtnStop:`_toolConnectBtnStop_1hfby_180`,externalIcon:`_externalIcon_1hfby_192`};function Jr(e){return e.every(e=>e===`connected`)?`connected`:e.every(e=>e===`idle`)?`idle`:e.some(e=>e===`connecting`)?`connecting`:`partial`}function Yr(e){return e===`connected`?`connected`:e===`connecting`?`connecting`:`idle`}var Xr=[{href:`/info`,label:`Info`},{href:`/info/lib`,label:`Libraries`},{href:`/info/routes`,label:`Services`},{href:`/health`,label:`Health`},{href:`/env`,label:`Environment`},{href:`http://localhost:8085/api/ws/json`,label:`Legacy JSON`},{href:`http://localhost:8085/api/ws/graph`,label:`Legacy Graph`}];function Zr({addToast:e,sessionCollaboration:t}){let n=Se(),r=he.map(e=>n.getSlot(e.wsPath).phase),i=Jr(r),a=r.every(e=>e===`connected`),o=r.some(e=>e===`connecting`);function s(){he.forEach(t=>{n.getSlot(t.wsPath).phase===`idle`&&n.connect(t.wsPath,e)})}function c(){he.forEach(e=>{let{phase:t}=n.getSlot(e.wsPath);(t===`connected`||t===`connecting`)&&n.disconnect(e.wsPath)})}return(0,P.jsxs)(`nav`,{className:qr.nav,"aria-label":`Main navigation`,children:[t&&(0,P.jsx)(Kr,{controller:t}),(0,P.jsxs)(Hr,{label:`Tools`,dotStatus:i,children:[(0,P.jsx)(`div`,{className:qr.connectAllRow,children:(0,P.jsx)(`button`,{className:`${qr.connectAllBtn} ${a?qr.connectAllBtnStop:``}`,onClick:a?c:s,disabled:o,"aria-label":o?`Connecting…`:a?`Disconnect all WebSockets`:`Connect all WebSockets`,children:o?`Connecting…`:a?`Disconnect All`:`Connect All`})}),(0,P.jsx)(`ul`,{className:qr.menuList,role:`none`,children:he.map(t=>{let{phase:r}=n.getSlot(t.wsPath),i=Yr(r),a=r===`connected`,o=r===`connecting`,s=i===`connected`?qr.toolDotConnected:i===`connecting`?qr.toolDotConnecting:qr.toolDotIdle;return(0,P.jsxs)(`li`,{role:`none`,className:qr.toolRow,children:[(0,P.jsxs)(w,{to:t.path,role:`menuitem`,className:({isActive:e})=>`${qr.toolLink} ${e?qr.toolLinkActive:``}`,children:[(0,P.jsx)(`span`,{className:`${qr.toolDot} ${s}`,"aria-hidden":`true`}),(0,P.jsx)(`span`,{className:qr.toolLabel,children:t.label})]}),(0,P.jsx)(`button`,{className:`${qr.toolConnectBtn} ${a?qr.toolConnectBtnStop:``}`,onClick:()=>a||o?n.disconnect(t.wsPath):n.connect(t.wsPath,e),disabled:o,"aria-label":o?`Connecting…`:a?`Disconnect ${t.label}`:`Connect ${t.label}`,title:o?`Connecting…`:_e(t.wsPath),children:o?`…`:a?`Stop`:`Start`})]},t.path)})})]}),(0,P.jsx)(Hr,{label:`Quick Links`,children:(0,P.jsx)(`ul`,{className:qr.menuList,role:`none`,children:Xr.map(e=>(0,P.jsx)(`li`,{role:`none`,children:(0,P.jsxs)(`a`,{href:e.href,role:`menuitem`,className:qr.menuItem,target:`_blank`,rel:`noopener noreferrer`,children:[e.label,(0,P.jsx)(`span`,{className:qr.externalIcon,"aria-hidden":`true`,children:`↗`})]})},e.href))})})]})}var Qr={saveBtn:`_saveBtn_ek34s_3`,saveBtnSaved:`_saveBtnSaved_ek34s_25`,saveBtnLabel:`_saveBtnLabel_ek34s_35`,saveForm:`_saveForm_ek34s_50`,saveInput:`_saveInput_ek34s_56`,saveInputWarn:`_saveInputWarn_ek34s_72`,saveWarnLabel:`_saveWarnLabel_ek34s_76`,saveActionBtn:`_saveActionBtn_ek34s_82`};function $r(e){return e?`Saved: ${e}`:`Save Graph`}function ei({disabled:e,defaultName:t,savedName:n=null,onSave:r,nameExists:i,connected:a=!1}){let[o,s]=(0,j.useState)(!1),[c,l]=(0,j.useState)(``),u=(0,j.useRef)(null),d=(0,j.useRef)(null),f=(0,j.useRef)(!1),p=(0,j.useCallback)(()=>{l(t),s(!0)},[t]),m=(0,j.useCallback)(()=>{f.current=!0,s(!1),l(``)},[]),h=(0,j.useCallback)(()=>{let e=c.trim();e&&(r(e),f.current=!0,s(!1),l(``))},[c,r]),g=(0,j.useCallback)(e=>{e.key===`Enter`&&(e.preventDefault(),h()),e.key===`Escape`&&(e.preventDefault(),m())},[h,m]);return(0,j.useEffect)(()=>{o?u.current?.focus():f.current&&(f.current=!1,d.current?.focus())},[o]),o?(0,P.jsxs)(`div`,{className:Qr.saveForm,children:[(0,P.jsx)(`input`,{ref:u,className:`${Qr.saveInput}${i?.(c.trim())?` ${Qr.saveInputWarn}`:``}`,type:`text`,value:c,onChange:e=>l(e.target.value),onKeyDown:g,placeholder:`Enter a name…`,"aria-label":`Graph save name`,maxLength:80}),i?.(c.trim())&&(0,P.jsx)(`span`,{className:Qr.saveWarnLabel,role:`status`,children:`Overwrite?`}),(0,P.jsx)(`button`,{className:Qr.saveActionBtn,onClick:h,disabled:!c.trim(),"aria-label":`Confirm save`,children:`✅`}),(0,P.jsx)(`button`,{className:Qr.saveActionBtn,onClick:m,"aria-label":`Cancel save`,children:`❌`})]}):(0,P.jsxs)(`button`,{ref:d,className:`${Qr.saveBtn}${n?` ${Qr.saveBtnSaved}`:``}`,onClick:p,disabled:e||!a,title:e?`No graph loaded`:a?n?`Graph saved as ${n}. Click to save again`:`Export graph snapshot to server and save bookmark`:`Connect first to save`,"aria-label":n?`Graph saved as ${n}. Save again`:`Save graph snapshot`,children:[(0,P.jsx)(`span`,{"aria-hidden":`true`,children:n?`✅`:`💾`}),(0,P.jsx)(`span`,{className:Qr.saveBtnLabel,children:$r(n)})]})}var ti={empty:`_empty_tpeii_3`,hint:`_hint_tpeii_12`,list:`_list_tpeii_21`,row:`_row_tpeii_31`,rowInfo:`_rowInfo_tpeii_50`,rowName:`_rowName_tpeii_58`,rowMeta:`_rowMeta_tpeii_67`,rowActions:`_rowActions_tpeii_78`,loadBtn:`_loadBtn_tpeii_84`,deleteBtn:`_deleteBtn_tpeii_85`};function ni({savedGraphs:e,onLoad:t,onDelete:n,connected:r}){return(0,P.jsx)(Hr,{label:e.length>0?`Load Graph (${e.length})`:`Load Graph`,children:e.length===0?(0,P.jsx)(`p`,{className:ti.empty,children:`No saved graphs yet.`}):(0,P.jsxs)(P.Fragment,{children:[!r&&(0,P.jsx)(`p`,{className:ti.hint,children:`Connect to load a graph`}),(0,P.jsx)(`ul`,{className:ti.list,role:`list`,children:e.map(e=>(0,P.jsxs)(`li`,{className:ti.row,children:[(0,P.jsxs)(`div`,{className:ti.rowInfo,children:[(0,P.jsx)(`span`,{className:ti.rowName,title:e.name,children:e.name}),(0,P.jsx)(`span`,{className:ti.rowMeta,children:new Date(e.savedAt).toLocaleString()})]}),(0,P.jsxs)(`div`,{className:ti.rowActions,children:[(0,P.jsx)(`button`,{className:ti.loadBtn,onClick:()=>t(e.name),disabled:!r,title:r?`Run: import graph from ${e.name}`:`Connect to the playground first`,"aria-label":`Load graph ${e.name}`,children:`Load`}),(0,P.jsx)(`button`,{className:ti.deleteBtn,onClick:()=>n(e.name),title:`Remove "${e.name}" from local storage`,"aria-label":`Delete saved graph ${e.name}`,children:`Delete`})]})]},e.name))})]})})}var ri={payloadRoot:`_payloadRoot_6u47x_2`,labelRow:`_labelRow_6u47x_10`,label:`_label_6u47x_10`,payloadControls:`_payloadControls_6u47x_26`,charCounter:`_charCounter_6u47x_32`,typeIndicator:`_typeIndicator_6u47x_38`,validationIcon:`_validationIcon_6u47x_49`,formatButton:`_formatButton_6u47x_53`,uploadButton:`_uploadButton_6u47x_67`,textarea:`_textarea_6u47x_82`,textareaError:`_textareaError_6u47x_107`,errorMessage:`_errorMessage_6u47x_109`,sampleButtonsRow:`_sampleButtonsRow_6u47x_117`,sampleButtons:`_sampleButtons_6u47x_117`,sampleLabel:`_sampleLabel_6u47x_130`,sampleGroup:`_sampleGroup_6u47x_136`,sampleGroupLabel:`_sampleGroupLabel_6u47x_143`,sampleButton:`_sampleButton_6u47x_117`};function ii({onLoad:e}){let t=Object.keys(ge).filter(e=>e.startsWith(`json_`)),n=Object.keys(ge).filter(e=>e.startsWith(`xml_`)),r=e=>e.replace(/^(json|xml)_/,``).replace(/_/g,` `);return(0,P.jsxs)(`div`,{className:ri.sampleButtons,children:[(0,P.jsx)(`span`,{className:ri.sampleLabel,children:`Quick load:`}),(0,P.jsxs)(`div`,{className:ri.sampleGroup,children:[(0,P.jsx)(`span`,{className:ri.sampleGroupLabel,children:`JSON:`}),t.map(t=>(0,P.jsx)(`button`,{className:ri.sampleButton,onClick:()=>e(ge[t]),children:r(t)},t))]}),(0,P.jsxs)(`div`,{className:ri.sampleGroup,children:[(0,P.jsx)(`span`,{className:ri.sampleGroupLabel,children:`XML:`}),n.map(t=>(0,P.jsx)(`button`,{className:ri.sampleButton,onClick:()=>e(ge[t]),children:r(t)},t))]})]})}function ai({payload:e,onChange:t,validation:n,onFormat:r,onUpload:i}){return(0,P.jsxs)(`div`,{className:ri.payloadRoot,children:[(0,P.jsxs)(`div`,{className:ri.labelRow,children:[(0,P.jsx)(`label`,{htmlFor:`payload`,className:ri.label,children:`JSON/XML Payload`}),(0,P.jsxs)(`div`,{className:ri.payloadControls,children:[(0,P.jsxs)(`span`,{className:ri.charCounter,children:[`size: `,e.length]}),e&&n.type&&(0,P.jsx)(`span`,{className:ri.typeIndicator,children:n.type.toUpperCase()}),e&&(0,P.jsx)(`span`,{className:ri.validationIcon,children:n.valid?`✅`:`❌`}),(0,P.jsx)(`button`,{className:ri.formatButton,onClick:r,disabled:!e||n.type!==`json`,title:n.type===`xml`?`Format only available for JSON`:`Format JSON`,children:`Format`}),i!==void 0&&(0,P.jsx)(`button`,{className:ri.uploadButton,onClick:i,disabled:!e||!n.valid||n.type!==`json`,title:`Upload JSON payload to current session via REST`,children:`Upload`})]})]}),(0,P.jsx)(`textarea`,{id:`payload`,className:`${ri.textarea} ${n.valid?``:ri.textareaError}`,placeholder:`Paste your JSON/XML payload here`,value:e,onChange:e=>t(e.target.value)}),!n.valid&&(0,P.jsx)(`div`,{className:ri.errorMessage,children:n.error}),(0,P.jsx)(`div`,{className:ri.sampleButtonsRow,children:(0,P.jsx)(ii,{onLoad:t})})]})}var oi={Root:{icon:`🚀`,label:`Root`},End:{icon:`🏁`,label:`End`},Fetcher:{icon:`🌐`,label:`Fetcher`},mapper:{icon:`🗺️`,label:`Mapper`},Math:{icon:`🔢`,label:`Math`},JavaScript:{icon:`📜`,label:`JavaScript`},Provider:{icon:`🔌`,label:`Provider`},Dictionary:{icon:`📖`,label:`Dictionary`},Join:{icon:`🔀`,label:`Join`},Extension:{icon:`🧩`,label:`Extension`},Island:{icon:`🏝️`,label:`Island`},Decision:{icon:`❓`,label:`Decision`},Suspend:{icon:`⏸️`,label:`Suspend`},Resume:{icon:`▶️`,label:`Resume`},Suspensible:{icon:`⏯️`,label:`Suspensible`}},si={boxSizing:`border-box`,borderRadius:`8px`,borderWidth:`1.5px`,borderStyle:`solid`,background:`var(--bg-secondary, #1e1e2e)`,color:`var(--text-primary, #cdd6f4)`,fontSize:`0.75rem`,boxShadow:`0 2px 8px rgba(0,0,0,0.45)`,overflow:`visible`,padding:0},ci={Root:`#15803d`,End:`#dc2626`,Fetcher:`#2563eb`,mapper:`#ea580c`,Math:`#a16207`,JavaScript:`#7e22ce`,Provider:`#be185d`,Dictionary:`#0e7490`,Join:`#65a30d`,Extension:`#4338ca`,Island:`#475569`,Decision:`#b45309`,Suspend:`#0d9488`,Resume:`#0284c7`,Suspensible:`#c026d3`},li=`#6c7086`;function ui(e){return oi[e]??{icon:`📦`,label:e}}function di(e){return ci[e]??li}function fi(e){let t=ci[e]??li;return{...si,borderColor:t,"--node-accent":t}}var pi={content:`_content_1g9w1_8`,header:`_header_1g9w1_24`,icon:`_icon_1g9w1_44`,alias:`_alias_1g9w1_49`,badge:`_badge_1g9w1_55`,body:`_body_1g9w1_67`,bodyPeek:`_bodyPeek_1g9w1_77`,row:`_row_1g9w1_85`,label:`_label_1g9w1_98`,value:`_value_1g9w1_104`,edgeHandle:`_edgeHandle_1g9w1_118`,authoringRing:`_authoringRing_1g9w1_134`,authoringTargetOverlay:`_authoringTargetOverlay_1g9w1_197`,authoringTargetOverlayActive:`_authoringTargetOverlayActive_1g9w1_213`};function mi({label:e,value:t}){return(0,P.jsxs)(`div`,{className:pi.row,children:[(0,P.jsx)(`span`,{className:pi.label,children:e}),(0,P.jsx)(`span`,{className:pi.value,title:t,children:t})]})}function hi({properties:e}){let t=Object.entries(e).filter(([,e])=>e!=null);return t.length===0?null:(0,P.jsx)(P.Fragment,{children:t.map(([e,t])=>Array.isArray(t)?t.map((t,n)=>{let r=typeof t==`string`?t:JSON.stringify(t);return(0,P.jsx)(mi,{label:n===0?e:``,value:r},`${e}-${n}`)}):(0,P.jsx)(mi,{label:e,value:typeof t==`string`?t:JSON.stringify(t)},e))})}function gi({alias:e,nodeType:t,properties:n,compact:r=!1}){let i=ui(t);return(0,P.jsx)(j.Fragment,{children:(0,P.jsxs)(`div`,{className:pi.content,children:[(0,P.jsxs)(`div`,{className:pi.header,children:[(0,P.jsx)(`span`,{className:pi.icon,children:i.icon}),(0,P.jsx)(`span`,{className:pi.alias,children:e}),(0,P.jsx)(`span`,{className:pi.badge,children:i.label})]}),(0,P.jsx)(`div`,{className:r?`${pi.body} ${pi.bodyPeek}`:pi.body,children:(0,P.jsx)(hi,{properties:n})})]})})}function _i({id:e,data:t,isConnectable:n,selected:r}){let[i,a]=(0,j.useState)(!1),o=t.supportsConnectionAuthoring&&!i,c=p(),l=o&&c.inProgress&&c.fromNode?.id!==e;return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(y,{minWidth:180,minHeight:t.minHeight,isVisible:r,onResizeStart:()=>a(!0),onResizeEnd:()=>a(!1)}),t.targetHandles.map(({id:e,offset:t})=>(0,P.jsx)(s,{id:e,type:`target`,position:_.Left,isConnectable:n,className:pi.edgeHandle,style:{top:`calc(50% + ${t}px)`}},e)),t.backSourceHandles.map(({id:e,offset:t})=>(0,P.jsx)(s,{id:e,type:`source`,position:_.Left,isConnectable:n,className:pi.edgeHandle,style:{top:`calc(50% + ${t}px)`}},e)),(0,P.jsx)(gi,{alias:t.alias,nodeType:t.nodeType,properties:t.properties,compact:t.compact}),o&&(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(s,{id:`authoring-source`,type:`source`,position:_.Right,isConnectable:n,isConnectableEnd:!1,className:pi.authoringRing}),(0,P.jsx)(s,{id:`authoring-target`,type:`target`,position:_.Left,isConnectable:n,isConnectableStart:!1,className:l?`${pi.authoringTargetOverlay} ${pi.authoringTargetOverlayActive}`:pi.authoringTargetOverlay})]}),t.sourceHandles.map(({id:e,offset:t})=>(0,P.jsx)(s,{id:e,type:`source`,position:_.Right,isConnectable:n,className:pi.edgeHandle,style:{top:`calc(50% + ${t}px)`}},e)),t.backTargetHandles.map(({id:e,offset:t})=>(0,P.jsx)(s,{id:e,type:`target`,position:_.Right,isConnectable:n,className:pi.edgeHandle,style:{top:`calc(50% + ${t}px)`}},e))]})}var vi={Root:_i,End:_i,Fetcher:_i,mapper:_i,Math:_i,JavaScript:_i,Provider:_i,Dictionary:_i,Join:_i,Extension:_i,Island:_i,Decision:_i,default:_i},R={graphWrapper:`_graphWrapper_1pee8_15`,graphSurface:`_graphSurface_1pee8_24`,empty:`_empty_1pee8_30`,emptyIcon:`_emptyIcon_1pee8_43`,emptyCreateButton:`_emptyCreateButton_1pee8_48`,emptyHint:`_emptyHint_1pee8_70`,refreshingOverlay:`_refreshingOverlay_1pee8_135`,clipboardDropOverlay:`_clipboardDropOverlay_1pee8_147`,clipboardDropMessage:`_clipboardDropMessage_1pee8_160`,refreshingSpinner:`_refreshingSpinner_1pee8_175`,graphRefreshSpin:`_graphRefreshSpin_1pee8_1`,connectBanner:`_connectBanner_1pee8_189`,connectBannerCancel:`_connectBannerCancel_1pee8_209`,detailToggleIcon:`_detailToggleIcon_1pee8_248`,detailToggleHeader:`_detailToggleHeader_1pee8_259`,detailToggleLine:`_detailToggleLine_1pee8_266`},yi=class extends j.Component{constructor(...e){super(...e),this.state={caughtError:null}}static getDerivedStateFromError(e){return{caughtError:e instanceof Error?e.message:String(e)}}componentDidCatch(e,t){let n=e instanceof Error?e.message:String(e);console.error(`[GraphView] Render error:`,n,t.componentStack),this.props.onRenderError?.(`Graph render failed: ${n}`)}render(){return this.state.caughtError?(0,P.jsxs)(`div`,{className:R.empty,children:[(0,P.jsx)(`span`,{className:R.emptyIcon,children:`⚠️`}),(0,P.jsx)(`span`,{children:`Graph could not be rendered.`}),(0,P.jsx)(`span`,{children:this.state.caughtError})]}):this.props.children}},bi=[`fetch`,`details`,`ext-call`,`mapping`,`compute`,`calculate`,`evaluate`,`fork`,`join`,`one`,`two`,`three`,`more`,`done`,`complete`,`finish`,`positive`,`negative`],xi={fetch:`#0369a1`,details:`#0369a1`,"ext-call":`#0369a1`,mapping:`#b45309`,compute:`#b45309`,calculate:`#b45309`,evaluate:`#b45309`,fork:`#7e22ce`,join:`#7e22ce`,one:`#7e22ce`,two:`#6d28d9`,three:`#5b21b6`,more:`#4c1d95`,done:`#15803d`,complete:`#15803d`,finish:`#15803d`,positive:`#15803d`,negative:`#b91c1c`},Si=[`#0369a1`,`#15803d`,`#b45309`,`#7e22ce`,`#b91c1c`,`#0f766e`,`#c2410c`,`#a16207`];function Ci(e){let t=0;for(let n=0;n<e.length;n++)t=(t<<5)-t+e.charCodeAt(n),t|=0;return Math.abs(t)}function wi(e,t){if(e.length===0)return t;let n=e[0].trim().toLowerCase();return xi[n]||Si[Ci(n)%Si.length]}var Ti=240,Ei=100,Di=100,Oi=60,ki=360,Ai=120,ji=80,Mi=4,Ni=1e4,Pi=2e3,z=64,Fi=256,Ii=256,Li=512,Ri=.001,zi=8,Bi=16,Vi=`rgba(148, 163, 184, 0.42)`,Hi=`var(--bg-secondary)`,Ui=24,Wi=32;function Gi(e){return wi(e,Vi)}function Ki(e){return`source-${e}`}function qi(e){return`target-${e}`}function Ji(e){return`back-source-${e}`}function Yi(e){return`back-target-${e}`}function Xi(e,t){return t<=1?0:t===2?e===0?-24:Ui:(e-(t-1)/2)*Ui}function Zi(e,t=Ei){return e<=1?t:Math.max(t,(e-1)*Ui+Wi*2)}var Qi=40,$i=9,ea=18,ta=22;function na(e){let t=typeof e==`string`?e:JSON.stringify(e)??``;return Math.max(1,Math.ceil(t.length/ta))}function ra(e){let t=Qi;for(let n of Object.values(e.properties??{})){if(n==null)continue;let e=Array.isArray(n)?n:[n];for(let n of e)t+=$i+na(n)*ea}return Math.max(Ei,t)}var ia=new Set([`graph.math`,`graph.js`]),aa=[`Dictionary`,`Provider`,`Module`,`Entity`],oa={ROOT_TREE:0,DEFAULT_TREE:1,END_TREE:2};function sa(e){return e.alias.toLowerCase()===`root`||e.types.includes(`Root`)||e.types.includes(`entry_point`)}function ca(e){return e.alias.toLowerCase()===`end`||e.types.includes(`End`)}function la(e){return e.hasRoot?oa.ROOT_TREE:e.hasEnd?oa.END_TREE:oa.DEFAULT_TREE}function ua(e,t){let n=la(e)-la(t);return n===0?e.sortKey.localeCompare(t.sortKey):n}function da(e){return`real:${e}`}function fa(e){return new Map([...e].map(([e,t])=>[e,t.slice()]))}function pa(e){return new Map(e.map((e,t)=>[e.id,t]))}function ma(e,t,n){let r=(t.get(e)??[]).map(e=>n.get(e)).filter(e=>e!==void 0);if(r.length!==0)return r.reduce((e,t)=>e+t,0)/r.length}function ha(e,t,n){let r=pa(e);return e.slice().sort((e,i)=>{let a=ma(e.id,t,n),o=ma(i.id,t,n);if(a!==void 0&&o!==void 0){let e=a-o;if(Math.abs(e)>2**-52)return e}let s=r.get(e.id)-r.get(i.id);return s===0?e.stableKey.localeCompare(i.stableKey):s})}function ga(e,t){let n=Array(t+1).fill(0),r=e=>{let t=0;for(let r=e;r>0;r-=r&-r)t+=n[r];return t},i=e=>{for(let t=e;t<n.length;t+=t&-t)n[t]+=1},a=0;for(let t=e.length-1;t>=0;t--){let n=e[t]+1;a+=r(n-1),i(n)}return a}function _a(e,t){let n=new Map([...e].map(([e,t])=>[e,pa(t)])),r=new Map;for(let e of t)r.has(e.level)||r.set(e.level,[]),r.get(e.level).push(e);let i=0;for(let[e,t]of r){let r=n.get(e),a=n.get(e+1);if(!r||!a)continue;let o=t.map(e=>({sourceId:e.sourceId,targetId:e.targetId,sourcePosition:r.get(e.sourceId),targetPosition:a.get(e.targetId)})).sort((e,t)=>e.sourcePosition-t.sourcePosition||e.targetPosition-t.targetPosition||e.sourceId.localeCompare(t.sourceId)||e.targetId.localeCompare(t.targetId)).map(e=>e.targetPosition);i+=ga(o,a.size)}return i}function va(e,t,n){e.has(t)||e.set(t,[]),e.get(t).push(n)}function ya(e){return[e.source,e.target,...e.relations.map(e=>e.type)].join(`	`)}function ba(e,t){return e.nodeIntrusions<t.nodeIntrusions||e.nodeIntrusions===t.nodeIntrusions&&e.edgeCrossings<t.edgeCrossings}function xa(e){let t=new Map;for(let[n,r]of e){let e=-(r.reduce((e,t)=>e+t.height,0)+Math.max(0,r.length-1)*Oi)/2;for(let i of r)i.alias&&t.set(i.alias,{alias:i.alias,level:n,x:n*360,y:e,height:i.height}),e+=i.height+Oi}return t}function Sa(e,t,n,r,i){let a=1-i;return a*a*a*e+3*a*a*i*t+3*a*i*i*n+i*i*i*r}function Ca(e,t,n,r){let i=0,a=1;for(let o=0;o<32;o++){let o=(i+a)/2;Sa(e,t,t,n,o)<r?i=o:a=o}return(i+a)/2}function wa(e,t,n,r,i){let a=e.x+Ti,o=t.x,s=i.x+Ri,c=i.x+Ti-Ri;if(s>=o||c<=a)return null;let l=a+(o-a)/2,u=Ca(a,l,o,s),d=Ca(a,l,o,c),f=e.y+e.height/2+n,p=t.y+t.height/2+r,m=Sa(f,f,p,p,u),h=Sa(f,f,p,p,d);return{yLow:Math.min(m,h),yHigh:Math.max(m,h)}}function Ta(e,t,n,r,i){let a=wa(e,t,n,r,i);if(!a)return!1;let o=i.y+Ri,s=i.y+i.height-Ri;return a.yHigh>o&&a.yLow<s}function Ea(e,t){let n=new Map;for(let[e,r]of t)n.has(r)||n.set(r,[]),n.get(r).push(e);for(let e of n.values())e.sort();let r=[];for(let[i,a]of e.entries()){let e=t.get(a.source),o=t.get(a.target);if(!(e===void 0||o===void 0||o-e<=1)){for(let t=e+1;t<o;t++)for(let e of n.get(t)??[])if(r.push({connectionIndex:i,nodeAlias:e}),r.length>Pi)return null}}return r}function Da(e,t,n){let r=new Map,i=new Map;for(let e of t.keys())r.set(e,[]),i.set(e,[]);for(let[n,a]of e.entries()){let e=t.get(a.source),o=t.get(a.target);if(e===void 0||o===void 0)continue;let s=e>=o,c=ya(a);s?(i.get(a.source).push({connectionIndex:n,peerAlias:a.target,isBack:s,stableKey:c}),r.get(a.target).push({connectionIndex:n,peerAlias:a.source,isBack:s,stableKey:c})):(r.get(a.source).push({connectionIndex:n,peerAlias:a.target,isBack:s,stableKey:c}),i.get(a.target).push({connectionIndex:n,peerAlias:a.source,isBack:s,stableKey:c}))}let a=(e,t)=>n(e.peerAlias)-n(t.peerAlias)||e.peerAlias.localeCompare(t.peerAlias)||e.stableKey.localeCompare(t.stableKey)||e.connectionIndex-t.connectionIndex;for(let e of r.values())e.sort(a);for(let e of i.values())e.sort(a);let o=new Map,s=new Map;for(let e of r.values())for(let[t,n]of e.entries()){let r=Xi(t,e.length);n.isBack?s.set(n.connectionIndex,r):o.set(n.connectionIndex,r)}for(let e of i.values())for(let[t,n]of e.entries()){let r=Xi(t,e.length);n.isBack?o.set(n.connectionIndex,r):s.set(n.connectionIndex,r)}return{sourceOffsets:o,targetOffsets:s}}function Oa(e,t,n,r){let i=xa(e),{sourceOffsets:a,targetOffsets:o}=Da(n,t,e=>i.get(e)?.y??0),s=0;for(let{connectionIndex:e,nodeAlias:t}of r){let r=n[e],c=i.get(r.source),l=i.get(r.target),u=i.get(t);!c||!l||!u||Ta(c,l,a.get(e)??0,o.get(e)??0,u)&&(s+=1)}return s}function ka(e,t,n,r){let i=e=>t.map(t=>e.get(t).map(e=>e.id).join(`	`)).join(`
`),a=fa(e),o=1,s=a,c=n(a),l=[{candidate:a,depth:0}],u=new Set([i(a)]),d=0;for(;d<l.length&&o<r;){let{candidate:e,depth:a}=l[d++];if(!(a>=2))for(let d of t){let t=e.get(d);for(let f=0;f<t.length;f++){for(let p=0;p<t.length;p++){if(f===p)continue;let t=fa(e),m=t.get(d),[h]=m.splice(f,1);m.splice(p,0,h);let g=i(t);if(u.has(g))continue;u.add(g);let _=n(t);if(o+=1,ba(_,c)&&(s=t,c=_),a+1<2&&l.push({candidate:t,depth:a+1}),o>=r)break}if(o>=r)break}if(o>=r)break}}for(let n of t)e.set(n,s.get(n).slice());return o}function Aa(e,t,n,r){let i=new Map;for(let[t,n]of e)i.has(n)||i.set(n,[]),i.get(n).push({id:da(t),alias:t,height:r.get(t)??Ei,stableKey:`real:${t}`});for(let e of i.values())e.sort((e,t)=>e.stableKey.localeCompare(t.stableKey));let a=fa(i),o=fa(i),s=t.map((t,n)=>({connectionIndex:n,source:t.source,target:t.target,sourceLevel:e.get(t.source),targetLevel:e.get(t.target),stableKey:ya(t)})).filter(e=>e.sourceLevel!==void 0&&e.targetLevel!==void 0&&!n.has(`${e.source}\t${e.target}`)&&e.sourceLevel<e.targetLevel).sort((e,t)=>e.source.localeCompare(t.source)||e.target.localeCompare(t.target)||e.stableKey.localeCompare(t.stableKey)||e.connectionIndex-t.connectionIndex),c=s.reduce((e,t)=>e+(t.targetLevel-t.sourceLevel),0)<=Ni,l=new Map,u=new Map,d=[];for(let[e,t]of s.entries()){let n=t.sourceLevel,r=t.targetLevel;if(!c&&r-n>1)continue;let i=da(t.source),a=n;for(let s=n+1;s<r;s++){let n=`dummy:${t.source}\t${t.target}\t${e}\t${s}`;o.has(s)||o.set(s,[]),o.get(s).push({id:n,height:Ei,stableKey:n}),d.push({sourceId:i,targetId:n,level:a}),va(u,i,n),va(l,n,i),i=n,a=s}let s=da(t.target);d.push({sourceId:i,targetId:s,level:a}),va(u,i,s),va(l,s,i)}for(let e of o.values())e.sort((e,t)=>e.stableKey.localeCompare(t.stableKey));let f=[...o.keys()].sort((e,t)=>e-t);if(f.length<=1||d.length===0)return a;let p=fa(o),m=fa(o),h=Ea(t,e),g=h?.length??2001,_=h!==null,v=n=>({nodeIntrusions:_?Oa(n,e,t,h??[]):0,edgeCrossings:_a(n,d)}),y=v(m),b=()=>{let e=v(p);ba(e,y)&&(y=e,m=fa(p))},x=[...o.values()].reduce((e,t)=>e+t.length,0)<=z&&d.length<=Fi&&g<=Ii,S=0,C=()=>{let e=Li-S;!x||e<=1||(S+=ka(p,f,v,e),b())};for(let e=0;e<Mi;e++){for(let e=1;e<f.length;e++){let t=f[e],n=f[e-1];p.set(t,ha(p.get(t),l,pa(p.get(n))))}b(),C();for(let e=f.length-2;e>=0;e--){let t=f[e],n=f[e+1];p.set(t,ha(p.get(t),u,pa(p.get(n))))}b(),C()}return _&&Oa(a,e,t,h??[])<y.nodeIntrusions?a:m}function ja(e,t,n,r,i){let a=n.slice().sort((e,n)=>ya(t[e.connectionIndex]).localeCompare(ya(t[n.connectionIndex]))||e.nodeAlias.localeCompare(n.nodeAlias)||e.connectionIndex-n.connectionIndex);for(let{connectionIndex:n,nodeAlias:o}of a){let a=t[n],s=e.get(a.source),c=e.get(a.target),l=e.get(o);if(!s||!c||!l)continue;let u=wa(s,c,r.get(n)??0,i.get(n)??0,l);if(!u)continue;let d=l.y+Ri,f=l.y+l.height-Ri;if(u.yHigh<=d||u.yLow>=f)continue;let p=u.yHigh+Bi-l.y,m=l.y+l.height-(u.yLow-Bi);return p<=m?{x:l.x,y:l.y,delta:p,direction:1}:{x:l.x,y:l.y,delta:m,direction:-1}}return null}function Ma(e,t,n,r){let i=Ea(n,t);if(!(i===null||i.length===0))for(let a=0;a<zi;a++){let a=new Map;for(let[n,i]of e){let e=t.get(n);e!==void 0&&a.set(n,{alias:n,level:e,x:i.x,y:i.y,height:r.get(n)??Ei})}let{sourceOffsets:o,targetOffsets:s}=Da(n,t,e=>a.get(e)?.y??0),c=ja(a,n,i,o,s);if(!c)return;for(let[t,n]of e)n.x===c.x&&(c.direction===1?n.y>=c.y:n.y<=c.y)&&e.set(t,{x:n.x,y:n.y+c.delta*c.direction})}}function Na(e,t){if(t.has(e.alias))return`flow`;let n=e.types[0]??``,r=typeof e.properties.skill==`string`?e.properties.skill:void 0;return n===`Dictionary`?`Dictionary`:n===`Provider`?`Provider`:r&&ia.has(r)?`Module`:r?`__unknown__`:`Entity`}function Pa(e,t,n){let r=new Set;for(let e of t??[])r.add(e.source),r.add(e.target);let i=[],a=[],o=new Map;for(let t of e){let e=Na(t,r);o.set(t.alias,e),e===`flow`?i.push(t):a.push(t)}let s=new Set(i.map(e=>e.alias)),c=new Map(i.map(e=>[e.alias,e])),l=new Map,u=new Map,d=new Map;for(let e of i)l.set(e.alias,[]),u.set(e.alias,new Set),d.set(e.alias,0);for(let e of t??[])!s.has(e.source)||!s.has(e.target)||(l.get(e.source)?.push(e.target),u.get(e.source)?.add(e.target),u.get(e.target)?.add(e.source),d.set(e.target,(d.get(e.target)??0)+1));for(let e of l.values())e.sort();let f=i.filter(e=>d.get(e.alias)===0||e.types.includes(`entry_point`)||sa(e)).map(e=>e.alias).sort(),p=new Set;{let e=new Map;for(let t of i)e.set(t.alias,0);function t(t){if(e.get(t)!==0)return;e.set(t,1);let n=[{node:t,childIdx:0}];for(;n.length>0;){let t=n[n.length-1],r=l.get(t.node)??[];if(t.childIdx>=r.length){e.set(t.node,2),n.pop();continue}let i=r[t.childIdx++],a=e.get(i);a===1?p.add(`${t.node}\t${i}`):a===0&&(e.set(i,1),n.push({node:i,childIdx:0}))}}for(let e of f)t(e);for(let e of[...s].sort())t(e)}let m=[],h=new Set;for(let e of Array.from(s).sort()){if(h.has(e))continue;let t=[],n=[e];for(h.add(e);n.length>0;){let e=n.pop();t.push(e);for(let t of u.get(e)??[])h.has(t)||(h.add(t),n.push(t))}t.sort();let r=t.map(e=>c.get(e)).filter(e=>!!e);m.push({aliases:t,nodes:r,hasRoot:r.some(sa),hasEnd:r.some(ca),sortKey:t[0]??``})}m.sort(ua);let g=new Map;m.forEach((e,t)=>{e.aliases.forEach(e=>g.set(e,t))});let _=m.map(()=>[]);for(let e of t){let t=g.get(e.source),n=g.get(e.target);t!==void 0&&t===n&&_[t].push(e)}let v=new Map,y=new Map,b=0,x=0;for(let[e,t]of m.entries()){let r=new Set(t.aliases),i=t.nodes.filter(e=>d.get(e.alias)===0||e.types.includes(`entry_point`)||sa(e)).map(e=>e.alias).sort();i.length===0&&t.aliases.length>0&&i.push(t.aliases[0]);let a=new Map,o=[...i];i.forEach(e=>a.set(e,0));let s=0;for(;s<o.length;){let e=o[s++],t=a.get(e)??0;for(let n of l.get(e)??[])r.has(n)&&(p.has(`${e}\t${n}`)||(!a.has(n)||a.get(n)<=t)&&(a.set(n,t+1),o.push(n)))}let c=a.size>0?Math.max(...a.values()):0;for(let e of t.aliases)a.has(e)||a.set(e,c+1);let u=Aa(a,_[e],p,n),f=x;for(let[e,t]of[...u].sort(([e],[t])=>e-t)){let n=-(t.reduce((e,t)=>e+t.height,0)+Math.max(0,t.length-1)*Oi)/2,r=b+e,i=x+e*360;f=Math.max(f,i);for(let e of t)e.alias&&(v.set(e.alias,r),y.set(e.alias,{x:i,y:n})),n+=e.height+Oi}let m=a.size>0?Math.max(...a.values()):0;b+=m+1,x=f+Ti+ki}Ma(y,v,t,n);let S=0;for(let[e,t]of y)S=Math.max(S,t.y+(n.get(e)??Ei));let C=S+(y.size>0?Ai:0),w=new Map;for(let e of aa)w.set(e,[]);w.set(`__unknown__`,[]);for(let e of a){let t=o.get(e.alias);w.get(t).push(e.alias)}for(let e of[...aa,`__unknown__`]){let t=(w.get(e)??[]).slice().sort();if(t.length===0)continue;let r=t.reduce((e,t)=>Math.max(e,n.get(t)??Ei),0);t.forEach((e,t)=>{y.set(e,{x:0+t*360,y:C})}),C+=r+ji}return{positions:y,levelOf:v}}function Fa(e,t,n){let r=new Map,i=new Map;for(let e of t)r.set(e.source,(r.get(e.source)??0)+1),i.set(e.target,(i.get(e.target)??0)+1);return new Map(e.map(e=>{let t=Zi(Math.max(r.get(e.alias)??0,i.get(e.alias)??0),n?Di:Ei);return[e.alias,n?t:Math.max(t,ra(e))]}))}function Ia(e,t,n={}){let r=e.connections??[],i=Fa(e.nodes,r,n.compactNodes===!0);for(let[e,n]of t)i.has(e)&&Number.isFinite(n)&&n>0&&i.set(e,n);return Pa(e.nodes,r,i).positions}function La(e,t={}){let n=e.connections??[],r=t.supportsConnectionAuthoring===!0,i=t.compactNodes===!0,a=Fa(e.nodes,n,i),{positions:o,levelOf:s}=Pa(e.nodes,n,a),c=new Set;for(let[e,t]of n.entries()){let n=s.get(t.source),r=s.get(t.target);n!==void 0&&r!==void 0&&n>=r&&c.add(e)}let l=new Map,d=new Map;for(let t of e.nodes)l.set(t.alias,[]),d.set(t.alias,[]);for(let[e,t]of n.entries()){let n=ya(t);c.has(e)?(d.get(t.source).push({connIndex:e,peerAlias:t.target,isBack:!0,stableKey:n}),l.get(t.target).push({connIndex:e,peerAlias:t.source,isBack:!0,stableKey:n})):(l.get(t.source).push({connIndex:e,peerAlias:t.target,isBack:!1,stableKey:n}),d.get(t.target).push({connIndex:e,peerAlias:t.source,isBack:!1,stableKey:n}))}let f=e=>o.get(e)?.y??0,p=(e,t)=>f(e.peerAlias)-f(t.peerAlias)||e.peerAlias.localeCompare(t.peerAlias)||e.stableKey.localeCompare(t.stableKey)||e.connIndex-t.connIndex;for(let e of l.values())e.sort(p);for(let e of d.values())e.sort(p);let m=new Map,h=new Map,g=e.nodes.map(e=>{let t=l.get(e.alias)??[],n=d.get(e.alias)??[],s=Zi(Math.max(t.length,n.length),i?Di:Ei),c=Math.max(s,a.get(e.alias)??Ei),u=[],f=[],p=0,g=0;for(let e=0;e<t.length;e++){let n=t[e],r=Xi(e,t.length);if(n.isBack){let e=Yi(g++);f.push({id:e,offset:r}),h.set(n.connIndex,e)}else{let e=Ki(p++);u.push({id:e,offset:r}),m.set(n.connIndex,e)}}let _=[],v=[],y=0,b=0;for(let e=0;e<n.length;e++){let t=n[e],r=Xi(e,n.length);if(t.isBack){let e=Ji(b++);v.push({id:e,offset:r}),m.set(t.connIndex,e)}else{let e=qi(y++);_.push({id:e,offset:r}),h.set(t.connIndex,e)}}return{id:e.alias,type:e.types[0]??`default`,className:`nokey`,position:o.get(e.alias)??{x:0,y:0},width:Ti,...i?{height:c}:{initialHeight:c},style:{...fi(e.types[0]??`unknown`),minHeight:s},data:{alias:e.alias,nodeType:e.types[0]??`unknown`,properties:e.properties,sourceHandles:u,targetHandles:_,backSourceHandles:v,backTargetHandles:f,supportsConnectionAuthoring:r,compact:i,minHeight:s}}}),_=[];for(let[e,t]of n.entries()){let n=t.relations.map(e=>e.type),r=`${t.source}__${t.target}__${e}`,i=Gi(n);_.push({id:r,source:t.source,target:t.target,sourceHandle:m.get(e),targetHandle:h.get(e),label:n.join(`, `),type:`bezier`,markerEnd:{type:u.ArrowClosed,width:16,height:16,color:Vi},style:{stroke:Vi,strokeWidth:2},labelStyle:{fill:i,fontSize:10,fontWeight:700},labelBgStyle:{fill:Hi,fillOpacity:.94,stroke:`rgba(15, 23, 42, 0.16)`,strokeWidth:1},labelBgPadding:[5,2],labelBgBorderRadius:6,data:{relationTypes:n}})}return{nodes:g,edges:_}}var Ra=`application/x-minigraph-clipboard-item`;function za(e){return e.includes(Ra)}function Ba(e,t){e.effectAllowed=`copy`,e.setData(Ra,t)}function Va(e){let t=e?.getData(`application/x-minigraph-clipboard-item`)??``;return t.trim()?t:null}function Ha(e,t){return e.nodes.find(e=>e.alias===t)}function Ua(e,t){return(e.connections??[]).filter(e=>e.source!==e.target&&(e.source===t||e.target===t))}var Wa={viewBox:`0 0 16 16`,width:16,height:16,fill:`none`,stroke:`currentColor`,strokeWidth:1.5,strokeLinecap:`round`,strokeLinejoin:`round`,focusable:`false`};function Ga(e){return(0,P.jsxs)(`svg`,{...Wa,...e,children:[(0,P.jsx)(`path`,{d:`M8 1.75 13.25 4.75v6.5L8 14.25l-5.25-3v-6.5L8 1.75Z`}),(0,P.jsx)(`path`,{d:`m2.95 4.9 5.05 2.9 5.05-2.9M8 7.8v6.15`})]})}function Ka(e){return(0,P.jsx)(`svg`,{...Wa,...e,children:(0,P.jsx)(`path`,{d:`m5.25 3 6.5 5-6.5 5V3Z`})})}function qa(e){return(0,P.jsxs)(`svg`,{...Wa,...e,children:[(0,P.jsx)(`rect`,{x:`5`,y:`2`,width:`8.5`,height:`9`,rx:`1.25`}),(0,P.jsx)(`path`,{d:`M10.75 14h-7A1.25 1.25 0 0 1 2.5 12.75V6A1.25 1.25 0 0 1 3.75 4.75H5`})]})}var Ja={toolbar:`_toolbar_stok4_2`,nameGroup:`_nameGroup_stok4_17`,graphName:`_graphName_stok4_24`,stats:`_stats_stok4_33`,toolbarActions:`_toolbarActions_stok4_53`,runControls:`_runControls_stok4_59`,tooltipAnchor:`_tooltipAnchor_stok4_65`,actionTooltip:`_actionTooltip_stok4_76`,toolbarButton:`_toolbarButton_stok4_116`,toolbarIconButton:`_toolbarIconButton_stok4_134`,toolbarIcon:`_toolbarIcon_stok4_134`};function Ya({graphData:e,graphName:t,onCopySuccess:n,onCopyError:r,extraActions:i}){let a=(0,j.useCallback)(()=>{e&&navigator.clipboard.writeText(JSON.stringify(e,null,2)).then(()=>n?.()).catch(()=>r?.())},[e,n,r]),o=e?.nodes.length??0,s=(e?.connections??[]).length;return(0,P.jsxs)(`div`,{className:Ja.toolbar,children:[(0,P.jsxs)(`div`,{className:Ja.nameGroup,children:[(0,P.jsx)(`span`,{className:Ja.graphName,children:t??`Untitled`}),(0,P.jsxs)(`span`,{className:Ja.stats,children:[o,` node`,o===1?``:`s`,` · `,s,` connection`,s===1?``:`s`]})]}),(0,P.jsxs)(`div`,{className:Ja.toolbarActions,children:[i,(0,P.jsx)(`button`,{type:`button`,className:`${Ja.toolbarButton} ${Ja.toolbarIconButton}`,onClick:a,title:`Copy raw graph JSON to clipboard`,"aria-label":`Copy raw graph JSON to clipboard`,children:(0,P.jsx)(qa,{className:Ja.toolbarIcon,"aria-hidden":`true`,focusable:`false`})})]})]})}var Xa=new Set([`instantiating`,`requesting-input`,`awaiting-input`,`outcome-uncertain`]);function Za(e){switch(e){case`instantiating`:return`Instantiating…`;case`requesting-input`:return`Preparing…`;case`awaiting-input`:return`Input required`;case`outcome-uncertain`:return`Waiting…`;default:return`Instantiate`}}function Qa(e){switch(e){case`instantiating`:return`Graph is being instantiated`;case`requesting-input`:return`Graph input is being prepared`;case`awaiting-input`:return`Graph is waiting for input`;case`outcome-uncertain`:return`Waiting for the backend graph outcome`;default:return`Instantiate graph`}}function $a(e){switch(e){case`instantiating`:return`Graph is being instantiated`;case`requesting-input`:return`Preparing graph input`;case`awaiting-input`:return`Complete or cancel the mock graph input panel`;case`running`:return`Graph is running`;case`outcome-uncertain`:return`Waiting for the backend graph outcome`;default:return``}}function eo(e,t){return t?`${e} ${/[.!?]$/.test(t)?t:`${t}.`}`:e}function to({id:e,text:t,keyboardFallback:n,children:r}){let[i,a]=(0,j.useState)(!1),[o,s]=(0,j.useState)(!1);return(0,P.jsxs)(`span`,{className:Ja.tooltipAnchor,onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),onFocusCapture:()=>s(!0),onBlurCapture:e=>{e.currentTarget.contains(e.relatedTarget)||s(!1)},tabIndex:n?0:void 0,"aria-describedby":n?e:void 0,children:[r,(0,P.jsx)(`span`,{id:e,className:Ja.actionTooltip,role:`tooltip`,"data-state":i||o?`open`:`closed`,children:t})]})}function no({phase:e,canInstantiate:t,canRun:n,disabledReason:r,onInstantiate:i,onRun:a}){let o=(0,j.useId)(),s=`${o}-instantiate`,c=`${o}-run`,l=Xa.has(e),u=$a(e),d=r||u||(e===`ready`?`The graph is already instantiated`:``),f=r||u||(n?``:`Instantiate the graph first`),p=eo(`Prepare the current graph to run and add input if required.`,d),m=eo(`Run the graph after it has been instantiated.`,f);return(0,P.jsxs)(`div`,{className:Ja.runControls,role:`group`,"aria-label":`Graph run controls`,children:[(0,P.jsx)(to,{id:s,text:p,keyboardFallback:!t,children:(0,P.jsxs)(`button`,{type:`button`,className:Ja.toolbarButton,onClick:i,disabled:!t,"aria-label":Qa(e),"aria-describedby":s,"aria-busy":l,children:[(0,P.jsx)(Ga,{className:Ja.toolbarIcon,"aria-hidden":`true`,focusable:`false`}),(0,P.jsx)(`span`,{children:Za(e)})]})}),(0,P.jsx)(to,{id:c,text:m,keyboardFallback:!n,children:(0,P.jsxs)(`button`,{type:`button`,className:Ja.toolbarButton,onClick:a,disabled:!n,"aria-label":e===`ready`?`Run instantiated graph`:e===`running`?`Graph is running`:`Run graph`,"aria-describedby":c,"aria-busy":e===`running`,children:[(0,P.jsx)(Ka,{className:Ja.toolbarIcon,"aria-hidden":`true`,focusable:`false`}),(0,P.jsx)(`span`,{children:e===`running`?`Running…`:`Run`})]})})]})}var ro={menu:`_menu_13qxg_1`,menuItem:`_menuItem_13qxg_12`};function io({open:e,x:t,y:n,canCreateNode:r,onCreateNode:i,onClose:a}){let o=(0,j.useRef)(null),s=(0,j.useRef)(null);return(0,j.useEffect)(()=>{if(!e)return;s.current?.focus();let t=e=>{o.current&&!o.current.contains(e.target)&&a()},n=e=>{e.key===`Escape`&&(e.preventDefault(),a())};return document.addEventListener(`pointerdown`,t),document.addEventListener(`keydown`,n),()=>{document.removeEventListener(`pointerdown`,t),document.removeEventListener(`keydown`,n)}},[e,a]),e?(0,P.jsx)(`div`,{ref:o,className:ro.menu,style:{left:t,top:n},role:`menu`,"aria-label":`Graph actions`,children:(0,P.jsx)(`button`,{ref:s,role:`menuitem`,type:`button`,className:ro.menuItem,disabled:!r,onClick:()=>{r&&(i(),a())},children:`Create Node`})}):null}var ao={menu:`_menu_1trgd_1`,menuItem:`_menuItem_1trgd_12`,dangerItem:`_dangerItem_1trgd_38`,confirmation:`_confirmation_1trgd_51`,confirmationText:`_confirmationText_1trgd_57`,confirmationActions:`_confirmationActions_1trgd_65`},oo=8;function so(e){let{open:t,x:n,y:r,onClose:i}=e,[a,o]=(0,j.useState)(!1),[s,c]=(0,j.useState)({left:n,top:r}),l=(0,j.useRef)(null),u=(0,j.useRef)(null),d=(0,j.useRef)(null),f=e.mode===`multi-node`?e.selectedCount:null,p=f!==null&&f>1,m=e.mode===`multi-node`?p&&e.canClipSelectedNodes:e.canClipNode,h=e.mode===`single-node`&&e.canConnectNode,g=e.mode===`single-node`&&e.canEditNode,_=e.mode===`multi-node`?p&&e.canDeleteSelectedNodes:e.canDeleteNode,v=m||h||g||_,y=p?`${f} selected nodes`:e.mode===`single-node`?e.nodeAlias:``;return(0,j.useLayoutEffect)(()=>{t&&o(!1)},[t,y,n,r]),(0,j.useLayoutEffect)(()=>{if(!t)return;let e=l.current;if(!e){c({left:n,top:r});return}let i=e.getBoundingClientRect(),a=Math.max(oo,window.innerWidth-i.width-oo),o=Math.max(oo,window.innerHeight-i.height-oo);c({left:Math.min(Math.max(n,oo),a),top:Math.min(Math.max(r,oo),o)})},[m,_,g,a,t,y,n,r]),(0,j.useEffect)(()=>{if(!t){o(!1);return}a?d.current?.focus():u.current?.focus()},[a,t]),(0,j.useEffect)(()=>{if(!t)return;let e=e=>{l.current&&!l.current.contains(e.target)&&i()},n=e=>{e.key===`Escape`&&(e.preventDefault(),i())},r=()=>i();return document.addEventListener(`pointerdown`,e),document.addEventListener(`keydown`,n),window.addEventListener(`scroll`,r,!0),window.addEventListener(`resize`,r),()=>{document.removeEventListener(`pointerdown`,e),document.removeEventListener(`keydown`,n),window.removeEventListener(`scroll`,r,!0),window.removeEventListener(`resize`,r)}},[i,t]),!t||!v?null:(0,P.jsx)(`div`,{ref:l,className:ao.menu,style:{left:s.left,top:s.top},role:`menu`,"aria-label":p?`Actions for ${f} selected nodes`:`Node actions for ${y}`,children:a?(0,P.jsxs)(`div`,{className:ao.confirmation,role:`group`,"aria-label":`Confirm delete ${y}`,children:[(0,P.jsx)(`div`,{className:ao.confirmationText,children:p?`Delete ${f} selected nodes?`:`Delete "${y}"?`}),(0,P.jsxs)(`div`,{className:ao.confirmationActions,children:[(0,P.jsx)(`button`,{ref:d,type:`button`,className:`${ao.menuItem} ${ao.dangerItem}`,onClick:()=>{e.mode===`multi-node`?e.onDeleteSelectedNodes():e.onDeleteNode(),i()},children:`Delete`}),(0,P.jsx)(`button`,{type:`button`,className:ao.menuItem,onClick:()=>o(!1),children:`Cancel`})]})]}):(0,P.jsxs)(P.Fragment,{children:[m&&(0,P.jsx)(`button`,{ref:u,role:`menuitem`,type:`button`,className:ao.menuItem,onClick:()=>{e.mode===`multi-node`?e.onClipSelectedNodes():e.onClipNode(),i()},children:p?`Clip ${f} selected nodes to Workspace`:`Clip to Workspace`}),h&&e.mode===`single-node`&&(0,P.jsx)(`button`,{ref:m?void 0:u,role:`menuitem`,type:`button`,className:ao.menuItem,onClick:()=>{e.onConnectNode(),i()},children:`Connect to…`}),g&&e.mode===`single-node`&&(0,P.jsx)(`button`,{ref:m||h?void 0:u,role:`menuitem`,type:`button`,className:ao.menuItem,onClick:()=>{e.onEditNode(),i()},children:`Edit Node`}),_&&(0,P.jsx)(`button`,{ref:!m&&!h&&!g?u:void 0,role:`menuitem`,type:`button`,className:`${ao.menuItem} ${ao.dangerItem}`,onClick:()=>o(!0),children:p?`Delete ${f} selected nodes`:`Delete Node`})]})})}var co=8;function lo({open:e,x:t,y:n,sourceAlias:r,targetAlias:i,relations:a,onDeleteRelation:o,onClose:s}){let[c,l]=(0,j.useState)({left:t,top:n}),u=(0,j.useRef)(null),d=(0,j.useRef)(null);return(0,j.useLayoutEffect)(()=>{if(!e)return;let r=u.current;if(!r){l({left:t,top:n});return}let i=r.getBoundingClientRect(),a=Math.max(co,window.innerWidth-i.width-co),o=Math.max(co,window.innerHeight-i.height-co);l({left:Math.min(Math.max(t,co),a),top:Math.min(Math.max(n,co),o)})},[e,a,t,n]),(0,j.useEffect)(()=>{e&&d.current?.focus()},[e]),(0,j.useEffect)(()=>{if(!e)return;let t=e=>{u.current&&!u.current.contains(e.target)&&s()},n=e=>{e.key===`Escape`&&(e.preventDefault(),s())},r=()=>s();return document.addEventListener(`pointerdown`,t),document.addEventListener(`keydown`,n),window.addEventListener(`scroll`,r,!0),window.addEventListener(`resize`,r),()=>{document.removeEventListener(`pointerdown`,t),document.removeEventListener(`keydown`,n),window.removeEventListener(`scroll`,r,!0),window.removeEventListener(`resize`,r)}},[s,e]),!e||a.length===0?null:(0,P.jsxs)(`div`,{ref:u,className:ao.menu,style:{left:c.left,top:c.top},role:`menu`,"aria-label":`Connection actions for ${r} → ${i}`,children:[a.map((e,t)=>(0,P.jsxs)(`button`,{ref:t===0?d:void 0,role:`menuitem`,type:`button`,className:`${ao.menuItem} ${ao.dangerItem}`,onClick:()=>{o(e),s()},children:[`Delete '`,e,`'`]},`${e}-${t}`)),a.length>1&&(0,P.jsxs)(`button`,{role:`menuitem`,type:`button`,className:`${ao.menuItem} ${ao.dangerItem}`,onClick:()=>{o(void 0),s()},children:[`Delete all (`,a.length,`)`]})]})}var B={island:`_island_had6p_6`,islandDragging:`_islandDragging_had6p_18`,islandGrip:`_islandGrip_had6p_22`,islandGripDots:`_islandGripDots_had6p_46`,islandGripLabel:`_islandGripLabel_had6p_51`,minimap:`_minimap_had6p_55`,controls:`_controls_had6p_59`,toggleButton:`_toggleButton_had6p_63`,toggleIcon:`_toggleIcon_had6p_68`},uo={Root:`#15803d`,End:`#dc2626`,Fetcher:`#2563eb`,mapper:`#ea580c`,Math:`#a16207`,JavaScript:`#7e22ce`,Provider:`#be185d`,Dictionary:`#0e7490`,Join:`#65a30d`,Extension:`#4338ca`,Island:`#475569`,Decision:`#b45309`},fo={left:50,bottom:15},V=8,H=`graph-minimap-position`;function po(e){return uo[e.type??``]??`#6c7086`}function mo(e){return e instanceof Element&&e.closest(`input, textarea, select, [contenteditable]:not([contenteditable="false"])`)!==null}function ho(e,t,n){if(t.clientWidth<=0||t.clientHeight<=0||n.offsetWidth<=0||n.offsetHeight<=0)return e;let r=Math.max(t.clientWidth-n.offsetWidth-V,V),i=Math.max(t.clientHeight-n.offsetHeight-V,V);return{left:Math.min(Math.max(e.left,V),r),bottom:Math.min(Math.max(e.bottom,V),i)}}function go({open:e,onOpenChange:t,hotkeyEnabled:n,children:r}){let i=e?`Hide minimap`:`Show minimap`,a=(0,j.useCallback)(()=>{t(!e)},[t,e]);(0,j.useEffect)(()=>{if(!n)return;let e=e=>{e.defaultPrevented||e.repeat||!e.ctrlKey||e.metaKey||e.altKey||e.shiftKey||e.code!==`KeyM`||mo(e.target)||(e.preventDefault(),a())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[n,a]);let[o,s]=pe(H,fo),c=(0,j.useRef)(null),[l,u]=(0,j.useState)(null),d=(0,j.useCallback)(e=>{e.pointerType===`mouse`&&e.button!==0||(e.preventDefault(),u({pointerId:e.pointerId,startX:e.clientX,startY:e.clientY,origin:o}))},[o]);return(0,j.useEffect)(()=>{if(l===null)return;let e=e=>{if(e.pointerId!==l.pointerId)return;let t=c.current,n=t?.offsetParent instanceof HTMLElement?t.offsetParent:null,r={left:l.origin.left+(e.clientX-l.startX),bottom:l.origin.bottom-(e.clientY-l.startY)};s(t&&n?ho(r,n,t):r)},t=e=>{e.pointerId===l.pointerId&&u(null)};return window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`pointercancel`,t),()=>{window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`pointercancel`,t)}},[l,s]),(0,j.useEffect)(()=>{if(!e)return;let t=c.current,n=t?.offsetParent instanceof HTMLElement?t.offsetParent:null;if(!t||!n)return;let r=()=>{s(e=>{let r=ho(e,n,t);return r.left===e.left&&r.bottom===e.bottom?e:r})};if(r(),typeof ResizeObserver>`u`)return;let i=new ResizeObserver(r);return i.observe(n),()=>i.disconnect()},[e,s]),(0,P.jsxs)(P.Fragment,{children:[e&&(0,P.jsxs)(`div`,{ref:c,className:l===null?B.island:`${B.island} ${B.islandDragging}`,style:{left:o.left,bottom:o.bottom},role:`group`,"aria-label":`Graph minimap`,children:[(0,P.jsxs)(`div`,{className:B.islandGrip,role:`button`,"aria-label":`Move minimap`,title:`Drag to move the minimap`,onPointerDown:d,children:[(0,P.jsx)(`span`,{className:B.islandGripDots,"aria-hidden":`true`,children:`⠿`}),(0,P.jsx)(`span`,{className:B.islandGripLabel,children:`Minimap`})]}),(0,P.jsx)(g,{className:B.minimap,nodeColor:po,maskColor:`rgba(0,0,0,0.3)`,pannable:!0,style:{position:`relative`,margin:0,background:`#fff`}})]}),(0,P.jsxs)(f,{position:`bottom-left`,showInteractive:!1,className:B.controls,children:[r,(0,P.jsx)(v,{className:`${B.toggleButton} nodrag nopan`,"aria-label":i,"aria-keyshortcuts":`Control+M`,"aria-pressed":e,title:`${i} (Ctrl + M)`,onClick:a,children:(0,P.jsxs)(`svg`,{className:B.toggleIcon,viewBox:`1.5 2 17 16`,fill:`none`,"aria-hidden":`true`,focusable:`false`,children:[(0,P.jsx)(`rect`,{x:`2.5`,y:`3`,width:`15`,height:`14`,rx:`1.5`}),(0,P.jsx)(`path`,{d:`M6 12.5 9 8l2.5 2 2.5-3`}),(0,P.jsx)(`circle`,{cx:`6`,cy:`12.5`,r:`1`}),(0,P.jsx)(`circle`,{cx:`9`,cy:`8`,r:`1`}),(0,P.jsx)(`circle`,{cx:`11.5`,cy:`10`,r:`1`}),(0,P.jsx)(`circle`,{cx:`14`,cy:`7`,r:`1`})]})})]})]})}var _o={tip:`_tip_a9o1b_1`,fading:`_fading_a9o1b_11`,tipButton:`_tipButton_a9o1b_15`};function vo({visible:e,fading:t,onDismiss:n}){return e?(0,P.jsx)(`div`,{className:`${_o.tip}${t?` ${_o.fading}`:``}`,role:`status`,children:(0,P.jsx)(`button`,{type:`button`,className:_o.tipButton,onClick:n,children:`Multi-select: Shift/Ctrl/Cmd + click nodes, or Shift + drag on the canvas.`})}):null}function yo(e){return e.trim().toLowerCase()}function bo(e){let t=new Set;return e.filter(e=>{let n=yo(e);return t.has(n)?!1:(t.add(n),!0)})}function xo(e,t){let n=bo(t),r=yo(e);return n.length>1&&n.some(e=>yo(e)===r)?{kind:`multi-node`,aliases:n}:{kind:`single-node`,alias:e}}function So(e,t){let n=new Map(t.nodes.map(e=>[yo(e.alias),e]));return bo(e).map(e=>n.get(yo(e))).filter(e=>e!==void 0)}var Co=[],wo=[],To=[`Shift`,`Control`,`Meta`];function Eo(e,t){return e.length===t.length&&e.every((e,n)=>e===t[n])}function Do({graphData:e,graphName:t,onCopySuccess:n,onCopyError:r,graphRunControls:i,onRenderError:a,isRefreshing:o=!1,onClipNode:s,onClipNodes:u,onClipboardDrop:d,isActive:f,isConnected:p,supportsAuthoring:g=!1,onCreateNode:_,onCreateConnection:y,onEditNode:S,onDeleteNode:C,onDeleteNodes:w,onDeleteConnections:ee,panelLayoutKey:te}){let[T,E]=(0,j.useState)(null),[ne,D]=(0,j.useState)(null),[re,ie]=(0,j.useState)(null),[ae,oe]=(0,j.useState)([]),[O,se]=(0,j.useState)(!1),[k,A]=(0,j.useState)(!1),[ce,M]=(0,j.useState)(!1),[le,N]=(0,j.useState)(!1),ue=(0,j.useRef)(0),de=(0,j.useRef)(!1),fe=(0,j.useRef)(null),me=!!(g&&_&&p),he=!!(g&&y&&p),ge=!!s,_e=!!u,ve=!!(g&&S&&p),ye=!!(g&&C&&p),be=!!(g&&w&&p),xe=ge||ve||ye||he,Se=_e||be,Ce=xe||Se,we=!!(d&&p),Te=(0,j.useCallback)(()=>{ue.current=0,se(!1)},[]);(0,j.useEffect)(()=>{if(!ne)return;let e=e=>{e.key===`Escape`&&D(null)},t=()=>D(null);return document.addEventListener(`keydown`,e),window.addEventListener(`scroll`,t,!0),window.addEventListener(`resize`,t),()=>{document.removeEventListener(`keydown`,e),window.removeEventListener(`scroll`,t,!0),window.removeEventListener(`resize`,t)}},[ne]),(0,j.useEffect)(()=>{let e=()=>Te();return window.addEventListener(`dragend`,e),window.addEventListener(`drop`,e),()=>{window.removeEventListener(`dragend`,e),window.removeEventListener(`drop`,e),Te()}},[Te]);let Ee=(0,j.useRef)(a);(0,j.useEffect)(()=>{Ee.current=a},[a]);let[De,Oe]=pe(`graph-nodes-compact`,!1),{nodes:ke,edges:Ae,transformError:je}=(0,j.useMemo)(()=>{if(!e)return{nodes:Co,edges:wo,transformError:null};try{return{...La(e,{supportsConnectionAuthoring:he,compactNodes:De}),transformError:null}}catch(e){return{nodes:Co,edges:wo,transformError:e instanceof Error?e.message:String(e)}}},[he,De,e]);(0,j.useEffect)(()=>{je&&Ee.current?.(`Graph render failed: ${je}`)},[je]);let Me=(0,j.useMemo)(()=>e?JSON.stringify(e.nodes.map(e=>e.alias)):`empty`,[e]),[Ne,Pe,Fe]=l(ke),[Ie,Le,Re]=x(Ae),ze=(0,j.useRef)(null),Be=!!(e&&e.nodes.length>0),Ve=(0,j.useCallback)(({nodes:e})=>{let t=e.map(e=>e.data.alias);oe(e=>Eo(e,t)?e:t)},[]);(0,j.useEffect)(()=>{Pe(ke),Le(Ae),oe([]),E(null),ie(null)},[ke,Ae,Pe,Le]);let He=(0,j.useRef)(null),Ue=(0,j.useRef)(null);(0,j.useEffect)(()=>{if(!e||e.nodes.length===0)return;let t=Ue.current;if(t&&t.graph===e&&t.compact===De)return;let n=new Map(e.nodes.map(e=>[e.alias,e.properties]));if(!(Ne.length===n.size&&Ne.every(e=>n.get(e.id)===e.data.properties&&e.data.compact===De)))return;let r=new Map;for(let e of Ne){let t=e.measured?.height;if(typeof t!=`number`)return;r.set(e.id,t)}Ue.current={graph:e,compact:De};let i=Ia(e,r,{compactNodes:De});Ne.some(e=>{let t=i.get(e.id);return t!==void 0&&(t.x!==e.position.x||t.y!==e.position.y)})&&Pe(e=>e.map(e=>{let t=i.get(e.id);return t?{...e,position:t}:e})),requestAnimationFrame(()=>{He.current?.fitView({padding:.1})})},[De,e,Ne,Pe]);let We=(0,j.useCallback)(()=>{!k||ce||(M(!0),fe.current!==null&&clearTimeout(fe.current),fe.current=setTimeout(()=>{A(!1),fe.current=null},400))},[ce,k]);(0,j.useEffect)(()=>{!Be||je||de.current||(de.current=!0,M(!1),A(!0))},[Be,je]),(0,j.useEffect)(()=>{if(!k||ce)return;let e=setTimeout(We,5e3);return()=>clearTimeout(e)},[We,ce,k]),(0,j.useEffect)(()=>()=>{fe.current!==null&&clearTimeout(fe.current)},[]);let Ge=e=>{we&&za(Array.from(e.dataTransfer.types))&&(e.preventDefault(),ue.current+=1,se(!0))},Ke=e=>{we&&za(Array.from(e.dataTransfer.types))&&(e.preventDefault(),e.dataTransfer.dropEffect=`copy`,se(!0))},qe=e=>{za(Array.from(e.dataTransfer.types))&&(ue.current=Math.max(0,ue.current-1),ue.current===0&&se(!1))},Je=e=>{if(!we||!za(Array.from(e.dataTransfer.types)))return;e.preventDefault();let t=Va(e.dataTransfer);Te(),t&&d?.(t)},Ye=(0,j.useMemo)(()=>new Set(e?.nodes.map(e=>e.alias)??[]),[e]),Xe=T?.target.kind===`single-node`&&e?Ha(e,T.target.alias):null,Ze=T?.target.kind===`multi-node`?T.target.aliases:[],Qe=e?So(Ze,e):[],$e=(0,j.useCallback)(e=>!he||!e.source||!e.target||e.source===e.target||!Ye.has(e.source)||!Ye.has(e.target)?!1:e.sourceHandle===`authoring-source`&&e.targetHandle===`authoring-target`,[he,Ye]),et=(0,j.useRef)(null);(0,j.useEffect)(()=>{let e=e=>{et.current={x:e.clientX,y:e.clientY}};return document.addEventListener(`pointerup`,e,!0),()=>document.removeEventListener(`pointerup`,e,!0)},[]);let tt=(0,j.useCallback)(e=>{$e(e)&&(!e.source||!e.target||y?.(e.source,e.target,et.current??void 0))},[$e,y]),[nt,rt]=(0,j.useState)(null);(0,j.useEffect)(()=>{rt(null)},[e,he]),(0,j.useEffect)(()=>{if(nt===null)return;let e=e=>{e.key===`Escape`&&(e.preventDefault(),rt(null))};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[nt]);let it=(0,j.useCallback)((e,t)=>{t.handleId!==`authoring-source`||t.handleType!==`source`||(ze.current=t.nodeId,E(null),D(null),ie(null))},[]),at=(0,j.useCallback)(()=>{ze.current=null},[]),ot=(0,j.useRef)(te);(0,j.useEffect)(()=>{if(ot.current===te||(ot.current=te,!Be))return;let e=null,t=requestAnimationFrame(()=>{e=requestAnimationFrame(()=>{He.current?.fitView({padding:.1})})});return()=>{cancelAnimationFrame(t),e!==null&&cancelAnimationFrame(e)}},[Be,te]);let st=!!(g&&ee&&p),ct=(0,j.useCallback)(async({edges:e})=>{if(st&&e.length>0){let t=new Set,n=[];for(let r of e){let e=`${r.source}\t${r.target}`;t.has(e)||(t.add(e),n.push({source:r.source,target:r.target}))}ee?.(n)}return!1},[st,ee]);return je?(0,P.jsxs)(`div`,{className:R.empty,children:[(0,P.jsx)(`span`,{className:R.emptyIcon,children:`⚠️`}),(0,P.jsx)(`span`,{children:`Graph could not be rendered.`}),(0,P.jsx)(`span`,{children:je})]}):(0,P.jsx)(yi,{onRenderError:a,children:(0,P.jsxs)(`div`,{className:R.graphWrapper,"aria-busy":o,children:[Be&&e&&(0,P.jsx)(Ya,{graphData:e,graphName:t,onCopySuccess:n,onCopyError:r,extraActions:i?(0,P.jsx)(no,{...i}):void 0}),(0,P.jsxs)(`div`,{className:R.graphSurface,"data-connect-picking":nt!==null||void 0,onDragEnter:Ge,onDragOver:Ke,onDragLeave:qe,onDrop:Je,onWheelCapture:We,children:[Be?(0,P.jsxs)(c,{nodes:Ne,edges:Ie,onInit:e=>{He.current=e},onNodesChange:Fe,onEdgesChange:Re,nodesConnectable:he,edgesReconnectable:!1,connectOnClick:!1,isValidConnection:$e,onConnect:tt,onConnectStart:it,onConnectEnd:at,deleteKeyCode:[`Delete`,`Backspace`],onBeforeDelete:ct,nodeTypes:vi,fitView:!0,fitViewOptions:{padding:.1},minZoom:.2,maxZoom:4,zoomOnScroll:!0,zoomOnPinch:!0,zoomOnDoubleClick:!0,panOnScroll:!1,selectionKeyCode:`Shift`,multiSelectionKeyCode:To,selectionOnDrag:!1,selectionMode:m.Partial,proOptions:{hideAttribution:!1},onSelectionChange:Ve,onNodeContextMenu:(e,t)=>{if(e.preventDefault(),e.stopPropagation(),We(),D(null),ie(null),!Ce)return;let n=xo(t.data.alias,ae);n.kind===`single-node`&&ae.length>1&&(Pe(e=>e.map(e=>({...e,selected:e.data.alias===t.data.alias}))),oe([t.data.alias])),E({x:e.clientX,y:e.clientY,target:n})},onEdgeContextMenu:(e,t)=>{e.preventDefault(),e.stopPropagation(),We(),E(null),D(null),st&&ie({x:e.clientX,y:e.clientY,source:t.source,target:t.target,relations:t.data?.relationTypes??[]})},onPaneContextMenu:e=>{e.preventDefault(),We(),E(null),ie(null),me&&D({x:e.clientX,y:e.clientY})},onPaneClick:()=>{We(),E(null),D(null),ie(null),rt(null)},onNodeClick:(e,t)=>{if(We(),nt===null)return;e.preventDefault(),e.stopPropagation();let n=t.data.alias;n!==nt&&y?.(nt,n,{x:e.clientX,y:e.clientY}),rt(null)},onNodeDragStart:()=>We(),onSelectionStart:()=>We(),onMoveStart:e=>{e&&We()},children:[(0,P.jsx)(b,{variant:h.Dots,gap:18,size:1,color:`rgba(255,255,255,0.07)`}),(0,P.jsx)(go,{open:le,onOpenChange:N,hotkeyEnabled:f,children:(0,P.jsx)(v,{onClick:()=>Oe(e=>!e),title:De?`Show node details`:`Show thumbnail nodes`,"aria-label":De?`Show node details`:`Show thumbnail nodes`,"aria-pressed":De,children:(0,P.jsxs)(`span`,{className:R.detailToggleIcon,"aria-hidden":`true`,children:[(0,P.jsx)(`span`,{className:R.detailToggleHeader}),De&&(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(`span`,{className:R.detailToggleLine}),(0,P.jsx)(`span`,{className:R.detailToggleLine}),(0,P.jsx)(`span`,{className:R.detailToggleLine})]})]})})})]}):(0,P.jsxs)(`div`,{className:R.empty,children:[(0,P.jsx)(`span`,{className:R.emptyIcon,children:`🕸️`}),(0,P.jsx)(`span`,{children:`No graph data yet.`}),(0,P.jsxs)(`span`,{children:[`Run `,(0,P.jsx)(`strong`,{children:`create node`}),` or `,(0,P.jsx)(`strong`,{children:`import graph from`}),` in the playground — the view follows the live session graph.`]}),g&&_&&(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(`button`,{type:`button`,className:R.emptyCreateButton,disabled:!p,onClick:()=>_(`empty-graph`),children:`Create Node`}),!p&&(0,P.jsx)(`span`,{className:R.emptyHint,children:`Connect WebSocket to create a node.`})]})]}),(0,P.jsx)(vo,{visible:k,fading:ce,onDismiss:We}),nt!==null&&(0,P.jsxs)(`div`,{className:R.connectBanner,role:`status`,children:[(0,P.jsxs)(`span`,{children:[`Connecting from `,(0,P.jsx)(`strong`,{children:nt}),` — click a target node`]}),(0,P.jsx)(`button`,{type:`button`,className:R.connectBannerCancel,onClick:()=>rt(null),children:`Cancel (Esc)`})]}),o&&(0,P.jsx)(`div`,{className:R.refreshingOverlay,children:(0,P.jsx)(`div`,{className:R.refreshingSpinner,role:`status`,"aria-label":`Graph refreshing`})}),O&&(0,P.jsx)(`div`,{className:R.clipboardDropOverlay,children:(0,P.jsx)(`div`,{className:R.clipboardDropMessage,children:`Drop to paste workspace node`})}),(0,P.jsx)(io,{open:ne!==null,x:ne?.x??0,y:ne?.y??0,canCreateNode:me,onCreateNode:()=>_?.(`pane-context-menu`),onClose:()=>D(null)}),T?.target.kind===`multi-node`?(0,P.jsx)(so,{mode:`multi-node`,open:Qe.length>1&&Se,x:T.x,y:T.y,selectedCount:Ze.length,canClipSelectedNodes:_e,canDeleteSelectedNodes:be,onClipSelectedNodes:()=>{if(!e){u?.([]);return}let t=Qe.map(t=>({node:t,connections:Ua(e,t.alias)}));u?.(t)},onDeleteSelectedNodes:()=>{let e=Qe.length===Ze.length;w?.(e?Qe:[])},onClose:()=>E(null)}):(0,P.jsx)(so,{mode:`single-node`,open:T!==null&&Xe!==null&&xe,x:T?.x??0,y:T?.y??0,nodeAlias:T?.target.kind===`single-node`?T.target.alias:``,canClipNode:ge&&Xe!==null,canConnectNode:he&&Xe!==null,canEditNode:ve&&Xe!==null,canDeleteNode:ye&&Xe!==null,onConnectNode:()=>{Xe&&rt(Xe.alias)},onClipNode:()=>{if(!Xe||!e)return;let t=Ua(e,Xe.alias);s?.(Xe,t)},onEditNode:()=>{Xe&&S?.(Xe)},onDeleteNode:()=>{Xe&&C?.(Xe)},onClose:()=>E(null)}),(0,P.jsx)(lo,{open:re!==null&&st,x:re?.x??0,y:re?.y??0,sourceAlias:re?.source??``,targetAlias:re?.target??``,relations:re?.relations??[],onDeleteRelation:e=>{re&&ee?.([{source:re.source,target:re.target,relation:e}])},onClose:()=>ie(null)})]})]})},Me)}var Oo={root:`_root_1yhjs_2`,empty:`_empty_1yhjs_10`,emptyIcon:`_emptyIcon_1yhjs_23`,toolbarButton:`_toolbarButton_1yhjs_29 _toolbarButton_stok4_116`,scrollBody:`_scrollBody_1yhjs_34`,jsonContainer:`_jsonContainer_1yhjs_45`,jsonLabel:`_jsonLabel_1yhjs_46`,jsonString:`_jsonString_1yhjs_47`,jsonNumber:`_jsonNumber_1yhjs_48`,jsonBoolean:`_jsonBoolean_1yhjs_49`,jsonNull:`_jsonNull_1yhjs_50`},ko={default:e=>e<3,all:i,none:a};function Ao({graphData:e,graphName:t,onCopySuccess:n,onCopyError:i}){let[a,s]=(0,j.useState)(`all`);return e?(0,P.jsxs)(`div`,{className:Oo.root,children:[(0,P.jsx)(Ya,{graphData:e,graphName:t,onCopySuccess:n,onCopyError:i,extraActions:(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(`button`,{className:Oo.toolbarButton,onClick:()=>s(`all`),title:`Expand all nodes`,"aria-label":`Expand all JSON nodes`,"aria-pressed":a===`all`,children:`➖`}),(0,P.jsx)(`button`,{className:Oo.toolbarButton,onClick:()=>s(`none`),title:`Collapse all nodes`,"aria-label":`Collapse all JSON nodes`,"aria-pressed":a===`none`,children:`➕`})]})}),(0,P.jsx)(`div`,{className:Oo.scrollBody,children:(0,P.jsx)(o,{data:e,shouldExpandNode:ko[a],style:{...r,container:`${r.container} ${Oo.jsonContainer}`,label:Oo.jsonLabel,stringValue:Oo.jsonString,numberValue:Oo.jsonNumber,booleanValue:Oo.jsonBoolean,nullValue:Oo.jsonNull}})})]}):(0,P.jsx)(`div`,{className:Oo.root,children:(0,P.jsxs)(`div`,{className:Oo.empty,children:[(0,P.jsx)(`span`,{className:Oo.emptyIcon,children:`🕸️`}),(0,P.jsx)(`span`,{children:`No graph data yet.`}),(0,P.jsx)(`span`,{children:`Pin a graph-link message in the Console to load the raw data here.`})]})})}var U={rightPanel:`_rightPanel_xa3j1_2`,tabStrip:`_tabStrip_xa3j1_10`,tab:`_tab_xa3j1_10`,tabActive:`_tabActive_xa3j1_41`,tabBadge:`_tabBadge_xa3j1_45`,tabBody:`_tabBody_xa3j1_51`,tabBodyHidden:`_tabBodyHidden_xa3j1_64`,graphContent:`_graphContent_xa3j1_68`,rightPanelGroup:`_rightPanelGroup_xa3j1_75`,verticalResizeHandle:`_verticalResizeHandle_xa3j1_83`},jo=`help-split-percent`,Mo=`help-split-maximized`,No=45,Po=98;function Fo({tabs:e,payload:t,onChange:n,validation:r,onFormat:i,onUpload:a,graphData:o,graphName:s,activeTab:c,onTabChange:l,onGraphRenderError:u,onGraphDataCopySuccess:d,onGraphDataCopyError:f,graphRunControls:p,isGraphRefreshing:m,onClipNode:h,onClipNodes:g,onClipboardDrop:_,isConnected:v,supportsAuthoring:y,onCreateNode:b,onCreateConnection:x,onEditNode:S,onDeleteNode:C,onDeleteNodes:w,onDeleteConnections:ee,panelLayoutKey:te,helpPanel:T}){let E=(0,j.useId)(),ne=`${E}-tab-payload`,D=`${E}-tab-graph`,ae=`${E}-tab-graph-data`,O=!!T,se=(0,j.useRef)(Number(sessionStorage.getItem(jo))||No),k=(0,j.useRef)(null),A=(0,j.useRef)(null),[ce,M]=(0,j.useState)(()=>sessionStorage.getItem(Mo)===`1`),le=(0,j.useRef)(ce),N=(0,P.jsxs)(`div`,{className:U.rightPanel,children:[e.length>1&&(0,P.jsxs)(`div`,{className:U.tabStrip,role:`tablist`,"aria-label":`Right panel tabs`,children:[e.includes(`payload`)&&(0,P.jsx)(`button`,{role:`tab`,"aria-selected":c===`payload`,"aria-controls":ne,className:`${U.tab}${c===`payload`?` ${U.tabActive}`:``}`,onClick:()=>l(`payload`),children:`Payload Editor`}),e.includes(`graph`)&&(0,P.jsxs)(`button`,{role:`tab`,"aria-selected":c===`graph`,"aria-controls":D,className:`${U.tab}${c===`graph`?` ${U.tabActive}`:``}`,onClick:()=>l(`graph`),children:[`Graph`,o!==null&&(0,P.jsx)(`span`,{className:U.tabBadge,"aria-label":`Graph data available`,children:`🕸️`})]}),e.includes(`graph-data`)&&(0,P.jsx)(`button`,{role:`tab`,"aria-selected":c===`graph-data`,"aria-controls":ae,className:`${U.tab}${c===`graph-data`?` ${U.tabActive}`:``}`,onClick:()=>l(`graph-data`),children:`Graph Data (Raw)`})]}),e.includes(`payload`)&&(0,P.jsx)(`div`,{role:`tabpanel`,id:ne,tabIndex:c===`payload`?0:-1,className:`${U.tabBody}${c===`payload`?``:` ${U.tabBodyHidden}`}`,children:(0,P.jsx)(ai,{payload:t,onChange:n,validation:r,onFormat:i,onUpload:a})}),e.includes(`graph`)&&(0,P.jsx)(`div`,{role:`tabpanel`,id:D,tabIndex:c===`graph`?0:-1,className:`${U.tabBody}${c===`graph`?``:` ${U.tabBodyHidden}`}`,children:(0,P.jsx)(`div`,{className:U.graphContent,children:(0,P.jsx)(Do,{graphData:o,graphName:s,onRenderError:u,isRefreshing:m,onCopySuccess:d,onCopyError:f,graphRunControls:p,onClipNode:h,onClipNodes:g,onClipboardDrop:_,isActive:c===`graph`,isConnected:v,supportsAuthoring:y,onCreateNode:b,onCreateConnection:x,onEditNode:S,onDeleteNode:C,onDeleteNodes:w,onDeleteConnections:ee,panelLayoutKey:te})})}),e.includes(`graph-data`)&&(0,P.jsx)(`div`,{role:`tabpanel`,id:ae,tabIndex:c===`graph-data`?0:-1,className:`${U.tabBody}${c===`graph-data`?``:` ${U.tabBodyHidden}`}`,children:(0,P.jsx)(Ao,{graphData:o,graphName:s,onCopySuccess:d,onCopyError:f})})]}),ue=(0,j.useCallback)(e=>{let t=e[`help-split-help`];if(t===void 0)return;let n=t>=Po;n!==le.current&&(le.current=n,M(n),sessionStorage.setItem(Mo,n?`1`:`0`)),n||(se.current=t,sessionStorage.setItem(jo,String(t)))},[]),de=(0,j.useCallback)(()=>{let e=!le.current;if(le.current=e,M(e),sessionStorage.setItem(Mo,e?`1`:`0`),e)A.current?.resize(`0%`),k.current?.resize(`100%`);else{let e=se.current;k.current?.resize(`${e}%`),A.current?.resize(`${100-e}%`)}},[]);if((0,j.useEffect)(()=>{O&&le.current&&requestAnimationFrame(()=>{A.current?.resize(`0%`),k.current?.resize(`100%`)})},[O]),!T)return N;let fe=typeof T==`function`?T(de,ce):T,pe=le.current?100:se.current,me=100-pe;return(0,P.jsxs)(oe,{orientation:`vertical`,className:U.rightPanelGroup,onLayoutChanged:ue,children:[(0,P.jsx)(ie,{panelRef:A,defaultSize:`${me}%`,minSize:`0%`,children:N}),(0,P.jsx)(re,{className:U.verticalResizeHandle,"aria-label":`Resize help panel`}),(0,P.jsx)(ie,{id:`help-split-help`,panelRef:k,defaultSize:`${pe}%`,minSize:`15%`,children:fe})]})}var Io=class extends j.Component{constructor(...e){super(...e),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(e,t){console.error(`[ConsoleErrorBoundary] Failed to render message:`,e,t.componentStack)}render(){return this.state.hasError?(0,P.jsx)(`span`,{children:this.props.fallback}):this.props.children}},Lo=2e3,Ro=(e={})=>{let{onSuccess:t,onError:n}=e,[r,i]=(0,j.useState)(!1),a=(0,j.useRef)(null);return(0,j.useEffect)(()=>()=>{a.current!==null&&clearTimeout(a.current)},[]),{copy:(0,j.useCallback)(async e=>{if(!navigator.clipboard)return console.warn(`useCopyToClipboard: Clipboard API not available in this browser.`),n?.(),!1;try{return await navigator.clipboard.writeText(e),i(!0),a.current!==null&&clearTimeout(a.current),a.current=setTimeout(()=>{a.current=null,i(!1)},Lo),t?.(),!0}catch(e){return console.error(`useCopyToClipboard: Failed to write to clipboard.`,e),n?.(),!1}},[t,n]),copied:r}},W={consoleRoot:`_consoleRoot_1lgp1_2`,consoleHeader:`_consoleHeader_1lgp1_10`,consoleTitle:`_consoleTitle_1lgp1_20`,consoleControls:`_consoleControls_1lgp1_25`,controlButton:`_controlButton_1lgp1_30`,console:`_console_1lgp1_2`,emptyConsole:`_emptyConsole_1lgp1_67`,consoleMessage:`_consoleMessage_1lgp1_80`,consoleMessageActivatable:`_consoleMessageActivatable_1lgp1_94`,consoleMessageGraphLink:`_consoleMessageGraphLink_1lgp1_104`,consoleMessageLargePayload:`_consoleMessageLargePayload_1lgp1_115`,consoleMessageMockUpload:`_consoleMessageMockUpload_1lgp1_122`,uploadMockButton:`_uploadMockButton_1lgp1_131`,copyButton:`_copyButton_1lgp1_172`,copyButtonCopied:`_copyButtonCopied_1lgp1_225`,sendToJsonPathButton:`_sendToJsonPathButton_1lgp1_234`,messageIcon:`_messageIcon_1lgp1_268`,messageContent:`_messageContent_1lgp1_272`,messageText:`_messageText_1lgp1_278`,messageTime:`_messageTime_1lgp1_283`,"messageType-error":`_messageType-error_1lgp1_290`,"messageType-info":`_messageType-info_1lgp1_291`,"messageType-welcome":`_messageType-welcome_1lgp1_292`,jsonViewWrapper:`_jsonViewWrapper_1lgp1_295`,jsonContainer:`_jsonContainer_1lgp1_301`,jsonLabel:`_jsonLabel_1lgp1_302`,jsonString:`_jsonString_1lgp1_303`,jsonNumber:`_jsonNumber_1lgp1_304`,jsonBoolean:`_jsonBoolean_1lgp1_305`,jsonNull:`_jsonNull_1lgp1_306`};function zo({message:e,msgId:t,classificationMap:n,onGraphLink:i,onCopyMessage:a,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l}){let u=Ce(e),d=we(u.type),f=Te(u.message),p=(t===void 0?void 0:n?.get(t))??[],m=p.some(e=>e.kind===`graph.link`),h=p.some(e=>e.kind===`payload.large`),g=p.some(e=>e.kind===`upload.invitation`),_=p.find(e=>e.kind===`upload.invitation`)?.uploadPath??null,v=!!c&&g&&_!==null,y=v&&!!l?.has(_),b=!!i&&m&&!g&&!h,x=!!s&&f.isJSON,{copy:S,copied:C}=Ro({onSuccess:a}),w=t=>{t.stopPropagation(),S(e)},ee=t=>{(t.key===`Enter`||t.key===` `)&&(t.preventDefault(),t.stopPropagation(),S(e))},te=e=>{e.stopPropagation(),!(!s||!f.isJSON)&&s(JSON.stringify(f.data,null,2))},T=e=>{e.stopPropagation(),!(!c||!_)&&c(_)};return(0,P.jsxs)(`div`,{className:[W.consoleMessage,W[`messageType-${u.type}`],b?W.consoleMessageActivatable:``,m?W.consoleMessageGraphLink:``,h?W.consoleMessageLargePayload:``,g?W.consoleMessageMockUpload:``].filter(Boolean).join(` `),onClick:b?()=>i():void 0,title:b?`Click to load graph in Graph View`:void 0,role:b?`button`:void 0,tabIndex:b?0:void 0,onKeyDown:b?e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),i())}:void 0,"aria-label":b?`Load graph in Graph View`:void 0,children:[(0,P.jsx)(`span`,{className:W.messageIcon,children:g?`⬆️`:h?`⬇️`:m?`🕸️`:d}),(0,P.jsx)(`div`,{className:W.messageContent,children:f.isJSON?(0,P.jsx)(`div`,{className:W.jsonViewWrapper,children:(0,P.jsx)(o,{data:f.data,shouldExpandNode:e=>e<1,style:{...r,container:`${r.container} ${W.jsonContainer}`,label:W.jsonLabel,stringValue:W.jsonString,numberValue:W.jsonNumber,booleanValue:W.jsonBoolean,nullValue:W.jsonNull}})}):(0,P.jsxs)(`span`,{className:W.messageText,children:[u.message,y&&(0,P.jsx)(`span`,{title:`Upload succeeded`,children:` ✅`})]})}),(0,P.jsx)(`button`,{className:`${W.copyButton} ${C?W.copyButtonCopied:``}`,onClick:w,onKeyDown:ee,title:C?`Copied!`:`Copy message`,"aria-label":C?`Copied to clipboard`:`Copy message to clipboard`,tabIndex:0,children:C?`✅`:`📄`}),x&&(0,P.jsx)(`button`,{className:W.sendToJsonPathButton,onClick:te,onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&te(e)},title:`Open in JSON-Path Playground`,"aria-label":`Open this JSON in the JSON-Path Playground`,tabIndex:0,children:`➡️`}),v&&(0,P.jsx)(`button`,{className:W.uploadMockButton,onClick:T,onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&T(e)},title:`Re-open upload dialog`,"aria-label":`Re-open mock data upload dialog`,tabIndex:0,children:`⬆️ Upload JSON…`}),u.time&&(0,P.jsx)(`span`,{className:W.messageTime,children:u.time})]})}function Bo({messages:e,classificationMap:t,onCopy:n,onClear:r,consoleRef:i,onGraphLinkMessage:a,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l}){return(0,P.jsxs)(`div`,{className:W.consoleRoot,children:[(0,P.jsxs)(`div`,{className:W.consoleHeader,children:[(0,P.jsx)(`span`,{className:W.consoleTitle,children:`Console Output`}),(0,P.jsxs)(`div`,{className:W.consoleControls,children:[(0,P.jsx)(`button`,{className:W.controlButton,onClick:n,title:`Copy console output`,"aria-label":`Copy console output to clipboard`,children:`📑`}),(0,P.jsx)(`button`,{className:W.controlButton,onClick:r,title:`Clear console`,"aria-label":`Clear console`,children:`🗑️`})]})]}),(0,P.jsxs)(`div`,{className:W.console,ref:i,role:`log`,"aria-live":`polite`,children:[e.map(e=>(0,P.jsx)(Io,{fallback:e.raw,children:(0,P.jsx)(zo,{message:e.raw,msgId:e.id,classificationMap:t,onGraphLink:a?()=>a(e):void 0,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l})},e.id)),e.length===0&&(0,P.jsxs)(`div`,{className:W.emptyConsole,children:[`No messages yet. Use the `,(0,P.jsx)(`strong`,{children:`Start`}),` button in the header to connect.`]})]})]})}var Vo={commandInput:`_commandInput_188pe_2`,labelRow:`_labelRow_188pe_8`,labelGroup:`_labelGroup_188pe_16`,label:`_label_188pe_8`,infoWrapper:`_infoWrapper_188pe_28`,paletteToggle:`_paletteToggle_188pe_34`,paletteToggleActive:`_paletteToggleActive_188pe_66`,popover:`_popover_188pe_73`,popoverOpen:`_popoverOpen_188pe_95`,popoverTitle:`_popoverTitle_188pe_121`,popoverRow:`_popoverRow_188pe_135`,popoverKeyword:`_popoverKeyword_188pe_156`,popoverDesc:`_popoverDesc_188pe_168`,popoverAlias:`_popoverAlias_188pe_174`,inputRow:`_inputRow_188pe_181`,inputWrapper:`_inputWrapper_188pe_187`,textarea:`_textarea_188pe_197`,sendButton:`_sendButton_188pe_236`,hint:`_hint_188pe_253`,dropup:`_dropup_188pe_261`,dropupHeader:`_dropupHeader_188pe_276`,dropupItem:`_dropupItem_188pe_292`,dropupItemText:`_dropupItemText_188pe_315`,matchHighlight:`_matchHighlight_188pe_323`,multilineIndicator:`_multilineIndicator_188pe_329`},Ho=[`graph.data.mapper`,`graph.math`,`graph.js`,`graph.api.fetcher`,`graph.extension`,`graph.island`,`graph.join`],Uo=[{keyword:`help`,description:`List all help topics, or get help for a specific command`,template:`help`},{keyword:`create`,description:`Create a new graph node`,template:`create node {name}
with type {type}
with properties
...
{constant} -> input.body.{key}`,multiline:!0},{keyword:`upload mock data`,description:`Print the URL to POST a JSON payload as mock input.body`,template:`upload mock data`},{keyword:`execute`,description:`Execute a single node skill in isolation`,template:`execute node {name}`},{keyword:`inspect`,description:`Inspect a state-machine variable`,template:`inspect {variable_name}`},{keyword:`run`,description:`Run the graph instance from root to end`,template:`run`}];[...Ho.map(e=>({tokens:[`describe`,`skill`,e],template:`describe skill ${e}`,hint:`Describe built-in skill: ${e}`}))];function Wo(e,t){let[n,r]=(0,j.useState)(!1),[i,a]=(0,j.useState)(-1),o=(0,j.useMemo)(()=>{let n=t.trimStart();if(n.length===0)return[];let r=n.toLowerCase(),i=e.filter(e=>e.toLowerCase().startsWith(r)),a=new Set;return i.filter(e=>a.has(e)?!1:(a.add(e),!0)).slice(0,8)},[e,t]),s=()=>{r(!0),a(-1)},c=e=>{let t=o.length;t!==0&&a(n=>e===1?n<0?0:(n+1)%t:n<=0?t-1:n-1)},l=(e,t)=>{e>=0&&e<o.length&&t(o[e]),r(!1),a(-1)};return{suggestions:o,isOpen:n,activeIndex:i,onCommandChange:s,navigate:c,accept:l,onTab:e=>{!n||o.length===0||l(i>=0?i:0,e)},dismiss:()=>{r(!1),a(-1)}}}var Go=e=>(0,P.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 16 16`,fill:`none`,width:14,height:14,stroke:`currentColor`,strokeWidth:1.5,strokeLinecap:`round`,strokeLinejoin:`round`,...e,children:[(0,P.jsx)(`polyline`,{points:`2,4 6,8 2,12`}),(0,P.jsx)(`line`,{x1:7,y1:12,x2:14,y2:12})]});function Ko({command:e,onChange:t,onKeyDown:n,onSend:r,sendDisabled:i,disabled:a,history:o}){let s=(0,j.useRef)(null),c=(0,j.useRef)(null),l=(0,j.useRef)(null),[u,d]=(0,j.useState)(!1);(0,j.useEffect)(()=>{if(!u)return;let e=e=>{c.current&&!c.current.contains(e.target)&&d(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[u]);let f=Wo(o,e),p=(0,j.useCallback)(()=>{let e=s.current;e&&(e.style.height=`auto`,e.style.height=`${e.scrollHeight}px`)},[]);(0,j.useEffect)(()=>{p()},[e,p]),(0,j.useEffect)(()=>{let e=s.current?.parentElement;if(!e||typeof ResizeObserver>`u`)return;let t=null,n=new ResizeObserver(()=>{t===null&&(t=requestAnimationFrame(()=>{t=null,p()}))});return n.observe(e),()=>{n.disconnect(),t!==null&&cancelAnimationFrame(t)}},[p]);let m=a?`Not connected`:`Enter command (Enter to send · Shift+Enter for new line)`,h=a?`Enter your test message once it is connected`:`Enter to send · Shift+Enter for new line · ↑↓ for history`;return(0,P.jsxs)(`div`,{className:Vo.commandInput,children:[(0,P.jsx)(`div`,{className:Vo.labelRow,children:(0,P.jsxs)(`div`,{className:Vo.labelGroup,children:[(0,P.jsx)(`label`,{htmlFor:`command`,className:Vo.label,children:`Command`}),(0,P.jsxs)(`span`,{ref:c,className:Vo.infoWrapper,children:[(0,P.jsx)(`button`,{type:`button`,className:`${Vo.paletteToggle}${u?` ${Vo.paletteToggleActive}`:``}`,"aria-label":`Toggle command palette`,"aria-expanded":u,"aria-controls":`command-palette`,onClick:()=>d(e=>!e),onKeyDown:e=>{e.key===`ArrowDown`&&u&&(e.preventDefault(),(l.current?.querySelector(`[role="option"]`))?.focus())},title:`Command palette`,children:(0,P.jsx)(Go,{"aria-hidden":`true`,focusable:`false`})}),(0,P.jsxs)(`div`,{id:`command-palette`,ref:l,className:`${Vo.popover}${u?` ${Vo.popoverOpen}`:``}`,role:`listbox`,"aria-label":`Command palette`,onKeyDown:e=>{if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault();let t=l.current?.querySelectorAll(`[role="option"]`);if(!t||t.length===0)return;let n=Array.from(t).indexOf(document.activeElement);e.key===`ArrowDown`?t[n<0?0:(n+1)%t.length].focus():t[n<=0?t.length-1:n-1].focus()}else e.key===`Escape`&&(e.preventDefault(),d(!1),s.current?.focus())},children:[(0,P.jsx)(`p`,{className:Vo.popoverTitle,children:`Command palette — click to insert`}),Uo.map(({keyword:e,alias:n,description:r,template:i})=>(0,P.jsxs)(`div`,{className:Vo.popoverRow,role:`option`,"aria-selected":!1,tabIndex:u?0:-1,onMouseDown:e=>e.preventDefault(),onClick:()=>{t(i),d(!1),s.current?.focus()},onKeyDown:e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t(i),d(!1),s.current?.focus())},children:[(0,P.jsx)(`span`,{className:Vo.popoverKeyword,children:e}),(0,P.jsxs)(`span`,{className:Vo.popoverDesc,children:[r,n&&(0,P.jsxs)(`span`,{className:Vo.popoverAlias,children:[` · alias: `,n]})]})]},e))]})]})]})}),(0,P.jsxs)(`div`,{className:Vo.inputRow,children:[(0,P.jsxs)(`div`,{className:Vo.inputWrapper,children:[(0,P.jsxs)(`div`,{id:`history-dropup`,role:`listbox`,"aria-label":`Command history suggestions`,className:Vo.dropup,hidden:!(f.isOpen&&f.suggestions.length>0),children:[(0,P.jsx)(`div`,{className:Vo.dropupHeader,"aria-hidden":`true`,children:`Recent Commands`}),f.isOpen&&f.suggestions.length>0&&f.suggestions.map((n,r)=>{let i=n.split(`
`)[0],a=n.includes(`
`),o=e.trimStart().split(`
`)[0],c=Math.min(o.length,i.length),l=i.slice(0,c),u=i.slice(c);return(0,P.jsxs)(`div`,{id:`history-option-${r}`,role:`option`,"aria-selected":r===f.activeIndex,className:Vo.dropupItem,onMouseDown:e=>e.preventDefault(),onClick:()=>{f.accept(r,e=>t(e)),requestAnimationFrame(()=>{let e=s.current;e&&(e.selectionStart=e.selectionEnd=e.value.length)})},children:[(0,P.jsxs)(`span`,{className:Vo.dropupItemText,children:[c>0&&(0,P.jsx)(`strong`,{className:Vo.matchHighlight,children:l}),u,a?`…`:``]}),a&&(0,P.jsx)(`span`,{className:Vo.multilineIndicator,"aria-label":`multi-line command`,children:`↵`})]},n)})]}),(0,P.jsx)(`textarea`,{ref:s,id:`command`,role:`combobox`,"aria-expanded":f.isOpen&&f.suggestions.length>0,"aria-haspopup":`listbox`,"aria-controls":`history-dropup`,"aria-activedescendant":f.isOpen&&f.suggestions.length>0&&f.activeIndex>=0?`history-option-${f.activeIndex}`:void 0,"aria-autocomplete":`list`,className:Vo.textarea,rows:1,placeholder:m,value:e,disabled:a,onChange:e=>{t(e.target.value),f.onCommandChange()},onKeyDown:e=>{if(e.key===`Tab`){e.preventDefault(),f.isOpen&&f.suggestions.length>0&&(f.onTab(e=>t(e)),requestAnimationFrame(()=>{let e=s.current;e&&(e.selectionStart=e.selectionEnd=e.value.length)}));return}if(e.key===`Enter`){if(e.shiftKey)return;if(e.preventDefault(),f.isOpen&&f.activeIndex>=0){f.accept(f.activeIndex,e=>t(e)),requestAnimationFrame(()=>{let e=s.current;e&&(e.selectionStart=e.selectionEnd=e.value.length)}),s.current?.focus();return}r(),s.current?.focus();return}if(e.key===`Escape`){if(f.isOpen){f.dismiss(),e.preventDefault();return}return}if(e.key===`ArrowUp`||e.key===`ArrowDown`){if(f.isOpen&&f.suggestions.length>0){e.preventDefault(),f.navigate(e.key===`ArrowDown`?1:-1);return}let t=s.current;if(t){let{selectionStart:n,value:r}=t,i=!r.slice(0,n).includes(`
`),a=!r.slice(n).includes(`
`);if(!(e.key===`ArrowUp`&&i||e.key===`ArrowDown`&&a))return}n(e),requestAnimationFrame(()=>{let e=s.current;e&&(e.selectionStart=e.selectionEnd=e.value.length)});return}n(e)},onBlur:()=>f.dismiss(),autoComplete:`off`,autoCorrect:`off`,spellCheck:!1})]}),(0,P.jsx)(`button`,{className:Vo.sendButton,onClick:()=>{r(),s.current?.focus()},disabled:i,"aria-label":`Send command`,children:`Send`})]}),h&&(0,P.jsx)(`p`,{className:Vo.hint,children:h})]})}var qo={root:`_root_1ac49_1`};function Jo({messages:e,classificationMap:t,onCopy:n,onClear:r,consoleRef:i,onGraphLinkMessage:a,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l,command:u,onCommandChange:d,onCommandKeyDown:f,onSend:p,sendDisabled:m,inputDisabled:h,commandHistory:g}){return(0,P.jsxs)(`div`,{className:qo.root,children:[(0,P.jsx)(Bo,{messages:e,classificationMap:t,onCopy:n,onClear:r,consoleRef:i,onGraphLinkMessage:a,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l}),(0,P.jsx)(Ko,{command:u,onChange:d,onKeyDown:f,onSend:p,disabled:h,sendDisabled:m,history:g})]})}var Yo=e=>(0,P.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 16 16`,fill:`none`,width:16,height:16,stroke:`currentColor`,strokeWidth:1.8,strokeLinecap:`round`,strokeLinejoin:`round`,...e,children:[(0,P.jsx)(`line`,{x1:4.75,y1:4.75,x2:11.25,y2:11.25}),(0,P.jsx)(`line`,{x1:11.25,y1:4.75,x2:4.75,y2:11.25})]}),G={root:`_root_1qoh5_9`,card:`_card_1qoh5_19`,ribbon:`_ribbon_1qoh5_32`,ribbonIcon:`_ribbonIcon_1qoh5_45`,ribbonAlias:`_ribbonAlias_1qoh5_50`,ribbonAliasInput:`_ribbonAliasInput_1qoh5_57`,ribbonBadge:`_ribbonBadge_1qoh5_82`,ribbonClose:`_ribbonClose_1qoh5_93`,ribbonCloseIcon:`_ribbonCloseIcon_1qoh5_114`,body:`_body_1qoh5_121`,row:`_row_1qoh5_128`,rowDropTarget:`_rowDropTarget_1qoh5_138`,dragGrip:`_dragGrip_1qoh5_142`,rowLabel:`_rowLabel_1qoh5_166`,rowKey:`_rowKey_1qoh5_167`,rowValue:`_rowValue_1qoh5_178`,rowSpacer:`_rowSpacer_1qoh5_185`,keyInput:`_keyInput_1qoh5_189`,valueInput:`_valueInput_1qoh5_190`,removeButton:`_removeButton_1qoh5_228`,removeIcon:`_removeIcon_1qoh5_251`,addRow:`_addRow_1qoh5_257`,addButton:`_addButton_1qoh5_263`,message:`_message_1qoh5_282`,errorMessage:`_errorMessage_1qoh5_283`,warningMessage:`_warningMessage_1qoh5_284`,errorText:`_errorText_1qoh5_306`,footer:`_footer_1qoh5_312`,secondaryButton:`_secondaryButton_1qoh5_321`,primaryButton:`_primaryButton_1qoh5_322`},Xo=1,Zo=10,Qo=36;function $o(e){let t=e.split(`
`).reduce((e,t)=>e+Math.max(1,Math.ceil(t.length/Qo)),0);return Math.min(Math.max(t,Xo),Zo)}function es({mode:e,formState:t,phase:n,lockReason:r,serverMessage:i,validationErrors:a,onFormStateChange:o,onSubmit:s,onClose:c}){let l=(0,j.useRef)(null),u=(0,j.useRef)(null),d=(0,j.useRef)(new Map),f=(0,j.useRef)(null),p=e===`create`,m=n===`sending`,h=r===`disconnected`,g=m||h,_=p?`Create Node`:`Save Changes`,v=p?`Creating...`:`Saving...`,y=p?`Connection disconnected. Refresh the page and create the node again after the app reconnects.`:`Connection disconnected. Refresh the page and edit the node again after the app reconnects.`,b=ui(t.nodeType),x=di(t.nodeType);(0,j.useEffect)(()=>{p?l.current?.focus():u.current?.focus();let e=e=>{e.key===`Escape`&&(e.preventDefault(),m||c())};return document.addEventListener(`keydown`,e),()=>{document.removeEventListener(`keydown`,e)}},[p,c,m]),(0,j.useEffect)(()=>{let e=f.current;if(!e)return;let t=d.current.get(e);t&&(t.focus(),f.current=null)},[t.properties]);let S=(0,j.useCallback)(e=>{e.preventDefault(),!g&&s()},[g,s]),C=(0,j.useCallback)(e=>{o({...t,...e})},[t,o]),w=(0,j.useCallback)((e,n)=>{o({...t,properties:t.properties.map(t=>t.id===e?{...t,...n}:t)})},[t,o]),ee=(0,j.useCallback)(()=>{let e=gr();f.current=e.id,o({...t,properties:[...t.properties,e]})},[t,o]),te=(0,j.useCallback)(e=>{let n=t.properties.filter(t=>t.id!==e);o({...t,properties:n.length>0?n:[gr()]})},[t,o]),T=(0,j.useRef)(null),[E,ne]=(0,j.useState)(null),D=(0,j.useCallback)(()=>{T.current=null,ne(null)},[]),re=(0,j.useCallback)(e=>t=>{if(T.current=e,t.dataTransfer){t.dataTransfer.effectAllowed=`move`,t.dataTransfer.setData(`text/plain`,e);let n=t.currentTarget.closest(`[data-row-id]`);n instanceof HTMLElement&&typeof t.dataTransfer.setDragImage==`function`&&t.dataTransfer.setDragImage(n,16,16)}},[]),ie=(0,j.useCallback)(e=>t=>{T.current!==null&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),ne(t=>t===e?t:e))},[]),ae=(0,j.useCallback)(e=>{let n=T.current;if(D(),n===null||n===e)return;let r=t.properties.find(e=>e.id===n);if(!r)return;let i=t.properties.filter(e=>e.id!==n),a=i.length;if(e!==null){let t=i.findIndex(t=>t.id===e);t!==-1&&(a=t)}let s=[...i.slice(0,a),r,...i.slice(a)];o({...t,properties:xr(s)})},[D,t,o]),oe=(0,j.useCallback)(e=>t=>{T.current!==null&&(t.preventDefault(),ae(e))},[ae]);return(0,P.jsx)(`div`,{className:G.root,children:(0,P.jsxs)(`form`,{className:G.card,style:{borderColor:x,"--node-accent":x},"aria-label":p?`Create node`:`Edit node ${t.alias}`,onSubmit:S,children:[(0,P.jsxs)(`header`,{className:G.ribbon,children:[(0,P.jsx)(`span`,{className:G.ribbonIcon,"aria-hidden":`true`,children:b.icon}),p?(0,P.jsx)(`input`,{ref:l,className:G.ribbonAliasInput,value:t.alias,placeholder:`node-alias`,"aria-label":`Node alias`,disabled:g,"aria-invalid":!!a.alias,onChange:e=>C({alias:e.target.value})}):(0,P.jsx)(`span`,{className:G.ribbonAlias,children:t.alias}),(0,P.jsx)(`span`,{className:G.ribbonBadge,children:b.label}),(0,P.jsx)(`button`,{type:`button`,className:G.ribbonClose,"aria-label":`Close node editor`,title:`Close (Esc)`,onClick:c,disabled:m,children:(0,P.jsx)(Yo,{className:G.ribbonCloseIcon,"aria-hidden":`true`,focusable:`false`})})]}),(0,P.jsxs)(`div`,{className:G.body,children:[i&&!h&&(0,P.jsx)(`div`,{className:G.message,role:`status`,children:i}),a.command&&(0,P.jsx)(`div`,{className:G.errorMessage,role:`alert`,children:a.command}),a.alias&&(0,P.jsx)(`div`,{className:G.errorMessage,role:`alert`,children:a.alias}),h&&(0,P.jsx)(`div`,{className:G.warningMessage,role:`status`,children:i??y}),(0,P.jsxs)(`div`,{className:G.row,children:[(0,P.jsx)(`span`,{"aria-hidden":`true`}),(0,P.jsx)(`label`,{className:G.rowLabel,htmlFor:`node-edit-type`,children:`type`}),(0,P.jsxs)(`div`,{className:G.rowValue,children:[(0,P.jsx)(`input`,{id:`node-edit-type`,ref:u,className:G.valueInput,value:t.nodeType,disabled:g,"aria-invalid":!!a.nodeType,onChange:e=>C({nodeType:e.target.value})}),a.nodeType&&(0,P.jsx)(`span`,{className:G.errorText,children:a.nodeType})]}),(0,P.jsx)(`span`,{className:G.rowSpacer,"aria-hidden":`true`})]}),t.properties.map(e=>{let t=a[Yn(e.id,`key`)],n=a[Yn(e.id,`value`)];return(0,P.jsxs)(`div`,{"data-row-id":e.id,className:E===e.id?`${G.row} ${G.rowDropTarget}`:G.row,onDragOver:ie(e.id),onDrop:oe(e.id),children:[(0,P.jsx)(`span`,{className:G.dragGrip,role:`button`,"aria-label":`Reorder property ${e.key.trim()||`(empty)`}`,title:`Drag to reorder — same keys append as [0], [1], … in row order`,draggable:!g,onDragStart:re(e.id),onDragEnd:D,children:`⠿`}),(0,P.jsxs)(`div`,{className:G.rowKey,children:[(0,P.jsx)(`input`,{ref:t=>{t?d.current.set(e.id,t):d.current.delete(e.id)},className:G.keyInput,value:e.key,placeholder:`key`,"aria-label":`Property key`,disabled:g,"aria-invalid":!!t,onChange:t=>w(e.id,{key:t.target.value})}),t&&(0,P.jsx)(`span`,{className:G.errorText,children:t})]}),(0,P.jsxs)(`div`,{className:G.rowValue,children:[(0,P.jsx)(`textarea`,{className:G.valueInput,value:e.value,placeholder:`value`,"aria-label":`Property value`,disabled:g,rows:$o(e.value),"aria-invalid":!!n,onChange:t=>w(e.id,{value:t.target.value})}),n&&(0,P.jsx)(`span`,{className:G.errorText,children:n})]}),(0,P.jsx)(`button`,{type:`button`,className:G.removeButton,"aria-label":`Remove property`,disabled:g,onClick:()=>te(e.id),children:(0,P.jsx)(Yo,{className:G.removeIcon,"aria-hidden":`true`,focusable:`false`})})]},e.id)}),(0,P.jsx)(`div`,{className:E===`end`?`${G.addRow} ${G.rowDropTarget}`:G.addRow,onDragOver:ie(`end`),onDrop:oe(null),children:(0,P.jsxs)(`button`,{type:`button`,className:G.addButton,disabled:g,onClick:ee,children:[(0,P.jsx)(`span`,{"aria-hidden":`true`,children:`+`}),(0,P.jsx)(`span`,{children:`Add Property`})]})})]}),(0,P.jsxs)(`footer`,{className:G.footer,children:[(0,P.jsx)(`button`,{type:`button`,className:G.secondaryButton,onClick:c,disabled:m,children:`Cancel`}),(0,P.jsx)(`button`,{type:`submit`,className:G.primaryButton,disabled:g,children:m?v:_})]})]})})}var K={root:`_root_rdck7_7`,card:`_card_rdck7_17`,ribbon:`_ribbon_rdck7_30`,titleGroup:`_titleGroup_rdck7_41`,title:`_title_rdck7_41`,path:`_path_rdck7_54`,ribbonClose:`_ribbonClose_rdck7_61`,ribbonCloseIcon:`_ribbonCloseIcon_rdck7_90`,body:`_body_rdck7_96`,description:`_description_rdck7_105`,inputHints:`_inputHints_rdck7_112`,inputHintsLabel:`_inputHintsLabel_rdck7_122`,inputHintList:`_inputHintList_rdck7_128`,moreHints:`_moreHints_rdck7_135`,inputHintsNote:`_inputHintsNote_rdck7_147`,dropZone:`_dropZone_rdck7_153`,dropZoneActive:`_dropZoneActive_rdck7_175`,dropZoneIcon:`_dropZoneIcon_rdck7_181`,dropZoneText:`_dropZoneText_rdck7_187`,dropZoneOr:`_dropZoneOr_rdck7_200`,browseButton:`_browseButton_rdck7_207`,fileInputHidden:`_fileInputHidden_rdck7_236`,fileError:`_fileError_rdck7_241`,textareaLabel:`_textareaLabel_rdck7_246`,textarea:`_textarea_rdck7_246`,validationError:`_validationError_rdck7_274`,keyboardHint:`_keyboardHint_rdck7_279`,errorBanner:`_errorBanner_rdck7_284`,footer:`_footer_rdck7_295`,footerActions:`_footerActions_rdck7_305`,formatButton:`_formatButton_rdck7_311`,cancelButton:`_cancelButton_rdck7_312`,uploadButton:`_uploadButton_rdck7_313`,spinner:`_spinner_rdck7_380`,spin:`_spin_rdck7_380`};function ts({uploadPath:e,json:t,onSuccess:n,onError:r}){let[i,a]=(0,j.useState)(!1),o=(0,j.useRef)(null),s=(0,j.useCallback)(()=>{o.current?.abort(),o.current=null,a(!1)},[]);return{isUploading:i,upload:(0,j.useCallback)(async()=>{o.current?.abort();let i=new AbortController;o.current=i,a(!0);try{let o=await fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:t,signal:i.signal}),s=await o.text();if(!o.ok){a(!1),r(`HTTP ${o.status} — ${s}`);return}a(!1),n(s)}catch(e){if(e.name===`AbortError`){a(!1);return}a(!1),r(e.message??`Network error`)}},[e,t,n,r]),cancel:s}}var ns=(navigator.userAgentData?.platform??navigator.platform).toLowerCase().includes(`mac`);function rs(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=()=>n(Error(`Could not read file "${e.name}"`)),r.readAsText(e,`utf-8`)})}function is(e){let t=e.name.toLowerCase().endsWith(`.json`),n=e.type===`application/json`||e.type===`text/plain`;return!t&&!n?`"${e.name}" does not appear to be a JSON file. Only .json files are accepted.`:null}function as({uploadPath:e,onSuccess:t,onClose:n,onError:r,title:i=`⬆️ Upload Mock Data`,description:a,inputPathHints:o=[],submitLabel:s=`Upload`}){let[c,l]=(0,j.useState)(``),[u,d]=(0,j.useState)(null),[f,p]=(0,j.useState)(null),[m,h]=(0,j.useState)(!1),g=(0,j.useRef)(null),_=(0,j.useRef)(null),v=Te(c).isJSON,y=v&&c.trim()!==``,{isUploading:b,upload:x,cancel:S}=ts({uploadPath:e,json:c,onSuccess:n=>t(n,e),onError:e=>{d(e),r(e)}}),C=(0,j.useCallback)(()=>{S(),n(e)},[S,n,e]),w=(0,j.useRef)(b);(0,j.useEffect)(()=>{w.current=b},[b]),(0,j.useEffect)(()=>{g.current?.focus();let e=e=>{e.key===`Escape`&&(e.preventDefault(),w.current||C())};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[C]);let ee=(0,j.useCallback)(()=>{d(null),x()},[x]),te=(0,j.useCallback)(e=>{e.key===`Enter`&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),y&&!b&&ee())},[y,b,ee]),T=(0,j.useCallback)(()=>{v&&l(de(c))},[v,c]),E=(0,j.useCallback)(async e=>{p(null),d(null);let t=is(e);if(t){p(t);return}try{let t=await rs(e);if(!Te(t).isJSON){p(`"${e.name}" contains invalid JSON.`);return}l(de(t)),g.current?.focus()}catch(e){p(e.message)}},[]),ne=(0,j.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),m||h(!0)},[m]),D=(0,j.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),(e.currentTarget===e.target||!e.currentTarget.contains(e.relatedTarget))&&h(!1)},[]),re=(0,j.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),h(!1);let t=e.dataTransfer.files[0];t&&E(t)},[E]),ie=(0,j.useCallback)(e=>{let t=e.target.files?.[0];t&&(E(t),e.target.value=``)},[E]),ae=!v&&c.trim()!==``;return(0,P.jsx)(`div`,{className:K.root,children:(0,P.jsxs)(`section`,{className:K.card,"aria-label":i,children:[(0,P.jsxs)(`header`,{className:K.ribbon,children:[(0,P.jsxs)(`div`,{className:K.titleGroup,children:[(0,P.jsx)(`span`,{className:K.title,children:i}),(0,P.jsx)(`span`,{className:K.path,children:e})]}),(0,P.jsx)(`button`,{className:K.ribbonClose,onClick:C,"aria-label":`Close upload panel`,title:`Close (Esc)`,disabled:b,children:(0,P.jsx)(Yo,{className:K.ribbonCloseIcon,"aria-hidden":`true`,focusable:`false`})})]}),(0,P.jsxs)(`div`,{className:K.body,children:[a&&(0,P.jsx)(`p`,{className:K.description,children:a}),o.length>0&&(0,P.jsxs)(`div`,{className:K.inputHints,"aria-label":`Referenced graph input paths`,children:[(0,P.jsx)(`span`,{className:K.inputHintsLabel,children:`Referenced input paths`}),(0,P.jsxs)(`div`,{className:K.inputHintList,children:[o.slice(0,6).map(e=>(0,P.jsx)(`code`,{children:e},e)),o.length>6&&(0,P.jsxs)(`span`,{className:K.moreHints,children:[`+`,o.length-6,` more`]})]}),(0,P.jsx)(`span`,{className:K.inputHintsNote,children:`Hints are derived from graph references.`})]}),(0,P.jsxs)(`div`,{className:`${K.dropZone} ${m?K.dropZoneActive:``}`,onDragOver:ne,onDragLeave:D,onDrop:re,"aria-label":`Drop a JSON file here`,children:[(0,P.jsx)(`span`,{className:K.dropZoneIcon,children:`📂`}),(0,P.jsxs)(`span`,{className:K.dropZoneText,children:[`Drop a `,(0,P.jsx)(`code`,{children:`.json`}),` file here`]}),(0,P.jsx)(`span`,{className:K.dropZoneOr,children:`— or —`}),(0,P.jsx)(`input`,{ref:_,type:`file`,accept:`.json,application/json`,className:K.fileInputHidden,"aria-hidden":`true`,tabIndex:-1,onChange:ie}),(0,P.jsx)(`button`,{type:`button`,className:K.browseButton,onClick:()=>_.current?.click(),disabled:b,"aria-label":`Browse for a JSON file`,children:`Browse file…`})]}),f&&(0,P.jsxs)(`span`,{className:K.fileError,role:`alert`,children:[`⚠️ `,f]}),(0,P.jsx)(`label`,{htmlFor:`mock-upload-textarea`,className:K.textareaLabel,children:`JSON Payload`}),(0,P.jsx)(`textarea`,{id:`mock-upload-textarea`,ref:g,className:K.textarea,value:c,onChange:e=>{l(e.target.value),p(null)},onKeyDown:te,placeholder:`Paste JSON here, or drop / browse a .json file above`,rows:10,spellCheck:!1,"aria-describedby":ae?`mock-upload-validation`:void 0}),ae&&(0,P.jsx)(`span`,{id:`mock-upload-validation`,className:K.validationError,role:`status`,children:`⚠️ Invalid JSON — check syntax`}),(0,P.jsx)(`span`,{className:K.keyboardHint,children:ns?`⌘+Enter to ${s.toLowerCase()}`:`Ctrl+Enter to ${s.toLowerCase()}`}),u&&(0,P.jsxs)(`div`,{className:K.errorBanner,role:`alert`,children:[`❌ Upload failed: `,u]})]}),(0,P.jsxs)(`footer`,{className:K.footer,children:[(0,P.jsx)(`button`,{className:K.formatButton,onClick:T,disabled:!v||b,title:`Format JSON`,"aria-label":`Format JSON`,children:`Format`}),(0,P.jsxs)(`div`,{className:K.footerActions,children:[(0,P.jsx)(`button`,{className:K.cancelButton,onClick:C,disabled:b,children:`Cancel`}),(0,P.jsx)(`button`,{className:K.uploadButton,onClick:ee,disabled:!y||b,"aria-busy":b,children:b?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(`span`,{className:K.spinner,"aria-hidden":`true`}),` Uploading…`]}):s===`Upload`?`Upload ▶`:s})]})]})]})})}var os={popover:`_popover_qw337_7`,header:`_header_qw337_19`,endpoint:`_endpoint_qw337_30`,arrow:`_arrow_qw337_41`,chips:`_chips_qw337_46`,chip:`_chip_qw337_46`,customRow:`_customRow_qw337_73`,input:`_input_qw337_78`,submitButton:`_submitButton_qw337_100`,errorText:`_errorText_qw337_122`,statusText:`_statusText_qw337_128`,warningText:`_warningText_qw337_129`},ss=12;function cs({formState:e,phase:t,lockReason:n,serverMessage:r,validationErrors:i,anchor:a,onFormStateChange:o,onSubmit:s,onClose:c}){let l=(0,j.useRef)(null),u=(0,j.useRef)(null),[d,f]=(0,j.useState)(null),p=t===`sending`,m=n===`disconnected`,h=p||m,g=(0,j.useRef)(null);(0,j.useEffect)(()=>{g.current!==null&&e.relation===g.current&&(g.current=null,h||s())},[h,e.relation,s]),(0,j.useEffect)(()=>{u.current?.focus()},[]),(0,j.useLayoutEffect)(()=>{let e={x:window.innerWidth/2,y:96},t=a??e,n=l.current?.getBoundingClientRect(),r=n?.width??280,i=n?.height??180;f({left:Math.min(Math.max(t.x-r/2,ss),Math.max(ss,window.innerWidth-r-ss)),top:Math.min(Math.max(t.y+14,ss),Math.max(ss,window.innerHeight-i-ss))})},[a]),(0,j.useEffect)(()=>{let e=e=>{e.key===`Escape`&&(e.preventDefault(),p||c())},t=e=>{p||l.current&&!l.current.contains(e.target)&&c()};return document.addEventListener(`keydown`,e),document.addEventListener(`pointerdown`,t),()=>{document.removeEventListener(`keydown`,e),document.removeEventListener(`pointerdown`,t)}},[c,p]);let _=(0,j.useCallback)(t=>{o({...e,relation:t})},[e,o]),v=(0,j.useCallback)(t=>{h||(g.current=t,o({...e,relation:t}))},[h,e,o]),y=(0,j.useCallback)(e=>{e.preventDefault(),!h&&s()},[h,s]),b=i.relation??i.command??i.sourceAlias??i.targetAlias;return(0,P.jsxs)(`div`,{ref:l,className:os.popover,style:d?{left:d.left,top:d.top}:{visibility:`hidden`},role:`dialog`,"aria-label":`Create connection from ${e.sourceAlias} to ${e.targetAlias}`,children:[(0,P.jsxs)(`div`,{className:os.header,children:[(0,P.jsx)(`span`,{className:os.endpoint,children:e.sourceAlias}),(0,P.jsx)(`span`,{className:os.arrow,"aria-hidden":`true`,children:`→`}),(0,P.jsx)(`span`,{className:os.endpoint,children:e.targetAlias})]}),(0,P.jsx)(`div`,{className:os.chips,children:bi.map(e=>(0,P.jsx)(`button`,{type:`button`,className:os.chip,style:{"--chip-color":xi[e]},disabled:h,onClick:()=>v(e),children:e},e))}),(0,P.jsxs)(`form`,{className:os.customRow,onSubmit:y,children:[(0,P.jsx)(`input`,{ref:u,className:os.input,value:e.relation,placeholder:`custom relation…`,autoComplete:`off`,autoCorrect:`off`,spellCheck:!1,disabled:h,"aria-label":`Relation name`,"aria-invalid":!!i.relation,onChange:e=>_(e.target.value)}),(0,P.jsx)(`button`,{type:`submit`,className:os.submitButton,disabled:h||!e.relation.trim(),children:p?`Creating…`:`Connect`})]}),b&&!p&&(0,P.jsx)(`div`,{className:os.errorText,role:`alert`,children:b}),r&&(0,P.jsx)(`div`,{className:m?os.warningText:os.statusText,role:`status`,children:r})]})}var ls=1e4,us=`A graph authoring action is already pending. Wait for it to finish before starting another.`,ds=`Could not send the create-node command because the WebSocket is not open. The form values remain in this dialog.`,fs=`Could not send the edit-node command because the WebSocket is not open. Your changes remain in this dialog.`,ps=`Could not send the delete-node command because the WebSocket is not open.`,ms=`Could not send the create-connection command because the WebSocket is not open. The form values remain in this dialog.`,hs=`Could not send delete-node commands because the WebSocket is not open.`,gs=`No selected nodes are available to delete.`,_s=`Select 100 or fewer nodes to delete at once.`,vs=`Some delete-node commands were sent, but not all backend results were observed yet. Refresh the graph before trying again.`,ys=`This node is no longer available in the current graph.`,bs=`Connection disconnected. Refresh the page and create the node again after the app reconnects.`,xs=`Connection disconnected. Refresh the page and edit the node again after the app reconnects.`,Ss=`Connection disconnected. Refresh the page and create the connection again after the app reconnects.`,Cs=`Connection disconnected while the graph authoring action was pending. The outcome is unknown. Refresh the page and check the graph before trying again.`,ws={status:`closed`,pendingSubmit:null,serverMessage:null};function Ts(e){return e.pendingSubmit}function Es(e){return e.action===`delete-nodes`}function Ds(e){return e===`create-connection`?ms:e===`edit-node`?fs:e===`delete-node`?ps:ds}function Os(e){return Es(e)?vs:`The ${e.action} command was sent, but no backend result was observed yet. The outcome is unknown.`}function ks(e){return e===`create-connection`?Ss:e===`edit-node`?xs:bs}function As(e,t){return!e||!t?!1:e.trim().toLowerCase()===t.trim().toLowerCase()}function js(e,t){return e?.nodes.find(e=>e.alias.toLowerCase()===t.toLowerCase())??null}function Ms(e,t){return e.status===`error`?!0:t.action===`create-connection`?e.action===`create-connection`?e.alias===null?!0:As(e.alias,t.alias)?e.status===`accepted`?As(e.targetAlias,t.targetAlias):e.targetAlias===null||As(e.targetAlias,t.targetAlias):!1:e.action===null?As(e.alias,t.alias)||As(e.alias,t.targetAlias):!1:As(e.alias,t.alias)?e.action===null||e.action===t.action:!1}function Ns(e,t){let n=Ts(e);return!n||Es(n)||!Ms(t,n)?null:t.status===`accepted`?{state:ws,acceptedResult:{status:t.status,action:t.action,alias:t.alias,targetAlias:t.targetAlias,message:t.message}}:e.status===`open`?{state:{...e,phase:`editing`,pendingSubmit:null,serverMessage:t.status===`error`?`Backend returned an error while this submit was pending: ${t.message}`:t.message}}:{state:ws,notification:{message:t.message,type:`error`}}}function Ps(e){return{...e,phase:`editing`,pendingSubmit:null,serverMessage:Ds(e.action)}}function Fs(e){let t=Ts(e);if(!t)return null;let n=Os(t);return e.status===`open`?{state:{...e,phase:`editing`,pendingSubmit:null,serverMessage:n}}:{state:ws,notification:{message:n,type:`error`}}}function Is(e){let t=Ts(e);if(e.status===`open`){let n=t?Cs:ks(e.action);return{state:{...e,phase:`editing`,pendingSubmit:null,serverMessage:n,connectionLost:!0}}}return t?{state:ws,notification:{message:Cs,type:`error`}}:null}function Ls(e){return`sourceAlias`in e}function Rs({bus:e,connected:t,graphData:n,executor:r,timeoutMs:i=ls,onAccepted:a,onUserMessage:o}){let[s,c]=(0,j.useState)(ws),[l,u]=(0,j.useState)({}),d=(0,j.useRef)(s),f=(0,j.useRef)(null),p=(0,j.useRef)(t),m=(0,j.useRef)(n),h=(0,j.useRef)(a),g=(0,j.useRef)(o);(0,j.useEffect)(()=>{d.current=s},[s]),(0,j.useEffect)(()=>{m.current=n},[n]),(0,j.useEffect)(()=>{h.current=a},[a]),(0,j.useEffect)(()=>{g.current=o},[o]);let _=(0,j.useCallback)((e,t=`error`)=>{g.current?.(e,t)},[]),v=(0,j.useCallback)(e=>{d.current=e,c(e)},[]),y=(0,j.useCallback)(()=>{f.current!==null&&(clearTimeout(f.current),f.current=null)},[]),b=(0,j.useCallback)(()=>{y(),f.current=setTimeout(()=>{let e=Fs(d.current);e&&(v(e.state),e.notification&&_(e.notification.message,e.notification.type)),f.current=null},i)},[y,_,v,i]),x=(0,j.useCallback)(e=>{if(!t)return;if(Ts(d.current)){_(us,`error`);return}let n=_r(e);u({}),v({status:`open`,action:`create-node`,phase:`editing`,formState:n,originalAlias:null,pendingSubmit:null,serverMessage:null,connectionLost:!1})},[t,_,v]),S=(0,j.useCallback)((e,n)=>{if(!t)return;if(Ts(d.current)){_(us,`error`);return}let r={sourceAlias:e,targetAlias:n,relation:``},{relation:i,...a}=nr(r,{graphData:m.current,connected:t}).errors;Object.keys(a).length>0||(u({}),v({status:`open`,action:`create-connection`,phase:`editing`,formState:r,pendingSubmit:null,serverMessage:null,connectionLost:!1}))},[t,_,v]),C=(0,j.useCallback)(e=>{if(!t){_(xs,`error`);return}if(Ts(d.current)){_(us,`error`);return}let n=js(m.current,e.alias);if(!n){_(ys,`error`);return}let r=Er(n);if(!r.valid||!r.formState){_(r.message??`This node cannot be edited in the UI.`,`error`);return}u({}),v({status:`open`,action:`edit-node`,phase:`editing`,formState:r.formState,originalAlias:n.alias,pendingSubmit:null,serverMessage:null,connectionLost:!1})},[t,_,v]),w=(0,j.useCallback)(e=>{if(!t){_(ps,`error`);return}if(Ts(d.current)){_(us,`error`);return}let n=$n(e.alias,{graphData:m.current});if(!n.valid){_(Object.values(n.errors)[0]??`Invalid node alias.`,`error`);return}let i;try{i=lr(e.alias,{graphData:m.current})}catch(e){_(e instanceof Error?e.message:String(e),`error`);return}if(!r.execute(i)){_(ps,`error`);return}let a={action:`delete-node`,alias:e.alias.trim(),command:i,sentAt:new Date().toISOString()};u({}),v({status:`closed`,pendingSubmit:a,serverMessage:null}),b()},[t,r,_,v,b]),ee=(0,j.useCallback)(e=>{if(!t){_(hs,`error`);return}if(Ts(d.current)){_(us,`error`);return}if(e.length===0){_(gs,`info`);return}if(e.length>100){_(_s,`error`);return}let n=new Set,i=e.filter(e=>{let t=e.alias.trim().toLowerCase();return n.has(t)?!1:(n.add(t),!0)}),a=[],o=[];for(let e of i){let t=$n(e.alias,{graphData:m.current});if(!t.valid){_(Object.values(t.errors)[0]??gs,`error`);return}try{o.push(e.alias.trim()),a.push(lr(e.alias,{graphData:m.current}))}catch(e){_(e instanceof Error?e.message:String(e),`error`);return}}for(let[e,t]of a.entries())if(!r.execute(t)){_(e===0?hs:Cs,`error`);return}let s={action:`delete-nodes`,aliases:o,commands:a,sentAt:new Date().toISOString(),results:{}};u({}),v({status:`closed`,pendingSubmit:s,serverMessage:null}),_(`${o.length} delete-node commands sent. Waiting for backend response.`,`info`),b()},[t,r,_,v,b]),te=(0,j.useCallback)(e=>{let t=d.current;if(t.status===`open`&&!(t.phase===`sending`||t.connectionLost)){if(u({}),t.action===`create-connection`){if(!Ls(e))return;v({...t,formState:e,pendingSubmit:null,serverMessage:null,connectionLost:!1});return}Ls(e)||v({...t,formState:e,pendingSubmit:null,serverMessage:null,connectionLost:!1})}},[v]),T=(0,j.useCallback)(()=>{let e=d.current;if(e.status!==`open`||e.phase===`sending`||e.connectionLost)return;let n=e.action;if(!t){v({...e,serverMessage:Ds(n)});return}let i=e.action===`create-connection`?nr(e.formState,{graphData:m.current,connected:t}):Qn(e.formState,e.action===`edit-node`?{mode:`edit`,originalAlias:e.originalAlias}:{graphData:m.current});if(!i.valid){u(i.errors);return}let a,o,s=null;try{if(e.action===`edit-node`)o=e.originalAlias?.trim()??``,a=cr(e.formState,o);else if(e.action===`create-node`)o=e.formState.alias.trim(),a=sr(e.formState);else if(Ls(e.formState))o=e.formState.sourceAlias.trim(),s=e.formState.targetAlias.trim(),a=dr(e.formState);else{u({command:`Invalid connection form state.`});return}}catch(e){u({command:e instanceof Error?e.message:String(e)});return}if(!r.execute(a)){v(Ps(e));return}let c={action:n,alias:o,targetAlias:s,command:a,sentAt:new Date().toISOString()};u({}),v({...e,phase:`sending`,pendingSubmit:c,serverMessage:null,connectionLost:!1}),b()},[t,r,v,b]),E=(0,j.useCallback)(()=>{let e=d.current;e.status===`open`&&e.phase!==`sending`&&(y(),u({}),v(ws))},[y,v]);return(0,j.useEffect)(()=>e.on(`minigraph.nodeAction.textResult`,e=>{let t=d.current,n=Ts(t);if(!n)return;if(Es(n)){let r=Ir(n,e);if(!r)return;if(e.status===`accepted`&&h.current?.({status:e.status,action:e.action,alias:e.alias,targetAlias:e.targetAlias,message:e.message}),!Lr(r)){v({...t,pendingSubmit:r});return}y(),v(ws);let i=Rr(r);_(i.message,i.type);return}let r=Ns(t,e);r&&(y(),r.acceptedResult&&u({}),v(r.state),r.acceptedResult&&h.current?.(r.acceptedResult),r.notification&&_(r.notification.message,r.notification.type))}),[e,y,_,v]),(0,j.useEffect)(()=>{if(p.current&&!t){let e=Is(d.current);e&&(y(),v(e.state),e.notification&&_(e.notification.message,e.notification.type))}p.current=t},[y,t,_,v]),(0,j.useEffect)(()=>()=>{y()},[y]),{state:s,validationErrors:l,openCreateNode:x,openCreateConnection:S,openEditNode:C,deleteNode:w,deleteNodes:ee,updateFormState:te,submit:T,close:E}}var zs=/^ws-\d+-\d+$/;function Bs(e){return zs.test(e.trim())}var Vs={sessionId:null,startedSince:null,subscribedTo:null,subscribers:[],loading:!1,pendingCommand:null,error:null,lastInfo:null};function Hs(e){return Array.from(new Set(e)).sort()}function Us({enabled:e,connected:t,bus:n,classificationMap:r,sendRawText:i,addToast:a}){let[o,s]=(0,j.useState)(Vs),c=(0,j.useRef)(new Set),l=(0,j.useRef)(0),u=(0,j.useRef)(i),d=(0,j.useRef)(a);(0,j.useEffect)(()=>{u.current=i},[i]),(0,j.useEffect)(()=>{d.current=a},[a]);let f=(0,j.useCallback)(()=>{if(!e||!t)return!1;s(e=>({...e,loading:!0,pendingCommand:`refresh`,error:null,lastInfo:null}));let n=u.current(`session`);if(!n){let e=`Could not load session details because the WebSocket is not open.`;s(t=>({...t,loading:!1,pendingCommand:null,error:e})),d.current(e,`error`)}return n},[t,e]),p=(0,j.useCallback)(e=>{let t=`${e.kind}:${e.msgId}`;if(!c.current.has(t)){if(c.current.add(t),e.kind===`minigraph.session.started`){s({...Vs,sessionId:e.sessionId});return}if(e.kind===`minigraph.session.status`){s(t=>({...t,sessionId:e.sessionId,startedSince:e.startedSince,subscribedTo:e.subscribedTo,subscribers:Hs(e.subscribers),loading:!1,pendingCommand:null,error:null,lastInfo:null}));return}if(e.kind===`minigraph.session.commandResult`){if(e.status===`accepted`){s(t=>({...t,subscribedTo:e.command===`subscribe`?e.sessionId:e.command===`unsubscribe`?null:t.subscribedTo,pendingCommand:null,error:null,lastInfo:null}));return}s(t=>({...t,pendingCommand:null,error:e.message,lastInfo:null}));return}if(e.kind===`minigraph.session.notification`){e.type===`host-closed`?s(t=>({...t,subscribedTo:t.subscribedTo===e.sessionId?null:t.subscribedTo,subscribers:t.subscribers.filter(t=>t!==e.sessionId),error:null,lastInfo:null})):e.type===`subscriber-joined`?s(t=>({...t,subscribers:Hs([...t.subscribers,e.sessionId]),error:null,lastInfo:null})):s(t=>({...t,subscribers:t.subscribers.filter(t=>t!==e.sessionId),error:null,lastInfo:null}));return}e.kind===`session.reset`&&(s(e=>({...e,startedSince:null,subscribedTo:null,subscribers:[],loading:!1,pendingCommand:null,error:null,lastInfo:null})),f())}},[f]),m=(0,j.useCallback)(()=>{s(e=>({...e,error:null,lastInfo:null}))},[]),h=(0,j.useCallback)(n=>{let r=n.trim();if(!e||!t||o.pendingCommand!==null||o.subscribedTo!==null)return!1;if(!Bs(r))return s(e=>({...e,error:`Enter a valid session ID like ws-123456-1.`,lastInfo:null})),!1;s(e=>({...e,pendingCommand:`subscribe`,error:null,lastInfo:null}));let c=i(`session subscribe ${r}`);if(!c){let e=`Could not subscribe because the WebSocket is not open.`;s(t=>({...t,pendingCommand:null,error:e})),a(e,`error`)}return c},[a,t,e,i,o.pendingCommand,o.subscribedTo]),g=(0,j.useCallback)(()=>{if(!e||!t||o.pendingCommand!==null||o.subscribedTo===null)return!1;s(e=>({...e,pendingCommand:`unsubscribe`,error:null,lastInfo:null}));let n=i(`session unsubscribe`);if(!n){let e=`Could not unsubscribe because the WebSocket is not open.`;s(t=>({...t,pendingCommand:null,error:e})),a(e,`error`)}return n},[a,t,e,i,o.pendingCommand,o.subscribedTo]),_=(0,j.useCallback)(()=>{if(!e||!t||o.pendingCommand!==null||o.subscribedTo!==null||o.subscribers.length===0)return!1;s(e=>({...e,pendingCommand:`reset`,error:null,lastInfo:null}));let n=i(`session reset`);if(!n){let e=`Could not reset because the WebSocket is not open.`;s(t=>({...t,pendingCommand:null,error:e})),a(e,`error`)}return n},[a,t,e,i,o.pendingCommand,o.subscribedTo,o.subscribers.length]);(0,j.useEffect)(()=>{e&&t||(c.current.clear(),l.current=0,s(Vs))},[t,e]),(0,j.useEffect)(()=>{if(!e)return;let t=n.on(`minigraph.session.started`,e=>{p(e)}),r=n.on(`minigraph.session.status`,e=>{p(e)}),i=n.on(`minigraph.session.commandResult`,e=>{p(e)}),a=n.on(`minigraph.session.notification`,e=>{p(e)}),o=n.on(`session.reset`,e=>{p(e)});return()=>{t(),r(),i(),a(),o()}},[n,e,p]),(0,j.useEffect)(()=>{!e||!t||f()},[t,e,f]),(0,j.useEffect)(()=>{if(!e||!r)return;let t=l.current;for(let[e,n]of r)if(!(e<=l.current)){for(let e of n)(e.kind===`minigraph.session.started`||e.kind===`minigraph.session.status`||e.kind===`minigraph.session.commandResult`||e.kind===`minigraph.session.notification`||e.kind===`session.reset`)&&p(e);t=Math.max(t,e)}l.current=t,c.current.clear()},[r,e,p]);let v=o.subscribedTo===null,y=o.subscribers.length>0;return(0,j.useMemo)(()=>({state:o,connected:t,isPrimary:v,hasSubscribers:y,canSubscribe:e&&t&&o.pendingCommand===null&&o.subscribedTo===null,canUnsubscribe:e&&t&&o.subscribedTo!==null&&o.pendingCommand===null,canReset:e&&t&&o.pendingCommand===null&&o.subscribedTo===null&&o.subscribers.length>0,subscribeToSession:h,unsubscribe:g,resetSession:_,clearMessage:m}),[m,t,e,y,v,_,o,h,g])}var Ws=(e,t)=>t.some(t=>e instanceof t),Gs,Ks;function qs(){return Gs||=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]}function Js(){return Ks||=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey]}var Ys=new WeakMap,Xs=new WeakMap,Zs=new WeakMap;function Qs(e){let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`success`,i),e.removeEventListener(`error`,a)},i=()=>{t(ic(e.result)),r()},a=()=>{n(e.error),r()};e.addEventListener(`success`,i),e.addEventListener(`error`,a)});return Zs.set(t,e),t}function $s(e){if(Ys.has(e))return;let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`complete`,i),e.removeEventListener(`error`,a),e.removeEventListener(`abort`,a)},i=()=>{t(),r()},a=()=>{n(e.error||new DOMException(`AbortError`,`AbortError`)),r()};e.addEventListener(`complete`,i),e.addEventListener(`error`,a),e.addEventListener(`abort`,a)});Ys.set(e,t)}var ec={get(e,t,n){if(e instanceof IDBTransaction){if(t===`done`)return Ys.get(e);if(t===`store`)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return ic(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t===`done`||t===`store`)||t in e}};function tc(e){ec=e(ec)}function nc(e){return Js().includes(e)?function(...t){return e.apply(ac(this),t),ic(this.request)}:function(...t){return ic(e.apply(ac(this),t))}}function rc(e){return typeof e==`function`?nc(e):(e instanceof IDBTransaction&&$s(e),Ws(e,qs())?new Proxy(e,ec):e)}function ic(e){if(e instanceof IDBRequest)return Qs(e);if(Xs.has(e))return Xs.get(e);let t=rc(e);return t!==e&&(Xs.set(e,t),Zs.set(t,e)),t}var ac=e=>Zs.get(e);function oc(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,t),s=ic(o);return r&&o.addEventListener(`upgradeneeded`,e=>{r(ic(o.result),e.oldVersion,e.newVersion,ic(o.transaction),e)}),n&&o.addEventListener(`blocked`,e=>n(e.oldVersion,e.newVersion,e)),s.then(e=>{a&&e.addEventListener(`close`,()=>a()),i&&e.addEventListener(`versionchange`,e=>i(e.oldVersion,e.newVersion,e))}).catch(()=>{}),s}function sc(e,{blocked:t}={}){let n=indexedDB.deleteDatabase(e);return t&&n.addEventListener(`blocked`,e=>t(e.oldVersion,e)),ic(n).then(()=>void 0)}var cc=[`get`,`getKey`,`getAll`,`getAllKeys`,`count`],lc=[`put`,`add`,`delete`,`clear`],uc=new Map;function dc(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t==`string`))return;if(uc.get(t))return uc.get(t);let n=t.replace(/FromIndex$/,``),r=t!==n,i=lc.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||cc.includes(n)))return;let a=async function(e,...t){let a=this.transaction(e,i?`readwrite`:`readonly`),o=a.store;return r&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),i&&a.done]))[0]};return uc.set(t,a),a}tc(e=>({...e,get:(t,n,r)=>dc(t,n)||e.get(t,n,r),has:(t,n)=>!!dc(t,n)||e.has(t,n)}));var fc=[`continue`,`continuePrimaryKey`,`advance`],pc={},mc=new WeakMap,hc=new WeakMap,gc={get(e,t){if(!fc.includes(t))return e[t];let n=pc[t];return n||=pc[t]=function(...e){mc.set(this,hc.get(this)[t](...e))},n}};async function*_c(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;let n=new Proxy(t,gc);for(hc.set(n,t),Zs.set(n,ac(t));t;)yield n,t=await(mc.get(n)||t.continue()),mc.delete(n)}function vc(e,t){return t===Symbol.asyncIterator&&Ws(e,[IDBIndex,IDBObjectStore,IDBCursor])||t===`iterate`&&Ws(e,[IDBIndex,IDBObjectStore])}tc(e=>({...e,get(t,n,r){return vc(t,n)?_c:e.get(t,n,r)},has(t,n){return vc(t,n)||e.has(t,n)}}));var yc=`minigraph-clipboard`,bc=1,xc=`items`,Sc=null;function Cc(){return oc(yc,bc,{upgrade(e){e.objectStoreNames.contains(xc)&&e.deleteObjectStore(xc);let t=e.createObjectStore(xc,{keyPath:`id`});t.createIndex(`by-alias`,`node.alias`,{unique:!0}),t.createIndex(`by-clippedAt`,`clippedAt`)}})}function wc(){return Sc||=Cc().catch(async e=>(console.warn(`[clipboard/db] openDB failed, deleting and recreating:`,e),Sc=null,await sc(yc),Cc())),Sc}async function Tc(){return(await(await wc()).getAllFromIndex(xc,`by-clippedAt`)).reverse()}async function Ec(e){return(await wc()).getFromIndex(xc,`by-alias`,e)}async function Dc(e){await(await wc()).add(xc,e)}async function Oc(e,t){let n=(await wc()).transaction(xc,`readwrite`);await n.store.delete(e),await n.store.add(t),await n.done}async function kc(e){await(await wc()).delete(xc,e)}async function Ac(){await(await wc()).clear(xc)}var jc=`minigraph-clipboard-sync`;function Mc(){return new BroadcastChannel(jc)}function Nc(e,t){switch(t.type){case`HYDRATE`:return{items:t.items,isLoading:!1};case`ITEM_ADDED`:return{...e,items:[t.item,...e.items]};case`ITEM_REPLACED`:{let n=e.items.filter(e=>e.id!==t.previousId);return{...e,items:[t.item,...n]}}case`ITEM_REMOVED`:return{...e,items:e.items.filter(e=>e.id!==t.id)};case`ITEMS_CLEARED`:return{...e,items:[]};default:return e}}var Pc=(0,j.createContext)(null);function Fc({children:e}){let[t,n]=(0,j.useReducer)(Nc,{items:[],isLoading:!0}),r=(0,j.useRef)(null);(0,j.useEffect)(()=>{Tc().then(e=>n({type:`HYDRATE`,items:e}))},[]),(0,j.useEffect)(()=>{let e;try{e=Mc()}catch{return}return r.current=e,e.onmessage=e=>{let t=e.data;switch(t.type){case`item-added`:n({type:`ITEM_ADDED`,item:t.item});break;case`item-replaced`:n({type:`ITEM_REPLACED`,item:t.item,previousId:t.previousId});break;case`item-removed`:n({type:`ITEM_REMOVED`,id:t.id});break;case`items-cleared`:n({type:`ITEMS_CLEARED`});break}},()=>{e.close(),r.current=null}},[]);let i=(0,j.useCallback)(e=>{r.current?.postMessage(e)},[]),a=(0,j.useCallback)(async(e,t,r)=>{try{let a={id:crypto.randomUUID(),clippedAt:new Date().toISOString(),sourceWsPath:r.sourceWsPath,sourceLabel:r.sourceLabel,node:e,connections:t},o=await Ec(e.alias);if(o)return{status:`duplicate`,existingItem:o,pendingItem:a};try{await Dc(a)}catch(t){if(t instanceof DOMException&&t.name===`ConstraintError`){let t=await Ec(e.alias);if(t)return{status:`duplicate`,existingItem:t,pendingItem:a}}throw t}return n({type:`ITEM_ADDED`,item:a}),i({type:`item-added`,item:a}),{status:`added`}}catch(e){return{status:`error`,message:e instanceof Error?e.message:String(e)}}},[i]),o=(0,j.useCallback)(async(e,t)=>{await Oc(t,e),n({type:`ITEM_REPLACED`,item:e,previousId:t}),i({type:`item-replaced`,item:e,previousId:t})},[i]),s=(0,j.useCallback)(async e=>{await kc(e),n({type:`ITEM_REMOVED`,id:e}),i({type:`item-removed`,id:e})},[i]),c=(0,j.useCallback)(async()=>{await Ac(),n({type:`ITEMS_CLEARED`}),i({type:`items-cleared`})},[i]);return(0,P.jsx)(Pc.Provider,{value:{items:t.items,isLoading:t.isLoading,clipNode:a,confirmReplace:o,removeItem:s,clearAll:c},children:e})}function Ic(){let e=(0,j.useContext)(Pc);if(!e)throw Error(`useClipboardContext must be used inside <ClipboardProvider>`);return e}var Lc=new Intl.Collator(void 0,{sensitivity:`base`,numeric:!0});function Rc(e){return e.node.types[0]?.trim()||`unknown`}function zc(e,t){return Lc.compare(e,t)}function Bc(e,t){return e-t}function Vc(e){return e===`recent`||e===`connections`?`descending`:`ascending`}function Hc(e,t){return t===`descending`?-e:e}function Uc(e,t){let n=t.trim();if(!n)return{missing:!0,value:``};let r=e.node.properties[n];return r==null?{missing:!0,value:``}:typeof r==`string`?{missing:!1,value:r}:typeof r==`number`||typeof r==`boolean`?{missing:!1,value:String(r)}:{missing:!1,value:JSON.stringify(r)}}function Wc(e,t,n,r){let i=Uc(e,n),a=Uc(t,n);return i.missing&&!a.missing?1:!i.missing&&a.missing?-1:Hc(zc(i.value,a.value),r)}function Gc(e,t){let n=t.direction??Vc(t.field);return e.map((e,t)=>({item:e,originalIndex:t})).sort((e,r)=>{let i=0;switch(t.field){case`type`:i=zc(Rc(e.item),Rc(r.item));break;case`alias`:i=zc(e.item.node.alias,r.item.node.alias);break;case`source`:i=zc(e.item.sourceLabel,r.item.sourceLabel);break;case`connections`:i=e.item.connections.length-r.item.connections.length;break;case`property`:i=Wc(e.item,r.item,t.propertyKey??``,n);break;default:i=Date.parse(e.item.clippedAt)-Date.parse(r.item.clippedAt);break}return t.field!==`property`&&(i=Hc(i,n)),i===0?Bc(e.originalIndex,r.originalIndex):i}).map(({item:e})=>e)}function Kc(e){let t=Date.now()-new Date(e).getTime();if(t<0)return`just now`;let n=Math.floor(t/1e3);if(n<60)return`just now`;let r=Math.floor(n/60);if(r<60)return`${r} min ago`;let i=Math.floor(r/60);if(i<24)return`${i} hour${i>1?`s`:``} ago`;let a=Math.floor(i/24);return a===1?`yesterday`:a<30?`${a} days ago`:new Date(e).toLocaleDateString()}var qc={item:`_item_1ne62_1`,previewFrame:`_previewFrame_1ne62_13`,preview:`_preview_1ne62_13`,previewShell:`_previewShell_1ne62_25`,metaBlock:`_metaBlock_1ne62_29`,timestamp:`_timestamp_1ne62_35`,removeChrome:`_removeChrome_1ne62_40`,removeIcon:`_removeIcon_1ne62_71`};function Jc({item:e,onRemove:t,onOpenMenu:n,onCloseMenu:r}){let{node:i,clippedAt:a,sourceLabel:o}=e;return(0,P.jsxs)(`div`,{className:qc.item,children:[(0,P.jsxs)(`div`,{className:qc.previewFrame,children:[(0,P.jsx)(`button`,{type:`button`,className:qc.removeChrome,draggable:!1,"aria-label":`Remove node ${i.alias} from clipboard`,onClick:n=>{n.stopPropagation(),r(),t(e.id)},children:(0,P.jsx)(Yo,{className:qc.removeIcon,"aria-hidden":`true`,focusable:`false`})}),(0,P.jsx)(`div`,{className:qc.preview,role:`group`,draggable:!0,onDragStart:t=>{r(),Ba(t.dataTransfer,e.id)},onContextMenu:t=>{t.preventDefault(),n(e.id,t.clientX,t.clientY)},onKeyDown:t=>{if(t.key===`ContextMenu`||t.key===`F10`&&t.shiftKey){t.preventDefault();let r=t.currentTarget.getBoundingClientRect();n(e.id,Math.round(r.left+8),Math.round(r.top+8))}},tabIndex:0,"aria-label":`Drag node ${i.alias} into the graph to paste`,children:(0,P.jsx)(`div`,{className:qc.previewShell,style:fi(i.types[0]??`unknown`),children:(0,P.jsx)(gi,{alias:i.alias,nodeType:i.types[0]??`unknown`,properties:i.properties})})})]}),(0,P.jsx)(`div`,{className:qc.metaBlock,children:(0,P.jsxs)(`div`,{className:qc.timestamp,children:[`Clipped `,Kc(a),` from `,o]})})]})}var Yc={menu:`_menu_164vh_1`,menuItem:`_menuItem_164vh_12`},Xc=16;function Zc(e,t,n){let r=Xc,i=Math.max(Xc,n-t-Xc);return Math.min(Math.max(e,r),i)}function Qc({open:e,x:t,y:n,canPasteToInput:r,onPasteToInput:i,onInspect:a,onClose:o}){let s=(0,j.useRef)(null),c=(0,j.useRef)(null),l=(0,j.useRef)(null),[u,d]=(0,j.useState)({left:t,top:n});return(0,j.useLayoutEffect)(()=>{if(!e||!s.current)return;let r=s.current.getBoundingClientRect();d({left:Zc(t,r.width,window.innerWidth),top:Zc(n,r.height,window.innerHeight)})},[e,t,n]),(0,j.useEffect)(()=>{if(!e)return;r?c.current?.focus():l.current?.focus();let t=e=>{s.current&&!s.current.contains(e.target)&&o()},n=e=>{e.key===`Escape`&&(e.preventDefault(),o())},i=()=>o();return document.addEventListener(`pointerdown`,t),document.addEventListener(`keydown`,n),window.addEventListener(`scroll`,i,!0),window.addEventListener(`resize`,i),()=>{document.removeEventListener(`pointerdown`,t),document.removeEventListener(`keydown`,n),window.removeEventListener(`scroll`,i,!0),window.removeEventListener(`resize`,i)}},[e,r,o]),e?(0,P.jsxs)(`div`,{ref:s,className:Yc.menu,style:{left:u.left,top:u.top},role:`menu`,"aria-label":`Clipboard item actions`,children:[(0,P.jsx)(`button`,{ref:c,role:`menuitem`,type:`button`,className:Yc.menuItem,disabled:!r,onClick:()=>{r&&i()},children:`Paste to Input`}),(0,P.jsx)(`button`,{ref:l,role:`menuitem`,type:`button`,className:Yc.menuItem,onClick:a,children:`Inspect`})]}):null}var q={sidebar:`_sidebar_1jo34_2`,header:`_header_1jo34_12`,headerTitle:`_headerTitle_1jo34_25`,clearBtn:`_clearBtn_1jo34_32`,sortBar:`_sortBar_1jo34_48`,sortMenuWrapper:`_sortMenuWrapper_1jo34_63`,sortMenuButton:`_sortMenuButton_1jo34_68`,sortButtonLabel:`_sortButtonLabel_1jo34_93`,sortButtonValue:`_sortButtonValue_1jo34_98`,sortButtonDirection:`_sortButtonDirection_1jo34_106`,sortButtonCaret:`_sortButtonCaret_1jo34_114`,sortButtonCaretOpen:`_sortButtonCaretOpen_1jo34_121`,sortPopover:`_sortPopover_1jo34_125`,sortGroup:`_sortGroup_1jo34_139`,propertySortRow:`_propertySortRow_1jo34_150`,sortGroupTitle:`_sortGroupTitle_1jo34_154`,sortOption:`_sortOption_1jo34_164`,propertyLabel:`_propertyLabel_1jo34_197`,propertyInput:`_propertyInput_1jo34_205`,itemList:`_itemList_1jo34_223`,loading:`_loading_1jo34_233`,emptyState:`_emptyState_1jo34_243`,emptyIcon:`_emptyIcon_1jo34_256`,emptyTitle:`_emptyTitle_1jo34_261`,emptyHint:`_emptyHint_1jo34_265`,inspectPanel:`_inspectPanel_1jo34_271`,inspectHeader:`_inspectHeader_1jo34_279`,inspectClose:`_inspectClose_1jo34_293`,inspectBody:`_inspectBody_1jo34_307`,dialog:`_dialog_1jo34_313`,dialogTitle:`_dialogTitle_1jo34_328`,dialogBody:`_dialogBody_1jo34_335`,dialogActions:`_dialogActions_1jo34_342`,cancelBtn:`_cancelBtn_1jo34_349`,replaceBtn:`_replaceBtn_1jo34_363`};function $c(){return(0,P.jsxs)(`div`,{className:q.emptyState,children:[(0,P.jsx)(`span`,{className:q.emptyIcon,children:`📋`}),(0,P.jsx)(`span`,{className:q.emptyTitle,children:`No items clipped yet.`}),(0,P.jsx)(`span`,{className:q.emptyHint,children:`Right-click a node in the Graph view to get started.`})]})}var el=[{value:`recent`,label:`Recent`},{value:`type`,label:`Type`},{value:`alias`,label:`Alias`},{value:`source`,label:`Source`},{value:`connections`,label:`Connections`},{value:`property`,label:`Property`}],tl=[{value:`ascending`,label:`Ascending`},{value:`descending`,label:`Descending`}],nl=el.reduce((e,t)=>({...e,[t.value]:t.label}),{});function rl({connected:e,onPasteToInput:t}){let n=(0,j.useId)(),i=(0,j.useId)(),a=(0,j.useRef)(null),s=Ic(),[c,l]=(0,j.useState)(null),[u,d]=(0,j.useState)(null),[f,p]=(0,j.useState)(`recent`),[m,h]=(0,j.useState)(Vc(`recent`)),[g,_]=(0,j.useState)(``),[v,y]=(0,j.useState)(!1),b=(e,t,n)=>{d({itemId:e,x:t,y:n})},x=()=>{d(null)},S=e=>{x(),t(e)},C=e=>{x(),l(t=>t?.id===e.id?null:e)},w=e=>{x(),l(t=>t?.id===e?null:t),s.removeItem(e)},ee=()=>{x(),l(null),s.clearAll()},te=e=>{p(e),h(Vc(e))};(0,j.useEffect)(()=>{let e=new Set(s.items.map(e=>e.id));u&&!e.has(u.itemId)&&d(null),c&&!e.has(c.id)&&l(null)},[s.items,u,c]),(0,j.useEffect)(()=>{if(!v)return;let e=e=>{a.current?.contains(e.target)||y(!1)},t=e=>{e.key===`Escape`&&y(!1)};return document.addEventListener(`pointerdown`,e),document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`pointerdown`,e),document.removeEventListener(`keydown`,t)}},[v]);let T=(0,j.useMemo)(()=>u?s.items.find(e=>e.id===u.itemId)??null:null,[u,s.items]),E=(0,j.useMemo)(()=>Gc(s.items,{field:f,direction:m,propertyKey:g}),[s.items,m,f,g]);return(0,P.jsxs)(`div`,{className:q.sidebar,children:[(0,P.jsxs)(`div`,{className:q.header,children:[(0,P.jsx)(`span`,{className:q.headerTitle,children:`Workspace`}),s.items.length>0&&(0,P.jsx)(`button`,{className:q.clearBtn,onClick:ee,"aria-label":`Clear all workspace items`,children:`Clear`})]}),s.items.length>0&&(0,P.jsx)(`div`,{className:q.sortBar,children:(0,P.jsxs)(`div`,{className:q.sortMenuWrapper,ref:a,children:[(0,P.jsxs)(`button`,{type:`button`,className:q.sortMenuButton,onClick:()=>y(e=>!e),"aria-expanded":v,"aria-controls":n,children:[(0,P.jsx)(`span`,{className:q.sortButtonLabel,children:`Sort`}),(0,P.jsx)(`span`,{className:q.sortButtonValue,children:nl[f]}),(0,P.jsx)(`span`,{className:q.sortButtonDirection,children:m===`ascending`?`Asc`:`Desc`}),(0,P.jsx)(`span`,{className:`${q.sortButtonCaret}${v?` ${q.sortButtonCaretOpen}`:``}`,"aria-hidden":`true`,children:`▾`})]}),v&&(0,P.jsxs)(`div`,{id:n,className:q.sortPopover,children:[(0,P.jsxs)(`div`,{className:q.sortGroup,role:`group`,"aria-labelledby":`${n}-field-title`,children:[(0,P.jsx)(`div`,{id:`${n}-field-title`,className:q.sortGroupTitle,children:`Sort By`}),el.map(e=>(0,P.jsxs)(`label`,{className:q.sortOption,children:[(0,P.jsx)(`input`,{type:`radio`,name:`${n}-field`,value:e.value,checked:f===e.value,onChange:()=>te(e.value)}),(0,P.jsx)(`span`,{children:e.label})]},e.value))]}),f===`property`&&(0,P.jsxs)(`div`,{className:q.propertySortRow,children:[(0,P.jsx)(`label`,{className:q.propertyLabel,htmlFor:i,children:`Property Key`}),(0,P.jsx)(`input`,{id:i,className:q.propertyInput,value:g,onChange:e=>_(e.target.value),placeholder:`skill`,"aria-label":`Property key to sort by`})]}),(0,P.jsxs)(`div`,{className:q.sortGroup,role:`group`,"aria-labelledby":`${n}-direction-title`,children:[(0,P.jsx)(`div`,{id:`${n}-direction-title`,className:q.sortGroupTitle,children:`Sort Direction`}),tl.map(e=>(0,P.jsxs)(`label`,{className:q.sortOption,children:[(0,P.jsx)(`input`,{type:`radio`,name:`${n}-direction`,value:e.value,checked:m===e.value,onChange:()=>h(e.value)}),(0,P.jsx)(`span`,{children:e.label})]},e.value))]})]})]})}),(0,P.jsx)(`div`,{className:q.itemList,children:s.isLoading?(0,P.jsx)(`div`,{className:q.loading,children:`Loading…`}):s.items.length===0?(0,P.jsx)($c,{}):E.map(e=>(0,P.jsx)(Jc,{item:e,onRemove:w,onOpenMenu:b,onCloseMenu:x},e.id))}),c&&(0,P.jsxs)(`div`,{className:q.inspectPanel,children:[(0,P.jsxs)(`div`,{className:q.inspectHeader,children:[(0,P.jsxs)(`span`,{children:[`Inspect node `,c.node.alias]}),(0,P.jsx)(`button`,{className:q.inspectClose,onClick:()=>l(null),"aria-label":`Close inspect panel`,children:`✕`})]}),(0,P.jsx)(`div`,{className:q.inspectBody,children:(0,P.jsx)(o,{data:{node:c.node,connections:c.connections},style:r})})]}),u&&T&&(0,P.jsx)(Qc,{open:!0,x:u.x,y:u.y,canPasteToInput:e,onPasteToInput:()=>S(T),onInspect:()=>C(T),onClose:x})]})}function il(e){let{wheelTargetRef:t,scrollRef:n,contentWrapperRef:r,currentIndex:i,totalPages:a,onNavigatePrev:o,onNavigateNext:s}=e,c=(0,j.useRef)(0),l=(0,j.useRef)(null),u=(0,j.useRef)(!1),d=(0,j.useRef)(null),f=(0,j.useRef)(o),p=(0,j.useRef)(s),m=(0,j.useRef)(i),h=(0,j.useRef)(a);(0,j.useEffect)(()=>{f.current=o}),(0,j.useEffect)(()=>{p.current=s}),(0,j.useEffect)(()=>{m.current=i}),(0,j.useEffect)(()=>{h.current=a}),(0,j.useEffect)(()=>{d.current!==null&&(clearTimeout(d.current),d.current=null),r.current&&(r.current.style.transition=`none`,r.current.style.transform=`translateY(0)`),c.current=0,l.current=null},[i]),(0,j.useEffect)(()=>{let e=t.current;if(!e)return;function i(){c.current=0,l.current=null,r.current&&(r.current.style.transition=`transform 0.28s cubic-bezier(0.25, 0.46, 0.45, 0.94)`,r.current.style.transform=`translateY(0)`)}function a(e){if(e.deltaY===0)return;let t=n.current;if(!t)return;let a=t.scrollTop<=0,o=t.scrollTop+t.clientHeight>=t.scrollHeight-1,s=e.deltaY<0,g=e.deltaY>0,_=a&&s,v=o&&g;if(!_&&!v){i();return}if(u.current)return;let y=m.current,b=h.current;if(_&&y===0||v&&y===b-1)return;let x=_?`prev`:`next`;if(l.current!==null&&l.current!==x&&i(),l.current=x,c.current+=Math.abs(e.deltaY),r.current){let e=x===`prev`?-1:1,t=c.current*(18/120),n=Math.min(t,18)*e;r.current.style.transition=`none`,r.current.style.transform=`translateY(${n}px)`}if(d.current!==null&&clearTimeout(d.current),d.current=setTimeout(i,180),c.current>=120){d.current!==null&&clearTimeout(d.current);let e=l.current;i(),u.current=!0,e===`prev`?f.current():p.current(),setTimeout(()=>{u.current=!1},650)}}return e.addEventListener(`wheel`,a,{passive:!0}),()=>{d.current!==null&&clearTimeout(d.current),e.removeEventListener(`wheel`,a)}},[])}var J={helpRoot:`_helpRoot_18tja_2`,categoryNav:`_categoryNav_18tja_11`,categoryTabScroller:`_categoryTabScroller_18tja_21`,categoryTab:`_categoryTab_18tja_21`,categoryTabActive:`_categoryTabActive_18tja_71`,maximizeButton:`_maximizeButton_18tja_78`,closeButton:`_closeButton_18tja_100`,helpBody:`_helpBody_18tja_122`,emptyFallback:`_emptyFallback_18tja_130`,helpContent:`_helpContent_18tja_147`,topicLink:`_topicLink_18tja_226`,helpBodyContent:`_helpBodyContent_18tja_271`,chipStrip:`_chipStrip_18tja_276`,chipStripLabel:`_chipStripLabel_18tja_294`,topicChip:`_topicChip_18tja_310`,topicChipActive:`_topicChipActive_18tja_338`};function al(e){return typeof e==`string`?e:typeof e==`number`?String(e):Array.isArray(e)?e.map(al).join(``):j.isValidElement(e)?al(e.props.children):``}function ol(e){if(!e.trim().toLowerCase().startsWith(`help `))return null;let t=e.trim().slice(5).replace(/\s*\(.*\)\s*$/,``).trim().toLowerCase();return t.length>0?t:null}function sl({activeTopic:e,onNavigate:t,onClose:n,onToggleMaximize:r,isMaximized:i,contentProfile:a=`minigraph`}){let o=(0,j.useRef)(null),s=(0,j.useRef)(null),c=(0,j.useRef)(null),l=(0,j.useRef)(null);(0,j.useEffect)(()=>{o.current&&(o.current.scrollTop=0)},[e]),(0,j.useEffect)(()=>{let e=l.current;if(!e)return;let t=e.querySelector(`[aria-current="step"]`);t&&t.scrollIntoView({block:`nearest`,inline:`nearest`,behavior:`smooth`})},[e]);let u=(0,j.useMemo)(()=>Qt(a),[a]),d=(0,j.useMemo)(()=>rn(a),[a]),f=en(e,a),p=(0,j.useMemo)(()=>tn(f,a),[f,a]),m=p.length,h=(0,j.useMemo)(()=>u.find(e=>e.id===f)?.chipStripLabel??null,[f,u]),g=d.indexOf(e),_=g<0?0:g,v=d.length;il({wheelTargetRef:s,scrollRef:o,contentWrapperRef:c,currentIndex:_,totalPages:v,onNavigatePrev:()=>t(d[_-1]??``),onNavigateNext:()=>t(d[_+1]??d[d.length-1])});let y=Jt(e,a);return(0,P.jsxs)(`div`,{className:J.helpRoot,role:`region`,"aria-label":`Help browser`,ref:s,children:[(0,P.jsxs)(`nav`,{className:J.categoryNav,"aria-label":`Help categories`,children:[(0,P.jsx)(`div`,{className:J.categoryTabScroller,children:u.map(e=>(0,P.jsx)(`button`,{className:[J.categoryTab,e.id===f?J.categoryTabActive:``].join(` `).trim(),"aria-current":e.id===f?`true`:void 0,onClick:()=>{t(tn(e.id,a)[0]??``)},children:e.label},e.id))}),r&&(0,P.jsx)(`button`,{className:J.maximizeButton,onClick:r,"aria-label":i?`Restore help panel`:`Maximize help panel`,children:i?`⊞`:`⛶`}),n&&(0,P.jsx)(`button`,{className:J.closeButton,onClick:n,"aria-label":`Close help panel`,children:`×`})]}),m>1&&(0,P.jsxs)(`div`,{className:J.chipStrip,ref:l,children:[h!==null&&(0,P.jsx)(`span`,{className:J.chipStripLabel,children:h}),p.map(n=>{let r=n===e,i=nn(n,f);return(0,P.jsx)(`button`,{className:[J.topicChip,r?J.topicChipActive:``].join(` `).trim(),"aria-current":r?`step`:void 0,onClick:()=>t(n),children:i},n)})]}),(0,P.jsx)(`div`,{className:J.helpBody,ref:o,children:(0,P.jsx)(`div`,{className:J.helpBodyContent,ref:c,children:y===null?(0,P.jsxs)(`div`,{className:J.emptyFallback,children:[(0,P.jsxs)(`code`,{children:[`help `,e||``]}),`\xA0 not found in the local bundle.`]}):(0,P.jsx)(`div`,{className:J.helpContent,children:(0,P.jsx)(E,{remarkPlugins:[D],components:e===``?{li:({children:e,...n})=>{let r=ol(al(e).trim());return r!==null&&Jt(r,a)!==null?(0,P.jsx)(`li`,{...n,children:(0,P.jsx)(`button`,{className:J.topicLink,"aria-label":`Open help topic: ${r}`,onClick:()=>t(r),children:e})}):(0,P.jsx)(`li`,{...n,children:e})}}:void 0,children:y})})})})]})}function cl({existingItem:e,pendingItem:t,onReplace:n,onCancel:r}){let i=(0,j.useRef)(null);return(0,j.useEffect)(()=>{let e=i.current;e&&!e.open&&e.showModal()},[]),(0,P.jsxs)(`dialog`,{ref:i,className:q.dialog,onClose:r,"aria-labelledby":`duplicate-dialog-title`,children:[(0,P.jsx)(`h2`,{id:`duplicate-dialog-title`,className:q.dialogTitle,children:`Duplicate Node`}),(0,P.jsxs)(`p`,{className:q.dialogBody,children:[`A clipboard item with alias `,(0,P.jsxs)(`strong`,{children:[`"`,t.node.alias,`"`]}),` already exists (clipped `,Kc(e.clippedAt),`).`]}),(0,P.jsx)(`p`,{className:q.dialogBody,children:`Replace it with the new snapshot?`}),(0,P.jsxs)(`div`,{className:q.dialogActions,children:[(0,P.jsx)(`button`,{className:q.cancelBtn,onClick:r,children:`Cancel`}),(0,P.jsx)(`button`,{className:q.replaceBtn,onClick:n,children:`Replace`})]})]})}function ll(e,t,n=`minigraph`){if(!t)return null;let r=e.trim().toLowerCase();if(r!==`help`&&!r.startsWith(`help `))return null;let i=an(e);return Jt(i,n)===null?null:i}var ul=class{constructor(){this.listeners=new Map}on(e,t){let n=e;return this.listeners.has(n)||this.listeners.set(n,new Set),this.listeners.get(n).add(t),()=>{this.listeners.get(n)?.delete(t)}}emit(e){let t=this.listeners.get(e.kind);t&&t.forEach(t=>{try{t(e)}catch(t){console.error(`[ProtocolBus] listener for '${e.kind}' threw:`,t)}})}clear(){this.listeners.clear()}},dl=`(ws-\\d+-\\d+)`,fl=RegExp(`^session ${dl} started(?:\\nCompanion endpoint: (\\/api\\/companion\\/${dl}))?$`,`i`),pl=RegExp(`^Session ${dl} started since (.+)$`),ml=RegExp(`^subscribed to ${dl}$`),hl=/^subscribed by \[(.*)]$/,gl=RegExp(`^Subscribed to ${dl}$`),_l=RegExp(`^Session unsubscribed from ${dl}$`),vl=RegExp(`^Session ${dl} not found$`),yl=RegExp(`^${dl} is not a primary session$`),bl=RegExp(`^You have already subscribed to ${dl}(?:\\nPlease do 'session reset' before subscribing to another session)?$`),xl=RegExp(`^${dl} subscribed to your session$`),Sl=RegExp(`^${dl} unsubscribed from your session$`),Cl=RegExp(`^Session ${dl} has closed$`);function wl(e){let t=e.trim();return t.length===0||t.startsWith(`> `)?null:t}function Tl(e){return e.split(`,`).map(e=>e.trim()).filter(e=>e.length>0&&Bs(e))}function El(e){let t=wl(e);if(!t)return null;let n=t.match(fl);return n?{sessionId:n[1],companionEndpoint:n[2]??null}:null}function Dl(e){let t=wl(e);if(!t)return null;let n=t.split(`
`).map(e=>e.trim()).filter(Boolean),r=n[0];if(!r)return null;let i=r.match(pl);if(!i)return null;let a=null,o=[];for(let e of n.slice(1)){let t=e.match(ml);if(t){a=t[1];continue}let n=e.match(hl);n&&(o=Tl(n[1]))}return{sessionId:i[1],startedSince:i[2],subscribedTo:a,subscribers:o}}function Ol(e){let t=wl(e);if(!t)return null;let n=t.match(gl);if(n)return{command:`subscribe`,status:`accepted`,sessionId:n[1],message:t};let r=t.match(_l);if(r)return{command:`unsubscribe`,status:`accepted`,sessionId:r[1],message:t};let i=t.match(vl);if(i)return{command:`subscribe`,status:`rejected`,sessionId:i[1],message:t};let a=t.match(yl);if(a)return{command:`subscribe`,status:`rejected`,sessionId:a[1],message:t};let o=t.match(bl);return o?{command:`subscribe`,status:`rejected`,sessionId:o[1],message:t}:t===`You cannot subscribe to yourself`?{command:`subscribe`,status:`rejected`,sessionId:null,message:t}:t===`Nothing to unsubscribe`?{command:`unsubscribe`,status:`rejected`,sessionId:null,message:t}:t===`Invalid session command`?{command:`unknown`,status:`rejected`,sessionId:null,message:t}:null}function kl(e){let t=wl(e);if(!t)return null;let n=t.match(xl);if(n)return{type:`subscriber-joined`,sessionId:n[1],message:t};let r=t.match(Sl);if(r)return{type:`subscriber-left`,sessionId:r[1],message:t};let i=t.match(Cl);return i?{type:`host-closed`,sessionId:i[1],message:t}:null}var Al=new Set([`info`,`error`,`ping`,`welcome`]);function jl(e,t){let n=[],r={msgId:e,raw:t},i=!1,a=!1,o=!1,s=!1,c=!1,l=!1,u=Te(t);if(u.isJSON){let e=u.data;if(typeof e.type==`string`){let i=e.type;return n.push({...r,kind:`lifecycle`,type:i,knownType:Al.has(i),message:typeof e.message==`string`?e.message:t,time:e.time??null}),n.length>0?n:[{...r,kind:`unclassified`}]}return n.push({...r,kind:`json.response`,data:u.data}),n.length>0?n:[{...r,kind:`unclassified`}]}let d=Me(t);d&&(c=!0,n.push({...r,kind:`payload.large`,apiPath:d.apiPath,byteSize:d.byteSize,filename:d.filename}));let f=Ne(t);f&&(o=!0,n.push({...r,kind:`upload.invitation`,uploadPath:f}));let p=je(t);if(p&&(s=!0,n.push({...r,kind:`upload.contentPath`,uploadPath:p})),Ae(t)){a=!0;let e=ke(t);e&&n.push({...r,kind:`graph.link`,apiPath:e})}if(a){let e=Ee(t);e&&n.push({...r,kind:`graph.exported`,graphName:e.graphName,apiPath:e.apiPath})}let m=Ke(t);m&&n.push({...r,kind:`graph.mutation`,mutationType:m});let h=kn(t);h&&n.push({...r,kind:`graph.instance.created`,mockEntries:h.mockEntries,ttlMs:h.ttlMs}),An(t)&&n.push({...r,kind:`graph.instance.cleared`});let g=jn(t);g&&n.push({...r,kind:`graph.run.terminal`,status:g.status,elapsedMs:g.elapsedMs});let _=Mn(t);_&&n.push({...r,kind:`command.error`,message:_});let v=Ge(t);v&&n.push({...r,kind:`minigraph.nodeAction.textResult`,status:v.status,action:v.action,alias:v.alias,targetAlias:v.targetAlias,message:v.message}),v&&(v.action===`create-node`||v.status===`error`)&&n.push({...r,kind:`minigraph.createNode.textResult`,status:v.status,alias:v.alias,message:v.message}),t===`Session restarted`&&(l=!0,n.push({...r,kind:`session.reset`}));let y=El(t);y&&(l=!0,n.push({...r,kind:`minigraph.session.started`,sessionId:y.sessionId,companionEndpoint:y.companionEndpoint}));let b=Dl(t);b&&(l=!0,n.push({...r,kind:`minigraph.session.status`,sessionId:b.sessionId,startedSince:b.startedSince,subscribedTo:b.subscribedTo,subscribers:b.subscribers}));let x=Ol(t);x&&(l=!0,n.push({...r,kind:`minigraph.session.commandResult`,command:x.command,status:x.status,sessionId:x.sessionId,message:x.message}));let S=kl(t);S&&(l=!0,n.push({...r,kind:`minigraph.session.notification`,type:S.type,sessionId:S.sessionId,message:S.message})),t.startsWith(`> `)&&(i=!0,n.push({...r,kind:`command.echo`,commandText:t.slice(2)})),Pe(t)&&n.push({...r,kind:`command.helpOrDescribe`,commandText:t.slice(2)});let C=Fe(t);C&&n.push({...r,kind:`command.importGraph`,graphName:C});let w=De(t);return w&&n.push({...r,kind:`graph.export.failed`,reason:w.reason}),!i&&!a&&!o&&!s&&!c&&!l&&Oe(t)&&n.push({...r,kind:`docs.response`,isMarkdown:!0}),n.length===0&&n.push({...r,kind:`unclassified`}),n}function Ml({messages:e,bus:t}){let n=(0,j.useRef)(-1);(0,j.useEffect)(()=>{e.length>0&&(n.current=e[e.length-1].id)},[]);let r=(0,j.useMemo)(()=>{let t=new Map;for(let n of e)t.set(n.id,jl(n.id,n.raw));return t},[e]);return(0,j.useEffect)(()=>{if(e.length===0)return;let i=e.filter(e=>e.id>n.current);if(i.length!==0){n.current=e[e.length-1].id;for(let e of i){let n=r.get(e.id);if(n)for(let e of n)t.emit(e)}}},[e,t,r]),{classificationMap:r}}var Nl={console:`40%`,"node-edit":`30%`,upload:`30%`};function Pl({config:e}){let{title:t,wsPath:n,storageKeyPayload:r,storageKeyHistory:i,storageKeyTab:a,storageKeySavedGraphs:o,supportsUpload:s,supportsClipboard:c,supportsHelp:l,helpContentProfile:u=`minigraph`,supportsAuthoring:d,supportsGraphRun:f,supportsSessionCollaboration:p,tabs:m}=e,h=ee(),[g,_]=pe(r,``),v=Se(),[y,b]=(0,j.useState)(()=>v.peekPendingPayload(n)),{takePendingPayload:x}=v;(0,j.useEffect)(()=>{let e=x(n);e!==null&&b(e)},[x,n]);let S=y??g,C=(0,j.useCallback)(e=>{b(null),_(e)},[_]),w=(0,j.useMemo)(()=>S?ue(S):{valid:!0,error:null,type:null},[S]),{toasts:te,addToast:T,removeToast:E}=fe(),ne=(0,j.useRef)(new ul).current,D=Ye({wsPath:n,storageKeyHistory:i,payload:S,addToast:T,bus:ne,handleLocalCommand:(0,j.useCallback)(e=>ll(e,l===!0,u)!==null,[l,u])}),{classificationMap:O}=Ml({messages:D.messages,bus:ne}),se=Us({enabled:p===!0,bus:ne,classificationMap:O,connected:D.connected,sendRawText:D.sendRawText,addToast:T}),k=se.state.sessionId===null?null:`/api/graph/session/${se.state.sessionId}`,{graphData:A,setGraphData:ce,rightTab:le,setRightTab:N,isRefreshing:me,refetchGraph:he}=et(k,T,m[0],m,a),{uploadPanelPath:ge,successfulUploadPaths:_e,handleOpenUploadPanel:ve,handleCloseUploadPanel:ye,handleCloseUploadPath:be,handleUploadSuccess:xe,handleUploadError:Ce,resetSuccessfulPaths:we}=ln({bus:ne,addToast:T}),Te=(0,j.useCallback)(()=>ce(null),[ce]);tt({bus:ne,hasGraph:A!==null,connected:D.connected,refetchGraph:he,clearGraph:Te,addToast:T});let Ee=Pr({bus:ne,connected:D.connected,sendRawText:D.sendRawText,addToast:T}),De=(0,j.useRef)(null),Oe=(0,j.useRef)(null),ke=(0,j.useRef)(new Map),Ae=(0,j.useCallback)((e,t)=>{if(t===null){T(e,`success`);return}T(e,`success`,{durationMs:6e3,action:{label:`Undo`,onClick:()=>Ee.undoEntry(t)}})},[T,Ee.undoEntry]),je=(0,j.useCallback)(e=>{if(e.action===`edit-node`){let t=De.current;De.current=null,t&&t.alias===e.alias&&Ae(`Updated node ${t.alias}`,Ee.push(kr(t)));return}if(e.action===`create-node`&&e.alias){Ae(`Created node ${e.alias}`,Ee.push(Ar(e.alias)));return}if(e.action===`create-connection`){let t=Oe.current;Oe.current=null,Ae(`Connected ${e.alias??``} → ${e.targetAlias??``}`,Ee.push(t));return}if(e.action===`delete-node`&&e.alias){let t=ke.current.get(e.alias)??null;ke.current.delete(e.alias),Ae(`Deleted node ${e.alias}`,Ee.push(t))}},[Ee.push,Ae]),Me=(0,j.useRef)(!1);(0,j.useEffect)(()=>{Me.current&&!D.connected&&ce(null),Me.current=D.connected},[D.connected,ce]);let[Ne,Pe]=pe(e.storageKeyHelpTopic??`help-topic-fallback`,``),[Fe,Ie]=pe(`help-panel-open`,!1),[Le,Re]=(0,j.useState)(()=>!!l&&!Fe),[ze,Be]=(0,j.useState)(!1),Ve=(0,j.useRef)(null),He=(0,j.useCallback)(()=>{Le&&(Be(!0),Ve.current=setTimeout(()=>Re(!1),400))},[Le]);(0,j.useEffect)(()=>{if(!Le||ze)return;let e=setTimeout(He,3e3);return()=>clearTimeout(e)},[Le,ze,He]),(0,j.useEffect)(()=>{Fe&&Le&&He()},[Fe,Le,He]),(0,j.useEffect)(()=>()=>{Ve.current&&clearTimeout(Ve.current)},[]),(0,j.useEffect)(()=>{if(!l)return;let e=e=>{e.ctrlKey&&e.key==="`"&&(e.preventDefault(),Ie(e=>!e))};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[l,Ie]),on({bus:ne,setHelpTopic:Pe,onTabSwitch:l?()=>Ie(!0):()=>{},enabled:l===!0,contentProfile:u}),un({bus:ne,connected:D.connected,appendMessage:D.appendMessage,addToast:T});let[Ue,We]=pe(`console-panel-open`,!0),Ge=Ic(),[Ke,qe]=pe(`clipboard-sidebar-open`,!1),[Je,Ze]=(0,j.useState)(null),Qe=(0,j.useCallback)(e=>{let t=Hn(e,A);D.setCommand(t.command),T(`${t.verb===`create`?`Create`:`Update`} command for "${e.node.alias}" pasted to input`,`info`)},[A,D.setCommand,T]),$e=(0,j.useCallback)(e=>{let t=Ge.items.find(t=>t.id===e);if(!t){T(`Clipboard item is no longer available. It may have been removed in another tab.`,`error`);return}let n=Hn(t,A);if(!D.sendRawText(n.command)){T(`Could not send clipboard paste command because the WebSocket is not open.`,`error`);return}T(`Clipboard node "${t.node.alias}" sent as ${n.verb}. Waiting for backend response.`,`info`)},[Ge.items,A,D.sendRawText,T]),nt=(0,j.useCallback)(async(t,r)=>{try{let i=await Ge.clipNode(t,r,{sourceWsPath:n,sourceLabel:e.label});switch(i.status){case`added`:T(`Node "${t.alias}" clipped to workspace`,`success`);break;case`duplicate`:Ze({pendingItem:i.pendingItem,existingItem:i.existingItem});break;case`error`:T(`Clip failed: ${i.message}`,`error`);break}}catch(e){T(`Clip failed: ${e instanceof Error?e.message:String(e)}`,`error`)}},[Ge,n,e.label,T]),rt=(0,j.useCallback)(async t=>{if(t.length===0){T(`No selected nodes are available to clip.`,`info`);return}if(t.length>100){T(`Select 100 or fewer nodes to clip at once.`,`error`);return}let r={added:0,duplicates:0,failed:0};for(let i of t){if(!i.node?.alias?.trim()){r.failed+=1;continue}try{let t=await Ge.clipNode(i.node,i.connections,{sourceWsPath:n,sourceLabel:e.label});t.status===`added`&&(r.added+=1),t.status===`duplicate`&&(r.duplicates+=1),t.status===`error`&&(r.failed+=1)}catch{r.failed+=1}}let i=Wn(r);T(i.message,i.type)},[T,Ge,e.label,n]),it=dn(o??``),{defaultName:at,savedName:ot,resetName:st}=_n(o?`${o}-untitled-counter`:`untitled-counter`,ne,D.connected,D.connectionEpoch),ct=(0,j.useMemo)(()=>{let e=A?.nodes.find(e=>e.types.includes(`Root`)),t=typeof e?.properties?.name==`string`?e.properties.name:void 0;return t?.trim()?t:null},[A])??at,lt=(0,j.useMemo)(()=>Gn(D.sendRawText),[D.sendRawText]),F=Rs({bus:ne,connected:D.connected,graphData:A,executor:lt,onAccepted:je,onUserMessage:T}),ut=F.state,dt=d&&ut.status===`open`&&(ut.action===`edit-node`||ut.action===`create-node`)?ut:null,ft=d&&ut.status===`open`&&ut.action===`create-connection`?ut:null,[pt,mt]=(0,j.useState)(null),ht=dt!==null||ft!==null;(0,j.useEffect)(()=>{let e=e=>{if(e.key!==`z`&&e.key!==`Z`||!(e.metaKey||e.ctrlKey)||e.shiftKey||e.altKey)return;let t=e.target;t instanceof Element&&t.closest(`input, textarea, select, [contenteditable="true"]`)||ht||Ee.hasEntries()&&(e.preventDefault(),Ee.undoLast())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[ht,Ee.hasEntries,Ee.undoLast]);let gt=(0,j.useCallback)((e,t,n)=>{mt(n??null),Oe.current=A?jr(A,e,t):null,F.openCreateConnection(e,t)},[F.openCreateConnection,A]),_t=(0,j.useCallback)(e=>{if(!A)return;let t=pr(A,e);t&&(Ee.runCommands(t.commands),Ae(`Deleted ${mr(t.removed)}`,Ee.push(Or(t.removed))))},[A,Ee.push,Ee.runCommands,Ae]),vt=(0,j.useCallback)(e=>{De.current=e,F.openEditNode(e)},[F.openEditNode]),yt=(0,j.useCallback)(e=>{ke.current.set(e.alias,A?Mr(A,e):null),F.deleteNode(e)},[F.deleteNode,A]),bt=D.consoleRef,xt=Ue&&dt===null&&ge===null;(0,j.useEffect)(()=>{xt&&bt.current&&(bt.current.scrollTop=bt.current.scrollHeight)},[xt,bt]);let I=Ln({enabled:f===!0,bus:ne,connected:D.connected,connectionEpoch:D.connectionEpoch,graphData:A,graphIdentity:k,isPrimary:f!==!0||se.state.sessionId!==null&&se.isPrimary,sendRawText:D.sendRawText,addToast:T,onWorkflowInputInvalidated:be}),{handleSaveGraph:St,handleLoadGraph:Ct}=zn({bus:ne,connected:D.connected,sendRawText:D.sendRawText,saveGraph:o?it.saveGraph:null,addToast:T}),wt=(0,j.useCallback)(e=>{O.get(e.id)?.find(e=>e.kind===`graph.link`)&&(he(),N(`graph`))},[O,he,N]),{handleSendToJsonPath:Tt}=sn({ctx:v,navigate:h,addToast:T,wsPath:n}),Et=Xe(`(max-width: 768px)`),{defaultLayout:Dt,onLayoutChanged:Ot}=ae({id:e.path+`-panel-split-v2`,storage:localStorage,onlySaveAfterUserInteractions:!0}),kt=dt===null?ge===null?Ue?`console`:null:`upload`:`node-edit`,At=(0,j.useRef)(null),jt=(0,j.useRef)(kt);(0,j.useEffect)(()=>{let e=jt.current;if(jt.current=kt,kt===null||kt===e)return;let t=requestAnimationFrame(()=>{At.current?.resize(Nl[kt])});return()=>cancelAnimationFrame(t)},[kt]);let Mt=!!c&&Ke,Nt=kt===null?Mt?`80%`:`100%`:Mt?`40%`:`60%`,Pt=(0,j.useCallback)(()=>C(de(S)),[S]),Ft=(0,j.useCallback)(()=>{D.clearMessages(),ce(null),we(),st()},[D.clearMessages,ce,we,st]),It=(0,j.useCallback)((e,t)=>{xe(e),I.handleInputUploadSuccess(t)},[I.handleInputUploadSuccess,xe]),Lt=(0,j.useCallback)(e=>{ye(),I.handleInputCancelled(e)},[I.handleInputCancelled,ye]),Rt=ge!==null&&I.isWorkflowInputPanel&&I.workflowUploadPath===ge;return(0,P.jsxs)(`div`,{className:M.wrapper,children:[(0,P.jsx)(Br,{toasts:te,onRemove:E}),ft!==null&&(0,P.jsx)(cs,{formState:ft.formState,phase:ft.phase,lockReason:ft.phase===`sending`?`sending`:ft.connectionLost?`disconnected`:null,serverMessage:ft.serverMessage,validationErrors:F.validationErrors,anchor:pt,onFormStateChange:F.updateFormState,onSubmit:F.submit,onClose:F.close}),(0,P.jsxs)(`header`,{className:M.header,children:[(0,P.jsx)(`h1`,{className:M.title,children:t}),(0,P.jsxs)(`div`,{className:M.headerActions,children:[o&&(0,P.jsx)(ei,{disabled:!A,defaultName:at,savedName:ot,onSave:St,nameExists:it.hasGraph,connected:D.connected}),o&&it.savedGraphs.length>0&&(0,P.jsx)(ni,{savedGraphs:it.savedGraphs,onLoad:Ct,onDelete:it.deleteGraph,connected:D.connected}),(0,P.jsx)(`button`,{className:M.panelToggle,onClick:()=>{if(dt!==null){dt.phase!==`sending`&&(F.close(),We(!0));return}if(ge!==null){Lt(ge),We(!0);return}We(e=>!e)},"aria-label":dt===null?ge===null?Ue?`Hide console panel`:`Show console panel`:`Show console panel and close the upload form`:`Show console panel and close the node editor`,"aria-pressed":xt,title:dt===null?ge===null?void 0:`Closes the upload form`:`Closes the node editor`,children:`Console`}),c&&(0,P.jsxs)(`button`,{className:M.panelToggle,onClick:()=>qe(e=>!e),"aria-label":Ke?`Close workspace sidebar`:`Open workspace sidebar`,"aria-pressed":Ke,children:[`Workspace`,Ge.items.length>0?` (${Ge.items.length})`:``]}),(0,P.jsx)(Zr,{addToast:T,sessionCollaboration:p?se:null}),l&&(0,P.jsxs)(`div`,{className:M.helpButtonWrapper,children:[(0,P.jsx)(`button`,{className:`${M.helpToggle}${Le&&!ze?` ${M.helpTogglePulsing}`:``}`,onClick:()=>Ie(e=>!e),"aria-label":Fe?`Close help panel`:`Open help panel`,"aria-pressed":Fe,children:`?`}),Le&&(0,P.jsxs)(`div`,{className:`${M.helpHint}${ze?` ${M.helpHintFading}`:``}`,onClick:He,role:`status`,children:[(0,P.jsx)(`kbd`,{className:M.helpHintKbd,children:"Ctrl + `"}),` to toggle help`]})]})]})]}),Je&&(0,P.jsx)(cl,{existingItem:Je.existingItem,pendingItem:Je.pendingItem,onReplace:async()=>{try{await Ge.confirmReplace(Je.pendingItem,Je.existingItem.id),Ze(null),T(`Clipboard item "${Je.pendingItem.node.alias}" replaced`,`success`)}catch(e){T(`Replace failed: ${e instanceof Error?e.message:String(e)}`,`error`)}},onCancel:()=>{Ze(null),T(`Clip cancelled`,`info`)}}),(0,P.jsxs)(oe,{className:M.panelGroup,orientation:Et?`vertical`:`horizontal`,defaultLayout:Dt,onLayoutChanged:Ot,children:[kt!==null&&(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(ie,{panelRef:At,defaultSize:Nl[kt],minSize:`25%`,children:dt===null?ge===null?(0,P.jsx)(Jo,{messages:D.messages,classificationMap:O,onCopy:D.copyMessages,onClear:Ft,consoleRef:D.consoleRef,command:D.command,onCommandChange:D.setCommand,onCommandKeyDown:D.handleKeyDown,onSend:D.sendCommand,sendDisabled:!D.connected||!D.command.trim(),inputDisabled:!D.connected,commandHistory:D.history,onGraphLinkMessage:wt,onCopyMessage:()=>T(`Copied to clipboard`,`success`),onSendToJsonPath:Tt,onUploadMockData:ve,successfulUploadPaths:_e}):(0,P.jsx)(as,{uploadPath:ge,onSuccess:It,onClose:Lt,onError:Ce,title:Rt?`▶ Mock Graph Input`:void 0,description:Rt?`Add the JSON body and keep this graph instantiated for a later run.`:void 0,inputPathHints:Rt?I.inputBodyPaths:void 0,submitLabel:Rt?`Upload & Instantiate`:void 0},ge):(0,P.jsx)(es,{mode:dt.action===`edit-node`?`edit`:`create`,formState:dt.formState,phase:dt.phase,lockReason:dt.phase===`sending`?`sending`:dt.connectionLost?`disconnected`:null,serverMessage:dt.serverMessage,validationErrors:F.validationErrors,onFormStateChange:F.updateFormState,onSubmit:F.submit,onClose:F.close})}),(0,P.jsx)(re,{className:M.resizeHandle,"aria-label":`Resize panels`})]}),(0,P.jsx)(ie,{defaultSize:Nt,minSize:`20%`,children:(0,P.jsx)(Fo,{tabs:m,payload:S,onChange:C,validation:w,onFormat:Pt,onUpload:s?D.uploadPayload:void 0,graphData:A,graphName:ct,activeTab:le,onTabChange:N,onGraphRenderError:e=>T(e,`error`),onGraphDataCopySuccess:()=>T(`Graph JSON copied to clipboard!`,`success`),onGraphDataCopyError:()=>T(`Copy failed`,`error`),graphRunControls:f?{phase:I.phase,canInstantiate:I.canInstantiate,canRun:I.canRun,disabledReason:I.disabledReason,onInstantiate:I.instantiateGraph,onRun:I.runGraph}:void 0,isGraphRefreshing:me,onClipNode:c?nt:void 0,onClipNodes:c?rt:void 0,onClipboardDrop:c?$e:void 0,isConnected:D.connected,supportsAuthoring:d,onCreateNode:d?F.openCreateNode:void 0,onCreateConnection:d?gt:void 0,onEditNode:d?vt:void 0,onDeleteNode:d?yt:void 0,onDeleteNodes:d?F.deleteNodes:void 0,onDeleteConnections:d?_t:void 0,panelLayoutKey:`${kt??`closed`}|${Ke}|${Fe}`,helpPanel:l&&Fe?((e,t)=>(0,P.jsx)(sl,{activeTopic:Ne,contentProfile:u,onNavigate:Pe,onClose:()=>Ie(!1),onToggleMaximize:e,isMaximized:t})):void 0})}),c&&Ke&&(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(re,{className:M.resizeHandle,"aria-label":`Resize clipboard`}),(0,P.jsx)(ie,{defaultSize:`20%`,minSize:`10%`,maxSize:`40%`,children:(0,P.jsx)(rl,{connected:D.connected,onPasteToInput:Qe})})]})]})]})}function Fl(){let e=he[0].path;return(0,P.jsx)(xe,{children:(0,P.jsx)(Fc,{children:(0,P.jsx)(T,{children:(0,P.jsxs)(S,{children:[he.map(e=>(0,P.jsx)(C,{path:e.path,element:(0,P.jsx)(Pl,{config:e},e.path)},e.path)),(0,P.jsx)(C,{path:`*`,element:(0,P.jsx)(te,{to:e,replace:!0})})]})})})})}(0,ce.createRoot)(document.getElementById(`root`)).render((0,P.jsx)(j.StrictMode,{children:(0,P.jsx)(Fl,{})}));
//# sourceMappingURL=index-CAGJOSB4.js.map