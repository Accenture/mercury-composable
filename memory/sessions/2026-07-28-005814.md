...
Also: MERGED same day as [PR #237](https://github.com/Accenture/mercury-composable/pull/237)
(squash `8a81950c`, CI green 6m57s) — the handoff's open question is answered on both
sides: Rust = strict LRU (shipped), Java = accept + document (shipped).
