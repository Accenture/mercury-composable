...
`);if(!(e.key===`ArrowUp`&&i||e.key===`ArrowDown`&&a))return}n(e),requestAnimationFrame(()=>{let e=s.current;e&&(e.selectionStart=e.selectionEnd=e.value.length)});return}n(e)},onBlur:()=>f.dismiss(),autoComplete:`off`,autoCorrect:`off`,spellCheck:!1})]}),(0,I.jsx)(`button`,{className:H.sendButton,onClick:()=>{r(),s.current?.focus()},disabled:i,"aria-label":`Send command`,children:`Send`})]}),m&&(0,I.jsx)(`p`,{className:H.hint,children:m})]})}var Ds={root:`_root_1ac49_1`};function Os({messages:e,classificationMap:t,onCopy:n,onClear:r,consoleRef:i,onGraphLinkMessage:a,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l,command:u,onCommandChange:d,onCommandKeyDown:f,onSend:p,sendDisabled:m,inputDisabled:h,commandHistory:g}){return(0,I.jsxs)(`div`,{className:Ds.root,children:[(0,I.jsx)(xs,{messages:e,classificationMap:t,onCopy:n,onClear:r,consoleRef:i,onGraphLinkMessage:a,onCopyMessage:o,onSendToJsonPath:s,onUploadMockData:c,successfulUploadPaths:l}),(0,I.jsx)(Es,{command:u,onChange:d,onKeyDown:f,onSend:p,disabled:h,sendDisabled:m,history:g})]})}var ks=/^[A-Za-z0-9_-]+$/,As=/^[A-Za-z0-9_-]+(?:\[(?:0|[1-9]\d*)?\])*$/,js=new Set([`input`,`output`,`model`,`response`,`result`,`parameter`,`none`,`next`,`api`,`error`]);function Ms(e,t){return`properties.${e}.${t}`}function Ns(e){return e.split(`.`).every(e=>As.test(e))}function Ps(e){return Ns(e)}function Fs(e,t={}){let n={},r=t.mode??`create`,i=e.alias.trim(),a=t.originalAlias?.trim()??``,o=e.nodeType.trim();r===`edit`?a?ks.test(a)||(n.alias=`Use only letters, numbers, underscore, and hyphen.`):n.alias=`Original alias is required.`:i?ks.test(i)?js.has(i.toLowerCase())?n.alias=`"${i}" is reserved.`:t.graphData?.nodes.some(e=>e.alias.toLowerCase()===i.toLowerCase())&&(n.alias=`Node "${i}" already exists in the current graph.`):n.alias=`Use only letters, numbers, underscore, and hyphen.`:n.alias=`Alias is required.`,o&&!ks.test(o)&&(n.nodeType=`Use only letters, numbers, underscore, and hyphen.`);for(let t of e.properties){let e=t.key.trim(),r=t.value.trim();!e&&!r||(!e&&r?n[Ms(t.id,`key`)]=`Property key is required when value is present.`:Ps(e)||(n[Ms(t.id,`key`)]=`Use a property name or dot/bracket path, for example mapping[] or config.value.`),r.includes(`'''`)&&(n[Ms(t.id,`value`)]=`Property value cannot contain '''.`))}return{valid:Object.keys(n).length===0,errors:n}}function Is(e,t={}){let n={},r=e.trim();return r?ks.test(r)?t.graphData&&!t.graphData.nodes.some(e=>e.alias.toLowerCase()===r.toLowerCase())&&(n.alias=`Node "${r}" is no longer available in the current graph.`):n.alias=`Use only letters, numbers, underscore, and hyphen.`:n.alias=`Alias is required.`,{valid:Object.keys(n).length===0,errors:n}}function Ls(e,t){return!!e?.nodes.some(e=>e.alias.toLowerCase()===t.toLowerCase())}function Rs(e,t={}){let n={},r=e.sourceAlias.trim(),i=e.targetAlias.trim(),a=e.relation.trim();return t.connected===!1&&(n.command=`Connection disconnected. Reconnect before creating a connection.`),r?ks.test(r)?t.graphData&&!Ls(t.graphData,r)&&(n.sourceAlias=`Node "${r}" is no longer available in the current graph.`):n.sourceAlias=`Use only letters, numbers, underscore, and hyphen.`:n.sourceAlias=`Source is required.`,i?ks.test(i)?t.graphData&&!Ls(t.graphData,i)&&(n.targetAlias=`Node "${i}" is no longer available in the current graph.`):n.targetAlias=`Use only letters, numbers, underscore, and hyphen.`:n.targetAlias=`Target is required.`,r&&i&&r.toLowerCase()===i.toLowerCase()&&(n.targetAlias=`Source and target nodes must be different.`),a?ks.test(a)||(n.relation=`Use only letters, numbers, underscore, and hyphen.`):n.relation=`Relation is required.`,{valid:Object.keys(n).length===0,errors:n}}function zs(e){return e.length<=63488?{valid:!0,errors:{}}:{valid:!1,errors:{command:`The node command is too large. Shorten property values before submitting.`}}}var Bs=0;function Vs(e=``,t=``){return Bs+=1,{id:`property-row-${Bs}`,key:e,value:t}}function Hs(e){return{alias:e===`empty-graph`?`root`:``,nodeType:e===`empty-graph`?`Root`:``,properties:[Vs()],source:e}}function Us(e){let t=e.indexOf(`[`);if(t===-1)return null;let n=e.indexOf(`]`,t+1);return n===-1||e.indexOf(`[`,n+1)!==-1?null:{open:t,close:n}}function Ws(e){let t=Us(e);if(!t)return e;let n=e.slice(t.open+1,t.close);return/^\d+$/.test(n)?e.slice(0,t.open+1)+n.padStart(3,`0`)+e.slice(t.close):e}function Gs(e){let t=Us(e);if(!t)return e;let n=e.slice(t.open+1,t.close);return/^\d+$/.test(n)?e.slice(0,t.open+1)+e.slice(t.close):e}function Ks(e){return e.slice().sort((e,t)=>{let n=Ws(e.key.trim()),r=Ws(t.key.trim());return!n&&!r?0:n?!r||n<r?-1:+(n>r):1})}var qs=`This node contains data that cannot be safely represented in the edit form. Use the console edit command for this node.`;function Js(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function Ys(e){return e===null?`null`:String(e)}function Xs(e,t,n){if(!Ns(e))return!1;if(Array.isArray(t))return t.length!==0&&t.every((t,r)=>Xs(`${e}[${r}]`,t,n));if(Js(t)){let r=Object.entries(t);return r.length!==0&&r.every(([t,r])=>Xs(`${e}.${t}`,r,n))}let r=Ys(t);return r.includes(`'''`)?!1:(n.push(Vs(e,r)),!0)}function Zs(e){if(!ks.test(e.alias)||e.types.length>1)return{valid:!1,formState:null,message:qs};let t=Object.entries(e.properties),n=[];for(let[e,r]of t)if(!Xs(e,r,n))return{valid:!1,formState:null,message:qs};let r=Ks(n).map(e=>({...e,key:Gs(e.key)}));return{valid:!0,formState:{alias:e.alias,nodeType:e.types[0]??``,properties:r.length>0?r:[Vs()],source:`edit-node`},message:null}}var Qs=e=>(0,I.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 16 16`,fill:`none`,width:16,height:16,stroke:`currentColor`,strokeWidth:1.8,strokeLinecap:`round`,strokeLinejoin:`round`,...e,children:[(0,I.jsx)(`line`,{x1:4.75,y1:4.75,x2:11.25,y2:11.25}),(0,I.jsx)(`line`,{x1:11.25,y1:4.75,x2:4.75,y2:11.25})]}),U={root:`_root_1qoh5_9`,card:`_card_1qoh5_19`,ribbon:`_ribbon_1qoh5_32`,ribbonIcon:`_ribbonIcon_1qoh5_45`,ribbonAlias:`_ribbonAlias_1qoh5_50`,ribbonAliasInput:`_ribbonAliasInput_1qoh5_57`,ribbonBadge:`_ribbonBadge_1qoh5_82`,ribbonClose:`_ribbonClose_1qoh5_93`,ribbonCloseIcon:`_ribbonCloseIcon_1qoh5_114`,body:`_body_1qoh5_121`,row:`_row_1qoh5_128`,rowDropTarget:`_rowDropTarget_1qoh5_138`,dragGrip:`_dragGrip_1qoh5_142`,rowLabel:`_rowLabel_1qoh5_166`,rowKey:`_rowKey_1qoh5_167`,rowValue:`_rowValue_1qoh5_178`,rowSpacer:`_rowSpacer_1qoh5_185`,keyInput:`_keyInput_1qoh5_189`,valueInput:`_valueInput_1qoh5_190`,removeButton:`_removeButton_1qoh5_228`,removeIcon:`_removeIcon_1qoh5_251`,addRow:`_addRow_1qoh5_257`,addButton:`_addButton_1qoh5_263`,message:`_message_1qoh5_282`,errorMessage:`_errorMessage_1qoh5_283`,warningMessage:`_warningMessage_1qoh5_284`,errorText:`_errorText_1qoh5_306`,footer:`_footer_1qoh5_312`,secondaryButton:`_secondaryButton_1qoh5_321`,primaryButton:`_primaryButton_1qoh5_322`},$s=1,ec=10,tc=36;function nc(e){let t=e.split(`
`).reduce((e,t)=>e+Math.max(1,Math.ceil(t.length/tc)),0);return Math.min(Math.max(t,$s),ec)}function rc({mode:e,formState:t,phase:n,lockReason:r,serverMessage:i,validationErrors:a,onFormStateChange:o,onSubmit:s,onClose:c}){let l=(0,M.useRef)(null),u=(0,M.useRef)(null),d=(0,M.useRef)(new Map),f=(0,M.useRef)(null),p=e===`create`,m=n===`sending`,h=r===`disconnected`,g=m||h,_=p?`Create Node`:`Save Changes`,v=p?`Creating...`:`Saving...`,y=p?`Connection disconnected. Refresh the page and create the node again after the app reconnects.`:`Connection disconnected. Refresh the page and edit the node again after the app reconnects.`,b=ua(t.nodeType),x=da(t.nodeType);(0,M.useEffect)(()=>{p?l.current?.focus():u.current?.focus();let e=e=>{e.key===`Escape`&&(e.preventDefault(),m||c())};return document.addEventListener(`keydown`,e),()=>{document.removeEventListener(`keydown`,e)}},[p,c,m]),(0,M.useEffect)(()=>{let e=f.current;if(!e)return;let t=d.current.get(e);t&&(t.focus(),f.current=null)},[t.properties]);let S=(0,M.useCallback)(e=>{e.preventDefault(),!g&&s()},[g,s]),C=(0,M.useCallback)(e=>{o({...t,...e})},[t,o]),w=(0,M.useCallback)((e,n)=>{o({...t,properties:t.properties.map(t=>t.id===e?{...t,...n}:t)})},[t,o]),ee=(0,M.useCallback)(()=>{let e=Vs();f.current=e.id,o({...t,properties:[...t.properties,e]})},[t,o]),te=(0,M.useCallback)(e=>{let n=t.properties.filter(t=>t.id!==e);o({...t,properties:n.length>0?n:[Vs()]})},[t,o]),T=(0,M.useRef)(null),[E,ne]=(0,M.useState)(null),re=(0,M.useCallback)(()=>{T.current=null,ne(null)},[]),D=(0,M.useCallback)(e=>t=>{if(T.current=e,t.dataTransfer){t.dataTransfer.effectAllowed=`move`,t.dataTransfer.setData(`text/plain`,e);let n=t.currentTarget.closest(`[data-row-id]`);n instanceof HTMLElement&&typeof t.dataTransfer.setDragImage==`function`&&t.dataTransfer.setDragImage(n,16,16)}},[]),ie=(0,M.useCallback)(e=>t=>{T.current!==null&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),ne(t=>t===e?t:e))},[]),ae=(0,M.useCallback)(e=>{let n=T.current;if(re(),n===null||n===e)return;let r=t.properties.find(e=>e.id===n);if(!r)return;let i=t.properties.filter(e=>e.id!==n),a=i.length;if(e!==null){let t=i.findIndex(t=>t.id===e);t!==-1&&(a=t)}let s=[...i.slice(0,a),r,...i.slice(a)];o({...t,properties:Ks(s)})},[re,t,o]),oe=(0,M.useCallback)(e=>t=>{T.current!==null&&(t.preventDefault(),ae(e))},[ae]);return(0,I.jsx)(`div`,{className:U.root,children:(0,I.jsxs)(`form`,{className:U.card,style:{borderColor:x,"--node-accent":x},"aria-label":p?`Create node`:`Edit node ${t.alias}`,onSubmit:S,children:[(0,I.jsxs)(`header`,{className:U.ribbon,children:[(0,I.jsx)(`span`,{className:U.ribbonIcon,"aria-hidden":`true`,children:b.icon}),p?(0,I.jsx)(`input`,{ref:l,className:U.ribbonAliasInput,value:t.alias,placeholder:`node-alias`,"aria-label":`Node alias`,disabled:g,"aria-invalid":!!a.alias,onChange:e=>C({alias:e.target.value})}):(0,I.jsx)(`span`,{className:U.ribbonAlias,children:t.alias}),(0,I.jsx)(`span`,{className:U.ribbonBadge,children:b.label}),(0,I.jsx)(`button`,{type:`button`,className:U.ribbonClose,"aria-label":`Close node editor`,title:`Close (Esc)`,onClick:c,disabled:m,children:(0,I.jsx)(Qs,{className:U.ribbonCloseIcon,"aria-hidden":`true`,focusable:`false`})})]}),(0,I.jsxs)(`div`,{className:U.body,children:[i&&!h&&(0,I.jsx)(`div`,{className:U.message,role:`status`,children:i}),a.command&&(0,I.jsx)(`div`,{className:U.errorMessage,role:`alert`,children:a.command}),a.alias&&(0,I.jsx)(`div`,{className:U.errorMessage,role:`alert`,children:a.alias}),h&&(0,I.jsx)(`div`,{className:U.warningMessage,role:`status`,children:i??y}),(0,I.jsxs)(`div`,{className:U.row,children:[(0,I.jsx)(`span`,{"aria-hidden":`true`}),(0,I.jsx)(`label`,{className:U.rowLabel,htmlFor:`node-edit-type`,children:`type`}),(0,I.jsxs)(`div`,{className:U.rowValue,children:[(0,I.jsx)(`input`,{id:`node-edit-type`,ref:u,className:U.valueInput,value:t.nodeType,disabled:g,"aria-invalid":!!a.nodeType,onChange:e=>C({nodeType:e.target.value})}),a.nodeType&&(0,I.jsx)(`span`,{className:U.errorText,children:a.nodeType})]}),(0,I.jsx)(`span`,{className:U.rowSpacer,"aria-hidden":`true`})]}),t.properties.map(e=>{let t=a[Ms(e.id,`key`)],n=a[Ms(e.id,`value`)];return(0,I.jsxs)(`div`,{"data-row-id":e.id,className:E===e.id?`${U.row} ${U.rowDropTarget}`:U.row,onDragOver:ie(e.id),onDrop:oe(e.id),children:[(0,I.jsx)(`span`,{className:U.dragGrip,role:`button`,"aria-label":`Reorder property ${e.key.trim()||`(empty)`}`,title:`Drag to reorder — same keys append as [0], [1], … in row order`,draggable:!g,onDragStart:D(e.id),onDragEnd:re,children:`⠿`}),(0,I.jsxs)(`div`,{className:U.rowKey,children:[(0,I.jsx)(`input`,{ref:t=>{t?d.current.set(e.id,t):d.current.delete(e.id)},className:U.keyInput,value:e.key,placeholder:`key`,"aria-label":`Property key`,disabled:g,"aria-invalid":!!t,onChange:t=>w(e.id,{key:t.target.value})}),t&&(0,I.jsx)(`span`,{className:U.errorText,children:t})]}),(0,I.jsxs)(`div`,{className:U.rowValue,children:[(0,I.jsx)(`textarea`,{className:U.valueInput,value:e.value,placeholder:`value`,"aria-label":`Property value`,disabled:g,rows:nc(e.value),"aria-invalid":!!n,onChange:t=>w(e.id,{value:t.target.value})}),n&&(0,I.jsx)(`span`,{className:U.errorText,children:n})]}),(0,I.jsx)(`button`,{type:`button`,className:U.removeButton,"aria-label":`Remove property`,disabled:g,onClick:()=>te(e.id),children:(0,I.jsx)(Qs,{className:U.removeIcon,"aria-hidden":`true`,focusable:`false`})})]},e.id)}),(0,I.jsx)(`div`,{className:E===`end`?`${U.addRow} ${U.rowDropTarget}`:U.addRow,onDragOver:ie(`end`),onDrop:oe(null),children:(0,I.jsxs)(`button`,{type:`button`,className:U.addButton,disabled:g,onClick:ee,children:[(0,I.jsx)(`span`,{"aria-hidden":`true`,children:`+`}),(0,I.jsx)(`span`,{children:`Add Property`})]})})]}),(0,I.jsxs)(`footer`,{className:U.footer,children:[(0,I.jsx)(`button`,{type:`button`,className:U.secondaryButton,onClick:c,disabled:m,children:`Cancel`}),(0,I.jsx)(`button`,{type:`submit`,className:U.primaryButton,disabled:g,children:m?v:_})]})]})})}var W={dialog:`_dialog_g80bk_4`,modalInner:`_modalInner_g80bk_26`,modalHeader:`_modalHeader_g80bk_34`,modalTitleGroup:`_modalTitleGroup_g80bk_44`,modalTitle:`_modalTitle_g80bk_44`,modalPath:`_modalPath_g80bk_57`,closeButton:`_closeButton_g80bk_64`,modalBody:`_modalBody_g80bk_95`,dropZone:`_dropZone_g80bk_105`,dropZoneActive:`_dropZoneActive_g80bk_127`,dropZoneIcon:`_dropZoneIcon_g80bk_133`,dropZoneText:`_dropZoneText_g80bk_139`,dropZoneOr:`_dropZoneOr_g80bk_152`,browseButton:`_browseButton_g80bk_159`,fileInputHidden:`_fileInputHidden_g80bk_188`,fileError:`_fileError_g80bk_193`,textareaLabel:`_textareaLabel_g80bk_198`,textarea:`_textarea_g80bk_198`,validationError:`_validationError_g80bk_226`,keyboardHint:`_keyboardHint_g80bk_231`,errorBanner:`_errorBanner_g80bk_236`,modalFooter:`_modalFooter_g80bk_247`,footerActions:`_footerActions_g80bk_257`,formatButton:`_formatButton_g80bk_263`,cancelButton:`_cancelButton_g80bk_264`,uploadButton:`_uploadButton_g80bk_265`,spinner:`_spinner_g80bk_332`,spin:`_spin_g80bk_332`};function ic({uploadPath:e,json:t,onSuccess:n,onError:r}){let[i,a]=(0,M.useState)(!1),o=(0,M.useRef)(null),s=(0,M.useCallback)(()=>{o.current?.abort(),o.current=null,a(!1)},[]);return{isUploading:i,upload:(0,M.useCallback)(async()=>{o.current?.abort();let i=new AbortController;o.current=i,a(!0);try{let o=await fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:t,signal:i.signal}),s=await o.text();if(!o.ok){a(!1),r(`HTTP ${o.status} — ${s}`);return}a(!1),n(s)}catch(e){if(e.name===`AbortError`){a(!1);return}a(!1),r(e.message??`Network error`)}},[e,t,n,r]),cancel:s}}var ac=(navigator.userAgentData?.platform??navigator.platform).toLowerCase().includes(`mac`);function oc(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=()=>n(Error(`Could not read file "${e.name}"`)),r.readAsText(e,`utf-8`)})}function sc(e){let t=e.name.toLowerCase().endsWith(`.json`),n=e.type===`application/json`||e.type===`text/plain`;return!t&&!n?`"${e.name}" does not appear to be a JSON file. Only .json files are accepted.`:null}function cc({uploadPath:e,onSuccess:t,onClose:n,onError:r}){let[i,a]=(0,M.useState)(``),[o,s]=(0,M.useState)(null),[c,l]=(0,M.useState)(null),[u,d]=(0,M.useState)(!1),f=(0,M.useRef)(null),p=(0,M.useRef)(null),m=(0,M.useRef)(null),h=Er(i).isJSON,g=h&&i.trim()!==``,{isUploading:_,upload:v,cancel:y}=ic({uploadPath:e,json:i,onSuccess:t,onError:e=>{s(e),r(e)}});(0,M.useEffect)(()=>{let e=f.current;if(e)return e.open||e.showModal(),p.current?.focus(),()=>{e.open&&e.close()}},[]);let b=(0,M.useCallback)(()=>{y(),n()},[y,n]),x=(0,M.useCallback)(e=>{e.target===f.current&&b()},[b]),S=(0,M.useCallback)(e=>{e.preventDefault(),b()},[b]),C=(0,M.useCallback)(()=>{s(null),v()},[v]),w=(0,M.useCallback)(e=>{e.key===`Enter`&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),g&&!_&&C())},[g,_,C]),ee=(0,M.useCallback)(()=>{h&&a(fr(i))},[h,i]),te=(0,M.useCallback)(async e=>{l(null),s(null);let t=sc(e);if(t){l(t);return}try{let t=await oc(e);if(!Er(t).isJSON){l(`"${e.name}" contains invalid JSON.`);return}a(fr(t)),p.current?.focus()}catch(e){l(e.message)}},[]),T=(0,M.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),u||d(!0)},[u]),E=(0,M.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),(e.currentTarget===e.target||!e.currentTarget.contains(e.relatedTarget))&&d(!1)},[]),ne=(0,M.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),d(!1);let t=e.dataTransfer.files[0];t&&te(t)},[te]),re=(0,M.useCallback)(e=>{let t=e.target.files?.[0];t&&(te(t),e.target.value=``)},[te]),D=!h&&i.trim()!==``;return(0,I.jsx)(`dialog`,{ref:f,className:W.dialog,"aria-modal":`true`,"aria-labelledby":`mock-upload-modal-title`,onClick:x,onCancel:S,children:(0,I.jsxs)(`div`,{className:W.modalInner,onClick:e=>e.stopPropagation(),children:[(0,I.jsxs)(`div`,{className:W.modalHeader,children:[(0,I.jsxs)(`div`,{className:W.modalTitleGroup,children:[(0,I.jsx)(`span`,{id:`mock-upload-modal-title`,className:W.modalTitle,children:`⬆️ Upload Mock Data`}),(0,I.jsx)(`span`,{className:W.modalPath,children:e})]}),(0,I.jsx)(`button`,{className:W.closeButton,onClick:b,"aria-label":`Close upload modal`,title:`Close`,disabled:_,children:`✕`})]}),(0,I.jsxs)(`div`,{className:W.modalBody,children:[(0,I.jsxs)(`div`,{className:`${W.dropZone} ${u?W.dropZoneActive:``}`,onDragOver:T,onDragLeave:E,onDrop:ne,"aria-label":`Drop a JSON file here`,children:[(0,I.jsx)(`span`,{className:W.dropZoneIcon,children:`📂`}),(0,I.jsxs)(`span`,{className:W.dropZoneText,children:[`Drop a `,(0,I.jsx)(`code`,{children:`.json`}),` file here`]}),(0,I.jsx)(`span`,{className:W.dropZoneOr,children:`— or —`}),(0,I.jsx)(`input`,{ref:m,type:`file`,accept:`.json,application/json`,className:W.fileInputHidden,"aria-hidden":`true`,tabIndex:-1,onChange:re}),(0,I.jsx)(`button`,{type:`button`,className:W.browseButton,onClick:()=>m.current?.click(),disabled:_,"aria-label":`Browse for a JSON file`,children:`Browse file…`})]}),c&&(0,I.jsxs)(`span`,{className:W.fileError,role:`alert`,children:[`⚠️ `,c]}),(0,I.jsx)(`label`,{htmlFor:`mock-upload-textarea`,className:W.textareaLabel,children:`JSON Payload`}),(0,I.jsx)(`textarea`,{id:`mock-upload-textarea`,ref:p,className:W.textarea,value:i,onChange:e=>{a(e.target.value),l(null)},onKeyDown:w,placeholder:`Paste JSON here, or drop / browse a .json file above`,rows:10,spellCheck:!1,"aria-describedby":D?`mock-upload-validation`:void 0}),D&&(0,I.jsx)(`span`,{id:`mock-upload-validation`,className:W.validationError,role:`status`,children:`⚠️ Invalid JSON — check syntax`}),(0,I.jsx)(`span`,{className:W.keyboardHint,children:ac?`⌘+Enter to upload`:`Ctrl+Enter to upload`}),o&&(0,I.jsxs)(`div`,{className:W.errorBanner,role:`alert`,children:[`❌ Upload failed: `,o]})]}),(0,I.jsxs)(`div`,{className:W.modalFooter,children:[(0,I.jsx)(`button`,{className:W.formatButton,onClick:ee,disabled:!h||_,title:`Format JSON`,"aria-label":`Format JSON`,children:`Format`}),(0,I.jsxs)(`div`,{className:W.footerActions,children:[(0,I.jsx)(`button`,{className:W.cancelButton,onClick:b,disabled:_,children:`Cancel`}),(0,I.jsx)(`button`,{className:W.uploadButton,onClick:C,disabled:!g||_,"aria-busy":_,children:_?(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`span`,{className:W.spinner,"aria-hidden":`true`}),` Uploading…`]}):`Upload ▶`})]})]})]})})}var G={overlay:`_overlay_1vr0s_1`,panel:`_panel_1vr0s_21`,form:`_form_1vr0s_34`,header:`_header_1vr0s_41`,title:`_title_1vr0s_50`,iconButton:`_iconButton_1vr0s_57`,buttonIcon:`_buttonIcon_1vr0s_91`,body:`_body_1vr0s_119`,field:`_field_1vr0s_129`,label:`_label_1vr0s_136`,input:`_input_1vr0s_143`,message:`_message_1vr0s_172`,warningMessage:`_warningMessage_1vr0s_173`,errorMessage:`_errorMessage_1vr0s_174`,errorText:`_errorText_1vr0s_199`,footer:`_footer_1vr0s_204`,primaryButton:`_primaryButton_1vr0s_214`,secondaryButton:`_secondaryButton_1vr0s_215`};function lc({open:e,formState:t,phase:n,lockReason:r,serverMessage:i,validationErrors:a,onFormStateChange:o,onSubmit:s,onClose:c}){let l=(0,M.useRef)(null),u=n===`sending`,d=r===`disconnected`,f=u||d;(0,M.useEffect)(()=>{if(!e)return;l.current?.focus();let t=e=>{e.key===`Escape`&&(e.preventDefault(),u||c())};return document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`keydown`,t)}},[c,e,u]);let p=(0,M.useCallback)(e=>{e.preventDefault(),e.stopPropagation()},[]),m=(0,M.useCallback)(e=>{e.preventDefault(),e.stopPropagation(),u||c()},[c,u]),h=(0,M.useCallback)(e=>{e.stopPropagation()},[]),g=(0,M.useCallback)(e=>{e.preventDefault(),!f&&s()},[f,s]),_=(0,M.useCallback)(e=>{o({...t,relation:e})},[t,o]);return e?(0,I.jsx)(`div`,{className:G.overlay,onPointerDown:p,onClick:m,children:(0,I.jsxs)(`div`,{className:G.panel,role:`dialog`,"aria-modal":`true`,"aria-labelledby":`connection-dialog-title`,onPointerDown:h,onClick:e=>e.stopPropagation(),children:[(0,I.jsxs)(`header`,{className:G.header,children:[(0,I.jsx)(`div`,{children:(0,I.jsx)(`h2`,{id:`connection-dialog-title`,className:G.title,children:`Create Connection`})}),(0,I.jsx)(`button`,{type:`button`,className:G.iconButton,"aria-label":`Close create connection dialog`,onClick:c,disabled:u,children:(0,I.jsx)(Qs,{className:G.buttonIcon,"aria-hidden":`true`,focusable:`false`})})]}),(0,I.jsxs)(`form`,{className:G.form,onSubmit:g,children:[(0,I.jsxs)(`div`,{className:G.body,children:[i&&!d&&(0,I.jsx)(`div`,{className:G.message,role:`status`,children:i}),a.command&&(0,I.jsx)(`div`,{className:G.errorMessage,role:`alert`,children:a.command}),d&&(0,I.jsx)(`div`,{className:G.warningMessage,role:`status`,children:i??`Connection disconnected. Refresh the page and create the connection again after the app reconnects.`}),(0,I.jsxs)(`label`,{className:G.field,children:[(0,I.jsx)(`span`,{className:G.label,children:`Source`}),(0,I.jsx)(`input`,{className:G.input,value:t.sourceAlias,readOnly:!0,disabled:f,"aria-invalid":!!a.sourceAlias,"aria-describedby":a.sourceAlias?`connection-source-error`:void 0}),a.sourceAlias&&(0,I.jsx)(`span`,{id:`connection-source-error`,className:G.errorText,children:a.sourceAlias})]}),(0,I.jsxs)(`label`,{className:G.field,children:[(0,I.jsx)(`span`,{className:G.label,children:`Target`}),(0,I.jsx)(`input`,{className:G.input,value:t.targetAlias,readOnly:!0,disabled:f,"aria-invalid":!!a.targetAlias,"aria-describedby":a.targetAlias?`connection-target-error`:void 0}),a.targetAlias&&(0,I.jsx)(`span`,{id:`connection-target-error`,className:G.errorText,children:a.targetAlias})]}),(0,I.jsxs)(`label`,{className:G.field,children:[(0,I.jsx)(`span`,{className:G.label,children:`Relation`}),(0,I.jsx)(`input`,{ref:l,className:G.input,type:`text`,value:t.relation,placeholder:`e.g. fetch`,disabled:f,autoComplete:`off`,autoCorrect:`off`,spellCheck:!1,"aria-invalid":!!a.relation,"aria-describedby":a.relation?`connection-relation-error`:void 0,onChange:e=>_(e.target.value)}),a.relation&&(0,I.jsx)(`span`,{id:`connection-relation-error`,className:G.errorText,children:a.relation})]})]}),(0,I.jsxs)(`footer`,{className:G.footer,children:[(0,I.jsx)(`button`,{type:`button`,className:G.secondaryButton,onClick:c,disabled:u,children:`Cancel`}),(0,I.jsx)(`button`,{type:`submit`,className:G.primaryButton,disabled:f,children:u?`Creating...`:`Create Connection`})]})]})]})}):null}function uc({state:e,validationErrors:t,onFormStateChange:n,onSubmit:r,onClose:i}){if(e.status===`closed`||e.action!==`create-connection`)return null;let a=e.phase===`sending`?`sending`:e.connectionLost?`disconnected`:null;return(0,I.jsx)(lc,{open:!0,formState:e.formState,phase:e.phase,lockReason:a,serverMessage:e.serverMessage,validationErrors:t,onFormStateChange:e=>n(e),onSubmit:r,onClose:i})}function dc(e,t=!1){return e.properties.map(e=>({key:e.key.trim(),value:t?e.value.replace(/\r\n/g,`
`).replace(/\r/g,`
`):e.value.trim()})).filter(e=>e.key||e.value.trim())}function fc(e){let t=zs(e);if(!t.valid)throw Error(t.errors.command)}function pc(e,t,n){if(n.includes(`
`)){e.push(`${t}='''`),e.push(n),e.push(`'''`);return}e.push(`${t}=${n}`)}function mc(e){let t=Fs(e);if(!t.valid)throw Error(Object.values(t.errors)[0]??`Invalid node form state.`);let n=e.alias.trim(),r=e.nodeType.trim(),i=dc(e,!0),a=[`create node ${n}`];if(r&&a.push(`with type ${r}`),i.length>0){a.push(`with properties`);for(let e of i)pc(a,e.key,e.value)}let o=a.join(`
`);return fc(o),o}function hc(e,t){let n=t.trim(),r=Fs(e,{mode:`edit`,originalAlias:n});if(!r.valid)throw Error(Object.values(r.errors)[0]??`Invalid node form state.`);let i=e.nodeType.trim(),a=dc(e,!0),o=[`update node ${n}`];if(i&&o.push(`with type ${i}`),a.length>0){o.push(`with properties`);for(let e of a)pc(o,e.key,e.value)}let s=o.join(`
`);return fc(s),s}function gc(e,t={}){let n=e.trim(),r=Is(n,t);if(!r.valid)throw Error(Object.values(r.errors)[0]??`Invalid node alias.`);let i=`delete node ${n}`;return fc(i),i}function _c(e){let t=Rs(e);if(!t.valid)throw Error(Object.values(t.errors)[0]??`Invalid connection form state.`);let n=`connect ${e.sourceAlias.trim()} to ${e.targetAlias.trim()} with ${e.relation.trim()}`;return fc(n),n}var vc=1e4,yc=`A graph authoring action is already pending. Wait for it to finish before starting another.`,bc=`Could not send the create-node command because the WebSocket is not open. The form values remain in this dialog.`,xc=`Could not send the edit-node command because the WebSocket is not open. Your changes remain in this dialog.`,Sc=`Could not send the delete-node command because the WebSocket is not open.`,Cc=`Could not send the create-connection command because the WebSocket is not open. The form values remain in this dialog.`,wc=`Could not send delete-node commands because the WebSocket is not open.`,Tc=`No selected nodes are available to delete.`,Ec=`Select 100 or fewer nodes to delete at once.`,Dc=`Some delete-node commands were sent, but not all backend results were observed yet. Refresh the graph before trying again.`,Oc=`This node is no longer available in the current graph.`,kc=`Connection disconnected. Refresh the page and create the node again after the app reconnects.`,Ac=`Connection disconnected. Refresh the page and edit the node again after the app reconnects.`,jc=`Connection disconnected. Refresh the page and create the connection again after the app reconnects.`,Mc=`Connection disconnected while the graph authoring action was pending. The outcome is unknown. Refresh the page and check the graph before trying again.`,Nc={status:`closed`,pendingSubmit:null,serverMessage:null};function Pc(e){return e.pendingSubmit}function Fc(e){return e.action===`delete-nodes`}function Ic(e){return e===`create-connection`?Cc:e===`edit-node`?xc:e===`delete-node`?Sc:bc}function Lc(e){return Fc(e)?Dc:`The ${e.action} command was sent, but no backend result was observed yet. The outcome is unknown.`}function Rc(e){return e===`create-connection`?jc:e===`edit-node`?Ac:kc}function zc(e,t){return!e||!t?!1:e.trim().toLowerCase()===t.trim().toLowerCase()}function Bc(e,t){return e?.nodes.find(e=>e.alias.toLowerCase()===t.toLowerCase())??null}function Vc(e,t){return e.status===`error`?!0:t.action===`create-connection`?e.action===`create-connection`?e.alias===null?!0:zc(e.alias,t.alias)?e.status===`accepted`?zc(e.targetAlias,t.targetAlias):e.targetAlias===null||zc(e.targetAlias,t.targetAlias):!1:e.action===null?zc(e.alias,t.alias)||zc(e.alias,t.targetAlias):!1:zc(e.alias,t.alias)?e.action===null||e.action===t.action:!1}function Hc(e,t){let n=Pc(e);return!n||Fc(n)||!Vc(t,n)?null:t.status===`accepted`?{state:Nc,acceptedResult:{status:t.status,action:t.action,alias:t.alias,targetAlias:t.targetAlias,message:t.message}}:e.status===`open`?{state:{...e,phase:`editing`,pendingSubmit:null,serverMessage:t.status===`error`?`Backend returned an error while this submit was pending: ${t.message}`:t.message}}:{state:Nc,notification:{message:t.message,type:`error`}}}function Uc(e){return{...e,phase:`editing`,pendingSubmit:null,serverMessage:Ic(e.action)}}function Wc(e){let t=Pc(e);if(!t)return null;let n=Lc(t);return e.status===`open`?{state:{...e,phase:`editing`,pendingSubmit:null,serverMessage:n}}:{state:Nc,notification:{message:n,type:`error`}}}function Gc(e){let t=Pc(e);if(e.status===`open`){let n=t?Mc:Rc(e.action);return{state:{...e,phase:`editing`,pendingSubmit:null,serverMessage:n,connectionLost:!0}}}return t?{state:Nc,notification:{message:Mc,type:`error`}}:null}function Kc(e){return`sourceAlias`in e}function qc({bus:e,connected:t,graphData:n,executor:r,timeoutMs:i=vc,onAccepted:a,onUserMessage:o}){let[s,c]=(0,M.useState)(Nc),[l,u]=(0,M.useState)({}),d=(0,M.useRef)(s),f=(0,M.useRef)(null),p=(0,M.useRef)(t),m=(0,M.useRef)(n),h=(0,M.useRef)(a),g=(0,M.useRef)(o);(0,M.useEffect)(()=>{d.current=s},[s]),(0,M.useEffect)(()=>{m.current=n},[n]),(0,M.useEffect)(()=>{h.current=a},[a]),(0,M.useEffect)(()=>{g.current=o},[o]);let _=(0,M.useCallback)((e,t=`error`)=>{g.current?.(e,t)},[]),v=(0,M.useCallback)(e=>{d.current=e,c(e)},[]),y=(0,M.useCallback)(()=>{f.current!==null&&(clearTimeout(f.current),f.current=null)},[]),b=(0,M.useCallback)(()=>{y(),f.current=setTimeout(()=>{let e=Wc(d.current);e&&(v(e.state),e.notification&&_(e.notification.message,e.notification.type)),f.current=null},i)},[y,_,v,i]),x=(0,M.useCallback)(e=>{if(!t)return;if(Pc(d.current)){_(yc,`error`);return}let n=Hs(e);u({}),v({status:`open`,action:`create-node`,phase:`editing`,formState:n,originalAlias:null,pendingSubmit:null,serverMessage:null,connectionLost:!1})},[t,_,v]),S=(0,M.useCallback)((e,n)=>{if(!t)return;if(Pc(d.current)){_(yc,`error`);return}let r={sourceAlias:e,targetAlias:n,relation:``},{relation:i,...a}=Rs(r,{graphData:m.current,connected:t}).errors;Object.keys(a).length>0||(u({}),v({status:`open`,action:`create-connection`,phase:`editing`,formState:r,pendingSubmit:null,serverMessage:null,connectionLost:!1}))},[t,_,v]),C=(0,M.useCallback)(e=>{if(!t){_(Ac,`error`);return}if(Pc(d.current)){_(yc,`error`);return}let n=Bc(m.current,e.alias);if(!n){_(Oc,`error`);return}let r=Zs(n);if(!r.valid||!r.formState){_(r.message??`This node cannot be edited in the UI.`,`error`);return}u({}),v({status:`open`,action:`edit-node`,phase:`editing`,formState:r.formState,originalAlias:n.alias,pendingSubmit:null,serverMessage:null,connectionLost:!1})},[t,_,v]),w=(0,M.useCallback)(e=>{if(!t){_(Sc,`error`);return}if(Pc(d.current)){_(yc,`error`);return}let n=Is(e.alias,{graphData:m.current});if(!n.valid){_(Object.values(n.errors)[0]??`Invalid node alias.`,`error`);return}let i;try{i=gc(e.alias,{graphData:m.current})}catch(e){_(e instanceof Error?e.message:String(e),`error`);return}if(!r.execute(i)){_(Sc,`error`);return}let a={action:`delete-node`,alias:e.alias.trim(),command:i,sentAt:new Date().toISOString()};u({}),v({status:`closed`,pendingSubmit:a,serverMessage:null}),b()},[t,r,_,v,b]),ee=(0,M.useCallback)(e=>{if(!t){_(wc,`error`);return}if(Pc(d.current)){_(yc,`error`);return}if(e.length===0){_(Tc,`info`);return}if(e.length>100){_(Ec,`error`);return}let n=new Set,i=e.filter(e=>{let t=e.alias.trim().toLowerCase();return n.has(t)?!1:(n.add(t),!0)}),a=[],o=[];for(let e of i){let t=Is(e.alias,{graphData:m.current});if(!t.valid){_(Object.values(t.errors)[0]??Tc,`error`);return}try{o.push(e.alias.trim()),a.push(gc(e.alias,{graphData:m.current}))}catch(e){_(e instanceof Error?e.message:String(e),`error`);return}}for(let[e,t]of a.entries())if(!r.execute(t)){_(e===0?wc:Mc,`error`);return}let s={action:`delete-nodes`,aliases:o,commands:a,sentAt:new Date().toISOString(),results:{}};u({}),v({status:`closed`,pendingSubmit:s,serverMessage:null}),_(`${o.length} delete-node commands sent. Waiting for backend response.`,`info`),b()},[t,r,_,v,b]),te=(0,M.useCallback)(e=>{let t=d.current;if(t.status===`open`&&!(t.phase===`sending`||t.connectionLost)){if(u({}),t.action===`create-connection`){if(!Kc(e))return;v({...t,formState:e,pendingSubmit:null,serverMessage:null,connectionLost:!1});return}Kc(e)||v({...t,formState:e,pendingSubmit:null,serverMessage:null,connectionLost:!1})}},[v]),T=(0,M.useCallback)(()=>{let e=d.current;if(e.status!==`open`||e.phase===`sending`||e.connectionLost)return;let n=e.action;if(!t){v({...e,serverMessage:Ic(n)});return}let i=e.action===`create-connection`?Rs(e.formState,{graphData:m.current,connected:t}):Fs(e.formState,e.action===`edit-node`?{mode:`edit`,originalAlias:e.originalAlias}:{graphData:m.current});if(!i.valid){u(i.errors);return}let a,o,s=null;try{if(e.action===`edit-node`)o=e.originalAlias?.trim()??``,a=hc(e.formState,o);else if(e.action===`create-node`)o=e.formState.alias.trim(),a=mc(e.formState);else if(Kc(e.formState))o=e.formState.sourceAlias.trim(),s=e.formState.targetAlias.trim(),a=_c(e.formState);else{u({command:`Invalid connection form state.`});return}}catch(e){u({command:e instanceof Error?e.message:String(e)});return}if(!r.execute(a)){v(Uc(e));return}let c={action:n,alias:o,targetAlias:s,command:a,sentAt:new Date().toISOString()};u({}),v({...e,phase:`sending`,pendingSubmit:c,serverMessage:null,connectionLost:!1}),b()},[t,r,v,b]),E=(0,M.useCallback)(()=>{let e=d.current;e.status===`open`&&e.phase!==`sending`&&(y(),u({}),v(Nc))},[y,v]);return(0,M.useEffect)(()=>e.on(`minigraph.nodeAction.textResult`,e=>{let t=d.current,n=Pc(t);if(!n)return;if(Fc(n)){let r=L(n,e);if(!r)return;if(e.status===`accepted`&&h.current?.({status:e.status,action:e.action,alias:e.alias,targetAlias:e.targetAlias,message:e.message}),!Li(r)){v({...t,pendingSubmit:r});return}y(),v(Nc);let i=Ri(r);_(i.message,i.type);return}let r=Hc(t,e);r&&(y(),r.acceptedResult&&u({}),v(r.state),r.acceptedResult&&h.current?.(r.acceptedResult),r.notification&&_(r.notification.message,r.notification.type))}),[e,y,_,v]),(0,M.useEffect)(()=>{if(p.current&&!t){let e=Gc(d.current);e&&(y(),v(e.state),e.notification&&_(e.notification.message,e.notification.type))}p.current=t},[y,t,_,v]),(0,M.useEffect)(()=>()=>{y()},[y]),{state:s,validationErrors:l,openCreateNode:x,openCreateConnection:S,openEditNode:C,deleteNode:w,deleteNodes:ee,updateFormState:te,submit:T,close:E}}var Jc=/^ws-\d+-\d+$/;function Yc(e){return Jc.test(e.trim())}var Xc={sessionId:null,startedSince:null,subscribedTo:null,subscribers:[],loading:!1,pendingCommand:null,error:null,lastInfo:null};function Zc(e){return Array.from(new Set(e)).sort()}function Qc({enabled:e,connected:t,bus:n,classificationMap:r,sendRawText:i,addToast:a}){let[o,s]=(0,M.useState)(Xc),c=(0,M.useRef)(new Set),l=(0,M.useRef)(0),u=(0,M.useRef)(i),d=(0,M.useRef)(a);(0,M.useEffect)(()=>{u.current=i},[i]),(0,M.useEffect)(()=>{d.current=a},[a]);let f=(0,M.useCallback)(()=>{if(!e||!t)return!1;s(e=>({...e,loading:!0,pendingCommand:`refresh`,error:null,lastInfo:null}));let n=u.current(`session`);if(!n){let e=`Could not load session details because the WebSocket is not open.`;s(t=>({...t,loading:!1,pendingCommand:null,error:e})),d.current(e,`error`)}return n},[t,e]),p=(0,M.useCallback)(e=>{let t=`${e.kind}:${e.msgId}`;if(!c.current.has(t)){if(c.current.add(t),e.kind===`minigraph.session.started`){s({...Xc,sessionId:e.sessionId});return}if(e.kind===`minigraph.session.status`){s(t=>({...t,sessionId:e.sessionId,startedSince:e.startedSince,subscribedTo:e.subscribedTo,subscribers:Zc(e.subscribers),loading:!1,pendingCommand:null,error:null,lastInfo:null}));return}if(e.kind===`minigraph.session.commandResult`){if(e.status===`accepted`){s(t=>({...t,subscribedTo:e.command===`subscribe`?e.sessionId:e.command===`unsubscribe`?null:t.subscribedTo,pendingCommand:null,error:null,lastInfo:null}));return}s(t=>({...t,pendingCommand:null,error:e.message,lastInfo:null}));return}if(e.kind===`minigraph.session.notification`){e.type===`host-closed`?s(t=>({...t,subscribedTo:t.subscribedTo===e.sessionId?null:t.subscribedTo,subscribers:t.subscribers.filter(t=>t!==e.sessionId),error:null,lastInfo:null})):e.type===`subscriber-joined`?s(t=>({...t,subscribers:Zc([...t.subscribers,e.sessionId]),error:null,lastInfo:null})):s(t=>({...t,subscribers:t.subscribers.filter(t=>t!==e.sessionId),error:null,lastInfo:null}));return}e.kind===`session.reset`&&(s(e=>({...e,startedSince:null,subscribedTo:null,subscribers:[],loading:!1,pendingCommand:null,error:null,lastInfo:null})),f())}},[f]),m=(0,M.useCallback)(()=>{s(e=>({...e,error:null,lastInfo:null}))},[]),h=(0,M.useCallback)(n=>{let r=n.trim();if(!e||!t||o.pendingCommand!==null||o.subscribedTo!==null)return!1;if(!Yc(r))return s(e=>({...e,error:`Enter a valid session ID like ws-123456-1.`,lastInfo:null})),!1;s(e=>({...e,pendingCommand:`subscribe`,error:null,lastInfo:null}));let c=i(`session subscribe ${r}`);if(!c){let e=`Could not subscribe because the WebSocket is not open.`;s(t=>({...t,pendingCommand:null,error:e})),a(e,`error`)}return c},[a,t,e,i,o.pendingCommand,o.subscribedTo]),g=(0,M.useCallback)(()=>{if(!e||!t||o.pendingCommand!==null||o.subscribedTo===null)return!1;s(e=>({...e,pendingCommand:`unsubscribe`,error:null,lastInfo:null}));let n=i(`session unsubscribe`);if(!n){let e=`Could not unsubscribe because the WebSocket is not open.`;s(t=>({...t,pendingCommand:null,error:e})),a(e,`error`)}return n},[a,t,e,i,o.pendingCommand,o.subscribedTo]),_=(0,M.useCallback)(()=>{if(!e||!t||o.pendingCommand!==null||o.subscribedTo!==null||o.subscribers.length===0)return!1;s(e=>({...e,pendingCommand:`reset`,error:null,lastInfo:null}));let n=i(`session reset`);if(!n){let e=`Could not reset because the WebSocket is not open.`;s(t=>({...t,pendingCommand:null,error:e})),a(e,`error`)}return n},[a,t,e,i,o.pendingCommand,o.subscribedTo,o.subscribers.length]);(0,M.useEffect)(()=>{e&&t||(c.current.clear(),l.current=0,s(Xc))},[t,e]),(0,M.useEffect)(()=>{if(!e)return;let t=n.on(`minigraph.session.started`,e=>{p(e)}),r=n.on(`minigraph.session.status`,e=>{p(e)}),i=n.on(`minigraph.session.commandResult`,e=>{p(e)}),a=n.on(`minigraph.session.notification`,e=>{p(e)}),o=n.on(`session.reset`,e=>{p(e)});return()=>{t(),r(),i(),a(),o()}},[n,e,p]),(0,M.useEffect)(()=>{!e||!t||f()},[t,e,f]),(0,M.useEffect)(()=>{if(!e||!r)return;let t=l.current;for(let[e,n]of r)if(!(e<=l.current)){for(let e of n)(e.kind===`minigraph.session.started`||e.kind===`minigraph.session.status`||e.kind===`minigraph.session.commandResult`||e.kind===`minigraph.session.notification`||e.kind===`session.reset`)&&p(e);t=Math.max(t,e)}l.current=t,c.current.clear()},[r,e,p]);let v=o.subscribedTo===null,y=o.subscribers.length>0;return(0,M.useMemo)(()=>({state:o,connected:t,isPrimary:v,hasSubscribers:y,canSubscribe:e&&t&&o.pendingCommand===null&&o.subscribedTo===null,canUnsubscribe:e&&t&&o.subscribedTo!==null&&o.pendingCommand===null,canReset:e&&t&&o.pendingCommand===null&&o.subscribedTo===null&&o.subscribers.length>0,subscribeToSession:h,unsubscribe:g,resetSession:_,clearMessage:m}),[m,t,e,y,v,_,o,h,g])}var $c=(e,t)=>t.some(t=>e instanceof t),el,tl;function nl(){return el||=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]}function rl(){return tl||=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey]}var il=new WeakMap,al=new WeakMap,ol=new WeakMap;function sl(e){let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`success`,i),e.removeEventListener(`error`,a)},i=()=>{t(pl(e.result)),r()},a=()=>{n(e.error),r()};e.addEventListener(`success`,i),e.addEventListener(`error`,a)});return ol.set(t,e),t}function cl(e){if(il.has(e))return;let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`complete`,i),e.removeEventListener(`error`,a),e.removeEventListener(`abort`,a)},i=()=>{t(),r()},a=()=>{n(e.error||new DOMException(`AbortError`,`AbortError`)),r()};e.addEventListener(`complete`,i),e.addEventListener(`error`,a),e.addEventListener(`abort`,a)});il.set(e,t)}var ll={get(e,t,n){if(e instanceof IDBTransaction){if(t===`done`)return il.get(e);if(t===`store`)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return pl(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t===`done`||t===`store`)||t in e}};function ul(e){ll=e(ll)}function dl(e){return rl().includes(e)?function(...t){return e.apply(ml(this),t),pl(this.request)}:function(...t){return pl(e.apply(ml(this),t))}}function fl(e){return typeof e==`function`?dl(e):(e instanceof IDBTransaction&&cl(e),$c(e,nl())?new Proxy(e,ll):e)}function pl(e){if(e instanceof IDBRequest)return sl(e);if(al.has(e))return al.get(e);let t=fl(e);return t!==e&&(al.set(e,t),ol.set(t,e)),t}var ml=e=>ol.get(e);function hl(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,t),s=pl(o);return r&&o.addEventListener(`upgradeneeded`,e=>{r(pl(o.result),e.oldVersion,e.newVersion,pl(o.transaction),e)}),n&&o.addEventListener(`blocked`,e=>n(e.oldVersion,e.newVersion,e)),s.then(e=>{a&&e.addEventListener(`close`,()=>a()),i&&e.addEventListener(`versionchange`,e=>i(e.oldVersion,e.newVersion,e))}).catch(()=>{}),s}function gl(e,{blocked:t}={}){let n=indexedDB.deleteDatabase(e);return t&&n.addEventListener(`blocked`,e=>t(e.oldVersion,e)),pl(n).then(()=>void 0)}var _l=[`get`,`getKey`,`getAll`,`getAllKeys`,`count`],vl=[`put`,`add`,`delete`,`clear`],yl=new Map;function bl(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t==`string`))return;if(yl.get(t))return yl.get(t);let n=t.replace(/FromIndex$/,``),r=t!==n,i=vl.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||_l.includes(n)))return;let a=async function(e,...t){let a=this.transaction(e,i?`readwrite`:`readonly`),o=a.store;return r&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),i&&a.done]))[0]};return yl.set(t,a),a}ul(e=>({...e,get:(t,n,r)=>bl(t,n)||e.get(t,n,r),has:(t,n)=>!!bl(t,n)||e.has(t,n)}));var xl=[`continue`,`continuePrimaryKey`,`advance`],Sl={},Cl=new WeakMap,wl=new WeakMap,Tl={get(e,t){if(!xl.includes(t))return e[t];let n=Sl[t];return n||=Sl[t]=function(...e){Cl.set(this,wl.get(this)[t](...e))},n}};async function*El(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;let n=new Proxy(t,Tl);for(wl.set(n,t),ol.set(n,ml(t));t;)yield n,t=await(Cl.get(n)||t.continue()),Cl.delete(n)}function Dl(e,t){return t===Symbol.asyncIterator&&$c(e,[IDBIndex,IDBObjectStore,IDBCursor])||t===`iterate`&&$c(e,[IDBIndex,IDBObjectStore])}ul(e=>({...e,get(t,n,r){return Dl(t,n)?El:e.get(t,n,r)},has(t,n){return Dl(t,n)||e.has(t,n)}}));var Ol=`minigraph-clipboard`,kl=1,Al=`items`,jl=null;function Ml(){return hl(Ol,kl,{upgrade(e){e.objectStoreNames.contains(Al)&&e.deleteObjectStore(Al);let t=e.createObjectStore(Al,{keyPath:`id`});t.createIndex(`by-alias`,`node.alias`,{unique:!0}),t.createIndex(`by-clippedAt`,`clippedAt`)}})}function Nl(){return jl||=Ml().catch(async e=>(console.warn(`[clipboard/db] openDB failed, deleting and recreating:`,e),jl=null,await gl(Ol),Ml())),jl}async function Pl(){return(await(await Nl()).getAllFromIndex(Al,`by-clippedAt`)).reverse()}async function Fl(e){return(await Nl()).getFromIndex(Al,`by-alias`,e)}async function Il(e){await(await Nl()).add(Al,e)}async function Ll(e,t){let n=(await Nl()).transaction(Al,`readwrite`);await n.store.delete(e),await n.store.add(t),await n.done}async function Rl(e){await(await Nl()).delete(Al,e)}async function K(){await(await Nl()).clear(Al)}var q=`minigraph-clipboard-sync`;function J(){return new BroadcastChannel(q)}function Y(e,t){switch(t.type){case`HYDRATE`:return{items:t.items,isLoading:!1};case`ITEM_ADDED`:return{...e,items:[t.item,...e.items]};case`ITEM_REPLACED`:{let n=e.items.filter(e=>e.id!==t.previousId);return{...e,items:[t.item,...n]}}case`ITEM_REMOVED`:return{...e,items:e.items.filter(e=>e.id!==t.id)};case`ITEMS_CLEARED`:return{...e,items:[]};default:return e}}var X=(0,M.createContext)(null);function zl({children:e}){let[t,n]=(0,M.useReducer)(Y,{items:[],isLoading:!0}),r=(0,M.useRef)(null);(0,M.useEffect)(()=>{Pl().then(e=>n({type:`HYDRATE`,items:e}))},[]),(0,M.useEffect)(()=>{let e;try{e=J()}catch{return}return r.current=e,e.onmessage=e=>{let t=e.data;switch(t.type){case`item-added`:n({type:`ITEM_ADDED`,item:t.item});break;case`item-replaced`:n({type:`ITEM_REPLACED`,item:t.item,previousId:t.previousId});break;case`item-removed`:n({type:`ITEM_REMOVED`,id:t.id});break;case`items-cleared`:n({type:`ITEMS_CLEARED`});break}},()=>{e.close(),r.current=null}},[]);let i=(0,M.useCallback)(e=>{r.current?.postMessage(e)},[]),a=(0,M.useCallback)(async(e,t,r)=>{try{let a={id:crypto.randomUUID(),clippedAt:new Date().toISOString(),sourceWsPath:r.sourceWsPath,sourceLabel:r.sourceLabel,node:e,connections:t},o=await Fl(e.alias);if(o)return{status:`duplicate`,existingItem:o,pendingItem:a};try{await Il(a)}catch(t){if(t instanceof DOMException&&t.name===`ConstraintError`){let t=await Fl(e.alias);if(t)return{status:`duplicate`,existingItem:t,pendingItem:a}}throw t}return n({type:`ITEM_ADDED`,item:a}),i({type:`item-added`,item:a}),{status:`added`}}catch(e){return{status:`error`,message:e instanceof Error?e.message:String(e)}}},[i]),o=(0,M.useCallback)(async(e,t)=>{await Ll(t,e),n({type:`ITEM_REPLACED`,item:e,previousId:t}),i({type:`item-replaced`,item:e,previousId:t})},[i]),s=(0,M.useCallback)(async e=>{await Rl(e),n({type:`ITEM_REMOVED`,id:e}),i({type:`item-removed`,id:e})},[i]),c=(0,M.useCallback)(async()=>{await K(),n({type:`ITEMS_CLEARED`}),i({type:`items-cleared`})},[i]);return(0,I.jsx)(X.Provider,{value:{items:t.items,isLoading:t.isLoading,clipNode:a,confirmReplace:o,removeItem:s,clearAll:c},children:e})}function Bl(){let e=(0,M.useContext)(X);if(!e)throw Error(`useClipboardContext must be used inside <ClipboardProvider>`);return e}var Vl=new Intl.Collator(void 0,{sensitivity:`base`,numeric:!0});function Hl(e){return e.node.types[0]?.trim()||`unknown`}function Ul(e,t){return Vl.compare(e,t)}function Wl(e,t){return e-t}function Gl(e){return e===`recent`||e===`connections`?`descending`:`ascending`}function Kl(e,t){return t===`descending`?-e:e}function ql(e,t){let n=t.trim();if(!n)return{missing:!0,value:``};let r=e.node.properties[n];return r==null?{missing:!0,value:``}:typeof r==`string`?{missing:!1,value:r}:typeof r==`number`||typeof r==`boolean`?{missing:!1,value:String(r)}:{missing:!1,value:JSON.stringify(r)}}function Jl(e,t,n,r){let i=ql(e,n),a=ql(t,n);return i.missing&&!a.missing?1:!i.missing&&a.missing?-1:Kl(Ul(i.value,a.value),r)}function Yl(e,t){let n=t.direction??Gl(t.field);return e.map((e,t)=>({item:e,originalIndex:t})).sort((e,r)=>{let i=0;switch(t.field){case`type`:i=Ul(Hl(e.item),Hl(r.item));break;case`alias`:i=Ul(e.item.node.alias,r.item.node.alias);break;case`source`:i=Ul(e.item.sourceLabel,r.item.sourceLabel);break;case`connections`:i=e.item.connections.length-r.item.connections.length;break;case`property`:i=Jl(e.item,r.item,t.propertyKey??``,n);break;default:i=Date.parse(e.item.clippedAt)-Date.parse(r.item.clippedAt);break}return t.field!==`property`&&(i=Kl(i,n)),i===0?Wl(e.originalIndex,r.originalIndex):i}).map(({item:e})=>e)}function Xl(e){let t=Date.now()-new Date(e).getTime();if(t<0)return`just now`;let n=Math.floor(t/1e3);if(n<60)return`just now`;let r=Math.floor(n/60);if(r<60)return`${r} min ago`;let i=Math.floor(r/60);if(i<24)return`${i} hour${i>1?`s`:``} ago`;let a=Math.floor(i/24);return a===1?`yesterday`:a<30?`${a} days ago`:new Date(e).toLocaleDateString()}var Zl={item:`_item_1ne62_1`,previewFrame:`_previewFrame_1ne62_13`,preview:`_preview_1ne62_13`,previewShell:`_previewShell_1ne62_25`,metaBlock:`_metaBlock_1ne62_29`,timestamp:`_timestamp_1ne62_35`,removeChrome:`_removeChrome_1ne62_40`,removeIcon:`_removeIcon_1ne62_71`};function Ql({item:e,onRemove:t,onOpenMenu:n,onCloseMenu:r}){let{node:i,clippedAt:a,sourceLabel:o}=e;return(0,I.jsxs)(`div`,{className:Zl.item,children:[(0,I.jsxs)(`div`,{className:Zl.previewFrame,children:[(0,I.jsx)(`button`,{type:`button`,className:Zl.removeChrome,draggable:!1,"aria-label":`Remove node ${i.alias} from clipboard`,onClick:n=>{n.stopPropagation(),r(),t(e.id)},children:(0,I.jsx)(Qs,{className:Zl.removeIcon,"aria-hidden":`true`,focusable:`false`})}),(0,I.jsx)(`div`,{className:Zl.preview,role:`group`,draggable:!0,onDragStart:t=>{r(),Bo(t.dataTransfer,e.id)},onContextMenu:t=>{t.preventDefault(),n(e.id,t.clientX,t.clientY)},onKeyDown:t=>{if(t.key===`ContextMenu`||t.key===`F10`&&t.shiftKey){t.preventDefault();let r=t.currentTarget.getBoundingClientRect();n(e.id,Math.round(r.left+8),Math.round(r.top+8))}},tabIndex:0,"aria-label":`Drag node ${i.alias} into the graph to paste`,children:(0,I.jsx)(`div`,{className:Zl.previewShell,style:fa(i.types[0]??`unknown`),children:(0,I.jsx)(ga,{alias:i.alias,nodeType:i.types[0]??`unknown`,properties:i.properties})})})]}),(0,I.jsx)(`div`,{className:Zl.metaBlock,children:(0,I.jsxs)(`div`,{className:Zl.timestamp,children:[`Clipped `,Xl(a),` from `,o]})})]})}var $l={menu:`_menu_164vh_1`,menuItem:`_menuItem_164vh_12`},eu=16;function tu(e,t,n){let r=eu,i=Math.max(eu,n-t-eu);return Math.min(Math.max(e,r),i)}function nu({open:e,x:t,y:n,canPasteToInput:r,onPasteToInput:i,onInspect:a,onClose:o}){let s=(0,M.useRef)(null),c=(0,M.useRef)(null),l=(0,M.useRef)(null),[u,d]=(0,M.useState)({left:t,top:n});return(0,M.useLayoutEffect)(()=>{if(!e||!s.current)return;let r=s.current.getBoundingClientRect();d({left:tu(t,r.width,window.innerWidth),top:tu(n,r.height,window.innerHeight)})},[e,t,n]),(0,M.useEffect)(()=>{if(!e)return;r?c.current?.focus():l.current?.focus();let t=e=>{s.current&&!s.current.contains(e.target)&&o()},n=e=>{e.key===`Escape`&&(e.preventDefault(),o())},i=()=>o();return document.addEventListener(`pointerdown`,t),document.addEventListener(`keydown`,n),window.addEventListener(`scroll`,i,!0),window.addEventListener(`resize`,i),()=>{document.removeEventListener(`pointerdown`,t),document.removeEventListener(`keydown`,n),window.removeEventListener(`scroll`,i,!0),window.removeEventListener(`resize`,i)}},[e,r,o]),e?(0,I.jsxs)(`div`,{ref:s,className:$l.menu,style:{left:u.left,top:u.top},role:`menu`,"aria-label":`Clipboard item actions`,children:[(0,I.jsx)(`button`,{ref:c,role:`menuitem`,type:`button`,className:$l.menuItem,disabled:!r,onClick:()=>{r&&i()},children:`Paste to Input`}),(0,I.jsx)(`button`,{ref:l,role:`menuitem`,type:`button`,className:$l.menuItem,onClick:a,children:`Inspect`})]}):null}var Z={sidebar:`_sidebar_1jo34_2`,header:`_header_1jo34_12`,headerTitle:`_headerTitle_1jo34_25`,clearBtn:`_clearBtn_1jo34_32`,sortBar:`_sortBar_1jo34_48`,sortMenuWrapper:`_sortMenuWrapper_1jo34_63`,sortMenuButton:`_sortMenuButton_1jo34_68`,sortButtonLabel:`_sortButtonLabel_1jo34_93`,sortButtonValue:`_sortButtonValue_1jo34_98`,sortButtonDirection:`_sortButtonDirection_1jo34_106`,sortButtonCaret:`_sortButtonCaret_1jo34_114`,sortButtonCaretOpen:`_sortButtonCaretOpen_1jo34_121`,sortPopover:`_sortPopover_1jo34_125`,sortGroup:`_sortGroup_1jo34_139`,propertySortRow:`_propertySortRow_1jo34_150`,sortGroupTitle:`_sortGroupTitle_1jo34_154`,sortOption:`_sortOption_1jo34_164`,propertyLabel:`_propertyLabel_1jo34_197`,propertyInput:`_propertyInput_1jo34_205`,itemList:`_itemList_1jo34_223`,loading:`_loading_1jo34_233`,emptyState:`_emptyState_1jo34_243`,emptyIcon:`_emptyIcon_1jo34_256`,emptyTitle:`_emptyTitle_1jo34_261`,emptyHint:`_emptyHint_1jo34_265`,inspectPanel:`_inspectPanel_1jo34_271`,inspectHeader:`_inspectHeader_1jo34_279`,inspectClose:`_inspectClose_1jo34_293`,inspectBody:`_inspectBody_1jo34_307`,dialog:`_dialog_1jo34_313`,dialogTitle:`_dialogTitle_1jo34_328`,dialogBody:`_dialogBody_1jo34_335`,dialogActions:`_dialogActions_1jo34_342`,cancelBtn:`_cancelBtn_1jo34_349`,replaceBtn:`_replaceBtn_1jo34_363`};function ru(){return(0,I.jsxs)(`div`,{className:Z.emptyState,children:[(0,I.jsx)(`span`,{className:Z.emptyIcon,children:`📋`}),(0,I.jsx)(`span`,{className:Z.emptyTitle,children:`No items clipped yet.`}),(0,I.jsx)(`span`,{className:Z.emptyHint,children:`Right-click a node in the Graph view to get started.`})]})}var iu=[{value:`recent`,label:`Recent`},{value:`type`,label:`Type`},{value:`alias`,label:`Alias`},{value:`source`,label:`Source`},{value:`connections`,label:`Connections`},{value:`property`,label:`Property`}],au=[{value:`ascending`,label:`Ascending`},{value:`descending`,label:`Descending`}],ou=iu.reduce((e,t)=>({...e,[t.value]:t.label}),{});function su({connected:e,onPasteToInput:t}){let n=(0,M.useId)(),i=(0,M.useId)(),a=(0,M.useRef)(null),s=Bl(),[c,l]=(0,M.useState)(null),[u,d]=(0,M.useState)(null),[f,p]=(0,M.useState)(`recent`),[m,h]=(0,M.useState)(Gl(`recent`)),[g,_]=(0,M.useState)(``),[v,y]=(0,M.useState)(!1),b=(e,t,n)=>{d({itemId:e,x:t,y:n})},x=()=>{d(null)},S=e=>{x(),t(e)},C=e=>{x(),l(t=>t?.id===e.id?null:e)},w=e=>{x(),l(t=>t?.id===e?null:t),s.removeItem(e)},ee=()=>{x(),l(null),s.clearAll()},te=e=>{p(e),h(Gl(e))};(0,M.useEffect)(()=>{let e=new Set(s.items.map(e=>e.id));u&&!e.has(u.itemId)&&d(null),c&&!e.has(c.id)&&l(null)},[s.items,u,c]),(0,M.useEffect)(()=>{if(!v)return;let e=e=>{a.current?.contains(e.target)||y(!1)},t=e=>{e.key===`Escape`&&y(!1)};return document.addEventListener(`pointerdown`,e),document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`pointerdown`,e),document.removeEventListener(`keydown`,t)}},[v]);let T=(0,M.useMemo)(()=>u?s.items.find(e=>e.id===u.itemId)??null:null,[u,s.items]),E=(0,M.useMemo)(()=>Yl(s.items,{field:f,direction:m,propertyKey:g}),[s.items,m,f,g]);return(0,I.jsxs)(`div`,{className:Z.sidebar,children:[(0,I.jsxs)(`div`,{className:Z.header,children:[(0,I.jsx)(`span`,{className:Z.headerTitle,children:`Workspace`}),s.items.length>0&&(0,I.jsx)(`button`,{className:Z.clearBtn,onClick:ee,"aria-label":`Clear all workspace items`,children:`Clear`})]}),s.items.length>0&&(0,I.jsx)(`div`,{className:Z.sortBar,children:(0,I.jsxs)(`div`,{className:Z.sortMenuWrapper,ref:a,children:[(0,I.jsxs)(`button`,{type:`button`,className:Z.sortMenuButton,onClick:()=>y(e=>!e),"aria-expanded":v,"aria-controls":n,children:[(0,I.jsx)(`span`,{className:Z.sortButtonLabel,children:`Sort`}),(0,I.jsx)(`span`,{className:Z.sortButtonValue,children:ou[f]}),(0,I.jsx)(`span`,{className:Z.sortButtonDirection,children:m===`ascending`?`Asc`:`Desc`}),(0,I.jsx)(`span`,{className:`${Z.sortButtonCaret}${v?` ${Z.sortButtonCaretOpen}`:``}`,"aria-hidden":`true`,children:`▾`})]}),v&&(0,I.jsxs)(`div`,{id:n,className:Z.sortPopover,children:[(0,I.jsxs)(`div`,{className:Z.sortGroup,role:`group`,"aria-labelledby":`${n}-field-title`,children:[(0,I.jsx)(`div`,{id:`${n}-field-title`,className:Z.sortGroupTitle,children:`Sort By`}),iu.map(e=>(0,I.jsxs)(`label`,{className:Z.sortOption,children:[(0,I.jsx)(`input`,{type:`radio`,name:`${n}-field`,value:e.value,checked:f===e.value,onChange:()=>te(e.value)}),(0,I.jsx)(`span`,{children:e.label})]},e.value))]}),f===`property`&&(0,I.jsxs)(`div`,{className:Z.propertySortRow,children:[(0,I.jsx)(`label`,{className:Z.propertyLabel,htmlFor:i,children:`Property Key`}),(0,I.jsx)(`input`,{id:i,className:Z.propertyInput,value:g,onChange:e=>_(e.target.value),placeholder:`skill`,"aria-label":`Property key to sort by`})]}),(0,I.jsxs)(`div`,{className:Z.sortGroup,role:`group`,"aria-labelledby":`${n}-direction-title`,children:[(0,I.jsx)(`div`,{id:`${n}-direction-title`,className:Z.sortGroupTitle,children:`Sort Direction`}),au.map(e=>(0,I.jsxs)(`label`,{className:Z.sortOption,children:[(0,I.jsx)(`input`,{type:`radio`,name:`${n}-direction`,value:e.value,checked:m===e.value,onChange:()=>h(e.value)}),(0,I.jsx)(`span`,{children:e.label})]},e.value))]})]})]})}),(0,I.jsx)(`div`,{className:Z.itemList,children:s.isLoading?(0,I.jsx)(`div`,{className:Z.loading,children:`Loading…`}):s.items.length===0?(0,I.jsx)(ru,{}):E.map(e=>(0,I.jsx)(Ql,{item:e,onRemove:w,onOpenMenu:b,onCloseMenu:x},e.id))}),c&&(0,I.jsxs)(`div`,{className:Z.inspectPanel,children:[(0,I.jsxs)(`div`,{className:Z.inspectHeader,children:[(0,I.jsxs)(`span`,{children:[`Inspect node `,c.node.alias]}),(0,I.jsx)(`button`,{className:Z.inspectClose,onClick:()=>l(null),"aria-label":`Close inspect panel`,children:`✕`})]}),(0,I.jsx)(`div`,{className:Z.inspectBody,children:(0,I.jsx)(o,{data:{node:c.node,connections:c.connections},style:r})})]}),u&&T&&(0,I.jsx)(nu,{open:!0,x:u.x,y:u.y,canPasteToInput:e,onPasteToInput:()=>S(T),onInspect:()=>C(T),onClose:x})]})}function cu(e){let{wheelTargetRef:t,scrollRef:n,contentWrapperRef:r,currentIndex:i,totalPages:a,onNavigatePrev:o,onNavigateNext:s}=e,c=(0,M.useRef)(0),l=(0,M.useRef)(null),u=(0,M.useRef)(!1),d=(0,M.useRef)(null),f=(0,M.useRef)(o),p=(0,M.useRef)(s),m=(0,M.useRef)(i),h=(0,M.useRef)(a);(0,M.useEffect)(()=>{f.current=o}),(0,M.useEffect)(()=>{p.current=s}),(0,M.useEffect)(()=>{m.current=i}),(0,M.useEffect)(()=>{h.current=a}),(0,M.useEffect)(()=>{d.current!==null&&(clearTimeout(d.current),d.current=null),r.current&&(r.current.style.transition=`none`,r.current.style.transform=`translateY(0)`),c.current=0,l.current=null},[i]),(0,M.useEffect)(()=>{let e=t.current;if(!e)return;function i(){c.current=0,l.current=null,r.current&&(r.current.style.transition=`transform 0.28s cubic-bezier(0.25, 0.46, 0.45, 0.94)`,r.current.style.transform=`translateY(0)`)}function a(e){if(e.deltaY===0)return;let t=n.current;if(!t)return;let a=t.scrollTop<=0,o=t.scrollTop+t.clientHeight>=t.scrollHeight-1,s=e.deltaY<0,g=e.deltaY>0,_=a&&s,v=o&&g;if(!_&&!v){i();return}if(u.current)return;let y=m.current,b=h.current;if(_&&y===0||v&&y===b-1)return;let x=_?`prev`:`next`;if(l.current!==null&&l.current!==x&&i(),l.current=x,c.current+=Math.abs(e.deltaY),r.current){let e=x===`prev`?-1:1,t=c.current*(18/120),n=Math.min(t,18)*e;r.current.style.transition=`none`,r.current.style.transform=`translateY(${n}px)`}if(d.current!==null&&clearTimeout(d.current),d.current=setTimeout(i,180),c.current>=120){d.current!==null&&clearTimeout(d.current);let e=l.current;i(),u.current=!0,e===`prev`?f.current():p.current(),setTimeout(()=>{u.current=!1},650)}}return e.addEventListener(`wheel`,a,{passive:!0}),()=>{d.current!==null&&clearTimeout(d.current),e.removeEventListener(`wheel`,a)}},[])}var lu={helpRoot:`_helpRoot_18tja_2`,categoryNav:`_categoryNav_18tja_11`,categoryTabScroller:`_categoryTabScroller_18tja_21`,categoryTab:`_categoryTab_18tja_21`,categoryTabActive:`_categoryTabActive_18tja_71`,maximizeButton:`_maximizeButton_18tja_78`,closeButton:`_closeButton_18tja_100`,helpBody:`_helpBody_18tja_122`,emptyFallback:`_emptyFallback_18tja_130`,helpContent:`_helpContent_18tja_147`,topicLink:`_topicLink_18tja_226`,helpBodyContent:`_helpBodyContent_18tja_271`,chipStrip:`_chipStrip_18tja_276`,chipStripLabel:`_chipStripLabel_18tja_294`,topicChip:`_topicChip_18tja_310`,topicChipActive:`_topicChipActive_18tja_338`};function uu(e){return typeof e==`string`?e:typeof e==`number`?String(e):Array.isArray(e)?e.map(uu).join(``):M.isValidElement(e)?uu(e.props.children):``}function du(e){if(!e.trim().toLowerCase().startsWith(`help `))return null;let t=e.trim().slice(5).replace(/\s*\(.*\)\s*$/,``).trim().toLowerCase();return t.length>0?t:null}function fu({activeTopic:e,onNavigate:t,onClose:n,onToggleMaximize:r,isMaximized:i}){let a=(0,M.useRef)(null),o=(0,M.useRef)(null),s=(0,M.useRef)(null),c=(0,M.useRef)(null);(0,M.useEffect)(()=>{a.current&&(a.current.scrollTop=0)},[e]),(0,M.useEffect)(()=>{let e=c.current;if(!e)return;let t=e.querySelector(`[aria-current="step"]`);t&&t.scrollIntoView({block:`nearest`,inline:`nearest`,behavior:`smooth`})},[e]);let l=li(e),u=(0,M.useMemo)(()=>ui(l),[l]),d=u.length,f=(0,M.useMemo)(()=>si.find(e=>e.id===l)?.chipStripLabel??null,[l]),p=fi.indexOf(e),m=p<0?0:p,h=fi.length;cu({wheelTargetRef:o,scrollRef:a,contentWrapperRef:s,currentIndex:m,totalPages:h,onNavigatePrev:()=>t(fi[m-1]??``),onNavigateNext:()=>t(fi[m+1]??fi[fi.length-1])});let g=ai(e);return(0,I.jsxs)(`div`,{className:lu.helpRoot,role:`region`,"aria-label":`Help browser`,ref:o,children:[(0,I.jsxs)(`nav`,{className:lu.categoryNav,"aria-label":`Help categories`,children:[(0,I.jsx)(`div`,{className:lu.categoryTabScroller,children:si.map(e=>(0,I.jsx)(`button`,{className:[lu.categoryTab,e.id===l?lu.categoryTabActive:``].join(` `).trim(),"aria-current":e.id===l?`true`:void 0,onClick:()=>{t(ui(e.id)[0]??``)},children:e.label},e.id))}),r&&(0,I.jsx)(`button`,{className:lu.maximizeButton,onClick:r,"aria-label":i?`Restore help panel`:`Maximize help panel`,children:i?`⊞`:`⛶`}),n&&(0,I.jsx)(`button`,{className:lu.closeButton,onClick:n,"aria-label":`Close help panel`,children:`×`})]}),d>1&&(0,I.jsxs)(`div`,{className:lu.chipStrip,ref:c,children:[f!==null&&(0,I.jsx)(`span`,{className:lu.chipStripLabel,children:f}),u.map(n=>{let r=n===e,i=di(n,l);return(0,I.jsx)(`button`,{className:[lu.topicChip,r?lu.topicChipActive:``].join(` `).trim(),"aria-current":r?`step`:void 0,onClick:()=>t(n),children:i},n)})]}),(0,I.jsx)(`div`,{className:lu.helpBody,ref:a,children:(0,I.jsx)(`div`,{className:lu.helpBodyContent,ref:s,children:g===null?(0,I.jsxs)(`div`,{className:lu.emptyFallback,children:[(0,I.jsxs)(`code`,{children:[`help `,e||``]}),`\xA0 not found in the local bundle.`]}):(0,I.jsx)(`div`,{className:lu.helpContent,children:(0,I.jsx)(b,{remarkPlugins:[S],components:e===``?{li:({children:e,...n})=>{let r=du(uu(e).trim());return r!==null&&ai(r)!==null?(0,I.jsx)(`li`,{...n,children:(0,I.jsx)(`button`,{className:lu.topicLink,"aria-label":`Open help topic: ${r}`,onClick:()=>t(r),children:e})}):(0,I.jsx)(`li`,{...n,children:e})}}:void 0,children:g})})})})]})}function pu({existingItem:e,pendingItem:t,onReplace:n,onCancel:r}){let i=(0,M.useRef)(null);return(0,M.useEffect)(()=>{let e=i.current;e&&!e.open&&e.showModal()},[]),(0,I.jsxs)(`dialog`,{ref:i,className:Z.dialog,onClose:r,"aria-labelledby":`duplicate-dialog-title`,children:[(0,I.jsx)(`h2`,{id:`duplicate-dialog-title`,className:Z.dialogTitle,children:`Duplicate Node`}),(0,I.jsxs)(`p`,{className:Z.dialogBody,children:[`A clipboard item with alias `,(0,I.jsxs)(`strong`,{children:[`"`,t.node.alias,`"`]}),` already exists (clipped `,Xl(e.clippedAt),`).`]}),(0,I.jsx)(`p`,{className:Z.dialogBody,children:`Replace it with the new snapshot?`}),(0,I.jsxs)(`div`,{className:Z.dialogActions,children:[(0,I.jsx)(`button`,{className:Z.cancelBtn,onClick:r,children:`Cancel`}),(0,I.jsx)(`button`,{className:Z.replaceBtn,onClick:n,children:`Replace`})]})]})}function mu(e,t){if(!t)return null;let n=e.trim().toLowerCase();if(n!==`help`&&!n.startsWith(`help `))return null;let r=pi(e);return ai(r)===null?null:r}var hu=class{constructor(){this.listeners=new Map}on(e,t){let n=e;return this.listeners.has(n)||this.listeners.set(n,new Set),this.listeners.get(n).add(t),()=>{this.listeners.get(n)?.delete(t)}}emit(e){let t=this.listeners.get(e.kind);t&&t.forEach(t=>{try{t(e)}catch(t){console.error(`[ProtocolBus] listener for '${e.kind}' threw:`,t)}})}clear(){this.listeners.clear()}},gu=`(ws-\\d+-\\d+)`,_u=RegExp(`^session ${gu} started(?:\\nCompanion endpoint: (\\/api\\/companion\\/${gu}))?$`,`i`),vu=RegExp(`^Session ${gu} started since (.+)$`),yu=RegExp(`^subscribed to ${gu}$`),bu=/^subscribed by \[(.*)]$/,xu=RegExp(`^Subscribed to ${gu}$`),Su=RegExp(`^Session unsubscribed from ${gu}$`),Cu=RegExp(`^Session ${gu} not found$`),wu=RegExp(`^${gu} is not a primary session$`),Tu=RegExp(`^You have already subscribed to ${gu}(?:\\nPlease do 'session reset' before subscribing to another session)?$`),Eu=RegExp(`^${gu} subscribed to your session$`),Du=RegExp(`^${gu} unsubscribed from your session$`),Ou=RegExp(`^Session ${gu} has closed$`);function ku(e){let t=e.trim();return t.length===0||t.startsWith(`> `)?null:t}function Au(e){return e.split(`,`).map(e=>e.trim()).filter(e=>e.length>0&&Yc(e))}function ju(e){let t=ku(e);if(!t)return null;let n=t.match(_u);return n?{sessionId:n[1],companionEndpoint:n[2]??null}:null}function Mu(e){let t=ku(e);if(!t)return null;let n=t.split(`
`).map(e=>e.trim()).filter(Boolean),r=n[0];if(!r)return null;let i=r.match(vu);if(!i)return null;let a=null,o=[];for(let e of n.slice(1)){let t=e.match(yu);if(t){a=t[1];continue}let n=e.match(bu);n&&(o=Au(n[1]))}return{sessionId:i[1],startedSince:i[2],subscribedTo:a,subscribers:o}}function Nu(e){let t=ku(e);if(!t)return null;let n=t.match(xu);if(n)return{command:`subscribe`,status:`accepted`,sessionId:n[1],message:t};let r=t.match(Su);if(r)return{command:`unsubscribe`,status:`accepted`,sessionId:r[1],message:t};let i=t.match(Cu);if(i)return{command:`subscribe`,status:`rejected`,sessionId:i[1],message:t};let a=t.match(wu);if(a)return{command:`subscribe`,status:`rejected`,sessionId:a[1],message:t};let o=t.match(Tu);return o?{command:`subscribe`,status:`rejected`,sessionId:o[1],message:t}:t===`You cannot subscribe to yourself`?{command:`subscribe`,status:`rejected`,sessionId:null,message:t}:t===`Nothing to unsubscribe`?{command:`unsubscribe`,status:`rejected`,sessionId:null,message:t}:t===`Invalid session command`?{command:`unknown`,status:`rejected`,sessionId:null,message:t}:null}function Pu(e){let t=ku(e);if(!t)return null;let n=t.match(Eu);if(n)return{type:`subscriber-joined`,sessionId:n[1],message:t};let r=t.match(Du);if(r)return{type:`subscriber-left`,sessionId:r[1],message:t};let i=t.match(Ou);return i?{type:`host-closed`,sessionId:i[1],message:t}:null}var Fu=new Set([`info`,`error`,`ping`,`welcome`]);function Iu(e,t){let n=[],r={msgId:e,raw:t},i=!1,a=!1,o=!1,s=!1,c=!1,l=!1,u=Er(t);if(u.isJSON){let e=u.data;if(typeof e.type==`string`){let i=e.type;return n.push({...r,kind:`lifecycle`,type:i,knownType:Fu.has(i),message:typeof e.message==`string`?e.message:t,time:e.time??null}),n.length>0?n:[{...r,kind:`unclassified`}]}return n.push({...r,kind:`json.response`,data:u.data}),n.length>0?n:[{...r,kind:`unclassified`}]}let d=Nr(t);d&&(c=!0,n.push({...r,kind:`payload.large`,apiPath:d.apiPath,byteSize:d.byteSize,filename:d.filename}));let f=Pr(t);f&&(o=!0,n.push({...r,kind:`upload.invitation`,uploadPath:f}));let p=Mr(t);if(p&&(s=!0,n.push({...r,kind:`upload.contentPath`,uploadPath:p})),jr(t)){a=!0;let e=Ar(t);e&&n.push({...r,kind:`graph.link`,apiPath:e})}if(a){let e=Dr(t);e&&n.push({...r,kind:`graph.exported`,graphName:e.graphName,apiPath:e.apiPath})}let m=qr(t);m&&n.push({...r,kind:`graph.mutation`,mutationType:m});let h=Kr(t);h&&n.push({...r,kind:`minigraph.nodeAction.textResult`,status:h.status,action:h.action,alias:h.alias,targetAlias:h.targetAlias,message:h.message}),h&&(h.action===`create-node`||h.status===`error`)&&n.push({...r,kind:`minigraph.createNode.textResult`,status:h.status,alias:h.alias,message:h.message}),t===`Session restarted`&&(l=!0,n.push({...r,kind:`session.reset`}));let g=ju(t);g&&(l=!0,n.push({...r,kind:`minigraph.session.started`,sessionId:g.sessionId,companionEndpoint:g.companionEndpoint}));let _=Mu(t);_&&(l=!0,n.push({...r,kind:`minigraph.session.status`,sessionId:_.sessionId,startedSince:_.startedSince,subscribedTo:_.subscribedTo,subscribers:_.subscribers}));let v=Nu(t);v&&(l=!0,n.push({...r,kind:`minigraph.session.commandResult`,command:v.command,status:v.status,sessionId:v.sessionId,message:v.message}));let y=Pu(t);y&&(l=!0,n.push({...r,kind:`minigraph.session.notification`,type:y.type,sessionId:y.sessionId,message:y.message})),t.startsWith(`> `)&&(i=!0,n.push({...r,kind:`command.echo`,commandText:t.slice(2)})),Fr(t)&&n.push({...r,kind:`command.helpOrDescribe`,commandText:t.slice(2)});let b=Ir(t);b&&n.push({...r,kind:`command.importGraph`,graphName:b});let x=Or(t);return x&&n.push({...r,kind:`graph.export.failed`,reason:x.reason}),!i&&!a&&!o&&!s&&!c&&!l&&kr(t)&&n.push({...r,kind:`docs.response`,isMarkdown:!0}),n.length===0&&n.push({...r,kind:`unclassified`}),n}function Lu({messages:e,bus:t}){let n=(0,M.useRef)(-1);(0,M.useEffect)(()=>{e.length>0&&(n.current=e[e.length-1].id)},[]);let r=(0,M.useMemo)(()=>{let t=new Map;for(let n of e)t.set(n.id,Iu(n.id,n.raw));return t},[e]);return(0,M.useEffect)(()=>{if(e.length===0)return;let i=e.filter(e=>e.id>n.current);if(i.length!==0){n.current=e[e.length-1].id;for(let e of i){let n=r.get(e.id);if(n)for(let e of n)t.emit(e)}}},[e,t,r]),{classificationMap:r}}function Ru({config:e}){let{title:t,wsPath:n,storageKeyPayload:r,storageKeyHistory:i,storageKeyTab:a,storageKeySavedGraphs:o,supportsUpload:s,supportsClipboard:c,supportsHelp:l,supportsAuthoring:u,supportsSessionCollaboration:d,tabs:f}=e,p=St(),[m,h]=mr(r,``),g=Cr(),[_,v]=(0,M.useState)(()=>g.peekPendingPayload(n)),{takePendingPayload:y}=g;(0,M.useEffect)(()=>{let e=y(n);e!==null&&v(e)},[y,n]);let b=_??m,x=(0,M.useCallback)(e=>{v(null),h(e)},[h]),S=(0,M.useMemo)(()=>b?dr(b):{valid:!0,error:null,type:null},[b]),{toasts:T,addToast:E,removeToast:ne}=pr(),re=(0,M.useRef)(new hu).current,D=Xr({wsPath:n,storageKeyHistory:i,payload:b,addToast:E,bus:re,handleLocalCommand:(0,M.useCallback)(e=>mu(e,l===!0)!==null,[l])}),{classificationMap:ie}=Lu({messages:D.messages,bus:re}),[ae,oe]=ki(n),{graphData:se,setGraphData:O,rightTab:k,setRightTab:A,isRefreshing:ce}=ei(ae,E,f[0],f,a),{modalUploadPath:le,successfulUploadPaths:ue,handleOpenUploadModal:de,handleCloseUploadModal:j,handleUploadSuccess:fe,handleUploadError:pe,resetSuccessfulPaths:me}=_i({bus:re,addToast:E});ti({bus:re,pinnedGraphPath:ae,setPinnedGraphPath:oe,connected:D.connected,sendRawText:D.sendRawText,addToast:E});let he=(0,M.useRef)(!1);(0,M.useEffect)(()=>{he.current&&!D.connected&&(oe(null),O(null)),he.current=D.connected},[D.connected,oe,O]);let[ge,_e]=mr(e.storageKeyHelpTopic??`help-topic-fallback`,``),[ve,ye]=mr(`help-panel-open`,!1),[be,xe]=(0,M.useState)(()=>!!l&&!ve),[Se,Ce]=(0,M.useState)(!1),we=(0,M.useRef)(null),Te=(0,M.useCallback)(()=>{be&&(Ce(!0),we.current=setTimeout(()=>xe(!1),400))},[be]);(0,M.useEffect)(()=>{if(!be||Se)return;let e=setTimeout(Te,3e3);return()=>clearTimeout(e)},[be,Se,Te]),(0,M.useEffect)(()=>{ve&&be&&Te()},[ve,be,Te]),(0,M.useEffect)(()=>()=>{we.current&&clearTimeout(we.current)},[]),(0,M.useEffect)(()=>{if(!l)return;let e=e=>{e.ctrlKey&&e.key==="`"&&(e.preventDefault(),ye(e=>!e))};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[l,ye]),mi({bus:re,setHelpTopic:_e,onTabSwitch:l?()=>ye(!0):()=>{}}),vi({bus:re,connected:D.connected,appendMessage:D.appendMessage,addToast:E});let[Ee,De]=mr(`console-panel-open`,!0),Oe=Bl(),[ke,Ae]=mr(`clipboard-sidebar-open`,!1),[je,Me]=(0,M.useState)(null),Ne=(0,M.useCallback)(e=>{let t=Mi(e,se);D.setCommand(t.command),E(`${t.verb===`create`?`Create`:`Update`} command for "${e.node.alias}" pasted to input`,`info`)},[se,D.setCommand,E]),Pe=(0,M.useCallback)(e=>{let t=Oe.items.find(t=>t.id===e);if(!t){E(`Clipboard item is no longer available. It may have been removed in another tab.`,`error`);return}let n=Mi(t,se);if(!D.sendRawText(n.command)){E(`Could not send clipboard paste command because the WebSocket is not open.`,`error`);return}E(`Clipboard node "${t.node.alias}" sent as ${n.verb}. Waiting for backend response.`,`info`)},[Oe.items,se,D.sendRawText,E]),Fe=(0,M.useCallback)(async(t,r)=>{try{let i=await Oe.clipNode(t,r,{sourceWsPath:n,sourceLabel:e.label});switch(i.status){case`added`:E(`Node "${t.alias}" clipped to workspace`,`success`);break;case`duplicate`:Me({pendingItem:i.pendingItem,existingItem:i.existingItem});break;case`error`:E(`Clip failed: ${i.message}`,`error`);break}}catch(e){E(`Clip failed: ${e instanceof Error?e.message:String(e)}`,`error`)}},[Oe,n,e.label,E]),Ie=(0,M.useCallback)(async t=>{if(t.length===0){E(`No selected nodes are available to clip.`,`info`);return}if(t.length>100){E(`Select 100 or fewer nodes to clip at once.`,`error`);return}let r={added:0,duplicates:0,failed:0};for(let i of t){if(!i.node?.alias?.trim()){r.failed+=1;continue}try{let t=await Oe.clipNode(i.node,i.connections,{sourceWsPath:n,sourceLabel:e.label});t.status===`added`&&(r.added+=1),t.status===`duplicate`&&(r.duplicates+=1),t.status===`error`&&(r.failed+=1)}catch{r.failed+=1}}let i=Pi(r);E(i.message,i.type)},[E,Oe,e.label,n]),Le=yi(o??``),{defaultName:Re,savedName:ze,resetName:Be}=Ti(o?`${o}-untitled-counter`:`untitled-counter`,re,D.connected,D.connectionEpoch),Ve=(0,M.useMemo)(()=>{let e=se?.nodes.find(e=>e.types.includes(`Root`)),t=typeof e?.properties?.name==`string`?e.properties.name:void 0;return t?.trim()?t:null},[se])??Re,He=(0,M.useMemo)(()=>Fi(D.sendRawText),[D.sendRawText]),N=qc({bus:re,connected:D.connected,graphData:se,executor:He,onUserMessage:E}),Ue=N.state,P=u&&Ue.status===`open`&&(Ue.action===`edit-node`||Ue.action===`create-node`)?Ue:null,We=D.consoleRef,Ge=Ee&&P===null;(0,M.useEffect)(()=>{Ge&&We.current&&(We.current.scrollTop=We.current.scrollHeight)},[Ge,We]);let Ke=Qc({enabled:d===!0,bus:re,classificationMap:ie,connected:D.connected,sendRawText:D.sendRawText,addToast:E}),{handleSaveGraph:qe,handleLoadGraph:Je}=Di({bus:re,connected:D.connected,sendRawText:D.sendRawText,saveGraph:o?Le.saveGraph:null,addToast:E}),Ye=(0,M.useCallback)(e=>{let t=ie.get(e.id)?.find(e=>e.kind===`graph.link`);t&&oe(t.apiPath)},[ie]),{handleSendToJsonPath:Xe}=hi({ctx:g,navigate:p,addToast:E,wsPath:n}),Ze=Zr(`(max-width: 768px)`),{defaultLayout:Qe,onLayoutChanged:$e}=ee({id:e.path+`-panel-split`,storage:localStorage}),et=(0,M.useCallback)(()=>x(fr(b)),[b]),tt=(0,M.useCallback)(()=>{D.clearMessages(),oe(null),O(null),me(),Be()},[D.clearMessages,O,me,Be]);return(0,I.jsxs)(`div`,{className:cr.wrapper,children:[(0,I.jsx)(Bi,{toasts:T,onRemove:ne}),le&&(0,I.jsx)(cc,{uploadPath:le,onSuccess:fe,onClose:j,onError:pe}),u&&(0,I.jsx)(uc,{state:N.state,validationErrors:N.validationErrors,onFormStateChange:N.updateFormState,onSubmit:N.submit,onClose:N.close}),(0,I.jsxs)(`header`,{className:cr.header,children:[(0,I.jsx)(`h1`,{className:cr.title,children:t}),(0,I.jsxs)(`div`,{className:cr.headerActions,children:[o&&(0,I.jsx)(ea,{disabled:!se,defaultName:Re,savedName:ze,onSave:qe,nameExists:Le.hasGraph,connected:D.connected}),o&&Le.savedGraphs.length>0&&(0,I.jsx)(na,{savedGraphs:Le.savedGraphs,onLoad:Je,onDelete:Le.deleteGraph,connected:D.connected}),(0,I.jsx)(`button`,{className:cr.panelToggle,onClick:()=>{if(P!==null){P.phase!==`sending`&&(N.close(),De(!0));return}De(e=>!e)},"aria-label":P===null?Ee?`Hide console panel`:`Show console panel`:`Show console panel and close the node editor`,"aria-pressed":Ge,title:P===null?void 0:`Closes the node editor`,children:`Console`}),c&&(0,I.jsxs)(`button`,{className:cr.panelToggle,onClick:()=>Ae(e=>!e),"aria-label":ke?`Close workspace sidebar`:`Open workspace sidebar`,"aria-pressed":ke,children:[`Workspace`,Oe.items.length>0?` (${Oe.items.length})`:``]}),(0,I.jsx)(Zi,{addToast:E,sessionCollaboration:d?Ke:null}),l&&(0,I.jsxs)(`div`,{className:cr.helpButtonWrapper,children:[(0,I.jsx)(`button`,{className:`${cr.helpToggle}${be&&!Se?` ${cr.helpTogglePulsing}`:``}`,onClick:()=>ye(e=>!e),"aria-label":ve?`Close help panel`:`Open help panel`,"aria-pressed":ve,children:`?`}),be&&(0,I.jsxs)(`div`,{className:`${cr.helpHint}${Se?` ${cr.helpHintFading}`:``}`,onClick:Te,role:`status`,children:[(0,I.jsx)(`kbd`,{className:cr.helpHintKbd,children:"Ctrl + `"}),` to toggle help`]})]})]})]}),je&&(0,I.jsx)(pu,{existingItem:je.existingItem,pendingItem:je.pendingItem,onReplace:async()=>{try{await Oe.confirmReplace(je.pendingItem,je.existingItem.id),Me(null),E(`Clipboard item "${je.pendingItem.node.alias}" replaced`,`success`)}catch(e){E(`Replace failed: ${e instanceof Error?e.message:String(e)}`,`error`)}},onCancel:()=>{Me(null),E(`Clip cancelled`,`info`)}}),(0,I.jsxs)(te,{className:cr.panelGroup,orientation:Ze?`vertical`:`horizontal`,defaultLayout:Qe,onLayoutChanged:$e,children:[(Ee||P!==null)&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(w,{defaultSize:ve||ke?`50%`:`60%`,minSize:`25%`,children:P===null?(0,I.jsx)(Os,{messages:D.messages,classificationMap:ie,onCopy:D.copyMessages,onClear:tt,consoleRef:D.consoleRef,command:D.command,onCommandChange:D.setCommand,onCommandKeyDown:D.handleKeyDown,onSend:D.sendCommand,sendDisabled:!D.connected||!D.command.trim(),inputDisabled:!D.connected,commandHistory:D.history,onGraphLinkMessage:Ye,onCopyMessage:()=>E(`Copied to clipboard`,`success`),onSendToJsonPath:Xe,onUploadMockData:de,successfulUploadPaths:ue}):(0,I.jsx)(rc,{mode:P.action===`edit-node`?`edit`:`create`,formState:P.formState,phase:P.phase,lockReason:P.phase===`sending`?`sending`:P.connectionLost?`disconnected`:null,serverMessage:P.serverMessage,validationErrors:N.validationErrors,onFormStateChange:N.updateFormState,onSubmit:N.submit,onClose:N.close})}),(0,I.jsx)(C,{className:cr.resizeHandle,"aria-label":`Resize panels`})]}),(0,I.jsx)(w,{defaultSize:ve?`50%`:ke?`30%`:`40%`,minSize:`20%`,children:(0,I.jsx)(gs,{tabs:f,payload:b,onChange:x,validation:S,onFormat:et,onUpload:s?D.uploadPayload:void 0,graphData:se,graphName:Ve,activeTab:k,onTabChange:A,onGraphRenderError:e=>E(e,`error`),onGraphDataCopySuccess:()=>E(`Graph JSON copied to clipboard!`,`success`),onGraphDataCopyError:()=>E(`Copy failed`,`error`),isGraphRefreshing:ce,onClipNode:c?Fe:void 0,onClipNodes:c?Ie:void 0,onClipboardDrop:c?Pe:void 0,isConnected:D.connected,supportsAuthoring:u,onCreateNode:u?N.openCreateNode:void 0,onCreateConnection:u?N.openCreateConnection:void 0,onEditNode:u?N.openEditNode:void 0,onDeleteNode:u?N.deleteNode:void 0,onDeleteNodes:u?N.deleteNodes:void 0,helpPanel:l&&ve?((e,t)=>(0,I.jsx)(fu,{activeTopic:ge,onNavigate:_e,onClose:()=>ye(!1),onToggleMaximize:e,isMaximized:t})):void 0})}),c&&ke&&(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(C,{className:cr.resizeHandle,"aria-label":`Resize clipboard`}),(0,I.jsx)(w,{defaultSize:`20%`,minSize:`10%`,maxSize:`40%`,children:(0,I.jsx)(su,{connected:D.connected,onPasteToInput:Ne})})]})]})]})}function zu(){let e=gr[0].path;return(0,I.jsx)(Sr,{children:(0,I.jsx)(zl,{children:(0,I.jsx)(Vn,{children:(0,I.jsxs)(Xt,{children:[gr.map(e=>(0,I.jsx)(Jt,{path:e.path,element:(0,I.jsx)(Ru,{config:e},e.path)},e.path)),(0,I.jsx)(Jt,{path:`*`,element:(0,I.jsx)(qt,{to:e,replace:!0})})]})})})})}(0,sr.createRoot)(document.getElementById(`root`)).render((0,I.jsx)(M.StrictMode,{children:(0,I.jsx)(zu,{})}));
//# sourceMappingURL=index-BqpgurX2.js.map