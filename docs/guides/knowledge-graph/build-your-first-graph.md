...
The graph isn't called directly — it's wrapped by an [Event Script](../CHAPTER-4.md) flow, which is
...
- [Event Script Syntax](../CHAPTER-4.md) — the data-mapping syntax the skills share, and the flow
