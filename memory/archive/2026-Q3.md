...
## 2026-09-07 — archived via archive-fact (faded (completed threads past archive_window: sslu 30, 28, 32 > 20))
...
## 2026-09-10 — archived via archive-fact (faded — not referenced in over archive_window (20) sessions (sslu 31))
...
## 2026-09-10 — archived via archive-fact (completed thread past archive_window (sslu 34); invariants all confirmed 2026-09-04)
...
## 2026-09-11 — archived via archive-fact (faded)
...
## 2026-09-12 — archived via archive-fact (completed; swept after archive_window (21 sessions since last use))
...
- [x] **(docs) agent-memory locators — DONE 2026-09-10.** agent-memory joined the Mercury family
  ...
  <!-- id: ot-agent-memory-attribution-locators | created: 2026-09-05 | last_used: 2026-09-10 | uses: 3 | tier: archive-candidate | origin: 2026-09-05-174738 -->

## 2026-09-14 — archived via archive-fact (faded)
...
## 2026-09-16 — archived via archive-fact (faded (sslu 21 / 25 > archive_window 20))
...
## 2026-09-16 — archived via archive-fact (retired 2026-09-16 by Eric at the invariant re-verification — pure invalidation, no successor)
...
- **Telemetry/log presentation parity across language engines is a field requirement (Eric,
  ...
  **Scope extension: the Event Script surface is part of the cross-engine contract** — flows are
  ...
  <!-- id: conv-telemetry-presentation-parity | created: 2026-07-23 | last_used: 2026-09-02 | uses: 42 | tier: superseded | origin: 2026-07-23-145132 | note: RETIRED 2026-09-16 by Eric at the invariant re-verification — pure invalidation, no successor. What is retired is the standing telemetry/log PRESENTATION-parity obligation and its lock-step corollary for new built-in plugins. The Java-is-reference-implementation principle it rested on SURVIVES, restated by Eric in conv-ports-adopt-java-release-number and documented in docs/guides/registration-metadata-contract.md. Promoted to core 2026-09-04; retired as core 12 days later -->

## 2026-09-16 — archived via archive-fact (faded (sslu 23 > archive_window 20); shipped in v4.12.9 PR #364, design realized in code and the sync-over-async guide)
...
## 2026-09-17 — archived via archive-fact (completed and faded (sslu 114-189); closed in the 2026-09-16 stale-thread audit, narrative in each origin log)
...
- [x] (docs backlog → **MERGED 2026-09-16 into [[thread-doc-improvement-feedback-loop]]**) **Documentation
  improvement — serve both audiences.** The two were machinery and queue; acceptance criteria (human
  storytelling / AI token-efficiency) survive in the loop thread.
  **Audited at merge: 8 of 9 items had already shipped** with the record never updated. One residual
  carried forward — a request-response RPC demo in `lambda-example` (`HelloRemoteRelay` is a
  hop-through relay returning `Void`).
...
## 2026-09-18 — archived via archive-fact (faded)
...
## 2026-09-19 — archived via archive-fact (faded)
...
## 2026-09-22 — archived via archive-fact (swept (completed thread, past archive_window))
...
## 2026-09-23 — archived via archive-fact (faded / completed - past archive_window at the 2026-09-23 cadence review)
...
## 2026-09-24 — archived via archive-fact (overdue (sslu 21 > archive_window 20) at the v4.12.17 seam; its rule shipped upstream as agent-memory v4.41.1 (DECAY.md §1), so the fact carried only history)
...
## 2026-09-24 — archived via archive-fact (overdue (sslu 21 > archive_window 20) at the v4.12.17 seam; the parser fix shipped upstream as agent-memory v4.41.2, the header placeholder stays as the honest example)
...
## 2026-09-25 — archived via archive-fact (faded — demoted from core 2026-09-25 by Eric at the invariant walk (an implementation detail, not a decision anyone consults); unreferenced since 2026-06-27)
...
- **platform-core serializes `java.time.Instant` as first-class (2026-06-27).** Instant had no adapter and
  ...
  <!-- id: instant-serialization | created: 2026-06-27 | last_used: 2026-06-27 | uses: 1 | tier: archive-candidate | note: demoted from core 2026-09-25 (Eric, invariant walk) - an implementation detail that no longer influences key decisions -->

## 2026-09-25 — archived via archive-fact (faded)
...
## 2026-09-25 — archived via archive-fact (completed thread swept past archive_window)
...
## 2026-09-25 — archived via archive-fact (faded past archive_window at the release seam)
...
## 2026-09-25 — archived via archive-fact (faded past archive_window 20 at the docs/deploy-without-rebuild seam; both rules shipped in v4.12.13 (PRs #426, #427) and live in the code and event-envelope-reference.md)
...
## 2026-09-25 — archived via archive-fact (faded past archive_window 20 at the feat/graph-manifest-list seam; the ruling (log forwarding is an infrastructure task) shipped with v4.12.13 docs and stands in the observability guide)
...
## 2026-09-25 — archived via archive-fact (faded past archive_window 20 at the release/4.12.19 seam; the ReentrantLock rule stands in code comments (RedisHealthProbe) and the Kafka shutdown LeaveGroup shipped in 4.12.15 (PRs #440, #441))
