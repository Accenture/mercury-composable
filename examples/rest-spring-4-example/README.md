...
This example project folder contains an example application that use the rest-spring-4 library and platform-core
together to generate a Spring Boot application.

The rest-spring-4 library is a customized Spring Boot 4 application server. It is provided as a convenient and unified
...
This sample application requires Spring Boot version 4 as its application server.
