...
/**
 * Test sink on the SECONDARY cluster side: records what arrived over cluster B after the
 * A-to-B bridge hop, so the test can assert body, correlation-id, and trace continuity.
 */
@PreLoad(route = "bridge.sink.b", instances = 5)
public class BridgeSinkB implements TypedLambdaFunction<byte[], Map<String, Object>> {
