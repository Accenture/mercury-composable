...
/**
 * Test sink on the PRIMARY cluster side: records what arrived over cluster A after the
 * B-to-A bridge hop, so the test can assert body, correlation-id, and trace continuity.
 */
@PreLoad(route = "bridge.sink.a", instances = 5)
public class BridgeSinkA implements TypedLambdaFunction<byte[], Map<String, Object>> {
